...
public class SchemeWiseJAXBClient {
	...
	public static void main(String[] args) throws JAXBException{
		...
		try {
			...
			int insertStatus=0;
			String url = "http://localhost:8080/AssetRegistrationWS_Jaxb/rest/SchemeAssetsService/SchemeWiseAssets/00001501180016/15";
			...
			for(Asset a:assets){
				...
				rs2=stmt2.executeQuery("select * from rwss_asset_registration_details1 where source_code='"+hpCode+"'");
				if(rs2.next()){
				...
				assetRegInserQry="insert into rwss_asset_registration_details1(habitation_name, habitation_code, asset_type, asset_name, asset_location, asset_code, asset_status, area_covered, source_code, gps_lat, gps_long, yield, drain_existing, platform_existing, response_code) values('"+habitationName+"','"+habitationCode+"','"+assetType+"','"+assetName+"','"+assetLocation+"','"+assetCode+"','"+assetStatus+"','"+areaCovered+"','"+hpCode+"','"+gpsLat+"','"+gpsLong+"','"+yield+"','"+drainExisting+"','"+platformExisting+"','"+responseCode+"') ";
