...
public class OMProposalTracking extends Action 
{
		...
		HttpServletRequest request, HttpServletResponse response) throws Exception
	{
		...
		if(myForm != null)
		{
			...
			String omProposalId = myForm.getProposalId();
			ArrayList proposalTracks = proposalDAO.getOMProposalTracking(omProposalId);
