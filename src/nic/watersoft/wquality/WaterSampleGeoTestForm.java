 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class WaterSampleGeoTestForm extends ActionForm
{
	...
	public void setHeadOfficeCode(String headOfficeCode) {
	 ...
	 public WaterSampleGeoTestForm()
	 {
	 	//System.out.println("in WaterSampleGeoTestForm()");
	...
	{
		//System.out.println("##### Entered to getResultsSubmittedToSubdivision() #####");
