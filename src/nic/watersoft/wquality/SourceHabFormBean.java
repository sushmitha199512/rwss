...
public class SourceHabFormBean implements Serializable {
	...
	private String esubsidy="";
	private String amunteligible="";
	...
	public void setIhhlcon(String ihhlcon) {
		this.ihhlcon = ihhlcon;
	}
	public String getIhhlcon() {
		return ihhlcon;
	}
	...
	public void setEsubsidy(String esubsidy) {
		this.esubsidy = esubsidy;
	}
	public String getEsubsidy() {
		return esubsidy;
	}
	public void setAmunteligible(String amunteligible) {
		this.amunteligible = amunteligible;
	}
	public String getAmunteligible() {
		return amunteligible;
	}
	...
	public String getSourcehab() {
		return sourcehab;
	}
	public void setSourcehab(String sourcehab) {
		this.sourcehab = sourcehab;
	}
