...
public class AuthorisedMobileUserDetailsForm extends ActionForm {

	private ArrayList<AuthorisedMobileUserBean> users;
	...
	public void setUsers(ArrayList<AuthorisedMobileUserBean> users) {
		this.users = users;
	}
	public ArrayList<AuthorisedMobileUserBean> getUsers() {
		return users;
	}
