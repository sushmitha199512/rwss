...
public class ChangePasswordAction extends Action {
	...
	protected int updateRecord(DataSource dataSource) throws SQLException {
		try {
			...
			String rsQuery = " select password from rws_password_tbl WHERE user_id = '"+userid+"'";
			
			//System.out.println("*****************"+rsQuery);
			
			ResultSet rs = conn.createStatement().executeQuery(rsQuery);
			while(rs.next())
			{
