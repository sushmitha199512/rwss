...
public class UserManagementData extends Action {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws ServletException, Exception {
		...
		String authAccess=myForm.getModeCheck();
		String path=myForm.getUrlPath();
		System.out.println("path  "+path);System.out.println("authAccess  "+authAccess);
		/*if(authAccess.equals("AuthCheck")){
			RwsOffices rwsOffices = new RwsOffices(getDataSource(request));
			String resp=rwsOffices.getDataCheck(path,userId);
