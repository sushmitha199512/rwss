        ...
        try
		{
        	...
        	if(recordExists)
        	{
        		sqlQuery= " update RWS_MON_PROGREES_OB_BAL" 
        			+ " set OP_BAL=?," 
					+ " CL_BAL=? where dcode=?" 
					+ " and DIVISION_OFFICE_CODE=? and programme_code=? and " 
					+ " fin_year=?"; 
        		ps = conn.prepareStatement(sqlQuery);
        		ps.setString(1,openingBalance);
        		ps.setString(2,closingBalance);
        		ps.setString(3,dcode);
        		ps.setString(3,divCode);
        		ps.setString(4,programmeCode);
        	...
        	else
        	{
        		...
        		ps.setString(4,openingBalance);
        		ps.setString(5,closingBalance);
	 ...
	 public DAOMessage insertClosingBalanceForPreviousYear(String dcode,String financialYear,String programmeCode)throws Exception
		{
	        ...
	        try
			{
	        	...
	        	//System.out.println("query is "+sqlQuery);
	        		...
	        		ps.setString(3,getPreviousFinancialYear(financialYear));
	        		ps.setDouble(4,closingBalanceForThePreviousYear);
	        	int rcount=ps.executeUpdate();
