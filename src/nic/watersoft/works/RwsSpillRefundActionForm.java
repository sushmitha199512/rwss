...
public class RwsSpillRefundActionForm extends ActionForm{
    ...
    private ArrayList spillrefundWorks=new ArrayList();
	...
	public ArrayList getSpillrefundWorks() {
		return spillrefundWorks;
	}
	public void setSpillrefundWorks(ArrayList spillrefundWorks) {
		this.spillrefundWorks = spillrefundWorks;
	}
}
