...
public class OfficeMasterForm extends ActionForm
{
	...
	private String changeWorkName="";
	
	
	
	public String getChangeWorkName() {
		return changeWorkName;
	}
	public void setChangeWorkName(String changeWorkName) {
		this.changeWorkName = changeWorkName;
	}
	/**
