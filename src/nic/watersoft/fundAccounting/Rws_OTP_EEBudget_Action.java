...
public class Rws_OTP_EEBudget_Action extends Action
{
	...
	public ActionForward execute(ActionMapping mapping,ActionForm form,HttpServletRequest request,HttpServletResponse response)throws ServletException,IOException
	{
		...
		Rws_OTP_EEBudget_Form frm=(Rws_OTP_EEBudget_Form) form;
		...
		{
			reset(frm);
			if(userid.equals("ENC") || userid.equals("EE-Budget")){
		...
		System.out.println("Exception in Rws_OTP_EEBudget_Action-- "+e);
		}
		return(mapping.findForward(mode));
	}
	void reset(Rws_OTP_EEBudget_Form frm)
	{
		frm.setOtp("");
