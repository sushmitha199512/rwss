...
public class DroughtDTO extends BaseDTO implements Serializable
{
	...
	/**
	 * @return Returns the habvalue.
	 */
	public String getHabvalue() {
		return habvalue;
	}
	/**
	 * @param habvalue The habvalue to set.
	 */
	public void setHabvalue(String habvalue) {
		this.habvalue = habvalue;
	}
	/**
