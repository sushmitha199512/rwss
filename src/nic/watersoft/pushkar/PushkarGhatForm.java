...
public class PushkarGhatForm extends ActionForm{
...
public void setMinorityCovered(int minorityCovered) {
	...
	public void setHabStatusForm(String habStatusForm) {
		this.habStatusForm = habStatusForm;
	}
	public String getHabStatusForm() {
		return habStatusForm;
	}
	public void setPushkartype(String pushkartype) {
		this.pushkartype = pushkartype;
	}
	public String getPushkartype() {
		return pushkartype;
	}
}
