...
public class Rws_PushkarWorkForm extends BaseActionForm  {
...
private String tenderaprvd;
   ...
   // Source Identification
	...
	public PushkarHolder getWORK(int index)
	{
		while(index >= proposals.size())
		{
			proposals.add(new PushkarHolder());
		}
		return (PushkarHolder)proposals.get(index);
	}
