...
public class rws_AsstComplaintActout_frm extends Action
{
	String cmpCode="";
    public rws_AsstComplaintActout_frm()
    {
        ...
        throws Exception
    {
        ...
        CompForm compForm = ComplaintMasterData.getComplaintnoout(complaintno, getDataSource(request));
        ...
        throws ServletException, IOException
    {
        ...
        { 
         ...
         Debug.println("generate1");
        }
        if(mode != null && mode.equalsIgnoreCase("save"))
        {
           Debug.println("save mode************** ............");
            ...
            try 
            {
               ...
               // String cmpCode=request.getParameter("cmpcode");
                ...
                compCount = nic.watersoft.complaints.ComplaintMasterData.insertComplaintout(frm.getAssetCode(),complaintno, date, category, desc, givenby, name, address, phone, compForm,  sourcecode, cmpCode, getDataSource(request));
        ...
        if(mode != null && mode.equalsIgnoreCase("cdelete"))
        {
            ...
            try
            {
                ...
                Debug.println("cono" + cono);
                i = nic.watersoft.complaints.ComplaintMasterData.deleteComplaints(cono, getDataSource(request));
                if(i == 1)
