...
public class rws_AsstComplaintStatusActgeneric_frm extends Action
{

    public rws_AsstComplaintStatusActgeneric_frm()
    {
    }
        ...
        throws ServletException, IOException
    {
        ...
        if(mode != null && mode.equalsIgnoreCase("get2"))
        {
            ...
            try
            {
                ...
                {
                    mandals = complaintMasterData.getCompMandalsgenericno(frm.getDist(), getDataSource(request));
                ...
                {
                    villages = complaintMasterData.getCompVillagesgeneric(frm.getDist(), frm.getMand(), frm.getPanch(), getDataSource(request));
                ...
                {
                    habitations = complaintMasterData.getCompHabitationsgeneric(frm.getDist(), frm.getMand(), frm.getPanch(), frm.getVill(), getDataSource(request));
        ...
        if(mode != null && mode.equalsIgnoreCase("view"))
        {
            try
            {
                ...
                {
                    reccomplaints = ComplaintMasterData.getrecComplaintsgeneric(frm.getHabCode(), getDataSource(request));
                ...
                if(frm.getHabCode() != null && !frm.getHabCode().equals(""))
                {
                    fromdates = ComplaintMasterData.getFromDatesdistgeneric(frm.getDist(), frm.getHabCode(), getDataSource(request));
                    session.setAttribute("fromdates", fromdates);
                    String s = frm.getFromDate();
                }
                if(frm.getFromDate() != null)
                {
                    todates = ComplaintMasterData.getToDatesdistgeneric(frm.getDist(), frm.getHabCode(), frm.getFromDate(), getDataSource(request));
        ...
        if(mode != null && mode.equalsIgnoreCase("dates"))
        {
            try
            {
                ...
                if(frm.getFromDate() != null)
                {
                    ...
                    request.setAttribute("fromdates", ComplaintMasterData.getFromDatesdistgeneric(frm.getDist(), frm.getHabCode(), getDataSource(request)));
                    frm.setFromDate(frdt);
                    Debug.println(" value of the fromDate:" + frdt);
                    todates = ComplaintMasterData.getToDatesdistgeneric(frm.getDist(), frm.getHabCode(), frdt, getDataSource(request));
                    session.setAttribute("todates", todates);
                    request.setAttribute("todates", ComplaintMasterData.getToDatesdistgeneric(frm.getDist(), frm.getHabCode(), frdt, getDataSource(request)));
        ...
        if(mode != null && mode.equalsIgnoreCase("display"))
        {
            try
            {
               System.out.println("disply mode");
                ...
                tdate = frm.getToDate();
                Debug.println("todate1" + tdate);
                attendedcomplaints = ComplaintMasterData.getComplaintsattendedlistgeneric(frm.getHabCode(), frdt, tdate, getDataSource(request));
