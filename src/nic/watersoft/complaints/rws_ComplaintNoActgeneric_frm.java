...
public class rws_ComplaintNoActgeneric_frm extends Action
{

    public rws_ComplaintNoActgeneric_frm()
    {
    }
      ...
      //  System.out.println("mode:" + mode);
        ...
        if(mode != null && mode.equalsIgnoreCase("cview"))
        {
            ...
            try
            {
                ...
                String com = nic.watersoft.complaints.ComplaintMasterData.getComplaintsNogeneric1(frm.getComplntno(), getDataSource(request));
                complaintsalist = nic.watersoft.complaints.ComplaintMasterData.getComplaintsNogeneric(frm.getComplntno(), getDataSource(request));
        ...
        if(mode != null && mode.equals("get3"))
        {
            ...
            try
            {
            	...
            	ComplaintMasterData complaintMasterData = new ComplaintMasterData(); 
                 ...
                 cno = ComplaintMasterData.getComplaintnodatesgeneric(frm.getDist(), frm.getMand(), frm.getPanch(), getDataSource(request));
