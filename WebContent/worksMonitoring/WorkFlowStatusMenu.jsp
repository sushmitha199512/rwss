...
function fnsubmit()
{
	document.f1.action="/pred/worksMonitoring/WorkFlowStatusReport.jsp";
	document.f1.submit();
}
...
<table cellpadding="0" cellspacing="0">
		<tr>
			...
			<td background="/pred/resources/images/top_center_b.gif" width="280" class="heading" valign="middle" align="center" class id ="mainheading">Work Flow Status Report</td>
...
<form name=f1 method="post" action="/pred/worksMonitoring/WorkFlowStatusMenu.jsp">
