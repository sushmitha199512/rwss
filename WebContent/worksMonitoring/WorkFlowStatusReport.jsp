...
<tr>
<td colspan=20 align=center class=label bgcolor=#A899FB>Work Flow Status Report</b></center></td>
</tr>
<tr>
...
<td class=label colspan=5><center>Work Flow Status</center></b></td>
	   ...
	   while(rs.next())
	   {
		   ...
		   %>
 		   ...
 		   <tr>     
			  ...
			  <td class=label><a href="WorkFlowStatusDivisionReport.jsp?circle=<%=rs.getString(22)%>&division=<%=rs.getInt(23)%>&subdivision=<%=subdivisioncode%>&AssetType=<%=AssetType%>&cmbYear=<%=year%>&cmbMonth=<%=month%>" ><%=rs.getString(1)%></a></td> 
...
if (!circlecode.equals("00") && !AssetType.equals("") && !year.equals("") && divisioncode!=0 && subdivisioncode.equals("0") && !month.equals("0"))
	{
	System.out.println("circle code"+circlecode);
	query="select division_office_name,COST_OF_SPOVER_WORKS_DUR_MON,COST_OF_SPOVER_WORKS_UPTO_MON  ,NO_NEW_WORKS_SANC_UPTO_MON  ,NO_NEW_WORKS_SANC_DUR_MON ,TOT_OF_WORKS_TECHSANC_DUR_MON ,TOT_OF_WORKS_TECHSANC_UPTO_MON,WORK_TENDER_COST_DUR_MON ,WORK_TENDER_COST_UPTO_MON ,TOT_NO_WORKS_GRD_DUR_MON ,TOT_NO_WORKS_GRD_UPTO_MON ,TOT_NO_WORKS_COMP_DUR_MON,TOT_NO_WORKS_COMP_UPTO_MON,NO_OF_PC_HABS_TAR_UPTO_MON,NO_OF_PC_HABS_TAR_DUR_MON ,NO_OF_NSS_HABS_TAR_UPTO_MON,NO_OF_NSS_HABS_TAR_DUR_MON ,NO_OF_PC_HABS_COV_DUR_MON,NO_OF_PC_HABS_COV_UPTO_MON,NO_OF_NSS_HABS_COV_DUR_MON ,NO_OF_NSS_HABS_COV_UPTO_MON from rws_division_office_tbl do,rws_physical_progress_tbl pp where do.circle_office_code = substr(pp.office_code,2,2) and do.division_office_code = substr(pp.office_code,4,1) and substr(pp.office_code,2,2)=? and substr(pp.office_code,4,1)=? and year= ? and asset_type = ? and month=? ";
	pstmt=conn.prepareStatement(query);
	   pstmt.setString(1,circlecode);
	   pstmt.setInt(2,divisioncode);
...
if (!circlecode.equals("00") && !AssetType.equals("") && !year.equals("") && divisioncode==0 && subdivisioncode.equals("0") && !month.equals("0"))
	{
	System.out.println("circle code"+circlecode);
	query="select circle_office_name,COST_OF_SPOVER_WORKS_DUR_MON,COST_OF_SPOVER_WORKS_UPTO_MON  ,NO_NEW_WORKS_SANC_UPTO_MON  ,NO_NEW_WORKS_SANC_DUR_MON ,TOT_OF_WORKS_TECHSANC_DUR_MON ,TOT_OF_WORKS_TECHSANC_UPTO_MON,WORK_TENDER_COST_DUR_MON ,WORK_TENDER_COST_UPTO_MON ,TOT_NO_WORKS_GRD_DUR_MON ,TOT_NO_WORKS_GRD_UPTO_MON ,TOT_NO_WORKS_COMP_DUR_MON,TOT_NO_WORKS_COMP_UPTO_MON,NO_OF_PC_HABS_TAR_UPTO_MON,NO_OF_PC_HABS_TAR_DUR_MON ,NO_OF_NSS_HABS_TAR_UPTO_MON,NO_OF_NSS_HABS_TAR_DUR_MON ,NO_OF_PC_HABS_COV_DUR_MON,NO_OF_PC_HABS_COV_UPTO_MON,NO_OF_NSS_HABS_COV_DUR_MON ,NO_OF_NSS_HABS_COV_UPTO_MON,substr(pp.office_code,4,1) from rws_circle_office_tbl co,rws_physical_progress_tbl pp where co.circle_office_code = substr(pp.office_code,2,2) and substr(pp.office_code,2,2)=? and year= ? and asset_type = ? and month=? ";
	pstmt=conn.prepareStatement(query);
	   pstmt.setString(1,circlecode);
...
if (!circlecode.equals("00") && !AssetType.equals("") && !year.equals("") && divisioncode!=0 && !subdivisioncode.equals("0") && !month.equals("0"))
	{
	System.out.println("circle code"+circlecode);
	query="select subdivision_office_name,COST_OF_SPOVER_WORKS_DUR_MON,COST_OF_SPOVER_WORKS_UPTO_MON  ,NO_NEW_WORKS_SANC_UPTO_MON  ,NO_NEW_WORKS_SANC_DUR_MON ,TOT_OF_WORKS_TECHSANC_DUR_MON ,TOT_OF_WORKS_TECHSANC_UPTO_MON,WORK_TENDER_COST_DUR_MON ,WORK_TENDER_COST_UPTO_MON ,TOT_NO_WORKS_GRD_DUR_MON ,TOT_NO_WORKS_GRD_UPTO_MON ,TOT_NO_WORKS_COMP_DUR_MON,TOT_NO_WORKS_COMP_UPTO_MON,NO_OF_PC_HABS_TAR_UPTO_MON,NO_OF_PC_HABS_TAR_DUR_MON ,NO_OF_NSS_HABS_TAR_UPTO_MON,NO_OF_NSS_HABS_TAR_DUR_MON ,NO_OF_PC_HABS_COV_DUR_MON,NO_OF_PC_HABS_COV_UPTO_MON,NO_OF_NSS_HABS_COV_DUR_MON ,NO_OF_NSS_HABS_COV_UPTO_MON from rws_subdivision_office_tbl co,rws_physical_progress_tbl pp where co.circle_office_code = substr(pp.office_code,2,2) and co.division_office_code = substr(pp.office_code,4,1) and co.subdivision_office_code = substr(pp.office_code,5,2) and substr(pp.office_code,2,2)=? and substr(pp.office_code,4,1)=? and substr(pp.office_code,5,2)=? and year= ? and asset_type = ? and month=? ";
	pstmt=conn.prepareStatement(query);
	   pstmt.setString(1,circlecode);
	   pstmt.setInt(2,divisioncode);
	   pstmt.setString(3,subdivisioncode);
...
<br><br><br><br><br><br>
 <p align="center">
 <span class = label>Designed & Developed by National Informatics Centre, AP State Centre</span>
