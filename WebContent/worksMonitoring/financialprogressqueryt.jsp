...
<html>			
	...
	{
		document.financialFormt.action="/pred/worksMonitoring/GenFinancialProgressActiont.do";
...
function getSubProgramme()
{
 ...
 <html:form action="FinancialProgresst" > 
...
<br><br><br>
   ...
   <TR>
	...
	<table width="430" bgcolor=#edf2f8 cellpadding="2" cellspacing="2" border="1" bordercolor="#364d67" rules="none" style="border-collapse:collapse">
	<tr>
	...
	<tr>
		...
		<td><html:select property="cmbDivision" styleClass="comboFont" style="width:130px" onchange="getSubDivisions()">
