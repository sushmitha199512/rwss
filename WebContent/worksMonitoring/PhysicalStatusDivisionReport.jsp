	    ...
	    while(rs.next())
	   {
		   ...
		   %>
 		   ...
 		   <tr>     
			  ...
			  <td class=label><a href="PhysicalStatusSubdivisionReport.jsp?circle=<%=circlecode%>&division=<%=divisioncode%>&subdivision=<%=rs.getString(6)%>&AssetType=<%=AssetType%>&cmbYear=<%=year%>&cmbMonth=<%=month%>" ><%=rs.getString(1)%></a></td> 
