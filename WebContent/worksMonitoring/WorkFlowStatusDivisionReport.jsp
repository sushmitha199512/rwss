...
<tr>
<td colspan=20 align=center class=label bgcolor=#A899FB>Work Flow Status Division Report</b></center></td>
</tr>
<tr>
	    ...
	    while(rs.next())
	   {
		   ...
		   %>
 		   ...
 		   <tr>     
			  ...
			  <td class=label><a href="WorkFlowStatusSubdivisionReport.jsp?circle=<%=circlecode%>&division=<%=divisioncode%>&subdivision=<%=rs.getString(22)%>&AssetType=<%=AssetType%>&cmbYear=<%=year%>&cmbMonth=<%=month%>" ><%=rs.getString(1)%></a></td> 
