...
<table bgcolor="#DEE3E0" bordercolor= "#8A9FCD" rules="none" 
	...
	<div id="normal" style="position:relative;overflow-y:auto;left:0;height:126;top:0;display:none">
		<table bgcolor="#DEE3E0" bordercolor= "#8A9FCD" rules="none" border=1 style="border-collapse:collapse;width:908px" >
			<tr>
				...
				<td class="textborder" colspan="2"><html:text property="estCost" readonly="true"/><font color="red" face="verdana" size="2">Rs.</font></td>
			</tr>
			<tr>
				<td class="textborder" colspan="2" style="width:300px">GOI Share</td>
				<td class="textborder" colspan="2"><input type="text" name="goi1"><font color="red" face="verdana" size="2">Rs.</font></td>
			</tr>
			<tr>
				<td class="textborder" colspan="2" style="width:300px">State/Other Share</td>
				<td class="textborder" colspan="2"><input type="text" name="state1"><font color="red" face="verdana" size="2">Rs.</font></td>
			</tr>
			<tr>
				<td class="textborder" colspan="2" style="width:300px">Community Contribution Deposited(Cash+Kind+Labour)</td>
				<td class="textborder" colspan="2"><input type="text" name="comm1"><font color="red" face="verdana" size="2">Rs.</font></td>
			</tr>
		</table>
	</div>
	<div id="submission" style="position:relative;overflow-y:auto;left:0;height:350;top:0;display:none">
		<table bgcolor="#DEE3E0" bordercolor= "#8A9FCD" rules="none" border=1 style="border-collapse:collapse;" >
			...
			<tr>
				<td class="textborder" colspan="2" style="width:300px">GOI Share</td>
				<td class="textborder" colspan="2"><input type="text" name="goi2"><font color="red" face="verdana" size="2">Rs.</font></td>
			</tr>
			<tr>
				<td class="textborder" colspan="2" style="width:300px">State/Other Share</td>
				<td class="textborder" colspan="2"><input type="text" name="state2"><font color="red" face="verdana" size="2">Rs.</font></td>
			</tr>
			<tr>
				<td class="textborder" colspan="2" style="width:300px">Community Contribution Deposited(Cash+Kind+Labour)</td>
				<td class="textborder" colspan="2"><input type="text" name="comm2"><font color="red" face="verdana" size="2">Rs.</font></td>
			</tr>
		</table>
	</div>
	<div id="sustainability" style="position:relative;overflow-y:auto;left:0;height:126;top:0;display:none">
		<table bgcolor="#DEE3E0" bordercolor= "#8A9FCD" rules="none" border=1 style="border-collapse:collapse;width:908px" >
			...
			<tr>
				<td class="textborder" colspan="2" style="width:300px">GOI Share</td>
				<td class="textborder" colspan="2"><input type="text" name="goi3"><font color="red" face="verdana" size="2">Rs.</font></td>
			</tr>
			<tr>
				<td class="textborder" colspan="2" style="width:300px">State/Other Share</td>
				<td class="textborder" colspan="2"><input type="text" name="state3"><font color="red" face="verdana" size="2">Rs.</font></td>
			</tr>
			<tr>
				<td class="textborder" colspan="2" style="width:300px">Community Contribution Deposited(Cash+Kind+Labour)</td>
				<td class="textborder" colspan="2"><input type="text" name="comm3"><font color="red" face="verdana" size="2">Rs.</font></td>
			</tr>
		</table>
	</div>
	</td>
