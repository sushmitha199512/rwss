...
<body leftmargin="0" topmargin="0" bgcolor="#edf2f8" onload="funcInit()">

<html:form action="SaveHabitation" >
...
function funcInit()
{
	for(var i=0;i<<%=count%>;i++)
	{
		if(document.forms[0].selectedHabCode(i).checked==true)
		{
			...
			//document.getElementById("hab"+i).style.background="#e5ecf9";
			//#ccccff;#BCD2EE;#D9D9F3;#6699FF;#D0D0D0; #d9d9f3
		}
	}
