...
function fnsubmit()
{
	document.f1.action="/pred/worksMonitoring/ReleasesExpenditureReport.jsp";
	document.f1.submit();
}
...
<table cellpadding="0" cellspacing="0">
		  <tr>
			...
			<td background="/pred/resources/images/top_center_b.gif" width="210" class="heading" valign="middle" align="center" class id ="mainheading">Releases and Expenditure Report</td>
			<td><img src="/pred/resources/images/top_right_b.gif"></td>
		</tr>
		
	</table>
	
<table border=1 cellspacing=1 cellpadding=1 width="310" style="border-collapse:collapse" rules="none" bordercolor=navy >


<form name=f1 method="post" action="/pred/worksMonitoring/ReleasesandExpenditureMenu.jsp">
