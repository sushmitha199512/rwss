...
<html>			
	...
	{
		document.financialForm.action="/pred/worksMonitoring/GenFinancialProgressAction.do";
...
function getSubProgramme()
{
	...
	<link rel="stylesheet" type="text/css" href="/pred/resources/style/style.css">
		<link rel="stylesheet" type="text/css" href="/pred/resources/style/menu.css">
	</head>
...
<tr height="1%">
   ...
   <TR>
	...
	<tr>
		...
		<td><html:select property="cmbCircle" styleClass="comboFont" onchange="getDivisions()" style="width:130px">
			<%
	...
	%>
		...
		<td><html:select property="cmbCircle" styleClass="comboFont" style="width:130px">
			<html:option value="">Please Select...</html:option>
	...
	<tr>
		...
		<td class=label><font color="#000000" face=verdana size=2><B>:</td>
		<td><html:select property="cmbDivision" styleClass="comboFont" onchange="getSubDivisions()" style="width:130px">
				<%
	...
	%>
		...
		<td class=label><font color="#000000" face=verdana size=2><B><bean:message key="app.common.division" />
		<td class=label><font color="#000000" face=verdana size=2><B>:</td>
		<td><html:select property="cmbDivision" styleClass="comboFont" style="width:130px">
			<html:option value="">Please Select...</html:option>  
	...
	<tr>
		...
		<td class=label><font color="#000000" face=verdana size=2><B>:</td>
		<td><html:select property="cmbSubDivision" styleClass="comboFont" style="width:130px">
			<%
	...
	<tr>
		...
		<td class=label><font color="#000000" face=verdana size=2><B>:</td>
		<td><html:select property="cmbMonth" styleClass="comboFont" style="width:130px">
		    <html:option value="">Please Select...</html:option>
	...
	<tr>
		...
		<td class=label><font color="#000000" face=verdana size=2><B>:</td>
		<td><html:select property="cmbYear" styleClass="comboFont" style="width:130px">
			<html:option value="">Please Select...</html:option>
	...
	<tr>
		...
		<td class=label><font color="#000000" face=verdana size=2><B>:</td>
		<td><html:select property="cmbProgramme" styleClass="comboFont" style="width:130px" onchange="getSubProgramme()">
			<html:option value="">Please Select...</html:option>
		...
		<td class=label><font color="#000000" face=verdana size=2><B><bean:message key="app.common.programme" />
		<td class=label><font color="#000000" face=verdana size=2><B>:</td>
		<td><html:select property="cmbProgramme" styleClass="comboFont" style="width:130px">
			<html:option value="">Please Select...</html:option>
			</html:select>
		</td>
		</logic:notPresent>
	...
	<tr>
		...
		<td class=label><font color="#000000" face=verdana size=2><B>:</td>
		<td><html:select property="cmbSubprogramme" styleClass="comboFont" style="width:130px">
			<html:option value="">Please Select...</html:option>
