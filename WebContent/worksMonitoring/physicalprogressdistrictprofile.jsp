...
function fnsubmit()
{
	document.f1.action="/pred/worksMonitoring/physicalprogressdistrictprofilereport.jsp";
	document.f1.submit();
}
...
<TABLE CELLPADDING="0" CELLSPACING="0"   style="border-collapse:collapse"  bordercolor= "#8A9FCD">
   <TR>
	  ...
	  <tr><td >
	  <font color="#000000" face=verdana size=2><B><center>Physical Progress District Profile Report</center></B><font></td>
...
<form name=f1 method="post" action="/pred/worksMonitoring/physicalprogressdistrictprofile.jsp">
