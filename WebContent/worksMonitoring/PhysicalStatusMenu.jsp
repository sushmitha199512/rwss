...
function fnsubmit()
{
	document.f1.action="/pred/worksMonitoring/PhysicalStatusReport.jsp";
	document.f1.submit();
}
...
<br><br>
 <table cellpadding="0" cellspacing="0">
		<tr>
			...
			<td background="/pred/resources/images/top_center_b.gif" width="299" class="heading" valign="middle" align="center" class id ="mainheading">Physical Status Report</td>
			<td><img src="/pred/resources/images/top_right_b.gif"></td>
		</tr>
	</table> 
	
<table border=1 cellspacing=1 cellpadding=1 width=399 style="border-collapse:collapse" rules="none" bordercolor=navy >


<form name=f1 method="post" action="/pred/worksMonitoring/PhysicalStatusMenu.jsp">
...
%>
    ...
    <%
		...
		<tr>	
			...
			<td background="/pred/resources/images/bottom_center.gif" width="319" class="heading" valign="middle"	align="center"></td>
