...
<tr>
<td colspan=20 align=center class=label bgcolor=#A899FB>Physical Progress During Year Division Report</b></center></td>
</tr>
<tr>
<td class=label rowspan=3>S.No</b></td>
<td class=label rowspan=3>Name of the Division</b></td>
		   ...
		   %>
 		   ...
 		   <tr>     
			  <td class=label><%=sln%></td>
			   <td class=label><a href="PhysicalProgressDuringYearSubdivisionReport.jsp?circle=<%=circlecode%>&division=<%=divisioncode%>&subdivision=<%=rs.getString(14)%>&AssetType=<%=AssetType%>&cmbYear=<%=year%>&cmbMonth=<%=month%>" ><%=rs.getString(1)%></a></td>
