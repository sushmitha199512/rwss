	   ...
	   while(rs.next())
	   {
		   ...
		   %>
 		   ...
 		   <tr>     
			  ...
			  <td class=label><a href="ReleasesExpenditureDivisionReport.jsp?circle=<%=rs.getString(20)%>&division=<%=rs.getInt(21)%>&subdivision=<%=subdivisioncode%>&AssetType=<%=AssetType%>&cmbYear=<%=year%>&cmbMonth=<%=month%>" ><%=rs.getString(1)%></a></td> 
...
if (!circlecode.equals("00") && !AssetType.equals("") && !year.equals("") && divisioncode==0 && subdivisioncode.equals("0") && month.equals("0"))
	{
 query="select circle_office_name,sum(a.NO_NEW_WORKS_SANC_UPTO_MON  ) as NO_NEW_WORKS_SANC_UPTO_MON  ,sum(a.NO_NEW_WORKS_SANC_DUR_MON ) as NO_NEW_WORKS_SANC_DUR_MON ,sum(a.NO_AUG_WORKS_SANC_UPTO_MON  ) as NO_AUG_WORKS_SANC_UPTO_MON  ,sum(a.NO_AUG_WORKS_SANC_DUR_MON  ) as NO_AUG_WORKS_SANC_DUR_MON   ,sum(a.TOT_EXP_INLAKHS_DUR_MON ) as TOT_EXP_INLAKHS_DUR_MON ,sum(a.TOT_EXP_INLAKHS_UPTO_MON ) as TOT_EXP_INLAKHS_UPTO_MON ,sum(a.NO_OF_PC_HABS_TAR_UPTO_MON ) as NO_OF_PC_HABS_TAR_UPTO_MON ,sum(a.NO_OF_PC_HABS_TAR_DUR_MON ) as NO_OF_PC_HABS_TAR_DUR_MON ,sum(a.NO_OF_NSS_HABS_TAR_UPTO_MON ) as NO_OF_NSS_HABS_TAR_UPTO_MON ,sum(a.NO_OF_NSS_HABS_TAR_DUR_MON ) as NO_OF_NSS_HABS_TAR_DUR_MON ,sum(a.NO_OF_PC_HABS_COV_DUR_MON ) as NO_OF_PC_HABS_COV_DUR_MON ,sum(a.NO_OF_PC_HABS_COV_UPTO_MON ) as NO_OF_PC_HABS_COV_UPTO_MON ,sum(a.NO_OF_NSS_HABS_COV_DUR_MON ) as NO_OF_NSS_HABS_COV_DUR_MON ,sum(a.NO_OF_NSS_HABS_COV_UPTO_MON ) as NO_OF_NSS_HABS_COV_UPTO_MON ,sum(a.TOT_NO_WORKS_COMP_DUR_MON ) as TOT_NO_WORKS_COMP_DUR_MON ,sum(a.TOT_NO_WORKS_COMP_UPTO_MON ) as TOT_NO_WORKS_COMP_UPTO_MON ,sum(b.RELEASES_UPTO_THE_MONTH ) as RELEASES_UPTO_THE_MONTH ,sum(b.RELEASES_DUR_THE_MONTH ) as RELEASES_DUR_THE_MONTH from rws_circle_office_tbl co,rws_physical_progress_tbl a,rws_financial_progress_tbl b where co.circle_office_code=substr(a.office_code,2,2) and co.circle_office_code=substr(b.office_code,2,2) and a.office_code=b.office_code and substr(a.office_code,2,2)=? and a.year= ? and a.asset_type = ? group by circle_office_name, substr(a.office_code,4,1)";
...
if (!circlecode.equals("00") && !AssetType.equals("") && !year.equals("") && divisioncode!=0 && subdivisioncode.equals("0") && month.equals("0"))
	{
	System.out.println("circle code"+circlecode);
	query="select division_office_name,sum(a.NO_NEW_WORKS_SANC_UPTO_MON  ) as NO_NEW_WORKS_SANC_UPTO_MON  ,sum(a.NO_NEW_WORKS_SANC_DUR_MON ) as NO_NEW_WORKS_SANC_DUR_MON ,sum(a.NO_AUG_WORKS_SANC_UPTO_MON  ) as NO_AUG_WORKS_SANC_UPTO_MON  ,sum(a.NO_AUG_WORKS_SANC_DUR_MON  ) as NO_AUG_WORKS_SANC_DUR_MON   ,sum(a.TOT_EXP_INLAKHS_DUR_MON ) as TOT_EXP_INLAKHS_DUR_MON ,sum(a.TOT_EXP_INLAKHS_UPTO_MON ) as TOT_EXP_INLAKHS_UPTO_MON ,sum(a.NO_OF_PC_HABS_TAR_UPTO_MON ) as NO_OF_PC_HABS_TAR_UPTO_MON ,sum(a.NO_OF_PC_HABS_TAR_DUR_MON ) as NO_OF_PC_HABS_TAR_DUR_MON ,sum(a.NO_OF_NSS_HABS_TAR_UPTO_MON ) as NO_OF_NSS_HABS_TAR_UPTO_MON ,sum(a.NO_OF_NSS_HABS_TAR_DUR_MON ) as NO_OF_NSS_HABS_TAR_DUR_MON ,sum(a.NO_OF_PC_HABS_COV_DUR_MON ) as NO_OF_PC_HABS_COV_DUR_MON ,sum(a.NO_OF_PC_HABS_COV_UPTO_MON ) as NO_OF_PC_HABS_COV_UPTO_MON ,sum(a.NO_OF_NSS_HABS_COV_DUR_MON ) as NO_OF_NSS_HABS_COV_DUR_MON ,sum(a.NO_OF_NSS_HABS_COV_UPTO_MON ) as NO_OF_NSS_HABS_COV_UPTO_MON ,sum(a.TOT_NO_WORKS_COMP_DUR_MON ) as TOT_NO_WORKS_COMP_DUR_MON ,sum(a.TOT_NO_WORKS_COMP_UPTO_MON ) as TOT_NO_WORKS_COMP_UPTO_MON ,sum(b.RELEASES_UPTO_THE_MONTH ) as RELEASES_UPTO_THE_MONTH ,sum(b.RELEASES_DUR_THE_MONTH ) as RELEASES_DUR_THE_MONTH from rws_division_office_tbl co,rws_physical_progress_tbl a,rws_financial_progress_tbl b where co.circle_office_code = substr(a.office_code,2,2) and co.circle_office_code = substr(b.office_code,2,2) and co.division_office_code = substr(a.office_code,4,1) and co.division_office_code = substr(a.office_code,4,1) and a.office_code=b.office_code and substr(a.office_code,2,2)=? and a.year= ? and a.asset_type = ? group by division_office_name, substr(a.office_code,4,1)";
	pstmt=conn.prepareStatement(query);
	   pstmt.setString(1,circlecode);
	    pstmt.setString(2,year);
	    pstmt.setString(3,AssetType);
...
if (!circlecode.equals("00") && !AssetType.equals("") && !year.equals("") && divisioncode!=0 && subdivisioncode.equals("0") && !month.equals("0"))
	{
	System.out.println("circle code"+circlecode);
	query="select division_office_name,NO_NEW_WORKS_SANC_UPTO_MON  ,NO_NEW_WORKS_SANC_DUR_MON ,NO_AUG_WORKS_SANC_UPTO_MON  ,NO_AUG_WORKS_SANC_DUR_MON   ,TOT_EXP_INLAKHS_DUR_MON ,TOT_EXP_INLAKHS_UPTO_MON ,NO_OF_PC_HABS_TAR_UPTO_MON ,NO_OF_PC_HABS_TAR_DUR_MON ,NO_OF_NSS_HABS_TAR_UPTO_MON ,NO_OF_NSS_HABS_TAR_DUR_MON ,NO_OF_PC_HABS_COV_DUR_MON ,NO_OF_PC_HABS_COV_UPTO_MON ,NO_OF_NSS_HABS_COV_DUR_MON ,NO_OF_NSS_HABS_COV_UPTO_MON ,TOT_NO_WORKS_COMP_DUR_MON ,TOT_NO_WORKS_COMP_UPTO_MON ,RELEASES_UPTO_THE_MONTH ,RELEASES_DUR_THE_MONTH from rws_division_office_tbl co,rws_physical_progress_tbl a,rws_financial_progress_tbl b where co.circle_office_code = substr(a.office_code,2,2) and co.circle_office_code = substr(b.office_code,2,2) and co.division_office_code = substr(a.office_code,4,1) and co.division_office_code = substr(b.office_code,4,1) and a.office_code=b.office_code and substr(a.office_code,2,2)=? and substr(a.office_code,4,1)=? and a.year= ? and a.asset_type = ? and a.month=? ";
	pstmt=conn.prepareStatement(query);
	   pstmt.setString(1,circlecode);
	   pstmt.setInt(2,divisioncode);
...
if (!circlecode.equals("00") && !AssetType.equals("") && !year.equals("") && divisioncode==0 && subdivisioncode.equals("0") && !month.equals("0"))
	{
	System.out.println("circle code"+circlecode);
	query="select circle_office_name,NO_NEW_WORKS_SANC_UPTO_MON  ,NO_NEW_WORKS_SANC_DUR_MON ,NO_AUG_WORKS_SANC_UPTO_MON  ,NO_AUG_WORKS_SANC_DUR_MON   ,TOT_EXP_INLAKHS_DUR_MON ,TOT_EXP_INLAKHS_UPTO_MON ,NO_OF_PC_HABS_TAR_UPTO_MON ,NO_OF_PC_HABS_TAR_DUR_MON ,NO_OF_NSS_HABS_TAR_UPTO_MON ,NO_OF_NSS_HABS_TAR_DUR_MON ,NO_OF_PC_HABS_COV_DUR_MON ,NO_OF_PC_HABS_COV_UPTO_MON ,NO_OF_NSS_HABS_COV_DUR_MON ,NO_OF_NSS_HABS_COV_UPTO_MON ,TOT_NO_WORKS_COMP_DUR_MON ,TOT_NO_WORKS_COMP_UPTO_MON ,RELEASES_UPTO_THE_MONTH ,RELEASES_DUR_THE_MONTH from rws_circle_office_tbl co,rws_physical_progress_tbl a,rws_financial_progress_tbl b where co.circle_office_code = substr(a.office_code,2,2) and co.circle_office_code = substr(b.office_code,2,2) and a.office_code=b.office_code and substr(a.office_code,2,2)=? and a.year= ? and a.asset_type = ? and a.month=? ";
	pstmt=conn.prepareStatement(query);
	   pstmt.setString(1,circlecode);
...
if (!circlecode.equals("00") && !AssetType.equals("") && !year.equals("") && divisioncode!=0 && !subdivisioncode.equals("0") && !month.equals("0"))
	{
	System.out.println("circle code"+circlecode);
	query="select subdivision_office_name,NO_NEW_WORKS_SANC_UPTO_MON  ,NO_NEW_WORKS_SANC_DUR_MON ,NO_AUG_WORKS_SANC_UPTO_MON  ,NO_AUG_WORKS_SANC_DUR_MON   ,TOT_EXP_INLAKHS_DUR_MON ,TOT_EXP_INLAKHS_UPTO_MON ,NO_OF_PC_HABS_TAR_UPTO_MON ,NO_OF_PC_HABS_TAR_DUR_MON ,NO_OF_NSS_HABS_TAR_UPTO_MON ,NO_OF_NSS_HABS_TAR_DUR_MON ,NO_OF_PC_HABS_COV_DUR_MON ,NO_OF_PC_HABS_COV_UPTO_MON ,NO_OF_NSS_HABS_COV_DUR_MON ,NO_OF_NSS_HABS_COV_UPTO_MON ,TOT_NO_WORKS_COMP_DUR_MON ,TOT_NO_WORKS_COMP_UPTO_MON ,RELEASES_UPTO_THE_MONTH ,RELEASES_DUR_THE_MONTH from rws_subdivision_office_tbl co,rws_physical_progress_tbl a,rws_financial_progress_tbl b where co.circle_office_code = substr(a.office_code,2,2) and co.circle_office_code = substr(b.office_code,2,2) and co.division_office_code = substr(a.office_code,4,1) and co.division_office_code = substr(b.office_code,4,1) and co.subdivision_office_code = substr(a.office_code,5,2) and co.subdivision_office_code = substr(b.office_code,5,2) and a.office_code=b.office_code and substr(a.office_code,2,2)=? and substr(a.office_code,4,1)=? and substr(a.office_code,5,2)=? and a.year= ? and a.asset_type = ? and a.month=? ";
	pstmt=conn.prepareStatement(query);
	   pstmt.setString(1,circlecode);
	   pstmt.setInt(2,divisioncode);
	   pstmt.setString(3,subdivisioncode);
