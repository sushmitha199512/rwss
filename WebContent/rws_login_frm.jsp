...
<script type="text/javascript">
	...
	/* function preventBack() { window.history.forward();alert("calling"); }  
...
<tr><td align="center"><a target="_blank" href="https://pmmementos.gov.in/#/"><img src="images/1778-542-dekstop.jpg" width="600"
	...
	<!-- 25-03-2022																		<a href="./downloads/EOI_ISA_CORRIGENDUM.PDF" target=_new>
...
<!-- 25-03-2022 <a href="./downloads/notifications/ISA_EOI_Document PUBLISH-2.pdf" target=_new>
...
<!-- <tr><td colspan="2"  style="text-align: right !important;"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="switch.do?prefix=/admin&page=/forgotPassword.do&mode=forgot" class="style10" style="cursor:hand">Forgot password? </a></td></tr> -->
		...
		<input type="hidden" name="as_sfid" value="AAAAAAVVB8zI43tE-lZL6aP42wlMZkj4lj_Y5sLIQq5giRadWf3eSMWFlkyDF9wMdM-GuOX4wReqJyKll7jjrO1PVtrTYfqHegUFglOX-UlioDUEIgbkeCARdP-jL900EUnmbiE=" /><input type="hidden" name="as_fid" value="748c954e4f7b7f88c1955fda6b5feca20641334d" />
