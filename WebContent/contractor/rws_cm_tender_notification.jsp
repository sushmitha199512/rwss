...
function getData()
{
	document.forms[0].action="switch.do?prefix=/contractor&page=/TenderNotification.do&mode=data";
	...
	if(typeOfTender=="")
	 ...
	 if(typeOfTender=="Y"){
	  ...
	  var top = parseInt((screen.availHeight/2)-(height/2));
  	  var url = "switch.do?prefix=/contractor&page=/TenderNotification.do&mode=pickWorkId";
...
<html:form action="/TenderNotification.do"  >
...
<jsp:include page="/commons/TableHeader.jsp">
	...
	<TABLE bgcolor="#DEE3E0" width="780" border="1" cellpadding="1" rules="none" cellspacing="0" bordercolor= "#8A9FCD" style="border-collapse:collapse"> 
		...
		<TR>
			...
			<TD class="textborder" colspan="6" align="left"><html:text property="tenderIdNo"  maxlength="15"></html:text></TD>
		</TR>
		<TR>
		...
		<TR>
			<TD class="textborder" colspan="6" align=center>
				<html:submit property="mode" title="Save the Fields"  styleClass="btext" value="Save" onclick="return validateTenderNotificationForm(this)" />
