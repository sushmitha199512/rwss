...
%>
<script language="JavaScript" src="<rws:context page='/resources/javascript/rwsWQLabParamValidate.js'/>"></script>
<script language="JavaScript">
	function showForm(){
	 document.forms[0].action="switch.do?prefix=/wquality&page=/WaterLabTestingParameter.do&mode=parameters";
		...
		if(document.forms[0].forwarded.value=="YES"){
			if(document.forms[0].ftklab[0].checked==true){
				if(document.forms[0].forwardDate.value.length<10 && document.forms[0].ftkTestDate.value.length>8){
					...
					document.forms[0].action="switch.do?prefix=/wquality&page=/WaterLabTestingParameter.do&mode=forwardtolab&ftklab=lab&sourceTypeCode="+sourceTypeCode+"&sourceCode="+sourceCode+"&ftktestid="+ftktestid+"&mandalCode="+mcode+"&panchayatCode="+pcode+"&habCode="+hcode;
					document.forms[0].submit();
				}
			}
		} 
		...
		return false;
			...
			if(dt2>=dt1){
	              if(fnAdd1(document.forms[0].testCode.value)){
						document.forms[0].action="switch.do?prefix=/wquality&page=/WaterLabTestingParameter.do&mode=Save";
			 			document.forms[0].submit();
					}
		  	}
			else {
...
function ftkview(){
   ...
   { 
     ...
     return false;
       ...
       document.forms[0].action="switch.do?prefix=/wquality&page=/WaterLabTestingParameter.do&mode=view";
	  document.forms[0].submit();
	   }
}
function labview(){
    ...
    if(document.forms[0].forwardtolab.checked==false)
       {
         alert("Please select forwarded date");
          ...
          {
             document.forms[0].action="switch.do?prefix=/wquality&page=/WaterLabTestingParameter.do&mode=Update";
             document.forms[0].submit();
            }
	   }
...
if(document.forms[0].circleOfficeCode.value=="")
	...
	{
	document.forms[0].action="switch.do?prefix=/wquality&page=/WaterLabTestingParameter.do&mode=data&ftklab=ftk&mode1=formftk";
	document.forms[0].submit();
	}
...
if(document.forms[0].circleOfficeCode.value=="")
	...
	{
	document.forms[0].action="switch.do?prefix=/wquality&page=/WaterLabTestingParameter.do&mode=data&ftklab=lab&mode1=formlab";
	document.forms[0].submit();
 	}
...
{   
    document.forms[0].ftklab[0].checked="false";
	document.forms[0].ftklab[1].checked="false";
	document.forms[0].action="switch.do?prefix=/wquality&page=/WaterLabTestingParameter.do&mode=reset";
	document.forms[0].submit();
}
function funcReset()
{
	...
	else
	{
			...
			"District:"+document.forms[0].circleOfficeCode.options[document.forms[0].circleOfficeCode.selectedIndex].text
				...
				else
				{
				   ...
				   var url = "switch.do?prefix=/wquality&page=/rws_select_sources_param_frm.jsp?&habCode="+habCode+"&ftklab="+ftklab+"&printString="+printString;
				  var properties = "width="+width+",height="+height+",screenX="+left+",screenY="+top+",toolbar=no,"
								   + "status=no,menubar=no,location=no,directories=no,scrollbars=yes,copyhistory=no,"
								   + "resizable=yes,status=yes";
						newWindow = window.open(url, "_New", properties);
...
if(document.forms[0].panchayatCode.value != "")
{
	if(document.forms[0].habCode.value!="")
	{
		 var url = "switch.do?prefix=/wquality&page=/WaterLabTestingParameter.do&mode=viewftkSources&ftktested=yes&circleOfficeCode="+circleOfficeCode+"&mandalCode="+mandalCode+"&panchayatCode="+panchayatCode+"&habCode="+habCode+"&ftklab="+ftklab;
	     var properties = "width="+width+",height="+height+",screenX="+left+",screenY="+top+",toolbar=no,"
					   + "status=no,menubar=no,location=no,directories=no,scrollbars=yes,copyhistory=no,"
					   + "resizable=yes,status=yes";
			newWindow = window.open(url, "_New", properties);
...
else
{
	if(document.forms[0].mandalCode.value!="")
	{
		 var url = "switch.do?prefix=/wquality&page=/WaterLabTestingParameter.do&mode=viewftkSources&ftktested=yes&circleOfficeCode="+circleOfficeCode+"&mandalCode="+mandalCode+"&ftklab="+ftklab;
	     var properties = "width="+width+",height="+height+",screenX="+left+",screenY="+top+",toolbar=no,"
					   + "status=no,menubar=no,location=no,directories=no,scrollbars=yes,copyhistory=no,"
					   + "resizable=yes,status=yes";
			newWindow = window.open(url, "_New", properties);
...
var getcheck='<%= request.getParameter("mode") %>';
	...
	document.forms[0].action="switch.do?prefix=/wquality&page=/WaterLabTestingParameter.do&mode=data&ftklab=lab&getcheck="+getcheck;
	document.forms[0].submit();
...
function getSourceCodes()
{
	if(document.forms[0].mandalCode.value!="")
	{
		document.forms[0].action="switch.do?prefix=/wquality&page=/WaterLabTestingParameter.do&mode=data&ftklab=ftk";
		document.forms[0].submit();
	}
	else 
	{
...
<html:form action="/WaterLabTestingParameter.do" method="post">
<% 
	String csrfToken="";
...
<jsp:include page="/commons/TableHeader.jsp">
	<jsp:param name="TableName" value="Water Quality Lab Testing(9 Parameters)" />
...
<tr bgcolor="green"  >
				...
				<tr align="left" bgcolor="lightblue" >
					...
					<td  class="bwborder" >
						...
						<% if(count1-1==1 || count1-1==2 || count1-1==3 || count1-1==4 || count1-1==5 || count1-1==6 ){ %>
