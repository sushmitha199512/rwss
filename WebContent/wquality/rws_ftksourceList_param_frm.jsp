...
opener.document.forms[0].action="switch.do?prefix=/wquality&page=/WaterLabTestingParameter.do&mode=selectftkSource&ftklab=ftk&sourceTypeCode="+sourceTypeCode+"&sourceCode="+sourceCode;
...
opener.document.forms[0].action="switch.do?prefix=/wquality&page=/WaterLabTestingParameter.do&mode=selectftkSource&ftklab=lab&sourceTypeCode="+sourceTypeCode+"&sourceCode="+sourceCode+"&ftktestid="+ftktestid;
opener.document.forms[0].submit();
self.close();}
...
<html:form action="/WaterLabTestingParameter.do">
