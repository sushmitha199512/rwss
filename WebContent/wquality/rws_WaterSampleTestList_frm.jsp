...
{
	document.forms[0].action="switch.do?prefix=/wquality&page=/WaterLabTesting.do&mode=delete&testId="+ndx;
...
<tr >
	...
	<%if(userid!=null && userid.equals("1000WQ") || userid.equals("100000") || userid.equals("admin")){ %>
...
<%if(userid!=null && userid.equals("1000WQ")){ %>
