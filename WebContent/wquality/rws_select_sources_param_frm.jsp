...
function sourceSelected(index)
{
	...
	//alert("in :"+index);
if(document.forms[0].elements['ftklab'].value=="ftk"){
var sourceCode=document.forms[0].elements["SOURCESLIST["+index+"].sourceCode"].value;
//alert("scode:"+sourceCode);
var sourceTypeCode=document.forms[0].elements["SOURCESLIST["+index+"].sourceTypeCode"].value;
//alert("stypecode:"+sourceTypeCode);
opener.document.forms[0].action="switch.do?prefix=/wquality&page=/WaterLabTestingParameter.do&mode=selectSource&ftklab=ftk&sourceTypeCode="+sourceTypeCode+"&sourceCode="+sourceCode;
opener.document.forms[0].submit();
self.close();}
else if(document.forms[0].elements['ftklab'].value=="lab"){

	var sourceCode=document.forms[0].elements["SOURCESLIST["+index+"].sourceCode"].value;
	//alert("scode:"+sourceCode);
	var sourceTypeCode=document.forms[0].elements["SOURCESLIST["+index+"].sourceTypeCode"].value;//alert("stypecode"+sourceTypeCode);

opener.document.forms[0].action="switch.do?prefix=/wquality&page=/WaterLabTestingParameter.do&mode=selectSource&ftklab=lab&sourceTypeCode="+sourceTypeCode+"&sourceCode="+sourceCode;
//alert(" after open");
opener.document.forms[0].submit();
self.close();}
...
<td  class="bwborder" align=left nowrap>
<nested:write name="SOURCESLIST" property="elevation" /></td>
<td  class="bwborder" align=left nowrap>
<nested:write name="SOURCESLIST" property="waypoint" /></td>
