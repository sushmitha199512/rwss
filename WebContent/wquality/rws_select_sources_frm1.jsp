...
opener.document.forms[0].action="switch.do?prefix=/wquality&page=/WaterLabTesting.do&mode=selectSource&ftklab=ftk&sourceTypeCode="+sourceTypeCode+"&sourceCode="+sourceCode;
...
opener.document.forms[0].action="switch.do?prefix=/wquality&page=/WaterLabTesting.do&mode=selectSource&ftklab=lab&sourceTypeCode="+sourceTypeCode+"&sourceCode="+sourceCode;
//alert(" after open");
opener.document.forms[0].submit();
self.close();}
