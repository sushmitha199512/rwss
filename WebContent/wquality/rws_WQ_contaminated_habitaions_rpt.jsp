...
%>
<logic:iterate id="contaminatedHabsView" name="contaminatedHabsView">
<tr><td class="<%=style %>" style="text-align: left;" align="right"><%=count++ %></td>
<td class="<%=style %>" style="text-align: left;" align="right"><bean:write name="contaminatedHabsView" property="districtName" /></td>
<td class="<%=style %>" style="text-align: left;" align="right"><bean:write name="contaminatedHabsView" property="mandal" /></td>
 <td class="<%=style %>" style="text-align: left;" align="right"><bean:write name="contaminatedHabsView" property="panchayat" /></td>
<td class="<%=style %>" style="text-align: left;" align="right"><bean:write name="contaminatedHabsView" property="village" /></td>
<td class="<%=style %>" style="text-align: left;" align="right"><bean:write name="contaminatedHabsView" property="habName" /></td>
<td class="<%=style %>" style="text-align: left;" align="right"><bean:write name="contaminatedHabsView" property="habCode" /></td>
