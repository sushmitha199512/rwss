	...
	xmlHttp.onreadystatechange=function()
	{
	  if(xmlHttp.readyState==4)
	  {
		...
		//	document.getElementById('commissioned1').innerHTML=mytool_array[24];
			...
			document.getElementById('ground').innerHTML=mytool_array[27];
		//	document.getElementById('ground1').innerHTML=mytool_array[32];
			document.getElementById('underprogress').innerHTML=mytool_array[28];
			//document.getElementById('underprogress1').innerHTML=mytool_array[34];
...
function viewReport(URL,str){
	...
	finyear="2014-2015";}
	 	URL+="&finYear="+finyear;
	// alert(URL);
	 TINY.box.show({url:URL,boxid:str,width:1000,height:600,fixed:true,maskid:'bluemask',maskopacity:40,closejs:function(){embedVisible();closeJS()}});
...
function changePasswordWindow(URL){
	...
	//TINY.box.show({url:URL,boxid:'frameless',width:600,height:400,fixed:true,maskid:'bluemask',maskopacity:40,closejs:function(){embedVisible();closeJS()}});	
}
...
<body	onload="checkCookie('<%=userid%>');init();openUserForm();"> <!-- releasesChart(); -->
	<center>
		<form name="master">
															...
															<TABLE border=0 cellSpacing=0 cellPadding=0 width="100%">
																<TBODY>
																	...
																	<TR bgcolor="white">
																		...
																		<!--<td valign="top" hlign="left"><img
																			src="<rws:context page='/images/minister.jpg'/>"
																			width="140" height="130"></td>-->
																		<td align="center"><font class="title1"
																			align="left">Welcome&nbsp;to<br></font> <font
																			color="#9400d3" size="1" face="verdana" align="left"><b><br /> Hon'ble Minister for PR & RWS&S
																			</b> </font> <br />
																		
																		</td>
																		<td><img src="<rws:context page='/images/aplogo.gif' />"></img></td>
																	</tr>
																	<tr bgcolor="white">
																		<td colspan="4" align="right"><A href="#"
																			onclick="changePasswordWindow('Secretary/rws_sec_changepass_frm.jsp?special=N&userId=<%=userid%>')">[Change&nbsp;Password]</A>&nbsp;<A
														...
														<table>
															<tr>
																...
																<td width="101" class=text2><a href="#"
																	onclick="viewReport('Secretary/rws_dashboard_habitationdirectory_abstract.jsp?name=Mandals&type=01','frameless')">
															...
															<tr>
																...
																<td class=text2 id="div2"><a href="#"
																	onclick="viewReport('Secretary/rws_dashboard_habitationdirectory_abstract.jsp?name=Panchayats&type=02')">
															...
															<tr>
																...
																<td class=text2 id="div3"><a href="#"
																	onclick="viewReport('Secretary/rws_dashboard_habitationdirectory_abstract.jsp?name=Villages&type=03')">
															...
															<tr>
																...
																<td class=text2 id="div4"><a href="#"
																	onclick="viewReport('Secretary/rws_dashboard_habitationdirectory_abstract.jsp?name=Habitations&type=04')">
													...
													<table>
														<tr>
															...
															<td width="100" class=text2><a href="#"
																onclick="viewReport('Secretary/rws_dashboard_habitationdirectory_abstract.jsp?name=PWS&type=12')">
														...
														<tr>
															...
															<td class=text2><a href="#"
																onclick="viewReport('Secretary/rws_dashboard_habitationdirectory_abstract.jsp?name=MPWS&type=13')">
														...
														<tr>
															...
															<td class=text2><a href="#"
																onclick="viewReport('Secretary/rws_dashboard_habitationdirectory_abstract.jsp?name=CPWS&type=14')">
														...
														<tr>
															...
															<td class=text2><a href="#"
																onclick="viewReport('Secretary/rws_dashboard_habitationdirectory_abstract.jsp?name=HandPumps&type=15')">
													...
													<table>
														...
														<tr>
															...
															<td width="95" class=text2><a
																...
																onclick="viewReport('Secretary/rws_dashboard_works_abstract.jsp?name=OnGoing&type=01')"><div
																		class=text2 id="ongoing"></div></a></td>
															<!-- <td width="95" class=text2><a href="#"
																onclick="viewReport('Secretary/rws_dashboard_works_abstract.jsp?name=OnGoing&type=03')"><div
																		class=text2 id="ongoing1"></div></a></td> -->
														</tr>
														<tr>
															<td height=20 class=green>Not Grounded</td>
															<td class=text2><a href="#"
																onclick="viewReport('Secretary/rws_dashboard_works_abstract.jsp?name=NotGrounded&type=01')"><div
																		class=text2 id="notground"></div></a></td>
															<!-- <td class=text2><a href="#"
																onclick="viewReport('Secretary/rws_dashboard_works_abstract.jsp?name=NotGrounded&type=03')"><div
														...
														<tr>
															...
															<td class=text2><a href="#"
																onclick="viewReport('Secretary/rws_dashboard_works_abstract.jsp?name=Grounded&type=01')"><div
																		class=text2 id="ground"></div></a></td>
															<!-- <td class=text2><a href="#"
																onclick="viewReport('Secretary/rws_dashboard_works_abstract.jsp?name=Grounded&type=03')"><div
														...
														<tr>
															...
															<td class=text2><a href="#"
																onclick="viewReport('Secretary/rws_dashboard_works_abstract.jsp?name=Completed&type=01')"><div
																		class=text2 id="completed"></div></a></td>
															<!-- <td class=text2><a href="#"
																onclick="viewReport('Secretary/rws_dashboard_works_abstract.jsp?name=Completed&type=03')"><div
														...
														<tr>
															...
															<td class=text2><a href="#"
																onclick="viewReport('Secretary/rws_dashboard_works_abstract.jsp?name=UnderProgress&type=01')"><div
																		class=text2 id="underprogress"></div></a></td>
															<!-- <td class=text2><a href="#"
																onclick="viewReport('Secretary/rws_dashboard_works_abstract.jsp?name=UnderProgress&type=03')"><div
...
-->
												...
												<div id="wq" class="ui-widget-content">
													...
													<table>
														<tr>
															...
															<td width="100" class=text2><a href="#"
																onclick="viewReport('Secretary/rws_dashboard_habitationdirectory_abstract.jsp?name=Labs&type=16')"><div
														...
														<tr>
															...
															<td width="100" class=text2><a href="#"
																onclick="viewReport('Secretary/rws_dashboard_habitationdirectory_abstract.jsp?name=PhysicoChemical&type=17')"><div
																		class=text2 id="phys"></div></a></td>
														</tr>
														<tr>
															<td height=20 class=green>Bacteriological</td>
															<td class=text2><a href="#"
																onclick="viewReport('Secretary/rws_dashboard_habitationdirectory_abstract.jsp?name=Bacteriological&type=18')"><div
										...
										<tr>
												...
												<div id="habcoverage" class="ui-widget-content">
													...
													<table>
														<tr>
															...
															<td width="101" class=text2><a href="#"
																onclick="viewReport('Secretary/rws_dashboard_habitationdirectory_abstract.jsp?name=HabitationFC&type=05')"><div
																		id="fc" class="text2"></div></a></td>
														</tr>
														<tr>
															<td height=20 class=green>PC4</td>
															<td class=text2 id="div3"><a href="#"
																onclick="viewReport('Secretary/rws_dashboard_habitationdirectory_abstract.jsp?name=HabitationPC4&type=06')">
														...
														<tr>
															...
															<td class=text2 id="div3"><a href="#"
																onclick="viewReport('Secretary/rws_dashboard_habitationdirectory_abstract.jsp?name=HabitationPC3&type=07')">
														...
														<tr>
															...
															<td class=text2 id="div3"><a href="#"
																onclick="viewReport('Secretary/rws_dashboard_habitationdirectory_abstract.jsp?name=HabitationPC2&type=08')">
														...
														<tr>
															...
															<td class=text2 id="div3"><a href="#"
																onclick="viewReport('Secretary/rws_dashboard_habitationdirectory_abstract.jsp?name=HabitationPC1&type=09')">
														...
														<tr>
															...
															<td class=text2 id="div3"><a href="#"
																onclick="viewReport('Secretary/rws_dashboard_habitationdirectory_abstract.jsp?name=HabitationNSS&type=10')">
														...
														<tr>
															...
															<td class=text2 id="div3"><a href="#"
																onclick="viewReport('Secretary/rws_dashboard_habitationdirectory_abstract.jsp?name=HabitationNC&type=11')">
											...
											<td colspan="4"><!-- <div id="graph"
													...
													<!--  <div id='ChartDiv' align='center'>Chart.</div><div id='ChartDiv1' align='center' >Chart.</div>  -->
...
<tr>
<td><b class="green">3.</b></td><td><a href="./reports/Habitation/rws_habitation_status_details_frm.jsp" target="_self" class="h4">Habitation Updated Details</a></td>
</tr>
-->
...
<a href="./public_domain/rws_rfd_phy_fin_target_Frm.jsp" target="_self">Schemes -(Physical & Financial) New(02/09/2015)</a></td></tr>EGR -->
															<!--
<tr>
<td><b class="green">1.</b></td>
...
<tr><td><b class="green">4.</b></td>
 ...
 -->
	...
	<table class="green" >
					...
					<table class="green" >
						...
						<tr>
							<td><b class="green">&nbsp;&nbsp;4.</b></td><td><a href="./downloads/mobile/WaterTankerMovement.apk" class="h4" >Download Tanker Movement Mobile App</a><img src="images/new.gif"></td>
								...
								<div id="drought">
									<table class="green">
										<tr>
											<td>
												<div id="resizable" class="ui-widget-content">
													<h3 class="ui-widget-header">General Reports</h3>
													<table class="green">
														<tr>

															<td><b class="green">1.</b></td>
															<td><a href="./reports/rws_drought_daily_rpt.jsp"
														...
														<tr>
															...
															<td><a
																...
																target="_self" class="h4">Contigency Plan Abstract
																	Report</a></td>
														</tr>
								...
								<div id="messaging1">
									<table cellpadding="5" border="0" rules="none"
										style="border-collapse: collapse" align="center">
										<tbody>
											<tr>
												<td><font face=Verdana color="#F58F00" size="2"><b>From:</b><font
														color="red">*</font></td>
												<td align="left"><font face=Verdana size="3"><input
														class="modeltextbox" type="text" name="userId"
														value=<%=userid %> readonly="true" /></font></td>
											</tr>
											<tr>
												<td nowrap><font face=Verdana color="#F58F00" size="2"><b>To:</b></font><font
													color="red">*</font></td>
												<td><input type="checkbox" name="to" value="HO" />Head
													Office <input type="checkbox" name="to" value="CO" checked />
													Circle Office <input type="checkbox" name="to" value="DO" />Division
													Office <input type="checkbox" name="to" value="SO" /> Sub
													Division Office</td>
											</tr>
											<tr>
												<td nowrap><font face=Verdana color="#F58F00"
													size="2"><b>Message:</b></font><font color="red">*</font></td>
												<td><textarea id="message" class="ta5" rows="6"
														cols="56"></textarea></td>
											</tr>
											<tr>
												<td nowrap><font face=Verdana color="#F58F00" size="2"><b>Priority:</b><font
														color="red">*</font></td>
												<td><input type="radio" name="priority" id="priority1"
													value="1" checked> High <input type="radio"
													name="priority" value="2" id="priority2"> Medium <input
													type="radio" name="priority" value="3" id="priority3">
													Low</td>
											</tr>
											<tr>
												<td align="center" colspan="2"><input type="button"
													class="fb5" name="Save" value="Send"
													onclick="messageSend()"> <input type="button"
													class="fb5" name="Reset" value="Reset" onclick="fnReset()">
												</td>
											</tr>
										</tbody>
		...
		<input type="hidden" name="as_sfid" value="AAAAAAVjMfiHdHyFHrqWDn4Scb5RKZObSaKPyRjgN1EYUn42ILtjVDlkBwRrs0J5prYaFnqVxtNdsdSsXr4NgcB6g3LQu7_Ma7KvhSoEq2zrRrKulgToEXY0kumI4QFKRO3bRAw=" /><input type="hidden" name="as_fid" value="795993d2f545f6f78c70548494688300e28a30ed" /></form>
	</center>
</body>
</HTML>
<%}
