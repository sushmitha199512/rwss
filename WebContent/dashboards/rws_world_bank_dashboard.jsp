...
<body   onload="checkCookie('<%=userid %>');init();creategraph();" >
<center>
<form name="master">
...
<!-- 
<tr>
       <td height=20 colspan="2" class="h4"><span class="text2"><a href="switch.do?prefix=/works&page=/WorkLink.do&mode=data"  class="h4" onClick="fnCall('22')">Work Link(Old/New)</a></span></td>
</tr>
 -->
