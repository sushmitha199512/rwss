...
if (finYear != null) {
	...
	if (fyears[0].equals(String.valueOf(cyear))) {
		...
		if (name!=null && name.equals("Mandals") && type.equals("01")) {
			...
			query = "select  d.dname,count(*),d.dcode from rws_district_tbl d,rws_complete_hab_view h,"+habtable+" ch  where  ch.hab_code=h.panch_code and  d.dcode=h.dcode and ch.COVERAGE_STATUS='FC' group by d.dname,d.dcode order by d.dname";
		} else if (name.equals("HabitationPC4") && type.equals("06")) {
			query = "select  d.dname,count(*),d.dcode from rws_district_tbl d,rws_complete_hab_view h ,"+habtable+" ch  where  ch.hab_code=h.panch_code and  d.dcode=h.dcode and ch.COVERAGE_STATUS='PC4' group by d.dname,d.dcode order by d.dname";
		} else if (name.equals("HabitationPC3") && type.equals("07")) {
			query = "select  d.dname,count(*),d.dcode from rws_district_tbl d,rws_complete_hab_view h ,"+habtable+" ch  where  ch.hab_code=h.panch_code and  d.dcode=h.dcode and ch.COVERAGE_STATUS='PC3' group by d.dname,d.dcode order by d.dname";
		} else if (name.equals("HabitationPC2") && type.equals("08")) {
			query = "select  d.dname,count(*),d.dcode from rws_district_tbl d,rws_complete_hab_view h ,"+habtable+" ch  where  ch.hab_code=h.panch_code and  d.dcode=h.dcode and ch.COVERAGE_STATUS='PC2' group by d.dname,d.dcode order by d.dname";
		} else if (name.equals("HabitationPC1") && type.equals("09")) {
			query = "select  d.dname,count(*),d.dcode from rws_district_tbl d,rws_complete_hab_view h ,"+habtable+" ch  where  ch.hab_code=h.panch_code and  d.dcode=h.dcode and ch.COVERAGE_STATUS='PC1' group by d.dname,d.dcode order by d.dname";
		} else if (name.equals("HabitationNSS") && type.equals("10")) {
			query = "select  d.dname,count(*),d.dcode from rws_district_tbl d,rws_complete_hab_view h ,"+habtable+" ch  where  ch.hab_code=h.panch_code and  d.dcode=h.dcode and ch.COVERAGE_STATUS='NSS' group by d.dname,d.dcode order by d.dname";
		} else if (name.equals("HabitationNC") && type.equals("11")) {
			query = "select  d.dname,count(*),d.dcode from rws_district_tbl d,rws_complete_hab_view h ,"+habtable+" ch  where  ch.hab_code=h.panch_code and  d.dcode=h.dcode and ch.COVERAGE_STATUS='NC' group by d.dname,d.dcode order by d.dname";
...
<% }%>
	...
	<%try
      ...
      phyqry="select dname,count(*),dcode from RWS_WQ_TEST_RESULTS_TBL r,rws_district_tbl,rws_water_quality_lab_tbl w   where  w.LAB_CODE=r.LAB_CODE and substr(r.source_code,1,2)=dcode  and test_code='1' and to_date(r.PREPARED_ON ,'dd/mm/yy')>='01/APR/"+ fyears[0]+"' and to_date(r.PREPARED_ON,'dd/mm/yy')<'01/APR/"+ fyears[1]+"' group by dname,dcode order by dname";
       ...
       int pwscount=0,mpwscount=0,cpwscount=0,handpumpscount=0,labscount=0,phycount=0,bactcount=0;
       ...
       while(rs1.next())
       {
		...
		%>
              ...
              <% if ((name.equals("Mandals") && type.equals("01"))|| (name.equals("Panchayats") && type.equals("02"))||(name.equals("Villages") && type.equals("03"))|| (name.equals("Habitations") && type.equals("04")) ||(name.equals("HabitationFC") && type.equals("05"))||(name.equals("HabitationPC4") && type.equals("06"))||(name.equals("HabitationPC3") && type.equals("07"))||(name.equals("HabitationPC2") && type.equals("08"))||(name.equals("HabitationPC1") && type.equals("09"))||(name.equals("HabitationNSS") && type.equals("10"))||(name.equals("HabitationNC") && type.equals("11"))|| (name.equals("PWS") && type.equals("12"))||(name.equals("MPWS") && type.equals("13"))||(name.equals("CPWS") && type.equals("14"))||(name.equals("HandPumps") && type.equals("15"))){ %>
				...
				<td class=<%=style %> style="text-align: left;"><a href="rws_dashboard_habitationdirectory_div_abstract.jsp?dcode=<%=rs1.getString(3) %>&dname=<%=rs1.getString(1) %>" ><%=rs1.getString(1)%></a></td>    
