...
<body
	onload="checkCookie('<%=userid%>');init();openUserForm();">
	<center>
		<form name="master">
															...
															<TABLE border=0 cellSpacing=0 cellPadding=0 width="100%">
																<TBODY>
																	...
																	<TR bgcolor="white">
																		...
																		<td width="580px;" valign="top" align="center" height="100px;"
																			bordercolor="#FFFFFF">
																			<%-- <img  height="100px;"
																			src="<rws:context page='/img/logos/water1.png' />"></img> --%>
																			<!-- <embed src="imagess/rural.swf"  width="550px"
																				height="130px" id="banner" ></embed > --></td>

																		<%--<td align="left"> <img
																			src="<rws:context page='/images/JAWAHAR.jpg' />"
																			width="150" height="130"> </td>--%>
																		<td align="center"><font class="title1"
																			align="left">Welcome&nbsp;to<br></font> <font
																			color="#9400d3" size="1" face="verdana" align="left">
																					Principal&nbsp;Secretary,&nbsp;RWS&S
																			</b> </font> <br />
														...
														<table>
															<tr>
																...
																<td width="101" class=text2><a href="#"
																	onclick="viewReport('Secretary/rws_dashboard_habitationdirectory_abstract.jsp?name=Mandals&type=01')">
