...
<tr>
 ...
 -->
																					<tr>
																						<!--  <td height=20 colspan="2" class="h4"><span class="text2"><a href="switch.do?prefix=/fundAccounting&page=/BANKBillAction.do&mode=data&mode1=clear"  class="h4" ><b class="green">&nbsp;&nbsp;1.</b>Bank - Bill Selection</a></span></td> -->
																						<!-- href="switch.do?prefix=/fundAccounting&page=/otp.do&mode=data" -->
																						<td height=20 colspan="2" class="h4"><span
																							class="text2"><a
																							href="switch.do?prefix=/fundAccounting&page=/BANKBillAction.do?mode=data"
																								class="h4"><b class="green">&nbsp;&nbsp;1.</b>Bank
																									- Bill Selection</a></span></td>
																					</tr>
																					...
																					<tr>
																						<td height=20 colspan="2" class="h4"><span
																							class="text2"><a
																								href="switch.do?prefix=/fundAccounting&page=/PAOBillAction.do&mode=data&mode1=clear"
																								class="h4"><b class="green">&nbsp;&nbsp;2.</b>PAO
																									- Bill Selection</a></span></td>
																					</tr>
...
<tr>
 ...
 -->
																					...
																					<tr>
																						<td height=20 colspan="2" class="h4"><span
																							class="text2"><a
																								href="switch.do?prefix=/works&page=/WorkReleases.do&mode=data&mode1=clear"
																								class="h4"><b class="green">&nbsp;&nbsp;3.</b>Refunds</a></span></td>
																					</tr>
																					...
																					<tr>
																						...
																						<td height=20 colspan="2" class="h4"><span
																							class="text2"><a
																								href="switch.do?prefix=/works&page=/SpillWorkReleases.do&mode=data&mode1=clear"
																								class="h4"><b class="green">&nbsp;&nbsp;4.</b>Spill
																									Refunds</a></span></td>
																					...
																					<tr>
																						...
																						<td height=20 colspan="2" class="h4"><span
																							class="text2"><a
																								href="switch.do?prefix=/works&page=/SpillWorkAdmChange.do&mode=data&mode1=clear"
																								class="h4"><b class="green">&nbsp;&nbsp;5.</b>Bill
																									Amount Admissible To Be Changed With Bill
																									Amount Contractor</a></span></td>
...
-->
																					<tr>
																						...
																						<td height=20 colspan="2" class="h4"><span
																							class="text2"><a
																								href="<rws:context page='/downloads/rws_files_browse.jsp' />"
																								class="h4"><b class="green">&nbsp;&nbsp;5.</b>BANK
																									Check Files</a></span></td>
																					</tr>
																		...
																		<div>
																			<table class="green">
																				...
																				<tr>
																					<td><b class="green">&nbsp;&nbsp;6.</b></td>
																					<td><a
																						href="./reports/rws_Exp_Rel_Pro_groupsec_frm.jsp"
																						class="h4">ProgrammeWise(NRDWP) Rel VS Exp</a></td>
																				</tr>
