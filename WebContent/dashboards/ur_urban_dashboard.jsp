...
<td width="57" valign="bottom"><A href="#" onclick="changePasswordWindow('dashboards/rws_grievance_dashboard_changepass_frm.jsp?special=N&userId=<%=userid %>')">[Change&nbsp;Password]</A></td>
														...
														<tr>
															<td>
																<div id="resizable6" class="ui-widget-content">
																	<h3 class="ui-widget-header">Urban Master</h3>
																	...
																	<table class="green">
																		...
																		<!-- <tr>
																			...
																			<td><a
																				href="switch.do?prefix=/masters&page=/UrHead.do&mode=data"
																				class="h4" target="_self"><b class="green">&nbsp;&nbsp;</b>Head
																					Office</a></td>
																		</tr> -->
																		<tr>
																			<td><b class="green">1.</b></td>
																			<td><a
																				href="switch.do?prefix=/masters&page=/UrCircle.do&mode=data"
																				class="h4" target="_self"><b class="green">&nbsp;&nbsp;</b>Regional Office</a></td>
																		</tr>
																		<tr>
																			<td><b class="green">2.</b></td>
																			<td><a
																				href="switch.do?prefix=/masters&page=/UrDivision.do&mode=data"
																				class="h4" target="_self"><b class="green">&nbsp;&nbsp;</b>Circle / Division
																					Office</a></td>
																		</tr>
																		<tr>
																			<td><b class="green">3.</b></td>
																			<td><a
																				href="switch.do?prefix=/masters&page=/UrSubDivision.do&mode=data"
																				class="h4" target="_self"><b class="green">&nbsp;&nbsp;</b>Subdivision
																					Office</a></td>
																		</tr>
<tr>
																			<td><b class="green">4.</b></td>
																			<td><a
																				href="switch.do?prefix=/masters&page=/MuncipalSubdivision.do?mode=data"
																				class="h4" target="_self"><b class="green">&nbsp;&nbsp;</b>Muncipality SubDivision
																					Office</a></td>
																		</tr>
																			<tr>
																			<td><b class="green">5.</b></td>
																			<td  class="h4"><span class="text2"><a href="switch.do?prefix=/complaints&page=/employeeEntryNew.do&mode=get"  class="h4" target="_self"><b class="green">&nbsp;&nbsp;</b>Employee Mobile Entry</a></span></td>
																		</tr>
		...
		<tr>
			<td>
				<div id="resizable5" class="ui-widget-content">
				    ...
				    <table>	
						<tr>
						    <td height=20 colspan="2" class="green"><span class="text2">
						    	<a href="switch.do?prefix=/complaints&page=/GenericActionTaken_Urban.do&mode=get2"  class="h4" >
						    		<b class="green">1.</b>Generic Action To Be Taken Form
						    	</a></span>
						    </td>
						</tr>	
						<!-- <tr>
							<td height=20 colspan="2" class="green"><span class="text2">
								<a href="switch.do?prefix=/complaints&page=/Complaintsgeneric.do&mode=get2&special=reset" class="h4"><b class="green">2.</b>
									Grievnace Entry Form
								</a></span><img src="images/new.gif"></td>
						</tr> -->
					</table></p>	
				<!--  </marquee> -->
				</div>
			...
			<td>
				<div id="resizable15" class="ui-widget-content">
					...
					<div>
						<table>
							<tr><td class="green"> 1.<a href="/pred/reports/complaints/rws_Generic_Complaints_rpt.jsp" class="h4" >Generic ActionTaken Report</a><img src="images/new.gif"></td></tr>
