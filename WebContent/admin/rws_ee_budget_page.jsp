...
function fnChangePassword()
{
   ...
   var url="../admin/rws_gen_admn_changepass_frm.jsp?special=N&userId="+userId;
...
function submitFn()
	{
//alert(document.forms[0].slt.value);
var rSaltValue='<%=ranDomString %>';
	  document.forms[0].slt.value='<%=ranDomString %>';
		...
		newWindow = window.open("rws_EE_LoginValidate.jsp?userId="+document.forms[0].userId.value+"&password="+document.forms[0].password.value+"&slt="+document.forms[0].slt.value, "_New", properties);
		newWindow.focus();
