...
function submitFn()
  {
		...
		var left = parseInt((screen.availWidth/2)-(width/2));
		var top = parseInt((screen.availHeight/2)-(height/2));
		//alert("rws_HO_LoginValidate.jsp?userId="+document.forms[0].userId.value+"&password="+document.forms[0].password.value+"&slt="+document.forms[0].slt.value+"&captcha="+document.forms[0].number.value);
		var properties = "width="+width+",height="+height+",screenX="+left+",screenY="+top+",toolbar=no,"
						   + "status=no,menubar=no,location=no,directories=no,scrollbars=yes,copyhistory=no,"
						   + "resizable=yes,status=yes,left=10,top=10";
		newWindow = window.open("rws_HO_LoginValidate.jsp?userId="+document.forms[0].userId.value+"&password="+document.forms[0].password.value+"&slt="+document.forms[0].slt.value+"&captcha="+document.forms[0].number.value, "_New", properties);
		newWindow.focus();
...
var validPassword = strongRegex.test(document.forms[0].password1.value);//alert(validPassword);
//encryptPassword();
//submitFn();
...
<body bgcolor="#edf2f8" onload="fnInit();userCheck();">

<form method="post" focus="userId" autocomplete="off">
        ...
        <TBODY>
         <TR>
          <TD width="100%" height=26 bgcolor="#99CC00"><B><FONT face=Verdana 
                        ...
                        color="#000000" size=2><b>RWS HO Special Login </b></FONT></TD>
        </TR>
        <TR>
          <TD width="100%" height=19><DIV align=center>
              <CENTER>
                <TABLE id=AutoNumber14 style="BORDER-COLLAPSE: collapse" borderColor=#111111 height=69 cellSpacing=0 
                        cellPadding=0 width="96%" border=0>
                  <TBODY>
                    <TR>
                      <TD width="32%" bgColor=#ffffff height=32><FONT face=Verdana color=#000000 size=1><B>&nbsp;User Id</B></FONT></TD>
                      <TD width="68%" bgColor=#ffffff height=32><P align=center>
                          <input type="text" name="userId" value="" styleClass="thin-text-box" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off"/>
                    ...
                    <TR>
                      ...
                      <TD width="68%" bgColor=#ffffff height=32><P align=center>
                          ...
                          <input type="password" name="password1" value="" styleClass="thin-text-box" autocomplete="off"/>
                          
                          
                          <%-- <td>
                          <html:hidden property="slt"/>
                          <html:hidden property="password"/>
                          <html:password property="password" styleClass="thin-text-box" maxlength="12"/>
                          </td> --%>
                    ...
                    <TR align=center>
                      <TD width="100%" bgColor=#ffffff colSpan=2><BR>
                            ...
                            <input name="reset2" type="button" style="BORDER-RIGHT: #ffa87d 2px inset; BORDER-TOP: #ffa87d 2px inset; BORDER-LEFT: #ffa87d 2px inset; COLOR: #000080; BORDER-BOTTOM: #ffa87d 2px inset; BACKGROUND-COLOR: #ffe9d2" value="Reset" styleClass="btext"  onclick="location.reload();"/>
