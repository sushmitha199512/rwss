																						...
																						<td valign="top"><!-- <table width="100%"
																							...
																							<div id="tabs">
																								...
																								<ul>
																									...
																									<li><a href="#gos">Media Gallery</a></li>
																									
																								</ul>
																								<div id="gos">
																									<table>
																										<!--<tr>
																											<td>1.<a href="./ntrsujala.jsp">
																												NTR Sujala Patakam</a></td>
																										</tr>-->
																										<tr>
																											<td>1.<a href="./solarphotos.jsp">Solar Photos</a></td>
																										</tr>
																										<tr>
																											<td>2.<a href="./nscs.jsp">National Sanitation Campign</a></td>
																										</tr>
																										<tr>
																											<td>3.<a href="./cpwss.jsp">Community Water Public System Schemes</a></td>
																										</tr>
