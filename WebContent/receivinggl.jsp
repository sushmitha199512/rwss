    ...
    <body>
        <form name="f1">
            <%
                ...
                String query="";
                int smsid=0;
                String keyword="",GLValue="",LocationOG="";
                String type="G";
          ...
          String maxvalueQuery="select max(MESG_ID) from RWS_OHSR_GLSR_SMS_TBL  ";
                ...
                out.println("**TESTING***"+ps);
                    ...
                    while(rs1.next())
                    {
                     String resultAlert="GLSR Not Cleaned in "+rs1.getString(4)+"    ";
                    for (String mobileNumbers : alertNumbers) {
                        ...
                        if(Result.equals("Deliverd"))
 		               {
 	                       ...
 	                       String inoutqry="insert into RWS_SMS_IN_OUT_STATUS_TBL (MOBILE,SMS_DATE,SMS_TYPE,SMS_MODULE_AREA,SMS_DESC,habitation_code) values(?,SYSDATE,'PUSH','GL',?,?)";
 	                       System.out.println("inoutqry"+inoutqry);
 	                      PreparedStatement ps3=con.prepareStatement(inoutqry);
 	                      ps3.setString(1,mobileNumbers);
 	             		  ps3.setString(2,  resultAlert);
 	             		  ps3.setString(3,rs1.getString(5));
 	             		  ps3.executeUpdate();
