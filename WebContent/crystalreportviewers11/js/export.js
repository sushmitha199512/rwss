...
function getExportDialog() {
	...
	if (!print) {
		...
		"    <tr>" +
		"      <td width='35%'><span class='crexportmessage'><label for='exportformatlist'>File Format:</label></span></td>" + 
		...
		"  <TR><TD align='left'><table width='100%' border='0'>" +
		"    <tr>" +
		"      <td width='35%'><span class='crexportmessage'>Page Range:</span></td>" + 
		"      <td width='65%' align='left'><input type='radio' id='radio1' name='isRange' value='all' onclick='return toggleRangeFields(this);'/><span class='crexportmessage'><label for='radio1'>All</label></span></td>" + 
		"    </tr>" +
		"    <tr>" + 
		"      <td rowspan='2'></td>" + 
		"      <td align='left'><input type='radio' id='radio2' checked name='isRange' value='selection' onclick='return toggleRangeFields(this);'/><span class='crexportmessage'><label for='radio2'>Pages:</label></span></td>" +
		"    </tr>" +
		"    <tr>" +
		"      <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class='crexportmessage'><label for='from'>From:</label></span>&nbsp;&nbsp;<input class='crexporttextbox' type='text' width='20' size='6' maxlength='6' name='from' value='1'>&nbsp;&nbsp;<span class='crexportmessage'><label for='to'>To:</label></span>&nbsp;&nbsp;<input class='crexporttextbox' type='text' width='20' size='6' maxlength='6' name='to' value='1'></td>" +
		"    </tr>" +
		"  </table></TD></TR>" +
		"  <TR><TD><hr class='crexportruler'></TD></TR>";
	...
	if (print) {
		...
		exportDialog +=
		"  <TR valign='top'><TD align='right'><input class='crexportbutton' id='submitexport' type='button' value='OK' onclick='checkValuesAndSubmit();'/>&nbsp;&nbsp;<input class='crexportbutton' type='button' value='Cancel' onclick='window.close();'/></TD></TR>" +
		"</TABLE>" +
		"</FORM>" +
		"</BODY>" +
		"</HTML>";
