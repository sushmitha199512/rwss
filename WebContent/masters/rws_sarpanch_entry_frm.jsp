...
function fnSave()
{
	...
	document.forms[0].action="/pred/masters/sarpanch.do?mode=save";
	document.forms[0].submit();
...
<td>
	<jsp:include page="/commons/TableHeader.jsp">
		<jsp:param name="TableName" value="Sarpanch Entry Form" />
...
<td>
		...
		<tr>
			<td class="textborder">Sarpanch Name
				<span class="mandatory">*</span>
			</td>
			<td>
	...
	<tr>
			<td class="textborder">Sarpanch Mobile No
				<span class="mandatory">*</span>
			</td>
			<td>
		...
		<tr>
			<td class="textborder">Sarpanch Email Id
				<span class="mandatory"></span>
			</td>
			<td>
					<html:text property="sarpanchEmailId" style="width:140px" readonly="false"  />
		...
		<td  class=textborder >
		<html:text property="frmDate" value="" styleClass="mytext" size="10" />
		...
		<html:text property="toDate" value="" styleClass="mytext" size="10" />
