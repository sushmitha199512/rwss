...
<body onload="autocompletion()">
	<html:form action="Desgn.do?mode=edit" onsubmit="return winView()">
		...
		<table bgcolor="#DEE3E0" bordercolor="#8A9FCD" rules="cols" border="1"
					...
					<table border=0 width="300" align=center
						...
						<tr>
							<td class=mycborder><FONT class=myfontclr><bean:message
										key="app.desgnCode" /><font color="#FF6666">*</font></FONT></td>
							<td class=mycborder><html:text property="desgnCode"
									styleClass="mytext" maxlength="2" readonly="true" /></td>
						</tr>
						<tr>
							<td class=mycborder><FONT class=myfontclr><bean:message
										key="app.desgnAcr" /><font color="#FF6666">*</font></FONT></td>
							<td class=mycborder><html:text property="desgnAcr"
									styleClass="mytext" maxlength="10"
									onkeypress="return textOnly(event);" /></td>
						</tr>

						<tr>
							<td class=mycborder><FONT class=myfontclr><bean:message
										key="app.desgnName" /><font color="#FF6666">*</font></FONT></td>
							<td class=mycborder><html:text property="desgnName"
									styleClass="mytext" maxlength="30"
									onkeypress="return textOnly(event);" /></td>
						</tr>
						<tr>
							<td class=mycborder><FONT class=myfontclr><bean:message
										key="app.desgnType" /><font color="#FF6666">*</FONT></FONT></td>
							<td class=mycborder><html:select property="desgnType"
									style="width:130px" styleClass="mycombo">
			...
			<tr>
				<td colspan="2" align="center"><html:submit property="mode"
						title="Save the Fields" styleClass="btext" value="Update"
						onclick="return validateDesgnForm(desgnForm)" /> <html:reset
