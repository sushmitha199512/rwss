...
<table width=500>
<tr><td align=right><html:link page="/UrDivision.do?mode=data">Back&nbsp;|&nbsp;</html:link>
...
<td  class=mycborder1 align=center>
<a href="./UrDivision.do?doc=<bean:write name='divisionlist' property='doc' />&coc=<bean:write name='divisionlist' property='coc' />&hoc=<bean:write name='divisionlist' property='hoc' />&mode=get"><font color="#6600CC">Edit&nbsp;&nbsp;|</font></a>&nbsp;&nbsp;
