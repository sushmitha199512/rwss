...
function fnchkdelete()
{
	...
	{
		document.forms[0].action="switch.do?prefix=/masters&page=/MuncipalSubdivision.do&mode=saveHabData";
...
{
	document.forms[0].action="switch.do?prefix=/masters&page=/MuncipalSubdivision.do&mode=resetForm";
	document.forms[0].submit();
	}
}
...
function getData()
{
	document.forms[0].action="switch.do?prefix=/masters&page=/MuncipalSubdivision.do&mode=data1";
	document.forms[0].submit();
}
function viewfun()
{
  document.forms[0].action="switch.do?prefix=/masters&page=/MuncipalSubdivision.do&mode=View";
  document.forms[0].submit();
}
var newWindow;
function showHabsForMandal()
{
	 var url = "switch.do?prefix=/masters&page=/MuncipalSubdivision.do&mode=showMandals&coc="+ document.forms[0].coc.value+"&doc="+ document.forms[0].doc.value;
	 var width = 538;
	 var height = 532;
...
<body onload="init()">
<html:form action="/MuncipalSubdivision.do?mode=showData" >
...
{	
	...
	for(var j=0;j<<%=workCount%>;j++)
	{
		//alert("1:"+document.getElementById("WORKEXP_LIST[0].qp1").checked);
		//alert("2:"+document.getElementById("WORKEXP_LIST[0].qp2").checked);
		//alert("3:"+document.getElementById("WORKEXP_LIST[0].qp3").checked);
		//alert("4:"+document.getElementById("WORKEXP_LIST[0].qp4").checked);
		...
		{
		//	alert("in:"+document.getElementById("WORKEXP_LIST["+j+"].qa").checked);
			document.getElementById("WORKEXP_LIST["+j+"].qa").checked = true;
		//	alert("in1:"+document.getElementById("WORKEXP_LIST["+j+"].qa").checked);
		}
		else
		{
...
/*	for (i=0; i<document.forms[0].qp.length; i++)
	{
		if (document.forms[0].qp[i].checked==true)
			qastatus = true;
	}
	if(qastatus==true)
		document.forms[0].qa.checked = true;
	else
		document.forms[0].qa.checked = false;
		*/
}
</script>
