...
<html:form action="SubDivision.do?mode=edit"
	onsubmit="return validateSubdivisionOfficeForm(this)">
				...
				<table border=0 width="300" align=center
					...
					<tr>
						<td class=mycborder><FONT class=myfontclr><bean:message
									key="app.hoc" /></FONT></td>
						<td class=mycborder><html:text property="hoc"
								styleClass="mytext" maxlength="1" readonly="true" /></td>
					</tr>
					<tr>
						<td class=mycborder><FONT class=myfontclr><bean:message
									key="app.coc" /></FONT></td>
						<td class=mycborder><html:text property="coc"
								styleClass="mytext" maxlength="2" readonly="true" /></td>
					</tr>
					<tr>
						<td class=mycborder><FONT class=myfontclr><bean:message
									key="app.doc" /></FONT></td>
						<td class=mycborder><html:text property="doc"
								styleClass="mytext" maxlength="1" readonly="true" /></td>
					</tr>
					<tr>
						<td class=mycborder><FONT class=myfontclr><bean:message
									key="app.sdoc" /></FONT></td>
						<td class=mycborder><html:text property="sdoc"
								styleClass="mytext" maxlength="1" readonly="true" /></td>
					</tr>
					<tr>
						<td class=mycborder><FONT class=myfontclr><bean:message
									key="app.sdon" /></FONT></td>
						<td class=mycborder><html:text property="sdon"
