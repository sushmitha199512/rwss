...
function getData()
{
	document.forms[0].action="switch.do?prefix=/masters&page=/MuncipalSubdivision.do&mode=data";
	document.forms[0].submit();
}
function viewfun()
{
...
<html:form action="/MuncipalSubdivision.do?mode=Save" >

<jsp:include page="/commons/TableHeader.jsp">
	<jsp:param name="TableName" value="Muncipal SubDivision Link Entry Form" />
...
<td>
	<table  border=0  width="350"  align=center  style="margin-bottom:5;margin-top:5">
		...
		<tr>
			...
			<td>
			<html:select property="district" style="width:170px"  styleClass="mycombo" onchange="javascript:getData()" >
				<html:option value="">SELECT...</html:option>
				<html:options collection="dists" name="labelValueBean" property="urbanDistCode" labelProperty="urbanDistName" />
				</html:select>
		...
		<tr>		
			<td class="textborder" >
				<bean:message key="app.muncipal" /><font color="#FF6666">*</font>
			</td>
			<td class="bwborder" >
				...
				<html:options collection="mandals" name="rwsLocationBean" 
							  property="urbanMandCode" labelProperty="urbanMandName" />
				</html:select>
			</td>
		</tr>
	</table>
