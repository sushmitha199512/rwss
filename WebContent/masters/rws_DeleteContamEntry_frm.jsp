...
<html:form action="Contam.do?mode=delete" onsubmit="return validateContamForm(this)">
...
<tr>
	...
	<html:submit title="Save the Fields" styleClass="btext" value="Delete" onclick="return validateContamForm(contamForm)" /> 
