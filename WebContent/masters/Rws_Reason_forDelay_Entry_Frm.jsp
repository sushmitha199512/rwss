...
function validate()
{
	 ...
	 if(document.forms[0].reasonName.value=='')
	{
	...
	document.forms[0].action="switch.do?prefix=/masters&page=/reasons.do?mode=save";
	document.forms[0].submit();
}
}
</script>
<html:form action="reasons.do">
	<% 
		String csrfToken="";
...
<jsp:include page="/commons/TableHeaderWithoutClose.jsp">
	<jsp:param name="TableName" value="Reasons for Delay Entry Form" />
...
<td>
	...
	<tr>
	<td class=mycborder >
	<FONT class=myfontclr>Reason Code:<font color="#FF6666">*</font></FONT>
	</td>
	<td class=mycborder >
	<html:text property="reasonCode" value="<%=(String)request.getAttribute(\"reasonCode\")%>" styleClass="mytext" maxlength="2" readonly="true" />
	</td></tr>
	<tr >
		<td class=mycborder >
	<FONT class=myfontclr>Reason Name:<font color="#FF6666">*</font></FONT>
	</td>
	<td class=mycborder >
	<html:text property="reasonName"  styleClass="mytext" />
	</td>
	</tr>
