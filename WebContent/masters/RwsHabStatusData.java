...
public class RwsHabStatusData {
	...
	public  int insertPanchayat(DataSource dataSource,String dcode, String mcode,String pcode,String pname) throws Exception {   
		...
		try {
			...
			query = " update rws_panchayat_tbl set pname='"+pname+"' where dcode='"+dcode+"' and mcode='"+mcode+"' and pcode='"+pcode+"'";
	...
	conn = RwsOffices.getConn();
	stmt = conn.createStatement();
	query = " update rws_panchayat_raj_tbl set panch_name='"+habName+"' where panch_code='"+habCode+"'";
	...
	*/
	public  int insertVillage(DataSource dataSource,String dcode, String mcode,String pcode,String vcode,String vname) throws Exception {   
		...
		try {
			conn = RwsOffices.getConn();
			stmt = conn.createStatement();
			query = " update rws_village_tbl set vname='"+vname+"' where dcode='"+dcode+"' and mcode='"+mcode+"' and pcode='"+pcode+"' and vcode='"+vcode+"'";
	...
	public  String deletePanchayat(DataSource dataSource,String dcode, String mcode,String pcode) throws Exception {   
		...
		try {
			conn = RwsOffices.getConn();
			stmt = conn.createStatement();
			query = " select * from rws_village_tbl where dcode='"+dcode+"' and mcode='"+mcode+"' and pcode='"+pcode+"'";
			//Debug.println("query is "+query);
			rs = stmt.executeQuery(query);
			while(rs.next())
			{
			...
			{
			query = " delete  from rws_panchayat_tbl  where dcode='"+dcode+"' and mcode='"+mcode+"' and pcode='"+pcode+"'";
	...
	public  String deleteVillage(DataSource dataSource,String dcode, String mcode,String pcode,String vcode) throws Exception {   
		...
		try {
			...
			query = " delete  from rws_village_tbl  where dcode='"+dcode+"' and mcode='"+mcode+"' and pcode='"+pcode+"' and vcode='"+vcode+"'";
	...
	public  String insertNewPanchayat(DataSource dataSource,String dcode, String mcode,String pcode,String pname) throws Exception {   
		...
		try {
			...
			{
			query = " insert into rws_panchayat_tbl(dcode,mcode,pcode,pname) values('"+dcode+"','"+mcode+"','"+pcode+"','"+pname+"')";
	...
	public  String insertNewVillage(DataSource dataSource,String dcode, String mcode,String pcode,String vcode,String vname) throws Exception {   
		...
		try {
			...
			if(!codeAlreadyExists)
			{
			query = " insert into rws_village_tbl(dcode,mcode,pcode,vcode,vname) values('"+dcode+"','"+mcode+"','"+pcode+"','"+vcode+"','"+vname+"')";
...
public void deleteContHab(String contType,Statement stmt,String habCode)
{
	...
	try {
		...
		String query="delete from RWS_HAB_CONTAMINATION_TBL where hab_code='"+habCode+"' and cont_type='"+contType+"'";
...
public void addContHab(String contType,Statement stmt,String habCode)
{
	...
	try {
		//stmt = conn.createStatement();
		Debug.println("got stmt");
		String query="insert into RWS_HAB_CONTAMINATION_TBL(hab_code,cont_type)values('"+habCode+"','"+contType+"')";
...
public static int insertHabsData(String habcode,String tsp)throws Exception 
{
	...
	try {
		...
		query= " update rws_habitation_directory_tbl set TSP_NTSP='"+tsp.toUpperCase()+"' where HAB_CODE='"+habcode+"' ";
...
public static int insertScData(String habcode,String lccode,String lcname)throws Exception 
{
	...
	try {
		...
		if(!rs1.next()){
			Debug.println("in if");
		query=" insert into RWS_SC_ST_MIN_LOCALITY_TBL(hab_code,locality_code,locality_name)values('"+habcode+"','"+lccode+"','"+lcname+"')";
		
		}else{
			
			query=" update RWS_SC_ST_MIN_LOCALITY_TBL set locality_name='"+lcname+"' where hab_code='"+habcode+"' and locality_code='"+lccode+"'";
...
public static int insertAssetData(String habcode,String astcode,String lccode,String popserved)throws Exception 
{
	...
	try {
		...
		if(!rs1.next()){
		query=" insert into RWS_ASSET_LOCALITY_SERVE_TBL (hab_code,asset_code,locality_code,population_served)values('"+habcode+"','"+astcode+"','"+lccode+"','"+popserved+"')";
		}else{
			query=" update RWS_ASSET_LOCALITY_SERVE_TBL set population_served='"+popserved+"' where hab_code='"+habcode+"' and asset_code='"+astcode+"' and locality_code='"+lccode+"'";	
		}
