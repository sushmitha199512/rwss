...
function validate()
{
	 ...
	 if(document.forms[0].ddwsPhyName.value=='')
	{
	...
	document.forms[0].action="switch.do?prefix=/masters&page=/ddwsPhyComp.do?mode=save";
	document.forms[0].submit();
}
}
</script>
<html:form action="ddwsPhyComp.do">
	<% 
		String csrfToken="";
...
<jsp:include page="/commons/TableHeaderWithoutClose.jsp">
	<jsp:param name="TableName" value="DDWS Physiacal Component Entry" />
...
<td>
	...
	<tr>
	<td class=mycborder >
	<FONT class=myfontclr>DDws Comp Code:<font color="#FF6666">*</font></FONT>
	</td>
	<td class=mycborder >
	<html:text property="ddwsPhyCode" value="<%=(String)request.getAttribute(\"compCode\")%>" styleClass="thin-text-box" maxlength="2" readonly="true" />
	</td></tr>
	<tr >
		<td class=mycborder >
	<FONT class=myfontclr>DDws Comp Name:<font color="#FF6666">*</font></FONT>
	</td>
	<td class=mycborder >
