...
document.forms[0].action="rws_div_spillworks_refunds_process.jsp";
	document.forms[0].submit();	
}
...
<tr><td colspan="3"></td>
	...
	try
	{
		...
		String qry = "select b.dname,c.division_office_name,a.work_id,d.work_name,a.refund_bill_amount,nvl(a.remarks,'-') from "+tableName+" a,rws_district_tbl b,rws_division_office_tbl c,rws_work_admn_tbl d where a.work_id=d.work_id and substr(d.office_code,2,2)=b.dcode and  substr(d.office_code,4,1)=c.division_office_code and  b.dcode=c.circle_office_code and a.refund_flag='I' and a.ee_forward_date is not null ";
	...
	<td class=btext>Select</td>
		...
		onmouseout="this.style.background='WHITE'">
						...
						<td><input type=checkbox name=check<%=count-1%> value='<%=rs.getString(3) %>' ></td>
					</tr>
				<%
								}
if(count==1){
...
<% }
	...
	<%}
		...
		System.out.println("Exception at rws_bill_spillworks_refunds : "+e);//e.printStackTrace();
		}finally{
		try{
			if(rs!=null)rs.close();if(stmt!=null)stmt.close();
			if(conn!=null)conn.close();
		}catch(Exception eee){
			System.out.println("Exception at finally block of rws_bill_spillworks_refunds : "+eee);//eee.getMessage();
			}
		}
