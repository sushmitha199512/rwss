...
try
{
	...
	String q = "select sum(OP_CL_BAL),substr(office_code,2,3) from RWS_GRANT_OP_CL_BAL_TBL where programme_code in (01,02,18,23,32,48,49,50,51,58,59,60,72) group by substr(office_code,2,3)";
...
<table align="center" cellpadding="0" cellspacing="0">
  <col width="311">
  <tr height="17">
    <td height="17" width="500"><span class="style1"><bean:message key="app.nrdwprelatedfin"/></tr>
</table>
