...
function getData()
{
	document.forms[0].action="switch.do?prefix=/masters&page=/MuncipalSubdivision.do&mode=disp";
	document.forms[0].submit();
}
 
//-->
</SCRIPT>
<html:form action="/MuncipalSubdivision.do?mode=edit" onsubmit="return validateMandalSubdivisionForm(this)">

<jsp:include page="/commons/TableHeader.jsp">
	<jsp:param name="TableName" value="Muncipal Sub Division Link Entry Form" />
