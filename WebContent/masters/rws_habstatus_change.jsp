...
qry="select TOTAL_WATER_SUPPLY,CENSUS_PLAIN_POPU,CENSUS_SC_POPU,CENSUS_ST_POPU,FLOAT_POP,MINORITY_POP_COVERED from rws_habitation_directory_tbl";
   ...
   while(rs8.next())
   {
	...
	{	
		...
		qry="update rws_habitation_directory_tbl set EXIST_WATER_LEVEL='"+totwaterlevel+"' ,COVERAGE_STATUS='"+calCoverageStatus+"' ";
  	 ...
  	 /* /* int totnetpopuyear=(totnetpopu*Math.pow(1.01,4));
  	 
	   int levelwatersupply=(water)/totnetpopuyear; */   	 
