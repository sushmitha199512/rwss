...
document.forms[0].action="switch.do?prefix=/masters&page=/milestonestage.do?mode=data&mode1=stageCode";
...
function validate()
{
 ...
 else if(document.forms[0].ddwsLinked.value=='')
	{
	...
	document.forms[0].action="switch.do?prefix=/masters&page=/milestonestage.do?mode=save";
	document.forms[0].submit();
}
}
</script>
<html:form action="milestonestage.do">
	<% 
		String csrfToken="";
...
<jsp:include page="/commons/TableHeaderWithoutClose.jsp">
	<jsp:param name="TableName" value="MileStone Stage Entry"  />
...
<tr>
	...
	<td class=mycborder >
	<html:text property="mileStoneStageCode" value="<%=(String)request.getAttribute(\"mileStoneStageCode\")%>" styleClass="mytext" maxlength="2"  readonly="true"/>
	</td></tr>
	<tr >
<tr>
		<td class=mycborder >
	...
	<td class=mycborder >
	<html:text property="mileStoneStageName"  styleClass="mytext" />
	</td>
	</tr>
	<tr>
	<td class=mycborder >
