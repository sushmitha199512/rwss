...
<td>
	<jsp:include page="/commons/TableHeader.jsp">
		<jsp:param name="TableName" value="Village Secretary Entry Form" />
...
<td>
		...
		<td>
				...
				<html:select property="panchayat" style="width:140px"    styleClass="mycombo"  onchange="fnPanchayatChanged()">
					<html:option value=""><bean:message key="app.pleaseSelect" /></html:option>
		...
		<td>
				...
				<html:select property="village" style="width:140px"    styleClass="mycombo" >
					<html:option value=""><bean:message key="app.pleaseSelect" /></html:option>
