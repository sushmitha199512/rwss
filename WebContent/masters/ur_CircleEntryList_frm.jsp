...
<table width=500>
<tr><td align=right><html:link page="/UrCircle.do?mode=data">Back&nbsp;|&nbsp;</html:link>
...
<td  class=mycborder1 align="center">
<a href="./UrCircle.do?hoc=<bean:write name='circlelist' property='hoc' />&coc=<bean:write name='circlelist' property='coc' />&mode=get">
