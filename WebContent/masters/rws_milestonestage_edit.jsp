...
function validate()
{
	 if(document.forms[0].mileStoneStageName.value=='')
	{
		alert("please Enter MileStone Stage Name ");
		return false;
	}
	 if(document.forms[0].ddwsLinked.value=='')
		{
...
<html:form action="milestonestage.do?mode=edit" >
	<% 
		String csrfToken="";
...
<td>
	...
	<td class=mycborder >
	<html:text property="mileStoneStageCode" readonly="true" styleClass="mytext" />
	</td>
	</tr>
<tr >
	<td class=mycborder >
