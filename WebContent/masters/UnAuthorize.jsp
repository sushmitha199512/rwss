...
<table width=100% height=90% border=1 bordercolor="#595CB2">
	...
	<tr align=center valign=middle>
		<td>
		<font face=verdana size=4 color=red><B>You are not Authorized to View this Page</B></font><BR><BR><BR><BR>
			<a  href="/pred/home.jsp">
				<font face=verdana size=3 color=BLUE><B>Go Home</B></font>
			</a>
		</td>
		</tr>
		<tr height="2%">
