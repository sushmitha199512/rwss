...
function getData()
{
	document.forms[0].action="/pred/masters/assetReconvertion.do?mode=new";
	document.forms[0].submit();	
	}

function getData1()
{
	document.forms[0].action="/pred/masters/assetReconvertion.do?mode=exist";
	document.forms[0].submit();	
}
...
function funcDistrictChanged()
{
	...
	document.forms[0].action="/pred/masters/assetReconvertion.do?mode=exist&mode1=mandals";
	document.forms[0].submit();	
}
function funcDistrictChanged1()
{
	document.forms[0].action="/pred/masters/assetReconvertion.do?mode=new&mode1=mandals";
	document.forms[0].submit();	
}
function selectionChanged(mode)
{
	if(document.forms[0].panchayat)
	{
		...
		document.forms[0].action="/pred/masters/assetReconvertion.do?mode=exist&mode1="+mode;
		document.forms[0].submit();
	}
}
function selectionChanged1(mode)
{
	if(document.forms[0].panchayat)
	{
		...
		document.forms[0].action="/pred/masters/assetReconvertion.do?mode=new&mode1="+mode;
		document.forms[0].submit();
	}
}
function convertHab()
{
			...
			{
		alert("please Select Existing District");
		return false;
			}
	
			else if(document.getElementById('mandal').value=='')
			{
			alert("please Select  Existing Mandal");
			return false;
			}
			else if(document.getElementById('panchayat').value=='')
			{
			alert("please Select Existing Panchayat");
			return false;
			}
			else if(document.getElementById('village').value=='')
			{
			alert("please Select Existing Village");
			return false;
			}
			else if(document.getElementById('habCode').value=='')
			{
			alert("please Select Existing Habitation");
			return false;
			}
			else if(document.getElementById('district1').value=='')
			{
			alert("please Select New District");
			return false;
			}
		
			else if(document.getElementById('mandal1').value=='')
			{
			alert("please Select  New Mandal");
			return false;
			}
			else if(document.getElementById('panchayat1').value=='')
			{
			alert("please Select New Panchayat");
			return false;
			}
			else if(document.getElementById('village1').value=='')
			{
			alert("please Select New Village");
			return false;
			}
			else if(document.getElementById('habitation1').value=='')
			{
			alert("please Select New Habitation");
			return false;
			}
			else if(document.getElementById('assetCode').value=='')
			{
			alert("please Select Existing Assets");
			return false;
			}
			else{
				
			document.getElementById("submits").value="Please Wait...."
			document.forms[0].action="switch.do?prefix=/masters&page=/assetReconvertion.do&mode=convert&oldCode="+oldCode+"&newCode="+newCode;
			document.forms[0].submit();
			}	
		}
...
<body> 
<html:form action="assetReconvertion.do">
	<% 
		String csrfToken="";
...
<td>
	<jsp:include page="/commons/TableHeaderWithoutClose.jsp">
		<jsp:param name="TableName" value="Asset ReOrganisation Form" />
...
<td>
	...
	<table bgcolor="#DEE3E0" bordercolor= "#8A9FCD" border="1" 
	   style="border-collapse:collapse;" width="920" >
	   <tr>
			<td class="textborder" align="center" width="450" >Existing Assets Info</td>
			<td class="textborder" align="center" width="20">&nbsp;</td>
			<td class="textborder" align="center" width="450">New Assets Info</td>
		</tr>
	<tr>
    <td><table  border=0  width="450">
      ...
      <tr>
        <td class="textborder">Asset Code <span class="mandatory">*</span> </td>
        <td><html:select property="assetCode" style="width:300px" multiple="true" >
            
            <html:options collection="assets" name="labelValueBean" 
