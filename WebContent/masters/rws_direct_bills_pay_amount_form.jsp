...
<%
int count=0;
String qry="select WORK_ID,BILL_SL_NO,BILL_NO,to_char(BILL_DATE,'dd/mm/yyyy'),BILL_AMT_CONTRACTOR ,BILL_AMT_ADMISSIBLE  from rws_work_direct_bill_tbl where work_id='"+workid+"' order by 2";
