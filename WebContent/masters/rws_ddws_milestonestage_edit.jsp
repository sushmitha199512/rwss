...
<html:form action="ddwsmilestonestage.do?mode=edit" >
	<% 
		String csrfToken="";
...
<jsp:include page="/commons/TableHeaderWithoutClose.jsp">
	<jsp:param name="TableName" value="DDWS Phy. MileStoneStage" />
...
<td>
	...
	<td class=mycborder >
	<html:text property="mileStoneStageCode" readonly="true" styleClass="thin-text-box" />
	</td>
	</tr>
<tr >
	<td class=mycborder >
