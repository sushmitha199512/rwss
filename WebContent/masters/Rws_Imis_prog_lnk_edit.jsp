	...
	{ 
	 ...
	 else  if(document.forms[0].subProgramme.value=="")
     {
	    ...
	    else if(document.forms[0].amtIn.value=="")
       {
	    ...
	    {
	    	document.forms[0].programme.disabled=false;
	    	document.forms[0].subProgramme.disabled=false;
	        document.forms[0].action="switch.do?prefix=/masters&page=/ImisProgrammeLink.do&mode=update"; 
	    	document.forms[0].submit();
		...
		<thead>
			<tr>
				...
				<jsp:include page="/commons/TableHeaderWithoutClose.jsp">
					<jsp:param name="TableName" value="IMIS Program Linkage Edit Form" />
			...
			<tr>
				...
				<table bgcolor="#DEE3E0" bordercolor="#8A9FCD" rules="none" border=1
					...
					<tr>
						...
						<td>
							<html:select property="programme" style="width:143px" styleClass="mycombo"  disabled="true" >
					...
					<tr>
						...
						<td><html:select property="subProgramme" style="width:143px" styleClass="mycombo" disabled="true" >
								<html:option value="">Select...</html:option>
					...
					<tr>
					<td colspan="2"><span class="mandatory">Note:- For MVS schemes Amount is distributed to all categories </span></td>
					</tr>
					<tr>
