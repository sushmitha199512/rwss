	...
	function fnSubmit()
	{
		...
		if(user=="admin" || user=="100000")
		{
			...
			else
			{
				...
				document.f1.action="./rws_work_direct_voucher_list_frm.jsp";
				document.f1.submit();
			}	
		}
		else
...
<table border = 1 align = center cellspacing = 0 cellpadding = 0 rules = "rows" bordercolor = navy style = "border-collapse:collapse" bgcolor="#ffffff" width=350>		
	...
	<tr bgcolor="#8A9FCD" align="center">
		<td align="center" class="rptHeading" colspan=3>Select Work for Direct Voucher</td>	
	</tr>
...
&nbsp;&nbsp;&nbsp;Note****: <BR>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;1. You can enter the Vouchers for the Works which are having Mile Stones Information and Bills Information <br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2. Which is covered by direct Vouchers for the works which are having Mile Stones Information and Bills Information
