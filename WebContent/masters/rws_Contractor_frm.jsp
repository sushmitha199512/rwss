...
<%
String newval="";
newval=(String)request.getAttribute("exist");
String conNamee="";
conNamee = (String)request.getAttribute("conName");
String conCodee="";
conCodee = (String)request.getAttribute("conCode");
//System.out.println("new vallllllllll:"+newval);
%>
...
contractorForm.bankName.value="";
  ...
  var URL="/pred/masters/rws_getbank_details_ifsc.jsp?ifsc="+ifsc.toUpperCase();
...
{
	var code='<%=newval%>';
	var conName = '<%=conNamee%>';
	var conCode = '<%=conCodee%>';
	if(code=="YES")
	{
		opener.document.forms[0].action="switch.do?prefix=/works&page=/WorkStatus.do&mode=insContract&conName="+conCode;
...
{   
  ...
  function orderview()
  {
	  var firstname1=document.contractorForm.firstName.value;
	  if(firstname1 ==null || firstname1 == "")
		{
		  	alert("Please Enter Starting letter(s) of Firstname which You want to VIEW");
			document.contractorForm.contractorRegno.focus();
		 	 return false;
		}
		else
...
<tr>
	...
	<td><html:text property="street" value="" styleClass="mytext1" tabindex="5" size="20"  onkeypress="upperOnly()"/></td>
	<td class="btext1">Phone:</td>
	<td><html:text property="phone" value="" styleClass="mytext1" tabindex="9" size="20" maxlength="10"  onkeypress="return numeralsOnly(event)" /></td>

</tr><tr>
	<td class="btext1">Area:</td>
	<td><html:text property="area" value="" styleClass="mytext1" tabindex="6" size="20" onkeypress="upperOnly()"/></td>
	<td nowrap class="btext1">&nbsp;Cell No:<font color="#FF6666">*</font></td>
	<td><html:text property="mobile" value="" styleClass="mytext1" tabindex="10" size="20" maxlength="10" onkeypress="return numeralsOnly(event)" /></td>
	
</tr>
<tr>
	<td class="btext1">City:</td>
	<td><html:text property="city" value="" styleClass="mytext1" tabindex="7" size="20" onkeypress="upperOnly()"/></td>	
	<td class="btext1">&nbsp;Fax:</td>
	<td><html:text property="fax" value="" styleClass="mytext1" tabindex="11" size="20" onkeypress="upperOnly()" /></td>
	
</tr>
<tr>
	<td class="btext1">PinCode:</td>
	<td><html:text property="pin" value="" styleClass="mytext1" tabindex="8" size="6" maxlength="6" onkeypress="return numeralsOnly(event)" /></td>
</TR>
<TR>
	<td class="btext1">Email<font color="#FF6666">*</font></td>
	<td colspan="2"><html:text property="email" value="" styleClass="mytext1" tabindex="12" size="40" /></td>
...
<tr>
	...
	<td><html:text property="contractorRegno" value="" styleClass="mytext1" tabindex="13" size="12" maxlength="4"  onkeypress="return checkSpaceAndSpecial(event)"/></td>
	</tr>
	<tr>
	<td nowrap class="btext1">Registered At:</td>
	<td><html:text property="registerAt" value="" styleClass="mytext1" tabindex="14" size="12" onkeypress="upperOnly()" /></td>
	</tr>
	<tr>
	<td nowrap class="btext1">Registration Dt:</td>
	<td><html:text property="registrationDate" value="" styleClass="mytext1" tabindex="15" size="8" /><a href="javascript: showCalendar(document.contractorForm.registrationDate);"></font><IMG SRC="<rws:context page='/images/calendar.gif'/>" width="30" border="0" height="19" align="absmiddle"></a></td>
   </tr>
	...
	<td colspan=2><html:text property="validTo" value="" styleClass="mytext1" tabindex="17" size="8" /><a href="javascript: showCalendarFuture(document.contractorForm.validTo);"></font><img src="<rws:context page='/images/calendar.gif'/>" width="30" height="19" border="0" alt="" align="absmiddle"/></td>
    </tr>
...
<td class="btext1">IFSC&nbsp;Code<font color="#FF6666">*</font>:</td>
	<td><html:text property="ifscCode" value=""    size="15" styleClass="btext2" maxlength="11" onblur="ajaxFunction_ifsc();" /></TD>
	<td class="btext1">Bank&nbsp;Name<font color="#FF6666">*</font>:</td>
	<td><html:text property="bankName"   readonly="true" value="" styleClass="btext2" size="20"  /></TD>
	<td class="btext1">&nbsp;&nbsp;Branch&nbsp;Name<font color="#FF6666">*</font>:</td>
	<td><html:text property="branchName" readonly="true" value="" styleClass="btext2" size="30"  /></TD>
   
<tr>
<tr>
	    <td class="btext1">Account&nbsp;Number<font color="#FF6666">*</font>:</td>
	<td><html:text property="accountNo" value="" styleClass="btext2"  size="20" maxlength="24" onkeypress="return numeralsOnly(event)" /></TD>
	
  <td class="btext1">&nbsp;&nbsp;Address<font color="#FF6666">*</font>:</td>
	<td><html:textarea property="branchAddress"  readonly="true" styleClass="btext2"  rows="4" cols="25"   /><div id="content" style="display:none" ><img src="images/banloading.gif" alt="Loading Wait..." title="Loading Wait..."></div> </TD>
...
<tr>
	...
	<!-- onclick="return validateContractorForm(contractorForm)" />  -->
     <html:reset title="Clear all the Fields" styleClass="btext1" value="Reset" />
     <html:submit title="close" styleClass="btext1" value="Close" onclick="closewin(this)" />
	 <html:submit property="mode" title="View the Fields" styleClass="btext1" value="View" onclick="return orderview()"/>
