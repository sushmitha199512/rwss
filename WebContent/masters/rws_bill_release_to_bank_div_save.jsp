...
/* Bill Activation ,Bank on 23012015*/
	...
	qry = "insert into rws_bill_bank_bridge_det_tbl SELECT WORK_ID,OFFICE_CODE,BILL_SL_NO,BILL_AMOUNT_CENTRAL,SYSDATE,'Y','"+request.getParameter("txId")+"',BILL_ACTIVATION_FLAG,'BANK' from rws_bill_bank_bridge_temp_tbl where BILL_ACTIVATION_FLAG='S'";
	
	/* Bill Activation ,Bank end  */
	//System.out.println("Qry:"+qry);
	stmt.addBatch(qry);
