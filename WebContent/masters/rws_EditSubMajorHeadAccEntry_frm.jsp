...
<body onload="autocompletion()">
	<html:form action="SubMajorHead.do?mode=edit"
		onsubmit="return validateSubMajorHeadForm(this)">
			...
			<tr>
				<td>
					<table border=0 width="300" align=center
						...
						<tr>
							<td class=mycborder><FONT class=myfontclr><bean:message
										key="app.submajorHeadName" /></FONT></td>
							<td class=mycborder><html:text property="submajorHeadName"
