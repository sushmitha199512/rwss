...
<script language="JavaScript">
	function getMandals(sdoc,doc,coc,sdon,noofmandals)
	{
	  ...
	  {
		url = "switch.do?prefix=/masters&page=/SubDivision.do&mode=getmandals&sdoc="+sdoc+"&doc="+doc+"&coc="+coc+"&sdon="+sdon;
...
<table width="95%">
<tr><td align=right>
<html:link page="/SubDivision.do?mode=data">Back&nbsp;|&nbsp;</html:link>
...
<td  class=mycborder1 >
<a href="./SubDivision.do?sdoc=<bean:write name='subdivisionlist' property='sdoc' />&doc=<bean:write name='subdivisionlist' property='doc' />&coc=<bean:write name='subdivisionlist' property='coc' />&mode=get"><font color="#6600CC">Edit<!-- &nbsp;&nbsp;| --></font></a>&nbsp;&nbsp;
