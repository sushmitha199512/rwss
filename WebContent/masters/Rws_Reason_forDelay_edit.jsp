...
<html:form action="reasons.do?mode=edit" >
	<% 
		String csrfToken="";
...
<jsp:include page="/commons/TableHeaderWithoutClose.jsp">
	<jsp:param name="TableName" value="Reasons for Delay Update Form" />
...
<td>
	...
	<tr>
	<td class=mycborder >
	<FONT class=myfontclr>Reason Code:</FONT>
	</td>
	<td class=mycborder >
	<html:text property="reasonCode" styleClass="mytext" readonly="true" />
	</td></tr>
	<tr >
	<td class=mycborder >
	<FONT class=myfontclr>Reason Name:</FONT>
	</td>
	<td class=mycborder >
