...
<html:form action="Section.do?mode=edit" onsubmit="return validateSectionOfficeForm(this)">
...
<tr>
		...
		<tr>
		<td  class=mycborder >
		<FONT class=myfontclr>Section Office Code</FONT>
		</td>
		<td  class=mycborder >
		<html:text property="soc" styleClass="mytext" maxlength="1" readonly="true" />
		</td>
		</tr>
		<tr>
		<td  class=mycborder >
		<FONT class=myfontclr>Section Office Name</FONT>
		</td>
		<td  class=mycborder >
		<html:text property="son" styleClass="mytext" maxlength="20" />
		</td>
		</tr>
