...
<html:form action="WaterLab.do?mode=edit" >
...
<td>
	...
	<td  class=mycborder >
	<html:select property="hoc" disabled="true"  styleClass="mycombo" style="width:123px" onchange="javascript:getData()" >
	...
	<td  class=mycborder >
		<html:select property="coc" disabled="true" style="width:123px" styleClass="mycombo" onchange="javascript:getData()" >
	...
	<td  class=mycborder >
		<html:select property="doc" disabled="true" style="width:123px" styleClass="mycombo" onchange="javascript:getData()" >
	...
	<td  class=mycborder >
		<html:select disabled="true" property="mancode" style="width:123px" styleClass="mycombo"  >
...
<td  class=mycborder nowrap>
		...
		<td  class=mycborder >
		<FONT class=myfontclr>Lab Head</FONT></td>
		<td  class=mycborder >
		...
		<td  class=mycborder >
		<html:text property="labEstablishedYear"  maxlength="4"/>
		</td>
		<td  class=mycborder nowrap>
		<FONT class=myfontclr>Contact Number</FONT>
		</td>
		<td  class=mycborder >
		<html:text property="contactNum" />
		</td>
		</tr>
		<tr>
		<td  class=mycborder >
...
<td>
	...
	<html:submit title="Save the Fields" styleClass="btext" value="Save" onclick="return validateWqLabForm(wqLabForm)" />
