			...
			<table  border=0 rules=none style="border-collapse:collapse" align = "right">		
				<tr>
					<td align="right" class="bwborder">
						<a href="rws_bill_release_to_pao.jsp">Close</a>
					</td>
				</tr>
			</table>
		</caption>
...
<%
String pname=request.getParameter("per");
...
<table border = 1 cellspacing = 0 cellpadding = 0 bordercolor=#000000 style="border-collapse:collapse" bgcolor="#ffffff" align="center">
	<tr>
		<td class="textborder" align="left">Select Program Name<span class="mandatory">*</span></td>
		...
		while(rs.next())
		{		
				if(pname!=null && pname.equals(rs.getString(1))) 
			 {
			%>
...
try
{
	...
	String q = "select sum(OP_CL_BAL),substr(office_code,2,3) from RWS_GRANT_OP_CL_BAL_TBL where programme_code='"+pname+"' group by substr(office_code,2,3)";
	...
	String q3 = "select nvl(sum(voucher_amt),0),substr(b.office_code,2,3) from rws_work_exp_voucher_tbl a,rws_work_admn_tbl b where a.work_id=b.work_id and BILL_SL_NO <> '0' and b.programme_code='"+pname+"' group by substr (b.office_code,2,3)";
	////System.out.println("qqqqq3:"+q3);
	...
	String q5 = "select nvl(sum(BILL_AMT_CONTRACTOR),0),nvl(sum(BILL_AMT_ADMISSIBLE),0),substr(b.office_code,2,3) from rws_work_bill_tbl a,rws_work_admn_tbl b where a.work_id=b.work_id and bill_sl_no<>'0' and b.programme_code='"+pname+"' group by substr(b.office_code,2,3)";
	////System.out.println("qqqqq5:"+q5);
...
Note********: In this Report all programmes Division wise Balance Details are Displayed</font>
 <%}%>
<table align="center" cellpadding="0" cellspacing="0">
  <col width="311">
  <tr height="17">
    <td height="17" width="410"><span class="style1"></span></td>
  </tr>
  <tr height="17">
    <td height="17"><span class="style1"></span></td>
  </tr>
