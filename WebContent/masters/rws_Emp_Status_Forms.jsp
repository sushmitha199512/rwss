...
function unview()
{
	...
	if(a=="-1")
	{
       document.forms[0].elements["butview"].disabled=true;
	}
}
...
function fnSubmit()
{
var a=document.forms[0].elements["hoc"].value;
var b=document.forms[0].elements["coc"].value;
if(a=="0")
{
...
<table border = 1 align=center cellspacing = 0 cellpadding = 0 rules="rows" width="20%" height="80%" bordercolor=navy style="border-collapse:collapse" bgcolor="#ffffff">
	...
	<tr>
	<td class=rptLabel>Circle Office&nbsp;&nbsp;<font color="#FF6666">*</font></td>
	<td class=btext>
