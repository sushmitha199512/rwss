					...
					<table border=0 width="350" align=center
						...
						<tr>
							...
							<td class=mycborder><html:text property="instituteCode"
									value="<%=(String) request.getAttribute(\"instcode\")%>"
						...
						<tr>
							...
							<td class=mycborder><html:text property="instituteName"
									value="" styleClass="mytext" maxlength="20" /></td>
						</tr>
					</table> <%
 	String csrfToken = "";
 ...
 %> <html:hidden property="token" styleClass="mytext"
			...
			<tr>
				<td colspan="2" align="center"><html:submit property="mode"
						...
						onclick="return validateInstituteForm(instituteForm)" /> <html:reset
