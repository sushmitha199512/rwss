...
try
{
	...
	String q1 = "select substr(office_code,2,3),sum(bill_amout_state) from rws_bill_pao_bridge_temp_tbl group by substr(office_code,2,3)";
...
<%}
	...
	System.out.println("Exception  in rws_bill_selected_to_encpao_rpt: "+e.getMessage());
	}
	finally{
	try{
	...
	}catch(Exception eee){System.out.println("Exception  in rws_bill_selected_to_encpao_rpt: "+eee.getMessage());}
	}%>
</body>
</html>