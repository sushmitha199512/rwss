...
/******************************************************/
		...
		double targetE=Double.parseDouble(rs3.getString(4));
		 ...
		 styleCount++;
		  ...
		  String insertQuery="insert into rws_svs_graph_view_tbl values (?,?,?,?,'SVS')";
          PreparedStatement ps1=conn.prepareStatement(insertQuery);
          ps1.setString(1, rs3.getString(1));
          ps1.setString(2, rs3.getString(2));
          ps1.setDouble(3, habper);
          ps1.setDouble(4, expper);
		  ps1.executeUpdate();
