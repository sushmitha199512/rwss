...
<tr>
<td height="20"></td>
<tr><td align="right" class="bwborder" colspan="2"><a href="./rws_rfd_mvs_target_ach_excel.jsp" target="_new">Excel</a>|<a href="javascript:onclick=history.go(-1)">Back</a></td></tr>   
		  ...
		  int res[]=sst1.executeBatch();
			 ...
			 count=1;
			     while(rst.next()){
				  ...
				  <td class="<%=style %>" style="text-align: right;"><a href="#" onclick="viewWorks('rws_rfd_svs_target_ach_rpt_drill.jsp?dcode=<%=rst.getString(1) %>&type=1')"><%=rst.getString(5) %></a></td>
...
String colorValueHab="",colorValueExp="";
 ...
 %>
				  ...
				  Please Click Here to View Graph<a href="<rws:context page='/public_domain/rws_rfd_mvs_target_ach_graph.jsp' />" target="_new"><img src="<rws:context page='/images/chart.png' />"  width="40" height="40"/></a></td>
				</tr>
</table>
