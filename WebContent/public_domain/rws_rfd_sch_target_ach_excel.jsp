...
response.setHeader("Content-Disposition", "inline; filename="
		+ "Rfd_Sch_Target_Achievement.xls");
...
<!-- Grid Table Starts -->                                      
					...
					<table width="100%" border="1" cellspacing="0" cellpadding="0">
                                   ...
                                   <tr >
		<td align="center" colspan=5>Drinking Water Facilities In Schools. <%=cYear %>-<%=nYear %></td>	
	</tr>
		<tr >
		<td  align=center>Sl.No</td>
		<td   align=center>District</td>
<td   align=center  nowrap >Target(<%=cYear %>-<%=nYear %>)</td>
<td   align=center >Achievement (<%=prevmonth %>-<%=cYear %>)</td>
  ...
  try{
	  ...
	  int res[]=sst1.executeBatch();
		 ...
		 count=1;
		  ...
		  <tr><td style="text-align: left;"><%=count++ %></td><td style="text-align: left;" ><%=rst.getString(2) %></td><td style="text-align: right;"  ><%=rst.getString(3) %></td><td style="text-align: right;"  > <%=rst.getString(5) %></td>
	  ...
	  <td style="text-align: right;"><%=ndf.format(ghabper) %></td></tr>
