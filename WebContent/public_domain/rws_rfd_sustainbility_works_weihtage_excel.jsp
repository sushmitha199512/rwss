...
response.setHeader("Content-Disposition", "inline; filename="
		+ "Rfd_Sustainbility_Works_weightage.xls");
...
query+=" order by d.dcode";rs1=stmt1.executeQuery(query);
while(rs1.next())
{    
...
%>    
	 ...
	 <td style="text-align: left;"><%=rs1.getString(2) %></td>
	 <td style="text-align: right;"><%=totWorks %></td>
	  <td style="text-align: right;"><%=ndf.format(totalBalEst) %></td>
	  <td style="text-align: right;"><%=totWorks%></td>
	  <td style="text-align: right;"><%=achno%></td>
	  <td style="text-align: right;"><%=ndf.format(per1) %></td>
	  <td style="text-align: right;"><%=ndf.format(wt) %></td>
	 </tr>
...
<% 
 ...
 <tr><td  style="text-align: right;"   colspan="2">Total </td>
	  <td  style="text-align: right;"><%=ndf.format(gtotWorks) %></td>
	  <td  style="text-align: right;" ><%=ndf.format(gtotalBalEst) %></td>
	  <td  style="text-align: right;" ><%=ndf.format(gtotWorks) %></td>
	  <td  style="text-align: right;" > <%=ndf.format(tot4) %></td>
	  <td   style="text-align: right;"><%=ndf.format(((double)tot4*100)/(double)gtotWorks)%></td>
	  <td  style="text-align: right;"><%=ndf.format(((((double)tot4*100)/(double)gtotWorks)*5)/100)%></td>
	  </tr>
