...
<tr><td align="right" class="bwborder" colspan="2"><a href="/pred/home.jsp?loginMode=watersoft">Home</a>&nbsp;|&nbsp;
                 <a href="javascript:onclick=history.go(-1)">Back | &nbsp;
                    <a href="rws_rfd_sch&awd_excel.jsp" target="_new">Excel</a></td></tr>    
...
<!-- Grid Table Starts -->                                      
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
                                   ...
                                   <tr >
		<td align="center" class="gridhdbg" colspan=18><font size="2" color="white">Toilet Facilities In  Schools & Anganwadies <%=pYear %>-<%=cYear %></font></td>	
	</tr>
		<tr >
		
		<td align="center" class="gridhdbg" colspan=9><font size="2" color="white">Schools </font></td>
		<td align="center" class="gridhdbg" colspan=8><font size="2" color="white">Anganwadies</font></td>
		</tr>
		<tr>
