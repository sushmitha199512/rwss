...
String currentMonth=RwsUtils.getCurrentMont().toUpperCase();
...
<td height="20"></td>
   ...
   <tr><td align="right" class="bwborder" colspan="2"><a href="/pred/home.jsp?loginMode=watersoft">Home</a>&nbsp;|&nbsp;
                    <a href="rws_rfd_dpr_preparation_weihtage_excel.jsp" target="_new">Excel</a></td></tr>       
				<tr>
...
<tr bgcolor="#8A9FCD">
		<td align="center" class="gridhdbg" colspan=13><font color="white"><b>Preparation of DPRs (<%=cYear +"-"+ nYear %>)</b></font></td>	
	</tr>
		<tr >
...
<td class="gridhdbg"  align=center colspan=2 nowrap >Works <br></br><font color="red"><b>.</b></font></td>
 <td class="gridhdbg"  align="center"  rowspan="2" >Target</td>
 <td  class="gridhdbg"  align="center"  rowspan="2" >Achievement</td>
  <td  class="gridhdbg"  align="center"  rowspan="2">Percentage</td>
  <td  class="gridhdbg"  align="center"  rowspan="2" >Weightage</td>
</tr>
<tr>
...
double sanamount=0;
  try{
	...
	//System.out.println("dprlan11******KKKKKK"+dprlan11);
	  ...
	  while(rs3.next()){
		...
		// System.out.println(""+s1);
		 ...
		 styleCount++;
		  ...
		  <td class="<%=style %>" style="text-align: right;"><%=w2 %></td>
		  
		  <td class="<%=style %>" style="text-align: right;" ><%=ndf.format(s2) %></td>
		  <td class="<%=style %>" style="text-align: right;"><%=w2 %></td>
		  <td class="<%=style %>" style="text-align: right;"><%=pending %></td>
		  <td class="<%=style %>" style="text-align: right;"><%=ndf.format(i3)%></td>
		  <td class="<%=style %>" style="text-align: right;"><%=ndf.format(i4)%></td>
		  </tr>
	  ...
	  <td  style="text-align: right;"  class="gridhdbg" ><%=gtot %> </td>
	  <td  style="text-align: right;"  class="gridhdbg" ><%=ndf.format(gsantot) %> </td>
	  <td  style="text-align: right;"  class="gridhdbg" ><%=gtot %> </td>
	   <td  style="text-align: right;"  class="gridhdbg" ><%=(int)gach %> </td>
	   <td  style="text-align: right;"  class="gridhdbg" ><%=ndf.format(gper) %> </td>
	   <td  style="text-align: right;"  class="gridhdbg" ><%=ndf.format(gw) %> </td>
	  </tr>
