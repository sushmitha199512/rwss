...
<tr >
		<td align="center" colspan=13><b>Schemes Handing over to GP 's</b></td>	
	</tr>
		<tr >
		<td rowspan=2 align=center>Sl.No</td>
		<td  rowspan=2 align=center>District</td>
<td align=center colspan=5 nowrap >Works <br></br><font color="red"><b></b></font></td>
<td align=center rowspan=2 nowrap >Percentage</td>
<td  align=center rowspan=2 nowrap >Weightage</td>
...
<td  align="center"  >No</td>
 <td   align="center"  >Est.Cost</td>
 	<td  align="center"  >No. Of Schemes Completed<br>(Target)</br></td>
 	<td  align="center"  >No. Of Schemes Commissioned<br>(Achievement)</br></td>
 	<td  align="center"  >No. Of Schemes Handed over to GramPanchayat's</td>
...
//	System.out.println("dprlan****111**"+dprlan);
	...
	//
		 ...
		 styleCount++;
		  ...
		  <td  style="text-align: center;"><%=ndf.format(v2)%></td>
		   <td  style="text-align: center;"><%=noc %></td>
		    <td style="text-align: center;"><%=noc1 %></td>
		    <td style="text-align: center;"><%=handing %></td>
		     <td  style="text-align: center;"><%=ndf.format(i1) %></td>
		  <td style="text-align: center;"><%=ndf.format(i2) %></td>
	  ...
	  <td  style="text-align: center;"  ><%=gtn %> </td>

 <td  style="text-align: center;"   ><%=ndf.format(gv2)%> </td>
 <td  style="text-align: center;"   ><%=ndf.format(gnoc)%> </td>
 <td  style="text-align: center;"  ><%=ndf.format(gnoc1)%> </td>
 <td  style="text-align: center;"  ><%=ndf.format(ghanding)%> </td>
 <td  style="text-align: center;"  ><%=ndf.format(gper) %> </td>
 <td  style="text-align: center;"  ><%=ndf.format(gw) %> </td>
	  </tr>
