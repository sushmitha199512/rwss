...
StringBuffer financialstartyr=new StringBuffer();
	...
	if(session.getAttribute("financialstartyr")!=null)
	{
	  financialstartyr.append(session.getAttribute("financialstartyr"));
	}
	System.out.println("financialyr>>>>>>>>>>>>>......"+financialstartyr);
  //schemes
//String scheme="";
StringBuffer scheme=new StringBuffer();
if(session.getAttribute("scheme")!=null)
{
...
<tr >
		<td align="center" class="gridhdbg" colspan=15 ><font color="white"><b>Schemes - (Physical & Financial)<%=startyr.toString() %>-<%=endyr.toString() %></b></font></td>	
	</tr>		
<tr >
		<td align="center" class="gridhdbg" colspan=16 ><font color="white"><b>Schemes - (Physical & Financial)<%=startyr.toString() %>-<%=endyr.toString() %></b></font></td>	
	</tr>		
			<tr >
