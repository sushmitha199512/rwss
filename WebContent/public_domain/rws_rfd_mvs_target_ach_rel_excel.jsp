...
response.setHeader("Content-Disposition", "inline; filename="
		+ "Mvs_Target_Achievement_rel.xls");
...
<tr >
		<td align="center" class="gridhdbg" colspan=8><b>Works Program under MVS <%=cYear %>-<%=nYear %></b></td>	
	</tr>
		<tr >
...
/******************************************************/
		...
		style.delete(0,style.length());
		 ...
		 styleCount++;
		  ...
		  <td class="<%=style %>" style="text-align: right;"><%=svsTargetHabs %></td><td class="<%=style %>" style="text-align: right;" ><%=ndf.format(bankpaoupto) %></td><td class="<%=style %>" style="text-align: right;" ><%=ndf.format(bankpaocurrent) %></td><td class="<%=style %>" style="text-align: right;" ><%=ndf.format(bankpaotot) %></td></tr>
