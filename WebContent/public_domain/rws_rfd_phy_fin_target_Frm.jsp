...
function unview()
{
  ...
  var year2=finyear.substring(5,9);
     var cyear=new Date().getFullYear() ;
		...
		if(logValue=="admin" || logValue=="100000" || logValue=="secrwss")
		{
...
document.f1.distname.value = document.f1.combo.options[document.f1.combo.options.selectedIndex].text;
			...
			else
		{
		    ...
		    document.f1.action="./rws_rfd_phy_fin_target_rpt.jsp";
...
<%} %>
	...
	<tr bgcolor="#8A9FCD" align="center">
		<td align="center" class="rptHeading" colspan=4>Schemes - (Physical & Financial)</td>
	</tr>
