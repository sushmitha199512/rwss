...
<tr>
		<td align="center" colspan=13><b>DPR Permissions Report&nbsp;<%=cYear %>-<%=nYear %></b></td>	
	</tr>
		<tr >
...
<td  colspan=6 align=center > <br><font color="red"><b></b></font></br></td>
 
</tr>
<tr>
<td   align="center"  >Total Works</td>
 <td  align="center"  >Est.Cost</td>	
 <td  align="center"  >No. of works for which permissions pending</td>
 
 <td   align="center"  >Work Wise Obtained</td>
  <td  align="center"  >permissions pending target</td>
 <td   align="center"  >Permissions cleared(Obtained achi)</td>
	...
	*/
		...
		pendingweight=(allsumpercentage/100)*5;
		 ...
		 styleCount++;
		  ...
		  <td  style="text-align: right;"><%=svsTargetHabs %></td>
		  <td  style="text-align: right;" ><%=ndf.format(s2) %></td>
		  <td  style="text-align: right;" ><%=dprpend %></td>
		 
		  
		    <td style="text-align: right;" ><%=dprpendnot%></td>
		    
		    <td  style="text-align: right;" ><%=pendingsumCASE%></td>
		    <td  style="text-align: right;" ><%=obtinedsumCASE%></td>
		    
		      <td style="text-align: right;" ><%=ndf.format(allsumpercentage)%></td>
		        <td style="text-align: right;" ><%=ndf.format(pendingweight)%></td>
		  <% 
	  ...
	  <td  style="text-align: right;"><%=ongoingw %></td>
	  <td  style="text-align: right;"><%=ndf.format(totexp1)%></td>
	  <td   style="text-align: right;"><%=dprpendtot %></td>
	   <td style="text-align: right;"><%=gpendingsumCASE1%></td>
	  <td  style="text-align: right;"><%=dprpendtot1 %></td>
	  
	   <td  style="text-align: right;"><%=gobtCASE1 %></td>
	   <%gallsumpercentage+=allsumpercentage;
	   gpendingweight+=pendingweight;
	   %>
	   <td  style="text-align: right;"><%=gallsumpercentage %></td>
	   
	   <td  style="text-align: right;"><%=gpendingweight%></td>
	  </tr>
