...
function physicalChart(){
	...
	if(chart1XML==""){
		var URL1="<rws:context page='/public_domain/rws_process_graph_data.jsp?type=phy' />";
...
function finChart(){
	...
	if(chart2XML==""){
		var URL1="<rws:context page='/public_domain/rws_process_graph_data.jsp?type=fin' />";
