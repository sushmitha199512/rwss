...
var jsPDF = function(orientation,unit,pageFormat,unkwnBool){
	...
	var beginPage = function() {
		...
		if (orientation === 'p' || orientation === 'portrait') {
			pageHeight = pageFormats[pageFormat][1] / k;
			pageWidth = pageFormats[pageFormat][0] / k;
		} else if (orientation === 'l' || orientation === 'landscape') {
            pageHeight = pageFormats[pageFormat][0] / k;
			pageWidth = pageFormats[pageFormat][1] / k;
        } else {
