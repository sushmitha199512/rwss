...
function showCalendar(dateField,ev,new_title) {
    title = "Calendar" ; 
    if(new_title) { 
    	title = new_title ; 
    }	
...
function buildBottomCalFrame() {       
	...
	dynamicDate.setFullYear(year,month,j);
	//alert(dynamicDate);
	var paddingChar = "&nbsp;";
		...
		{
			calDoc += "<TD align=center bgcolor='" + cellColor + "' title='Future Date Not Allowed'><font face=verdana size=2 color=black>" +
                  "" + padding + currentDay + paddingChar + "</font></TD>";
		}
        columnCount++;
