...
var MENU_ITEMS =[
	["Administration", null,
		...
		//["User Roles", "switch.do?prefix=/admin&page=/UserRolesData.do"],
		["Change Password", "switch.do?prefix=/admin&page=/rws_change_password_frm.jsp"],
		["User Audit", "switch.do?prefix=/masters&page=/UserAudit.do&mode=data"],
		["General Admin", null]
	],
	["Masters", null,
		["General",null,
			...
			["Technical Sanction Monetary Limit","switch.do?prefix=/masters&page=/Tslimit.do&mode=data"]
		],
		["Habitation",null,
		...
		["Offices",null,
			...
			["Head Of Office ","switch.do?prefix=/masters&page=/Hoffice.do&mode=data"]
		],
		["Employee Details",null,
			...
			["Work Specialization","switch.do?prefix=/masters&page=/WorkSpecial.do&mode=data"],
		...
		["Head Of Accounts",null,
			...
			["Sub Major Head","switch.do?prefix=/masters&page=/SubMajorHead.do&mode=data"],
			...
			["Sub Detail Head","switch.do?prefix=/masters&page=/SubDetailHead.do&mode=data"]
		...
		["Water Quality",null,
			...
			["Contamination Master","switch.do?prefix=/masters&page=/Contam.do&mode=data"]
		]/*,
	...
	["Work Flow", null,
		...
		["Contractor Management", null,
			...
			["Tender Application","switch.do?prefix=/contractor&page=/TenderApplication.do&mode=data"],
	...
	["Reports", null,
		["Master Reports",null,
			["Habitation",null,
   			    ["Habitations Last Updated","./reports/rws_hab_update_frm.jsp"],
			...
			//	["Asset","./reports/rws_asset_frm.jsp"],
				...
				["Check List-SubComponents","switch.do?prefix=/reports&page=/CheckList.do?mode=data"]
