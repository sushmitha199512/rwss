...
function init()
{
	...
	menus[1].addItem("./reports/rws_financial_exp_porting_frm.jsp", "", 30, "left", "Porting - Fin Progress(Excel)", 0);
    menus[1].addItem("./reports/rws_physical_mpr_porting_frm.jsp", "", 30, "left", "Porting - Phy Progress(Excel)", 0);
  	menus[1].addItem("switch.do?prefix=/reports&page=/accessPorting.do", "",32, "left","MPR Porting(Access)", 0);	
    menus[1].addItem("switch.do?prefix=/reports&page=/PSExcel.do", "",32, "left","ProjectShelf Porting(Access)", 0);
    
    menus[1].addItem("/pred/reports/rws_udate_count_frm.jsp", "", 30, "left", "Data Entry Statistics", 0);
	menus[1].addItem("./admin/rws_general_admn_login.jsp", "", 22, "left", "General Admin", 0);
  ...
  //  menus[12].addItem("#", "", 22, "left", "Contractor Management", 16);
	...
	//menus[12].addItem("#", "", 22, "left", "Stock Management", 0);
		      ...
		      menus[15] = new menu(300, "vertical", 0, 0, 0, 0, "#E1E1E1", "#8A9FCD", "Verdana,Helvetica", 9, "bold", "bold", "black", "white", 1, "gray", 2, 62, false, true, false, false, 0, true, 4, 4, "#cccccc");
								...
								menus[15].addItem("switch.do?prefix=/wquality&page=/WaterLabTesting.do&mode=data", "", 22, "left", "Lab Testing", 0);
				menus[15].addItem("switch.do?prefix=/wquality&page=/WaterSample.do&mode=data", "", 22, "left", "FTK Testing", 0);
	...
	menus[17].addItem("#", "", 22, "left", "Habitations", 75);
	menus[17].addItem("#", "", 22, "left", "Assets", 42);
	menus[17].addItem("#", "", 22, "left", "WaterQuality", 76);
    //menus[17].addItem("#", "", 22, "left", "FundAccounting", 77);
    menus[17].addItem("#", "", 22, "left", "Works Monitoring", 77);
...
//	menus[19].addItem("#", "", 22, "left", "Estimates", 25);
	...
	menus[19].addItem("#", "", 22, "left", "Data Entry GAP's", 79);
	...
	menus[26].addItem("./reports/rws_dist_wise_gisentrydet_rpt.jsp", "", 18, "left", "GIS Entry Details Report", 0);	
   ...
   //////////////////
	...
	menus[27].addItem("./reports/rws_sourcesgis_frm.jsp","", 22, "left", "GIS Sources Information Report", 0);
	////added by jyothi
	menus[27].addItem("./reports/rws_onlyschemes_distwise_rpt.jsp", "", 35, "left", "Covered by Schemes(Assets Data)", 0);
    menus[27].addItem("./reports/rws_onlyhp_distwise_rpt.jsp", "", 35, "left", "Covered by HPs(Assets Data)", 0);
   ...
   //////////////////
	...
	menus[24] = new menu(400, "vertical", 0, 0, 0, 0, "#E1E1E1", "#8A9FCD", "Verdana,Helvetica", 9, "bold", "bold", "black", "white", 1, "gray", 2, 62, false, true, false, false, 0, true, 4, 4, "#cccccc");
	 ...
	 menus[24].addItem("./reports/rws_wq_samples_frm.jsp", "", 25, "left", "Abstract- Samples Vs All Tests",0);
	 menus[24].addItem("./reports/rws_wq_sam_res_loc_frm.jsp", "", 22, "left", "Status Report-District Wise", 0); 
 
	 menus[24].addItem("./reports/rws_water_nsshabs_frm_rpt.jsp", "", 25, "left", "Habitation Vs Water Quality (Flouride,Salinity)", 0); 
	...
	menus[24].addItem("./reports/rws_WQ_Habs_Coverage_Frm.jsp", "", 29, "left", "Habitation Coverage By Test Results(Priority Based)",0);
	 ...
	 menus[24].addItem("./reports/rws_ftk_test_result_frm.jsp", "", 22, "left", "Ftk Test Results", 0); 
		 ...
		 menus[24].addItem("./reports/rws_wq_data_proforam_frm.jsp", "", 22, "left", "Source ProForma I", 0);
...
menus[28].addItem("./help/drought.doc", "", 22, "left", "Drought", 0);
     menus[28].addItem("./help/Directbills.doc", "", 29, "left", "Direct Bills / Direct Vouchers", 0);
    menus[28].addItem("./help/forgetpassword.doc", "", 29, "left", "Forget Password", 0);
...
////su menu items of WORKFLOW-PROPOSAL
	...
	//	menus[36].addItem("/pred/works/ProgressReportOBEntry.do?mode=openingBalanceFrm", "", 22, "left", "Opening Balance Entry Form", 0);
		...
		menus[36].addItem("switch.do?prefix=/works&page=/Auglinkmain.do?mode=data&mode1=circles", "", 22, "left", "Update Action Plan", 0); 
		...
		menus[36].addItem("switch.do?prefix=/works&page=/aap1.do&mode=data&mode1=circles", "", 22, "left", "Probable Date of Comp.", 0);
		menus[36].addItem("switch.do?prefix=/works&page=/WorkLink.do&mode=data", "", 22, "left", "Work Link(Old/New)", 0);
		menus[36].addItem("switch.do?prefix=/works&page=/HabLink.do&mode=data", "", 22, "left", "Work Hab Link", 0);
		menus[36].addItem("switch.do?prefix=/works&page=/MultipleSource.do&mode=init", "", 22, "left", "Multi Source Entry", 0);
		
		//menus[36].addItem("switch.do?prefix=/works&page=/OfficeChange.do&mode=data&special=reset", "", 22, "left", "Office Change for  Work", 0);
	   ...
	   // "Works Monitoring Reports"
		...
		menus[37].addItem("./reports/rws_hab_cov_frm.jsp", "", 22, "left", "Coverage of Habs- Work Completion", 0);           				
		menus[37].addItem("switch.do?prefix=/reports&page=/flexReport1.do?mode=inFlexi", "", 22, "left", "Free Format Report", 0);
menus[37].addItem("#", "", 22, "left", "HabScore Card", 83);
menus[37].addItem("#", "", 22, "left", "RFD", 80);
menus[37].addItem("#", "", 22, "left", "RFD-SECRETARY", 81);
		menus[37].addItem("#", "", 22, "left", "Performance Reports", 78);
	   ...
	   // menus[37].addItem("./reports/rws_work_admn_tech_frm.jsp", "", 22, "left", "Difference In Admn and Tech Habs", 0);
		...
		menus[37].addItem("./reports/rws_PhyCom_FinNotCom_frm.jsp", "", 22, "left", "Phy Completed Fin Not Completed Works ", 0);  
		menus[37].addItem("./reports/rws_works_not_having_habs_frm.jsp", "", 22, "left", "Works-Habs", 0);  
		menus[37].addItem("#", "", 22, "left", "Analysis Reports", 74);
		 //menus[37].addItem("./reprots/rws_financial_exp_porting_frm.jsp", "", 22, "left", "Financial Expenditure", 0);
        // menus[37].addItem("./reprots/rws_physical_mpr_porting_frm.jsp", "", 22, "left", "Physical Expenditure", 0);
		...
		menus[40] = new menu(280, "vertical", 0, 0, 0, 0, "#E1E1E1", "#8A9FCD", "Verdana,Helvetica", 9, "bold", "bold", "black", "white", 1, "gray", 2, "rollover:images/tri-right1.gif:images/tri-right2.gif", false, true, false, false, 0, true, 4, 4, "#cccccc");
	...
	//	menus[40].addItem("switch.do?prefix=/fundAccounting&page=/broDetailsList.do&mode=getBroList_frm", "", 22, "left", "List BRO", 0);      
				menus[40].addItem("./works/rws_work_parta_bill_frm.jsp", "", 22, "left", "Part-A Bills & Voucher Payments", 0);
		menus[40].addItem("./works/rws_work_bill_frm.jsp", "", 22, "left", "Bills", 0);
	
		menus[40].addItem("#", "", 22, "left", "Voucher Payments", 57);

		menus[40].addItem("./masters/rws_direct_bills_payment.jsp", "", 22, "left", "Direct Bills", 0);      
		menus[40].addItem("./masters/rws_work_direct_voucher_frm.jsp", "", 22, "left", "Direct Vouchers", 0);      
...
//		menus[40].addItem("./fundAccounting/rws_push_bills_frm.jsp", "", 22, "left", "Push Bills", 0);
		...
		menus[41] = new menu(500, "vertical", 0, 0, 0, 0, "#E1E1E1", "#8A9FCD", "Verdana,Helvetica", 9, "bold", "bold", "black", "white", 1, "gray", 2, "rollover:images/tri-right1.gif:images/tri-right2.gif", false, true, false, false, 0, true, 4, 4, "#cccccc");
//menus[41].addItem("switch.do?prefix=/fundAccounting&page=/releasesVsExpenditureWorkWise.do&mode=init", "", 18, "left", "Releases Vs Expenditure", 0);      
	...
	//	menus[41].addItem("switch.do?prefix=/fundAccounting&page=/releasesVsExpenditureProgrammeWise.do&mode=ProgWiseDrillFrm", "", 18, "left", "Programme Wise Rpt2 Releases Vs Expenditure", 0);
		...
		menus[41].addItem("./reports/rws_program_works_rpt.jsp", "", 22, "left", "Work-Program Releases", 0);
		menus[41].addItem("./reports/rws_precedings_adit_frm.jsp", "", 22, "left", "Audit - Releases Vs Expenditure", 0);
				menus[41].addItem("./reports/rws_voucher_audit_frm.jsp", "", 22, "left", "Audit - Releases Vs Expenditure1", 0);
		...
		menus[42].addItem("./reports/assetReports/rws_graph_frm1.jsp", "", 32, "left", "All Asset Types", 0);      
		menus[42].addItem("./reports/rws_distwise_assets_graph_frm.jsp", "", 18, "left", "District Wise Assets Graph", 0);	
		menus[42].addItem("./reports/rws_graph_frm.jsp", "", 22, "left", "BoreWell Status", 0);
	 ...
	 menus[45].addItem("switch.do?prefix=/reports&page=/GisTables.do", "",22, "left","GIS Tables Data", 0);
	 	 menus[45].addItem("./reports/rws_download_newfrm.jsp", "",22, "left","DDWS Portings",82 );
	...
	menus[51].addItem("./reports/rws_work_general_abstract_rpt_p.jsp", "", 18, "left", "General Abstract Report -Revised", 0);  
	...
	menus[52].addItem("./reports/rws_habs_cov_schemes_rpt.jsp", "", 35, "left", "Covered by Schemes(Water Supply)", 0);
	menus[52].addItem("./reports/rws_hab_cov_hps_rpt.jsp", "", 35, "left", "Covered by HPs(Water Supply)", 0);
	
	menus[52].addItem("./reports/rws_list_habs_notcovered_frm.jsp", "", 22, "left", "Not Covered by Schemes", 0);
	...
	menus[58].addItem("switch.do?prefix=/contractor&page=/ContractorChange.do&mode=get2", "", 22, "left", "Contractor Change Entry", 0);
	...
	// menus[61].addItem("./reports/rws_Slipage_hab_frm.jsp", "", 22, "left", "Slippage Report", 0);	
	 menus[61].addItem("./reports/rws_slippagetable_hab_frm.jsp", "", 22, "left", "Slipped Habitations", 0);
	  ...
	  menus[62] = new menu(310, "vertical", 0, 0, 0, 0, "#E1E1E1", "#8A9FCD", "Verdana,Helvetica", 9, "bold", "bold", "black", "white", 1, "gray", 2, "rollover:images/tri-right1.gif:images/tri-right2.gif", false, true, false, false, 0, true, 4, 4, "#cccccc");
      menus[62].addItem("switch.do?prefix=/masters&page=/Contractor.do&mode=getContractorlist&special=reset", "", 22, "left", "Contractor Performance Report", 0);
	 menus[62].addItem("./reports/Contractor/rws_contractor_frm.jsp", "", 22, "left", "Contractor Status Report", 0);
...
//added by swapna
		...
		menus[67].addItem("./reports/rws_work_refund_bank_rpt.jsp","", 22, "left", "Refunds Abstract", 0);	
		...
		menus[70].addItem("./reports/rws_Exp_Rel_Pro_groupsec_frm.jsp", "", 18, "left", " ProgrammeWise(NRDWP) Rel VS Exp ",0);
      ...
      //added by jyothi on 31-03-2012 for ss tanks
      menus[71].addItem("switch.do?prefix=/drought&page=/sstank.do&mode=data&special=reset", "", 22, "left", "Drought SS Tanks", 0);
     //added by jyothi on 16072012 
	 menus[71].addItem("switch.do?prefix=/drought&page=/AdminstrativeSanction.do&mode=null", "", 22, "left", "Drought Works", 0);
    //end
	...
	menus[72].addItem("./reports/rws_drought_deepen_abst_frm.jsp","", 22, "left", "Contingency Plan Abstract-2", 0);
	menus[72].addItem("./reports/rws_drought_daily_rpt.jsp","", 22, "left", "Daily Report", 0);
     ...
     //added by jyothi for ss tank rep on 31-03-2012

menus[72].addItem("./reports/rws_drought_distwise_sstank_rpt.jsp", "", 22, "left", "SS Tank- Detailed", 0);
    menus[72].addItem("./reports/rws_sstank_consolidated_rpt.jsp", "", 22, "left", "SS Tank- Consolidated", 0);
        menus[72].addItem("./reports/rws_drought_contigencyplan_habs_frm.jsp", "", 22, "left", "Contengency New Drought", 0);
       menus[72].addItem("./reports/rws_drought_drinking_water_situation_frm.jsp", "", 22, "left", "Drought Daily Report(Drinking Water)", 0);
    ...
    //end
	    ...
	    menus[73].addItem("switch.do?prefix=/drought&page=/Scarcity.do&mode=data", "", 22, "left", "Scarcity Master ", 0);
		  ...
		  menus[74] = new menu(260, "vertical", 0, 0, 0, 0, "#E1E1E1", "#8A9FCD", "Verdana,Helvetica", 9, "bold", "bold", "black", "white", 1, "gray", 2, "rollover:images/tri-right1.gif:images/tri-right2.gif", false, true, false, false, 0, true, 4, 4, "#cccccc");
	      menus[74].addItem("./reports/rws_work_admn_tech_frm.jsp", "", 22, "left", "Difference In Admn and Tech Habs", 0);
        menus[74].addItem("./reports/rws_work_pendency_frm.jsp", "", 22, "left", "Work Pendency  Status Report", 0);	
		menus[74].addItem("switch.do?prefix=/works&page=/workgap.do?mode=data", "", 22, "left", "Gap Report", 0);
	   menus[74].addItem("./reports/rws_works_exception_frm.jsp", "", 22, "left", "Status of Work Progress Report", 0);
	  
	
     //added by laxmi on 16072012
     menus[75] = new menu(260, "vertical", 0, 0, 0, 0, "#E1E1E1", "#8A9FCD", "Verdana,Helvetica", 9, "bold", "bold", "black", "white", 1, "gray", 2, "rollover:images/tri-right1.gif:images/tri-right2.gif", false, true, false, false, 0, true, 4, 4, "#cccccc");
	 menus[75].addItem("./reports/rws_coveragefc_status_graph_frm.jsp", "", 22, "left", "Coverage Status", 0);
	menus[75].addItem("./reports/rws_nss_habitations_graph_frm.jsp", "", 22, "left", "NSS Habitations", 0);
	menus[75].addItem("./reports/rws_graph_frm1.jsp", "", 22, "left", "FC-Proposed Year", 0);
    menus[75].addItem("./reports/rws_graph_frm2.jsp", "", 22, "left", "FC-Proposed Est.Cost", 0);
        
   menus[76] = new menu(260, "vertical", 0, 0, 0, 0, "#E1E1E1", "#8A9FCD", "Verdana,Helvetica", 9, "bold", "bold", "black", "white", 1, "gray", 2, "rollover:images/tri-right1.gif:images/tri-right2.gif", false, true, false, false, 0, true, 4, 4, "#cccccc");
   menus[76].addItem("./reports/rws_graph_waterquality_frm.jsp", "", 22, "left", "Water Quality Samples  Graph", 0);
   menus[76].addItem("./reports/rws_wq_contamination_graph_frm.jsp", "", 18, "left", "Habitaions Contaminated with Paramteres ", 0);	
   
    //menus[77] = new menu(260, "vertical", 0, 0, 0, 0, "#E1E1E1", "#8A9FCD", "Verdana,Helvetica", 9, "bold", "bold", "black", "white", 1, "gray", 2, "rollover:images/tri-right1.gif:images/tri-right2.gif", false, true, false, false, 0, true, 4, 4, "#cccccc");
	//menus[77].addItem("./reports/rws_graph_exp_frm.jsp", "", 22, "left", "Work Expenditure", 0);
    
    menus[77] = new menu(340, "vertical", 0, 0, 0, 0, "#E1E1E1", "#8A9FCD", "Verdana,Helvetica", 9, "bold", "bold", "black", "white", 1, "gray", 2, "rollover:images/tri-right1.gif:images/tri-right2.gif", false, true, false, false, 0, true, 4, 4, "#cccccc");
	//menus[77].addItem("./reports/rws_work_abstract_graph_frm.jsp", "", 22, "left", "Works General Graph", 0);
     menus[77].addItem("./reports/rws_graph_work_plan_frm.jsp", "", 22, "left", "Works In Progress( Plan / Non Plan )", 0);
     menus[77].addItem("./reports/rws_wrks_progress_graph_frm.jsp", "", 18, "left", "Work Progress Graph", 0);
     
     
       menus[78] = new menu(340, "vertical", 0, 0, 0, 0, "#E1E1E1", "#8A9FCD", "Verdana,Helvetica", 9, "bold", "bold", "black", "white", 1, "gray", 2, "rollover:images/tri-right1.gif:images/tri-right2.gif", false, true, false, false, 0, true, 4, 4, "#cccccc");
	   
	   menus[78].addItem("./reports/rws_performance_sc_st_frm.jsp", "", 22, "left", "PLAIN,SC,ST SVS-ABSTRACT ", 0);
	   menus[78].addItem("./reports/rws_performance_mvs_scst_frm.jsp", "", 22, "left", "PLAIN,SC,ST MVS-ABSTRACT ", 0);
	   
	   menus[78].addItem("./reports/rws_works_program_details_frm.jsp", "", 22, "left", "Abstract Works Spill Over/ New ", 0);
	    menus[78].addItem("./reports/rws_work_status_new_frm.jsp", "", 22, "left", "Completed  Not Commisioned", 0);
	    menus[78].addItem("./reports/rws_work_program_fin_notcompl_frm.jsp", "", 22, "left", "Financially Not Completed ", 0);
	    
	   menus[78].addItem("./reports/rws_schools_monitoring_rpt.jsp", "", 22, "left", "Schools", 0);
	   menus[78].addItem("./reports/rws_totalnolabs_frm.jsp", "", 22, "left", "LAB ABSTRACT ", 0);
	   menus[78].addItem("./reports/rws_totalnowatersample_frm.jsp", "", 22, "left", "FTK ABSTRACT ", 0);
	
	   
	    menus[79] = new menu(340, "vertical", 0, 0, 0, 0, "#E1E1E1", "#8A9FCD", "Verdana,Helvetica", 9, "bold", "bold", "black", "white", 1, "gray", 2, "rollover:images/tri-right1.gif:images/tri-right2.gif", false, true, false, false, 0, true, 4, 4, "#cccccc");
	   menus[79].addItem("./reports/rws_habsupplyasset_frm.jsp", "", 22, "left", "Hab Supply Status and Assets ", 0);
	 
	  
      menus[80] = new menu(380, "vertical", 0, 0, 0, 0, "#E1E1E1", "#8A9FCD", "Verdana,Helvetica", 9, "bold", "bold", "black", "white", 1, "gray", 2, "rollover:images/tri-right1.gif:images/tri-right2.gif", false, true, false, false, 0, true, 4, 4, "#cccccc");
	   menus[80].addItem("./reports/rws_constituency_frm.jsp", "", 22, "left", "CS Report", 0);
	   	   menus[80].addItem("./reports/rws_lab_onesource_tested_rpt.jsp", "", 22, "left", "WQ Tested Habs", 0);
	   menus[80].addItem("./reports/RFDReports/rws_fin_phy_prg_ach_frm.jsp", "", 22, "left", "Financial and Physical Achievements", 0);
	   menus[80].addItem("./reports/rws_work_dpr_fin_frm.jsp", "", 22, "left", "DPR Status Progress Report", 0);
menus[80].addItem("./reports/rws_work_dpr_fin_StatusPermissions_frm.jsp", "", 22, "left", "DPR Permission Status", 0);
menus[80].addItem("./reports/RFDReports/rws_rfd_schools_rpt.jsp", "", 40, "left", "Coverage of Schools/Anganwadis with Drinking Water Facilities", 0);

   menus[80].addItem("./reports/rws_svs_mvs_detail_rpt.jsp", "", 22, "left", "SVS - MVS", 0);
   menus[80].addItem("./reports/rws_svs_mvs_prevcomp_curr_update_rpt.jsp", "", 32, "left", "Work Completion Date Updation ", 0);
      menus[80].addItem("./reports/rws_susworks_finphy_details_rpt.jsp", "", 22, "left", "Sustainbility Structures", 0);
     menus[80].addItem("./reports/RFDReports/rws_WQ_RFD_lab_frm.jsp", "", 22, "left", "Water Quality-Lab Abstract", 0);
          menus[80].addItem("./reports/rws_ftk_test_ftkuptomonth_frm.jsp", "", 22, "left", "Water Quality-FTK Abstract", 0);
            menus[80].addItem("./reports/RFDReports/rws_asset_habs_status_rpt.jsp", "", 22, "left", "Scheme(MVS)-Hab Status", 0);
                     menus[80].addItem("./reports/RFDReports/rws_asset_habs_status_svs_rpt.jsp", "", 22, "left", "Scheme(SVS)-Hab Status", 0);
                     menus[80].addItem("./reports/RFDReports/rws_drought_works_abstract_rpt.jsp", "", 22, "left", "Drought Works Status", 0);
          
    
      menus[81] = new menu(380, "vertical", 0, 0, 0, 0, "#E1E1E1", "#8A9FCD", "Verdana,Helvetica", 9, "bold", "bold", "black", "white", 1, "gray", 2, "rollover:images/tri-right1.gif:images/tri-right2.gif", false, true, false, false, 0, true, 4, 4, "#cccccc");
	   menus[81].addItem("./reports/rws_programe_milestone_frm.jsp", "", 22, "left", "Works Milestone Wise Abstract", 0);
	   menus[81].addItem("./reports/rws_not_forward_bill_rpt.jsp", "", 22, "left", "Pending Bills Abstract", 0);
	   
	   
	   menus[81].addItem("./Secretary/rws_works_program_details_frm.jsp", "", 22, "left", "Abstract Works Spill Over/ New", 0);
	   	   menus[81].addItem("./Secretary/rws_work_dpr_sec_StatusP_drill_frm.jsp", "", 22, "left", "Permission Pending Status", 0);
	   	   	   menus[81].addItem("./Secretary/rws_work_dpr_fin_secpro_frm.jsp", "", 22, "left", "DPR Status Progress Report", 0);
	   	   	   	   menus[81].addItem("./Secretary/rws_rfd_schools_rpt.jsp", "", 30, "left", "Coverage of Schools/Anganwadis with Drinking Water Facilities", 0);
	   	   	   	   	   menus[81].addItem("./Secretary/rws_svs_mvs_prevcomp_curr_update_rpt.jsp", "", 22, "left", "Work Completion Date Updation", 0);
	   	   	   	   	   	   menus[81].addItem("./Secretary/rws_work_program_fin_notcompl_frm.jsp", "", 30, "left", "Physically completed and Financially not completed", 0);
	   	   	   	   	   	   	   menus[81].addItem("./Secretary/rws_WQ_RFD_lab_frm.jsp", "", 22, "left", "Water Quality-Lab Abstract ", 0);
	   	   	   	   	   	   	   	   menus[81].addItem("./Secretary/rws_ftk_test_ftkuptomonth_sec_frm.jsp", "", 22, "left", "Water Quality-FTK Abstract ", 0);
	   	   	   	   	   	   	   	   	   menus[81].addItem("./reports/RFDReports/rws_asset_habs_status_rpt.jsp", "", 22, "left", "Scheme(MVS)-Hab Status", 0);
	   	   	   	   	   	   	   	   	   	   menus[81].addItem("./reports/RFDReports/rws_asset_habs_status_svs_rpt.jsp", "", 22, "left", "Scheme(SVS)-Hab Status", 0);
	   	   	   	   	   	   	   	   	   	   	   menus[81].addItem("./Secretary/rws_drought_works_abstract_rpt.jsp", "", 22, "left", "Drought Works Status", 0);
	   	   	   	   	   	   	   	   	   	   	   	   	   	   	   	   	   	   	   	   	   	   menus[81].addItem("./reports/rws_wq_data_proforam_frm.jsp", "", 22, "left", "Proforma-1", 0);
	   	   	   	   	   	   	   	   	   	   	   	   	   	   	   	   	   	   	   	   	   	   menus[81].addItem("./reports/rws_habs_nocordinates_frm.jsp", "", 22, "left", "Habs Details", 0);
	   	   	   	   	   	   	   	   	   	   	   	   	   	   	   	   	   	   	   	   	   	   
	   	   	   	   	   	   	   	   	   	   	   
	   	   	   	   	   	   	   	   	   	   	   
	   	   	   	   	   	   	   	   	   	   	   
	   	   	   	   	   	   	   	   	      menus[82] = new menu(380, "vertical", 0, 0, 0, 0, "#E1E1E1", "#8A9FCD", "Verdana,Helvetica", 9, "bold", "bold", "black", "white", 1, "gray", 2, "rollover:images/tri-right1.gif:images/tri-right2.gif", false, true, false, false, 0, true, 4, 4, "#cccccc");
	   	   	   	   	   	   	   	   	   	   	   menus[82].addItem("switch.do?prefix=/reports&page=/accessPorting.do", "",32, "left","MPR Porting(Access)", 0);	
	 //menus[45].addItem("switch.do?prefix=/reports&page=/PSExcel.do", "",22, "left","ProjectShelf Porting", 0);
	...
	//menus[45].addItem("switch.do?prefix=/reports&page=/ListTables.do", "",22, "left","Tables Data Download", 0);
	 ...
	 menus[82].addItem("switch.do?prefix=/reports&page=/PSExcel.do", "",22, "left","ProjectShelf Porting", 0);
	 menus[82].addItem("switch.do?prefix=/reports&page=/draccessPorting.do", "",42, "left","Drought Porting(Access)", 0);	
	// menus[82].addItem("switch.do?prefix=/reports&page=/WQExcel.do", "",22, "left","WQ LAB Porting", 0);
	// menus[82].addItem("switch.do?prefix=/reports&page=/WQFTKACCESS.do", "",22, "left","WQ FTK Porting", 0);
	 	 menus[82].addItem("switch.do?prefix=/reports&page=/DistrictLevel.do", "",22, "left","District Level Porting", 0);



		  menus[83] = new menu(380, "vertical", 0, 0, 0, 0, "#E1E1E1", "#8A9FCD", "Verdana,Helvetica", 9, "bold", "bold", "black", "white", 1, "gray", 2, "rollover:images/tri-right1.gif:images/tri-right2.gif", false, true, false, false, 0, true, 4, 4, "#cccccc");
	   	  menus[83].addItem("./public_domain/rws_rfd_svs_target_ach_rpt.jsp", "",32, "left","SVS", 0);	
		  menus[83].addItem("./public_domain/rws_rfd_mvs_target_ach_rpt.jsp", "",32, "left","MVS", 0);	

menus[83].addItem("./public_domain/rws_rfd_svs_target_ach_rel_rpt.jsp", "",32, "left","SVS-Releases", 0);	
		  menus[83].addItem("./public_domain/rws_rfd_mvs_target_ach_rel_rpt.jsp", "",32, "left","MVS-Releases", 0);	

				  	   	  menus[83].addItem("./public_domain/rws_rfd_sch_target_ach_rpt.jsp", "",32, "left","Schools", 0);	
						  	   	  menus[83].addItem("./public_domain/rws_rfd_anganavadi_target_ach_rpt.jsp", "",32, "left","Anganwadi", 0);	
