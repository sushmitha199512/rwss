...
function init()
{
	...
	menus[1] = new menu(180, "vertical", 0, 0, -5, -5, "#DEE3E0", "#8A9FCD", "Verdana,Helvetica", 9, "bold", 
...
//Sub Menus for 3rd Main Menu Item ("workflow"):
	...
	menus[12].addItem("#", "", 22, "left", "Drought Monitoring", 65);
...
//Sub Menus for 4rd Main Menu Item ("graphs"):
  ...
  menus[19].addItem("#", "", 22, "left", "Works Monitoring", 37);
	...
	menus[19].addItem("#", "", 22, "left", "Fund Accounting", 40);
	menus[19].addItem("#", "", 22, "left", "Contractor", 59);
    	menus[19].addItem("#", "", 22, "left", "Drought",66);
...
menus[27].addItem("./reports/rws_onlyhp_distwise_rpt.jsp", "", 35, "left", "Covered by HPs(Assets Data)", 0);
       ...
       //
			   ...
			   //////////////////
			    ...
			    menus[24].addItem("./reports/rws_lab_test_frm.jsp", "", 22, "left", "Lab Test Results", 0);		   // code added end
 menus[24].addItem("./reports/rws_wq_data_proforam_frm.jsp", "", 22, "left", "Water Quality Sources Proforma-1", 0);
...
//Sub Menus for Main Menu Item ("Help"):
	...
	menus[28].addItem("#", "", 22, "left", "General Problems", 64);
    ...
    menus[28].addItem("./help/DetailedProjectReport.doc", "", 29, "left", "Detailed Project Report(DPR) Help", 0);
...
//                menus[36].addItem("switch.do?prefix=/works&page=/worksDelete.do&mode=data", "", 22, "left", "Works Deletion", 0);			   
				...
				menus[37].addItem("#", "", 22, "left", "RFD", 68);
				menus[37].addItem("#", "", 22, "left", "RFD-SECRETARY", 69);
				menus[37].addItem("#", "", 22, "left", "Performance Reports", 67);
				...
				menus[37].addItem("#", "", 22, "left", "Gap Reports", 62);
			    menus[37].addItem("#", "", 22, "left", "Adhoc Reports", 63);
				menus[37].addItem("./reports/rws_Aap_frm.jsp", "", 22, "left", "AAP 2011-2012 Works ", 0);//
...
//				menus[40] = new menu(250, "vertical", 0, 0, 0, 0, "#E1E1E1", "#8A9FCD", "Verdana,Helvetica", 9, "bold", "bold", "black", "white", 1, "gray", 2, "rollover:images/tri-right1.gif:images/tri-right2.gif", false, true, false, false, 0, true, 4, 4, "#cccccc");
	         	menus[40] = new menu(290, "vertical", 0, 0, 0, 0, "#E1E1E1", "#8A9FCD", "Verdana,Helvetica", 9, "bold", "bold", "black", "white", 1, "gray", 2, "rollover:images/tri-right1.gif:images/tri-right2.gif", false, true, false, false, 0, true, 4, 4, "#cccccc");
				...
				menus[40].addItem("./reports/rws_payment_details_frm.jsp", "", 22, "left", "Payment Details Report ", 0);
//				menus[36].addItem("./works/rws_work_exp_voucher_frm.jsp", "", 22, "left", "Voucher Payments", 0);			
				menus[40].addItem("./reports/rws_bill_history_frm.jsp", "", 22, "left", "Bill History Report ", 0);
				menus[40].addItem("./reports/rws_Recipents_Paymnets_frm.jsp", "", 22, "left", "Receipts Vs Payments ", 0);
				menus[40].addItem("#", "", 22, "left", "Financial Status Reports", 56);
				menus[40].addItem("#", "", 22, "left", "Bank Reports", 61);
				menus[40].addItem("./reports/rws_billvoucher_division_frm.jsp", "", 22, "left", "Division Wise Bill-Voucher Details ", 0);
				menus[40].addItem("./reports/rws_program_works_rpt.jsp", "", 22, "left", "Work-Program Releases", 0);
			...
			//Reports Employee Check List
				...
				menus[42].addItem("./reports/rws_dist_pop_frm2.jsp", "",22, "left", "Category Wise", 0); 
						menus[42].addItem("./reports/rws_dist_pop_cons.jsp", "",22, "left", "Constituency Wise", 0); 
			...
			//menus[48].addItem("./reports/rws_work_proj_abstract_rpt.jsp", "", 22, "left", "Project Works", 0);  
			...
			//menus[48].addItem("./reports/rws_ongoing_abstract.jsp", "", 22, "left", "Ongoing Works Abstract", 0);
			//menus[48].addItem("./reports/rws_districtwise_statuswise_work_rpt.jsp", "", 22, "left", " NRDWP-COV Works Abstract", 0);
			//menus[48].addItem("./reports/rws_works_frm.jsp", "", 22, "left", "Total Works/Habs ", 0);  
			//menus[48].addItem("./reports/rws_Aap_abstract_frm.jsp", "", 22, "left", "AAP 2011-12", 0);
			//menus[48].addItem("./reports/rws_Aap_abstract_frm.jsp", "", 22, "left", "AAP Target 2011-12", 0);
	       //     menus[48].addItem("./reports/rws_Aap_abstractAch_frm.jsp", "", 22, "left", "AAP Achievement 2011-12", 0);
			...
			//////////////
			menus[49].addItem("./reports/rws_habs_cov_schemes_rpt.jsp", "", 35, "left", "Covered by Schemes(WaterSupply)", 0);
			
			menus[49].addItem("./reports/rws_hab_cov_hps_rpt.jsp", "", 35, "left", "Covered by HPs(WaterSupply)", 0);
			/////////////
			...
			menus[53].addItem("./reports/rws_asset_statement_rpt.jsp", "", 22, "left", "GOI Statement", 0);
			...
			menus[55] = new menu(220, "vertical", 0, 0, 0, 0, "#E1E1E1", "#8A9FCD", "Verdana,Helvetica", 9, "bold", "bold", "black", "white", 1, "gray", 2, "rollover:images/tri-right1.gif:images/tri-right2.gif", false, true, false, false, 0, true, 4, 4, "#cccccc");
			menus[55].addItem("switch.do?prefix=/masters&page=/Contractor.do&mode=data", "", 22, "left", "Contractor Entry", 0);
			menus[55].addItem("switch.do?prefix=/works&page=/WorkStatus.do&mode=contractorUpdate", "", 22, "left", "Update Contractor", 0);
			...
			menus[56].addItem("./reports/rws_bill_tobe_release_rpt.jsp", "", 22, "left", "Division Wise", 0);
			menus[56].addItem("./reports/rws_bill_tobe_release_nrdwp_rpt.jsp", "", 22, "left", "NRDWP Related", 0);			
			menus[56].addItem("./reports/rws_biil_release_program_rpt.jsp", "", 22, "left", "Program Wise", 0);
			menus[56].addItem("./reports/rws_work_details_exp_frm.jsp", "", 22, "left", "Work Wise", 0);
			
			 menus[57] = new menu(230, "vertical", 0, 0, 0, 0, "#E1E1E1", "#8A9FCD", "Verdana,Helvetica", 9, "bold", "bold", "black", "white", 1, "gray", 2, "rollover:images/tri-right1.gif:images/tri-right2.gif", false, true, false, false, 0, true, 4, 4, "#cccccc");
			 menus[57].addItem("switch.do?prefix=/complaints&page=/Complaints.do&mode=get2&special=reset", "", 22, "left", "Complaints Registration", 0);
			 menus[57].addItem("switch.do?prefix=/complaints&page=/Complaintstatus.do&mode=get2&special=reset", "", 22, "left", "Complaints Status", 0);      
			 menus[57].addItem("switch.do?prefix=/complaints&page=/Complaintattended.do&mode=get2&special=reset", "", 22, "left", "Complaints Attended", 0);
			 menus[57].addItem("switch.do?prefix=/complaints&page=/TotalComplaints.do&mode=get2&special=reset", "", 22, "left", "Complaints Report", 0);
		...
		menus[62] = new menu(270, "vertical", 0, 0, 0, 0, "#E1E1E1", "#8A9FCD", "Verdana,Helvetica", 9, "bold", "bold", "black", "white", 1, "gray", 2, "rollover:images/tri-right1.gif:images/tri-right2.gif", false, true, false, false, 0, true, 4, 4, "#cccccc");
		menus[62].addItem("switch.do?prefix=/works&page=/workgap.do?mode=data", "", 22, "left", "Gap Report", 0);
        menus[62].addItem("./reports/rws_work_admn_tech_frm.jsp", "", 22, "left", "Diff. In Admn & Tech Habs", 0);
		menus[62].addItem("./reports/rws_work_probdate_frm.jsp", "", 22, "left", "Probable Completion date View", 0);
		menus[62].addItem("./reports/rws_Pending_works_rpt.jsp", "", 22, "left", "Pending Works Report", 0);
        menus[62].addItem("./reports/rws_works_exception_frm.jsp", "", 22, "left", "Status of Work Progress Report", 0);
        
		menus[63] = new menu(350, "vertical", 0, 0, 0, 0, "#E1E1E1", "#8A9FCD", "Verdana,Helvetica", 9, "bold", "bold", "black", "white", 1, "gray", 2, "rollover:images/tri-right1.gif:images/tri-right2.gif", false, true, false, false, 0, true, 4, 4, "#cccccc");
		menus[63].addItem("switch.do?prefix=/proposals&page=/Workwise.do?mode=circles", "", 22, "left", "WorkWise Report", 0);      
		menus[63].addItem("./reports/rws_prajapatham_workstatus_select.jsp", "", 22, "left", "Work Status", 0);      
		menus[63].addItem("./reports/rws_mnth_frm.jsp", "", 22, "left", "Monthly Progress Report", 0); 				
		menus[63].addItem("./reports/rws_work_valueofwork_notpaid_rpt.jsp?", "", 22, "left", "Value Of Work Done But Not Paid ", 0);           
		menus[63].addItem("./reports/rws_qa_habs_covered_31032010.jsp", "", 22, "left", "QA Habs Covered By 31.03.2010", 0);           
		menus[63].addItem("./reports/rws_spill_ncnsspc1habs_covered_10_11.jsp", "", 22, "left", "Hab Coverage of SpillOver Works", 0);           				
		menus[63].addItem("./reports/rws_work_pendency_frm.jsp", "", 22, "left", "Work Pendency  Status Report", 0);
		menus[63].addItem("./reports/rws_work_exp_frm.jsp", "", 22, "left", "Payment Status Report ", 0);
		menus[63].addItem("./reports/rws_work_vouchers_frm.jsp", "", 22, "left", "Voucher Payment Status Report ", 0);
		menus[63].addItem("./reports/rws_workid_search_frm.jsp", "", 22, "left", "Work ID Based -Work Details", 0);
		menus[63].addItem("./reports/rws_project_shelf_frm.jsp", "", 22, "left", "Project Shelf Districtwise Report", 0);
		menus[63].addItem("./reports/rws_work_ongoing_frm.jsp", "", 22, "left", "Ongoing Works - Habs Benefitted Report", 0);

		menus[64] = new menu(350, "vertical", 0, 0, 0, 0, "#E1E1E1", "#8A9FCD", "Verdana,Helvetica", 9, "bold", "bold", "black", "white", 1, "gray", 2, "rollover:images/tri-right1.gif:images/tri-right2.gif", false, true, false, false, 0, true, 4, 4, "#cccccc");
		menus[64].addItem("FontDownloadHelp.html", "", 22, "left", "Rupee Font Download", 0);
		menus[64].addItem("ScreenshotHelp.html", "", 22, "left", "Screen Shot Help", 0);
		menus[64].addItem("./help/Disable_popup.doc", "", 22, "left", "Enable PopUp Window", 0);

     menus[65] = new menu(250, "vertical", 0, 0, 0, 0, "#E1E1E1", "#8A9FCD", "Verdana,Helvetica", 9, "bold", "bold", "black", "white", 1, "gray", 2, "rollover:images/tri-right1.gif:images/tri-right2.gif", false, true, false, false, 0, true, 4, 4, "#cccccc");
	menus[65].addItem("switch.do?prefix=/drought&page=/PowerTransport.do&mode=get2&special=reset", "", 22, "left", "Habitations For Drought", 0);
	menus[65].addItem("switch.do?prefix=/drought&page=/TransportWaterDetail.do&mode=get2", "", 22, "left", "Daily Entry(TRANS,HIRING)", 0);
    menus[65].addItem("switch.do?prefix=/drought&page=/FlushDeep.do&mode=data&special=reset", "", 22, "left", "Flushing Deepening of Borewells", 0);
    menus[65].addItem("switch.do?prefix=/drought&page=/AdminstrativeSanction.do&mode=null", "", 22, "left", "Drought Works", 0);
    menus[65].addItem("switch.do?prefix=/drought&page=/dailyReprot.do&mode=data&special=reset", "", 22, "left", "Daily Report Abstract Entry", 0);
    
  menus[66] = new menu(350, "vertical", 0, 0, 0, 0, "#E1E1E1", "#8A9FCD", "Verdana,Helvetica", 9, "bold", "bold", "black", "white", 1, "gray", 2, "rollover:images/tri-right1.gif:images/tri-right2.gif", false, true, false, false, 0, true, 4, 4, "#cccccc");

    menus[66].addItem("./reports/rws_drought_frm.jsp","", 22, "left", "Drought Habitations Report", 0);
	menus[66].addItem("switch.do?prefix=/drought&page=/DroughtReport.do&mode=get2", "", 22, "left", "Status report of drought Habitations ", 0);
	menus[66].addItem("./reports/rws_drought_deepen_frm.jsp","", 22, "left", "Abstract Flushing/Deepnening", 0);
		menus[66].addItem("./reports/rws_drought_deepen_abst_frm.jsp","", 22, "left", "Contingency Plan Abstract-2", 0);
	menus[66].addItem("./reports/rws_drought_daily_rpt.jsp","", 22, "left", "Daily Report", 0);
	menus[66].addItem("./reports/rws_drought_habitations_frm.jsp","", 22, "left", "Contingency Abstract Report", 0);
    menus[66].addItem("./reports/rws_drought_daily_comparision_consolidate_rpt.jsp", "", 22, "left", "Daily Comparision ", 0);
    menus[66].addItem("./reports/rws_drought_ongoing_works_rpt.jsp", "", 22, "left", "On Going Works ", 0);
    menus[66].addItem("./reports/rws_drought_distwise_sstank_rpt.jsp", "", 22, "left", "SS Tank- Detailed", 0);
    menus[66].addItem("./reports/rws_sstank_consolidated_rpt.jsp", "", 22, "left", "SS Tank- Consolidated", 0);
    menus[66].addItem("./reports/rws_drought_drinking_water_situation_frm.jsp", "", 22, "left", "Abstract of Daily Report on Drinking Water Situation ( Drought )", 0);
 
	 menus[67] = new menu(340, "vertical", 0, 0, 0, 0, "#E1E1E1", "#8A9FCD", "Verdana,Helvetica", 9, "bold", "bold", "black", "white", 1, "gray", 2, "rollover:images/tri-right1.gif:images/tri-right2.gif", false, true, false, false, 0, true, 4, 4, "#cccccc");
	   menus[67].addItem("./reports/rws_works_program_details_frm.jsp", "", 22, "left", "Abstract Works Spill Over/ New ", 0);
	    menus[67].addItem("./reports/rws_work_program_fin_notcompl_frm.jsp", "", 22, "left", "Financially Not Completed ", 0);
	    menus[67].addItem("./reports/rws_work_status_new_frm.jsp", "", 22, "left", "Completed  Not Commisioned", 0);
	    
	    
	      menus[68] = new menu(380, "vertical", 0, 0, 0, 0, "#E1E1E1", "#8A9FCD", "Verdana,Helvetica", 9, "bold", "bold", "black", "white", 1, "gray", 2, "rollover:images/tri-right1.gif:images/tri-right2.gif", false, true, false, false, 0, true, 4, 4, "#cccccc");
	      menus[68].addItem("./reports/RFDReports/rws_fin_phy_prg_ach_frm.jsp", "", 22, "left", "Financial and Physical Achievements", 0);
	      menus[68].addItem("./reports/RFDReports/rws_rfd_schools_rpt.jsp", "", 40, "left", "Coverage of Schools/Anganwadis with Drinking Water Facilities", 0);
	    	   menus[68].addItem("./reports/rws_work_dpr_fin_frm.jsp", "", 22, "left", "DPR Status Progress Report", 0);
	        menus[68].addItem("./reports/RFDReports/rws_WQ_RFD_lab_frm.jsp", "", 22, "left", "Water Quality-Lab Abstract", 0);
	    
	 menus[68].addItem("./reports/rws_susworks_finphy_details_rpt.jsp", "", 22, "left", "Sustainbility Structures", 0);
     menus[68].addItem("./reports/RFDReports/rws_WQ_RFD_lab_frm.jsp", "", 22, "left", "Water Quality-Lab Abstract", 0);
     menus[68].addItem("./reports/rws_ftk_test_ftkuptomonth_frm.jsp", "", 22, "left", "Water Quality-FTK Abstract", 0);
     menus[68].addItem("./reports/RFDReports/rws_asset_habs_status_rpt.jsp", "", 22, "left", "Scheme(MVS)-Hab Status", 0);
     menus[68].addItem("./reports/RFDReports/rws_asset_habs_status_svs_rpt.jsp", "", 22, "left", "Scheme(SVS)-Hab Status", 0);
     menus[68].addItem("./reports/RFDReports/rws_drought_works_abstract_rpt.jsp", "", 22, "left", "Drought Works Status", 0);
          
  menus[69] = new menu(380, "vertical", 0, 0, 0, 0, "#E1E1E1", "#8A9FCD", "Verdana,Helvetica", 9, "bold", "bold", "black", "white", 1, "gray", 2, "rollover:images/tri-right1.gif:images/tri-right2.gif", false, true, false, false, 0, true, 4, 4, "#cccccc");
	   menus[69].addItem("./Secretary/rws_works_program_details_frm.jsp", "", 22, "left", "Abstract Works Spill Over/ New", 0);
	   	   menus[69].addItem("./Secretary/rws_work_dpr_sec_StatusP_drill_frm.jsp", "", 22, "left", "Permission Pending Status", 0);
	   	   	   menus[69].addItem("./Secretary/rws_work_dpr_fin_secpro_frm.jsp", "", 22, "left", "DPR Status Progress Report", 0);
	   	   	   	   menus[69].addItem("./Secretary/rws_rfd_schools_rpt.jsp", "", 30, "left", "Coverage of Schools/Anganwadis with Drinking Water Facilities", 0);
	   	   	   	   	   menus[69].addItem("./Secretary/rws_svs_mvs_prevcomp_curr_update_rpt.jsp", "", 22, "left", "Work Completion Date Updation", 0);
	   	   	   	   	   	   menus[69].addItem("./Secretary/rws_work_program_fin_notcompl_frm.jsp", "", 30, "left", "Physically completed and Financially not completed", 0);
	   	   	   	   	   	   	   menus[69].addItem("./Secretary/rws_WQ_RFD_lab_frm.jsp", "", 22, "left", "Water Quality-Lab Abstract ", 0);
	   	   	   	   	   	   	   	   menus[69].addItem("./Secretary/rws_ftk_test_ftkuptomonth_sec_frm.jsp", "", 22, "left", "Water Quality-FTK Abstract ", 0);
	   	   	   	   	   	   	   	   	   menus[69].addItem("./reports/RFDReports/rws_asset_habs_status_rpt.jsp", "", 22, "left", "Scheme(MVS)-Hab Status", 0);
	   	   	   	   	   	   	   	   	   	   menus[69].addItem("./reports/RFDReports/rws_asset_habs_status_svs_rpt.jsp", "", 22, "left", "Scheme(SVS)-Hab Status", 0);
	   	   	   	   	   	   	   	   	   	   	   menus[69].addItem("./Secretary/rws_drought_works_abstract_rpt.jsp", "", 22, "left", "Drought Works Status", 0);
