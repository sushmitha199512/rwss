...
function init()
{
	...
	menus[0].addItem("#", "", 80, "center", "Help", 38);
	menus[0].addItem("/pred/Logout.do", "", 80, "center", "LogOut", 0);

	//Sub Menu for 1nd Main Menu Item ("Administrator"):
	menus[1] = new menu(175, "vertical", 0, 0, -5, -5, "#DEE3E0", "#8A9FCD", "Verdana,Helvetica", 9, "bold", 
	...
	menus[2].addItem("switch.do?prefix=/masters&page=/Contractor.do&mode=data", "", 22, "left", "Contractor", 0);
    ...
    menus[12].addItem("/pred/underConstruction.do", "", 22, "left", "Complaints Monitoring", 0);  
 ...
 //   menus[17].addItem("#", "", 22, "left", "Proposal", 18);
  ...
  //  menus[19].addItem("#", "", 22, "left", "Pendency Status", 23);
	...
	menus[19].addItem("#", "", 22, "left", "Contractor Mgmt", 0);
	...
	menus[19].addItem("#", "", 22, "left", "Drought Reports ", 59);
	...
	menus[20].addItem("#", "", 22, "left", "Fund Accounting", 48);				
	menus[20].addItem("#", "", 22, "left", "Schools", 50);	
	menus[20].addItem("#", "", 22, "left", "Bank", 58);
	...
	menus[26].addItem("#", "", 18, "left", "Analysis Reports", 57);
   ...
   //////////////////
	...
	menus[24].addItem("./reports/rws_WQ_Habs_Coverage_Frm.jsp", "", 29, "left", "Habitation Coverage By Test Results(Priority Based)",0);
	 ...
	 menus[24].addItem("./reports/rws_ftk_test_result_frm.jsp", "", 22, "left", "Ftk Test Results", 0); 
	 	 ...
	 	 menus[24].addItem("switch.do?prefix=/wquality&page=/WaterLabTesting.do&mode=data", "", 22, "left", "WQ Lab Entry", 0);
...
////su menu items of WORKFLOW-PROPOSAL
	   ...
	   // "Works Monitoring":
		...
		menus[36].addItem("/pred/works/ProgressReportEntry.do?mode=progressRptSelect", "", 22, "left", "Monthly Progress Report", 0);
	   ...
	   // "Works Monitoring Reports"
		...
		menus[37].addItem("#", "", 22, "left", "RFD", 61);
		menus[37].addItem("#", "", 22, "left", "RFD-SECRETARY", 62);
		
		
		menus[37].addItem("#", "", 22, "left", "Performance Reports", 60);
        ...
        menus[37].addItem("./reports/rws_work_ongoing_frm.jsp", "", 22, "left", "Ongoing Works - Habitations Benefitted Report", 0); 
		 // "HELP DOCUMENTS"
		menus[38] = new menu(280, "vertical", 0, 0, 0, 0, "#E1E1E1", "#8A9FCD", "Verdana,Helvetica", 9, "bold", "bold", "black", "white", 1, "gray", 2, 62, false, true, false, false, 0, true, 4, 4, "#cccccc");
		...
		menus[41] = new menu(420, "vertical", 0, 0, 0, 0, "#E1E1E1", "#8A9FCD", "Verdana,Helvetica", 9, "bold", "bold", "black", "white", 1, "gray", 2, "rollover:images/tri-right1.gif:images/tri-right2.gif", false, true, false, false, 0, true, 4, 4, "#cccccc");
		...
		//menus[41].addItem("switch.do?prefix=/fundAccounting&page=/releasesVsExpenditureSchemeWise.do&mode=init", "", 32, "left", "Scheme Wise Releases Vs Expenditure", 0);      
		...
		menus[41].addItem("./reports/rws_billvoucher_division_frm.jsp", "", 22, "left", "Division Wise Bill-Voucher Details ", 0);
		
		//Asset Graph Reports
		menus[42] = new menu(200, "vertical", 0, 0, 0, 0, "#E1E1E1", "#8A9FCD", "Verdana,Helvetica", 9, "bold", "bold", "black", "white", 1, "gray", 2, "rollover:images/tri-right1.gif:images/tri-right2.gif", false, true, false, false, 0, true, 4, 4, "#cccccc");
		...
		menus[44] = new menu(200, "vertical", 0, 0, 0, 0, "#E1E1E1", "#8A9FCD", "Verdana,Helvetica", 9, "bold", "bold", "black", "white", 1, "gray", 2, "rollover:images/tri-right1.gif:images/tri-right2.gif", false, true, false, false, 0, true, 4, 4, "#cccccc");
	...
	menus[48].addItem("./reports/rws_program_works_rpt.jsp", "", 22, "left", "Work-Program Releases", 0);
	...
	menus[51] = new menu(220, "vertical", 0, 0, 0, 0, "#E1E1E1", "#8A9FCD", "Verdana,Helvetica", 9, "bold", "bold", "black", "white", 1, "gray", 2, "rollover:images/tri-right1.gif:images/tri-right2.gif", false, true, false, false, 0, true, 4, 4, "#cccccc");			
	...
	menus[57].addItem("./reports/rws_Slipage_hab_frm.jsp", "", 22, "left", "Slippage Report", 0);
	menus[57].addItem("./reports/rws_Sources_hab_frm.jsp", "", 22, "left", "Source Details", 0);	
	...
	menus[58].addItem("./reports/rws_bank_rpt.jsp","", 22, "left", "Account Details", 0);


    menus[59] = new menu(350, "vertical", 0, 0, 0, 0, "#E1E1E1", "#8A9FCD", "Verdana,Helvetica", 9, "bold", "bold", "black", "white", 1, "gray", 2, "rollover:images/tri-right1.gif:images/tri-right2.gif", false, true, false, false, 0, true, 4, 4, "#cccccc");
    menus[59].addItem("./reports/rws_drought_frm.jsp","", 22, "left", "Drought Habitations Report", 0);
	menus[59].addItem("switch.do?prefix=/drought&page=/DroughtReport.do&mode=get2", "", 22, "left", "Status report of drought Habitations ", 0);
	menus[59].addItem("./reports/rws_drought_deepen_frm.jsp","", 22, "left", "Abstract Flushing/Deepnening", 0);
	menus[59].addItem("./reports/rws_drought_deepen_abst_frm.jsp","", 22, "left", "Contingency Plan Abstract-2", 0);
	menus[59].addItem("./reports/rws_drought_daily_rpt.jsp","", 22, "left", "Daily Report", 0);
	menus[59].addItem("./reports/rws_drought_habitations_frm.jsp","", 22, "left", "Contingency Abstract Report", 0);
    menus[59].addItem("./reports/rws_drought_daily_comparision_consolidate_rpt.jsp", "", 22, "left", "Daily Comparision ", 0);
    menus[59].addItem("./reports/rws_drought_ongoing_works_rpt.jsp", "", 22, "left", "On Going Works ", 0);
    menus[59].addItem("./reports/rws_drought_distwise_sstank_rpt.jsp", "", 22, "left", "SS Tank- Detailed", 0);
    menus[59].addItem("./reports/rws_sstank_consolidated_rpt.jsp", "", 22, "left", "SS Tank- Consolidated", 0);
    
    menus[60] = new menu(340, "vertical", 0, 0, 0, 0, "#E1E1E1", "#8A9FCD", "Verdana,Helvetica", 9, "bold", "bold", "black", "white", 1, "gray", 2, "rollover:images/tri-right1.gif:images/tri-right2.gif", false, true, false, false, 0, true, 4, 4, "#cccccc");
	menus[60].addItem("./reports/rws_works_program_details_frm.jsp", "", 22, "left", "Abstract Works Spill Over/ New ", 0);
	
	
	 menus[61] = new menu(380, "vertical", 0, 0, 0, 0, "#E1E1E1", "#8A9FCD", "Verdana,Helvetica", 9, "bold", "bold", "black", "white", 1, "gray", 2, "rollover:images/tri-right1.gif:images/tri-right2.gif", false, true, false, false, 0, true, 4, 4, "#cccccc");
	   menus[61].addItem("./reports/RFDReports/rws_fin_phy_prg_ach_frm.jsp", "", 22, "left", "Financial and Physical Achievements", 0);
	   menus[61].addItem("./reports/rws_work_dpr_fin_frm.jsp", "", 22, "left", "DPR Status Progress Report", 0);
menus[61].addItem("./reports/rws_work_dpr_fin_StatusPermissions_frm.jsp", "", 22, "left", "DPR Permission Status", 0);
menus[61].addItem("./reports/RFDReports/rws_rfd_schools_rpt.jsp", "", 40, "left", "Coverage of Schools/Anganwadis with Drinking Water Facilities", 0);

   menus[61].addItem("./reports/rws_svs_mvs_detail_rpt.jsp", "", 22, "left", "SVS - MVS", 0);
   menus[61].addItem("./reports/rws_svs_mvs_prevcomp_curr_update_rpt.jsp", "", 32, "left", "Work Completion Date Updation ", 0);
      menus[61].addItem("./reports/rws_susworks_finphy_details_rpt.jsp", "", 22, "left", "Sustainbility Structures", 0);
     menus[61].addItem("./reports/RFDReports/rws_WQ_RFD_lab_frm.jsp", "", 22, "left", "Water Quality-Lab Abstract", 0);
          menus[61].addItem("./reports/rws_ftk_test_ftkuptomonth_frm.jsp", "", 22, "left", "Water Quality-FTK Abstract", 0);
            menus[61].addItem("./reports/RFDReports/rws_asset_habs_status_rpt.jsp", "", 22, "left", "Scheme(MVS)-Hab Status", 0);
                     menus[61].addItem("./reports/RFDReports/rws_asset_habs_status_svs_rpt.jsp", "", 22, "left", "Scheme(SVS)-Hab Status", 0);
                     menus[61].addItem("./reports/RFDReports/rws_drought_works_abstract_rpt.jsp", "", 22, "left", "Drought Works Status", 0);
                     
                     
                     
                     
      menus[62] = new menu(380, "vertical", 0, 0, 0, 0, "#E1E1E1", "#8A9FCD", "Verdana,Helvetica", 9, "bold", "bold", "black", "white", 1, "gray", 2, "rollover:images/tri-right1.gif:images/tri-right2.gif", false, true, false, false, 0, true, 4, 4, "#cccccc");
	   menus[62].addItem("./Secretary/rws_works_program_details_frm.jsp", "", 22, "left", "Abstract Works Spill Over/ New", 0);
	   	   menus[62].addItem("./Secretary/rws_work_dpr_sec_StatusP_drill_frm.jsp", "", 22, "left", "Permission Pending Status", 0);
	   	   	   menus[62].addItem("./Secretary/rws_work_dpr_fin_secpro_frm.jsp", "", 22, "left", "DPR Status Progress Report", 0);
	   	   	   	   menus[62].addItem("./Secretary/rws_rfd_schools_rpt.jsp", "", 30, "left", "Coverage of Schools/Anganwadis with Drinking Water Facilities", 0);
	   	   	   	   	   menus[62].addItem("./Secretary/rws_svs_mvs_prevcomp_curr_update_rpt.jsp", "", 22, "left", "Work Completion Date Updation", 0);
	   	   	   	   	   	   menus[62].addItem("./Secretary/rws_work_program_fin_notcompl_frm.jsp", "", 30, "left", "Physically completed and Financially not completed", 0);
	   	   	   	   	   	   	   menus[62].addItem("./Secretary/rws_WQ_RFD_lab_frm.jsp", "", 22, "left", "Water Quality-Lab Abstract ", 0);
	   	   	   	   	   	   	   	   menus[62].addItem("./Secretary/rws_ftk_test_ftkuptomonth_sec_frm.jsp", "", 22, "left", "Water Quality-FTK Abstract ", 0);
	   	   	   	   	   	   	   	   	   menus[62].addItem("./reports/RFDReports/rws_asset_habs_status_rpt.jsp", "", 22, "left", "Scheme(MVS)-Hab Status", 0);
	   	   	   	   	   	   	   	   	   	   menus[62].addItem("./reports/RFDReports/rws_asset_habs_status_svs_rpt.jsp", "", 22, "left", "Scheme(SVS)-Hab Status", 0);
	   	   	   	   	   	   	   	   	   	   	   menus[62].addItem("./Secretary/rws_drought_works_abstract_rpt.jsp", "", 22, "left", "Drought Works Status", 0);
