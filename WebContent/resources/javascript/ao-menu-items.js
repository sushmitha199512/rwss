...
function init()
{
	...
	menus[0].addItem("#", "", 110, "center", "Downloads", 0);
...
//	menus[12].addItem("#", "", 22, "left", "Proposals", 0);
 //   menus[12].addItem("#", "", 22, "left", "Estimates", 0);
	//menus[12].addItem("#", "", 22, "left", "Water Quality Management", 0);
//    menus[12].addItem("#", "", 22, "left", "Contractor Management", 0);
   // menus[12].addItem("#", "", 22, "left", "Works Monitoring", 0);
...
//	menus[19].addItem("#", "", 22, "left", "Estimates", 25);
	menus[19].addItem("#", "", 22, "left", "Contractor Mgmt", 60);
	...
	menus[20].addItem("#", "", 22, "left", "Bank", 61);
	...
	menus[26].addItem("#", "", 18, "left", "Analysis Reports", 59);
   ...
   //////////////////
	...
	//menus[24].addItem("./reports/rws_wq_off_rpt_frm.jsp", "", 22, "left", "Water Quality Statuts Report/office", 0); 
...
////su menu items of WORKFLOW-PROPOSAL
	   ...
	   // "Works Monitoring Reports"
		...
		menus[37].addItem("./reports/rws_works_projectshelf_rpt.jsp", "", 22, "left", "Remain Project Shelf 2010-11", 0);      
...
//		menus[40].addItem("switch.do?prefix=/fundAccounting&page=/broDetailsList.do&mode=getBroList_frm", "", 22, "left", "List BRO", 0);      
		//menus[40].addItem("./works/rws_work_exp_voucher_frm.jsp", "", 22, "left", "Voucher Payments", 0);			
		...
		menus[41] = new menu(220, "vertical", 0, 0, 0, 0, "#E1E1E1", "#8A9FCD", "Verdana,Helvetica", 9, "bold", "bold", "black", "white", 1, "gray", 2, "rollover:images/tri-right1.gif:images/tri-right2.gif", false, true, false, false, 0, true, 4, 4, "#cccccc");
		...
		menus[41].addItem("#", "", 22, "left", "Financial Status Reports", 58);
		menus[41].addItem("#", "", 22, "left", "Bank Reports", 62);
	...
	menus[58].addItem("./reports/rws_bill_tobe_release_rpt.jsp", "", 22, "left", "Division Wise", 0);
	menus[58].addItem("./reports/rws_bill_tobe_release_nrdwp_rpt.jsp", "", 22, "left", "NRDWP Related", 0);
	menus[58].addItem("./reports/rws_biil_release_program_rpt.jsp", "", 22, "left", "Program Wise", 0);
	menus[58].addItem("./reports/rws_work_details_exp_frm.jsp", "", 22, "left", "Work Wise", 0);
    ...
    menus[59].addItem("./reports/rws_Slipage_hab_frm.jsp", "", 22, "left", "Slippage Report", 0);
	menus[59].addItem("./reports/rws_Sources_hab_frm.jsp", "", 22, "left", "Source Details", 0);	
 	menus[59].addItem("./reports/rws_Fc_schemes_frm.jsp", "", 22, "left", "Assets Report", 0);	
      ...
      menus[60].addItem("switch.do?prefix=/masters&page=/Contractor.do&mode=getContractorlist&special=reset", "", 22, "left", "Contractor Details Report", 0);
	 menus[61] = new menu(230, "vertical", 0, 0, 0, 0, "#E1E1E1", "#8A9FCD", "Verdana,Helvetica", 9, "bold", "bold", "black", "white", 1, "gray", 2, "rollover:images/tri-right1.gif:images/tri-right2.gif", false, true, false, false, 0, true, 4, 4, "#cccccc");
		menus[61].addItem("./reports/rws_bank_rpt.jsp","", 22, "left", "Account Details", 0);
		...
		menus[62].addItem("./reports/rws_bank_process_frm.jsp","", 22, "left", "Bill Wise Bank Releases", 0);
		menus[62].addItem("./reports/rws_bankwise_State_frm.jsp","", 22, "left", "Bill Wise State Releases", 0);	  
		menus[62].addItem("./reports/rws_bill_pao_rpt.jsp","", 22, "left", "State Bill Report", 0);		
		menus[62].addItem("./reports/rws_precedings_frm.jsp","", 22, "left", "Bank Proceedings", 0);  
