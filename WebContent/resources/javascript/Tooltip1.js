...
{ var isInit = -1;
  ...
  this.Show =  function(e,strHTML)
  {
    ...
    if(strHTML!=null)
    {
		...
		divHeight1 = document.getElementById('b').offsetHeight;
		div.appendChild(document.getElementById('b'));
	    //divHeight1 = parseInt(document.getElementById('b').offsetheight);
		//alert("aas:"+divHeight1);
    ...
    newPosy= curPosy-divHeight1;
    else
    newPosy = curPosy-divHeight1-100;
	//alert(curPosx);
	//alert(curPosy);
	//alert(divHeight1);
	if(divHeight1==0)
