...
function init()
{
	...
	//Scarcity Master
	menus[2].addItem("#", "", 22, "left", "Drought Scarcity Master", 3);
...
menus[3].addItem("switch.do?prefix=/drought&page=/Scarcity.do&mode=data", "", 22, "left", "Scarcity Reasons ", 0);
...
////su menu items of WORKFLOW-PROPOSAL
	...
	//	menus[36].addItem("/pred/works/ProgressReportOBEntry.do?mode=openingBalanceFrm", "", 22, "left", "Opening Balance Entry Form", 0);
       ...
       // menus[37].addItem("./reports/rws_work_pendency_frm.jsp", "", 22, "left", "Work Pendency  Status Report", 0);	
		...
		menus[37].addItem("#", "", 22, "left", "Analysis Reports", 73);
        ...
        menus[38].addItem("./help/drought.doc", "", 22, "left", "Drought Monitoring Help", 0);      
...
//menus[71].addItem("switch.do?prefix=/drought&page=/DroughtCumulative.do&mode=get2", "", 22, "left", "Cumulative Expenditure", 0);
    ...
    menus[72] = new menu(350, "vertical", 0, 0, 0, 0, "#E1E1E1", "#8A9FCD", "Verdana,Helvetica", 9, "bold", "bold", "black", "white", 1, "gray", 2, "rollover:images/tri-right1.gif:images/tri-right2.gif", false, true, false, false, 0, true, 4, 4, "#cccccc");
    ...
    menus[72].addItem("./reports/rws_sstank_consolidated_rpt.jsp", "", 22, "left", "SS Tank- Consolidated", 0);
	      ...
	      menus[73].addItem("./reports/rws_work_admn_tech_frm.jsp", "", 22, "left", "Difference In Admn and Tech Habs", 0);
        menus[73].addItem("./reports/rws_work_pendency_frm.jsp", "", 22, "left", "Work Pendency  Status Report", 0);	
		menus[73].addItem("switch.do?prefix=/works&page=/workgap.do?mode=data", "", 22, "left", "Gap Report", 0);
	    menus[73].addItem("./reports/rws_works_exception_frm.jsp", "", 22, "left", "Status of Work Progress Report", 0);
