...
<table border = 1 cellspacing = 0 cellpadding = 0 height=5% width="40%" bordercolor=#000000 style="border-collapse:collapse" bgcolor="#ffffff" align = "center">	
			...
			<table  border=0 rules=none style="border-collapse:collapse" align = "right">		
				<tr>
					...
					<a href="../home.jsp">Home</a>|
						<a href="./rws_Financial_rpt_xls.jsp" target="_new">Excel </a>
					</td>
				</tr>
			</table>
		</caption>
  ...
  try{
			if(loggedUser!=null && (loggedUser.equals(Constants.ADMIN)||loggedUser.equals(Constants.LAKH_USER) ||loggedUser.equals(Constants.GUEST)  ||loggedUser.equals(Constants.SEC_RWSS)))
		{
		%>
	...
	<tr><td class=rptLabel>Financial Year&nbsp;&nbsp;<font color="red">*</font></td>
		...
		<tr><td><font color="red"><b>NOTE:</b></font> <font color="blue" size="3">NRDWP Related Programmes (ARWS,SMP,BHARAT NIRMAN ,ARWS BHARAT NIRMAN ,ARWS (SCP),<br>NRDWP-COV,NRDWP-SUS,NRDWP-QA,NRDWP-DDP,NRDWP-CALAMITY,NRDWP-O AND M) </font></td></tr>
		</table><br>
		...
		<td class=btext  >OB Balance(1/4/2011)</td>
