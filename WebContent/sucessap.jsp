																						...
																						<td valign="top"><!-- <table width="100%"
																							...
																							<div id="tabs">
																								...
																								<ul>
																									...
																									<li><a href="#gos">Sucess Stories</a></li>
																									
																								</ul>
																								<div id="gos">
																									<table>
																										<tr>
																											<td>1.<a href="./downloads/Innovative technologies.pdf"
																												target="_blank">Innovative technologies</a></td>
																										</tr>
																										<tr>
																											<td>2.<a href="./downloads/Kuppam-NTRS.pdf"
																												target="_blank">Kuppam-NTRS</a></td>
																										</tr>
																										<tr>
																											<td>3.<a href="./downloads/Note on NTR SUJALA AND COMMUNITY.pdf"
																												target="_blank">Note on NTR SUJALA AND COMMUNITY</a></td>
																										</tr>
