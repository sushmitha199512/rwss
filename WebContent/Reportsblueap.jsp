																						...
																						<td valign="top"><!-- <table width="100%"
																							...
																							<div id="tabs">
																								...
																								<ul>
																									...
																									<li><a href="#gos">Reports</a></li>
																									
																								</ul>
																								<div id="gos">
																									<table>
																										<tr>
																											<td>1.<a href="./reports/assetReports/rws_asset_hab_abstract_home_frm.jsp" target="_self" class="h4">Habitation Information Report </a>  <img src="images/new.gif"> </td>
																										</tr>
																										
																										<tr>
																											<td>2.<a href="./reports/rws_hab_status_resource_home_rpt.jsp" target="_self" class="h4" >Know Your Habitation</a><img src="images/new.gif"></td>
																										</tr>
																										<tr>
																											<td>3.<a href="./reports/rws_dist_status_cm_rpt1.jsp" target="_self" class="h4" >Habitation Coverage Status</a><img src="images/new.gif"></td>
																										</tr>
