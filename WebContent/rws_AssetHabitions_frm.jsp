...
function addfunc()
{
  ...
  if(temp=="edit")
  {
   ...
   if(k==0)
   {
      ...
      opener.document.forms[0].action="switch.do?prefix=/masters&page=/Asset.do&mode=data&typeOfAssetCode="+document.assetForm.assetTypeCode.value;
...
<tr>
	...
	<td class=mycborder >
	<%
		if(((String)session.getAttribute("district")) != null)
		{
	 %>
	 	 <html:text name="assetForm" property="district" style="width:150px"  styleClass="mytext" readonly="true" />
     ...
     <%
     	...
     	{
      %>
	<html:select property="district" style="width:150px" styleClass="mycombo" onchange="javascript:getData()" >
	...
	<table border=1 width="590" style="border-collapse:collapse;" bgcolor="#ffffff" bordercolor= "#8A9FCD" >
		<tr bgcolor="#8A9FCD">
		<td class=mycborder colspan=3><FONT class=myfontclr><font color="#ffffff">Select the Habitations</td>
		</tr>
