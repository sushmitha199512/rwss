...
function fnSave()
{
    ...
    {
		document.forms[0].action="switch.do?prefix=/drought&page=/Scarcity.do?mode=save";
...
function fnView()
{
		...
		document.forms[0].action="switch.do?prefix=/drought&page=/Scarcity.do?mode=view";
		document.forms[0].submit();
	}
...
<jsp:include page="/commons/TableHeader.jsp">
	<jsp:param name="TableName" value="Scarcity Entry Form" />
...
<td>
	...
	<tr>
		...
		<td  class=mycborder >
		<html:text property="scarcityCode" value="<%=(String)request.getAttribute(\"scode\")%>" styleClass="mytext" maxlength="2" readonly="true" />
		</td>
		</tr>
		<tr>
		<td  class=mycborder >
		...
		<td  class=mycborder >
		<html:text property="scarcityName" value="" styleClass="mytext" maxlength="30" onkeypress="return textOnly(evt);" />
		</td>
		</tr>
		</table>
...
<tr>
	...
	<html:button property="mode" title="Save the Fields" styleClass="btext" value="Save" onclick="fnSave()" /> 
	 ...
	 <html:button property="mode" title="View the Fields" styleClass="btext" value="View" onclick="fnView()" />
