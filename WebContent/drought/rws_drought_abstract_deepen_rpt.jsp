...
<table   bgcolor="#FFFFFF" bordercolor= "#8A9FCD"  width="100%" border=1 style="border-collapse:collapse"  ALIGN=CENTER ><tr align=center>
               ...
               <td class=btext colspan=4 nowrap> Flushing Borewells</td> 
			   <td class=btext colspan=4 nowrap> Deepening Borewells</td> 
               <td class=btext colspan=2 nowrap>Total ( Flushing or Deepening Borewells )</td> 
...
gatnotcond=atnotcond+gatnotcond;
		...
		%>
			...
			<td class=rptValue NOWRAP><%=atnotcont%></td>
                ...
                <td class=rptValue NOWRAP><%=conflush+condeep%></td>
				<td class=rptValue NOWRAP><%=flush+deep%></td>
...
<%			
	...
	<tr>
	 <td class="btext" colspan="2">Total:</td>
	  ...
	  <td class="btext" ><%=gtotcon%></td>
	   <td class="btext" ><%=gtotrecords%></td>
	 	</tr>
	<%
}
catch(Exception e)
