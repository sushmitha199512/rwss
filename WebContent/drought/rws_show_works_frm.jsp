...
//	document.forms[0].action="switch.do?prefix=/proposals&page=/AdminstrativeSanction.do?mode=getDivisions1";
	...
	document.forms[0].action="switch.do?prefix=/drought&page=/AdminstrativeSanction.do?mode=getWorks&someCond1=div";
	document.forms[0].submit();

}
function getSubDivisions()
{
	document.forms[0].action="switch.do?prefix=/drought&page=/AdminstrativeSanction.do?mode=getWorks&someCond1=subdiv";
	document.forms[0].submit();
}
function getData()
{
	...
	{
	document.forms[0].action="switch.do?prefix=/drought&page=/AdminstrativeSanction.do?mode=getWorks&someCond=yes&someCond1=yes";
	document.forms[0].submit();
	}
}
function initFunc()
...
<!-- end of ajax code -->
	...
	function getParameters(that)
	{
		...
		if(that.checked)
		{
			...
			frm.action = "switch.do?prefix=/drought&page=/AdminstrativeSanction.do?mode=populateWorkId&augsch="+testval;
			frm.submit();
			window.close();
		}
	}
