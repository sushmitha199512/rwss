...
<body  >
<html:form  action="AdminstrativeSanction.do?mode=data" enctype="multipart/form-data"   >
<jsp:include page="/commons/TableHeader.jsp">
	<jsp:param name="TableName" value="Administrative Sanction" />
...
<table bgcolor="#DEE3E0" bordercolor= "#8A9FCD" rules="none" width="820" border=1 style="border-collapse:collapse;">
	<tr>
		<td class="textborder" align="center">INVALID USER</td>
	</tr>
</table>		
