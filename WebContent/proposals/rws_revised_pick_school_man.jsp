...
var len=document.getElementById('count').value;
  ...
  document.forms[0].action="switch.do?prefix=/proposals&page=/PickRevisedHabitation.do&mode=addRemoveHabs&proposalId="+proposalId;
...
<tr bgcolor="#8A9FCD">
<th colspan=2>Select Mandals To Add Schools</th>
</tr>
<tr bgcolor="#8A9FCD">
