...
<% 		
String a = request.getParameter("divisions");
Statement st = null;
...
String stat123="select * from rws_water_quality_lab_tbl where  "+a.substring(0,len-3)+")   order by 1";
...
%>
<option  value=<%=rs123.getString(1)%>><%=rs123.getString(1)%>-<%=rs123.getString(2)%>-<%=rs123.getString(3)%></option>
