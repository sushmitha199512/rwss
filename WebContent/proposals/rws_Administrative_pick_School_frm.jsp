...
<script language="JavaScript">
	function carrySchools(){
		...
		if(selectSchools=="true"){
			...
			if(confirm("Are you sure to Add Selected Schools("+count+") .\nPress OK to continue...")){
			...
			alert("Select School to Add Schools");
		}
	}
	...
	function AjaxFun1(destinationname){
		...
		if(selectHab=="true"){
			...
			var postData = "";
			var openRequest = getAjaxRequest();
			var urll = "/pred/proposals/SchoolsGet.jsp?mandals="+s;      
			...
			alert("Select Habitation to Get Schools");
		}
	}
...
<body method="post"leftmargin="0" topmargin="0" bgcolor="#edf2f8">
	<html:form action="SaveAdminHabitation" onsubmit="return fnAdd(this)">
		...
		<logic:notEmpty name="mandals">
					...
					<td>
						<table width="100%" cellspacing="0" cellpadding="2" border="1" bordercolor="#000000">
							<tr>
								...
								<td width="5%">&nbsp;</td>
								<td width="70%"  align=center><FONT size="2" face="verdana"><b>Schools : School Code-School Name-Location</b></FONT></td>
							</tr>
							<%int i=0; %>
							<tr>
								<td>
								...
								<td>
									<input type="button" value="Get Schools>>>" onClick="AjaxFun1('schools')">
								</td>
								<td id="schools1">
			...
			<br/>
			<center>
				<html:button property="mode" value="Add Schools" styleClass="btext" onclick="carrySchools()"/>
