...
<h4 align="center"><u>New Proposal History</u></h4>
...
<colgroup class="staticLabelBold">
<tr>
	<td nowrap><bean:message key="app.proposalId" /></td>
	<td><c:out value="${track1.proposalId}" /></td>
	<td><bean:message key="app.workName" /></td>
	<td width="210"><c:out value="${track1.proposalName}" /></td>
	<td><bean:message key="app.noOfHabs" /></td>
	<td><c:out value="${track1.noOfHabs}" /></td>
</tr>
<tr>
	<td><bean:message key="app.scheme" /></td>
	<td><c:out value="${track1.typeOfAsset}" /></td>
	<td><bean:message key="app.programme" /></td>
	<td><c:out value="${track1.programmeName}" /></td>
	<td><bean:message key="app.subprogramme" /></td>
	<td><c:out value="${track1.subprogrammeName}" /></td>
</tr>
<tr>
	<td><bean:message key="app.priority" /></td>
	<td><c:out value="${track1.priorityCode}" /></td>
...
<tr bgcolor="lightyellow">
	<td colspan="13"><b>Date:&nbsp;<c:out value="${item.submitDate}"/></b></td>
</tr>
</c:if>
...
<table border="1">
<caption class="staticLabelBold">
	Proposal sanctioned at <c:out value="${track1.officeName}"/> on <c:out value="${track1.adminDate}"/> by <c:out value="${track1.userId}" />
</caption>
<tbody>
<colgroup class="staticLabel">
<colgroup class="staticLabelBold">
