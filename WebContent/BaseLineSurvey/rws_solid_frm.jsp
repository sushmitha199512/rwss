...
function fnSave()
{
	 ...
	 else if(document.forms[0].totDustbins.value=="" || document.forms[0].totDustbins.value==null)
    ...
    {
	document.forms[0].action="switch.do?prefix=/BaseLineSurvey&page=/SolidWaste.do&mode=save";
    document.forms[0].submit();
...
<jsp:include page="/commons/TableHeader.jsp">
	<jsp:param name="TableName" value="BaseLine Survey Solid Waste Details Entry Form" />
...
<table bgcolor="ffffe0" bordercolor= "#8A9FCD" rules="none" border="1" 
	   style="border-collapse:collapse;" width="1000" >
		...
		<td class="textborder" >
		<html:text property="totDustbins"    maxlength="4" size="4" onkeypress="numeralsOnly(event)" /></td>
