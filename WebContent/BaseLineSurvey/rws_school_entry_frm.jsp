...
function fnSave()
{
...
else if(document.forms[0].schoolName.value=="" || document.forms[0].schoolName.value==null)
	{
	...
	document.forms[0].action="switch.do?prefix=/BaseLineSurvey&page=/School.do&mode=save";
    document.forms[0].submit();
...
<jsp:include page="/commons/TableHeader.jsp">
	<jsp:param name="TableName" value="BaseLine Survey Schools Entry Form" />
...
<table bgcolor="ffffe0" bordercolor= "#8A9FCD" rules="none" border="1" 
	   style="border-collapse:collapse;" width="1000" >
		...
		<td class="textborder" >
		<html:text property="schoolName"  style="width:180px"  maxlength="100" size="50" onkeypress="return alpha(event)" /></td>
		...
		<html:option value="">SELECT</html:option>
		<html:option value="NBA"><font class="btext2">NBA </html:option>
		<html:option value="Other than NBA"><font class="btext2">Other than NBA</html:option>
