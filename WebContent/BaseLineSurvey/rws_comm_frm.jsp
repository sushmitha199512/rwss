...
function getData2()
{
	document.forms[0].action="switch.do?prefix=/BaseLineSurvey&page=/Commgp.do&mode=data";
	document.forms[0].submit();
}
function getData3()
{
	document.forms[0].action="switch.do?prefix=/BaseLineSurvey&page=/Commgp.do&mode=view";
    document.forms[0].submit();
}
...
function fnView()
{
	...
	document.forms[0].action="switch.do?prefix=/BaseLineSurvey&page=/Commgp.do&mode=cview";
    document.forms[0].submit();
...
function fnSave()
{
	if(document.forms[0].dist.value=="" || document.forms[0].dist.value==null)
	 ...
	 else if(document.forms[0].vwscFormed.value == null || document.forms[0].vwscFormed.value=="")
		{
	...
	document.forms[0].action="switch.do?prefix=/BaseLineSurvey&page=/Commgp.do&mode=save";
    document.forms[0].submit();
	}
}
...
<jsp:include page="/commons/TableHeader.jsp">
	<jsp:param name="TableName" value="BaseLine Survey Vwsm Committe Entry Form" />
...
<table bgcolor="ffffe0" bordercolor= "#8A9FCD" rules="none" border="1" 
	   style="border-collapse:collapse;" width="1000" >
		...
		<tr>
		<td class="btext2" >Vmsc Formed<font color="#FF6666">*</font><font color="#FF6666"></font></td>
		<td class="textborder" >
