...
<%
 ...
 /* nic.watersoft.commons.RWSUser users=(nic.watersoft.commons.AgencyUser)session.getAttribute("AGENCY_USER"); */
System.out.println(users);
String userid = users.getUserId();
System.out.println("userid  DSAFA"+userid);
String isEmailRegistered=users.getIsEmailRegistered();
Boolean agency=(Boolean)session.getAttribute("AGENCY");
System.out.println("Agency dashboard"+agency);

%>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3c.org/TR/1999/REC-html401-19991224/loose.dtd">
<%@ include file="/reports/conn.jsp" %>
<%@ include file="/dashboards/rws_alerts.jsp" %>
...
<body  onload="checkCookie('<%=userid %>');init();openUserForm();"><!-- creategraph(); -->
<center>
...
<ul>
      ...
      <%if(agency!=null && agency == true && userid.equals("admin")) {%>
 ...
 <%} %>
     <!--   <li><a href="#master">Masters</a></li>
       ...
       <li><a href="#helpdesk">Grievance Rural</a></li>
       <li><a href="#helpdesk_Urban">Grievance Urban</a></li>
...
<tr>
<!-- <td class="green"><b >&nbsp;&nbsp;1.</b></td><td><a href="switch.do?prefix=/masters&page=/UserAudit.do&mode=data2"  >Agency Registration</a></td></tr>-->
<td class="green"><b >&nbsp;&nbsp;1.</b></td><td><a href="switch.do?prefix=/complaints&page=/Agency.do&mode=data"  >Agency Registration</a></td></tr>
<tr>

<td  class="green"><b>&nbsp;&nbsp;2.</b></td><td><a href="switch.do?prefix=/complaints&page=/UserAgencyAct.do&mode=data" >User Management</a></td></tr>

 
 <tr>
<td class="green"><b >&nbsp;&nbsp;3.</b></td><td><a href="switch.do?prefix=/masters&page=/UserAudit.do&mode=data2"  >User Audit</a></td></tr>
...
<tr>
<td><b class="green">&nbsp;&nbsp;7.</b></td><td><a href="./admin/rws_pwd_search_frm.jsp" class="h4" >Password Search</a></td>
</tr>
<tr>
<td><b class="green">&nbsp;&nbsp;8.</b></td><td><a href="./reports/rws_useremail_frm.jsp" class="h4" >Email Details</a><img src="images/new.gif"></td>
</tr>

<tr>
<td><b class="green">&nbsp;&nbsp;9.</b></td><td><a href="./reports/Habitation/rws_district_useraudit_entry_form.jsp" class="h4" >District wise audit</a><img src="images/new.gif"></td>
</tr>
<tr>
<td><b class="green">&nbsp;&nbsp;10.</b></td><td><a href="./reports/rws_UserWorkAudit_frm.jsp" class="h4" >Progress Report Accessed Log</a><img src="images/new.gif"></td>
</tr>
 -->
...
<tr>
       <td class="h4"><span class="text2"><a href="switch.do?prefix=/masters&page=/MandalSubdivision.do?mode=data"  class="h4" target="_self"><b class="green">&nbsp;&nbsp;2.</b>Mandal Subdivision</a></span></td>
</tr>
<tr>
...
<tr>
       <td  class="h4"><span class="text2"><a href="switch.do?prefix=/masters&page=/ceo.do"  class="h4" target="_self"><b class="green">&nbsp;&nbsp;8.</b>ZP CEO Entry</a></span></td>
</tr>
<tr>
       <td  class="h4"><span class="text2"><a href="switch.do?prefix=/masters&page=/mpdo.do"  class="h4" target="_self"><b class="green">&nbsp;&nbsp;9.</b>MPDO/MRO Entry</a></span></td>
</tr>
<tr>
       <td  class="h4"><span class="text2"><a href="switch.do?prefix=/masters&page=/sarpanch.do"  class="h4" target="_self"><b class="green">&nbsp;&nbsp;10.</b>Sarpanch Entry</a></span></td>
</tr>
<tr>
       <td  class="h4"><span class="text2"><a href="switch.do?prefix=/masters&page=/villagesec.do"  class="h4" target="_self"><b class="green">&nbsp;&nbsp;11.</b>Village Secretary Entry</a></span></td>
</tr>
...
<tr>
       <td  class="h4"><span class="text2"><a href="masters/rws_assets_convert_division_subdivision.jsp"  class="h4" target="_self"><b class="green">&nbsp;&nbsp;4.</b>Asset-Division - Sub Division modification</a></span></td>
</tr>
...
<tr>
      ...
      <td  class="h4"><span class="text2"><a href="switch.do?prefix=/masters&page=/Institute.do&mode=data"  class="h4" target="_self"><b class="green">&nbsp;&nbsp;5.</b>Public Institutions</a></span></td>
</tr>
<tr>
 
      <td  class="h4"><span class="text2"><a href="switch.do?prefix=/masters&page=/Priority.do&mode=data"  class="h4" target="_self"><b class="green">&nbsp;&nbsp;6.</b>Priorities</a></span></td>
</tr>
<tr>
 
      <td  class="h4"><span class="text2"><a href="masters/rws_Hab_SC_St_details_frm.jsp"  class="h4" target="_self"><b class="green">&nbsp;&nbsp;7.</b>Habitation  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;SC/ST/Minority Status</a></span></td>
</tr>
...
<tr>
      ...
      <td  class="h4"><span class="text2"><a href="switch.do?prefix=/masters&page=/SourceType.do&mode=data"  class="h4" target="_self"><b class="green">&nbsp;&nbsp;8.</b>Source Type</a></span></td>
</tr>
<tr>
 
      <td  class="h4"><span class="text2"><a href="switch.do?prefix=/masters&page=/SubSourceType.do&mode=data"  class="h4" target="_self"><b class="green">&nbsp;&nbsp;9.</b>Sub Source Type</a></span></td>
</tr>

<tr>
       <td  class="h4"><span class="text2"><a href="switch.do?prefix=/masters&page=/HabiYield.do&mode=data&modeType=districts"  class="h4" target="_self"><b class="green">&nbsp;&nbsp;10.</b>Source Yield Entry</a></span></td>
</tr>
<tr>
		<td class="h4"><span class="text2"><a href="switch.do?prefix=/masters&page=/habSafeSuply.do&mode=init" class="h4" target="_self"><b class="green">&nbsp;&nbsp;11.</b>Coverage Status Automation Form</a></span>
		</td>
</tr>
...
<tr>
       <td  class="h4"><span class="text2"><a href="switch.do?prefix=/masters&page=/HabWork.do&mode=data&special=reset"  class="h4" target="_self"><b class="green">&nbsp;&nbsp;10.</b>Target Entry</a></span></td>
</tr>
...
<tr>
	...
	<td><b class="green">&nbsp;&nbsp;40.</b></td><td><a href="./reports/Habitation/rws_hab_status_pop_frm.jsp" target="_self" class="h4">UnSafe Supply Habs</a></td>
	
	
	</tr>
	
	<tr>
	<td><b class="green">&nbsp;&nbsp;41.</b></td><td><a href="./reports/assetReports/rws_asset_hab_frm.jsp" target="_self" class="h4">Habitaion & Assets</a></td>
	...
	<td><b class="green">&nbsp;&nbsp;42.</b></td><td><a href="./reports/assetReports/rws_asset_hab_abstract_frm.jsp" target="_self" class="h4">Habitation Information Report </a>  <img src="images/new.gif"> </td>
	 <td><b class="green">&nbsp;&nbsp;43.</b></td><td><a href="./reports/Habitation/rws_nss_contamintaion_status_report.jsp" target="_self" class="h4">Habitation Contamination(As per HabStatus)</a>  <img src="images/new.gif"> </td>
	 <td><b class="green">&nbsp;&nbsp;44.</b></td><td><a href="./reports/Habitation/rws_habitation_status_details_frm.jsp" target="_self" class="h4">Habitation Updated Details</a>  <img src="images/new.gif"> </td>
	</tr>
...
target="_self" class="h4">House Connections And House Holds</a></td>
</tr>
...
<tr>
 ...
 <tr>
     ...
     <td><b class="green">&nbsp;&nbsp;26.</b></td><td><a href="./reports/rws_hab_cov_surface_water_frm.jsp" target="_self" class="h4">Coverage Of Habitations(Surface Water & Ground Water)</a></td>
	 <td><b class="green">&nbsp;&nbsp;27.</b></td><td><a href="./reports/assetReports/rws_district_wise_status_frm.jsp" target="_self" class="h4">District Wise HandPumps Status Report</a></td>
</tr>

 <tr>
     <td><b class="green">&nbsp;&nbsp;28.</b></td><td><a href="./reports/assetReports/rws_district_wise_shpstatus_frm.jsp" target="_self" class="h4">District Wise Shallow HandPumps Status Report</a></td>
     <td><b class="green">&nbsp;&nbsp;29.</b></td><td><a href="./reports/assetReports/rws_assetwise_habbenificiary_frm.jsp" target="_self" class="h4">Asset Wise Habs Benefited Report</a></td>
	  <td><b class="green">&nbsp;&nbsp;30.</b></td><td><a href="./reports/assetReports/rws_asset_component_mobile_data_frm.jsp" target="_self" class="h4">Assets and Components Report - Image Status</a></td>
	 
</tr>
<tr>
<td><b class="green">&nbsp;&nbsp;31.</b></td><td><a href="./reports/assetReports/rws_ohsr_glsr_sstanks_frm.jsp" target="_self" class="h4">Component Wise Source Details</a></td>
...
<tr>
	<td><b class="green">7.</b></td><td><a href="switch.do?prefix=/masters&page=/IFSCEntry.do&mode=ViewReport" target="_self" class="h4">IFSC Code Details</a></td>
</tr>
			</table>
	</div>
	
	
	<h3><a href="#">CM Reports <img src="images/new.gif"></a></h3>
	<div>
	<table class="green">
	<tr>
	<td><b class="green">1.</b></td><td><a href="./reports/rws_school_eduinsti_frm.jsp" target="_self" class="h4">Schools Institutions Abstract</a></td>
	</tr>
	
<tr>
	<td><b class="green">2.</b></td><td><a href="./reports/rws_tanks_rpt_frm.jsp" target="_self" class="h4">Water Facilites Through Schemes</a></td>
			
</tr>
<tr>
	<td><b class="green">3.</b></td><td><a href="./reports/rws_detail_Handpumps_frm.jsp" target="_self" class="h4">HandPumps Details</a></td>
			
</tr>
<tr>
	<td><b class="green">4.</b></td><td><a href="./reports/rws_tap_stand_existing_frm.jsp" target="_self" class="h4">Taps and StandPosts Details</a></td>
			
</tr>

<tr>
	<td><b class="green">5.</b></td><td><a href="./reports/rws_hab_annual_current_frm.jsp" target="_self" class="h4">Habitations-Current and Annual Coverage</a></td>
			
</tr>

<tr>
	<td><b class="green">6.</b></td><td><a href="./masters/rws_habitation_abstract_frm.jsp" target="_self" class="h4">Panchayat Wise Habitation Abstract</a></td>
...
<td>
<div id="resizable7" class="ui-widget-content">
	<h3 class="ui-widget-header">Works Monitoring Data Entry</h3>
...
<tr>
       ...
       <td  class="h4"><span class="text2"><a href="switch.do?prefix=/proposals&page=/AdminstrativeSanction.do&mode=null"  onl class="h4" onclick="fncall(9999)" ><b class="green">&nbsp;&nbsp;1.</b>&nbsp;&nbsp;Administrative Sanction</a></span></td>
</tr>
...
<div id="resizable13" class="ui-widget-content">
	<h3 class="ui-widget-header">Works Monitoring Reports</h3>
...
<a href="./reports/rws_works_frm.jsp" target="_self">Total Works Vs Habs</a>
	...
	<a href="./reports/works/rws_work_progress_abstract_rpt.jsp" target="_self">Work Progress Abstract Report</a>
	 </td></tr>
	  <tr>
	<td><b class="green">10.</b></td><td>
	
	<a href="./reports/works/rws_user_work_progress_abstract_rpt.jsp" target="_self">Work Progress Abstract Report(NRDWP, NABARD, APRWSP_WB, 13TH FC)</a>
	 </td></tr>
	 
	 <tr>
	<td><b class="green">11.</b></td><td>
	
	<a href="./reports/rws_work_flow_status_cm_rpt.jsp" target="_blank">Work Progress - Work Flow</a>
	 </td></tr>
	 </table>
	</p>
	</div>
...
<td><b class="green">&nbsp;&nbsp;15.</b></td><td><a href="./reports/rws_work_probdate_frm.jsp" target="_self">Works - Probable Completion date</a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	...
	<td><b class="green">&nbsp;&nbsp;18.</b></td><td><a href="./reports/works/rws_ongoing_works_det_frm.jsp" target="_self">Ongoing Works Progress</a> 
		...
		<tr>	
		<td><b class="green">&nbsp;&nbsp;19.</b></td><td><a href="./reports/rws_ongoing_works_abs_frm.jsp" target="_self">Ongoing Works Progress(Abstract)</a> 
		</td>
		</tr>
...
<td>
<div id="resizable7" class="ui-widget-content">
	<h3 class="ui-widget-header">NTR Sujala Entry Forms</h3>
<h3 class="ui-widget-header"></h3>
 ...
 <tr>
       <td height=20 colspan="2" class="h4"><span class="text2"><a href="switch.do?prefix=/works&page=/ntrSujala.do&mode=data&special=reset"  class="h4" ><b class="green">&nbsp;&nbsp;1.</b>NTR Sujala Patakam </a> <img src="images/new.gif"> </span></td>
       </tr>

 <tr>
       <td height=20 colspan="2" class="h4"><span class="text2"><a href="switch.do?prefix=/works&page=/ntrSujalaImpl.do&mode=data&special=reset"  class="h4" ><b class="green">&nbsp;&nbsp;2.</b>NTR Sujala -Habitation & Sponsor Details </a> <img src="images/new.gif"> </span></td>
       </tr>
...
<td>
<div id="resizable13" class="ui-widget-content">
	<h3 class="ui-widget-header">NTR Sujala Reports</h3>
	...
	<tr>	
        <td><b class="green">&nbsp;&nbsp;1.</b></td><td><a href="./reports/Habitation/Rws_Ntr_Sujala_Patakam_Abs_Rpt.jsp" target="_self" class="h4">NTR Sujala Patakam.(Abstract)</a>  <img src="images/new.gif"> </td>
	</tr>
	<tr>
	<td><b class="green">&nbsp;&nbsp;2.</b></td><td><a href="./reports/Habitation/Rws_Ntr_Sujala_Patakam_Rpt_frm.jsp" target="_self" class="h4">NTR Sujala Patakam Details.</a>  <img src="images/new.gif"> </td>
	</tr>
	<tr>
	<td><b class="green">&nbsp;&nbsp;3.</b></td><td><a href="./reports/rws_ntr_sujala_impl_detail_frm.jsp" target="_self" class="h4">NTR Sujala Habitation Details </a>  <img src="images/new.gif"> </td>
	</tr>
	<tr>
	<td><b class="green">&nbsp;&nbsp;4.</b></td><td><a href="./reports/Rws_Ntr_Hab_Plant_Details_Frm.jsp" target="_self" class="h4">NTR Sujala Plant Installation Details </a>  <img src="images/new.gif"> </td>
	</tr>
...
<td><b class="green">&nbsp;&nbsp;6.</b></td>
 <td  class="h4"><a href="./reports/rws_exp_voucher_tot_rpt.jsp"  class="h4" >Summarized Financial Report(All Years)</a>
	...
	<tr>
	<td><b class="green">&nbsp;&nbsp;7.</b></td>
 <td  class="h4"><a href="./reports/fund/rws_bill_releases_rpt.jsp"  class="h4" >Bill forwarded by EE Division</a>
	</td></tr>
...
<tr>
       <td  class="h4"><span class="text2"><a href="switch.do?prefix=/drought&page=/newsItem.do&mode=districts&special=reset&level=State"  class="h4" ><b class="green">7.</b>News Paper Clippings</a></span></td>
</tr>
...
<td><b class="green">6.</b></td><td>
	<a href="./reports/rws_Typeof_Adverse_News_Item_frm.jsp" target="_self" class="h4">Type Adverse News Item Report</a>
	</td></tr>
	<tr>
	      
<td><b class="green">7.</b></td><td>
	<a href="./reports/rws_drought_distinct_hab_frm.jsp" target="_self" class="h4">Drought Distinct Habitations Report</a>
	</td></tr>
<tr>
	      
<td><b class="green">8.A.</b></td><td>
	<a href="./reports/rws_drought_hab_category_frm.jsp" target="_self" class="h4">Transportation Report(Category A-B-C)</a>
	</td></tr>
	<tr>
	      
<td><b class="green">8.B.</b></td><td>
	<a href="./reports/rws_drought_hab_category_cm_rpt.jsp" target="_self" class="h4">Transportation Report(Category A-B-C) for CM Dashboard</a>
	</td></tr>
	
	<tr>
	      
<td><b class="green">9.</b></td><td>
	<a href="./reports/rws_drought_hired_sou_frm.jsp" target="_self" class="h4">Water Supplied Through Hired Sources(only for test)</a>
	</td></tr>
...
<h3 class="ui-widget-header"></h3>
 ...
 <tr>
       <td  class="h4"><span class="text2"><a href="switch.do?prefix=/wquality&page=/WaterLabTesting.do&mode=data&paramValue=34"  class="h4" ><b class="green">1.</b>Lab Testing</a></span></td>
</tr>
 
 <tr>
       <td  class="h4"><span class="text2"><a href="switch.do?prefix=/wquality&page=/WaterLabTestingParameter.do&mode=data"  class="h4" ><b class="green">2.</b>Lab Testing-9 Paramters</a></span></td>
</tr>
 
 <tr>
       <td  class="h4"><span class="text2"><a href="switch.do?prefix=/wquality&page=/WaterLabTesting.do&mode=data&paramValue=13"  class="h4" ><b class="green">3.</b>Lab Testing-13 Paramters</a></span></td>
</tr>
 
<tr>
       <td  class="h4"><span class="text2"><a href="switch.do?prefix=/wquality&page=/WaterSample.do&mode=data"  class="h4" ><b class="green">3.</b>FTK Testing</a></span></td>
</tr>
<tr>
       <td  class="h4"><span class="text2"><a href="switch.do?prefix=/wquality&page=/sourceHab.do&mode=data&special=reset"  class="h4" ><b class="green">4.</b>Single Source Multiple Habitations</a></span></td>
</tr>
...
<td><b class="green">8.</b></td><td>
	<a href="./reports/rws_prepost_data_district_NEW_frm.jsp" target="_self" class="h4">Pre & Post Monsoon Tests Source Wise(New) </a>
	</td></tr>
	<tr>
	<td><b class="green">9.</b></td><td>	
	<a href="./reports/WaterQuality/rws_WQ_lab_coverageall_frm_rpt.jsp" target="_self" class="h4">WQ- Habs Coverage(2012 To 2014)</a><img src="images/new.gif">
	</td></tr>
	
	<tr>
	<td><b class="green">10.</b></td><td>	
	<a href="./wquality/rws_WQ_contaminated_habitations_frm_rpt.jsp" target="_self" class="h4">Contaminated Habitations As Per Lab Testing</a><img src="images/new.gif">
	</td></tr>
...
<td><b class="green">10.</b></td><td>
<a href="./reports/rws_WQ_nottestedsources_frm.jsp" target="_self" class="h4">Sources Not Tested<img src="images/new.gif"></a>
		</td></tr>
...
<div id="resizable13" class="ui-widget-content">
	...
	<div id="accordion15">
	<h3><a href="#">RFD Secretary Reports <img src="images/new.gif"></a> </h3>
	<div>
<table >
<tr>
...
<tr>
<td><b class="green">&nbsp;&nbsp;18.</b></td><td><a href="#" class="h4" onclick="viewWorks('./reports/RFDReports/rws_rwss_action_plan_rfd_frm.jsp')">Habitaions Achievement RFD</a><img src="images/new.gif"></td></tr>

<tr>
<td><b class="green">&nbsp;&nbsp;19.</b></td><td><a href="#" class="h4" onclick="viewWorks('./reports/RFDReports/rws_cm_habitation_asset_status_frm.jsp')">Habitation Status (CM dasboard -1)</a><img src="images/new.gif"></td></tr>
...
<h3><a href="#">CM Reports</a></h3>
<div>

<table >

<tr>
	<td><b class="green">1.</b></td><td><a href="./reports/RFDReports/rws_cm_habitation_asset_status_frm.jsp" target="_self" class="h4">Habitation Status(CM Report1)</a></td>
			
</tr>

<tr>
	<td><b class="green">2.</b></td><td><a href="./reports/RFDReports/rws_OandM_mvs_frm.jsp" target="_self" class="h4">O & M (MVS)CM Report2</a></td>
			
</tr>

<tr>
	<td><b class="green">3.</b></td><td><a href="./reports/RFDReports/rws_WQ_lab_ftk_CM_rpt.jsp" target="_self" class="h4">Lab & FTK CM Report</a></td>
...
<tr>
<td><b class="green">&nbsp;&nbsp;15.</b></td><td><a href="#" class="h4" onclick="viewWorks('./help/PushkarWork.doc')">Pushkar</a><img src="images/new.gif"></td></tr>

<tr>
<td><b class="green">&nbsp;&nbsp;16.</b></td><td><a href="#" class="h4" onclick="viewWorks('./help/SMS.doc')">SMS Sending Procedure </a><img src="images/new.gif"></td></tr>

<tr>
<td><b class="green">&nbsp;&nbsp;17.</b></td><td><a href="#" class="h4" onclick="viewWorks('./help/SMS_FLOW.doc')">Help Doccument for SMS Module</a><img src="images/new.gif"></td></tr>

<tr>
<td><b class="green">&nbsp;&nbsp;18.</b></td><td><a href="#" class="h4" onclick="viewWorks('./help/tankermovment.doc')">Help Doccument for Tanker Movement </a><img src="images/new.gif"></td></tr>

<tr>
<td><b class="green">&nbsp;&nbsp;19.</b></td><td><a href="#" class="h4" onclick="viewWorks('./help/worksandassets.doc')">Help Doccument for Works and Assets</a><img src="images/new.gif"></td></tr>
...
<tr>
<td><b class="green">&nbsp;&nbsp;5.</b></td><td><a href="switch.do?prefix=/reports&page=/imisIds.do?mode=get" class="h4" >IMIS Codes Porting  </a></td></tr>


<tr>
<td><b class="green">&nbsp;&nbsp;6.</b></td><td><a href="switch.do?prefix=/reports&page=/WQLab.do" class="h4" >WQ Lab Porting  </a></td></tr>

<tr>

<td><b class="green">&nbsp;&nbsp;7.</b></td><td><a href="switch.do?prefix=/reports&page=/WQFTKACCESS.do" class="h4" >WQ FTK Porting  </a></td></tr>

<tr>
<td><b class="green">&nbsp;&nbsp;8.</b></td><td><a href="switch.do?prefix=/reports&page=/draccessPorting.do" class="h4" >Drought Works</a></td></tr>

<tr>
<td><b class="green">&nbsp;&nbsp;9.</b></td><td><a href="switch.do?prefix=/reports&page=/DistrictLevel.do" class="h4" >District Level Works </a></td></tr>

<tr>
<td><b class="green">&nbsp;&nbsp;10.</b></td><td><a href="./smsmobile/rws_DataDownload_frm.jsp" class="h4" >Data Download(Sources & Schemes)</a></td></tr>

<tr>
<td><b class="green">&nbsp;&nbsp;11.</b></td><td><a href="./reports/rws_schemes_exp_rpt.jsp" class="h4" >13042016</td></tr>
...
<tr>
<td><b class="green">&nbsp;&nbsp;4.</b></td><td><a href="./reports/BaseLine/rws_jb_ihhl_report_frm.jsp" class="h4" >IHHL Report(NIC Hq data)</a></td></tr>
<tr>
...
<td>
<div id="resizable5" class="ui-widget-content">
	<h3 class="ui-widget-header">Grievance Monitoring Forms<img src="images/new.gif"> </h3>
<h3 class="ui-widget-header"></h3>
...
<!-- <tr>
       <td height=20 colspan="2" class="green"><span class="text2"><a href="switch.do?prefix=/complaints&page=/GenericActionTaken.do&mode=get2"  class="h4" ><b class="green">1.</b>Generic Action To Be Taken Form</a></span></td>
</tr> -->

<tr>
<td height=20 colspan="2" class="green"><span class="text2"><a href="switch.do?prefix=/complaints&page=/Complaintsgeneric.do&mode=get2&special=reset" class="h4"><b class="green">1.</b>Rural Grievnace Entry Form</a></span><img src="images/new.gif"></td></tr><tr>
<!-- <td height=20 colspan="2" class="green"><span class="text2"><a href="switch.do?prefix=/complaints&page=/UrbanComplaintsgeneric.do&mode=get2&special=reset" class="h4"><b class="green">2.</b>Urban Grievnace Entry Form</a></span><img src="images/new.gif"></td></tr><tr> -->
<td height=20 colspan="2" class="green"><span class="text2"><a href="switch.do?prefix=/complaints&page=/ComplaintNogeneric.do&mode=get2&special=reset" class="h4"><b class="green">2.</b>Know your Status of  Generic Grievance</a></span><img src="images/new.gif"></td></tr>
...
<div id="resizable15" class="ui-widget-content">
	<h3 class="ui-widget-header">Grievance Monitoring  Reports</h3>

<div id="accordion3">
     	<h3><a href="#">General Reports</a></h3>
	 <div>
		<table>
			<tr><td class="green"> 1.<a href="/pred/reports/complaints/rws_Generic_Complaints_rpt.jsp" class="h4" >Generic ActionTaken Report</a><img src="images/new.gif"></td>
			</tr>
			<tr><td class="green">2.<a href="./reports/complaints/rws_grievance_status_abstract_frm.jsp" class="h4" >Grievnace Status Abstract Report</a><img src="images/new.gif"></td></tr>		
			<tr><td class="green">3.<a href="./reports/complaints/rws_Grievances_Details_frm.jsp" class="h4" >Grievnace Details Report</a><img src="images/new.gif"></td></tr>					
			<tr><td class="green">4.<a href="./reports/complaints/rws_Nature_Of_Complaints_frm.jsp" class="h4" >Nature Of Compalints Abstract Report</a><img src="images/new.gif"></td></tr>			
			<tr><td class="green">5.<a href="./reports/complaints/rws_Action_Taken_frm.jsp" class="h4" >Action Taken(Nature) Abstract Report</a><img src="images/new.gif"></td></tr>		
		</table>
	</div> 
</div>
...
<!--Added on 17-04-2017 for Urban  -->
<div  id="helpdesk_Urban">
     <table border=0 cellSpacing=0 cellPadding=0   width="100%" >
<tr>
<td>
<div id="resizable5" class="ui-widget-content">
...
<!-- <tr><td height=20 colspan="2" class="green"><span class="text2"><a href="switch.do?prefix=/complaints&page=/Complaintsgeneric.do&mode=get2&special=reset" class="h4"><b class="green">1.</b>Rural Grievnace Entry Form</a></span><img src="images/new.gif"></td></tr> -->
<tr><td height=20 colspan="2" class="green"><span class="text2"><a href="switch.do?prefix=/complaints&page=/UrbanComplaintsgeneric.do&mode=get2&special=reset" class="h4"><b class="green">1.</b>Urban Grievnace Entry Form</a></span><img src="images/new.gif"></td></tr>
<tr><td height=20 colspan="2" class="green"><span class="text2"><a href="switch.do?prefix=/complaints&page=/ComplaintNogeneric_Urban.do&mode=get2&special=reset" class="h4"><b class="green">2.</b>Know your Status of  Generic Grievance</a></span><img src="images/new.gif"></td></tr>
...
<tr>
<td class="green">2.<a href="./reports/complaints/rws_grievance_status_abstract_frm.jsp" class="h4" >Grievnace Status Abstract Report</a><img src="images/new.gif"></td></tr>

<tr>
<td class="green">3.<a href="./reports/complaints/rws_Grievances_Details_frm.jsp" class="h4" >Grievnace Details Report</a><img src="images/new.gif"></td></tr>

		
	<tr>
<td class="green">4.<a href="./reports/complaints/rws_Nature_Of_Complaints_frm.jsp" class="h4" >Nature Of Compalints Abstract Report</a><img src="images/new.gif"></td></tr>
	
	<tr>
<td class="green">5.<a href="./reports/complaints/rws_Action_Taken_frm.jsp" class="h4" >Action Taken(Nature) Abstract Report</a><img src="images/new.gif"></td></tr>
...
<tr>
       <td  class="h4"><span class="text2"><a href="switch.do?prefix=/pushkar&page=/PushkarGhat.do"  class="h4" target="_self"><b class="green">&nbsp;&nbsp;1.</b>Pushkar Entry</a></span></td>
</tr>

<tr>
       <td  class="h4"><span class="text2"><a href="switch.do?prefix=/pushkar&page=/PushkarWork.do&mode=null"  class="h4" ><b class="green">2.</b>&nbsp;&nbsp;PushkarGhat Work Entry Form</a></span></td>
</tr>
...
<table >
 ...
 <tr>
     <td><b class="green">&nbsp;&nbsp;1.</b></td><td><a href="./reports/Pushkar/rws_pushkar_abstract_frm.jsp" target="_self" class="h4">Pushkar Work Wise Abstract Report</a></td>
     </tr>
     <tr>
     <td><b class="green">&nbsp;&nbsp;2.</b></td><td><a href="./reports/Pushkar/rws_pushkar_work_wise_progress_frm.jsp" target="_self" class="h4">Work wise progress Report</a></td>
   
</tr>
 <tr>
     <td><b class="green">&nbsp;&nbsp;3.</b></td><td><a href="./reports/Pushkar/rws_Pushkar_Ghatwise_report1_frm.jsp" target="_self" class="h4">Pushkar Abstract Report</a></td>
																...
																<div id="resizable7" class="ui-widget-content">
																	...
																	<div id="accordion44">
																		...
																		<div>
																			<table class="green">
<tr>
       <td  class="h4"><span class="text2"><a href="switch.do?prefix=/smsmobile&page=/employeeEntry.do&mode=get"  class="h4" target="_self"><b class="green">&nbsp;&nbsp;1.</b>Employee Mobile Entry</a></span></td>
</tr>
<tr>
       <td class="h4"><span class="text2"><a href="switch.do?prefix=/masters&page=/ceo.do"  class="h4" ><b class="green">&nbsp;&nbsp;2.</b>ZP CEO/DPO Entry</a></span></td>
</tr>
<tr>
       <td  class="h4"><span class="text2"><a href="switch.do?prefix=/masters&page=/mpdo.do"  class="h4" ><b class="green">&nbsp;&nbsp;3.</b>MPDO/MRO/Section Officer/EORD Entry</a></span></td>
</tr>
<tr>
       <td class="h4"><span class="text2"><a href="switch.do?prefix=/masters&page=/sarpanch.do"  class="h4" ><b class="green">&nbsp;&nbsp;4.</b>Sarpanch Entry</a></span></td>
</tr>
<tr>
       <td  class="h4"><span class="text2"><a href="switch.do?prefix=/masters&page=/villagesec.do"  class="h4"><b class="green">&nbsp;&nbsp;5.</b>Village Secretary Entry</a></span></td>
</tr>

<tr>
       <td  class="h4"><span class="text2"><a href="switch.do?prefix=/smsmobile&page=/dlpo.do"  class="h4" target="_self"><b class="green">&nbsp;&nbsp;6.</b>DLPO Entry</a></span></td>
</tr>

<tr>
       <td  class="h4"><span class="text2"><a href="switch.do?prefix=/smsmobile&page=/SmsRegistration.do&mode=get2&special=reset"  class="h4" target="_self"><b class="green">&nbsp;&nbsp;7.</b>Registration Form</a></span></td>
</tr>


<tr>
 <td  class="h4"><span class="text2"><a href="switch.do?prefix=/smsmobile&page=/AuthorisedUserDetails.do&mode=get2"  class="h4" target="_self"><b class="green">&nbsp;&nbsp;8.</b>Authorize Registered Users</a></span></td>
</tr>
<tr>
 <td  class="h4"><span class="text2"><a href="switch.do?prefix=/smsmobile&page=/ResidualChlorine.do&mode=get"  class="h4" target="_self"><b class="green">&nbsp;&nbsp;9.</b>Residual Chloride-Action Taken</a></span></td>
</tr>
<tr>
 <td  class="h4"><span class="text2"><a href="switch.do?prefix=/smsmobile&page=/SchemesActionTaken.do&mode=get"  class="h4" target="_self"><b class="green">&nbsp;&nbsp;10.</b>Schemes-Action Taken</a></span></td>
</tr>
<tr>
 <td  class="h4"><span class="text2"><a href="switch.do?prefix=/smsmobile&page=/DroughtActionTaken.do&mode=get"  class="h4" target="_self"><b class="green">&nbsp;&nbsp;11.</b>Water Tanker-Action Taken</a></span></td>
</tr>

<tr>
 <td  class="h4"><span class="text2"><a href="switch.do?prefix=/smsmobile&page=/OhsrActionTaken.do&mode=get"  class="h4" target="_self"><b class="green">&nbsp;&nbsp;12.</b>OHSR & GLSR Action Taken</a></span></td>
</tr>

<tr>
       <td  class="h4"><span class="text2"><a href="switch.do?prefix=/works&page=/aap1.do&mode=data&mode1=circles"  class="h4" ><b class="green">&nbsp;&nbsp;13.</b>Progress Report</a></span></td>
</tr>

<tr>
       <td  class="h4"><span class="text2"><a href="switch.do?prefix=/smsmobile&page=/divisionMandal.do"  class="h4" target="_self"><b class="green">&nbsp;&nbsp;14.</b>DLPO Division Mandal Mapping</a></span></td>
</tr>
...
<div>
	<table class="green">
	<tr>
	<td class="h4"><span class="text2"><a href="switch.do?prefix=/smsmobile&page=/SmsRegistration.do&mode=get2&special=reset" class="h4" target="_self"><b class="green">&nbsp;&nbsp;1.</b>Registration Form</a></span></td>
	</tr>
	<tr>
	<td class="h4"><span class="text2"><a href="switch.do?prefix=/smsmobile&page=/TankerRegistration.do&mode=get2&special=reset" class="h4" target="_self"><b class="green">&nbsp;&nbsp;2.</b>Tanker Registration Form</a></span></td>
	</tr>
	<tr>
	<td class="h4"><span class="text2"><a href="switch.do?prefix=/smsmobile&page=/PrivateSourceReg.do&mode=get2&special=reset" class="h4" target="_self"><b class="green">&nbsp;&nbsp;3.</b>Private Source Entry Form</a></span></td>
	</tr>
	<tr><td class="h4"><span class="text2"><a href="switch.do?prefix=/smsmobile&page=/SourceDestination.do&mode=get2&special=reset" class="h4" target="_self"><b class="green">&nbsp;&nbsp;4.</b>Source and Destination Entry Form</a></span></td>
	</tr>																		
	</table>
	</div>
	</div>
...
<tr>
	 ...
	 <tr>
<td><b class="green">&nbsp;&nbsp;4.</b></td><td><a href="#" class="h4" onclick="viewWorks('./help/SMS.doc')">SMS Sending Procedure </a><img src="images/new.gif"></td></tr>

<tr>
<td><b class="green">&nbsp;&nbsp;5.</b></td><td><a href="#" class="h4" onclick="viewWorks('./help/SMS_FLOW.doc')">Help Doccument for SMS Module</a><img src="images/new.gif"></td></tr>
...
<tr>
<td><b class="green">&nbsp;&nbsp;6.</b></td><td><a href="./downloads/mobile/RWSS_WaterTankerMovement_V1.0.apk" class="h4" >Download Tanker Movement Mobile App (Updated on 16-03-2017)</a><img src="images/new.gif"></td></tr>

<tr>
<td><b class="green">&nbsp;&nbsp;7.</b></td><td><a href="./downloads/mobile/Rwss_Asset_V1.0.apk" class="h4" >Download Works and Assets Mobile App</a><img src="images/new.gif"></td></tr>
...
<tr>
<td><b class="green">&nbsp;&nbsp;1.</b></td><td><a href="switch.do?prefix=/Sanitation&page=/IhhlReport.do?mode=inFlexi" target="_self" class="h4">IHHL Free Format Report</a></td>
</tr>
...
<tr>
       <td height=20 colspan="2" class="h4"><span class="text2"><a href="switch.do?prefix=/complaints&page=/GenericActionTaken.do&mode=get2"  class="h4" ><b class="green">7.</b>Generic Action To Be Taken Form</a></span></td>
</tr>
</table>
</div>
</td>
...
<tr>
<td height=20 colspan="2" class="green"><span class="text2"><a href="switch.do?prefix=/complaints&page=/Complaintsgeneric.do&mode=get2&special=reset" class="h4"><b class="green">2.</b>Grievnace Entry Form</a></span><img src="images/new.gif"></td></tr>
