						...
						<TD>
															...
															<TABLE border=0 cellSpacing=0 cellPadding=0 width="100%">
																<TBODY>
																	...
																	<TR bgcolor="white">
																		...
																		<%-- <td><img
																			src="<rws:context page='/images/enc.jpg' />"
																			width="120" height="130"></td> --%>
																		<td><font class="title1">Welcome&nbsp;to&nbsp;Engineer-in-Chief
																		</font><!-- <font color="#9400d3" size="2" face="verdana">Shri.&nbsp;Dr.Narayana Bharat Gupta, IAS,<br>Engineer In Chief,
																		</font>
																		<font class="title2"><br> RWSS </font> --></td>
							...
							<div id="tabs">
								<ul>
									...
									<li><a href="#bank">Bank Payments</a></li>
...
<td><b class="green">1.</b></td><td><a href="switch.do?prefix=/masters&page=/transferAmount.do?mode=divview" class="h4" >BANK - Bill Process</a></td></tr>
 -->

														<tr>

															<!--<td><b class="green">1.</b></td><td><a href="<rws:context page='/masters/rws_contractor_sel_payment.jsp'/>" class="h4" >BANK - Bill Process</a></td></tr>-->
															<!-- href="switch.do?prefix=/masters&page=/otp.do&mode=data" -->
															<%-- href="<rws:context page='/masters/rws_contractor_sel_payment.jsp'/>" --%>
															<td><b class="green">1.</b></td>
															<td><a
															href="<rws:context page='/masters/rws_contractor_sel_payment.jsp'/>"
																class="h4">BANK - Bill Process</a></td>
														</tr>
														<tr>
															...
															<td><a
																href="<rws:context page='/masters/rws_bill_release_to_pao_division.jsp'/>"
																class="h4">PAO - Bill Process</a></td>
														</tr>

														<tr>
															<td><b class="green">3.</b></td>
															<td><a
																href="<rws:context page='/masters/rws_div_works_refunds.jsp'/>"
																class="h4">Refunds</a></td>
														</tr>

														<tr>
															<td><b class="green">4.</b></td>
															<td><a
																href="switch.do?prefix=/fundAccounting&page=/paymentRevertion.do?mode=init"
																class="h4">Revertion (BANK Forward PAO )</a></td>
														</tr>

														<tr>
															<td><b class="green">5.</b></td>
															<td><a
																href="<rws:context page='/masters/rws_div_spillworks_refunds.jsp'/>"
																class="h4">Spill Refunds</a></td>
														</tr>


														<!--  
<tr>
<td><b class="green">4.</b></td><td><a href="switch.do?prefix=/masters&page=/transferAmount.do?mode=view" class="h4" >Bank - Contractor Wise </a></td></tr>

<tr>
<td><b class="green">5.</b></td><td><a href="<c:url value="switch.do?prefix=/masters&page=/encDSRegToken.do&mode=data"></c:url>" class="h4" >Registration DSC Token</a></td></tr>
...
%>
 <tr>
	...
	<a href="./reports/works/rws_work_progress_min_abstract_rpt.jsp" target="_blank">Abstract Progress Report(State Level Programmes)</a>
	  ...
	  <tr>	
		<td><b class="green">8.</b></td><td><a href="./reports/rws_ongoing_works_abs_frm.jsp" target="_self">Ongoing Works Progress(Abstract)</a> 
		</td>
		</tr>
	 </table>	
		<br>
