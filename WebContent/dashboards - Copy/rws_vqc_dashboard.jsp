...
<%
	...
	users.setDivisionOfficeName(rwsOffices.getCircleOfficeName((javax.sql.DataSource)request.getAttribute("dataSource"),"1",userid.substring(1,3)));
	users.setDivisionOfficeCode(userid.substring(1,3));
	users.setOfficeName("Vigilance and Quality Control");
															...
															<TABLE border=0 cellSpacing=0 cellPadding=0 width="100%">
																<TBODY>
																	...
																	<TR bgcolor="white">
																		...
																		<br> <br>
																				<font color="#3366ff"><b> <%= rwsOffices.getCircleOfficeName((javax.sql.DataSource)request.getAttribute("dataSource"),"1",userid.substring(1,3))%>
																				<br>
																				[ <c:out value="${sessionScope.RWS_USER.userType} " /> ]</b></font>
																		</b><br></br> <%-- [ <c:out
																...
																<div id="resizable3" class="ui-widget-content">
																	...
																	<table class="green">
																			...
																			<td class="h4"><span class="text2"><a
																					...
																					class="h4"><b class="green">&nbsp;&nbsp;1.</b>Quality Control
																			</a><img src="images/new.gif"></span></td>
																		</tr>
																		<tr>
																			<td class="h4"><span class="text2"><a
																					href="switch.do?prefix=/works&page=/TPQC.do&mode=data"
																					class="h4"><b class="green">&nbsp;&nbsp;2.</b>Third Party Quality Control
																			</a><img src="images/new.gif"></span></td>
																		</tr>
