...
URL = "./reports/rws_work_gen.jsp?district=00&finyear=<%=finYear1%>	&planNonplan=1&drill=null&distname=ALL";
			...
			URL = "switch.do?prefix=/drought&page=/TransportWaterDetail.do&mode=districts";
																...
																<tr>
																	<td height=20 colspan="2" class="h4"><span
																		class="text2"><a
																			...
																			class="h4"><b class="green">&nbsp;&nbsp;1.</b>Scarcity
																				Reasons</a></span></td>
																</tr>
																...
																<table>
																	...
																	<tr>
																		...
																		<td><a href="./reports/rws_Slipage_hab_frm.jsp"
																			target="_blank" class="h4">Slippage Report </a></td>
																		...
																		<td><a href="./reports/rws_Fc_schemes_frm.jsp"
																			target="_blank" class="h4">Assets Report </a></td>
																		<td><b class="green">28.</b></td>
																		<td><a href="./reports/rws_HabPop_rpt.jsp"
																			target="_blank" class="h4">Hab LPCD Population
																				Report</a></td>
																	...
																	<tr>
																		...
																		<td><a
																			...
																			target="_blank" class="h4"><br>Habitation
																...
																<table>
																	<tr>
																		...
																		<td><a
																			...
																			target="_blank" class="h4">Check List</a>
																		<td>
																	</tr>
																	<tr>
																		<td><b class="green">2.</b></td>
																		<td><a
																			...
																			target="_blank" class="h4">Status Forms</a>
																		<td>
																	</tr>
																	<tr>
																		<td><b class="green">3.</b></td>
																		<td><a
																			...
																			target="_blank" class="h4">Department Opted</a>
																		<td>
																	</tr>
																	<tr>
																		<td><b class="green">4.</b></td>
																		<td><a
																			...
																			target="_blank" class="h4">Employee Search</a>
																		<td>
																	</tr>
																	<tr>
																		<td><b class="green">5.</b></td>
																		<td><a href="./reports/rws_employee_work_frm.jsp"
																			target="_blank" class="h4">Employee Work Details
																		</a>
																		<td>
																	</tr>
																</table>
															...
															<div>
																<table>
																	...
																	<tr>
																		...
																		<td><b class="green">11.</b></td>
																		<td><a href="./reports/rws_asurfaceohsr_frm.jsp"
																			target="_self" class="h4">GIS Information Reports
																		</a></td>
												...
												<table>
													...
													<tr>
														<td height=20 colspan="2" class="h4"><span
															class="text2"><a
																...
																class="h4"><b class="green">1.</b>Habitations For
																	Drought</a></span></td>
													</tr>
													...
													<tr>
														<td height=20 colspan="2" class="h4"><span
															class="text2"><a
																...
																class="h4"><b class="green">4.</b>Drought SS Tanks</a></span></td>
													</tr>
													<tr>
														<td height=20 colspan="2" class="h4"><span
															class="text2"><a
													...
													<tr>
														<td class="h4"><span class="text2"><a
																href="switch.do?prefix=/drought&page=/newsItem.do&mode=districts&special=reset"
														...
														<table>
															...
															<tr>
																...
																<td><a
																	...
																	target="_self" class="h4">Status report of drought
																		Habitations </a></td>
															</tr>
															<tr>

																<td><b class="green">4.</b></td>
																<td><a href="./reports/rws_drought_deepen_frm.jsp"
															...
															<tr>
																...
																<td><a
																	...
																	target="_self" class="h4">Abstract of Daily Report
																		on Drinking Water Situation ( Drought ) </a></td>
															</tr>
														...
														<table>
															...
															<tr>
																...
																<td><a
																	...
																	target="_self" class="h4">SS Tank- Consolidated</a></td>
															</tr>

															<tr>

																<td><b class="green">7.</b></td>
																<td><a href="./reports/rws_works_exception_frm.jsp"
									...
									<tr>
										<td>
											<div id="resizable6" class="ui-widget-content">
												...
												<table>
													<tr>
       <td height=20 colspan="2" class="h4"><span class="text2"><a href="switch.do?prefix=/reports&page=/GenericActionTaken.do&mode=get2"  class="h4" ><b class="green">1.</b>Generic ActionTaken Report</a></span></td>
</tr>
...
<table>
<tr>
       <td height=20 colspan="2" class="h4"><span class="text2"><a href="switch.do?prefix=/reports&page=/GenericActionTaken.do&mode=get2"  class="h4" ><b class="green">4.</b>Generic ActionTaken Report</a></span></td>
</tr>
												...
												<div id="accordion15">
													...
													<table>
														...
														<tr>
                                                         ...
                                                         <tr>
																			...
																			<tr>
																				<td><b class="green">&nbsp;&nbsp;5.</b></td>
																				<td><a
																					href="./reports/smsmobile/rws_tanker_movement_daily_statistics_frm.jsp"
																			...
																			<!-- <tr>
																				<td><b class="green">&nbsp;&nbsp;5.</b></td>
																				<td><a
																					href="./reports/smsmobile/rws_tanker_movement_tanker_daily_statistics.jsp?mode=det"
																					target="_self" class="h4">Tanker Statistics -
																						Daily Report</a><img
																					src="images/new.gif"></td>
																			</tr> -->
														...
														<tr>
															<td><b class="green">&nbsp;&nbsp;6.</b></td>
															<td><a href="#" class="h4"
																onclick="viewWorks('./help/SMS.doc')">SMS Sending
																	Procedure </a><img src="images/new.gif"></td>
														</tr>
...
-->
														...
														<!-- <tr>
<td><b class="green">&nbsp;&nbsp;8.</b></td><td><a href="#" class="h4" onclick="viewWorks('./help/Tanker_Movement.doc')">Help Document for Tanker Movement and Works and Assets</a><img src="images/new.gif"></td></tr>
								...
								<table border=0 cellSpacing=0 cellPadding=0 width="100%">
									<tr>
										<td>
											<div id="resizable5" class="ui-widget-content">
												<h3 class="ui-widget-header">
													HelpDesk Form<img src="images/new.gif">
												</h3>
												<h3 class="ui-widget-header"></h3>
													...
													<tr>
														<td height=20 colspan="2" class="green"><span
															class="text2"><a
																...
																class="h4"><b class="green">1.</b>Generic Action To
																	Be Taken Form</a></span></td>
													</tr>
										...
										<td>
											...
											<div id="resizable15" class="ui-widget-content">
												<h3 class="ui-widget-header">HelpDesk Reports</h3>
														...
														<table>
															...
															<tr>
																<td class="green">4.<a
																	...
																	class="h4">Nature Of Compalints Abstract Report</a><img
																	src="images/new.gif"></td>
															</tr>
															...
															<tr>
																<td class="green">5.<a
																	...
																	class="h4">Action Taken(Nature) Abstract Report</a><img
																	src="images/new.gif"></td>
															</tr>
