...
infosoftglobal.FusionCharts.prototype = {
	...
	getSWFHTML: function() {
		...
		if (navigator.plugins && navigator.mimeTypes && navigator.mimeTypes.length) { 
			...
			swfNode = '<embed type="application/x-shockwave-flash" src="'+ this.getAttribute('swf') +'" style="position:relative;" width="'+ this.getAttribute('width') +'" height="'+ this.getAttribute('height') +'"  ';
