		...
		function fnSubmit1()
	{
		   ...
		   var loggedUser = '<%=loggedUser%>';
			...
			else
			{
				...
				document.f1.action="./Rws_Ntr_Hab_Plant_Details_Rpt.jsp";
				document.f1.submit();
			}	
...
<table border = 1 align = center cellspacing = 0 cellpadding = 0 rules = "rows" bordercolor = navy style = "border-collapse:collapse" bgcolor="#ffffff" width=350>		
	...
	<tr bgcolor="#8A9FCD" align="center">
		<td align="center" class="rptHeading" colspan=3>NTR Sujala Plant Installation Details  </td>	
	</tr>
...
<tr><td class=rptLabel>Coverage Status&nbsp;&nbsp;</td>
		<td class=btext>
...
%>
	<tr bgcolor="#8A9FCD" align="center">
		<td align="center" colspan=3 class=btext>
			<input type="button" name="reptype"  value="Get Details" onclick="fnSubmit1();"/>
         	</td>
	</tr>
