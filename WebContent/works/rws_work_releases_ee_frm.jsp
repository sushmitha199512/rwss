...
function getDivisions()
	{
	 ...
	 document.forms[0].action="switch.do?prefix=/works&page=/WorkReleases.do&mode=data&mode1=Divisions";
		document.forms[0].submit();
	
	}
function getWorkcategory()
	{
	  document.forms[0].action="switch.do?prefix=/works&page=/WorkReleases.do&mode=data&mode1=workcategory";
...
function getSubProgramme()
{
	...
	//document.forms[0].action="switch.do?prefix=/works&page=/WorkReleases.do&mode=data&mode1=subprogrammes";
	//monitoringForm.submit();
...
function getWorks1()
{
	...
	document.forms[0].action="switch.do?prefix=/works&page=/WorkReleases.do&mode=data&mode1=getworks";
	monitoringForm.submit();
...
function getCancelWorks()
{
	  ...
	  alert("Please Check Plan / Non Plan ");
		...
		document.forms[0].action="switch.do?prefix=/works&page=/WorkReleases.do&mode=data&mode1=getCancelWorks";
		document.forms[0].submit();		
		}
...
function checkAmount(value){
	value=value-1;
//alert(document.forms[0].elements["refundForm["+value+"].releaseAmount"].value);
//if(isNaN(document.forms[0].elements["refundForm["+value+"].releaseAmount"].value))
//{
//alert("dfdsf");
//document.forms[0].elements["refundForm["+value+"].releaseAmount")].value=value;
//return;
//}
...
//var refundAmount=document.forms[0].elements["refundForm["+value+"].refundAmount"].value;
//var releaseAmount=document.forms[0].elements["refundForm["+value+"].releaseAmount"].value*100000;
...
//alert("refundAmount"+refundAmount);
//alert("releaseAmount"+releaseAmount);
...
function getWorks1()
	{
	  ...
	  alert("Please Select Division Code");
		...
		document.forms[0].action="switch.do?prefix=/works&page=/WorkReleases.do&mode=data&mode1=getWorks1";
		document.forms[0].submit();	
		}
	}
...
function getFinancialYears()
{
	  ...
	  alert("Please Select Division Code");
		...
		document.forms[0].action="switch.do?prefix=/works&page=/WorkReleases.do&mode=data&mode1=finYears";
		document.forms[0].submit();	
		}
...
function getReleaseDates()
	{
	  ...
	  alert("Please Select Division Code");
		...
		document.forms[0].action="switch.do?prefix=/works&page=/WorkReleases.do&mode=data&mode1=releaseDates";
		document.forms[0].submit();	
		}
	}
...
function fnSave(count)
{
 ...
 for(i=1;i<count;i++){
//alert(document.forms[0].elements["refundForm[0].chequeNo"].value);
//alert(document.forms[0].elements['refundForm['+(i-1)+'].chequeNo'].value );
...
if(document.forms[0].elements['refundForm['+(i-1)+'].chequeNo'].value ==''){
   alert("Please Enter Check Number for Selected Works");
return;
}
...
return;
		...
		document.forms[0].action="switch.do?prefix=/works&page=/WorkReleases.do&mode=data&mode1=save";
               document.forms[0].submit();
}
...
if(document.forms[0].elements['check'+i].checked==true){
// if(document.forms[0].elements['refundForm['+(i-1)+'].chequeNo'].value !=""){
//alert(document.forms[0].elements['check'+i].checked);
flag=true;
break;
//}else{
...
return;
		...
		document.forms[0].action="switch.do?prefix=/works&page=/WorkReleases.do&mode=data&mode1=forwardenc";
               document.forms[0].submit();
}
	  ...
	  if(yes==1)
	   {
		 ...
		 //document.monitoringForm.action="switch.do?prefix=/works&page=/WorkReleases.do&mode=data&mode1=getWorks";
		 //document.monitoringForm.submit();
		  ...
		  if(val){
		  document.forms[0].action="switch.do?prefix=/works&page=/WorkReleases.do&mode=data&mode1=DeleteWorks";
          document.forms[0].submit();
	}
 ...
 function fnShowHabs(workid)
{
	...
	var url = "switch.do?prefix=/works&page=/WorkReleases.do&mode=showHabs&workID="+workId;
...
<html:form action="WorkReleases.do">
<body>
<% 
			String csrfToken="";
...
<jsp:include page="/commons/TableHeaderWithoutClose.jsp">
	<jsp:param name="TableName" value="Refunds" />
...
<logic:present name="circles">
				...
				<td class="textborder" colspan="4" nowrap>&nbsp;&nbsp;&nbsp;&nbsp;<html:radio
					property="bankOrPao" value="1"  onclick="getFinancialYears();" />Bank&nbsp;&nbsp;&nbsp;&nbsp;
				<html:radio property="bankOrPao" onclick="getFinancialYears();" value="2"
				 />PAO
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<logic:present name="financialYears">
						...
						<td class="textborder"><html:select property="finYear"
							style="width:143px" styleClass="mycombo"
							onchange="javascript:getReleaseDates();">
							<html:option value="">
								<font class="myfontclr1">Select...
							</html:option>
							<html:options collection="financialYears" property="value"
								labelProperty="label" />
						</html:select></td>
...
<logic:present name="releaseDates">
						<td class="textborder">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Release Dates</td>
						<td class="textborder"><html:select property="releaseDate"
							style="width:143px" styleClass="mycombo"
							onchange="javascript:getWorks();">
							<html:option value="0">
								<font class="myfontclr1">Select...
							</html:option>
							<html:options collection="releaseDates" property="value"
								labelProperty="label" />
						</html:select></td>
...
<logic:present name="programs">
	...
	<table bgcolor="#FFFFFF" bordercolor="#8A9FCD" width="100%" border=1
		...
		<tr bgcolor="#8A9FCD">
			<td class="bwborder" colspan="14"><B><font color="#FFFFFF">Works For
			Refund</B></td>
			<td align="center"></td>
		</tr>
		<tr>
...
<td class="bwborder" ><nested:text property="chequeDate" name="refundForm"   indexed="true"    style="width: 90px"  onkeypress="return decimalsOnly(event)"/>
