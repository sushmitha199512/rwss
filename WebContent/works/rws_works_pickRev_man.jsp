...
var len=document.forms[0].elements["count"].value;
  ...
  var mcodes="00";
    ...
    document.forms[0].action="switch.do?prefix=/works&page=/PickHabs.do?mode=none&workId="+workId+"&revTs=Yes";
...
<%try{
 java.util.ArrayList mcodes=(java.util.ArrayList)session.getAttribute("SanctionedRevHabs");
