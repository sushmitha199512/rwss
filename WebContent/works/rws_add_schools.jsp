...
var len=document.getElementById('count').value;
  ...
  var mcodes="00";
    ...
    document.forms[0].action="switch.do?prefix=/works&page=/HabLink.do?mode=pickschools";
...
<form name="HabLinkBean" method="post">
...
<tr bgcolor="#8A9FCD">
<th colspan=2>Select Mandals To Add/Remove Schools.</th>
</tr>
<tr bgcolor="#8A9FCD">
