...
function openFile(index){
	...
	var url="./switch.do?prefix=/works&page=/QC.do&mode=data&mode1=showQcCertificate&workId="+document.forms[0].workId.value;
...
function updateDetails()
{
	...
	var engineer_assn1=document.getElementById('engineerAssignDee').value;
	var engineer_assn2=document.getElementById('engineerAssignEe').value;
	var engineer_assn3=document.getElementById('engineerAssignSe').value;
	//alert("*******"+engineer_assn);
...
/* 	  var tptImg = document.getElementById('tptImg');
	  ...
	  alert("Please Enter  Work ID");
		return;
		  ...
		  alert("Please Select Name of the AE/AEE Inspected.");
			return;
		}
...
//var atype=document.getElementById("assettype"+index).value;
 ...
 // alert(atype);
  ...
  // document.forms[0].action="switch.do?prefix=/works&page=/QC.do&mode=updatedetails";
   document.forms[0].action="switch.do?prefix=/works&page=/QC.do&mode=data&mode1=upddetails";
...
function funcDistrictChanged() {
	...
	document.forms[0].action="switch.do?prefix=/works&page=/QC.do&mode=data&mode1=getDetails";
	document.forms[0].submit();
}

function getDivisions()
	{
	  document.forms[0].action="switch.do?prefix=/works&page=/QC.do&mode=data&mode1=Divisions";
	  //alert(document.forms[0].circleCode.value);
	  /* if(document.forms[0].circleCode.value=='-1'){
	  var mySelect = document.getElementById("select");
	  var len = mySelect.length;
	  for (var i = 0; i < len; i++) {alert(i);
	      mySelect.remove(0);
	  }
	  } */
...
function getWorkcategory()
	{
	  document.forms[0].action="switch.do?prefix=/works&page=/QC.do&mode=data&mode1=workcategory";
	  document.getElementById("workCat").selectedIndex = "0";
...
/* function getSubDivisions()
	{
		document.forms[0].action="switch.do?prefix=/works&page=/QC.do&mode=data";
		monitoringForm.submit();
	} */
function getSubDivisions()
{
	document.forms[0].action="switch.do?prefix=/works&page=/QC.do&mode=data&mode1=subDivisions";
	document.getElementById("workCat").selectedIndex = "0"; 
	monitoringForm.submit();
}
function getProgramme()
{
	document.forms[0].action="switch.do?prefix=/works&page=/QC.do&mode=data&mode1=programmes";
	monitoringForm.submit();	
}
function getSubProgramme()
{
	document.forms[0].action="switch.do?prefix=/works&page=/QC.do&mode=data&mode1=subprogrammes";
	monitoringForm.submit();	
}
function getWorks1()
{
	document.forms[0].action="switch.do?prefix=/works&page=/QC.do&mode=data&mode1=getworks";
	monitoringForm.submit();
}
...
function getCancelWorks()
{
	  ...
	  alert("Please Check Plan / Non Plan ");
		...
		document.forms[0].action="switch.do?prefix=/works&page=/QC.do&mode=data&mode1=getCancelWorks";
		document.forms[0].submit();		
		}
	  ...
	  if(yes==1)
	   {
		 alert("TO DELETE WORKS SELECT CHECK BOXES");
		  ...
		  if(val){
		  document.forms[0].action="switch.do?prefix=/works&page=/QC.do&mode=data&mode1=DeleteWorks";
          document.forms[0].submit();
	}
 ...
 function fnShowHabs(workid)
{
	...
	var url = "switch.do?prefix=/works&page=/QC.do&mode=showHabs&workID="+workId;
...
<html:form action="QC.do" method="post" enctype="multipart/form-data">
<body onload="checkMe()">
<%-- <table width="100%">
...
<table bgcolor="#DEE3E0" bordercolor= "#8A9FCD" rules="none" value="700" border=1 style="border-collapse:collapse;" >
   ...
   <%String cirfi=(String)session.getAttribute("fixcircle");
      ...
      String divusercode=RWS_USER.getDivisionOfficeCode(); System.out.println("rws_qc_frm divusercode :"+divusercode);
	 ...
	 <%-- <tr >
	    ...
	    <tr class="textborder">
			<logic:present name="rwsWorks">
	            ...
	            <html:option value="-1"><font class="myfontclr1">Select...</font></html:option>
		...
		<table cellpadding="0" cellspacing="2"   border="0" bordercolor= "#8A9FCD" style="border-collapse:collapse;" >
		<tr>
		<td class="textborder" align="right">Name of the AE/AEE Inspected<font color="#FF6666">*</font><html:select property="engineerAssign" style="width: 400px" styleClass="mycombo" >
		...
		<tr>
		<td class="textborder" align="right">Name of the DEE Inspected<font color="#FF6666">*</font><html:select property="engineerAssignDee" style="width: 400px" styleClass="mycombo" >
			<html:option value=""><bean:message key="app.pleaseSelect" /></html:option>
				<logic:present name="engAssignedByDee">
				<html:options collection="engAssignedByDee" property="value" labelProperty="label" />
			</logic:present>
		</html:select></td>
		</tr>
		<tr>
		<td class="textborder" align="right">Name of the EE Inspected<font color="#FF6666">*</font><html:select property="engineerAssignEe" style="width:400px" styleClass="mycombo" >
			<html:option value=""><bean:message key="app.pleaseSelect" /></html:option>
				<logic:present name="engAssignedByEe">
				<html:options collection="engAssignedByEe" property="value" labelProperty="label" />
			</logic:present>
		</html:select></td>
		</tr><tr>
		<td class="textborder" align="right">Name of the SE Inspected<font color="#FF6666">*</font><html:select property="engineerAssignSe" style="width: 400px" styleClass="mycombo" >
			<html:option value=""><bean:message key="app.pleaseSelect" /></html:option>
				<logic:present name="engAssignedBySe">
				<html:options collection="engAssignedBySe" property="value" labelProperty="label" />
			</logic:present>
		</html:select></td>
		</tr>
...
<tr>
		<td class="textborder" align="right" ><font face=verdana size=2><b>Date of Inspection</b></font><font color="#FF6666">*</font></td>
		<td class="textborder" align="right" style="padding-right: 200px;"><html:text  property="issueDate" style="width:145" styleClass="mytext" readonly="readonly"  />
		...
		<td class="textborder" align="right"><html:text property="certDate" style="width:145" styleClass="mytext"  readonly="readonly"/>
