...
<table bgcolor="#DEE3E0" bordercolor= "#8A9FCD" rules="none" 
		...
		<label>	<label>
			...
			<tr  bgcolor="#8A9FCD">
				...
				<td>
				<!-- <nested:equal name="WORK" property="label" value="Y">
					<INPUT type="button" name="voucher" value='...' class="btext" onClick='openVoucher(<nested:write name="WORK" property="workid" />,<nested:write name="WORK" property="mileStoneSno" />)'>
				</nested:equal> -->
				<!-- <nested:equal name="WORK" property="label" value="N">
					<INPUT type="button" name="voucher" value='...' class="btext" disabled title="Save the Milestone Achievement Details & Add Vouchers">
				</nested:equal> -->
				</td>
				</tr>
				</nested:iterate> 		 
...
function openVoucher()
{
	...
	var workIdd = '<%=request.getParameter("workId")%>';
			...
			var zURL = "./switch.do?prefix=/works&page=/WorkStatus.do&mode=ExpVoucherContractor&workId="+workIdd+"&workName="+workName;
