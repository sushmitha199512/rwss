...
function fnSave()
{
	...
	if(document.forms[0].circleOfficeCode.value=="")
	{
		...
		alert("Please Select Division");
	    return false;
	}else if(document.forms[0].sno.value=="0"){
	...
	{
	document.forms[0].action="/pred/works/eoatFrm.do?mode=update";
	document.forms[0].submit();
	}
}
...
<table   align=center bgcolor="#DEE3E0" bordercolor= "#8A9FCD"  border="0"  style="border-collapse:collapse;" width="100%" >	
 ...
 <tr>
	...
	<html:text property="sno" styleClass="mytext"  style="width:100"  readonly="true"/>
				</td>
  						...
  						<tr class="textborder">
					   		...
					   		<td colspan="3">
					   			<html:text property="workId" styleClass="mytext"  style="width:400"  readonly="true"/>
				    		...
				    		<td>
								<html:text property="programmeCode" styleClass="mytext"  style="width:80"  readonly="true"/>
					...
					<table   align=center bgcolor="#DEE3E0" bordercolor= "#8A9FCD"  border="0"   width="100%" >	
  						<tr class="textborder">
					   		...
					   		<td>
				    			   ...
				    			   styleClass="mytext" maxlength="25" style="width:125" onkeypress="upperOnly()" readonly="true"/>
				    		</td>
				    		<td width="150">
