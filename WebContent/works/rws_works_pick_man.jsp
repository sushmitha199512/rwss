...
var len=document.getElementById('count').value;
  ...
  var mcodes="00";
    ...
    document.forms[0].action="switch.do?prefix=/works&page=/PickHabs.do?mode=none&workId="+workId+"&revTs=No";
...
<%try{
 java.util.ArrayList mcodes=(java.util.ArrayList)session.getAttribute("SanctionedHabs");
 if(mcodes != null){
