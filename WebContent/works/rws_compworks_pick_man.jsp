...
var len=document.getElementById('count').value;
  ...
  var mcodes="00";
    ...
    document.forms[0].action="switch.do?prefix=/works&page=/PickCompHabs.do?mode=none&workId="+workId+"&revTs=No";
...
{
	if(mcodes[x]!=null)counts++;
}
}
 if(mcodes != null){
for(int i=0;i<counts;i++)
{
String mcode=(mcodes[i]).substring(5,7);
 %>
 <script>
	var len=document.getElementById('count').value;
	for(var i=0;i<len;i++)
