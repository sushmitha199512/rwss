...
function fnAdd()
{
	...
	var selectedHabs = 	WorkForm1.elements("selectedRevHabCode");
	var len;
	var isAllowed = false;
	if(selectedHabs)
	{
		...
		if(isAllowed)
		{
			if(confirm("Do you want add the selected habitations?"))
			{
				...
				openerDoc.getElementById("revTsHabsBen").value = noOfSelectedHabs;
		 	    
		 	 	document.forms[0].action="/pred/works/SaveHabs.jsp";
