...
{
	var zURL = "./switch.do?prefix=/works&page=/WorkStatus.do&mode=vouchersIssue&workId="+workId+"&workName="+workName;
...
String qr1 = "select count(*),b.work_id from rws_work_bill_tbl b where substr(work_id,5,2) ='"+request.getParameter("district")+"' group by b.work_id";
...
%>
	<tr onclick="toggleRowColor(this)">
			...
			<%if(!mile.equals("0") && !mile1.equals("0")) {
				%>
				<td class=rptValue><a href="#" onclick="wopen('../reports/rws_work_milestone_rpt.jsp?workid=<%=rs.getString(1)%>','popup', 950, 450)"><%=mile%></td>
				<%
				if(!bill1.equals("0")){%>
				<td class=rptValue><a href="#" onclick="wopen('../reports/rws_work_bill_rpt.jsp?workid=<%=rs.getString(1)%>','popup', 450, 300)"><%=bill1%></td>
...
System.out.println("Exception in rws_work_voucher_frm1.jsp");
}
%>
</table>
...
&nbsp;&nbsp;&nbsp;Note****:
 <BR>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font face=verdana size=2 color=red>1. List of Works which are Grounded only
 <BR>
