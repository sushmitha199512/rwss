...
<script type="text/javascript" src="resources/js/w3data.js"></script>
...
<tr>
        ...
        <div class="banner-container">
          <div class="right-ops"></div>
            ...
            <ul class="slides" style="width: 500%; -webkit-transition: 0.6s; transition: 0.6s; -webkit-transform: translate4d(-6745px, 0, 0);">
