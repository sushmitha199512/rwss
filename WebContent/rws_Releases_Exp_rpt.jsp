...
<table border = 1 cellspacing = 0 cellpadding = 0 height=5% width="40%" bordercolor=#000000 style="border-collapse:collapse" bgcolor="#ffffff" align = "center">	
	...
	%></tr>
		...
		if(finyear1!=null && finyear1.equals("2011-2012")){%>
			<option value='2011-2012' selected>2011-2012</option>
		<%}else{%>
			<option value='2011-2012'>2011-2012</option>
		<%}%>

		<%if(finyear1!=null  && finyear1.equals("2010-2011")){%>
			<option value='2010-2011' selected>2010-2011</option>
		<%}else{%>
			<option value='2010-2011'>2010-2011</option>
		<%}%>
		<%if(finyear1!=null  && finyear1.equals("2009-2010")){%>
		...
		<td class=btext  colspan="5" nowrap>Releases During the Year(01-APR-<%=finyear1.substring(0,4)%>To 31-MAR-<%=finyear1.substring(5,9)%>)</td>
		...
		<td class=btext align="center">Offline Release(Upto Now)</td>
		...
		String obqry="select sum(BILL_AMT_ADMISSIBLE),substr(office_code,2,3) from RWS_work_bill_TBL  a,rws_work_admn_tbl b where a.work_id=b.work_id ";
		...
		if(program!=null && !program.equals("All") && !programe.equals("All")) billsqry += " and programme_code in("+programe+")";
