	...
	//System.out.println("query 1234 :"+query);
		...
		//	System.out.println("pwsQuery:"+pws);
			...
			//	System.out.println("hpQuery:" + hp);
				...
				psm=conn.prepareStatement("delete from rws_secretary_details_tbl where fin_year=? and dcode is null ");
				psm.setString(1,finYear);
				psm.executeUpdate();
			//	System.out.println("before insert");
				String insertQuery = "insert into rws_secretary_details_tbl(MANDALS,PANCHAYATS,VILLAGES,HABS,PWS,MPWS,CPWS,BOREWELLS,ONGOING,NOTGROUNDED,COMPLETED,COMMISSIONED,FC,PC4,PC3,PC2,PC1,NSS,NC,PHY_TESTS,BACT_TESTS"+/* ,CPWS_ONGOING,CPWS_NOTGROUNDED,CPWS_COMPLETED,CPWS_COMMISSIONED */",FIN_YEAR,TOT_LABS,TOT_SOURCES_TESTS,CONTAMINATION_FLOURIDE,CONTAMINATION_BRAKISH,CONTAMINATION_IRON,CONTAMINATION_NITRATE,GROUNDED,"+/* CPWS_GROUNDED, */"UNDERPROGRESS"+/* ,CPWS_UNDERPROGRESS */") values("
				 ...
				 psm=conn.prepareStatement(insertQuery);
				 ps.setString(1, rs2.getString("mandals"));
					ps.setString(2,  rs2.getString("panchayats"));
					ps.setString(3, rs2.getString("villages"));
					ps.setString(4,rs2.getString("habs"));
					ps.setInt(5, pwscount);
					ps.setInt(6, mpwscount);
					ps.setInt(7,cpwscount);
					ps.setInt(8,hpcount);
					ps.setString(9, rs2.getString("ongoingpws"));
					ps.setString(10,rs2.getString("notgroundedpws"));
					ps.setString(11, rs2.getString("completedpws"));
					ps.setString(12, rs2.getString("commisionedpws"));
					ps.setString(13, rs3.getString("fc"));
					ps.setString(14, rs3.getString("PC4"));
					ps.setString(15, rs3.getString("PC3"));
					ps.setString(16, rs3.getString("PC2"));
					ps.setString(17,rs3.getString("PC1"));
					ps.setString(18,  rs3.getString("NSS"));
					ps.setString(19,rs3.getString("NC"));
					ps.setString(20,rs2.getString("phy"));
					ps.setString(21,rs2.getString("bact"));
					 ps.setString(22,finYear);
					 ps.setString(23,rs2.getString("labs") );
					 ps.setInt(24,sources);
					 ps.setInt(25,flouride);
					  ps.setInt(26,brakish);
					  ps.setInt(27,iron);
					  ps.setInt(28,nitrate); 
					  ps.setString(29,rs2.getString("groundingpws"));
					  ps.setString(30,rs2.getString("underprogresspws"));
				ps.executeUpdate();
%>
...
<%
			...
			if (finYear != null) {
				...
				ps.setString(21,rs2.getString("bact"));
				 ps.setString(22,finYear);
				 ps.setString(23,rs2.getString("labs") );
				 ps.setString(24,dcode);
				 ps.setString(25,rs2.getString("groundingpws"));
				 ps.setString(26,rs2.getString("underprogresspws"));
				 ps.executeUpdate();
%>       
<%-- <%=rs2.getString(11) + "/" + rs2.getString(12) + "/"
							+ rs2.getString(13) + "/" + rs2.getString(14) + "/"
