...
#resizable12 { width: 760px; height: 380px; padding: 0.5em; }
#resizable13 { width: 750px; height: 380px; padding: 0.5em; }
#resizable15 { width: 750px; height: 230px; padding: 0.5em; }
...
<td class=text2>
   ...
   <td ><div id='ChartDiv' align='center' style="display:none">Chart.</div><div id='ChartDiv1' align='center' style="display:none">Chart.</div></td>   
...
<tr>
       <td height=20 colspan="2" class="h4"><span class="text2"><a href="switch.do?prefix=/masters&page=/Employee.do&mode=data"  class="h4" ><b class="green">11.</b>Employee Master</a></span></td>
</tr>

<tr>
       <td height=20 colspan="2" class="h4"><span class="text2"><a href="switch.do?prefix=/masters&page=/EmpSearch.do&mode=EmployeeList&mode1=init"  class="h4" ><b class="green">12.</b>Employee Search Form</a></span></td>
</tr>


<tr>
       <td height=20 colspan="2" class="h4"><span class="text2"><a href="switch.do?prefix=/masters&page=/Contractor.do&mode=data"  class="h4" ><b class="green">13.</b>Contractor Entry</a></span></td>
</tr>

<tr>
       <td height=20 colspan="2" class="h4"><span class="text2"><a href="switch.do?prefix=/works&page=/WorkStatus.do&mode=contractorUpdate"  class="h4" ><b class="green">14.</b>Update Contractor</a></span></td>
</tr>
...
<tr>
       <td height=20 colspan="2" class="h4"><span class="text2"><a href="switch.do?prefix=/masters&page=/school.do&mode=data"  class="h4" ><b class="green">15.</b>School Form</a></span></td>
</tr>

<tr>
       <td height=20 colspan="2" class="h4"><span class="text2"><a href="switch.do?prefix=/masters&page=/HabiYield.do&mode=data&modeType=districts"  class="h4" target="_self"><b class="green">16.</b>Source Yield Entry</a></span></td>
...
<div id="accordion1">
	...
	<table class="green" >
	<tr>
	<td><b class="green">&nbsp;&nbsp;1.</b></td><td><a href="switch.do?prefix=/reports&page=/flexReport.do?mode=inFlexi" target="_self" class="h4">Free Format Report&nbsp;&nbsp;</a></td>
	<td><b class="green">&nbsp;&nbsp;2.</b></td><td><a href="/pred/reports/rws_hab_status_forms.jsp" target="_self" class="h4">CheckList Report</a></td>
	<td><b class="green">&nbsp;&nbsp;3.</b></td><td><a href="./reports/rws_coverage_status_frm1.jsp" target="_self" class="h4"><br>Coverage Status Directory Format-I</a></td>
	<td><b class="green">&nbsp;&nbsp;4.</b></td><td><a href="switch.do?prefix=/reports&page=/reportsDisplay.do&mode=data" target="_self" class="h4"><br>Coverage Status Directory Format-II</a></td>
		</tr>
	
	<tr>
	<td><b class="green">&nbsp;&nbsp;5.</b></td><td><a href="./reports/rws_hab_status_resource_rpt.jsp" target="_self" class="h4"><br>Resources At a Glance </a></td>
	<td><b class="green">&nbsp;&nbsp;6.</b></td><td><a href="./reports/rws_const_coverage_status_frm.jsp" target="_self" class="h4">Constituency Status</a></td>
	<td><b class="green">&nbsp;&nbsp;7.</b></td><td><a href="./reports/rws_habitation_abstract_rpt.jsp" target="_self" class="h4">Status - Abstract Report  </a></td>
	<td><b class="green">&nbsp;&nbsp;8.</b></td><td><a href="./reports/rws_habs_cov_schemes_rpt.jsp" target="_self" class="h4">Covered by Schemes</a></td>
	</tr>
	<tr>
	<td><b class="green">&nbsp;&nbsp;9.</b></td><td><a href="./reports/rws_hab_cov_hps_rpt.jsp" target="_self" class="h4">Covered by HPs </a></td>
    ...
    <td><b class="green">11.</b></td><td><a href="./reports/rws_asset_abstract_rpt.jsp" target="_self" class="h4">Asset Abstract Report  </a></td>
	<td><b class="green">12.</b></td><td><a href="./reports/rws_dist_pop_frm.jsp" target="_self" class="h4">Population Range</a></td>
	</tr>
	<tr><td></td></tr>
	<tr>
	<td><b class="green">13.</b></td><td><a href="./reports/rws_dist_pop_frm1.jsp" target="_self" class="h4">Status Wise </a></td>
	<td><b class="green">14.</b></td><td><a href="./reports/rws_dist_pop_frm2.jsp" target="_self" class="h4">Category Wise</a></td>
	<td><b class="green">15.</b></td><td><a href="./reports/rws_dist_pop_cons.jsp" target="_self" class="h4">Constituency Wise</a></td>
   <td><b class="green"> 16.</b></td><td><a href="./reports/rws_planning_format_frm.jsp" target="_self" class="h4">Planning Report-I  </a></td>
	
	</tr>
	
	<tr>
	<td><b class="green">17.</b></td><td><a href="./reports/rws_planning_format1_frm.jsp" target="_self" class="h4">Planing-Format-II</a></td>
	<td><b class="green">18.</b></td><td><a href="./reports/rws_planning_format2_frm.jsp" target="_self" class="h4">Planing-Format-III </a><br></td>
	<td><b class="green">19.</b></td><td><a href="switch.do?prefix=/reports&page=/duplicates.do&mode=data" target="_self" class="h4">Duplicates List</a></td>
   <td> <b class="green">20.</b></td><td><a href="switch.do?prefix=/reports&page=/unidentified.do&mode=data" target="_self" class="h4">UnIdentified Habitations  </a></td>
	
	</tr>
		
	
	<tr>
	<td><b class="green">21.</b></td><td><a href="./reports/rws_hab_updates_frm.jsp" target="_self" class="h4">Month Wise Updations</a></td>
	<td><b class="green">22.</b></td><td><a href="./reports/rws_hab_status_form.jsp" target="_self" class="h4">Location Status </a></td>
	<td><b class="green">23.</b></td><td><a href="./reports/rws_goi_coverage_frm.jsp" target="_self" class="h4">District Wise - GOI</a></td>
    <td><b class="green">24.</b></td><td><a href="switch.do?prefix=/reports&page=/PublicInst.do?mode=data" target="_self" class="h4">Public Institutes  </a></td>
	
	</tr>
		<tr><td></td></tr>
	
	<tr>
	<td><b class="green">25.</b></td><td><a href="./reports/rws_slip_back_rpt.jsp" target="_self" class="h4">Slipped Back Details</a></td>
	<td><b class="green">26.</b></td><td><a href="./reports/rws_Slipage_hab_frm.jsp" target="_self" class="h4">Slippage Report </a></td>
	<td><b class="green">27.</b></td><td><a href="./reports/rws_Sources_hab_frm.jsp" class="h4">Source Details</a></td>
    <td><b class="green">28.</b></td><td><a href="./reports/rws_Fc_schemes_frm.jsp" target="_self" class="h4">Assets Report </a></td>
	</tr><tr>
	<td><b class="green">29.</b></td><td><a href="./reports/rws_HabPop_rpt.jsp" target="_self" class="h4"><br>Hab LPCD Population Report</a></td>
	<td><b class="green">30.</b></td><td><a href="/pred/reports/rws_household_con_frm.jsp" target="_self" class="h4">Abstract HouseHolds/House Connections Report</a><img src="images/new.gif"></td>	
	</tr>
	</table>
	...
	<tr>
	<td><b class="green">10.</b></td><td><a href="./reports/rws_AssetAbstract_report.jsp" target="_self" class="h4">Abstract Report</a></td>
   <td> <b class="green">11.</b></td><td><a href="./reports/rws_Hp_rpt.jsp" target="_self" class="h4">HP Abstract  </a></td>
	<td><b class="green">12.</b></td><td><a href="./reports/rws_Schemes_rpt.jsp" target="_self" class="h4">Schemes Abstract</a></td>
</tr>

<tr>
<td><b class="green">13.</b></td><td><a href="./reports/rws_asset_statement_rpt.jsp" target="_self" class="h4">GOI Statement</a></td>
	<td><b class="green">14.</b></td><td><a href="./reports/rws_asurfaceohsr_frm.jsp" target="_self" class="h4">GIS Information Reports</a></td>
   <td> <b class="green">15.</b></td><td><a href="./reports/rws_sourcesgis_frm.jsp" target="_self" class="h4">GIS Sources Information Report  </a></td>
	
</tr>
<tr>
   <td><b class="green">16.</b></td><td><a href="./reports/rws_onlyschemes_distwise_rpt.jsp" target="_self" class="h4">Covered by Schemes(Assets Data)</a></td>
	<td><b class="green">17.</b></td><td><a href="./reports/rws_onlyhp_distwise_rpt.jsp" target="_self" class="h4">Covered by HPs(Assets Data)</a></td>
   <td><b class="green">18.</b></td><td><a href="./reports/assetReports/rws_asset_details_frm.jsp" target="_self" class="h4">Assets Abstract</a></td>
</tr>

<tr>
   <td><b class="green">19.</b></td><td><a href="./reports/assetReports/rws_source_details_frm.jsp" target="_self" class="h4">Yeild Updation Status</a></td>
	...
	<table class="green" >
	<tr>
		<td><b class="green">1.</b></td><td><a href="./reports/rws_pao_form.jsp" target="_self" class="h4">PAO Details</a></td>
	</tr><tr>
	<td><b class="green">2.</b></td><td><a href="./reports/rws_head_of_acc_form.jsp" target="_self" class="h4">Heads Details</a></td>
	</tr><tr>
	<td><b class="green">3.</b></td><td><a href="./reports/rws_bank_rpt.jsp" target="_self" class="h4">Account Details</a></td>
			</tr>
	...
	<table class="green" >
	<tr>
		<td><b class="green">1.</b></td><td><a href="switch.do?prefix=/masters&page=/schoolrep.do&mode=data" target="_self" class="h4">Detailed Report</a></td>
	</tr><tr>
	<td><b class="green">2.</b></td><td><a href="./reports/rws_school_abstract_rpt.jsp" target="_self" class="h4">Abstract Report</a></td>
	</tr><tr>
	<td><b class="green">3.</b></td><td><a href="./reports/rws_school_asset_rpt.jsp" target="_self" class="h4">Asset/work Linkage Status</a></td>
	</tr><tr>
	<td><b class="green">4.</b></td><td><a href="./reports/rws_school_detailed_rpt.jsp" target="_self" class="h4">School & Anganwadies</a></td>
...
<tr>
       <td height=20 colspan="2" class="h4"><span class="text2"><a href="switch.do?prefix=/works&page=/NotGrounded.do&mode=data&mode1=clear"  class="h4" ><b class="green">1.</b>DPR/Permission Status</a></span></td>
</tr>


<tr>
       <td height=20 colspan="2" class="h4"><span class="text2"><a href="switch.do?prefix=/works&page=/WorkStatus.do&mode=circles"  class="h4" ><b class="green">2.</b>Work Progress</a></span></td>
</tr>
<tr>
       <td height=20 colspan="2" class="h4"><span class="text2"><a href="switch.do?prefix=/works&page=/Auglinkmain.do?mode=data&mode1=circles"  class="h4" ><b class="green">3.</b>Update Action Plan</a></span></td>
</tr>
<tr>
 
       <td height=20 colspan="2" class="h4"><span class="text2"><a href="switch.do?prefix=/works&page=/Auglinkmain.do?mode=data"  class="h4" ><b class="green">4.</b>Augmentation-MainScheme Linkage</a></span></td>
</tr>
<tr>
 
      <td height=20 colspan="2" class="h4"><span class="text2"><a href="switch.do?prefix=/works&page=/SchemeAsset.do&mode=circles"  class="h4" ><b class="green">5.</b>Scheme-Asset Integration</a></span></td>
</tr>
<tr>
       <td height=20 colspan="2" class="h4"><span class="text2"><a href="switch.do?prefix=/works&page=/eoatFrm.do?mode=init"  class="h4" ><b class="green">6.</b>Extension Of Agreement Time</a></span></td>
</tr>

<tr>
       <td height=20 colspan="2" class="h4"><span class="text2"><a href="switch.do?prefix=/works&page=/worklocality.do&mode=data"  class="h4" ><b class="green">7.</b>Works Locality from</a></span></td>
</tr>
<!-- 
<tr>
 ...
 -->
<tr>
       <td height=20 colspan="2" class="h4"><span class="text2"><a href="switch.do?prefix=/works&page=/aap1.do&mode=data&mode1=circles"  class="h4" ><b class="green">8.</b>Probable Date of Comp</a></span></td>
</tr>
<tr>
       <td height=20 colspan="2" class="h4"><span class="text2"><a href="switch.do?prefix=/works&page=/HabLink.do&mode=data"  class="h4" ><b class="green">9.</b>Work Hab Link</a></span></td>
</tr>
<tr>
       <td height=20 colspan="2" class="h4"><span class="text2"><a href="switch.do?prefix=/works&page=/workUpdation.do?mode=data&mode1=clear"  class="h4" ><b class="green">10.</b>Work Updation- SC/ST Sub Plan & AAP</a> <img src="images/new.gif"> </span></td>
</tr>
 
<tr>
       <td  class="h4"><span class="text2"><a href="switch.do?prefix=/works&page=/MultipleSource.do&mode=init"  class="h4" ><b class="green">11.</b>Multiple Source Entry</a></span></td>
</tr>

<tr>
       <td  class="h4"><span class="text2"><a href="switch.do?prefix=/works&page=/LeadHab.do&mode=data&special=reset"  class="h4" ><b class="green">12.</b>Lead Habitation Updation</a><img src="images/new.gif"></span></td>
</tr>
...
<div id="accordion5">
	...
	<tr>
	<td><b class="green">1.</b></td><td><a href="./reports/rws_works_program_details_frm.jsp" target="_self">Abstract Works Spill Over/ New</a></td>
	</tr>
	<tr>
	<td><b class="green">2.</b></td><td><a href="./reports/rws_work_status_new_frm.jsp" target="_self">Completed  Not Commisioned</a></td>
		</tr>
		<tr>
	<td><b class="green">3.</b></td><td><a href="./reports/rws_work_program_fin_notcompl_frm.jsp" target="_self">Financially Not Completed </a>
	</td></tr>
	<td><b class="green">4.</b></td><td><a href="switch.do?prefix=/reports&page=/flexReport1.do?mode=inFlexi" target="_self">Free Format Report</a></td>
	<tr>	
...
<tr>	
	...
	<h3><a href="#">AAP & Ongoing Works & Analysis Reports</a></h3>
	<div>
	<table class="green" >
<tr>	
<td><b class="green">1.</b></td><td>
...
<td><b class="green">3.</b></td><td><a href="./reports/rws_work_habsubtype_abstract_rpt.jsp?" target="_self">SC/ST/PLAIN - Abstract Report</a>
	...
	<td><b class="green">9.</b></td><td><a href="./reports/works/rws_ongoing_works_det_frm.jsp" target="_self">Ongoing Works Progress</a> 
		</td>	
		</tr>
	<tr>
		
	<td><b class="green">10.</b></td><td><a href="./reports/rws_PhyCom_FinNotCom_frm.jsp" target="_self"> <br>Phy Completed Fin Not Completed Works</a>
		</td>	
		</tr>
...
<td><b class="green">&nbsp;&nbsp;6.</b></td><td><a href="./reports/rws_spill_ncnsspc1habs_covered_10_11.jsp" target="_self"><br>Hab Coverage of SpillOver Works </a>
	</td>	</tr>
	<tr>	
<td><b class="green">7.</b></td><td>
...
<td><b class="green">10.</b></td><td><a href="./reports/rws_workid_search_frm.jsp" target="_self">Work ID Based -Work Details</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		</td>
...
<td><b class="green">11.</b></td><td>
 ...
 <td><b class="green">12.</b></td><td>
		<a href="switch.do?prefix=/works&page=/workgap.do?mode=data" target="_self"><br>Gap Report </a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
	    </td> 
	    	
<td><b class="green">13.</b></td><td><a href="./reports/rws_work_ongoing_frm.jsp" target="_self"><br>Ongoing Works - Habitations Benefitted Report</a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		</td>
		
		<td><b class="green">14.</b></td><td><a href="./reports/rws_work_admn_tech_frm.jsp" target="_self"><br>Diff. In Admn & Tech Habs</a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		</td></tr>
 ...
 <td><b class="green">15.</b></td><td>
		<a href="./reports/rws_work_probdate_frm.jsp" target="_self"><br>Probable Completion date View </a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
	    </td> 
	    	
<td><b class="green">16.</b></td><td><a href="./reports/rws_Pending_works_rpt.jsp" target="_self"><br>Pending Works Report</a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		</td>
		
		<td><b class="green">17.</b></td><td><a href="./reports/rws_works_exception_frm.jsp" target="_self"><br>Status of Work Progress Report</a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		</td></tr>
		
		<tr>
		<td><b class="green">18.</b></td><td><a href="./reports/rws_Aap_frm.jsp" target="_self"><br>AAP 2011-2012 Works</a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		</td></tr>
...
<td><b class="green">4.</b></td><td>
	<a href="./reports/rws_payment_details_frm.jsp" target="_self" class="h4">Payment Details Report </a>
	</td></tr><tr>
	      
<td><b class="green">5.</b></td><td>
<a href="./reports/rws_program_works_rpt.jsp" target="_self" class="h4">Work-Program Releases </a>
	</td></tr>
...
<td><b class="green">1</b></td><td>
		...
		<a href="./reports/rws_bank_process_frm.jsp" target="_self" class="h4">Bill Wise Bank Releases</a>
	</td></tr><tr>
...
<tr>
       <td height=20 colspan="2" class="h4"><span class="text2"><a href="switch.do?prefix=/drought&page=/PowerTransport.do&mode=get2&special=reset"  class="h4" ><b class="green">1.</b>Habitations For Drought</a></span></td>
</tr>


<tr>
       <td height=20 colspan="2" class="h4"><span class="text2"><a href="switch.do?prefix=/drought&page=/TransportWaterDetail.do&mode=districts"  class="h4" ><b class="green">2.</b>Daily Entry(TRANS,HIRING)</a></span></td>
</tr>


<tr>
       <td height=20 colspan="2" class="h4"><span class="text2"><a href="switch.do?prefix=/drought&page=/FlushDeep.do&mode=data&special=reset"  class="h4" ><b class="green">3.</b>Flushing Deepening of Borewells</a></span></td>
</tr>
<tr>
       <td height=20 colspan="2" class="h4"><span class="text2"><a href="switch.do?prefix=/drought&page=/dailyReprot.do&mode=data&special=reset"  class="h4" ><b class="green">4.</b>Daily Report Abstract Entry</a></span></td>
</tr>
<tr>
       <td height=20 colspan="2" class="h4"><span class="text2"><a href="switch.do?prefix=/drought&page=/AdminstrativeSanction.do&mode=null"  class="h4" ><b class="green">5.</b>Drought Works</a></span></td>
</tr>
<tr>
       <td  class="h4"><span class="text2"><a href="switch.do?prefix=/drought&page=/newsItem.do&mode=districts&special=reset"  class="h4" ><b class="green">6.</b>News Paper Clippings</a></span></td>
</tr>
...
<!--   <marquee  behavior="scroll" direction="up"><p>  -->
 ...
 <tr>
       <td height=20 colspan="2" class="h4"><span class="text2"><a href="switch.do?prefix=/wquality&page=/WaterLabTesting.do&mode=data"  class="h4" ><b class="green">1.</b>Lab Testing</a></span></td>
</tr>
 
<tr>
       <td height=20 colspan="2" class="h4"><span class="text2"><a href="switch.do?prefix=/wquality&page=/WaterSample.do&mode=data"  class="h4" ><b class="green">2.</b>FTK Testing</a></span></td>
</tr>
  <tr>
       <td height=20 colspan="2" class="h4"><span class="text2"><a href="switch.do?prefix=/works&page=/RfdTraining.do?mode=data"  class="h4" ><b class="green">3.</b>WQ Training Entry</a> <img src="images/new.gif"> </span></td>
</tr>
			</table>
...
<table>
<tr><td class="green"> 1.<a href="/pred/help/Final PPT Dec-2013-Submitted.pptx" class="h4" >SE' S Conference Dated:18-12-2013-Presentation.</a><img src="images/new.gif"></td>
...
<a href="./reports/Gaps/rws_lpcd_lessthan10_hab_rpt.jsp" target="_self">Habs having lpcd lessthan 10</a><img src="images/new.gif"/> </td></tr>
	 <tr>	
<td><b class="green">6.</b></td><td>
<a href="./reports/Gaps/rws_lpcd_greatethan500_hab_rpt.jsp" target="_self">Habs having lpcd lessthan 500</a><img src="images/new.gif"/> </td></tr>
</table>
</div>
</td>
...
<td><b class="green">&nbsp;&nbsp;1.</b></td><td><a href="#" class="h4" onclick="viewWorks1('./help/assethelp.doc')">Asset</a></td></tr>
<tr>
<td><b class="green">&nbsp;&nbsp;2.</b></td><td><a href="#" class="h4" onclick="viewWorks1('./help/HabitationStatushelp.doc')">Habitation Status</a></td></tr>

<tr>
<td><b class="green">&nbsp;&nbsp;3.</b></td><td><a href="#" class="h4" onclick="viewWorks1('./help/WorkFlow.doc')">Works Monitoring</a></td></tr>

<tr>
<td><b class="green">&nbsp;&nbsp;4.</b></td><td><a href="#" class="h4" onclick="viewWorks1('./help/FundAccounting.doc')">Fund Accounting </a></td></tr>

<tr>
<td><b class="green">&nbsp;&nbsp;5.</b></td><td><a href="#" class="h4" onclick="viewWorks1('./help/CommissionedworkAsset.doc')">Asset Scheme Integration </a></td></tr>

<tr>
<td><b class="green">&nbsp;&nbsp;6.</b></td><td><a href="#" class="h4" onclick="viewWorks1('./help/panchayat.doc')">Panchayat</a></td></tr>


<tr>
<td><b class="green">&nbsp;&nbsp;7.</b></td><td><a href="#" class="h4" onclick="viewWorks1('./help/village.doc')">Village </a></td></tr>




<tr>
<td><b class="green">&nbsp;&nbsp;8.</b></td><td><a href="#" class="h4" onclick="viewWorks1('./help/Hab.doc')">Habitation </a></td></tr>

<tr>
<td><b class="green">&nbsp;&nbsp;9.</b></td><td><a href="#" class="h4" onclick="viewWorks1('./help/QualityEffectedHabs.doc')">Quality Effected Habs </a></td></tr>

<tr>
<td><b class="green">10.</b></td><td><a href="#" class="h4" onclick="viewWorks1('./help/WaterQuality.doc')">Water Quality </a></td></tr>

<tr>
<td><b class="green">11.</b></td><td><a href="#" class="h4" onclick="viewWorks1('./help/Help For PRED.htm')">Complete Online Help</a></td></tr>
<tr>
<td><b class="green">12.</b></td><td><a href="#" class="h4" onclick="viewWorks1('./help/School.doc')">School Form</a></td></tr>
<tr>
<td><b class="green">13.</b></td><td><a href="#" class="h4" onclick="viewWorks1('./help/DetailedProjectReport.doc')">Detailed Project Report(DPR) Help</a></td></tr>
