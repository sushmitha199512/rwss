...
function getData2()
{
	document.forms[0].action="switch.do?prefix=/complaints&page=/Complaintstatusgeneric.do?mode=get2";
	document.forms[0].submit();
}
function getFromDates()
{
document.forms[0].action="switch.do?prefix=/complaints&page=/Complaintstatusgeneric.do?mode=dates";
document.forms[0].submit();
}
function getFromDate1()
{
document.forms[0].action="switch.do?prefix=/complaints&page=/Complaintstatusgeneric.do?mode=display";
document.forms[0].submit();
...
function getData3()
{
	document.forms[0].action="switch.do?prefix=/complaints&page=/Complaintstatusgeneric.do?mode=get3";
	document.forms[0].submit();
}

function getData4()
{
	document.forms[0].action="switch.do?prefix=/complaints&page=/Complaintstatusgeneric.do?mode=get4";
	document.forms[0].submit();
}

function getData5()
{
	document.forms[0].action="switch.do?prefix=/complaints&page=/Complaintstatusgeneric.do?mode=get5";
	document.forms[0].submit();
}
function getData1()
{
	document.forms[0].action="switch.do?prefix=/complaints&page=/Complaintstatusgeneric.do?mode=view";
	document.forms[0].submit();
}
function init()
{
...
<html:form action="Complaintstatusgeneric.do">
<jsp:include page="/commons/TableHeader.jsp">
	<jsp:param name="TableName" value="Generic Grievance Status " />
...
java.util.Collection a = (java.util.Collection)request.getAttribute("reccomplaints"); 
	...
	<tr>
		...
		property="componentName" indexed="true" /> <nested:write
		name="COMPLIST" property="componentName" /></td>
...
<% resultCount++; %>
	...
	<nested:write  name="COMDPLIST" property="componentName" /> 
	</td>
	<td  class=bwborder align=left>
