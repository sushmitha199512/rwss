...
function getData2()
{
	document.forms[0].action="switch.do?prefix=/complaints&page=/TotalComplaints.do?mode=get2";
...
if(document.forms[0].dist.value== "" || document.forms[0].dist.value==null)
   ...
   else if(document.forms[0].asset.value== "0" || document.forms[0].asset.value==null)
   {
   ...
   {var asset=document.forms[0].asset.value;
   

		document.forms[0].action="switch.do?prefix=/complaints&page=/TotalComplaints.do?asset="+asset+"&mode=view";
		document.forms[0].submit;
   }
}
function init()
...
<html:form action="TotalComplaints.do">
<jsp:include page="/commons/TableHeader.jsp">
	<jsp:param name="TableName" value="Grievance(for Existing Assets) Report  " />
   ...
   <td class="textborder" width="100"><bean:message key="app.district"/><font color="#FF6666">*</font></td>
	...
	<tr>
	   ...
	   <td class="textborder" width="150">
		...
		<html:select property="asset" styleClass="mycombo" style="width:150px" onchange="javascript:getData2()" >
		<html:option value=""><font class="myfontclr1">SELECT...</html:option>
