...
<html:form action="employeeEntryNew.do">
...
try
{
java.util.Collection b = (java.util.ArrayList)session.getAttribute("list"); 
...
<logic:iterate id="REGLIST" name="list" >
<% if(count==0)
	{
...
<td  class="bwborder"  nowrap>
 <%-- <a href="./switch.do?prefix=/smsmobile&page=/employeeEntry.do?headOfficeCode=<bean:write name='REGLIST' property='headOfficeCode'/>&circleOfficeCode=<bean:write name='REGLIST' property='circleOfficeCode'/>&divisionOfficeCode=<bean:write name="REGLIST" property="divisionOfficeCode" />&subDivisionOfficeCode=<bean:write name="REGLIST" property="subDivisionOfficeCode" />&employeeId=<bean:write name="REGLIST" property="employeeId" />&employeeName=<bean:write name="REGLIST" property="employeeName" />&employeeMobile=<bean:write name="REGLIST" property="employeeMobile" />&mode=updateMobileData&mode1=1"><font color="#6600CC">Edit&nbsp;|&nbsp;</font></a> --%>
