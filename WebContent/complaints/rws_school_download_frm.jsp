...
document.forms[0].action="switch.do?prefix=/complaints&page=/Download.do&mode=schoolmode";
...
<td>
		...
		<html:option value="schoolform"><font class="myfontclr1">School Table</html:option>
		<html:option value="schoolcategory"><font class="myfontclr1">School Category Table</html:option>
		</html:select>
		</td>
