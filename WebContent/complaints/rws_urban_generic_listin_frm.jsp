...
function fnDelete(complntno,typeofAsset,dcode)
	...
	{
	document.forms[0].action="switch.do?prefix=/complaints&page=/UrbanComplaintsgeneric.do?mode=cdelete&complntno="+complntno+"&typeofAsset="+typeofAsset+"&dcode="+dcode;
	document.forms[0].submit();
	}
	}
function fnEdit(complntno,typeofAsset,dcode)
{
 document.forms[0].action="switch.do?prefix=/complaints&page=/UrbanComplaintsgeneric.do?mode=get&complntno="+complntno+"&typeofAsset="+typeofAsset+"&dcode="+dcode;
 document.forms[0].submit();
}
</script>
<table width="100%">
...
<html:form action="UrbanComplaintsgeneric.do">
<table    width="100%"   bgcolor="#8A9FCD">
<tr><td class=myfontclr><B><font color="#FFFFFF">Urban Generic Grievance List</font></B></td>
</tr>
</table>
...
try
{
java.util.Collection b = (java.util.ArrayList)session.getAttribute("complaintsgeneric"); 
System.out.println("B size"+b.size());
if(b.size() > 0)
{
 int count=0; 
System.out.println("Complaints"); %>
<logic:iterate id="COMPLAINTSLIST" name="complaintsgeneric">
...
<a href="#1" onclick="openEditWindow('switch.do?prefix=/complaints&page=/UrbanComplaintsgeneric.do?mode=get&complntno=<bean:write name='COMPLAINTSLIST' property='complntno' />')">Edit&nbsp;|</a>&nbsp;
...
<%--  <a href="#1" onclick="openDeleteWindow('switch.do?prefix=/complaints&page=/Complaintsgeneric.do?mode=cdelete&complntno=<bean:write name='COMPLAINTSLIST' property='complntno' />')"> 
