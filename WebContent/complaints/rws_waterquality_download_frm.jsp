...
document.forms[0].action="switch.do?prefix=/complaints&page=/Download.do&mode=waterqualitymode";
...
<td>
		...
		<html:select property="habresult" styleClass="mycombo" style="width:200px"  >
		<html:option value=""><font class="myfontclr1">Select</html:option>
		<html:option value="watersample"><font class="myfontclr1">Water Quality Sample Collection Table</html:option>
		<html:option value="waterlab"><font class="myfontclr1">Water Quality Lab Table</html:option>
		<html:option value="watertest"><font class="myfontclr1">Water Quality Test Table</html:option>
		<html:option value="ftk"><font class="myfontclr1">Water Quality FTK Testing Table</html:option>
		</html:select>
		</td>
