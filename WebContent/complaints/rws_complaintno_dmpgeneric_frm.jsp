...
function getComplaintNot(that)
	{
		...
		url = "switch.do?prefix=/complaints&page=/ComplaintNogeneric.do&mode=get4&complntno="+complaintno;
...
function getData2()
{
	document.forms[0].action="switch.do?prefix=/complaints&page=/ComplaintNogeneric.do?mode=get3";
