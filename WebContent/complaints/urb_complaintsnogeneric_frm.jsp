...
if(document.forms[0].complntno.value== "" || document.forms[0].complntno.value==null)
   ...
   else
   {
        ...
        url="switch.do?prefix=/complaints&page=/ComplaintNogeneric_Urban.do?mode=cview";
...
<td align=center>Complaint Number<font color="#FF6666">*</font>:<html:text property="complntno" 
 ...
 <tr>
	...
	<html:submit property="save" title=" Forget Complaint Number"  styleClass="btext"  value="?" onclick="fnSearch('switch.do?prefix=/complaints&page=/ComplaintNogeneric_Urban.do?mode=get3');"/></td>
