...
<html:form action="Complaintsoutgeneric.do">
...
<!--  <a href="#1" onclick="openEditWindow('switch.do?prefix=/complaints&page=/Complaintsoutgeneric.do?mode=get&complntno=<bean:write name='COMPLAINTSLIST' property='complntno' />')">Edit&nbsp;|</a>&nbsp;-->
...
<!--  <a href="#1" onclick="openDeleteWindow('switch.do?prefix=/complaints&page=/Complaintsoutgeneric.do?mode=cdelete&complntno=<bean:write name='COMPLAINTSLIST' property='complntno' />')">
