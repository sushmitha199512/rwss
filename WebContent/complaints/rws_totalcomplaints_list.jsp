...
<td  class="bwborder" ><%=count %></td>
				...
				<td align="center" class=bwborder><a href="/pred/complaints/TotalComplaints.do?complntno=<bean:write name="complist" property="complntno" />&source=<bean:write name="complist" property="sourceCode" />&assetcode=<bean:write name="complist" property="assetCode" />&dis=<bean:write name="complist" property="dist" />&man=<bean:write name="complist" property="mand" />&pan=<bean:write name="complist" property="panch" />&type=<bean:write name="complist" property="typeofAsset" />&mode=hdisplay"><bean:write name="complist" property="complntno" /></td>
