...
function fnDelete(complntno,typeofAsset,dcode)
	...
	{
	document.forms[0].action="switch.do?prefix=/complaints&page=/Complaintsgeneric.do?mode=cdelete&complntno="+complntno+"&typeofAsset="+typeofAsset+"&dcode="+dcode;
	document.forms[0].submit();
	}
	}
function fnEdit(complntno,typeofAsset,dcode)
{
 document.forms[0].action="switch.do?prefix=/complaints&page=/Complaintsgeneric.do?mode=get&complntno="+complntno+"&typeofAsset="+typeofAsset+"&dcode="+dcode;
 document.forms[0].submit();
}
</script>
<table width="100%">
...
<html:form action="Complaintsgeneric.do">
<table    width="100%"   bgcolor="#8A9FCD">
<tr><td class=myfontclr><B><font color="#FFFFFF">Generic Grievance List</font></B></td>
</tr>
</table>
...
<a href="#1" onclick="openEditWindow('switch.do?prefix=/complaints&page=/Complaintsgeneric.do?mode=get&complntno=<bean:write name='COMPLAINTSLIST' property='complntno' />')">Edit&nbsp;|</a>&nbsp;
