        ...
        else
{
	...
	document.forms[0].action="switch.do?prefix=/complaints&page=/UrbanComplaintsgeneric.do?mode=edit";
...
function getData1()
{
	document.forms[0].action="switch.do?prefix=/complaints&page=/UrbanComplaintsgeneric.do?mode=view";
	document.forms[0].submit();
}
...
<body  onload="">
<html:form action="UrbanComplaintsgeneric.do?mode=get">
...
<table   bgcolor="#DEE3E0" bordercolor= "#8A9FCD" rules="cols" border="1" style="border-collapse:collapse;" width="100%" align="center">
   ...
   <label>
	...
	<td class="textborder" width="100">
	Municipality / Panchayat<font color="#FF6666">*</font> <td><html:text property="panchayatName" maxlength="25"  size="25"  readonly="true" /></td>
	<html:hidden property="panchayatCode" />
	</tr>
	<tr>
	  <td class="textborder" width="100">
	Locality / Habitation <font color="#FF6666">*</font></td><td><html:text property="habName" maxlength="40"  size="40" readonly="true"  /></td>
...
<td>
 <fieldset>
	...
	<a href="javascript:showCalendar(document.UrbanCompForm.complntdt);"><IMG SRC="<rws:context page='/images/calendar.gif'/>" width="20" border="0" height="17" align="absmiddle"></a></td>
