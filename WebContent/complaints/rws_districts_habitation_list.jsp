...
<td align="center" class=btext>District :<%=request.getAttribute("distName")%>&nbsp;&nbsp;&nbsp;Mandal :<%=request.getAttribute("mandName")%>&nbsp;&nbsp;&nbsp;Panchayat :<%=request.getAttribute("panchName")%>&nbsp;&nbsp;&nbsp;Asset Type :<%=request.getAttribute("typeName")%></td>
	...
	<td align="center" class=clrborder>Source Code</td>
   	<td align="center" class=clrborder>Asset Code</td>
	...
	<td align="center" class=clrborder>Remarks</td>
		...
		<td align="center" class=bwborder><bean:write name="complist" property="assetCode" /></td>
		...
		<td align="center" class=bwborder><a href="/pred/complaints/TotalComplaints.do?assetcode=<bean:write name="complist" property="assetCode" />&source=<bean:write name="complist" property="sourceCode" />&complntno=<bean:write name="complist" property="complntno" />&dis=<bean:write name="complist" property="dist" />&man=<bean:write name="complist" property="mand" />&pan=<bean:write name="complist" property="panch" />&type=<bean:write name="complist" property="typeofAsset" />&mode=hdisplay"><bean:write name="complist" property="complntno" /></td>
