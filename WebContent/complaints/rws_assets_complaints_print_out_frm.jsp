...
window.opener.location.href="switch.do?prefix=/complaints&page=/Complaintsout.do?mode=view&asset="+ast+"&dcode="+dist+"&mcode="+man+"&pcode="+pan+"&hcode="+hab;
	window.close();
}
</script>
<head>
...
<table width="800" border = 1 align="center" cellpadding = 0 cellspacing = 0 bordercolor=#000000 bgcolor="#ffffff" style="border-collapse:collapse">
  <tr>
    <td colspan="5" align="center"><span class="style3">Grievance Acknowledgement Slip </span></td>
  </tr>
   <%
  try
  {
