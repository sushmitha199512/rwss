...
function getComplaintNot(that)
	{
		...
		url = "switch.do?prefix=/complaints&page=/ComplaintNogeneric_Urban.do&mode=get4&complntno="+complaintno;
...
function getData2()
{
	document.forms[0].action="switch.do?prefix=/complaints&page=/ComplaintNogeneric_Urban.do?mode=get3";
...
<html:form action="ComplaintNogeneric_Urban.do">
