...
function fnSave(){
  ...
  // alert("phonenumber"+phonenumber);
    ...
    var dt1  = parseInt(complaintDate.substring(0,2),10); 
	var mon1 = parseInt(complaintDate.substring(3,5),10); 
	var yr1  = parseInt(complaintDate.substring(6,10),10);
	var complaintDate1 = new Date(yr1, mon1, dt1); 
	
	var dt2  = parseInt(attendedate.substring(0,2),10); 
	var mon2 = parseInt(attendedate.substring(3,5),10); 
	var yr2  = parseInt(attendedate.substring(6,10),10); 
	var attendedate1 = new Date(yr2, mon2, dt2); 
    
	var dt3  = parseInt(dateofsent.substring(0,2),10); 
	var mon3 = parseInt(dateofsent.substring(3,5),10); 
	var yr3  = parseInt(dateofsent.substring(6,10),10); 
	var dateofsent1 = new Date(yr3, mon3, dt3); 
   ...
   if(document.getElementById("generic["+k+"].mesSentToGrevance").value==""){
	...
	if(attendedate1<complaintDate1 || dateofsent1<complaintDate1 )
	{
	alert("Attended Date/Date of Message Sent Should Be greater Than or equal to the Complaint given Date");
	 ...
	 return false;
		...
		document.forms[0].action="switch.do?prefix=/complaints&page=/GenericActionTaken_Urban.do&mode=Save";	
...
function getcomplaintData(){	
	...
	if(document.getElementById('district').value==''){
		...
		document.forms[0].action="switch.do?prefix=/complaints&page=/GenericActionTaken_Urban.do&mode=cmplaintData&district="+dist+"&date="+date;
		document.forms[0].submit();
	}	
}
</script>
...
<html:form  action="GenericActionTaken_Urban.do">
...
<tr >
	...
	<!-- <td class="btext" align="center" >District/<br>Mandal/<br>Village</td> -->
	 <td class="btext" align="center" >District/<br>Mandal</td> 
	...
	<!-- <td class="btext" align="center" >Message Sent to Officers</td>
	<td class="btext" align="center" >Send SMS</td>	 -->	
...
%>
	...
	<tr align="center" id='tr<%=count%>' onclick="changeColor(this)";>
		...
		<td  align="center" >
			...
			<html:option value="HP Repairs">HP Repairs</html:option>
			<html:option value="Illegal Connections">Illegal Connections</html:option>
			<html:option value="SS Tanks Filling">SS Tanks Filling</html:option>
		...
		<td  align="center" >
			...
			<html:option value="HPs repaired">HPs repaired</html:option>
			<html:option value="Pipelines rectified">Pipelines rectified</html:option>
			<html:option value="Complaint not factual">Complaint not factual</html:option>
			<html:option value="GP For Maintenance">GP For Maintenance</html:option>
			</html:select>
		</td>
		<td>
	...
	<td>
		...
		<td>
			<a href="#" onclick="viewWorks('switch.do?prefix=/complaints&page=/GenericActionTaken_Urban.do&mode=imageView&conplaintNo=<bean:write name="generic" property="complaintNumber" />')">Grievance View</a>		
		</td>
		...
		<!-- <td  align="center"><input type=button value=Send&nbsp;SMS id="Btn"  onclick="fnSendSMS();" class="btext"></td> --> 
		<td><html:checkbox name="generic" property="checks" indexed="true" onclick='<%= "check(" + index + ")" %>' /></td>	
