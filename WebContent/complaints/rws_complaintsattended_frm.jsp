...
function getComplaintNot(that)
	{
		...
		var assetname=document.getElementById("COMPNLIST["+index+"].assetName").value;
	...
	url = "switch.do?prefix=/complaints&page=/Complaintattended.do&mode=attend&categoryName="+categoryname+"&name="+rname+"&address="+raddress+"&assetName="+assetname+"&repName="+repname+"&sourceCode="+sourcecode+"&assetCode="+assetcode+"&complntdt="+complaintdate+"&complntdesc="+complaintdes+"&complntno="+complaintno;
...
<td>
	<jsp:include page="/commons/TableHeader.jsp">
		<jsp:param name="TableName" value="Grievance Attend Entry ( for Existing Assets ) " />
