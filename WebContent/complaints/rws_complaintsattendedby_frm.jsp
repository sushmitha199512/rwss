...
document.forms[0].action="switch.do?prefix=/complaints&page=/Complaintattended.do&mode=save";
...
<jsp:include page="/commons/TableHeader.jsp">
		<jsp:param name="TableName" value="Grievance Attended Entry ( for Existing Assets ) " />
...
<table bgcolor="#DEE3E0" bordercolor= "#8A9FCD" rules="cols" border="1" 
	   style="border-collapse:collapse;" width="780" >
		...
		<td class="textborder" >
		<html:text property="assetName" readonly="true"  value="<%=(String)session.getAttribute("assetname")%>" /></td>
		<tr>
		...
		<tr>
		 			<td class="textborder">Nature of Problem
		</td>
		<td class="textborder" >
		<html:text property="categoryName" readonly="true"  value="<%=(String)session.getAttribute("categoryname")%>" /></td>
