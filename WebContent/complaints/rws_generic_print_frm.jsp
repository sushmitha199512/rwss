...
//alert("D:"+dist+":M:"+man+":P:"+pan+":H:"+hab);
	...
	window.close(); */
	 document.forms[0].action="switch.do?prefix=/complaints&page=/Complaintsgeneric.do?mode=view&dcode="+dist+"&mcode="+man+"&pcode="+pan+"&hcode="+hab;
...
<%} %>
  ...
  {
  System.out.println("error in print form jsp -- "+e);
  }
  %>
