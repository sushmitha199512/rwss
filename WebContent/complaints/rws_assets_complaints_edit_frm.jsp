...
function fnSave()
{
if(document.forms[0].inwardNo.value== "" || document.forms[0].inwardNo.value==null)
     {
        ...
        else
{
	...
	document.forms[0].action="switch.do?prefix=/complaints&page=/Complaints.do?mode=edit";
...
<body  onload="">
<html:form action="Complaints.do?mode=get">
...
<td>
 <fieldset>
	...
	<td class="textborder" width="100">
	Inward No </td><td><html:text property="inwardNo" maxlength="10"  size="10"  /></td>
	<td class="textborder" >
