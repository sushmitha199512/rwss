...
function funcChanged()
{
	...
	document.forms[0].action="/pred/complaints/employeeEntryNew.do?mode=get";
...
function fnSave()
{
	...
	document.forms[0].action="/pred/complaints/employeeEntryNew.do?mode=ubdateMobile";
	document.forms[0].submit();
	}
}
...
function fnView()
{
	document.forms[0].action="/pred/complaints/employeeEntryNew.do?mode=viewMobile";
	document.forms[0].submit();
}
...
<body>
<html:form action="employeeEntryNew.do" method="post">
...
<td>
		...
		<tr>
			...
			<td>
		 	...
		 	<%-- <html:select property="employeeId" style="width:140px" styleClass="mycombo"  onchange="funcChanged()">
				 ...
				 <html:text property="employeeId" style="width:140px" /> 
		</td>
		...
		<tr>
			...
			<td>
					<html:text property="employeeName" style="width:140px"  />
	...
	<td>
		...
		<tr>
			...
			<!-- </td>
			<td class="textborder" align=center> -->
			<input type=button value=View id="vBtn" onClick="fnView();" class="btext">
			</td>
		</tr>
		</table>
	</td>
