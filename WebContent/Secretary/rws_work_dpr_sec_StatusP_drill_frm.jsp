...
function unview()
{
	...
	//alert("in fun");	
			...
			else
		{
			...
			document.f1.action="./rws_work_dpr_sec_StatusP_drill_rpt.jsp";
			document.f1.submit();
		}
		//}
		//else
...
<%} %>
	...
	<tr bgcolor="#8A9FCD" align="center">
		<td align="center" class="rptHeading" colspan=4>Pending Permissions</td>
	</tr>
...
<%
			...
			query="SELECT distinct d.dcode,d.dname from rws_district_tbl d where dcode='"+dcode+"'";
