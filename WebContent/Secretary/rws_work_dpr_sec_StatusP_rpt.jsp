...
{ %>
			<tr><td align="right" class="bwborder"><a href="/pred/home.jsp?loginMode=watersoft">Home|</a></td>
				<td class="bwborder"><a href="javascript:onclick=history.go(-1)">Back|</a><a href="./rws_work_dpr_fin_StatusPermissions_excel.jsp" target=_new>Excel</a></td></tr>
<%  } else {%>
...
<td class=rptValue ><%= dprlanper.get(rs1.getString(2))==null?"0":(svslan=(Integer.parseInt((String)dprlanper.get(rs1.getString(2))))) %></td>
<td class=rptValue ><%= dprforest.get(rs1.getString(2))==null?"0":(mvafore=(Integer.parseInt((String)dprforest.get(rs1.getString(2))))) %></td>
<td class=rptValue ><%= dprwater.get(rs1.getString(2))==null?"0":(dprswater=(Integer.parseInt((String)dprwater.get(rs1.getString(2))))) %></td>
<td class=rptValue ><%= dprrailway.get(rs1.getString(2))==null?"0":(dprsrail=(Integer.parseInt((String)dprrailway.get(rs1.getString(2))))) %></td>
<td class=rptValue ><%= dprroadcross.get(rs1.getString(1)+rs1.getString(2))==null?"0":(dprsroad=(Integer.parseInt((String)dprroadcross.get(rs1.getString(2))))) %></td>
<td class=rptValue ><%= roadstate.get(rs1.getString(2))==null?"0":(dprsroadstate=(Integer.parseInt((String)roadstate.get(rs1.getString(2))))) %></td>
<td class=rptValue ><%= dprpower.get(rs1.getString(2))==null?"0":(dprpowerp=(Integer.parseInt((String)dprpower.get(rs1.getString(2))))) %></td>
<td class=rptValue ><%= dprhmwssb.get(rs1.getString(2))==null?"0":(dprhmwssp=(Integer.parseInt((String)dprhmwssb.get(rs1.getString(2))))) %></td>
<td class=rptValue ><%= dprother.get(rs1.getString(2))==null?"0":(dprotherp=(Integer.parseInt((String)dprother.get(rs1.getString(2))))) %></td>
...
<td class=rptValue ><%= lanobdt.get(rs1.getString(2))==null?"0":(lanobdtp=(Integer.parseInt((String)lanobdt.get(rs1.getString(2))))) %></td>
<td class=rptValue ><%= forestobdt.get(rs1.getString(2))==null?"0":(forestsobdtp=(Integer.parseInt((String)forestobdt.get(rs1.getString(2))))) %></td>
<td class=rptValue ><%= waterobtdate.get(rs1.getString(2))==null?"0":(waterobtsobdtp=(Integer.parseInt((String)waterobtdate.get(rs1.getString(2))))) %></td>
<td class=rptValue ><%= railobtdate.get(rs1.getString(2))==null?"0":(railobtsobdtp=(Integer.parseInt((String)railobtdate.get(rs1.getString(2))))) %></td>
<td class=rptValue ><%= roadobtdate.get(rs1.getString(2))==null?"0":(railobtsobdtp1=(Integer.parseInt((String)roadobtdate.get(rs1.getString(2))))) %></td>
<td class=rptValue ><%= roadstateobtdate.get(rs1.getString(2))==null?"0":(roadstobtsobdtp=(Integer.parseInt((String)roadstateobtdate.get(rs1.getString(2))))) %></td>
<td class=rptValue ><%= powerobtdt.get(rs1.getString(2))==null?"0":(powerobtdate=(Integer.parseInt((String)powerobtdt.get(rs1.getString(2))))) %></td>
<td class=rptValue ><%= hmwssobtdt.get(rs1.getString(2))==null?"0":(hmwssobtdate=(Integer.parseInt((String)hmwssobtdt.get(rs1.getString(2))))) %></td>
<td class=rptValue ><%= otherobtdt.get(rs1.getString(2))==null?"0":(otherobtdate=(Integer.parseInt((String)otherobtdt.get(rs1.getString(2))))) %></td>
