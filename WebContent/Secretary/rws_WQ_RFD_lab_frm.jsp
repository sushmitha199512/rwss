...
<%
   ...
   String ccode="";
   String divcode=""; 
   if(!loggedUser.equals(nic.watersoft.commons.Constants.ADMIN) && !loggedUser.equals(nic.watersoft.commons.Constants.LAKH_USER) && !loggedUser.equals(nic.watersoft.commons.Constants.ENC) && !loggedUser.substring(0,3).equals("col") && !loggedUser.equals(nic.watersoft.commons.Constants.SEC_USER)){
	   //110102
	     ccode=loggedUser.substring(1,3);
	      divcode=loggedUser.substring(3,4);
	  } 
	     if(loggedUser.substring(0,3).equals("col")){
	  	   ccode=(String)session.getAttribute("district");  
	     }
...
document.f1.distname.value = document.f1.combo.options[document.f1.combo.options.selectedIndex].text;
		...
		{
			document.f1.action="./rws_WQ_RFD_rpt.jsp";
			document.f1.submit();
		}
		//}
		//else
...
<%} %>
	...
	<tr bgcolor="#8A9FCD" align="center">
		<td align="center" class="rptHeading" colspan=4>Water Quality Abstract-Lab </td>
	</tr>
...
if(ccode!=null && !ccode.equals("")&& !loggedUser.equals("guest") && !loggedUser.equals(Constants.SEC_USER)){
...
%>
    ...
    if((divcode==null || divcode.equals("0") || divcode.length()==0) && !loggedUser.equals("guest")){
...
%>
		...
		<%@ include file="/reports/RFDReports/rws_wq_financial_years.jsp" %>
