...
<caption>
	...
	<tr bgcolor="#8A9FCD" align="center">
		<td align="center" class="rptHeading" colspan="15"> <font color="red"><b>Amount in Rupees.</b></font></td>
</tr>	
<tr bgcolor="#8A9FCD" align="center">
		<td align="center" class="rptHeading" colspan="15">Bank Financial MPR:<%= finYear %> For <%=dname %> District And <%=constituencyName %> Constituency</td>
</tr>
<tr>
...
int TotPopForWork=0;
	String ConBillWorksRepQry="select nvl(sum(bill_amount_central),'0') as AmountforWork,a.work_id,b.WORK_NAME,com.MNAME,com.VNAME,com.PNAME,com.PANCH_CODE,com.PANCH_NAME,sum(nvl(com.CENSUS_PLAIN_POPU,0)+nvl(com.CENSUS_SC_POPU,0)+nvl(com.CENSUS_ST_POPU,0)) as population from rws_bill_bank_bridge_det_tbl a,rws_work_admn_tbl b,RWS_CONSTITUENCY_TBL c,RWS_ADMN_HAB_LNK_TBL d,rws_complete_hab_view com where to_date(bank_send_date) >='01-APR-"+year+"' and to_date(bank_send_date) <='31-MAR-"+year1+"' and txid is not null AND substr(a.office_code,2,2)='"+dcode+"' and a.work_id=b.work_id and d.hab_code=com.panch_code and substr(d.hab_code,6,2)=c.mcode and c.CONSTITUENCY_CODE='"+constituencyCode+"' and a.work_id=d.work_id group by a.work_id,b.WORK_NAME,com.MNAME,com.VNAME,com.PNAME,com.PANCH_CODE,com.PANCH_NAME order by a.work_id"; 
	/* String ConBillWorksRepQry="select a.work_id,b.WORK_NAME,com.MNAME,com.VNAME,com.PNAME,com.PANCH_CODE,com.PANCH_NAME,sum(nvl(com.CENSUS_PLAIN_POPU,0)+nvl(com.CENSUS_SC_POPU,0)+nvl(com.CENSUS_ST_POPU,0)) as population from rws_bill_bank_bridge_det_tbl a,rws_work_admn_tbl b,RWS_CONSTITUENCY_TBL c,rws_complete_hab_view com where to_date(bank_send_date) >='01-APR-"+year+"' and to_date(bank_send_date) <='31-MAR-"+year1+"' and txid is not null AND substr(a.office_code,2,2)='"+dcode+"' and a.work_id=b.work_id and lead_habitation=com.panch_code and substr(lead_habitation,6,2)=c.mcode and c.CONSTITUENCY_CODE='"+constituencyCode+"'  group by a.work_id,b.WORK_NAME,com.MNAME,com.VNAME,com.PNAME,com.PANCH_CODE,com.PANCH_NAME order by a.work_id"; */
	...
	while (rs3.next())
	{
		...
		/*  String PopQry="select nvl(nvl('"+rs3.getString("AmountforWork")+"'/sum(nvl(COM.CENSUS_PLAIN_POPU,0)+nvl(COM.CENSUS_SC_POPU,0)+nvl(COM.CENSUS_ST_POPU,0)),0)*('"+rs3.getString("population")+"'),0)  from rws_bill_bank_bridge_det_tbl a,rws_work_admn_tbl b,RWS_ADMN_HAB_LNK_TBL d,rws_complete_hab_view com where to_date(bank_send_date) >='01-APR-"+year+"' and to_date(bank_send_date) <='31-MAR-"+year1+"' and txid is not null AND substr(a.office_code,2,2)='"+dcode+"' and a.work_id=b.work_id and d.hab_code=com.panch_code and a.work_id=d.work_id and a.work_id='"+rs3.getString("work_id") +"'"; */ 
	    String PopQry="select nvl(nvl('"+rs3.getString("AmountforWork")+"'/sum(nvl(COM.CENSUS_PLAIN_POPU,0)+nvl(COM.CENSUS_SC_POPU,0)+nvl(COM.CENSUS_ST_POPU,0)),0)*('"+rs3.getString("population")+"'),0)  from rws_bill_bank_bridge_det_tbl a,rws_work_admn_tbl b,RWS_ADMN_HAB_LNK_TBL d,rws_complete_hab_view com where to_date(bank_send_date) >='01-APR-"+year+"' and to_date(bank_send_date) <='31-MAR-"+year1+"' and txid is not null AND substr(a.office_code,2,2)='"+dcode+"' and a.work_id=b.work_id and d.hab_code=com.panch_code and a.work_id=d.work_id and a.work_id='"+rs3.getString("work_id") +"'"; 
