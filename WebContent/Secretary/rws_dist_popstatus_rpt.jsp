...
<caption>
	<table  border=0 rules=none style="border-collapse:collapse" align = "right">
		<tr align="right">
			<td class="bwborder">
				<a href="./rws_dist_pop_frm1.jsp">Back|</a>
				<a href="./rws_dist_popstatus_xls.jsp" target="_new">Excel</a>
...
%> 
		...
		<tr>
		     ...
		     <td class=rptValue align="right"><%=c1%></td>
			 <td class=rptValue align="right"><%=c2%></td>
		     <td class=rptValue align="right"><%=c3%></td>
			 <td class=btext align="right"><%=c1+c2+c3%></td>
			 <td class=btext align="right"><%=poptot%></td>
			 <td class=rptValue align="right"><%=c4%></td>
			 <td class=rptValue align="right"><%=c5%></td>
		     <td class=rptValue align="right"><%=c6%></td>
			 <td class=btext align="right"><%=c4+c5+c6%></td>
			 <td class=btext align="right"><%=poptot1%></td>
			 
			 
			 <td class=rptValue align="right"><%=c13%></td>
			 <td class=rptValue align="right"><%=c14%></td>
		     <td class=rptValue align="right"><%=c15%></td>
			 <td class=btext align="right"><%=c13+c14+c15%></td>
			 <td class=btext align="right"><%=poptot4%></td>
			 
			 
			 <td class=rptValue align="right"><%=c7%></td>
			 <td class=rptValue align="right"><%=c8%></td>
		     <td class=rptValue align="right"><%=c9%></td>
			 <td class=btext align="right"><%=c7+c8+c9%></td>
			 <td class=btext align="right"><%=poptot2%></td>
			 
			 <td class=rptValue align="right"><%=c16%></td>
			 <td class=rptValue align="right"><%=c17%></td>
		     <td class=rptValue align="right"><%=c18%></td>
			 <td class=btext align="right"><%=c16+c17+c18%></td>
			 <td class=btext align="right"><%=poptot5%></td>
			 
			 <td class=rptValue align="right"><%=c19%></td>
			 <td class=rptValue align="right"><%=c20%></td>
		     <td class=rptValue align="right"><%=c21%></td>
			 <td class=btext align="right"><%=c19+c20+c21%></td>
			 <td class=btext align="right"><%=poptot6%></td>
			 
			 <td class=rptValue align="right"><%=c10%></td>
			 <td class=rptValue align="right"><%=c11%></td>
		     <td class=rptValue align="right"><%=c12%></td>
