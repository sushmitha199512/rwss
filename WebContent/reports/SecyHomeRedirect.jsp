                            ...
                            <TD vAlign=top width=881><table border=0 cellspacing=0 cellpadding=0 
                              ...
                              <tr>
                                        ...
                                        <td width="920" height=19 valign=top><table width="100%">
                                          ...
                                          <table width="868" border="0" align="center">
                                            ...
                                            <tr>
                                              ...
                                              <td colspan="3"><span class="indigo10pixel">Works (2010-2011)</span></td>
                                              <td colspan="3"><span class="indigo10pixel">Releases In Lakhs </span></td>
                                            </tr>
                                            <tr>
                                ...
                                height=5></td>
                                              ...
                                              <td width="30" align=right style="PADDING-RIGHT: 8px"><img 
                                src="imagess/arrow-samll.jpg" width=6 
                                height=5></td>
                                ...
                                src="imagess/arrow-samll.jpg" width=6 
                                height=5></td>
                                              <td width="68" height=20 class=green>BRO</td>
                                              <td width="95" class=text2><span class="indigo10pixel">
                                                <input type="text" class="noborder-text-box" readonly="true" name="bro" value="<%=rs1.getString(9)%>"></span></td>
                                            </tr>
                                            <tr>
                                ...
                                src="imagess/arrow-samll.jpg" width=6 
                                height=5></td>
                                              <td height=20 class=green>LOC</td>
                                              <td class=text2><span class="indigo10pixel">
                                                <input type="text" class="noborder-text-box" readonly="true" name="loc" value="<%=rs1.getString(10)%>"></span></td>
                                            </tr>
                                            <tr>
                                              <td style="PADDING-RIGHT: 8px" align=right><img 
                                src="imagess/arrow-samll.jpg" width=6 
                                ...
                                height=5></td>
                                              ...
                                              <td class=text2><span class="indigo10pixel">
                                                <input type="text" class="noborder-text-box" readonly="true" name="exp" value="<%=rs1.getString(11)%>"></span></td>
                                            </tr>
                                            <tr>
                                              <td style="PADDING-RIGHT: 8px" align=right><img 
                                src="imagess/arrow-samll.jpg" width=6 
                                ...
                                height=5></td>
                                              ...
                                              <td height="20" colspan="3" align=right style="PADDING-RIGHT: 8px"><div align="center"><a href="#" class="text2bold" onClick="toggleDisplay()">View Detailed Report</a></div></td>
                                              </tr>
                                            <tr>
                                              <td colspan="12" style="BORDER-BOTTOM: #666666 1px dotted; BORDER-BOTTOM: #666666 1px dotted" valign=bottom>&nbsp;</td>
                                            </tr>
                                            ...
                                            <tr>
                                              ...
                                              <td colspan="6"><span class="indigo10pixel">Reports</span></td>
                                              </tr>
                                            <tr>
                                              <td style="PADDING-RIGHT: 8px" align=right><img 
                                src="imagess/arrow-samll.jpg" width=6 
                                ...
                                src="imagess/arrow-samll.jpg" width=6 
                                height=5></td>
                                              <td height=20 colspan="2" class=green><span class="text2"><a href="#"  onClick="fnCall('4')">Assets Abstract</a></span></td>
                                              <td style="PADDING-RIGHT: 8px" align=right><img 
                                src="imagess/arrow-samll.jpg" width=6 
                                height=5></td>
                                              <td height=20 colspan="2" class=green><span class="text2"><a href="#" onClick="fnCall('5')">Assets-Sources </a></span></td>
                                            </tr>
                                            <tr>
                                              <td style="PADDING-RIGHT: 8px" align=right><img 
                                src="imagess/arrow-samll.jpg" width=6 
