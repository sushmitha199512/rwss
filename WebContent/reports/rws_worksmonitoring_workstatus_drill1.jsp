	...
	<caption>
		<table  border=0 rules=none style="border-collapse:collapse" align = "right">			
			<tr align="right">
				...
				<td class="bwborder"><a href="rws_worksmonitoring_workstatus_drill1_report_excel.jsp" target=_new">Excel|</a></td>
...
//	//System.out.println("in if");
	...
	////System.out.println("Test Qry is::"+qry1);
        ...
        <% if(rDistrict.equals("00") && drill.equals("1") && rConstituency.equals("-1"))
        	{
         %>
		<td class=rptValue nowrap><a href="rws_worksmonitoring_workstatus_drill1.jsp?rDistrict=<%=rs1.getString(1)%>&districtname=<%=rs1.getString(2)%>&constituency=<%=rConstituency%>&drill=2"><%=rs1.getString(2)%></a></td>	
		<%}
				else if(!rDistrict.equals("00") && drill.equals("1") && rConstituency.equals("00"))
		{%>
		...
		%>
					<td class=rptValue nowrap><%=rs1.getString(2)%></td>		
		<%}else if(drill.equals("2")){%>
				<td class=rptValue nowrap><a href="rws_worksmonitoring_workstatus_drill1.jsp?rDistrict=<%=rDistrict%>&districtname=<%=districtName1%>&rDivision=<%=rs1.getString(1)%>&rDivisonName=<%=rs1.getString(2)%>&constituency=<%=rConstituency%>&drill=3"><%=rs1.getString(2)%></a></td>	
		<%}
		else if(drill.equals("3")){%>
				<td class=rptValue nowrap><%=rs1.getString(2)%></td>	
		<%}
