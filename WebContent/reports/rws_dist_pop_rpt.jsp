...
<%		
	...
	ResultSet rs2=null,rs1=null,rs3=null,rs4=null,rs5=null,rs6=null,rs7=null,rs8=null,rs9=null,rs10=null,rs11=null;
...
<caption>
	<table  border=0 rules=none style="border-collapse:collapse" align = "right">
		<tr align="right">
			<td class="bwborder">
				<a href="./rws_dist_pop_frm.jsp">Back|</a>
				<a href="../home.jsp">Home|</a>
				<a href="./rws_dist_pop_xls.jsp" target="_new">Excel</a>
...
<table border = 1 cellspacing = 0 cellpadding = 0 width=100%  bordercolor=#000000 style="border-collapse:collapse" bgcolor="#ffffff">	
	...
	<tr>
	    ...
	    <td class=btext colspan = 2 align="center">0 - 100</td>
...
<%
	try
	{
		...
		while(rs2.next())
		{
			...
			System.out.println("lessThanQ is"+lessThanQ);
			try
			{
				...
				rs11 = st11.executeQuery(lessThanQ);
				rs11.next();
%>
	<tr>	
	   <td class=rptValue><%=++sno%></td>
	   <td class=rptValue><%=rs2.getString(2)%></td>
	   <td class=btext align="right"><%=rs11.getInt(1)%></td>
	   <td class=btext align="right"><%=rs11.getInt(2)%></td>
	   <td class=btext align="right"><%=rs3.getInt(1)+rs4.getInt(1)+rs5.getInt(1)+rs6.getInt(1)+rs7.getInt(1)+rs8.getInt(1)+rs9.getInt(1)+rs10.getInt(1)%></td>
	   <td class=btext align="right"><%=rs3.getInt(2)+rs4.getInt(2)+rs5.getInt(2)+rs6.getInt(2)+rs7.getInt(2)+rs8.getInt(2)+rs9.getInt(2)+rs10.getInt(2)%></td>
	   <td class=rptValue align="right"><%=rs3.getInt(1)%></td>
	   <td class=rptValue align="right"><%=rs3.getInt(2)%></td>
	   ...
	   <td class=rptValue align="right"><%=rs5.getInt(2)%></td>
	   <td class=rptValue align="right"><%=rs6.getInt(1)%></td>
		<td class=rptValue align="right"><%=rs6.getInt(2)%></td>
		...
		<td class=rptValue align="right"><%=rs8.getInt(2)%></td>
 ...
 totpop+=rs3.getInt(2)+rs4.getInt(2)+rs5.getInt(2)+rs6.getInt(2)+rs7.getInt(2)+rs8.getInt(2)+rs9.getInt(2)+rs10.getInt(2);
  ...
  pop8+=rs10.getInt(2);
	...
	%><tr>
	  ...
	  <td class=btext align="right"><%=totnohab%></td>
	  <td class=btext align="right"><%=totpop%></td>
	  <td class=rptValue align="right"><%=nohab1%></td>
	  <td class=rptValue align="right"><%=pop1%></td>
	  <td class=rptValue align="right"><%=nohab2%></td>
	  <td class=rptValue align="right"><%=pop2%></td>
	  <td class=rptValue align="right"><%=nohab3%></td>
	  <td class=rptValue align="right"><%=pop3%></td>
	  <td class=rptValue align="right"><%=nohab4%></td>
	  <td class=rptValue align="right"><%=pop4%></td>
	  <td class=rptValue align="right"><%=nohab5%></td>
	  <td class=rptValue align="right"><%=pop5%></td>
	  <td class=rptValue align="right"><%=nohab6%></td>
	  <td class=rptValue align="right"><%=pop6%></td>
	  <td class=rptValue align="right"><%=nohab7%></td>
	  <td class=rptValue align="right"><%=pop7%></td>
	  <td class=rptValue align="right"><%=nohab8%></td>
	  <td class=rptValue align="right"><%=pop8%></td>
