...
if(assettype.equals("cpws")){
	qry="select distinct a.asset_code,nvl(a.ASSET_NAME,'-'),nvl(a.LOCATION,'-'),nvl(to_char(a.DATE_CREATION,'dd-mm-yyyy'),'-'),nvl(ASSET_COST,0) from rws_asset_mast_tbl a,"+habTableName+" c where a.hab_code=c.hab_code  and a.DATE_CREATION<=to_date('31-03-"+ye+"','DD-MM-YYYY')  and type_of_asset_code='03' and substr(a.asset_code,5,2)='"+dcode+"'  and c.coverage_status is not null and c.coverage_status <> 'UI' ";
}
else if(assettype.equals("pws")){
	qry="select distinct a.asset_code,nvl(a.ASSET_NAME,'-'),nvl(a.LOCATION,'-'),nvl(to_char(a.DATE_CREATION,'dd-mm-yyyy'),'-'),nvl(ASSET_COST,0) from rws_asset_mast_tbl a,rws_asset_hab_tbl b,"+habTableName+" c where a.asset_code=b.asset_code and a.DATE_CREATION<=to_date('31-03-"+ye+"','DD-MM-YYYY')  and b.hab_code=c.hab_code and type_of_asset_code='01' and substr(a.asset_code,5,2)='"+dcode+"' and c.coverage_status is not null and c.coverage_status <> 'UI'   ";	
}
else if(assettype.equals("mpws")){
	qry="select distinct a.asset_code,nvl(a.ASSET_NAME,'-'),nvl(a.LOCATION,'-'),nvl(to_char(a.DATE_CREATION,'dd-mm-yyyy'),'-'),nvl(ASSET_COST,0) from rws_asset_mast_tbl a,rws_asset_hab_tbl b,"+habTableName+" c where a.asset_code=b.asset_code and a.DATE_CREATION<=to_date('31-03-"+ye+"','DD-MM-YYYY')  and b.hab_code=c.hab_code and type_of_asset_code='02' and substr(a.asset_code,5,2)='"+dcode+"' and c.coverage_status is not null and c.coverage_status <> 'UI'   ";	
}
else if(assettype.equals("dp")){
	qry="select distinct a.asset_code,nvl(a.ASSET_NAME,'-'),nvl(a.LOCATION,'-'),nvl(to_char(a.DATE_CREATION,'dd-mm-yyyy'),'-'),nvl(ASSET_COST,0) from rws_asset_mast_tbl a,rws_asset_hab_tbl b,"+habTableName+" c where a.asset_code=b.asset_code and a.DATE_CREATION<=to_date('31-03-"+ye+"','DD-MM-YYYY')  and b.hab_code=c.hab_code and type_of_asset_code='09'  and substr(a.asset_code,5,2)='"+dcode+"' and c.coverage_status is not null and c.coverage_status <> 'UI'   ";	
}
else if(assettype.equals("hp")){
	qry="select distinct a.asset_code,nvl(a.ASSET_NAME,'-'),nvl(a.LOCATION,'-'),nvl(to_char(a.DATE_CREATION,'dd-mm-yyyy'),'-'),nvl(ASSET_COST,0) from rws_asset_mast_tbl a,rws_asset_hab_tbl b,"+habTableName+" c where a.asset_code=b.asset_code and a.DATE_CREATION<=to_date('31-03-"+ye+"','DD-MM-YYYY')  and b.hab_code=c.hab_code and type_of_asset_code in ('04','05') and substr(a.asset_code,5,2)='"+dcode+"' and c.coverage_status is not null and c.coverage_status <> 'UI'   ";
}
else if(assettype.equals("ow")){
	qry="select distinct a.asset_code,nvl(a.ASSET_NAME,'-'),nvl(a.LOCATION,'-'),nvl(to_char(a.DATE_CREATION,'dd-mm-yyyy'),'-'),nvl(ASSET_COST,0) from rws_asset_mast_tbl a,rws_asset_hab_tbl b,"+habTableName+" c where a.asset_code=b.asset_code and a.DATE_CREATION<=to_date('31-03-"+ye+"','DD-MM-YYYY')  and b.hab_code=c.hab_code and type_of_asset_code='06' and substr(a.asset_code,5,2)='"+dcode+"'and c.coverage_status is not null and c.coverage_status <> 'UI'   ";	
}
else if(assettype.equals("o")){
	qry="select distinct a.asset_code,nvl(a.ASSET_NAME,'-'),nvl(a.LOCATION,'-'),nvl(to_char(a.DATE_CREATION,'dd-mm-yyyy'),'-'),nvl(ASSET_COST,0) from rws_asset_mast_tbl a,rws_asset_hab_tbl b,"+habTableName+" c where a.asset_code=b.asset_code and a.DATE_CREATION<=to_date('31-03-"+ye+"','DD-MM-YYYY')  and b.hab_code=c.hab_code and type_of_asset_code in ('07','08','10','11','12') and substr(a.asset_code,5,2)='"+dcode+"' and c.coverage_status is not null and c.coverage_status <> 'UI'   ";	
}
}else{
	if(assettype.equals("cpws")){
