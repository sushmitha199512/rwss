...
int ghpcount=0;
String mname="";
String assettype=request.getParameter("assettype1");
...
<caption>
		<table  border=0 rules=none style="border-collapse:collapse" align = "right">			
			<tr align="right">
				...
				<td class="bwborder"><a href="./rws_reservoirs_nodetails_excel_rpt.jsp?district=<%=district%>&assettype=<%=assettype%>" target="_new">Excel</a></td>
...
<tr bgcolor="#8A9FCD" align="center">
		<td align="center" class="rptHeading" colspan="14">  Assets  <%=assetName%> No Reservoirs Report </td>
</tr>
</table>
