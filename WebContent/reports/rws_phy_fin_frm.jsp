...
document.f1.distname.value = document.f1.combo.options[document.f1.combo.options.selectedIndex].text;
			...
			else
		{
			...
			document.f1.action="./rws_phy_fin_rpt.jsp";
...
</tr><tr><td class=rptLabel>Special Category&nbsp;&nbsp;<font color="red">*</font></td>
<td class=btext>
...
<%
		...
		String 	query4="select distinct(special_cat) from rws_work_admn_tbl where special_cat!='0'";
