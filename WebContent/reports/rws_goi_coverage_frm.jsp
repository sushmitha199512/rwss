...
function fnDistSubmit()
	{ 
		document.f1.action="./rws_goi_dist_rpt.jsp";
		document.f1.submit();
		
	}
	function fnMandSubmit()
	{ 
		document.f1.action="./rws_goi_mandal_rpt.jsp";
		document.f1.submit();
		
	}
		function fnPanchSubmit()
	{ 
		document.f1.action="./rws_goi_panch_rpt.jsp";
		document.f1.submit();
		
	}
		function fnPanchOnlySubmit()
	{ 
		document.f1.action="./rws_goi_panch_only_rpt.jsp";
		document.f1.submit();
	...
	<table  border=0 rules=none style="border-collapse:collapse" width=100% align = "right" bgcolor="#edf2f8">
		...
		<tr bgcolor="#8A9FCD" align="center">
			<td align="center" class="textborder" colspan="2">
				<font color="#FFFFFF">GOI-Coverage Status Report</font>
			</td>	
		</tr>
