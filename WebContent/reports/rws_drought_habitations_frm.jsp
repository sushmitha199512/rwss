	...
	function fnSubmit()
	{
		var loggedUser = '<%=loggedUser%>';
			...
			else
			{
				...
				document.f1.action="./rws_drought_habitations_abstract_rpt.jsp";
				document.f1.submit();
			}	
		}
		</script>
...
<%} %>
	...
	<tr bgcolor="#8A9FCD" align="center">
		<td align="center" class="rptHeading" colspan=3>Drought Habitation Abstract Report</td>	
	</tr>
	<%
try
{
