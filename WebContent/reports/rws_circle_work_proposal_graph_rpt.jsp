...
<%		int repcode=0,totfc=0,totpc1=0,totpc2=0,totpc3=0,totpc4=0,totnc=0,totnss=0;
 ...
 String distic=request.getParameter("district");
...
<caption>
	<table  border=0 rules=none style="border-collapse:collapse" align = "right">
		...
		<tr align="right">
			<td class="bwborder">
				<a href="./rws_circle_work_proposal_graph_frm.jsp">Back&nbsp;|&nbsp;</a>&nbsp;<a href="../home.jsp">Home</a>
			</td>
		</tr>
	</table>
</caption>
	...
	<tr bgcolor="lavander">
		<td class="textborder" align="center" colspan="7">
			<font color="ffffff">Work Proposal Details</font></td>
	</tr>
...
String qu1="";
	if(dCode.equals("51"))
		{
			 ...
			 qu1 = "SELECT c.circle_office_name,count(substr(office_code,2,2)) from 			 rws_work_proposal_tbl rp, RWS_CIRCLE_OFFICE_TBL c where substr(rp.office_code,2,2)=c.circle_office_code   ";
			...
			else if(!dCode.equals("51") && mCode.equals("null"))
		{
			// //System.out.println("val    sadiq ali"+district);
			 ...
			 qu1 = "SELECT c.division_office_name, count(substr(office_code,4,1)) from rws_work_proposal_tbl rp, RWS_division_OFFICE_TBL c where substr(rp.office_code,2,2)=c.circle_office_code and substr(rp.office_code,4,1)=c.division_office_code and   substr(rp.office_code,2,2)='"+district+"' ";
	...
	else if((!mCode.equals("5200") && !mandal.equals("5200"))|| pCode.equals("5300") ||  !mCode.equals("0"))
		{
			qu1 = "SELECT c.subdivision_office_name, count(substr(office_code,5,2)) from rws_work_proposal_tbl rp, RWS_subdivision_OFFICE_TBL c where substr(rp.office_code,2,2)=c.circle_office_code and substr(rp.office_code,4,1)=c.division_office_code and substr(rp.office_code,5,2)=c.subdivision_office_code  and substr(rp.office_code,2,2)='"+district+"' and substr(rp.office_code,4,1)='"+mandal+"'		";
	...
	%>
		...
		<%@ include file = "rws_circle_work_propo_graph.jsp" %>	
