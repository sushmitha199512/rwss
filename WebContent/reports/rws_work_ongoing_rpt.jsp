...
<caption>
		<table  border=0 rules=none style="border-collapse:collapse" align = "right">			
			<tr align="right">
				...
				<td class="bwborder"><a href="/pred/reports/rws_work_ongoing_xls.jsp" target="_new">Excel</a></td>
			</tr>  
		</table>
	</caption>
...
try
{
	String qry="SELECT w.work_id,no_of_habs,work_name,c.dname,c.mname,c.pname,c.vname,c.panch_name ,c.coverage_status,d.habitation_type,d.habitation_sub_type,(d.census_sc_popu+d.census_st_popu+d.census_plain_popu) as popu FROM RWS_WORK_ADMN_TBL W,rws_admn_hab_lnk_tbl b,rws_complete_hab_view c,rws_habitation_directory_tbl d where d.hab_code=c.panch_code and d.hab_code=b.hab_code and  w.work_id=b.work_id and b.hab_code=c.panch_code and w.ADMIN_DATE <'"+yr+"'and w.work_id not in (select work_id from rws_work_completion_tbl where (DATE_OF_COMPLETION <'"+yr+"') and substr(work_id,5,2)='"+dcode+"') and substr(w.work_id,5,2)='"+dcode+"' and category_code='"+category+"' and work_cancel_dt is null order by w.work_id";
