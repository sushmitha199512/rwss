<tr bgcolor="#8A9FCD" align="center">
		<td align="center" class="rptHeading" colspan=25>Program Wise Works Report</font></td>	
	</tr>
<% 
if(subprogramCode!=null || subprogramCode!="")
	{

%>	
	<tr  align="center">
		<td align="center" class="btext" colspan=25>District: All &nbsp; &nbsp;Work Category: <%=workCategory%> &nbsp; &nbsp;Program: <%=programName%></td>		
	</tr>	
	<tr align=center  align=center>
		<td class=btext rowspan = 3>Sl.No</td>
		<td class=btext rowspan = 3>Work Id</td>
		<td class=btext rowspan = 3>Works</td>
...
%>	
	<tr  align="center">
		<td align="center" class="btext" colspan=18>District: All &nbsp; &nbsp;Program:All</td><td class=btext colspan=7>Amount in Rs.Lakhs</td>		
	</tr>	
	<tr align=center  align=center>
		<td class=btext rowspan = 3>Sl.No</td>
