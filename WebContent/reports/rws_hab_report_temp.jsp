...
//	System.out.println("size at 2ND stage:"+labelcol2.size());

	session.setAttribute("arrayLabel",labelcol2);
...
<form name=f1 method="post" action="./rws_hab_report_temp.jsp">
		...
		<tr align="right">
			<td class="bwborder">
			    ...
			    <a href="rws_hab_rpt_excel_print.jsp"	 target="_new">Excel</a>-->
				 <a href="./rws_hab_rpt_excel_print2.jsp?aType=<%=assetType%>" target="new">Excel</a>
				</td>
		</tr>
	</table>
</caption>
	<tr bgcolor="lavander">
		<td class="textborder" align="center" colspan="20">
...
<tr >
		...
		<font size=2>Status As On : </font><font color=#F2A80D> <%=FDATE %> </font></font></td><%  if(assetType.equals("01")) %> 
	    <td class="textborder" align="center">
...
if(labelNames[j].equals("Houseconn"))
      ...
      <% } 
			...
			<tr>
			<%
			for(j=2;j<=((labelNames.length-2)/4)+1;j++ )
			 {%>
				<td class = btext>No.</td>
...
<% 			            
			...
			<%	}
			    ...
			    <%  
						...
						try
                {
					double dd = Double.parseDouble(""+record1[k]);
	            	%> 
