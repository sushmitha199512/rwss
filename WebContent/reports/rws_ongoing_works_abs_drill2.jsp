...
try
{
   ...
   if(mode==null || mode.equals("")){
	...
	habqry+=" and a.programme_code in ("+programe+")  group by a.work_id,a.work_name,a.SANCTION_AMOUNT,a.ADMIN_DATE,to_char(GROUNDING_DATE,'dd/mm/yyyy'),NO_OF_HABS,to_char(DATE_OF_COMPLETION,'dd/mm/yyyy'),i.dname,nvl(lead_habitation,'--') ";
