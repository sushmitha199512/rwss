...
<br>
<TABLE border="2" frame="hsides" rules="groups" border=1>
<COLGROUP align="left">
<COLGROUP align="left">
<COLGROUP align="left">
<COLGROUP align="left">
...
<COLGROUP align="left">
	<tr>
		<th rowspan=2 class = btest1>S.No
		<!-- <th class="mystyle">District Name</th> -->
		<% if(session.getAttribute("dName")==null){ %>
		<th rowspan=2 class = btest1>District Name</th> <% } %>

		<!-- <th class="mystyle">Mandal Name</th>	 -->
		<% if(session.getAttribute("mName")==null){ %>
		<th rowspan=2 class = btest1>Mandal Name</th> <% } %>

		<!-- <th class="mystyle">Panchayat Name</th> -->
		<% if(session.getAttribute("pName")==null){ %>
		<th rowspan=2 class = btest1>Panchayat Name</th> <% } %>

		<th rowspan=2 class = btest1>Habitation Name</th>
		...
		<%
			for(j=4; j<labelNames.length;j++ )
			{
				...
				{
			%>
				<th class = btest1><%= labelNames[j] %></th>
			<%
				} 
			}%>
			</tr>
