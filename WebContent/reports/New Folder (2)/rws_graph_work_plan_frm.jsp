...
<%			
	...
	rs5=st5.executeQuery("select distinct to_char(admin_date,'yyyy') from rws_work_admn_tbl where admin_date is not null and to_char(admin_date,'yyyy')<=to_char(sysdate,'yyyy') order by to_char(admin_date,'yyyy') desc"); 
