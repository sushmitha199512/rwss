...
query = "insert into wq_FTKTestingdetails(TestId,DDWS_TEST_ID,ParameterId)values('"+ftestId+"','"+ddws_id+"','"+parameterId+"')";
...
if(mnth>3){
 ...
 System.out.println("Ddws_id:"+ddws_id);
	...
	query = "update   wq_waterQualityTesting set DDWS_TEST_ID='"+ddws_id+"',FinYear='"+finYear+"' where TestId='"+ftestId+"'";
