...
%>
<table border=1 cellspacing=0 cellpadding = 0 bordercolor=#000000 style="border-collapse:collapse" bgcolor="#ffffff" align=center width=100%>
	<tr>
		<td class=textborder>List of Sub Division Offices</td>
	</tr>
</table>
<table border = 1 cellspacing = 0 cellpadding = 0 width=100%  bordercolor=#000000 style="border-collapse:collapse" bgcolor="#ffffff" align=center>
	<tr align=center bgcolor="#ffffff">
		...
		<td class=textborder>Sub Division Office Code</td>
		<td class=textborder>Sub Division Office Name</td>
	</tr>
