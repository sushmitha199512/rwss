...
System.out.println("type:"+type);
  ...
  if(sCode!=null && sCode.substring(19,21).equals("SO")){
	...
	String Query="insert into [WQM_WaterQualityTesting](TestId,Source,HabitationId,Districtid,TestCode)values('"+testid+"','"+sCode+"','"+rs1.getString(4)+"','"+rs1.getString(5)+"','"+rs1.getString(3)+"')";
