...
<table border = 0 cellspacing = 0 cellpadding = 0 width=30% bordercolor=#000000 style="border-collapse:collapse">
	...
	<tr>
		<td class="textborder" align="center" colspan="8">Select Percentage&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<select name="per" onchange="this.form.submit()">
			<%if(per!=null && per.equals("30")){%>
...
<table border = 1 cellspacing = 0 cellpadding = 0 width=100%  bordercolor=#000000 style="border-collapse:collapse" bgcolor="#ffffff">	
	<tr  align="center">
		<td align="center" class="btext" colspan=47>Report for District: All and Percentage: <%=per%>%</td>
	</tr>	
	...
	if(dcode!=null && !dcode.equals("")){
		rs2=st2.executeQuery("select distinct d.dcode,d.dname from rws_district_tbl d  where dcode <> '16' and dcode='"+dcode+"'  order by d.dcode,d.dname");
...
while(rs2.next())
{
	...
	%>
			<tr>	
		     ...
		     <td class=rptValue><a href="rws_dist_popcate_drill_rpt.jsp?district=<%=rs2.getString(1)%>&per=<%=per%>&dName=<%=rs2.getString(2)%>"><%=rs2.getString(2)%></a></td>
