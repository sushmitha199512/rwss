		...
		function fnSubmit() {    
	    	...
	    	if(d==''){
				...
				if(diffDays>31) {
				    ...
				    document.forms[0].action="switch.do?prefix=/reports&page=/WQFTKACCESS.do?mode=get";
...
<body bgcolor="#edf2f8">
	<html:form action="WQFTKACCESS.do">
	<table border="1" align="center" cellspacing="0" cellpadding="0" rules="rows" width="32%"  bordercolor="navy" style="border-collapse:collapse" bgcolor="#ffffff">
		...
		<tr bgcolor="#8A9FCD" align="center">
			<td align="center" class="textborder" colspan="2">
				<font color="#FFFFFF">WaterQuality FTK Porting</font>
			</td>	
		</tr>
		<tr> 
	...
	<table width="30%" align="center">
		<tr>
			...
			<td class=rptValue nowrap>1. FTK Test Dates are considered For FTK Data Porting.</td>
		</tr>
		<br>
		<tr>
			<td bordercolor="black"></td><td class=rptValue nowrap>2. Only One Month Data can be Ported at a time. </td>
		</tr>
	</table>
