...
if(loggedUser.substring(0,3).equals("col")){
	 rDistrict=(String)session.getAttribute("district");    
	   }
if(rDistrict!=null){
...
if(yrcreation!=null)
{
 ...
 if(yrcreation.equals("") || yrcreation==null)
{
yrcreation1="ALL";
 }else{
...
if(rDistrictName!=null){
System.out.println(" dist name:"+rDistrictName);
...
{ %>
			<tr><td align="right" class="bwborder"><a href="javascript:history.go(-1)">Back</a>|
					...
					<a href="./rws_AssetAbstract_report_xls.jsp?rDistrict=<%=rDistrict%>&yrcreation=<%=yrcreation%>&rDistrictName=<%=rDistrictName %>" target=_new>Excel</a>
					</td></tr>
<%  } else {%>
...
<%} %>
 ...
 <tr>
	<td class=btext colspan="2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Total</td>
				<td class=btext align="right"><%=coltot1%></td>
				<td class=btext align="right"><%=coltot2%></td>
				<td class=btext align="right"><%=coltot3%></td>
				<td class=btext align="right"><%=coltot4%></td>
				<td class=btext align="right"><%=coltot5%></td>
				<td class=btext align="right"><%=coltot6%></td>
				<td class=btext align="right"><%=coltot7%></td>
				<td class=btext align="right"><%=coltot8%></td>
	       </tr>
