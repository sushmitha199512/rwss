				...
				<table border=0 rules=none style="border-collapse: collapse"
					...
					<a href="excelrpt.jsp">Excel
						...
						<td align="right" class="bwborder"><a
							...
							<% }else{
								%> --%>
															<a href="./rws_habitation_abstract_rpt1_excel_n.jsp?poptype=<%=poptype.toString()%>&lpcdrange=<%=lpcdrange.toString()%>" target=_new>Excel</a>
		 ...
		 -->
			...
			<tr>
				...
				<td class="<%=style%>" class="rptValue" style="text-align: left;"><a
					href="rws_habitation_abstract_rpt1_n.jsp?drill=next&rDistrict=<%=rs2.getString(1)%>&rDistrictName=<%=rs2.getString(2)%>&finyear=<%=finYear%>&lpcdrange=<%=lpcdrange%>&poptype=<%=poptype%>"><%=rs2.getString(2)%></a></td>
				<td class="<%=style%>" style="text-align: right;"><%=pcount%></td>
				<td class="<%=style%>" style="text-align: right;"><%=vcount%></td>
				<td class="<%=style%>" style="text-align: right;"><a href="#" onclick="viewWorks('rws_habitation_abstract_overview_drillrpt_n.jsp?rDistrict=<%=rs2.getString(1)%>&rDistrictName=<%=rs2.getString(2)%>&finyear=<%=finYear%>&lpcdrange=<%=lpcdrange%>&poptype=<%=poptype%>')"><%=hcount%></a></td>
				<td class="<%=style%>" style="text-align: right;"><%=totalpop%></td>
				<td class="<%=style%>" style="text-align: right;"><a href="#"
					onclick="viewWorks('/pred/reports/rws_habitation_abstract_drill_rpt_n.jsp?rDistrict=<%=rs2.getString(1)%>&rDistrictName=<%=rs2.getString(2)%>&finyear=<%=finYear%>&lpcdrange=<%=lpcdrange%>&poptype=<%=poptype%>&coverageStatus=<%=FC%>')"><%=count1%></a></td>
				<td class="<%=style%>" style="text-align: right;"><%=FCpop%></td>
				<td class="<%=style%>" style="text-align: right;"><a href="#"
					onclick="viewWorks('/pred/reports/rws_habitation_abstract_drill_rpt_n.jsp?rDistrict=<%=rs2.getString(1)%>&rDistrictName=<%=rs2.getString(2)%>&finyear=<%=finYear%>&lpcdrange=<%=lpcdrange%>&poptype=<%=poptype%>&coverageStatus=<%=PC4%>')"><%=count5%></a></td>
				<td class="<%=style%>" style="text-align: right;"><%=PC4pop%></td>
				<td class="<%=style%>" style="text-align: right;"><a href="#"
					onclick="viewWorks('/pred/reports/rws_habitation_abstract_drill_rpt_n.jsp?rDistrict=<%=rs2.getString(1)%>&rDistrictName=<%=rs2.getString(2)%>&finyear=<%=finYear%>&lpcdrange=<%=lpcdrange%>&poptype=<%=poptype%>&coverageStatus=<%=PC3%>')"><%=count4%></a></td>
				<td class="<%=style%>" style="text-align: right;"><%=PC3pop%></td>
				<td class="<%=style%>" style="text-align: right;"><a href="#"
					onclick="viewWorks('/pred/reports/rws_habitation_abstract_drill_rpt_n.jsp?rDistrict=<%=rs2.getString(1)%>&rDistrictName=<%=rs2.getString(2)%>&finyear=<%=finYear%>&lpcdrange=<%=lpcdrange%>&poptype=<%=poptype%>&coverageStatus=<%=PC2%>')"><%=count3%></a></td>
				<td class="<%=style%>" style="text-align: right;"><%=PC2pop%></td>
				<td class="<%=style%>" style="text-align: right;"><a href="#"
					onclick="viewWorks('/pred/reports/rws_habitation_abstract_drill_rpt_n.jsp?rDistrict=<%=rs2.getString(1)%>&rDistrictName=<%=rs2.getString(2)%>&finyear=<%=finYear%>&lpcdrange=<%=lpcdrange%>&poptype=<%=poptype%>&coverageStatus=<%=PC1%>')"><%=count2%></a></td>
				<td class="<%=style%>" style="text-align: right;"><%=PC1pop%></td>
				<td class="<%=style%>" style="text-align: right;"><a href="#"
					onclick="viewWorks('/pred/reports/rws_habitation_abstract_drill_rpt_n.jsp?rDistrict=<%=rs2.getString(1)%>&rDistrictName=<%=rs2.getString(2)%>&finyear=<%=finYear%>&lpcdrange=<%=lpcdrange%>&poptype=<%=poptype%>&coverageStatus=<%=NSS%>')"><%=count6%></a></td>
				<td class="<%=style%>" style="text-align: right;"><%=NSSpop%></td>
				<td class="<%=style%>" style="text-align: right;"><a href="#"
					onclick="viewWorks('/pred/reports/rws_habitation_abstract_drill_rpt_n.jsp?rDistrict=<%=rs2.getString(1)%>&rDistrictName=<%=rs2.getString(2)%>&finyear=<%=finYear%>&lpcdrange=<%=lpcdrange%>&poptype=<%=poptype%>&coverageStatus=<%=NC%>')"><%=count7%></a></td>
			...
			<tr>
				...
				<td class=gridhdbg style="text-align: right;"><a href="#" onclick="viewWorks('rws_habitation_abstract_overview_drillrpt_n.jsp?rDistrict=<%=Dcode%>&rDistrictName=<%=Dname%>&finyear=<%=finYear%>&lpcdrange=<%=lpcdrange%>&poptype=<%=poptype%>')"><font color="#FFFFFF"><%=columnTotal3%></font></a></td>
...
<body bgcolor="#edf2f8">
	...
	<table border=1 cellspacing=0 cellpadding=0 height=5% width="100%"
		...
		<%
			rs2.previous();
							...
							while (rs2.next()) {
								...
								hQuery.delete(0, hQuery.length());
								//Query modified by pranavi
								hQuery.append("select h.panch_code,hd.exist_water_level,hd.ACT_COVERAGE_STATUS,(nvl(hd.ACT_PLAIN_POPU,'0')+nvl(hd.ACT_SC_POPU,'0')+nvl(hd.ACT_ST_POPU,'0')) as totalpop,nvl(hd.safe_lpcd,0),nvl(hd.unsafe_lpcd,0)  from rws_district_tbl d,rws_mandal_tbl m,rws_panchayat_tbl p,rws_village_tbl v,rws_panchayat_raj_tbl h,"
										+ habTableName
										+ " hd where d.dcode=m.dcode and m.dcode=p.dcode and m.mcode =p.mcode and p.dcode=v.dcode and p.mcode=v.mcode and p.pcode=v.pcode and substr (h.panch_code,1,2) = v.dcode and substr(h.panch_code,6,2) = v.mcode and substr(h.panch_code,13,2) = v.pcode and substr (h.panch_code,8,3) = v.vcode and h.panch_code=hd.hab_code and hd.ACT_COVERAGE_STATUS is not null and hd.ACT_COVERAGE_STATUS not in('UI','NW')  and d.dcode='"
										+ rDistrict
										+ "'  and m.mcode='"
								...
								hquery1.delete(0, hquery1.length());
								hquery1.append("select h.panch_code,nvl(ACT_PLAIN_POPU,0)+nvl(ACT_SC_POPU,0)+nvl(ACT_ST_POPU,0),nvl(total_water_supply,0) as totalpop ,nvl(hd.safe_lpcd,0),nvl(hd.unsafe_lpcd,0)  from rws_district_tbl d,rws_mandal_tbl m,rws_panchayat_tbl p,rws_village_tbl v,rws_complete_hab_view h,"
										+ habTableName
										+ " hd where d.dcode=m.dcode and m.dcode=p.dcode and m.mcode =p.mcode and p.dcode=v.dcode and p.mcode=v.mcode and p.pcode=v.pcode and substr (h.panch_code,1,2) = v.dcode and substr(h.panch_code,6,2) = v.mcode and substr(h.panch_code,13,2) = v.pcode and substr (h.panch_code,8,3) = v.vcode and h.panch_code=hd.hab_code and hd.ACT_COVERAGE_STATUS is not null and hd.ACT_COVERAGE_STATUS not in('UI','NW')  and d.dcode='"
										+ rDistrict
										+ "'  and m.mcode='"
		...
		<tr>
			...
			<td class="<%=style%>" style="text-align: right;"><%=pcount%></td>
			<td class="<%=style%>" style="text-align: right;"><%=vcount%></td>
			<td class="<%=style%>" style="text-align: right;"><a href="#" onclick="viewWorks('rws_habitation_abstract_overview_drillrpt_n.jsp?rDistrict=<%=rDistrict%>&rDistrictName=<%=rDistrictName%>&rMandal=<%=rs2.getString(1)%>&rMandalName=<%=rs2.getString(2)%>&finyear=<%=finYear%>&lpcdrange=<%=lpcdrange%>&poptype=<%=poptype%>')"><%=hcount%></a></td>
			<td class="<%=style%>" style="text-align: right;"><%=totalpop%></td>
		...
		<tr>
			...
			<td class=gridhdbg style="text-align: right;"><%=columnTotal1%></td>
			<td class=gridhdbg style="text-align: right;"><%=columnTotal2%></td>
			<td class=gridhdbg style="text-align: right;"><a href="#" onclick="viewWorks('rws_habitation_abstract_overview_drillrpt_n.jsp?rDistrict=<%=rDistrict%>&rDistrictName=<%=rDistrictName%>&finyear=<%=finYear%>&lpcdrange=<%=lpcdrange%>&poptype=<%=poptype%>')"><font color="#FFFFFF"><%=columnTotal3%></font></a></td>
			<td class=gridhdbg style="text-align: right;"><%=Gtotalpop%></td>
			<td class=gridhdbg style="text-align: right;"><%=columnTotal4%></td>
			<td class=gridhdbg style="text-align: right;"><%=FCpopTotal%></td>
			<td class=gridhdbg style="text-align: right;"><%=columnTotal5%></td>
		...
		<%
			rs2.previous();
					...
					while (rs2.next()) {
						...
						hQuery.append("select h.panch_code,hd.exist_water_level,hd.ACT_COVERAGE_STATUS,(nvl(hd.ACT_PLAIN_POPU,'0')+nvl(hd.ACT_SC_POPU,'0')+nvl(hd.ACT_ST_POPU,'0')) as totalpop,nvl(hd.safe_lpcd,0),nvl(hd.unsafe_lpcd,0)  from rws_district_tbl d,rws_mandal_tbl m,rws_panchayat_tbl p,rws_village_tbl v,rws_complete_hab_view h,"
								+ habTableName
								+ " hd where d.dcode=m.dcode and m.dcode=p.dcode and m.mcode =p.mcode and p.dcode=v.dcode and p.mcode=v.mcode and p.pcode=v.pcode and substr (h.panch_code,1,2) = v.dcode and substr(h.panch_code,6,2) = v.mcode and substr(h.panch_code,13,2) = v.pcode and substr (h.panch_code,8,3) = v.vcode and h.panch_code=hd.hab_code and hd.ACT_COVERAGE_STATUS is not null and hd.ACT_COVERAGE_STATUS not in('UI','NW')  and d.dcode='"
								+ rDistrict
								+ "'  and m.mcode='"
						...
						hquery1.delete(0, hquery1.length());
						hquery1.append("select h.panch_code,nvl(hd.ACT_PLAIN_POPU,0)+nvl(hd.ACT_SC_POPU,0)+nvl(hd.ACT_ST_POPU,0),nvl(hd.total_water_supply,0) as totalpop ,nvl(hd.safe_lpcd,0),nvl(hd.unsafe_lpcd,0)  from rws_district_tbl d,rws_mandal_tbl m,rws_panchayat_tbl p,rws_village_tbl v,rws_complete_hab_view h,"
								+ habTableName
								+ " hd where d.dcode=m.dcode and m.dcode=p.dcode and m.mcode =p.mcode and p.dcode=v.dcode and p.mcode=v.mcode and p.pcode=v.pcode and substr (h.panch_code,1,2) = v.dcode and substr(h.panch_code,6,2) = v.mcode and substr(h.panch_code,13,2) = v.pcode and substr (h.panch_code,8,3) = v.vcode and h.panch_code=hd.hab_code and hd.ACT_COVERAGE_STATUS is not null and hd.ACT_COVERAGE_STATUS not in('UI','NW')  and d.dcode='"
								+ rDistrict
								+ "'  and m.mcode='"
...
<body bgcolor="#edf2f8">
	...
	<table border=1 cellspacing=0 cellpadding=0 height=5% width="100%"
		...
		<%
			rs2.previous();
					...
					while (rs2.next()) {
						...
						hquery1.delete(0, hquery1.length());
						hquery1.append("select h.panch_code,nvl(hd.ACT_PLAIN_POPU,0)+nvl(hd.ACT_SC_POPU,0)+nvl(hd.ACT_ST_POPU,0),nvl(hd.safe_lpcd,0),nvl(hd.unsafe_lpcd,0),nvl(hd.total_water_supply,0)  from rws_district_tbl d,rws_mandal_tbl m,rws_panchayat_tbl p,rws_village_tbl v,rws_complete_hab_view h,"
								+ habTableName
								+ " hd where d.dcode=m.dcode and m.dcode=p.dcode and m.mcode =p.mcode and p.dcode=v.dcode and p.mcode=v.mcode and p.pcode=v.pcode and substr (h.panch_code,1,2) = v.dcode and substr(h.panch_code,6,2) = v.mcode and substr(h.panch_code,13,2) = v.pcode and substr (h.panch_code,8,3) = v.vcode and h.panch_code=hd.hab_code and hd.ACT_COVERAGE_STATUS is not null and hd.ACT_COVERAGE_STATUS not in('UI','NW')  and d.dcode='"
								+ rDistrict
								+ "'  and m.mcode='"
		...
		<tr>
			...
			<td class="<%=style%>" style="text-align: right;"><%=vcount%></td>
			<td class="<%=style%>" style="text-align: right;"><a href="#" onclick="viewWorks('rws_habitation_abstract_overview_drillrpt_n.jsp?rDistrict=<%=rDistrict%>&rDistrictName=<%=rDistrictName%>&rMandal=<%=rMandal%>&rMandalName=<%=rMandalName%>&rPanchayat=<%=rs2.getString(1)%>&rPanchayatName=<%=rs2.getString(2)%>&finyear=<%=finYear%>&lpcdrange=<%=lpcdrange%>&poptype=<%=poptype%>')"><%=hcount%></a></td>
			<td class="<%=style%>" style="text-align: right;"><%=totalpop%></td>
			<td class="<%=style%>" style="text-align: right;"><%=count1%></td>
			<td class="<%=style%>" style="text-align: right;"><%=FCpop%></td>
			<td class="<%=style%>" style="text-align: right;"><%=count5%></td>
		...
		<tr>
			...
			<td class=gridhdbg style="text-align: right;"><%=columnTotal2%></td>
			<td class=gridhdbg style="text-align: right;"><a href="#" onclick="viewWorks('rws_habitation_abstract_overview_drillrpt_n.jsp?rDistrict=<%=rDistrict%>&rDistrictName=<%=rDistrictName%>&rMandal=<%=rMandal%>&rMandalName=<%=rMandalName%>&finyear=<%=finYear%>&lpcdrange=<%=lpcdrange%>&poptype=<%=poptype%>')"><font color="#FFFFFF"><%=columnTotal3%></font></a></td>
			<td class=gridhdbg style="text-align: right;"><%=Gtotalpop%></td>
			<td class=gridhdbg style="text-align: right;"><%=columnTotal4%></td>
			<td class=gridhdbg style="text-align: right;"><%=FCpopTotal%></td>
			<td class=gridhdbg style="text-align: right;"><%=columnTotal5%></td>
		...
		<%
			rs2.previous();
					...
					while (rs2.next()) {
						...
						hquery1.delete(0, hquery1.length());
						hquery1.append("select h.panch_code,nvl(hd.ACT_PLAIN_POPU,0)+nvl(hd.ACT_SC_POPU,0)+nvl(hd.ACT_ST_POPU,0),nvl(hd.total_water_supply,0),nvl(hd.safe_lpcd,0),nvl(hd.unsafe_lpcd,0)  from rws_district_tbl d,rws_mandal_tbl m,rws_panchayat_tbl p,rws_village_tbl v,rws_complete_hab_view h,"
								+ habTableName
								+ " hd where d.dcode=m.dcode and m.dcode=p.dcode and m.mcode =p.mcode and p.dcode=v.dcode and p.mcode=v.mcode and p.pcode=v.pcode and substr (h.panch_code,1,2) = v.dcode and substr(h.panch_code,6,2) = v.mcode and substr(h.panch_code,13,2) = v.pcode and substr (h.panch_code,8,3) = v.vcode and h.panch_code=hd.hab_code and hd.ACT_COVERAGE_STATUS is not null and hd.ACT_COVERAGE_STATUS not in('UI','NW')  and d.dcode='"
								+ rDistrict
								+ "'  and m.mcode='"
