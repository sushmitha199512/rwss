...
//		   //System.out.println("value of c is  "+c);
	...
	ch.addTitle("Borewell Status Graph Report", "times new roman Bold Italic",12);
...
String ss[]=new String[c];
  ...
  for(j=0;j<c;j++){
	...
	if(x.equals("b"))
   {
	...
	ch.addTitle("Borewell Status", "Arial Bold", 10);
...
if(x.equals("p"))
 {
    ...
    ch.addTitle2(Chart.Top, "Borewell Status", "Times New Roman Bold Italic",13);
	ch.set3D();
...
%>
    ...
    if(x.equals("d"))
 {
	...
	ch.addTitle("Borewell Status", "times new roman Bold Italic",12);
	 ch.yAxis().setTitle("No. of Habitations");
	 ch.xAxis().setTitle("Coverage Status");
