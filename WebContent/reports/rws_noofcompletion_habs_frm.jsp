...
document.f1.distname.value = document.f1.combo.options[document.f1.combo.options.selectedIndex].text;
			...
			else
		{
			...
			document.f1.action="./rws_noofcompletion_habs_rpt.jsp";
...
<%} %>
	...
	<tr bgcolor="#8A9FCD" align="center">
		<td align="center" class="rptHeading" colspan=4>STATUS WISE COVERAGE OF HABITATIONS DURING THE CURRENT FINANCIAL YEAR -(2013-14)-(as per works monitoring) </td>
	</tr>
