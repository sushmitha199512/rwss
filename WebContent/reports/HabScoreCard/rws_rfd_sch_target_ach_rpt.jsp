...
function changeLanguage(){
	...
	var url="switch.do?prefix=/reports&page=/rwssHabScoreCard.do?mode=SCH";
...
<td height="20"></td>
   ...
   <td align="right" class="bwborder" colspan="2">
                    <a href="./public_domain/rws_rfd_sch_target_ach_excel.jsp" target="_new"><bean:message key="app.excel" /></a>|<a href="switch.do?prefix=/reports&page=/rwssHabScoreCard.do?mode=home" ><bean:message key="app.back" /></a></td></tr>       
...
<!-- Grid Table Starts -->                                      
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            ...
                                            <td colspan="5" align="right"><html:select  style="width:100px" property="language" onchange="changeLanguage()">
                                            <html:option value="English">English</html:option>
<html:option value="Telugu">Telugu</html:option></html:select></td></tr>
                                   <tr >
		<td align="center" class="gridhdbg" colspan=12><font color="white"><bean:message key="app.schoolsheading" /> (<%=cYear %>-<%=nYear %>)</font></td>	
	</tr>
		<tr >
...
int count=1;
  try{
	  ...
	  String selectedPrograms="'01','02','18','23','32','48','49','51','53','58','59','60','04','57','65','46'";
	  ...
	  String distQuery="select d.dcode,d.dname,t.SCH_HABS  from rws_district_tbl d , rws_work_sch_target_tbl t where t.dcode=d.dcode and FIN_YEAR='2013-2014'";
...
String deleteQuery="delete from rws_svs_graph_view_tbl WHERE TYPE='SCH'";
	  
	  sst.executeUpdate(deleteQuery);
	  
	  String deleteQuery2="delete from rws_rfd_cs_rpt_tmp_tbl WHERE RPT_TYPE='SCH'";
	  ...
	  while(rs3.next()){
		 ...
		 String insertQuery="insert into rws_svs_graph_view_tbl values ('"+rs3.getString(1)+"','"+rs3.getString(2)+"','"+habper+"','','SCH')";
		  sst1.addBatch(insertQuery);
		  insertQuery="insert into rws_rfd_cs_rpt_tmp_tbl (dcode,dname,TARGET_HABS,HAB_ACH,HAB_ACH_PER,RPT_TYPE )values ('"+rs3.getString(1)+"','"+rs3.getString(2)+"','"+targetHabs+"','"+coveredhabs+"','"+habper+"','SCH')";
		  sst1.addBatch(insertQuery);
	  ...
	  int res[]=sst1.executeBatch();
		 ...
		 String q1="select *from rws_rfd_cs_rpt_tmp_tbl where rpt_type='SCH' order by HAB_ACH_PER desc ";
	  ...
	  %>
	  <tr><td class="gridhdbg" style="text-align: right;"  colspan="2"><bean:message key="app.total" /> </td><td class="gridhdbg" style="text-align: right;"><%=(int)svsT %></td><td style="text-align: right;" class="gridhdbg" ><%=(int)svsH %></td>
 ...
 %>
				    ...
				    <bean:message key="app.graph" /><a href="<rws:context page='/public_domain/rws_rfd_sch_target_ach_graph.jsp' />" target="_new"><img src="<rws:context page='/images/chart.png' />"  width="40" height="40"/></a></td>
				</tr>
</table>
