...
function changeLanguage(){
	...
	var url="switch.do?prefix=/reports&page=/rwssHabScoreCard.do?mode=MVS";
...
<tr>
<td height="20"></td>
<tr><td align="right" class="bwborder" colspan="2"><a href="./public_domain/rws_rfd_mvs_target_ach_excel.jsp" target="_new"><bean:message key="app.excel" /></a>|<a href="switch.do?prefix=/reports&page=/rwssHabScoreCard.do?mode=home"><bean:message key="app.back" /></a></td></tr>   
...
<html:option value="Telugu">Telugu</html:option></html:select></td></tr>
                                   <tr >
<tr bgcolor="#8A9FCD" ">
		<td align="center" class="gridhdbg" colspan=11><font color="white"><b><bean:message key="app.mvsmainheading" /> <%=cYear %>-<%=nYear %></b></font></td>	
	</tr>
		<tr >
...
String colorValueHab="",colorValueExp="";
	  ...
	  %>
	  <tr><td  style="text-align: right;"  class="gridhdbg" colspan="2"><bean:message key="app.total" /> </td><td style="text-align: left;"  class="gridhdbg"  ><%=(int)svsT %></td><td class="gridhdbg" style="text-align: right;"><%=ndf.format(expT) %></td><td class="gridhdbg"  style="text-align: left;"><%=(int)svsH %></td><td class="gridhdbg" style="text-align: right;" ><%=ndf.format(expUpto) %></td><td class="gridhdbg" style="text-align: right;" ><%=ndf.format(expCurrent) %></td><td class="gridhdbg" style="text-align: right;" > <%=ndf.format(expTot) %></td>
 ...
 %>
				   ...
				   <bean:message key="app.graph" /><a href="<rws:context page='/public_domain/rws_rfd_mvs_target_ach_graph.jsp' />" target="_new"><img src="<rws:context page='/images/chart.png' />"  width="40" height="40"/></a></td>
				</tr>
</table>
