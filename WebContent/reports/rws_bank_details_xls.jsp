...
<td align="center" class="rptHeading" colspan=12 >Bills Vs Releases  Vs  Vouchers </td>	
</tr>
<tr><td class=btext>Sl.No</td>
<td class=btext>Work Id</td>
<td class=btext>Work Name</td>
<td class=btext>Program/Sub Program</td>
...
if(vamt!=null  && !vamt.equals("")  && !vamt.equals("null")) {
 ...
 <td class=rptvalue align="center" colspan="3"><%=css%></td>
  ...
  <td class=rptvalue  style=width:300px><%=css%><%=rs.getString("programme_name")%>/<%=rs.getString("subprogramme_name")%>
  </td>
