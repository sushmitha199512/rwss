...
<caption>
	<table  border=0 rules=none style="border-collapse:collapse" align = "right">
		<tr align="right">
			<td class="bwborder">
				<a href="./rws_wq_contamination_graph_frm.jsp">Back |</a>
	...
	<tr bgcolor="lavander">
		<td class="textborder" align="center" colspan="7">
			<font color="ffffff">Parameter Wise Contaminated Habitations Graph </font></td>
	</tr>
...
try
	...
	if(district.equals("51")){
		...
		%>	<%@ include file="./rws_wq_contamination_tot_rpt.jsp" %>
	 ...
	 <%@ include file = "rws_wq_contamination_graph.jsp"%>	
	<%
	}
	catch(Exception ee)
	{
