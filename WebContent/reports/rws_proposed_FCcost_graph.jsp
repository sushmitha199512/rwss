...
<%   
   ...
   /* rs.beforeFirst();
    ...
    dist[0]="     0-1 lacs  ";	    data[0]=rs.getInt(1);
	dist[1]="     1-10 lacs ";	data[1]=rs1.getInt(1);
	dist[2]="     10-20 lacs ";	data[2]=rs2.getInt(1);
	//System.out.println("rs2 is:"+rs2.getInt(1));
...
//System.out.println("value of p is  "+p);
	...
	ch.addTitle("Proposed FC Cost Graph Report", "times new roman Bold Italic",12);
...
String ss[]=new String[c];
  ...
  for(j=0;j<c;j++){
	...
	if(x.equals("b"))
   {
	...
	ch.addTitle("Proposed FC Cost", "Arial Bold", 10);
	//ch.setPlotArea(40, 40, 200, 150);
	ch.yAxis().setTitle("No. of Habitations");
	ch.xAxis().setTitle("Proposed Cost Status");
...
if(x.equals("p"))
 {
    ...
    ch.addTitle2(Chart.Top, "Proposed FC Cost", "Times New Roman Bold Italic",13);
	ch.set3D();
...
%>
    ...
    if(x.equals("d"))
 {
	...
	ch.addTitle("Proposed FC Cost", "times new roman Bold Italic",12);
	 ch.yAxis().setTitle("No. of Habitations");
	 ch.xAxis().setTitle("Proposed Cost Status");
