		...
		<caption>
			<table  border=0 rules=none style="border-collapse:collapse" align = "right">		
				<tr>
					...
					<a href="./rws_onlyschemes_distwise_xls.jsp" target=_new>Excel</a>
					</td>
				</tr>
			</table>
		</caption>
	...
	%>
     ...
     <%
      /* String qry19 = "select distinct substr(a.hab_code,1,2),sum(nvl(CENSUS_PLAIN_POPU,'0')+nvl(CENSUS_SC_POPU,'0')+nvl(CENSUS_ST_POPU,'0')) from rws_asset_hab_tbl a,rws_asset_mast_tbl b ,rws_habitation_directory_tbl c where b.type_of_asset_code in ('01','02','03','09') and a.asset_code=b.asset_code and a.hab_code=c.hab_code group by substr(a.hab_Code,1,2)";
	   ...
	   System.out.println("Asset Queryyyyyyyyyy14"+qry14);
      // Hashtable allhabs=new Hashtable();
	   while(rs14.next())
       {
          allhabs.put(rs14.getString(1),rs14.getString(2));    
    	   ...
    	   System.out.println("Exception at qry14"+ex);
       }
 		try{
	   ...
	   System.out.println("Asset Queryyyyyyyyyy13"+qry13);
     //  Hashtable dphabs=new Hashtable();
	   while(rs13.next())
       {
          dphabs.put(rs13.getString(1),rs13.getString(2));    
     	   ...
     	   System.out.println("Exception at qry13"+ex);
        }
  		try{
	   ...
	   System.out.println("Asset Queryyyyyyyyyyqry12"+qry12);
      // Hashtable mpwshabs=new Hashtable();
	   while(rs12.next())
       {
          mpwshabs.put(rs12.getString(1),rs12.getString(2));    
     	   ...
     	   System.out.println("Exception at qry12"+ex);
        }
  		try{
	   ...
	   System.out.println("Asset Queryyyyyyyyyy11"+qry11);
      // Hashtable pwshabs=new Hashtable();
	   while(rs11.next())
       {
          pwshabs.put(rs11.getString(1),rs11.getString(2));    
     	   ...
     	   System.out.println("Exception at qry11"+ex);
        }
  		try{
	   ...
	   System.out.println("Asset Queryyyyyyyyyy10"+qry10);
      // Hashtable cpwshabs=new Hashtable();
	   while(rs10.next())
       {
          cpwshabs.put(rs10.getString(1),rs10.getString(2));    
     	   ...
     	   System.out.println("Exception at qry10"+ex);
        }
  		try{
	   ...
	   System.out.println("Asset Queryyyyyyyyyy9"+qry9);
      // Hashtable lastcol=new Hashtable();
	   while(rs9.next())
       {
          lastcol.put(rs9.getString(1),rs9.getString(2));    
     	   ...
     	   System.out.println("Exception at qry9"+ex);
        }
  		try{
	   ...
	   System.out.println("Asset Queryyyyyyyyyy8"+qry8);
      // Hashtable ongoing=new Hashtable();
	   while(rs8.next())
       {
          ongoing.put(rs8.getString(1),rs8.getString(2));    
     	   ...
     	   System.out.println("Exception at qry8"+ex);
        }
  		try{
	  ...
	  System.out.println("Asset Queryyyyyyyyyy7"+qry7);
      //Hashtable all=new Hashtable();
	  while(rs7.next())
       {
          all.put(rs7.getString(1),rs7.getString(2));    
     	   ...
     	   System.out.println("Exception at qry7"+ex);
        }
  		try{
	  ...
	  System.out.println("Asset Queryyyyyyyyyy6"+qry6);
    //  Hashtable dp=new Hashtable();
	  while(rs6.next())
       {
          dp.put(rs6.getString(1),rs6.getString(2));    
     	   ...
     	   System.out.println("Exception at qry6"+ex);
        }
  		try{
	  ...
	  System.out.println("Asset Queryyyyyyyyyy5"+qry5);
     // Hashtable mpws=new Hashtable();
	  while(rs5.next())
       {
          mpws.put(rs5.getString(1),rs5.getString(2));    
     	   ...
     	   System.out.println("Exception at qry5"+ex);
        }
  		try{
	  ...
	  System.out.println("Asset Queryyyyyyyyyy4"+qry4);
    //  Hashtable pws=new Hashtable();
	  while(rs4.next())
       {
          pws.put(rs4.getString(1),rs4.getString(2));    
     	   ...
     	   System.out.println("Exception at qry4"+ex);
        }
  		try{
	  ...
	  System.out.println("Asset Queryyyyyyyyyy3"+qry3);
     // Hashtable cpws=new Hashtable();
	  while(rs3.next())
       {
          cpws.put(rs3.getString(1),rs3.getString(2));    
     	   ...
     	   System.out.println("Exception at qry3"+ex);
        }
	   ...
	   System.out.println("Asset Queryyyyyyyyyy1"+qry1);
	   while(rs1.next())
       {
	      ...
	      System.out.println("Asset Queryyyyyyyyyy2"+qry2);
	      while(rs2.next())
            {
                hcount++;
...
///////////dppop/////////////////////
     ...
     %>
        <tr align="center">
			...
			<td class=rptValue align=right><a href="./rws_onlyschemes_drill_rpt.jsp?dcode=<%=rs1.getString(1)%>&dname=<%=rs1.getString(2)%>"><%=Integer.parseInt(lastcount) %></a></td>
 		</tr>
   <%
