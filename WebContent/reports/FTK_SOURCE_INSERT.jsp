...
query = "insert into wq_FTKTestingdetails(TestId,DDWS_TEST_ID,ParameterId)values('"+FTK_ID+"','"+ddws_id+"','"+parameterId+"')";
...
if(mnth>3){
 ...
 System.out.println("Ddws_id:"+ddws_id);
	...
	query = "insert into wq_waterQualityTesting(TestId,DDWS_TEST_ID,TestingDate,ContaminatedYes_No,HabitationId,StateID,DistrictId,SchemeNo,GPId_testingDone,FinYear,Old_Ftk_Id)values('"
							...
							+ contaminated
							+ "','"
							+ rsqq.getString("HabitationId")
							+ "','"
							+ rsqq.getString("StateID")
							+ "','"
							+ rsqq.getString("DistrictId")
							+ "','"

							+ rsqq.getString(WORK_ID)
							+ "','"
							+ rsqq.getString("Panchayatid")
							+ "','"
							+ finYear
							+ "','"+OLD_FTK_ID+"')";
