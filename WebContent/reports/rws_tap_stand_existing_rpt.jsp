...
District:</td><td class="rptvalue"><%=dname%></td>
	...
	<td ><a href="javascript:onclick=history.go(-1)">Back | &nbsp; </td>
	  <td><a href="./rws_tap_stand_existing_xls.jsp">Excel</a></td>  
	</tr>  
	</table>
	</caption>
	<tr >
...
<td  class="<%=style%> "style="text-align: right;"><a href="#" onclick="viewWorks('rws_tap_stand_existing_drill.jsp?drill=yes&dcode=<%=dcode %>&mcode=<%=rs8.getString(3)%>&pcode=<%=rs8.getString(4)%>')"> <%=rs8.getInt(6)%></td>
