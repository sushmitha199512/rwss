...
function goSearch(last,dist,rmandal,assetcode)
{
	...
	{
		var url = "WsPagerPond.jsp?pager.offset="+document.forms[0].go.value+"&district="+dist+"&mandal="+rmandal+"&asset="+assetcode;
...
<caption>
 ...
 <tr bgcolor="#8A9FCD" align="center">
		 <td align="center" class="rptHeading" colspan=7><font color="white">Asset Check List Report - Ponds</font></td>	
   </tr>
    <tr bgcolor="#8A9FCD" align="center">
   ...
   <td align="center" class="rptHeading"><b>OPEN WELL</b></td>
	</tr>
	<%
...
//		////System.out.println("aa:"+aa);
       ...
       <%if(!aaa[0].equals("--")){%>
		...
		<td><font size=1 face="verdana">OPEN WELL</font></td>
...
<%}%>
 ...
 <%
if(totCount!=0){
String firstpgurl = "WsPagerPond.jsp?pager.offset=0&district="+rDist+"&mandal="+rMandal+"&asset="+assetcode+"";
String prevpgurl = "WsPagerPond.jsp?pager.offset="+prevpgno+"&district="+rDist+"&mandal="+rMandal+"&asset="+assetcode;
String nextpgurl = "WsPagerPond.jsp?pager.offset="+nextpgno+"&district="+rDist+"&mandal="+rMandal+"&asset="+assetcode;
String lastpgurl = "WsPagerPond.jsp?pager.offset="+totalpgno+"&district="+rDist+"&mandal="+rMandal+"&asset="+assetcode;
...
if(i<=totalpgno)
	{
	String currenturl = "WsPagerPond.jsp?pager.offset="+i+"&district="+rDist+"&mandal="+rMandal+"&asset="+assetcode;
	if(currentpageno==i){%>
...
<%}
	...
	{
		%>
		<%String currenturl = "WsPagerPond.jsp?pager.offset="+j+"&district="+rDist+"&mandal="+rMandal+"&asset="+assetcode;
		if(currentpageno==j){%>
