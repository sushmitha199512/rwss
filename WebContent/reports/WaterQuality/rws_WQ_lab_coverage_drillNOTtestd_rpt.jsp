...
String yr1=(String)session.getAttribute("yr2"); */
...
//before querry
query="select distinct dname,mname,pname,vname,panch_name,panch_code from rws_complete_hab_view c where NOT EXISTS (select substr(b.source_code,1,16) from rws_wq_test_results_tbl b where substr(b.source_code,1,16)=c.panch_code and  to_date(prepared_on)>='1-APR-"+yr+"' and  to_date(prepared_on)<='31-MAR-"+endyear+"') and C.COVERAGE_STATUS<>'UI' and C.COVERAGE_STATUS is not null and dcode='"+dcode+"'  order by dname";
