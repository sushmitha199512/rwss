...
<caption>
	<table  border=0 rules=none style="border-collapse:collapse" align = "right">
		<tr align="right">
			<td class="bwborder"><a href="#" onclick="javascript:history.go(-1)">Back</a>|<a href="../home.jsp">Home</a>|<a href="./rws_billvoucher_division_xls.jsp?district=<%=dist%>&division=<%=div%>&frmDate=<%=frmDate%>&dname=<%=dname%>&divname=<%=divname%>&toDate=<%=toDate%>&bill=<%=billType%>" target=_new>Excel</a>
...
<tr><td class=btext>Division Wise Bill-Voucher Details Report</td></tr>
...
<%}catch(Exception e){
	System.out.println("Exception in Bill Voucher Report:"+e);
}finally{
	if(rs!=null)rs.close();
