...
<% 
if(loggedUser!=null && (loggedUser.equals(Constants.ADMIN)||loggedUser.equals(Constants.LAKH_USER) ||loggedUser.equals(Constants.DROUGHT_USER)||loggedUser.equals(Constants.GUEST)))
{ %>
 ...
 try
{
    ...
    while(rs2.next())
	 {
      ...
      // System.out.println(".........."); 
       ...
       qry5="select distinct count(*) from rws_panchayat_raj_tbl b,rws_habitation_directory_tbl c where c.coverage_status<>'UI' and c.coverage_status is not null  and  c.hab_code=b.panch_code and  substr(c.hab_code,1,2)='"+dcode+"' and substr(c.hab_code,6,2)='"+rs4.getString(1)+"' and substr(c.hab_code,13,2)='"+rs2.getString(1)+"'";
       ...
       // System.out.println(". pan.."+rs2.getString(2));  
       // System.out.println("my hab count............."+mycnt); 
  ...
  %>   
        <tr>
        <td></td>
          <td class=rptValue nowrap colspan=8 align=left bgcolor=green ><font color="white"><b> Panchayat-<%=rs2.getString(2)%>&nbsp;&nbsp;Fully Covered</b></td>
        </tr>
<%
        }
    }
    else 
     {
       %>
        <tr>
         <td></td>
           <td class=rptValue nowrap colspan=8 align=left bgcolor=orange ><b><font color="white"><b> Panchayat-<%=rs2.getString(2)%>&nbsp;&nbsp;Not Fully Covered</b></td>
        </tr>
    <%
