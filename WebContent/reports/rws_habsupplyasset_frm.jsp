	...
	function fnSubmit()
	{
		var loggedUser = '<%=loggedUser%>';
			...
			else
			{
				...
				document.f1.action="./rws_habsupplyasset_rpt.jsp";
				document.f1.submit();
			}	
		}
		</script>
...
<table border = 1 align = center cellspacing = 0 cellpadding = 0 rules = "rows" bordercolor = navy style = "border-collapse:collapse" bgcolor="#ffffff" width=350>		
	...
	<tr bgcolor="#8A9FCD" align="center">
		<td align="center" class="rptHeading" colspan=3>Schemes Gap Report (Difference in Assets and Water Supply data)</td>	
	</tr>
	<%
try
{
...
%>
	...
	%></tr>
<tr>
		    <td class=rptLabel>UI/No UI (Habitations)<td class=btext>
  
 			<select name="type" id="ctype" styleClass="mycombo" style="width:220px" >
			 
            
            <option value="1"><font class="myfontclr1">No UI  </option>
            <option value="2"><font class="myfontclr1">UI  </option>
