...
<table border = 1 align = center cellspacing = 0 cellpadding = 0 rules = "rows" bordercolor = navy style = "border-collapse:collapse" bgcolor="#ffffff" width=350>		
	...
	<tr bgcolor="#8A9FCD" align="center">
		<td align="center" class="rptHeading" colspan=3>Abstract of Daily Report on Drinking Water Situation ( Drought ) - Report</td>	
	</tr>
<tr>
<td>
...
<table border=0 width="423" align=center style="margin-bottom:5;margin-top:5">
 <tr>
 <tr align=center>
<td align="center" class=rptvalue>From Date:&nbsp;<font color="red">*</font><input type="text" name="fromDate"  maxlength=15   style="width:80px">
...
<p align=center>
Note:-
1. For All Districts Selection->From Date Selection is mandatory.<br>
2.For District Wise Selection - District -> From Date and To Date Selection are mandatory
</p>
