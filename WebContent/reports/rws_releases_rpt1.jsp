...
<tr><td  class=rptHeading>Releases in the District:&nbsp;<%=dname%> and Division:&nbsp;<%=divname%> and Program:&nbsp;<%=pname%></td></tr></table><BR>
