...
<caption>
	<table  border=0 rules=none style="border-collapse:collapse" width=80% height=20%  >
		<tr align="right">
			<td class="bwborder">
			   <a href="../home.jsp">Home|</a>
				<a href="./rws_habPop_xls.jsp" target="_new">Excel</a>
...
<table border = 1 cellspacing = 0 cellpadding = 0 width=100%  bordercolor=#000000 style="border-collapse:collapse" bgcolor="#ffffff">	
	<tr  align="center">
		<td align="center" class="btext" colspan=28>District: All</td>		
	</tr>	
