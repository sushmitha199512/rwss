...
<td class="bwborder"></td>
	...
	<tr bgcolor="#8A9FCD" align="center">
		<td align="center" class="gridhdbg" colspan='14'>Drought Habitations Category Wise Report</td>
...
try
{
  ...
  while (rs1.next())
	 ...
	 //System.out.println(catAAchievement);
	  ...
	  rs.close();
		...
		%>
				...
				<td class=gridbg2 ><a href="rws_drought_hab_category_rpt.jsp?mode=mandals&dcode=<%=rs1.getString("dcode")%>&dname=<%=rs1.getString("dname")%>&statusDate=<%=statusDate%>"><%=rs1.getString("dname")%></a></td>
				...
				<td class=gridbgAbove75 align="right"><a href="#" onclick="viewWorks('rws_drought_category_habs_drill_rpt.jsp?mode=districts&mode1=TR&dcode=<%=rs1.getString("dcode")%>&dname=<%=rs1.getString("dname")%>&statusDate=<%=statusDate%>')"><%=catAAchHabs%></a></td>
	...
	<td class="gridhdbg" style="text-align: right; background-color: yellow;"><a href="#" onclick="viewWorks('rws_drought_category_habs_drill_rpt.jsp?mode=districts&mode1=ALLTR&dname=ALL&statusDate=<%=statusDate%>')"><%=catAAchHabsTot %></a></td>
...
%>
	...
	<tr bgcolor="#8A9FCD" align="center">
		<td align="center" class="gridhdbg" colspan='5'>Drought Habitations A-B-C Category Wise Report for District: <%=request.getParameter("dname") %></td>
...
while (rs1.next())
{
  ...
  rs.close();
	%>
			<tr >
			<td class=gridbg2 align="center"><%=sno++%></td>
			<td class=gridbg2 > <a href="rws_drought_hab_category_rpt.jsp?mode=panchayats&dcode=<%=dcode%>&dname=<%=dname%>&mcode=<%=rs1.getString("mcode")%>&mname=<%=rs1.getString("mname")%>&statusDate=<%=statusDate%>"> <%=rs1.getString("mname")%> </a> </td>
			<td class=gridbgAbove75 align="right"><%=catAPan%></td>
			...
			<td class=gridbgAbove75 align="right"><%=catAPop%></td>
			<td class=gridbgAbove75 align="right"><a href="#" onclick="viewWorks('rws_drought_category_habs_drill_rpt.jsp?mode=mandals&mode1=TR&dcode=<%=dcode%>&dname=<%=dname%>&mcode=<%=rs1.getString("mcode")%>&mname=<%=rs1.getString("mname")%>&statusDate=<%=statusDate%>')"><%=catAAchHabs%></a></td>
			<td class=gridbgAbove75 align="right"></td>
			<td class=gridbgAbove75 align="right"><%=ndf.format(catAAchQty)%></td>
			<td class=gridbgAbove75 align="right"><%=catAAchTrips%></td>
			<td class=gridbg25_50 align="right"><%=catBPan%></td>
...
<%}else if(mode.equals("panchayats")){ 
	...
	%>
		...
		<tr bgcolor="#8A9FCD" align="center">
			<td align="center" class="gridhdbg" colspan='5'>Drought Habitations Category Wise Report for District: <%=request.getParameter("dname") %> and Mandal: <%=request.getParameter("mname") %></td>
	...
	int catAAchHabs=0,catAAchTrips=0;Double catAAchQty=0.0;
	int catAAchHabsTot=0,catAAchTripsTot=0;Double catAAchQtyTot=0.0;
	try
	{
	//String dcode=request.getParameter("dcode");
	...
	while (rs1.next())
	{
	  ...
	  rs.close();
		%>
				<tr >
				<td class=gridbg2 align="center"><%=sno++%></td>
				<td class=gridbg2 > <a href="rws_drought_hab_category_rpt.jsp?mode=villages&dcode=<%=dcode%>&dname=<%=dname%>&mcode=<%=mcode%>&mname=<%=mname%>&pcode=<%=rs1.getString("pcode")%>&pname=<%=rs1.getString("pname")%>&statusDate=<%=statusDate%>"> <%=rs1.getString("pname")%></a> </td>
				...
				<td class=gridbgAbove75 align="right"><%=catAPop%></td>
				<td class=gridbgAbove75 align="right"><a href="#" onclick="viewWorks('rws_drought_category_habs_drill_rpt.jsp?mode=panchayats&mode1=TR&dcode=<%=dcode%>&dname=<%=dname%>&mcode=<%=mcode%>&mname=<%=mname%>&pcode=<%=rs1.getString("pcode")%>&pname=<%=rs1.getString("pname")%>&statusDate=<%=statusDate%>')"><%=catAAchHabs %></a></td>
				<td class=gridbgAbove75 align="right"></td>
				<td class=gridbgAbove75 align="right"><%=ndf.format(catAAchQty) %></td>
				<td class=gridbgAbove75 align="right"><%=catAAchTrips %></td>
	...
	<%}else if(mode.equals("villages")){ 
		...
		%>
			...
			<tr bgcolor="#8A9FCD" align="center">
				<td align="center" class="gridhdbg" colspan='5'>Drought Habitations Category Wise Report for District: <%=request.getParameter("dname") %> and Mandal: <%=request.getParameter("mname") %> and Panchayat: <%=request.getParameter("pname") %></td>
		...
		while (rs1.next())
		{
		  ...
		  rs.close();
			%>
					...
					<td class=gridbgAbove75 align="right"><%=catAPop%></td>
					<td class=gridbgAbove75 align="right"><a href="#" onclick="viewWorks('rws_drought_category_habs_drill_rpt.jsp?mode=villages&mode1=TR&dcode=<%=dcode%>&dname=<%=dname%>&mcode=<%=mcode%>&mname=<%=mname%>&pcode=<%=pcode%>&pname=<%=pname%>&vcode=<%=rs1.getString("vcode")%>&vname=<%=rs1.getString("vname")%>&statusDate=<%=statusDate%>')"><%=catAAchHabs %></a></td>
					<td class=gridbgAbove75 align="right"></td>
					<td class=gridbgAbove75 align="right"><%=ndf.format(catAAchQty) %></td>
					<td class=gridbgAbove75 align="right"><%=catAAchTrips %></td>
