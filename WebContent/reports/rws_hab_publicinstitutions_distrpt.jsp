 ...
 <logic:present name="PublicInstitutions">
                <TABLE border="1" cellspacing="0" cellpadding="0" width="100%"
					...
					<THEAD align="left" bgcolor="#8A9FCD" class="textborder">
 					...
 					<logic:iterate id="instittutions" name="PublicInstitutions"  
						scope="request">
						<%count++; %>
							<TR>
							    <td class="mystyle1"><%=count %></td>
							    <td class="mystyle1"><a href="PublicInst.do?mode=view&dcode=<%=((rws_hab_publicins_bean)instittutions).getDisCode()%>">
							    <bean:write name="instittutions" property="disName"/></a></td>
...
<logic:present name="PublicInstitutionsMan">
					...
					<%  count=0; %>
                      ...
                      <logic:iterate id="instittutions" name="PublicInstitutionsMan"  
						scope="request">
						<%count++; %>
							<TR>
							    <td class="mystyle1"><%=count %></td>
...
<logic:present name="PublicInstitutionsPan">
					...
					<%  count=0; %>
                      ...
                      <logic:iterate id="instittutions" name="PublicInstitutionsPan"  
						scope="request">
						<%count++; %>
							<TR>
							    <td class="mystyle1"><%=count %></td>
...
<logic:present name="PublicInstitutionsVil">
					...
					<%  count=0; %>
                      ...
                      <logic:iterate id="instittutions" name="PublicInstitutionsVil"  
						scope="request">
						<%count++; %>
							<TR>
							    <td class="mystyle1"><%=count %></td>
...
<logic:present name="PublicInstitutionsHab">
					...
					<%  count=0; %>
                      ...
                      <logic:iterate id="instittutions" name="PublicInstitutionsHab"  
						scope="request">
						<%count++; %>
							<TR>
							    <td class="mystyle1"><%=count %></td>
