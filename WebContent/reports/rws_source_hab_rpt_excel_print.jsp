...
<p align="center" class="mystyle1"><font color="black">Source Type Name: <%=session.getAttribute("dName") %>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</font>
</P>	
<% if(session.getAttribute("mName")!=null){%>
<P align="center" class="mystyle1"><font color="black">Sub Source Type Name: <%=session.getAttribute("mName") %>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</font>
<%}%>
</p>
<table border = 1 cellspacing = 0 cellpadding = 0 width=100%  bordercolor=#000000 style="border-collapse:collapse" bgcolor="#ffffff">	

	<tr >
		<td class = TEST1>S.No</td>
		
		
		<%		int i=0;
				for(j=0; j<labelNames.length;j++ ) {			
			%>
		<td class = TEST1><%= labelNames[j] %></td>
	<%
			} %>
	</tr>	
<%	
