...
<script language="JavaScript">
	...
	function show(){
	   if(document.f1.habresult.value=="schoolmast" ){
					...
					<tr align="center">
						...
						<td class="textborder" width="150">
							<select name="habresult" styleClass="mycombo" style="width:200px" onchange="show()"  >
						        ...
						        <option value="schoolmast" class="myfontclr1">School Master Table </option>			        
						        <option value="schoolcategory" class="myfontclr1">School Category Table </option>
							</select>
						</td>		
					</tr>
				</table>
