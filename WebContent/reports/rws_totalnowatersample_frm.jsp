	...
	function fnSubmit()
	{
		var loggedUser = '<%=loggedUser%>';
			...
			else
			{
				...
				document.f1.action="./rws_totalnowaterquality_rpt.jsp";
				document.f1.submit();
			}	
		}
		</script>
...
<table border = 1 align = center cellspacing = 0 cellpadding = 0 rules = "rows" bordercolor = navy style = "border-collapse:collapse" bgcolor="#ffffff" width=350>		
	...
	<tr bgcolor="#8A9FCD" align="center">
		<td align="center" class="rptHeading" colspan=3>Water Quality FTK - Report</td>	
	</tr>
	<%
try
{
...
%>
	...
	<tr><td class=rptLabel>From Date&nbsp;<font color="red">*</font></td>
		<td class=btext><input name="x" id="demo1" type="text" size="10" >
...
<td class=rptLabel>To Date&nbsp;<font color="red">*</font></td>
		<td class=btext><input name="y" id="demo2" type="text" size="10">
