<%
if((rDivision != null) && (!rDivision.equals("0")) && (rCircle != null) && (!rCircle.equals("0")) && (rAssetType != null) && (!rAssetType.equals("0")) && (rAssetType.equals("01")) && (rSubDivision.equals("0")) && (rMandal.equals("0")))
{
	//System.out.println("ASSET TYPE & CIRCLE & DIVISION SELECTED...");
...
try
{
	...
	query = " SELECT COUNT(*) FROM RWS_PWS_SUBCOMP_PARAM_TBL A, RWS_ASSET_MAST_TBL B, RWS_ASSET_SCHEME_TBL C WHERE B.CIRCLE_OFFICE_CODE = '" +rCircle+ "' AND B.DIVISION_OFFICE_CODE = '" +rDivision+ "' AND SUBSTR(A.PUMP_CODE,1,16) = B.HAB_CODE AND B.TYPE_OF_ASSET_CODE = '01' AND SUBSTR(A.PUMP_CODE,17,3) LIKE '%6%' AND A.ASSET_CODE = C.ASSET_CODE " ;
	rs = stmt.executeQuery(query);
	rs.next();

	query1 = " SELECT COUNT(*) FROM RWS_PWS_DISTRI_SC_PARAM_TBL A, RWS_ASSET_MAST_TBL B, RWS_ASSET_SCHEME_TBL C WHERE B.CIRCLE_OFFICE_CODE = '" +rCircle+ "' AND B.DIVISION_OFFICE_CODE = '" +rDivision+ "' AND SUBSTR(A.DISTRISC_CODE,1,16) = B.HAB_CODE AND B.TYPE_OF_ASSET_CODE = '" +rAssetType+ "' AND SUBSTR(A.DISTRISC_CODE,17,3) LIKE '%6%' AND A.ASSET_CODE = C.ASSET_CODE ";	
	rs1 = stmt1.executeQuery(query1);
	rs1.next();

	query2 = " SELECT COUNT(*) FROM RWS_PWS_OHSR_SC_PARAM_TBL A, RWS_ASSET_MAST_TBL B, RWS_ASSET_SCHEME_TBL C WHERE B.CIRCLE_OFFICE_CODE = '" +rCircle+ "' AND B.DIVISION_OFFICE_CODE = '" +rDivision+ "' AND SUBSTR(A.OHSR_CODE,1,16) = B.HAB_CODE AND B.TYPE_OF_ASSET_CODE = '" +rAssetType+ "' AND SUBSTR(A.OHSR_CODE,17,3) LIKE '%6%' AND A.ASSET_CODE = C.ASSET_CODE ";
	rs2 = stmt2.executeQuery(query2);
	rs2.next();

	query3 = " SELECT COUNT(*) FROM RWS_PWS_SP_HC_PC_SC_PARAM_TBL A, RWS_ASSET_MAST_TBL B, RWS_ASSET_SCHEME_TBL C WHERE B.CIRCLE_OFFICE_CODE = '" +rCircle+ "' AND B.DIVISION_OFFICE_CODE = '" +rDivision+ "' AND SUBSTR(A.SPHCPCSC_CODE,1,16) = B.HAB_CODE AND B.TYPE_OF_ASSET_CODE = '" +rAssetType+ "' AND SUBSTR(A.SPHCPCSC_CODE,17,3) LIKE '%6%' AND A.ASSET_CODE = C.ASSET_CODE ";
	rs3 = stmt3.executeQuery(query3);
	rs3.next();

	query4 = " SELECT COUNT(*) FROM RWS_PWS_CIS_SC_PARAM_TBL A, RWS_ASSET_MAST_TBL B, RWS_ASSET_SCHEME_TBL C WHERE B.CIRCLE_OFFICE_CODE = '" +rCircle+ "' AND B.DIVISION_OFFICE_CODE = '" +rDivision+ "' AND SUBSTR(A.CISSC_CODE,1,16) = B.HAB_CODE AND B.TYPE_OF_ASSET_CODE = '" +rAssetType+ "' AND SUBSTR(A.CISSC_CODE,17,3) LIKE '%6%' AND A.ASSET_CODE = C.ASSET_CODE ";	
	rs4 = stmt4.executeQuery(query4);
	rs4.next();

	query5 = " SELECT COUNT(*) FROM RWS_PWS_CP_SC_PARAM_TBL A, RWS_ASSET_MAST_TBL B, RWS_ASSET_SCHEME_TBL C WHERE B.CIRCLE_OFFICE_CODE = '" +rCircle+ "' AND B.DIVISION_OFFICE_CODE = '" +rDivision+ "' AND SUBSTR(A.CPSC_CODE,1,16) = B.HAB_CODE AND B.TYPE_OF_ASSET_CODE = '" +rAssetType+ "' AND SUBSTR(A.CPSC_CODE,17,3) LIKE '%6%' AND A.ASSET_CODE = C.ASSET_CODE ";
	rs5 = stmt5.executeQuery(query5);
	rs5.next();

	query6 = " SELECT COUNT(*) FROM RWS_PWS_GLSR_SC_PARAM_TBL A, RWS_ASSET_MAST_TBL B, RWS_ASSET_SCHEME_TBL C WHERE B.CIRCLE_OFFICE_CODE = '" +rCircle+ "' AND B.DIVISION_OFFICE_CODE = '" +rDivision+ "' AND SUBSTR(A.GLSR_CODE,1,16) = B.HAB_CODE AND B.TYPE_OF_ASSET_CODE = '" +rAssetType+ "' AND SUBSTR(A.GLSR_CODE,17,3) LIKE '%6%' AND A.ASSET_CODE = C.ASSET_CODE ";
	rs6 = stmt6.executeQuery(query6);
	rs6.next();

	query7 = " SELECT COUNT(*) FROM RWS_PWS_PM_SC_PARAM_TBL A, RWS_ASSET_MAST_TBL B, RWS_ASSET_SCHEME_TBL C WHERE B.CIRCLE_OFFICE_CODE = '" +rCircle+ "' AND B.DIVISION_OFFICE_CODE = '" +rDivision+ "' AND SUBSTR(A.PM_CODE,1,16) = B.HAB_CODE AND B.TYPE_OF_ASSET_CODE = '" +rAssetType+ "' AND SUBSTR(A.PM_CODE,17,3) LIKE '%6%' AND A.ASSET_CODE = C.ASSET_CODE ";
...
<%
		...
		{
		//System.out.println("HERE BORE WELL CIRDIV");
%>
...
%>
		<td class=rptValue><a href="./rws_asset_cirdiv_borewell_rpt.jsp">BORE WELL</td>
<%
		}
%>
...
<%		
		...
		{
%>
		<td class=rptValue><a href="./rws_asset_cirdiv_distri_rpt.jsp">DISTRIBUTION</td>
<%
		}
%>
		<td class=rptValue><%=rs1.getString(1)%></td>
...
<%		
		...
		{
%>
		<td class=rptValue><a href="./rws_asset_cirdiv_ohsr_rpt.jsp">OHSR</td>
<%
		}
%>
...
<%
		...
		{
%>		
			<td class=rptValue><a href="./rws_asset_cirdiv_pumphouse_rpt.jsp">PUMP HOUSE</td>
<%
		}
%>
...
<%		
		...
		{
%>
		<td class=rptValue><a href="./rws_asset_cirdiv_standposts_rpt.jsp">STAND POSTS</td>
<%
		}
%>
...
<%		
		...
		{
%>
		<td class=rptValue><a href="./rws_asset_cirdiv_cis_rpt.jsp">CISTERNS</td>
<%
		}
%>
...
<%		
		...
		{
%>
		<td class=rptValue><a href="./rws_asset_cirdiv_capac_rpt.jsp">CAPACITORS</td>
<%
		}
%>
...
<%		
		...
		{
%>
		<td class=rptValue><a href="./rws_asset_cirdiv_pumpingmain_rpt.jsp">PUMPING MAIN</td>
<%
		}
%>
...
<%		
		...
		{
%>
		<td class=rptValue><a href="./rws_asset_cirdiv_glsr_rpt.jsp">GLSR</td>
<%
		}
%>
