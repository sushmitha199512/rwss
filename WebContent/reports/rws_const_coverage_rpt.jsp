...
<%		
    ...
    //ADDED BY SAI PRASAD N ON 30/08/2012
   ...
   nic.watersoft.commons.RwsUser user=null;
	...
	String loggedUser = user.getUserId();
		...
		if(dname==null){
			dname=(String)session.getAttribute("districtName");
		}
		
		
		System.out.println("dname value:"+dname);

        String ccode=request.getParameter("constituency");
...
{ */ %>
			<tr><td class="bwborder">
				<A HREF="javascript:history.go(-1)">Back|</a>
				<a href="../home.jsp">Home|</a>
				<a href="./rws_const_coverage_rpt_xls.jsp" target="_new">Excel</a>
				
			</td></tr>
<% // } else {%>
	<!-- <tr><td align="center" class="bwborder"><a href="#" onclick="window.close()">Close</td></tr>  -->               
<%//} %>
...
<%} %>
<%if(dcode !=null && !dcode.equals("00") && ccode!=null && ccode.equals("00")){ %>
<table border = 1 cellspacing = 0 cellpadding = 0 width=100%  bordercolor=#000000 style="border-collapse:collapse" bgcolor="#ffffff">	
	<tr  align="center">
...
<%
	try
	{
		...
		System.out.println("District-All Const.."+query);
		rs2=st2.executeQuery(query);
        flag3=true;
		while(rs2.next())
		{
...
<%if(dcode!=null && !dcode.equals("00") && ccode!=null && !ccode.equals("00") && mcode!=null && mcode.equals("00")){ %>
<table border = 1 cellspacing = 0 cellpadding = 0 width=100%  bordercolor=#000000 style="border-collapse:collapse" bgcolor="#ffffff">	
	<tr  align="center">
...
<%if(dcode!=null && !dcode.equals("00") && ccode!=null && !ccode.equals("00") && mcode!=null && !mcode.equals("00") && pcode!=null && pcode.equals("00")){ %>
<table border = 1 cellspacing = 0 cellpadding = 0 width=100%  bordercolor=#000000 style="border-collapse:collapse" bgcolor="#ffffff">	
	<tr  align="center">
...
<%} %>
<%if(dcode!=null && !dcode.equals("00") && ccode!=null && !ccode.equals("00") && mcode!=null && !mcode.equals("00") && pcode!=null && !pcode.equals("00") && vcode!=null && vcode.equals("00")){ %>
<table border = 1 cellspacing = 0 cellpadding = 0 width=100%  bordercolor=#000000 style="border-collapse:collapse" bgcolor="#ffffff">	
	<tr  align="center">
...
<%if(dcode!=null && !dcode.equals("00") && !dcode.equals("-1")&& ccode!=null && !ccode.equals("00") && !ccode.equals("-1") &&  mcode!=null &&  mcode.equals("-1")){ %>
<table border = 1 cellspacing = 0 cellpadding = 0 width=100%  bordercolor=#000000 style="border-collapse:collapse" bgcolor="#ffffff">	
	<tr  align="center">
		<td align="center" class="rptValue" colspan=40><font color="blue"><%=dname%> District&nbsp;:&nbsp;<%=cname%> Constituency</font></td>		
	</tr>	
	<tr align=center  align=center>
		<td class=btext rowspan = 4>Sl.No</td>
        <td class=btext rowspan = 4>District Name</td>
...
<%if(dcode!=null && !dcode.equals("00") && !dcode.equals("-1") && ccode!=null && !ccode.equals("00") && !ccode.equals("-1") && !mcode.equals("00") && !mcode.equals("-1") && pcode.equals("-1")){ %>
<table border = 1 cellspacing = 0 cellpadding = 0 width=100%  bordercolor=#000000 style="border-collapse:collapse" bgcolor="#ffffff">	
	<tr  align="center">
		<td align="center" class="rptValue" colspan=40><font color="blue"> <%=dname%> District&nbsp;:&nbsp;<%=cname%> Constituency&nbsp;:&nbsp;<%=mname%> Mandal</font></td>		
	</tr>	
	<tr align=center  align=center>
		<td class=btext rowspan = 4>Sl.No</td>
        <td class=btext rowspan = 4>District Name</td>
...
<%
	...
	{   
		...
		System.out.println("District-Const-mandal");
		rs2=st2.executeQuery(query);
...
<%if(dcode!=null && !dcode.equals("00") && !dcode.equals("-1") && ccode!=null && !ccode.equals("00") && !ccode.equals("-1") && mcode!=null && !mcode.equals("00") && !mcode.equals("-1") && pcode!=null && !pcode.equals("00") && !pcode.equals("-1") && vcode!=null && vcode.equals("-1") ){ %>
<table border = 1 cellspacing = 0 cellpadding = 0 width=100%  bordercolor=#000000 style="border-collapse:collapse" bgcolor="#ffffff">	
	<tr  align="center">
		<td align="center" class="rptValue" colspan=40><font color="blue"><%=dname%> District&nbsp;:&nbsp;<%=cname%> Constituency&nbsp;:&nbsp;<%=mname%> Mandal&nbsp;:&nbsp;<%=pname%> Panchayat</font></td>		
	</tr>	
	<tr align=center  align=center>
		<td class=btext rowspan = 4>Sl.No</td>
        <td class=btext rowspan = 4>District Name</td>
...
<%
	...
	{   
		...
		System.out.println("District-Const-mandal-panchayat");
		rs2=st2.executeQuery(query);
...
<%if(dcode!=null && !dcode.equals("00") && !dcode.equals("-1") && ccode!=null && !ccode.equals("00") && !ccode.equals("-1") && mcode!=null && !mcode.equals("00") && !mcode.equals("-1") && pcode!=null && !pcode.equals("00") && !pcode.equals("-1") && vcode!=null && !vcode.equals("00") && !vcode.equals("-1")){ %>
<table border = 1 cellspacing = 0 cellpadding = 0 width=100%  bordercolor=#000000 style="border-collapse:collapse" bgcolor="#ffffff">	
	<tr  align="center">
		<td align="center" class="rptValue" colspan=40><font color="blue"><%=dname%> District&nbsp;:&nbsp;<%=cname%> Constituency&nbsp;:&nbsp;<%=mname%> Mandal&nbsp;:&nbsp;<%=pname%> Panchayat&nbsp;:&nbsp;<%=vname%> Village</font></td>		
	</tr>	
	<tr align=center  align=center>
		<td class=btext rowspan = 4>Sl.No</td>
        <td class=btext rowspan = 4>District Name</td>
...
<%
	...
	{   
		...
		System.out.println("District-Const-mandal-panchayat-village");
		rs2=st2.executeQuery(query);
