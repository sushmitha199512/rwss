...
<form name=f1 action="./rws_consti_hab_rpt_temp.jsp?start=<%=start%>&slno=<%=slno%>&pgcnt=<%=GOPG%>">
...
<caption>
	<table  border=0 rules=none style="border-collapse:collapse" align = "right">
		...
		<tr align="right">
			<td class="bwborder">
				<a href="./rws_consit_hab_status_form.jsp">Back&nbsp;|&nbsp;</a>&nbsp;<a href="../home.jsp">Home&nbsp;|&nbsp;</a>
				
			
			<a href="./rws_consti_hab_rpt_print.jsp"  target="_new">Print&nbsp;|&nbsp;</a>
			<a href="rws_consti_hab_rpt_excel_print.jsp" target="_new">Excel</a>
			</td>
		</tr>
	</table>
</caption>
...
<% 
	...
	if((start+20)<=myList1.size())
		{
		%>
		<a href="rws_consti_hab_rpt_temp.jsp?start=<%=r1%>&slno=<%=slno%>&pgcnt=<%=s1%>"><font   color=blue>Next </font></a>
		<%}
	%>
</td>
</table>
