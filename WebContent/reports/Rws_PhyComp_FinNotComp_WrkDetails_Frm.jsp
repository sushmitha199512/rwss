  ...
  var year2=finyear.substring(5,9);
     var cyear=new Date().getFullYear() ;
			...
			else
		{
			...
			document.f1.action="./Rws_PhyComp_FinNotComp_WrkDetails_Rpt.jsp";
...
<%} %>
	...
	<tr bgcolor="#8A9FCD" align="center">
		<td align="center" class="rptHeading" colspan=4>Physically Completed - Financially Not Completed Works Details</td>
	</tr>
