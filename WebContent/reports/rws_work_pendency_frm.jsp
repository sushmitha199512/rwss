...
function unview()
{
	...
	function fnSubmit()
	{
		...
		document.f1.action="./rws_work_pendency_rpt.jsp";
		document.f1.submit();	
...
<table border = 1 align = center cellspacing = 0 cellpadding = 0 rules = "rows" bordercolor = navy style = "border-collapse:collapse" bgcolor="#ffffff" width=350>		
	...
	<tr bgcolor="#8A9FCD" align="center">
		<td align="center" class="rptHeading" colspan=3>Work Pendency Status Report</td>	
	</tr>
<%
...
<%
		...
		<option value="-1">SELECT...</option>
		<%String ary1="select distinct to_char(admin_date,'yyyy')  from rws_work_admn_tbl a,rws_work_commencement_tbl b,rws_work_completion_tbl c where a.work_id=b.work_id and a.work_id=c.work_id and b.work_id=c.work_id and grounding_date is not null and date_of_completion is null ";
		
            if(rDistrict!=null && !rDistrict.equals("") && !rDistrict.equals("00"))
	      {
			 ary1+=" and substr(a.work_id,5,2)='"+rDistrict+"' ";
		  }
		   if(rwrktype!=null && !rwrktype.equals("") && !rwrktype.equals("-1"))
	      {
			 ary1+=" and a.category_code ='"+rwrktype+"' ";
		  }
		
		  ary1+=" order by to_char (admin_date,'yyyy') desc  ";
