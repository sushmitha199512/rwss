...
<%@ include file = "conn.jsp" %>
	...
	String tdate=String.valueOf(session.getAttribute("tdate"));
	 ...
	 String AType=String.valueOf(session.getAttribute("AType"));
...
<p width="100%" align="center"><b><font face="Verdana" size="3">Pendency Status Details Report</font>
	</p>
...
<%	
	...
	if(AType!=null && !AType.equals("null"))
	{
		query = query + " and  rp.TYPE_OF_ASSET = '"+ AType + "'";
	}
	query = query + a1;
...
<% String rCode=String.valueOf(session.getAttribute("repcode"));
	...
	<td align=center colspan=13 class="mystyle1"><B>Represented By:&nbsp;&nbsp;<font color="red"><%=session.getAttribute("repname") %> </font></td></tr>
	<td ><B>S.No</td>
	<% } else
		 ...
		 <%
			...
			if(rs5.next())
				{%>
					...
					<td class="mystyle1"><B>Technicalln Sanction </td>
