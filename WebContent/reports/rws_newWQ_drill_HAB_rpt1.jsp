...
<td class="<%=style %>" style="text-align: left;" align="right"><a href="#" onclick="viewWorks('rws_newWQ_drill_source_rpt1.jsp?ccode=<%=circleofficecode%>&divoffcode=<%=divisionofficecode%>&cirname=<%=cname%>&divsname=<%=divname %>&sourcec=<%=rs3.getString(2)%>&testCode=<%=rs3.getString(3)%>')"><%=rs3.getString(2) %></td>
