...
<%
	...
	//System.out.println("main   scheme value:"+rScheme);
...
<table border = 1 align = center cellspacing = 0 cellpadding = 0 rules = "rows" bordercolor = navy style = "border-collapse:collapse" bgcolor="#ffffff" width=350>		
	...
	<tr bgcolor="#8A9FCD" align="center">
		<td align="center" class="rptHeading" colspan=3>Administrative Sanction Report</font></td>	
	</tr>
...
<%
	...
	query = "SELECT distinct d.circle_office_code,d.circle_office_name  from rws_circle_office_tbl d,rws_work_admn_tbl w where   d.circle_office_code=substr(w.office_code,2,2) order by  d.circle_office_name";
