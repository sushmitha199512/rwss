...
<%}else if(rs.getString(3).equals("12"))
		   ...
		   <%}%>
			<td class=rptValue><b><%=rr.getInt(6)%></b></td>
		</tr>
<%
String qury2="";
...
<table border = 1 cellspacing = 0 cellpadding = 0  width="100%" bordercolor=#000000 style="border-collapse:collapse" bgcolor="#ffffff" align = "center">	  	 
		...
		<%if(rs.getString(3).equals("11"))
		        {%>
			<td class="btext">4. School Name</td>
			<td class="btext" align="right">Habitations</td>
			...
			<%}else if(rs.getString(3).equals("12")){ %>
			<td class="btext"colspan="3">4.Division</td>
			<td class="btext" align="center" colspan="3">Lab Code</td>
			<td class="btext" align="center" colspan="2">Lab Name</td>
...
%>
		...
		<%if(rs.getString(3).equals("11"))
		  ...
		  {%>
		  <tr bgcolor="#ffffff"> 	
			<td class="rptValue"><%=aserial%>.&nbsp;<%=rss.getString(8)%></td>
			<td class="rptValue" align="left" ><%=rss.getString(2)%></td>
			<td class="rptValue" align="right" ><%=rss.getString(3)%></td>
			<td class="rptValue" align="right"><%=rss.getString(4)%></td>
			<td class="rptValue" align="right"><%=rss.getString(5)%></td>
			<td class="rptValue" align="right"><%=rss.getString(6)%></td>
			<td class="rptValue" align="center"><%=rss.getString(7)%></td>
			</tr>
		<%}else if(rs.getString(3).equals("12")) {%>
		<tr bgcolor="#ffffff"> 	
			<td class="rptValue" colspan="3"><%=aserial%>.&nbsp;<%=rss.getString(2)%></td>
			<td class="rptValue" align="center" colspan="3"><%=rss.getString(3)%></td>
			<td class="rptValue" align="center" colspan="2"><%=rss.getString(4)%></td>
			</tr>
			<%}else{%>
			<tr bgcolor="#ffffff"> 	
			<td class="rptValue"><%=aserial%>.&nbsp;<%=rss.getString(2)%></td>
			<td class="rptValue" align="left" ><%=rss.getInt(3)%></td>
...
%>
		...
		<tr bgcolor="#ffffff">		
		<td class="btext" colspan="6">1. Sanction<br>&nbsp;&nbsp;&nbsp;&nbsp;Amt(Rs In Lakhs)</td>
			<td class="rptValue" ><%=rr1.getFloat(3)%></td>	
		</tr>
		<tr bgcolor="#ffffff">
		<td class="btext" colspan="6">2.Rev.Admin.SancNo/Rev.Admin.SancDate</td>
...
%>
		...
		{
		%>
		<td class="btext" colspan="6">4. No Of Schools</td>
		<%}else  if(rs.getString(3).equals("12")){%>
		<td class="btext" colspan="6">4. No Of Labs</td>
		<%}else{%>
		<td class="btext" colspan="6">4. No Of Habs</td>
		<%}%>
		...
		<td class="btext" >Coverage Status</td>
		  ...
		  <%}else if(rs.getString(3).equals("12")){%>
        <td class="btext" colspan="4">5. Division</td>
<td class="btext" colspan="3" align="center">Lab Name</td>
