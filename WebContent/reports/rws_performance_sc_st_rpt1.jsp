...
{ %>
			<tr><td align="right" class="bwborder"><a href="/pred/home.jsp?loginMode=watersoft">Home|</a></td>
				<td class="bwborder"><a href="javascript:onclick=history.go(-1)">Back|</a><a href="./rws_performance_sc_st_excel1.jsp" target=_new>Excel</a></td></tr>
<%  } else {%>
...
<td class=btext  align=center colspan=11 style="background-color:lightyellow">Spill Over Works</td>
<td class=btext colspan=8 align=center style="background-color:#d2b48c">New Works<br>(SVS)</td>
</tr>
<tr>
 ...
 <td  class=btext align="center"style="background-color:lightyellow" >Releases During <br><%=financialyr %></td>	
		<td  class=btext align="center"style="background-color:lightyellow"  >Expenditure During <br><%=financialyr %></td>	
		<td  class=btext align="center" style="background-color:lightyellow" >No.of.Works Completed<br><%=financialyr %></td>
...
<td  class=btext align="center" style="background-color:lightyellow" >Habs Covered during <br><%=financialyr %></td>	
<td class=btext align="center" style="background-color:#d2b48c" >No.of Works<br>(SVS)</td>
		<td  class=btext align="center" style="background-color:#d2b48c" >Est.Cost</td>
<td  class=btext align="center" style="background-color:#d2b48c" >Releases During <br><%=financialyr %></td>
		<td  class=btext align="center" style="background-color:#d2b48c" >Expenditure During <br><%=financialyr %></td>	
		<td class=btext align="center" style="background-color:#d2b48c" >Bal Est.Cost </td>

		<td  class=btext align="center" style="background-color:#d2b48c" >No.of.Works Completed <br><%=financialyr %></td>
		<td  class=btext align="center" style="background-color:#d2b48c" >Habs Sanctioned</td>	
<td  class=btext align="center" style="background-color:#d2b48c" >Habs Covered during <br><%=financialyr %></td>	
...
////System.out.println("New Works"+newWorksQuery);
	...
	String newWorksEstCostQuery="select b.circle_office_code,b.division_office_code,sum(w.sanction_amount) FROM RWS_WORK_ADMN_TBL W ,rws_division_office_tbl b where  (w.ADMIN_DATE >= '01-Apr-"+startyr+"' and w.ADMIN_DATE < '01-Apr-"+endyr+"') and work_cancel_dt is null and substr(w.office_code,2,2)=b.circle_office_code and substr(w.office_code,4,1)=b.division_office_code and  w.category_code='2' ";
 if(scheme!=null && !scheme.equals("")){
...
newWorksCompQuery+="and  w.programme_code in ("+programe+")  and w.work_id  in (select work_id from rws_work_completion_tbl where (to_date(DATE_OF_COMPLETION) >= '01-Apr-"+startyr+"') and (to_date(DATE_OF_COMPLETION) < '01-APR-"+endyr+"')) group by  b.circle_office_code,b.division_office_code  order by 1";
		stmt3=conn.createStatement();
////System.out.println("New Works"+newWorksCompQuery);
	...
	String newWorksExpQuery="select b.circle_office_code,b.division_office_code,sum(case when to_date(voucher_dt)< '01-Apr-"+startyr+"' then voucher_amt else 0 end)||'@'||sum(case when (to_date(voucher_dt)>= '01-Apr-"+startyr+"' and to_date(voucher_dt)< '01-APR-"+endyr+"') then voucher_Amt else 0 end) FROM RWS_WORK_ADMN_TBL W ,rws_division_office_tbl b,rws_work_exp_voucher_tbl a  where  (w.ADMIN_DATE >= '01-Apr-"+startyr+"' and w.ADMIN_DATE < '01-Apr-"+endyr+"') and work_cancel_dt is null and  w.category_code='2'";
 if(scheme!=null && !scheme.equals("")){
...
String newCurRelBankQuery="select b.circle_office_code,b.division_office_code,sum(case when (to_date(BANK_SEND_DATE)>= '01-APR-"+startyr+"' and to_date(BANK_SEND_DATE) < '01-APR-"+endyr+"') then BILL_AMOUNT_CENTRAL else 0 end) FROM RWS_WORK_ADMN_TBL W ,rws_division_office_tbl b,RWS_bill_bank_bridge_det_TBL a  where  (w.ADMIN_DATE >= '01-Apr-"+startyr+"' and w.ADMIN_DATE < '01-Apr-"+endyr+"') and work_cancel_dt is null and  w.category_code='2'";
 if(scheme!=null && !scheme.equals("")){
...
String newCurRelpaoQuery="select b.circle_office_code,b.division_office_code,sum(case when (to_date(STATE_SEND_DATE)>= '01-APR-"+startyr+"' and to_date(STATE_SEND_DATE) < '01-APR-"+endyr+"') then BILL_AMOUT_STATE else 0 end) FROM RWS_WORK_ADMN_TBL W ,rws_division_office_tbl b,RWS_bill_pao_bridge_det_TBL a  where  (w.ADMIN_DATE >= '01-Apr-"+startyr+"' and w.ADMIN_DATE < '01-Apr-"+endyr+"') and work_cancel_dt is null and  w.category_code='2'";
 if(scheme!=null && !scheme.equals("")){
...
String newWorksHabs="select b.circle_office_code,b.division_office_code,count(*) FROM RWS_WORK_ADMN_TBL W ,rws_division_office_tbl b,rws_admn_hab_lnk_tbl c  where w.work_id=c.work_id and  (w.ADMIN_DATE >= '01-Apr-"+startyr+"' and w.ADMIN_DATE < '01-Apr-"+endyr+"') and work_cancel_dt is null and substr(w.office_code,2,2)=b.circle_office_code and substr(w.office_code,4,1)=b.division_office_code and  w.category_code='2'";
if(scheme!=null && !scheme.equals("")){
...
String newWoksCoveredHabs="select b.circle_office_code,b.division_office_code,count(*) FROM RWS_WORK_ADMN_TBL W ,rws_division_office_tbl b,RWS_WORK_COMP_HAB_LNK_TBL c  where w.work_id=c.work_id and  (w.ADMIN_DATE >= '01-Apr-"+startyr+"' and w.ADMIN_DATE < '01-Apr-"+endyr+"') and work_cancel_dt is null and substr(w.office_code,2,2)=b.circle_office_code and substr(w.office_code,4,1)=b.division_office_code and  w.category_code='2' ";
if(scheme!=null && !scheme.equals("")){
...
newWoksCoveredHabs+=" and  w.programme_code in ("+programe+")  and w.work_id in(select work_id from rws_work_completion_tbl where (to_date(DATE_OF_COMPLETION) >= '01-Apr-"+startyr+"') and (to_date(DATE_OF_COMPLETION) < '01-APR-"+endyr+"')) group by  b.circle_office_code,b.division_office_code  order by 1";
		stmt3=conn.createStatement();
...
String spillOverEstQ="SELECT b.circle_office_code,b.division_office_code,sum(w.sanction_amount)  FROM RWS_WORK_ADMN_TBL W ,rws_division_office_tbl b where to_date(w.ADMIN_DATE) <'01-Apr-"+startyr+"'  and work_cancel_dt is null and substr(w.office_code,2,2)=b.circle_office_code and substr(w.office_code,4,1)=b.division_office_code and  w.category_code='2'  and w.programme_code in ("+programe+")  ";
if(scheme!=null && !scheme.equals("")){
...
spillOverComp+=" and  w.subprogramme_code in ("+sub+") ";
 ...
 spillOverComp+="and  w.work_id  in (select work_id from rws_work_completion_tbl where (to_date(DATE_OF_COMPLETION) >= '01-Apr-"+startyr+"') and (to_date(DATE_OF_COMPLETION) < '01-APR-"+endyr+"')) group by  b.circle_office_code,b.division_office_code  order by 1";
...
String spillOverHabsCovered="SELECT b.circle_office_code,b.division_office_code,count(*)  FROM RWS_WORK_ADMN_TBL W ,rws_division_office_tbl b,RWS_WORK_COMP_HAB_LNK_TBL c  where W.work_id=c.work_id and to_date(w.ADMIN_DATE) <'01-Apr-"+startyr+"'  and work_cancel_dt is null and substr(w.office_code,2,2)=b.circle_office_code and substr(w.office_code,4,1)=b.division_office_code  and  w.category_code='2' and w.programme_code in ("+programe+") ";
if(scheme!=null && !scheme.equals("")){
...
spillOverHabsCovered+=" and  w.subprogramme_code in ("+sub+") ";
 ...
 spillOverHabsCovered+="and  w.work_id  in (select work_id from rws_work_completion_tbl where (to_date(DATE_OF_COMPLETION) >= '01-Apr-"+startyr+"') and (to_date(DATE_OF_COMPLETION) < '01-APR-"+endyr+"')) group by  b.circle_office_code,b.division_office_code  order by 1";
...
String spillExpQuery="SELECT b.circle_office_code,b.division_office_code,sum(case when to_date(voucher_dt)< '01-Apr-"+startyr+"' then voucher_amt else 0 end)||'@'||sum(case when (to_date(voucher_dt)>= '01-Apr-"+startyr+"' and to_date(voucher_dt)< '01-APR-"+endyr+"') then voucher_Amt else 0 end)  FROM RWS_WORK_ADMN_TBL W ,rws_division_office_tbl b,rws_work_exp_voucher_tbl a where to_date(w.ADMIN_DATE) <'01-Apr-"+startyr+"'   and a.work_id=w.work_id  and  w.category_code='2'  and substr(w.office_code,2,2)=b.circle_office_code and substr(w.office_code,4,1)=b.division_office_code  and w.programme_code in ("+programe+") ";
...
String spillRelBankQuery="SELECT b.circle_office_code,b.division_office_code,sum(case when (to_date(BANK_SEND_DATE)>= '01-APR-"+startyr+"' and to_date(BANK_SEND_DATE) < '01-APR-"+endyr+"') then BILL_AMOUNT_CENTRAL else 0 end)  FROM RWS_WORK_ADMN_TBL W ,rws_division_office_tbl b,RWS_bill_bank_bridge_det_TBL a where to_date(w.ADMIN_DATE) <'01-Apr-"+startyr+"'   and a.work_id=w.work_id  and substr(w.office_code,2,2)=b.circle_office_code and  w.category_code='2' and substr(w.office_code,4,1)=b.division_office_code  and w.programme_code in ("+programe+") ";
...
String spillRelPaoQuery="SELECT b.circle_office_code,b.division_office_code,sum(case when (to_date(STATE_SEND_DATE)>= '01-APR-"+startyr+"' and  to_date(STATE_SEND_DATE) < '01-APR-"+endyr+"') then BILL_AMOUT_STATE else 0 end) FROM RWS_WORK_ADMN_TBL W ,rws_division_office_tbl b,RWS_bill_pao_bridge_det_TBL a where to_date(w.ADMIN_DATE) <'01-Apr-"+startyr+"'   and a.work_id=w.work_id  and substr(w.office_code,2,2)=b.circle_office_code and substr(w.office_code,4,1)=b.division_office_code and  w.category_code='2' and w.programme_code in ("+programe+") ";
...
String spillHabsCover="SELECT b.circle_office_code,b.division_office_code,count(*)  FROM RWS_WORK_ADMN_TBL W ,rws_division_office_tbl b,rws_admn_hab_lnk_tbl c where w.work_id=c.work_id and to_date(w.ADMIN_DATE) <'01-Apr-"+startyr+"'  and work_cancel_dt is null and substr(w.office_code,2,2)=b.circle_office_code and substr(w.office_code,4,1)=b.division_office_code and  w.category_code='2' and w.programme_code in ("+programe+") ";
if(scheme!=null && !scheme.equals("")){
...
if(srelban!=null){
sbankUpto=Double.parseDouble(srelban)/100000;
}
String srelpao=(String)spillOverRelPao.get(rs1.getString(3)+rs1.getString(4));
if(srelpao!=null){
 spaoUpto=Double.parseDouble(srelpao)/100000;
}
...
if(nrelban!=null){
 nbankUpto=Double.parseDouble(nrelban)/100000;
    
}
String nrelpao=(String)newRelpao.get(rs1.getString(3)+rs1.getString(4));
if(nrelpao!=null){
 npaoUpto=Double.parseDouble(nrelpao)/100000;
}
