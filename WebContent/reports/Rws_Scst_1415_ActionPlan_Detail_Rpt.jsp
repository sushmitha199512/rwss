...
{ %>
			<tr><td align="right" class="bwborder"><a href="/pred/home.jsp?loginMode=watersoft">Home|</a></td>
				<td class="bwborder"><a href="./Rws_Scst_1415_ActionPlan_Detail_Frm.jsp">Back|</a><a href="./Rws_Scst_1415_ActionPlan_Detail_Excel.jsp" target=_new>Excel</a></td></tr>
<%  } else {%>
...
<tr >
		<td align="center" class="gridhdbg" colspan=53>Spillover Infrastructure Works Proposed Under TSP 2014-15 for the Benefit of the ST Habitations  (<%=pname %>) .</td>	
	</tr>
		<tr>
...
<td class="gridhdbg"  colspan=1 "  rowspan="2" align="center">Total</td>	
		<td   class="gridhdbg" colspan=1   rowspan="2" align="center">Under TSP</td>	
...
<!-- <td class="gridhdbg"  colspan=1   align="center">PLAIN</td>	
 ...
 -->		
		<td class="gridhdbg"  colspan=1   align="center">PLAIN</td>	
		<td   class="gridhdbg" colspan=1  align="center">SC</td>	
		<td  class="gridhdbg" colspan=1  align="left">Under TSP</td>
		<td class="gridhdbg"  colspan=1   align="center">PLAIN</td>	
		<td   class="gridhdbg" colspan=1  align="center">SC</td>	
		<td  class="gridhdbg" colspan=1  align="left">Under TSP</td>
