...
<table border = 1 cellspacing = 0 cellpadding = 0 height=5% width="100%" bordercolor=#000000 style="border-collapse:collapse" bgcolor="#ffffff" align = "center">
	<caption>
		<table  border=0 rules=none style="border-collapse:collapse" align = "right">			
			<tr align="right">
				<td class="bwborder"><a href="./rws_planning_format2_frm.jsp">Back |</a></td>
				<td class="bwborder"><a href="../home.jsp">Home |</a></td>
				<td class="bwborder"><a href="./rws_planning_rpt_format2_prnt_rpt.jsp?rDistrict=<%=rDistrict%>&rMandal=<%=rMandal%>" target="_new">Print |</a></td>
			    <td class="bwborder"><a href="./rws_planning_rpt_format1_xls_rpt.jsp?rDistrict=<%=rDistrict%>&rMandal=<%=rMandal
