...
if(distcode!=null){
session.setAttribute("distcode",distcode);
}
if(dname!=null){
		...
		<caption>
			<table  border=0 rules=none style="border-collapse:collapse" align = "right">		
				<tr>
					...
					<a href="./rws_drought_daily_comparision_rpt_xls.jsp" target=_new>Excel</a>
					</td>
				</tr>
			</table>
		</caption>
...
float v13sum=0;
 ...
 //queries
          ...
          /* String qry4="select HABITATION_CODE,b.work_id from RWS_DROUGHT_HAB_TR_PVT_SO_TBl a ,rws_admn_hab_lnk_tbl b where a.habitation_code=b.hab_code and substr(habitation_code,1,2)='"+distcode+"' and date_of_entry=to_date('"+rvalue+"','dd-mm-yyyy') order by b.work_id";
	       Hashtable h3=new Hashtable();
	       pst4=conn.createStatement();
	       rs4=pst4.executeQuery(qry4);
           //System.out.println("my qry4 "+qry4);
	       while(rs4.next())
	       {
               h3.put(rs4.getString(1),rs4.getString(2));
	         //h3.put(rs4.getString(1),rs4.getString(2)+"@"+rs4.getString(3)+"@"+rs4.getString(4)+"@"+rs4.getString(5));
             //System.out.println(h3.put(rs4.getString(1),rs4.getString(2)));
             ////System.out.println(h3.put(rs4.getString(1),rs4.getString(2)+"@"+rs4.getString(3)+"@"+rs4.getString(4)+"@"+rs4.getString(5)));
	       }*/
