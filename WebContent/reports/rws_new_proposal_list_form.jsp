...
function fnSubmit()
{
	...
	document.f1.action="./rws_new_proposal_list_rpt.jsp";
	document.f1.submit();
	}
	function valSubmit()
	{ 
...
<table border = 1 align=center cellspacing = 0 cellpadding = 0 rules="rows" width=40%  bordercolor=navy style="border-collapse:collapse" bgcolor="#ffffff">
	...
	<tr bgcolor="#8A9FCD" align="center">
			<td algin="center" class="textborder" colspan="4"><font color="#FFFFFF">New Proposal List Print</font></td>	
		</tr>
	</table>
...
<%
	...
	rs =stmt.executeQuery("SELECT proposal_id FROM RWS_rep_proposal_tbl order by proposal_id");
