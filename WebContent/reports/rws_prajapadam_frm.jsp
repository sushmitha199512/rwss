...
<table bgcolor="#DEE3E0" bordercolor= "#8A9FCD" rules="none" 
	...
	<tr>
	    ...
	    <tr class="textborder"  >
		 ...
		 <tr class="textborder">
			 ...
			 <td> <html:text property="expendetureDuringMon"  /> 
			  Month: <html:select property="expMonth"  style="width:100px" styleClass="combo">
						<html:option value="0"><bean:message key="app.pleaseSelect" /></html:option>
						 <logic:present name="AllMonths">
							<html:options collection="AllMonths" name="labelValueBean"
										  property="value" labelProperty="label" />
						</logic:present>
						</html:select> 
			  </td>
		...
		<tr class="textborder">
			 ...
			 <td class="textborder"> <html:select  property="physycalStageOFWork" style="width:100px" styleClass="combo" >
			      ...
			      <html:option value="STARTED">STARTED</html:option>
			       <html:option value="PROGRESS">IN PROGRESS</html:option>
		...
		<tr>
		<td align="center">
		<html:button property="mode" styleClass="btext" onclick="saveFrm()">Save</html:button>
