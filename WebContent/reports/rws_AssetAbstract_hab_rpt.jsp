...
{ %>
			<tr><td align="right" class="bwborder"><a href="javascript:history.go(-1)">Back</a>|
					...
					<a href="./rws_AssetAbstract_hab_xls.jsp?rDistrict=<%=rDistrict%>&yrcreation=<%=yrcreation%>&mname=<%=mname%>&mcode=<%=mcode%>&dname=<%=dname%>" target=_new>Excel</a></td></tr>
<%  } else {%>
...
<%} %>
	...
	<tr>
		...
		<tr bgcolor="#8A9FCD" align="center">
			<td align="center" class="rptHeading" colspan=20>Asset-Abstract-Report</td>	
		</tr>
		</tr>
