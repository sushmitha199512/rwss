...
try
{
  ...
  query="select distinct to_char(COMPLAINT_DATE,'dd/mm/yyyy'),COMPLAINT_DATE from RWS_GENERIC_COMPLAINTS_REG_TBL where COMPLAINT_DATE between to_date('"+fromdate+"','dd/mm/yyyy') and to_date('"+todate+"','dd/mm/yyyy') and URBAN_WATER='R' order by COMPLAINT_DATE ";  
