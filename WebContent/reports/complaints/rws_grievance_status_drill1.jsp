...
%>
	<tr>
     ...
     <td class="<%=style %>" style="text-align: left;"><%=rs8.getString(1)%></td> 
      <td class="<%=style %>" style="text-align: left;"><%=rs8.getString(2)%>/<br><%=rs8.getString(3)%>/<br><%=rs8.getString(4)%>/<br><%=rs8.getString(17)%></td>  
