...
<script language="JavaScript">
	...
	function show(){
		if(document.f1.habresult.value=="watersample" || document.f1.habresult.value=="ftk" || document.f1.habresult.value=="parameter" || document.f1.habresult.value=="watertest"){
				...
				<tr align="center">
					...
					<td class="textborder" width="150">
						<select name="habresult" styleClass="mycombo" style="width:200px" onchange="show()"  >
							...
							<option value="watersample" class="myfontclr1">Water Quality Sample Collection Table</option>
							<option value="waterlab" class="myfontclr1">Water Quality Lab Table</option>
							<option value="watertest" class="myfontclr1">Water Quality Test Results Table</option>
							<option value="ftk" class="myfontclr1">Water Quality FTK Testing Table</option>       
						</select>		
					</td>	
				</tr>
			</table>
