...
<jsp:useBean id="workData" class="nic.watersoft.works.WorksData1" /> 
	...
	<table border=1 cellspacing = 0 cellpadding = 0 height=5% width="100%"  style="border-collapse:collapse"  align = "center">
		...
		<tr  > <td class="gridhdbg" colspan=17>District :<font color="red" face="verdana" size="2"> <%=dname%> </font> </td> </td>
...
%>
 <tr>
	   <td class=<%=style %> style="text-align: left;"><%=no++%></td>
	    <td class=<%=style %> ><%=rs1.getString(1)%></td>
		<td class=<%=style %>><%=rs1.getString(2)%></td>
