\<%
  ...
  <table border = 1 cellspacing = 0 cellpadding = 0 width="100%"  bordercolor=#000000 style="border-collapse:collapse" bgcolor="#ffffff" align = "center">
 	...
 	<tr align="center">
		<td align="left" class="rptHeading" colspan=8>VI.Work Expenditure Details</font></td>	
	</tr>
...
<%	 int no=0;
	...
	try
	{
	  while(rs.next())
	  {
	  //	System.out.println("WORKEXPENDITURE");
...
%>
	<tr bgcolor="#ffffff">
		...
		<td class="rptValue"><%=rs2.getDouble(1)%></td>
	</tr>
<%
		}
		}
...
<%		int counttotal = 0;
		...
		String queryyear="select distinct year from rws_work_expenditure_tbl where work_id='"+rs.getString(2)+"' and programme_code='"+r.getString(1)+"' order by year ";
		//.out.println("query year:"+queryyear);
		...
		while(rss.next())
		{
			...
			returnval++;
		String qurys = "select distinct count(*) from rws_work_expenditure_tbl e where  e.work_id='"+rs.getString(2)+"' and e.programme_code='"+r.getString(1)+"' and year='"+rss.getString(1)+"' ";
	...
	//	System.out.println("*****************************::"+qury1);
		...
		System.out.println("Exception in workExp 1"+e.getMessage());
		}
		finally
		{
		try
...
%>
	...
	<tr>
		...
		<td class="rptValue" align="right"><%=month[mon21[a12]-1]%></td>
		<td class="rptValue" align="right"><%=expd21[a12]%></td>
		<td class="rptValue" align="right"><%=valupto21[a12]%></td>
	 	<td class="rptValue" align="right"><%=workd21[a12]%></td>
...
%>
		<%-- 	<td class="rptValue" align="right"><b><%=totalmain+expd21[a12]+valupto21[a12]%></b></td>--%>
...
%>
	<tr> 
		...
		<td class="rptValue" align="right"><%=month[mon12[a12]-1]%></td>
		<td class="rptValue" align="right" ><%=expd12[a12]%></td>
		<td class="rptValue"  align="right"><%=valupto12[a12]%></td>
		<td class="rptValue"  align="right"><%=workd12[a12]%></td>
...
%>
	 	<%-- 	<td class="rptValue" align="right"><b><%=totalmain+expd12[a12]+valupto12[a12]%></b></td>--%>
...
<%
	...
	System.out.println("Exception in workExp 2"+e.getMessage());
	}
	finally
	{
	try
...
<%	   BigDecimal bd = new BigDecimal(Double.toString(totalmain));
	...
	System.out.println("Exception in workExp 3"+e.getMessage());
	}
	finally
	{
	try
...
<%
	...
	System.out.println("Exception in workExpenditure"+e.getMessage());
	}
	finally
	{
	try
