		 ...
		 -->
				...
				getDnameQuery.delete(0, getDnameQuery.length());
							...
							while (rs2.next()) {
								...
								pQuery.append("select distinct substr(h.panch_code,1,2)||substr(h.panch_code,6,2)||substr(h.panch_code,13,2) from rws_district_tbl d,rws_mandal_tbl m,rws_panchayat_tbl p,rws_village_tbl v,rws_complete_hab_view h,"
										+ habTableName
										+ " hd where d.dcode=m.dcode and m.dcode=p.dcode and m.mcode =p.mcode and p.dcode=v.dcode and p.mcode=v.mcode and p.pcode=v.pcode and substr (h.panch_code,1,2) = v.dcode and substr(h.panch_code,6,2) = v.mcode and substr(h.panch_code,13,2) = v.pcode and substr (h.panch_code,8,3) = v.vcode and h.panch_code=hd.hab_code and hd.coverage_status is not null and hd.coverage_status not in('UI','NW')  and d.dcode='"
										+ rs2.getString(1) + "' ");
								System.out.println("pQuery :"+pQuery);
								/* System.out.println("select distinct substr(h.panch_code,1,2)||substr(h.panch_code,6,2)||substr(h.panch_code,13,2) from rws_district_tbl d,rws_mandal_tbl m,rws_panchayat_tbl p,rws_village_tbl v,rws_complete_hab_view h,"
										+ habTableName
										+ " hd where d.dcode=m.dcode and m.dcode=p.dcode and m.mcode =p.mcode and p.dcode=v.dcode and p.mcode=v.mcode and p.pcode=v.pcode and substr (h.panch_code,1,2) = v.dcode and substr(h.panch_code,6,2) = v.mcode and substr(h.panch_code,13,2) = v.pcode and substr (h.panch_code,8,3) = v.vcode and h.panch_code=hd.hab_code and hd.coverage_status is not null and hd.coverage_status not in('UI','NW')  and d.dcode='"
										+ rs2.getString(1) + "' "); */
								vQuery.delete(0, vQuery.length());
								...
								/* System.out.println("select distinct substr(h.panch_code,1,2)||substr(h.panch_code,6,2)||substr(h.panch_code,13,2)||substr(h.panch_code,8,3) from rws_district_tbl d,rws_mandal_tbl m,rws_panchayat_tbl p,rws_village_tbl v,rws_complete_hab_view h,"
										+ habTableName
										+ " hd where d.dcode=m.dcode and m.dcode=p.dcode and m.mcode =p.mcode and p.dcode=v.dcode and p.mcode=v.mcode and p.pcode=v.pcode and substr (h.panch_code,1,2) = v.dcode and substr(h.panch_code,6,2) = v.mcode and substr(h.panch_code,13,2) = v.pcode and substr (h.panch_code,8,3) = v.vcode and h.panch_code=hd.hab_code and hd.coverage_status is not null and hd.coverage_status not in('UI','NW')  and d.dcode='"
										+ rs2.getString(1) + "' "); */
								//Query modified by pranavi
								hQuery.delete(0, hQuery.length());
								hQuery.append("select distinct h.panch_code,hd.exist_water_level,hd.coverage_status,(nvl(hd.CENSUS_PLAIN_POPU,'0')+nvl(hd.CENSUS_SC_POPU,'0')+nvl(hd.CENSUS_ST_POPU,'0')+nvl(hd.CENSUS_MINORITY_POPU,'0')) as totalpop,nvl(hd.safe_lpcd,0),nvl(hd.unsafe_lpcd,0),hd.CENSUS_SC_POPU from rws_district_tbl d,rws_mandal_tbl m,rws_panchayat_tbl p,rws_village_tbl v,rws_complete_hab_view h,"
										+ habTableName
										+ " hd where d.dcode=m.dcode and m.dcode=p.dcode and m.mcode =p.mcode and p.dcode=v.dcode and p.mcode=v.mcode and p.pcode=v.pcode and substr (h.panch_code,1,2) = v.dcode and substr(h.panch_code,6,2) = v.mcode and substr(h.panch_code,13,2) = v.pcode and substr (h.panch_code,8,3) = v.vcode and h.panch_code=hd.hab_code and hd.coverage_status is not null and hd.coverage_status not in('UI','NW')  and d.dcode='"
										+ rs2.getString(1) + "' ");
								System.out.println("hQuery :"+hQuery);
								/* System.out.println("Hab : select distinct h.panch_code,hd.exist_water_level,hd.coverage_status,(nvl(hd.CENSUS_PLAIN_POPU,'0')+nvl(hd.CENSUS_SC_POPU,'0')+nvl(hd.CENSUS_ST_POPU,'0')+nvl(hd.CENSUS_MINORITY_POPU,'0')) as totalpop,nvl(hd.safe_lpcd,0),nvl(hd.unsafe_lpcd,0),hd.CENSUS_SC_POPU from rws_district_tbl d,rws_mandal_tbl m,rws_panchayat_tbl p,rws_village_tbl v,rws_complete_hab_view h,"
										+ habTableName
										+ " hd where d.dcode=m.dcode and m.dcode=p.dcode and m.mcode =p.mcode and p.dcode=v.dcode and p.mcode=v.mcode and p.pcode=v.pcode and substr (h.panch_code,1,2) = v.dcode and substr(h.panch_code,6,2) = v.mcode and substr(h.panch_code,13,2) = v.pcode and substr (h.panch_code,8,3) = v.vcode and h.panch_code=hd.hab_code and hd.coverage_status is not null and hd.coverage_status not in('UI','NW')  and d.dcode='"
										+ rs2.getString(1) + "' "); */
								...
								if (poptype.toString() != null
									...
									if (poptype.toString().equals("SC")) {
										hQuery.append(" and (0.4)*(nvl(hd.CENSUS_PLAIN_POPU,'0')+nvl(hd.CENSUS_SC_POPU,'0')+nvl(hd.CENSUS_ST_POPU,'0')+nvl(hd.CENSUS_MINORITY_POPU,'0'))<= hd.CENSUS_SC_POPU and (0.4)*(nvl(hd.CENSUS_PLAIN_POPU,'0')+nvl(hd.CENSUS_SC_POPU,'0')+nvl(hd.CENSUS_ST_POPU,'0')+nvl(hd.CENSUS_MINORITY_POPU,'0'))> hd.CENSUS_ST_POPU  ");
									} else if (poptype.toString().equals("ST")) {
										hQuery.append("  and (0.4)*(nvl(hd.CENSUS_PLAIN_POPU,'0')+nvl(hd.CENSUS_SC_POPU,'0')+nvl(hd.CENSUS_ST_POPU,'0')+nvl(hd.CENSUS_MINORITY_POPU,'0'))<= hd.CENSUS_ST_POPU ");
									} else {
										hQuery.append(" AND (0.4)*(nvl(hd.CENSUS_PLAIN_POPU,'0')+nvl(hd.CENSUS_SC_POPU,'0')+nvl(hd.CENSUS_ST_POPU,'0')+nvl(hd.CENSUS_MINORITY_POPU,'0'))> hd.CENSUS_SC_POPU AND  (40/100)*(nvl(hd.CENSUS_PLAIN_POPU,'0')+nvl(hd.CENSUS_SC_POPU,'0')+nvl(hd.CENSUS_ST_POPU,'0')+nvl(hd.CENSUS_MINORITY_POPU,'0'))> hd.CENSUS_ST_POPU  ");

									}
									System.out.println("hQuery1 :"+hQuery);
								}
								hquery1.delete(0, hquery1.length());
								hquery1.append("select distinct h.panch_code,nvl(hd.CENSUS_PLAIN_POPU,0)+nvl(hd.CENSUS_SC_POPU,0)+nvl(hd.CENSUS_ST_POPU,0),nvl(hd.total_water_supply,0),nvl(hd.safe_lpcd,0),nvl(hd.unsafe_lpcd,0) from rws_district_tbl d,rws_mandal_tbl m,rws_panchayat_tbl p,rws_village_tbl v,rws_complete_hab_view h,"
										+ habTableName
										+ " hd where d.dcode=m.dcode and m.dcode=p.dcode and m.mcode =p.mcode and p.dcode=v.dcode and p.mcode=v.mcode and p.pcode=v.pcode and substr (h.panch_code,1,2) = v.dcode and substr(h.panch_code,6,2) = v.mcode and substr(h.panch_code,13,2) = v.pcode and substr (h.panch_code,8,3) = v.vcode and h.panch_code=hd.hab_code and hd.coverage_status is not null and hd.coverage_status not in('UI','NW')  and d.dcode='"
										+ rs2.getString(1) + "' ");
								System.out.println("hQuery2 :"+hQuery);
								if (poptype.toString() != null
										&& !poptype.toString().equals("")
										&& !poptype.toString().equals("ALL")) {

									if (poptype.toString().equals("SC")) {
										hquery1.append(" and (0.4)*(nvl(hd.CENSUS_PLAIN_POPU,'0')+nvl(hd.CENSUS_SC_POPU,'0')+nvl(hd.CENSUS_ST_POPU,'0')+nvl(hd.CENSUS_MINORITY_POPU,'0'))<= hd.CENSUS_SC_POPU and (0.4)*(nvl(hd.CENSUS_PLAIN_POPU,'0')+nvl(hd.CENSUS_SC_POPU,'0')+nvl(hd.CENSUS_ST_POPU,'0')+nvl(hd.CENSUS_MINORITY_POPU,'0'))> hd.CENSUS_ST_POPU  ");
									} else if (poptype.toString().equals("ST")) {
										hquery1.append("  and (0.4)*(nvl(hd.CENSUS_PLAIN_POPU,'0')+nvl(hd.CENSUS_SC_POPU,'0')+nvl(hd.CENSUS_ST_POPU,'0')+nvl(hd.CENSUS_MINORITY_POPU,'0'))<= hd.CENSUS_ST_POPU ");
									} else {
										hquery1.append(" AND (0.4)*(nvl(hd.CENSUS_PLAIN_POPU,'0')+nvl(hd.CENSUS_SC_POPU,'0')+nvl(hd.CENSUS_ST_POPU,'0')+nvl(hd.CENSUS_MINORITY_POPU,'0'))> hd.CENSUS_SC_POPU AND  (40/100)*(nvl(hd.CENSUS_PLAIN_POPU,'0')+nvl(hd.CENSUS_SC_POPU,'0')+nvl(hd.CENSUS_ST_POPU,'0')+nvl(hd.CENSUS_MINORITY_POPU,'0'))> hd.CENSUS_ST_POPU  ");
									}
								}
								System.out.println("hquery3 :"+hquery1);
								pcount = 0;
								vcount = 0;
								hcount = 0;
								count1 = 0;
								...
								if (lpcdrange.toString().equals("55")) {
									...
									while (hrs.next()) {
										...
										hcount++;
										totalpop = totalpop + hrs.getInt(4); //System.out.println("totalpop :"+totalpop);
			...
			<tr>
				...
				<td class="<%=style%>" class="rptValue" style="text-align: left;"><a
					href="rws_habitation_abstract_rpt1.jsp?drill=next&rDistrict=<%=rs2.getString(1)%>&rDistrictName=<%=rs2.getString(2)%>&finyear=<%=finYear%>&lpcdrange=<%=lpcdrange%>&poptype=<%=poptype%>"><%=rs2.getString(2)%></a></td>
				<td class="<%=style%>" style="text-align: right;"><%=pcount%></td>
				<td class="<%=style%>" style="text-align: right;"><%=vcount%></td>
				<td class="<%=style%>" style="text-align: right;"><a href="#" onclick="viewWorks('rws_habitation_abstract_overview_drillrpt.jsp?rDistrict=<%=rs2.getString(1)%>&rDistrictName=<%=rs2.getString(2)%>&finyear=<%=finYear%>&lpcdrange=<%=lpcdrange%>&poptype=<%=poptype%>')"><%=hcount%></a></td>
				<td class="<%=style%>" style="text-align: right;"><%=totalpop%></td>
				<td class="<%=style%>" style="text-align: right;"><a href="#"
					onclick="viewWorks('/pred/reports/rws_habitation_abstract_drill_rpt.jsp?rDistrict=<%=rs2.getString(1)%>&rDistrictName=<%=rs2.getString(2)%>&finyear=<%=finYear%>&lpcdrange=<%=lpcdrange%>&poptype=<%=poptype%>&coverageStatus=<%=FC%>')"><%=count1%></a></td>
				<td class="<%=style%>" style="text-align: right;"><%=FCpop%></td>
				<td class="<%=style%>" style="text-align: right;"><a href="#"
					onclick="viewWorks('/pred/reports/rws_habitation_abstract_drill_rpt.jsp?rDistrict=<%=rs2.getString(1)%>&rDistrictName=<%=rs2.getString(2)%>&finyear=<%=finYear%>&lpcdrange=<%=lpcdrange%>&poptype=<%=poptype%>&coverageStatus=<%=PC4%>')"><%=count5%></a></td>
				<td class="<%=style%>" style="text-align: right;"><%=PC4pop%></td>
				<td class="<%=style%>" style="text-align: right;"><a href="#"
					onclick="viewWorks('/pred/reports/rws_habitation_abstract_drill_rpt.jsp?rDistrict=<%=rs2.getString(1)%>&rDistrictName=<%=rs2.getString(2)%>&finyear=<%=finYear%>&lpcdrange=<%=lpcdrange%>&poptype=<%=poptype%>&coverageStatus=<%=PC3%>')"><%=count4%></a></td>
				<td class="<%=style%>" style="text-align: right;"><%=PC3pop%></td>
				<td class="<%=style%>" style="text-align: right;"><a href="#"
					onclick="viewWorks('/pred/reports/rws_habitation_abstract_drill_rpt.jsp?rDistrict=<%=rs2.getString(1)%>&rDistrictName=<%=rs2.getString(2)%>&finyear=<%=finYear%>&lpcdrange=<%=lpcdrange%>&poptype=<%=poptype%>&coverageStatus=<%=PC2%>')"><%=count3%></a></td>
				<td class="<%=style%>" style="text-align: right;"><%=PC2pop%></td>
				<td class="<%=style%>" style="text-align: right;"><a href="#"
					onclick="viewWorks('/pred/reports/rws_habitation_abstract_drill_rpt.jsp?rDistrict=<%=rs2.getString(1)%>&rDistrictName=<%=rs2.getString(2)%>&finyear=<%=finYear%>&lpcdrange=<%=lpcdrange%>&poptype=<%=poptype%>&coverageStatus=<%=PC1%>')"><%=count2%></a></td>
				<td class="<%=style%>" style="text-align: right;"><%=PC1pop%></td>
				<td class="<%=style%>" style="text-align: right;"><a href="#"
					onclick="viewWorks('/pred/reports/rws_habitation_abstract_drill_rpt.jsp?rDistrict=<%=rs2.getString(1)%>&rDistrictName=<%=rs2.getString(2)%>&finyear=<%=finYear%>&lpcdrange=<%=lpcdrange%>&poptype=<%=poptype%>&coverageStatus=<%=NSS%>')"><%=count6%></a></td>
				<td class="<%=style%>" style="text-align: right;"><%=NSSpop%></td>
				<td class="<%=style%>" style="text-align: right;"><a href="#"
					onclick="viewWorks('/pred/reports/rws_habitation_abstract_drill_rpt.jsp?rDistrict=<%=rs2.getString(1)%>&rDistrictName=<%=rs2.getString(2)%>&finyear=<%=finYear%>&lpcdrange=<%=lpcdrange%>&poptype=<%=poptype%>&coverageStatus=<%=NC%>')"><%=count7%></a></td>
				<td class="<%=style%>" style="text-align: right;"><%=NCpop%></td>
			</tr>
			<%
								columnTotal1 += pcount;
								columnTotal2 += vcount;	System.out.println("hcount :"+hcount);
								columnTotal3 += hcount; System.out.println("columnTotal3 :"+columnTotal3);
								columnTotal4 += count1;
								columnTotal5 += count5;
								columnTotal6 += count4;
								columnTotal7 += count3;
			...
			<tr>
				...
				<td class=gridhdbg style="text-align: right;"><a href="#" onclick="viewWorks('rws_habitation_abstract_overview_drillrpt.jsp?rDistrict=<%=Dcode%>&rDistrictName=<%=Dname%>&finyear=<%=finYear%>&lpcdrange=<%=lpcdrange%>&poptype=<%=poptype%>')"><font color="#FFFFFF"><%=columnTotal3%></font></a></td>
	...
	<table border=1 cellspacing=0 cellpadding=0 height=5% width="100%"
		...
		<%
			rs2.previous();
							...
							while (rs2.next()) {
								...
								hQuery.delete(0, hQuery.length());
								//Query modified by pranavi
								hQuery.append("select h.panch_code,hd.exist_water_level,hd.coverage_status,(nvl(hd.CENSUS_PLAIN_POPU,'0')+nvl(hd.CENSUS_SC_POPU,'0')+nvl(hd.CENSUS_ST_POPU,'0')) as totalpop,nvl(safe_lpcd,0),nvl(unsafe_lpcd,0)  from rws_district_tbl d,rws_mandal_tbl m,rws_panchayat_tbl p,rws_village_tbl v,rws_panchayat_raj_tbl h,"
										+ habTableName
										+ " hd where d.dcode=m.dcode and m.dcode=p.dcode and m.mcode =p.mcode and p.dcode=v.dcode and p.mcode=v.mcode and p.pcode=v.pcode and substr (h.panch_code,1,2) = v.dcode and substr(h.panch_code,6,2) = v.mcode and substr(h.panch_code,13,2) = v.pcode and substr (h.panch_code,8,3) = v.vcode and h.panch_code=hd.hab_code and hd.coverage_status is not null and hd.coverage_status not in('UI','NW')  and d.dcode='"
										+ rDistrict
										+ "'  and m.mcode='"
								...
								hquery1.delete(0, hquery1.length());
								hquery1.append("select h.panch_code,nvl(CENSUS_PLAIN_POPU,0)+nvl(CENSUS_SC_POPU,0)+nvl(CENSUS_ST_POPU,0),nvl(total_water_supply,0) as totalpop ,nvl(safe_lpcd,0),nvl(unsafe_lpcd,0)  from rws_district_tbl d,rws_mandal_tbl m,rws_panchayat_tbl p,rws_village_tbl v,rws_panchayat_raj_tbl h,"
										+ habTableName
										+ " hd where d.dcode=m.dcode and m.dcode=p.dcode and m.mcode =p.mcode and p.dcode=v.dcode and p.mcode=v.mcode and p.pcode=v.pcode and substr (h.panch_code,1,2) = v.dcode and substr(h.panch_code,6,2) = v.mcode and substr(h.panch_code,13,2) = v.pcode and substr (h.panch_code,8,3) = v.vcode and h.panch_code=hd.hab_code and hd.coverage_status is not null and hd.coverage_status not in('UI','NW')  and d.dcode='"
										+ rDistrict
										+ "'  and m.mcode='"
		...
		<tr>
			...
			<td class="rptValue" style="text-align: left;"><a
				href="rws_habitation_abstract_rpt1.jsp?drill=next1&rDistrict=<%=rDistrict%>&rDistrictName=<%=rDistrictName%>&rMandal=<%=rs2.getString(1)%>&rMandalName=<%=rs2.getString(2)%>&finyear=<%=finYear%>&poptype=<%=poptype%>&lpcdrange=<%=lpcdrange%>"><%=rs2.getString(2)%></a></td>
			<td class="<%=style%>" style="text-align: right;"><%=pcount%></td>
			<td class="<%=style%>" style="text-align: right;"><%=vcount%></td>
			<td class="<%=style%>" style="text-align: right;"><a href="#" onclick="viewWorks('rws_habitation_abstract_overview_drillrpt.jsp?rDistrict=<%=rDistrict%>&rDistrictName=<%=rDistrictName%>&rMandal=<%=rs2.getString(1)%>&rMandalName=<%=rs2.getString(2)%>&finyear=<%=finYear%>&lpcdrange=<%=lpcdrange%>&poptype=<%=poptype%>')"><%=hcount%></a></td>
			<td class="<%=style%>" style="text-align: right;"><%=totalpop%></td>
		...
		<tr>
			...
			<td class=gridhdbg style="text-align: right;"><%=columnTotal1%></td>
			<td class=gridhdbg style="text-align: right;"><%=columnTotal2%></td>
			<td class=gridhdbg style="text-align: right;"><a href="#" onclick="viewWorks('rws_habitation_abstract_overview_drillrpt.jsp?rDistrict=<%=rDistrict%>&rDistrictName=<%=rDistrictName%>&finyear=<%=finYear%>&lpcdrange=<%=lpcdrange%>&poptype=<%=poptype%>')"><font color="#FFFFFF"><%=columnTotal3%></font></a></td>
			<td class=gridhdbg style="text-align: right;"><%=Gtotalpop%></td>
			<td class=gridhdbg style="text-align: right;"><%=columnTotal4%></td>
			<td class=gridhdbg style="text-align: right;"><%=FCpopTotal%></td>
			<td class=gridhdbg style="text-align: right;"><%=columnTotal5%></td>
...
<script type="text/javascript">
	function fncheck() {
		...
		window.location.replace("rws_habitation_abstract_rpt1.jsp?lpcdrange="
				+ lpcdrange);
		alert("lpcdrange" + lpcdrange);
			...
			rs2.previous();
					...
					while (rs2.next()) {
						...
						pQuery.append("select distinct substr(h.hab_code,1,2)||substr(h.hab_code,6,2)||substr(h.hab_code,13,2) from rws_district_tbl d,rws_mandal_tbl m,rws_panchayat_tbl p,rws_village_tbl v,rws_panchayat_raj_tbl h,"
								...
								+ "'  and m.mcode='"
								+ rs2.getString(1) + "'");
						System.out.println("select distinct substr(h.hab_code,1,2)||substr(h.hab_code,6,2)||substr(h.hab_code,13,2) from rws_district_tbl d,rws_mandal_tbl m,rws_panchayat_tbl p,rws_village_tbl v,rws_panchayat_raj_tbl h,"
								+ habTableName
								+ " hd where d.dcode=m.dcode and m.dcode=p.dcode and m.mcode =p.mcode and p.dcode=v.dcode and p.mcode=v.mcode and p.pcode=v.pcode and substr (h.panch_code,1,2) = v.dcode and substr(h.panch_code,6,2) = v.mcode and substr(h.panch_code,13,2) = v.pcode and substr (h.panch_code,8,3) = v.vcode and h.panch_code=hd.hab_code and hd.coverage_status is not null and hd.coverage_status not in('UI','NW')  and d.dcode='"
								+ rDistrict
								+ "'  and m.mcode='"
						...
						if (lpcdrange.toString().equals("55")) {
							//System.out.println("in 55 lpcd");
							while (hrs.next()) {
											System.out.println("if 55 Before hcount :"+hcount);
								hcount++;
								System.out.println("if 55 After hcount :"+hcount);
								totalpop = totalpop + hrs.getInt(4);
								int total_pop = hrs.getInt(4);
								////System.out.println("totalpop="+total_pop);
								double water_supply = hrs.getDouble(2);
							...
							//System.out.println("in 40 lpcd");
							while (hrs.next()) {
								System.out.println("else Before hcount :"+hcount);
								hcount++;
								System.out.println("else After hcount :"+hcount);
								totalpop = totalpop + hrs.getInt(2);
								int total_pop = hrs.getInt(2);
								////System.out.println("totalpop="+total_pop);
								double water_supply = hrs.getDouble(3);
...
<body bgcolor="#edf2f8">
	...
	<table border=1 cellspacing=0 cellpadding=0 height=5% width="100%"
		...
		<%
			rs2.previous();
					...
					while (rs2.next()) {
						...
						hquery1.delete(0, hquery1.length());
						hquery1.append("select h.panch_code,nvl(CENSUS_PLAIN_POPU,0)+nvl(CENSUS_SC_POPU,0)+nvl(CENSUS_ST_POPU,0),nvl(safe_lpcd,0),nvl(unsafe_lpcd,0),nvl(total_water_supply,0)  from rws_district_tbl d,rws_mandal_tbl m,rws_panchayat_tbl p,rws_village_tbl v,rws_panchayat_raj_tbl h,"
								+ habTableName
								+ " hd where d.dcode=m.dcode and m.dcode=p.dcode and m.mcode =p.mcode and p.dcode=v.dcode and p.mcode=v.mcode and p.pcode=v.pcode and substr (h.panch_code,1,2) = v.dcode and substr(h.panch_code,6,2) = v.mcode and substr(h.panch_code,13,2) = v.pcode and substr (h.panch_code,8,3) = v.vcode and h.panch_code=hd.hab_code and hd.coverage_status is not null and hd.coverage_status not in('UI','NW')  and d.dcode='"
								+ rDistrict
								+ "'  and m.mcode='"
							...
							while (hrs.next()) {
								...
								if (safelpcd == 0 && unsafelpcd != 0) {
									...
									if (safelpcd == 0) {
										...
										count1++;
										FCpop = FCpop + total_pop; System.out.println("FCpop :"+FCpop);
									} else if (safelpcd > 0 && safelpcd <= 10) {
										count2++;
										PC1pop = PC1pop + total_pop;
									} else if (safelpcd > 10 && safelpcd <= 20) {
		...
		<tr>
			<td class="<%=style%>"><%=sno++%></td>
			<td class="rptValue" style="text-align: left;"><a
				href="rws_habitation_abstract_rpt1.jsp?drill=next2&rDistrict=<%=rDistrict%>&rDistrictName=<%=rDistrictName%>&rMandal=<%=rMandal%>&rMandalName=<%=rMandalName%>&rPanchayat=<%=rs2.getString(1)%>&rPanchayatName=<%=rs2.getString(2)%>&finyear=<%=finYear%>&poptype=<%=poptype%>&lpcdrange=<%=lpcdrange%>"><%=rs2.getString(2)%></a></td>
			<!-- <td class="<%=style%>"><%=pcount%></td>-->
			<td class="<%=style%>" style="text-align: right;"><%=vcount%></td>
			<td class="<%=style%>" style="text-align: right;"><a href="#" onclick="viewWorks('rws_habitation_abstract_overview_drillrpt.jsp?rDistrict=<%=rDistrict%>&rDistrictName=<%=rDistrictName%>&rMandal=<%=rMandal%>&rMandalName=<%=rMandalName%>&rPanchayat=<%=rs2.getString(1)%>&rPanchayatName=<%=rs2.getString(2)%>&finyear=<%=finYear%>&lpcdrange=<%=lpcdrange%>&poptype=<%=poptype%>')"><%=hcount%></a></td>
			<td class="<%=style%>" style="text-align: right;"><%=totalpop%></td>
			<td class="<%=style%>" style="text-align: right;"><%=count1%></td>
			<td class="<%=style%>" style="text-align: right;"><%=FCpop%></td>
			<td class="<%=style%>" style="text-align: right;"><%=count5%></td>
		...
		<tr>
			...
			<td class=gridhdbg style="text-align: right;"><%=columnTotal2%></td>
			<td class=gridhdbg style="text-align: right;"><a href="#" onclick="viewWorks('rws_habitation_abstract_overview_drillrpt.jsp?rDistrict=<%=rDistrict%>&rDistrictName=<%=rDistrictName%>&rMandal=<%=rMandal%>&rMandalName=<%=rMandalName%>&finyear=<%=finYear%>&lpcdrange=<%=lpcdrange%>&poptype=<%=poptype%>')"><font color="#FFFFFF"><%=columnTotal3%></font></a></td>
			<td class=gridhdbg style="text-align: right;"><%=Gtotalpop%></td>
			<td class=gridhdbg style="text-align: right;"><%=columnTotal4%></td>
			<td class=gridhdbg style="text-align: right;"><%=FCpopTotal%></td>
			<td class=gridhdbg style="text-align: right;"><%=columnTotal5%></td>
		...
		<%
			rs2.previous();
					...
					while (rs2.next()) {
						...
						hquery1.delete(0, hquery1.length());
						hquery1.append("select h.panch_code,nvl(CENSUS_PLAIN_POPU,0)+nvl(CENSUS_SC_POPU,0)+nvl(CENSUS_ST_POPU,0),nvl(total_water_supply,0),nvl(safe_lpcd,0),nvl(unsafe_lpcd,0)  from rws_district_tbl d,rws_mandal_tbl m,rws_panchayat_tbl p,rws_village_tbl v,rws_panchayat_raj_tbl h,"
								+ habTableName
								+ " hd where d.dcode=m.dcode and m.dcode=p.dcode and m.mcode =p.mcode and p.dcode=v.dcode and p.mcode=v.mcode and p.pcode=v.pcode and substr (h.panch_code,1,2) = v.dcode and substr(h.panch_code,6,2) = v.mcode and substr(h.panch_code,13,2) = v.pcode and substr (h.panch_code,8,3) = v.vcode and h.panch_code=hd.hab_code and hd.coverage_status is not null and hd.coverage_status not in('UI','NW')  and d.dcode='"
								+ rDistrict
								+ "'  and m.mcode='"
