...
try
{
   ...
   String habqry="select a.work_id,a.work_name,a.SANCTION_AMOUNT,to_char(a.ADMIN_DATE,'dd/mm/yyyy'),NO_OF_HABS  from RWS_WORK_ADMN_TBL a,rws_district_tbl i  where  work_cancel_dt is null  and   a.work_id not in (select work_id from rws_work_completion_tbl where (to_date(DATE_OF_COMPLETION) < '01-Apr-"+startyr+"')) and  substr(a.work_id,5,2)=i.dcode";
	...
	habqry+=" and a.programme_code in ("+programe+")  group by  a.work_id,a.work_name,a.SANCTION_AMOUNT,to_char(a.ADMIN_DATE,'dd/mm/yyyy'),NO_OF_HABS";
