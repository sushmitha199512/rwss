...
<tr><td  class=rptHeading>Opening Balance in the District:&nbsp;<%=dname%> and Division:&nbsp;<%=divname%>  and Program:&nbsp;<%=pname%></td></tr></table><BR>
...
int count=0;
String qry = "";
qry = "select HEAD_OF_ACCOUNT,OP_CL_BAL,programme_name from RWS_GRANT_OP_CL_BAL_TBL a,rws_programme_tbl p where  a.programme_code=p.programme_code and substr(office_code,2,3)='"+dcode+divcode+"' and a.programme_code='"+pcode+"'";
