...
function getDateObject(dateString,dateSeperator)
{
	...
	function fnSubmit()
	{
		var loggedUser = '<%=loggedUser%>';
            ...
            if(document.f1.admindate.value=='')
			{
			...
			else
			{
				...
				document.f1.action="./rws_admindroughtworks_rpt.jsp";
				document.f1.submit();
			}	
		}
		</script>
...
<table border = 1 align = center cellspacing = 0 cellpadding = 0 rules = "rows" bordercolor = navy style = "border-collapse:collapse" bgcolor="#ffffff" width=350>		
	...
	<tr bgcolor="#8A9FCD" align="center">
		<td align="center" class="rptHeading" colspan=3>Drought Works Report</td>	
	</tr>
	<%
try
{
...
%>
<tr><td class=rptLabel>Admin Sanction Year&nbsp;&nbsp;</td>
		<td class=btext>
		<SELECT name="admindate" id="combo" class="mycombo" style="width:150px" >
            ...
            try
{
			...
			query="select  distinct to_char(admin_date,'yyyy') from rws_drought_works_tbl order by to_char(admin_date,'yyyy')";
