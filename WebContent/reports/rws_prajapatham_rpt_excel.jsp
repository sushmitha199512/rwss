...
<%
	query2="SELECT P.WORK_ID ,UPPER(P.WORK_NAME)WORK_NAME ,P.DCODE,P.MCODE,P.HAB_CODE  ,P.WORK_NAME  ,P.ESTIMATE_COST ,"+  
		...
		" to_char(P.ADMN_SANC_DATE,'DD-MON-YY')ADMN_SANC_DATE    ,to_char(P.GROUND_DATE,'DD-MON-YY')GROUND_DATE     ,to_char(P.COMPLETION_DATE,'DD-MON-YY')COMPLETION_DATE   ,P.EXP_UPTO_THE_PRE_MONTH ,EXP_DUR_THE_MONTH ,EXP_TO_BE_INCURRED,"+    
		" UPPER(PHY_STAGE_OF_WORK)PHY_STAGE_OF_WORK,UPPER(P.REMARKS)REMARKS,"+
		
		" V.VCODE,V.VNAME, "+
		
		" DECODE(PE.EXIST_CPWS ,'Y','Yes','N','')EXIST_CPWS,"+
		...
		" PE.OTHER_DETAILS,HD.COVERAGE_STATUS  FROM rws_habitation_directory_tbl HD,rws_prajapadam_tbl P,RWS_PRAJAPADAM_EXIST_SCH_TBL PE,RWS_PROGRAMME_TBL PR,RWS_SUBPROGRAMME_TBL SPR,RWS_VILLAGE_TBL V WHERE P.HAB_CODE=PE.HAB_CODE AND PR.PROGRAMME_CODE=P.PROGRAMME_CODE AND P.PROGRAMME_CODE=SPR.PROGRAMME_CODE(+) AND P.SUBPROGRAMME_CODE=SPR.SUBPROGRAMME_CODE(+)"+
