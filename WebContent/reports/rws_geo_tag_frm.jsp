	...
	<script type="text/javascript">
		...
		/* 	 if(document.forms[0].fromDate.value==""){
			...
			/* 	 var fDate=getDateObject(document.forms[0].fromDate.value,"/");
				 ...
				 if(fDate<=tDate){ */
					 document.forms[0].action="./switch.do?prefix=/reports&page=/geoTagging.do&mode=view";
		 ...
		 function pp() {	
			 ...
			 if(msg=='Data Sucessfully Downloaded') {		
				  ...
				  document.forms[0].action="./switch.do?prefix=/reports&page=/geoTagging.do&mode=view1";
				  document.forms[0].submit();
				  return true;
			 }
			 if(msg=='Zip is Ready To Download') {
				  document.getElementById('container').style.display='none';
				  document.forms[0].action="./switch.do?prefix=/reports&page=/geoTagging.do&mode=zip";
					 document.forms[0].submit();
					 return true;
			 }	
		}
...
<body onload="pp();" >
	<html:form action="/geoTagging.do" >
		<center>
		<jsp:include page="/commons/TableHeader.jsp">
			<jsp:param name="TableName" value="GEO Tagging Format Download Form " />
			<jsp:param name="TWidth" value="350" />
		</jsp:include>
		<table bgcolor="#DEE3E0" bordercolor="#8A9FCD" rules="none" width="390" border=1 style="border-collapse:collapse;" >
			<tr>
