...
//    int totalconstructed=0,pop=0,housholdsnc=0,toilethav=0,toiletnothav=0;
   qry="select USER_ID,to_char(ACCESS_DATE,'dd/mm/yyyy'),ACCESS_TIME ,MODULE,ADDRESS from rws_log_tbl a where user_id='"+UserId+"' and trunc(ACCESS_DATE)=to_date('"+laggdate+"','dd/mm/yyyy')";
