...
{ %>
			<tr><td align="right" class="bwborder"><a href="/pred/home.jsp?loginMode=watersoft">Home|</a></td>
				<td class="bwborder"><a href="./Rws_Scsp_ActionPlan_1415_Frm.jsp">Back|</a><a href="./Rws_Scsp_ActionPlan_1415_Excel.jsp" target=_new>Excel</a></td></tr>
<%  } else {%>
...
//System.out.println("expQuery"+expQuery);
	 	...
	 	Hashtable expHash=new Hashtable();
		  ...
		  if(rs2!=null)rs2.close();
			...
			stmt2=conn.createStatement();
			String expQuery1="select W.WORK_ID,sum(voucher_Amt)/100000 FROM RWS_WORK_ADMN_TBL W ,rws_work_exp_voucher_tbl exp  where w.work_id=exp.work_id and  (to_date(voucher_dt)>= '01-APR-"+startyr+"' and to_date(voucher_dt)< '01-APR-"+endyr+"') and w.work_id not in (select work_id from rws_work_completion_tbl where DATE_OF_COMPLETION is not null and (to_date(DATE_OF_COMPLETION) < '01-Apr-"+startyr+"'))  ";
