	...
	while(rs1.next())
	 {
	   ...
	   if(HouseConnection!=null)
            {
			 Query4="insert into PhysicalMPR values('"+SchemeId+"','"+Habitationid+"','"+Monthid+"','"+yr+"','"+SCPopCovered+"','"+STPopCovered+"','"+GenPopCovered+"','"+HouseConnection+"','"+pstatus+"')"; //correct
		    }
       else
           {
             Query4="insert into PhysicalMPR values('"+SchemeId+"','"+Habitationid+"','"+Monthid+"','"+yr+"','"+SCPopCovered+"','"+STPopCovered+"','"+GenPopCovered+"','0','"+pstatus+"')"; //correct
		   } 
