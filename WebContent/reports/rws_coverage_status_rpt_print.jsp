...
<table border = 1 cellspacing = 0 cellpadding = 0 width=100% height=20%  bordercolor=#000000 style="border-collapse:collapse" >
<caption>
	...
	<tr >
		<td class="textborder" align="center" colspan="7">
			<b>Habitation Coverage Status  Report </td>
	</tr>
<tr><td valign=top>
<% if(!dCode.equals("51")) {%>
