...
<caption>
			<table  border=0 rules=none style="border-collapse:collapse" align = "right">		
				<tr>
					...
					<a href="../home.jsp">Home</a> |<a href="./rws_wq_ground_waterquality_data_pre_district_rpt_excel.jsp?District:&nbsp;&nbsp;<%=dName%> ">Excel</a></td>
				</tr>
			</table>
			</caption>
</table>
<table border = 0 cellspacing = 0 cellpadding = 0  width=100%  style="border-collapse:collapse">
<tr><td  align="center" class=gridhdbg>Water Quality Ground Data  Pre-Monsoon (01-March-<%=y %> to 31-May-<%=y %>)</td></tr>
</table>
