...
%> 
 <tr><td class=btext colspan=4><%=++count%>.Contractor Name:<%out.println(rs.getString(1));%>&nbsp;&nbsp;&nbsp;TransactionId:<%=rs.getString(2)%>&nbsp;</td></tr>
  <tr>
   <td>
   <table border=1 cellspacing = 0 cellpadding = 0  width=50%  bordercolor=#000000 style="border-collapse:collapse">
	   <td class=btext width="15%" align="center"><font color="red">Work Id</font></td>
	   <td class=btext width="50%" align="center"><font color="red">Work Name</font></td>
	   <td class=btext width="15%" align="center"><font color="red">Bill No</font></td>
	   <td class=btext width="20%" align="center"><font color="red">Bill Amount  Processed<br>(In Rupees)</font></td>
	</tr>
 <%
double amt=0.0;
