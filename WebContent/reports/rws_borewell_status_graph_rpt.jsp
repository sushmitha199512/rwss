...
<caption>
	<table  border=0 rules=none style="border-collapse:collapse" align = "right">
		<tr align="right">
			<td class="bwborder">
				<a href="./rws_graph_frm.jsp">Back |</a>
	...
	<tr bgcolor="lavander">
		<td class="textborder" align="center" colspan="7">
			<font color="ffffff">Borewell Status Graph  </font></td>
	</tr>
...
try
	...
	if(district.equals("51")){
		...
		%>	<%@ include file="./rws_borewell_dist_tot_rpt.jsp" %>
	 ...
	 <%@ include file = "rws_coverage_graph1.jsp"%>	
	<%
	}
	catch(Exception ee)
	{
