...
session.setAttribute("distCode",district);
session.setAttribute("mandCode",mandal);
session.setAttribute("panchCode",panchayat);
session.setAttribute("distName",request.getParameter("dName"));
session.setAttribute("mandName",request.getParameter("mName"));
session.setAttribute("panchName",request.getParameter("pName"));
