	 ...
	 var logValue = '<%=loggedUser%>';
		...
		if(document.f1.combo1.value=='0')
			...
			alert("Please Select Sub Programme");
				...
				if(cyear!=year1){     
					document.f1.action="./rws_performance_mvs_scst_rpt1.jsp";
                	document.f1.submit();
            }else {
            	document.f1.action="./rws_performance_mvs_scst_rpt.jsp";
				document.f1.submit();
			}	
		  }
		}
...
<%} %>
	...
	<tr bgcolor="#8A9FCD" align="center">
		<td align="center" class="rptHeading" colspan=4>PLAIN,SC,ST Works MVS - Abstract </td>
	</tr>
...
<td class=rptLabel>&nbsp;&nbsp;&nbsp;Sub Program&nbsp;&nbsp;<br>
		&nbsp;&nbsp;&nbsp;<SELECT name="subProg" id="combo3" style="width:120px" size=5 class="hightlongcombo" >
