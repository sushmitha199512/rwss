...
String categorycode="";
String year=request.getParameter("admindate");
...
String adminyear=request.getParameter("admindate");
session.setAttribute("adminyear",adminyear);
...
String gtxidValueOld = "",gtxidValue="";%>
	...
	</a><a href="./rws_admindroughtworks_xls.jsp" target=_new>Excel</a></td>
	</tr>  
	</table>
	</caption>
	<tr bgcolor="#8A9FCD" align="center">
	<td align="center" class="rptHeading" > Drought Works Report ( Detailed )</td>
	</tr>
	<tr bgcolor="#8A9FCD" align="center">
	<td class=btext>District:<font color=red><%=dname%></font>&nbsp;&nbsp;&nbsp;&nbsp;Year:<font color=red><%=adminyear%> </font></td>
	</tr>
	</table>
