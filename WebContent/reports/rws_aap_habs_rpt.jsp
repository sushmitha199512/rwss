...
<%System.out.println("ccode:fgfdgfdgfdg");%>
<%@ include file="/commons/rws_header1.jsp"%>
<%@ include file="conn.jsp"%>
<%
String dcode=request.getParameter("dcode");
String dname=request.getParameter("dname");
String ccode="",finYear="";
...
<tr>
	...
	String query="";
			...
			query=" SELECT distinct w.hab_code ,h.coverage_status,panch_name  FROM RWS_ADMN_hab_lnk_TBL W,rws_aap_selected_tbl b ,rws_work_admn_tbl c ,rws_habitation_directory_tbl h,rws_complete_hab_view ch where w.work_id=b.work_id  and substr(b.work_id,5,2)='"+dcode+"' and c.work_id=b.work_id and w.hab_code=h.hab_code  and ch.panch_code=h.hab_code and b.fin_year='"+finYear+"'";
