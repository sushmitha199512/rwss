...
<tr bgcolor="#8A9FCD" align="center">
		<td align="center" class="rptHeading" colspan="14"> Handpumps - No Borewells Report</td>
</tr>
...
try
{
		 ...
		 while(rs8.next())
		{
			 ...
			 String query55="select  c.mcode,a.asset_name,a.location,to_char(date_creation,'dd/mm/yyyy'),decode(a.asset_status,'1','Working','2','Not Working','3','Dried','4','Seasonal','5','Condemed')result,a.asset_cost,a.hab_code,c.panch_name,a.asset_code from rws_asset_mast_tbl a,rws_asset_scheme_tbl b,rws_complete_hab_view c where a.asset_code=b.asset_code and a.hab_code=c.panch_code and type_of_asset_code='"+assettype+"' and c.dcode='"+district+"' and a.asset_code='"+assetcode+"'";
			 ...
			 while(rs10.next())
				...
				<td class=rptValue><%=isNull(rs9.getString(9))%></td>
