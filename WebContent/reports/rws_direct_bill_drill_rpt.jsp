...
<td class=gridhdbg ><b>Sanction(lakhs)   </b></td>


<td class=gridhdbg ><b>Bill&nbsp;No </b></td>
<td class=gridhdbg ><b>Bill&nbsp;Sl&nbsp;No </b></td>

 <td class=gridhdbg ><b>Bill DATE </b></td>
<td class=gridhdbg ><b>Bill&nbsp;Amount&nbsp;Admissible  </b></td>
...
int habsCovered=0;
double billcount=0,sancount=0.0,gsancount=0.0;
...
query="SELECT w.WORK_ID,w.WORK_NAME,nvl(to_char(m.BILL_DATE ,'dd/mm/yyyy'),'-'),SANCTION_AMOUNT ,CATEGORY_CODE,m.BILL_AMT_ADMISSIBLE,m.BILL_SL_NO,m.BILL_NO   FROM RWS_WORK_ADMN_TBL W,rws_work_direct_bill_tbl  m   where  w.work_id=m.work_id  and work_cancel_dt is null and  substr(w.office_code,2,2)='"+circleofficecode+"' and substr(w.office_code,4,1)='"+divisionofficecode+"'  and  w.programme_code in ('04','57','65','46','12')  ";
