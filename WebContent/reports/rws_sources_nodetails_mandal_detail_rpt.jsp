...
<caption>
		<table  border=0 rules=none style="border-collapse:collapse" align = "right">			
			<tr align="right">
				...
				<td class="bwborder"><a href="./rws_sources_nodetails_mandal_detail_excel_rpt.jsp" target="_new">Excel</a></td>
...
try
{
			...
			<td class=rptValue align="right"><%=isNull(rs4.getString(5))%></td>
