...
response.setHeader("Content-Disposition", "inline; filename=" + "TSP 14-15 Action Plan Details.xls");
...
<tr >
		<td align="center"  colspan=53>Spillover Infrastructure Works Proposed Under TSP 2014-15 for the Benefit of the ST Habitations  (<%=pname %>) .</td>	
	</tr>
		<tr>
...
<td   colspan=1 "  rowspan="2" align="center">Total</td>	
		<td    colspan=1   rowspan="2" align="center">Under TSP</td>	
		<td   colspan=1    rowspan="2" align="left">Under Other Funds</td>
...
<!-- <td   colspan=1   align="center">PLAIN</td>	
 ...
 -->		
		<td   colspan=1   align="center">PLAIN</td>	
		<td    colspan=1  align="center">SC</td>	
		<td   colspan=1  align="left">Under TSP</td>
		<td   colspan=1   align="center">PLAIN</td>	
		<td    colspan=1  align="center">SC</td>	
		<td   colspan=1  align="left">Under TSP</td>
  ...
  try{
	...
	System.out.println("New Works"+newWorksQuery);
		...
		while(rs2.next())
		{
			...
			double totsanamt=0,underscexp=0,underotherexp=0;
		 	...
		 	double  existingWaterLevel=0,myamt=0;
				...
				underscexp=(scstateshare/totPop_exp)*stPOP;
				...
				//plaina+=(balanceEST*gen)/totalp;
		 		...
		 		<td class=<%=style %> style="text-align: right;" onmouseover="Tip('Under TSP Sanctioned Amount',TITLE,'Information')" onmouseout="UnTip()" ><%=uscexp %></td>
		 		<td class=<%=style %> style="text-align: right;" onmouseover="Tip('Under Other TSP Sanctioned Amount',TITLE,'Information')" onmouseout="UnTip()" ><%=ndf.format(totsanamt-underscexp) %></td>
	 ...
	 --%>	 		<td class=<%=style %> style="text-align: center;" onmouseover="Tip('Clause Type',TITLE,'Information')" onmouseout="UnTip()"><%=clauseType %></td>
		 		...
		 		<td class=<%=style %> style="text-align: right;" onmouseover="Tip('Under Other TSP',TITLE,'Information')" onmouseout="UnTip()"><%=ndf.format(glTotExp-lScExp) %></td>
		 	 --%>	
		 		...
		 		<td class=<%=style %> style="text-align: right;" onmouseover="Tip('Likely - Under Funds',TITLE,'Information')" onmouseout="UnTip()"><%=ndf.format(glNTotExp-lNStExp) %></td>
		 		...
		 		<td class=<%=style %> style="text-align: right;" onmouseover="Tip('Cumm. Under Other Funds',TITLE,'Information')" onmouseout="UnTip()"><%=ndf.format(totExpDur-expSt)  %></td>
			...
			else
			{
		 	...
		 	<td class=gridhdbg style="text-align: right;"  onmouseover="Tip('Work Wise: TSP Amount',TITLE,'Information')" onmouseout="UnTip()" ><%=ndf.format(gunderscexp) %></td>
		 	<td class=gridhdbg style="text-align: right;"  onmouseover="Tip('Work Wise: Other TSP Sanctioned Amount',TITLE,'Information')" onmouseout="UnTip()"><%=ndf.format(gtotsanamt-gunderscexp) %></td>
		 ...
		 --%> 	<%-- <td class=gridhdbg style="text-align: right;" onmouseover="Tip('Work Wise: State Share Of Plain Estimate Cost',TITLE,'Information')" onmouseout="UnTip()"><%=ndf.format(gstateplainEST) %></td>
		  ...
		  --%>	<td class=gridhdbg><%=clauseType1 %></td><td class=gridhdbg style="text-align: center;"><%=subplanSubmitted %></td>
		 	...
		 	<td class=gridhdbg style="text-align: right;" onmouseover="Tip('Work Wise: Under Other TSP',TITLE,'Information')" onmouseout="UnTip()"><%=ndf.format(glTotTot-glScTot) %></td>
		 --%> 	
		 	...
		 	<td class=gridhdbg style="text-align: right;" onmouseover="Tip('Work Wise: Likely - Under Other TSP',TITLE,'Information')" onmouseout="UnTip()"><%=ndf.format(glNTotTot-glNStTot) %></td>
		 	...
		 	<td class=gridhdbg style="text-align: right;" onmouseover="Tip('Work Wise: Cumm.Under Other Funds',TITLE,'Information')" onmouseout="UnTip()"><%=ndf.format(gExpTot-gExpSt) %></td>
		...
		<td class=gridhdbg style="text-align: right;"  onmouseover="Tip('TSP Estimate Cost',TITLE,'Information')" onmouseout="UnTip()"><%=ndf.format(ggunderscexp) %></td>
		<td class=gridhdbg style="text-align: right;"  onmouseover="Tip('Other TSP Balance Estimate Cost',TITLE,'Information')" onmouseout="UnTip()"><%=ndf.format(ggtotsanamt - ggunderscexp) %></td>	
	 ...
	 --%>	<td class=gridhdbg>-</td>
		...
		<td class=gridhdbg style="text-align: right;" onmouseover="Tip('Under Other TSP',TITLE,'Information')" onmouseout="UnTip()"><%=ndf.format(gglTotExp-gglScExp) %></td>
	 --%>	
		...
		<td class=gridhdbg style="text-align: right;" onmouseover="Tip(' Likely - Under Other SCSp',TITLE,'Information')" onmouseout="UnTip()"><%=ndf.format(gglNTotExp-gglNStExp) %></td>
		...
		<td class=gridhdbg style="text-align: right;" onmouseover="Tip('Cumm. Underother Funds  Expenditure.',TITLE,'Information')" onmouseout="UnTip()"><%=ndf.format(ggexpTot-ggexpSt) %></td>
