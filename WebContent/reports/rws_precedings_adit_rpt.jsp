...
//System.out.println("tname:::::::::::::"+tname);
   ...
   if(pname.equals("01,48,49,02"))
    {
    prname = "COVERAGE";
    qrystr="((d.programme_code='01' and d.subprogramme_code in(00,01,02,03,04,07,08)) or (d.programme_code in (48,49,02)))";
    }
    if(pname.equals("18,51"))
    {
    prname = "QUALITY";
    qrystr="d.programme_code in(18,51)";
    }
    if(pname.equals("50,01"))
    {
    prname = "SUSTAINBILITY";
    qrystr="((d.programme_code='01' and d.subprogramme_code in(06)) or (d.programme_code in (50)))";
    }
    if(pname.equals("32,60,01,23"))
    {
    prname = "O & M";
    qrystr="((d.programme_code='01' and d.subprogramme_code in(05)) or (d.programme_code in (32,60,23)))";
    }
    if(pname.equals("11,58"))
    {
      prname = "DDP";
      qrystr="d.programme_code in(11,58)";
    }
    if(pname.equals("59"))
    {
     prname = "CALAMITY";
     qrystr="d.programme_code in(59)";
    }
   ...
   if(qrystr!=null)
	{ session.setAttribute("qrystr",qrystr);
	}
    ...
    String dno=request.getParameter("division");
    //System.out.println("div"+dno);
    String divqry="";
	if(dno!=null)
	{
    ...
    if(dno!=null && dno.equals("00"))
    { 
    divqry="";
    }

    else if(dno!=null && !dno.equals("00"))
	{
      divqry="substr(d.office_code,2,3)='"+dno+"' and";
	}
   session.setAttribute("divqry",divqry);
  ...
  System.out.println("divisionnnnnnnnnnnnnnnnnnnn"+request.getParameter("division"));
...
<script>
          alert("No Records...");
          document.f1.action="./rws_precedings_adit_frm.jsp";
		  document.f1.submit();
</script>
<%}
}
