...
<table width="20%" border=0 rules=none style="border-collapse:collapse" align = right>
	<tr>
		...
		<td colspan=8 align=right><a href="./rws_designation_prnt_rpt.jsp" target="_new">Print</a></td>		
	</tr>
</table>
</caption>
<br>
...
<table border = 1 cellspacing = 0 cellpadding = 0 width=100%  bordercolor=#000000 style="border-collapse:collapse" bgcolor="#ffffff">
	<tr bgcolor="lavander">
		<td class=textborder><font color="#ffffff">List of Designation Codes / Names</td>
	</tr>
</table>
<table border = 1 cellspacing = 0 cellpadding = 0 width=100%  bordercolor=#000000 style="border-collapse:collapse" bgcolor="#ffffff">
	<tr align=center bgcolor="#ffffff">
		<td class=clrborder>SL.No</td>
		<td class=clrborder>Designation Code</td>
		<td class=clrborder>Designation Acronym</td>
		<td class=clrborder>Designation Name</td>		
	</tr>
