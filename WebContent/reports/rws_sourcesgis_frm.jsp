		...
		var loggedUser = '<%=loggedUser%>';
			...
			else
			{
				if(loggedUser=="admin"||loggedUser=="100000" ||loggedUser=="guest")
				{
					...
					document.f1.sname.value = document.f1.categorytype.options[document.f1.categorytype.selectedIndex].text; 
				...
				document.f1.action="./rws_sourcegis_rpt.jsp";
				document.f1.submit();
			}	
		}
		</script>
...
<table border = 1 align = center cellspacing = 0 cellpadding = 0 rules = "rows" bordercolor = navy style = "border-collapse:collapse" bgcolor="#ffffff" width=350>		
	...
	<tr bgcolor="#8A9FCD" align="center">
		<td align="center" class="rptHeading" colspan=3>GIS Sources  Information - Report</td>	
	</tr>
	<%
try
{
...
%>
	...
	<tr>
		    <td class=rptLabel>Source Type <td class=btext>
  
 			<select name="categorytype" id="ctype" styleClass="mycombo" style="width:220px" >
						<option value="SURFACE"><font class="myfontclr1">SURFACE </option>
			<option value="SUBSURFACE"><font class="myfontclr1">SUBSURFACE  </option>
             
            <option value="SUBSURFACE(Handpump)"><font class="myfontclr1">SUBSURFACE(Handpump)  </option>
            <option value="SUBSURFACE(ShallowHandpump)"><font class="myfontclr1">SUBSURFACE(ShallowHandpump)  </option>
            <option value="SUBSURFACE(Openwell)"><font class="myfontclr1">SUBSURFACE(Openwell)  </option>
            			<option value="GLSR"><font class="myfontclr1">GLSR </option>
                        <option value="GLBR"><font class="myfontclr1">GLBR </option>
                        <option value="OHSR"><font class="myfontclr1">OHSR</option>
