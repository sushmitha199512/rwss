...
<tr>
<td align="right"><a href="javascript:history.go(-1)">Back</a>|<a href="rws_asset_statement_xls_rpt.jsp?per=<%=per%>" target="_new">Excel</a>|<a href="../home.jsp">Home</a></td>
</tr>
</table>
<table border = 1 cellspacing = 0 cellpadding = 0 bordercolor=#000000 style="border-collapse:collapse" bgcolor="#ffffff">
	<tr>
		<td class="textborder" align="left">Select Date(Asset Created)<span class="mandatory">*</span></td>
		<td><input type="text" name="per" style="width:70px"  value="<%=per%>" readonly>
		<a href="javascript: showCalendar(document.forms[0].per);"><IMG SRC="<rws:context page='/images/calendar.gif'/>" width="20" border="0" height="17" align="absmiddle"></a>
		</td>
	</tr>
	<tr>
...
<table border = 1 cellspacing = 0 cellpadding = 0 width=100%  bordercolor=#000000 style="border-collapse:collapse" bgcolor="#ffffff">	
	<tr  align="center">
		<td align="center" class="btext" colspan=38>District: All&nbsp;&nbsp;&nbsp;Assets As on Date:<font color=red><%=per%></font></td>		
	</tr>	
	<tr align="center">
	...
	while(rs3.next())
	{
		...
		if(rs1.next())
		{
			...
			%>
				...
				<td class="rptValue" align="right"><%=ndf.format(Double.parseDouble(rs4.getString(1)))%></td>
			...
			<%
			col3 += rs1.getInt(1);col4+= rs1.getInt(3);col5 += Integer.parseInt(pop);col6 += rs4.getDouble(1);
		...
		if(rs2.next())
		{
			...
			%>
				...
				<td class="rptValue" align="right"><%=ndf.format(Double.parseDouble(rs5.getString(1)))%></td>
			...
			<%
			col11 += rs2.getInt(1);col12+= rs2.getInt(3);col13 += Integer.parseInt(pop1);col14 += rs5.getDouble(1);
