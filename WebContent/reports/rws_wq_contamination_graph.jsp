...
<%   
	...
	dist[0]="NSS";	data[0]=totfc;
	dist[1]="Flouride";	data[1]=totpc1;
	dist[2]="TDS";data[2]=totpc2;
	dist[3]="Salinity";	data[3]=totpc3;
...
//		   //System.out.println("value of c is  "+c);
	...
	ch.addTitle("Parameter Wise Contaminated Habitations", "times new roman Bold Italic",12);
...
String ss[]=new String[c];
  ...
  for(j=0;j<c;j++){
	...
	if(x.equals("b"))
   {
	...
	ch.addTitle("Parameter Wise Contaminated Habitations ", "Arial Bold", 10);
	//ch.setPlotArea(40, 40, 200, 150);
	ch.yAxis().setTitle("No. of Habitations");
	ch.xAxis().setTitle("Contaminated Parameters");
...
if(x.equals("p"))
 {
    ...
    ch.addTitle2(Chart.Top, "Parameter Wise Contaminated Habitations ", "Times New Roman Bold Italic",13);
	ch.set3D();
