...
<table border = 1 cellspacing = 0 cellpadding = 0 height=5% width="100%" bordercolor=#000000 style="border-collapse:collapse" bgcolor="#ffffff" align = "center">
	<caption>
		<table  border=0 rules=none style="border-collapse:collapse" align = "right">			
			<tr align="right">
				...
				<td class="bwborder"><a href="./rws_work_valueofwork_notpaid_excel.jsp?district=<%=rDistrict%>&planNonplan=<%=planCode%>" target=_new">Excel</a></td>
	...
	//  //System.out.println("query1:"+query1);
	 ...
	 while(rs2.next()){ 
	   ...
	   if(count!=0 && count>0){
	   %><td class=rptValue><a href="./rws_works_name_notpaid_rpt.jsp?&district=<%=rs1.getString(1)%>&plancode=<%=planCode%>"><%=count%></td><%}
	  ...
	  // ////System.out.println("query2:"+query2);
	    ...
	    if(count1>0){%>
	    <td class=rptValue><%=count1%></td><%}else {%> <td class=rptValue>-</td><%}
	    if(samt>0.0){%>
	    <td class=rptValue><%=samt%></td><%}else{%>
	    ...
	    if(exp>0.0){%>
	    <td class=rptValue><%=ndf.format(Math.round(exp*100)/100f)%></td><%}else{%><td class=rptValue>-</td><%}
	    if(expduring>0.0){%>
	     <td class=rptValue><%=ndf.format(Math.round(expduring*100)/100f)%></td><%}else{%>
	     <td class=rptValue>-</td> <%}%>
	     <% float tot=exp+ expduring; 
	     if(tot>0.0){ %>
	     <td class=rptValue><%=ndf.format(Math.round(tot*100)/100f)%></td><%}else{ %>
	     <td class=rptValue>-</td><%}%>
	    ...
	    if(value>0.0){%>
	   <td class=rptValue><%=value%></td><%}else{%>
	     <td class=rptValue>-</td> <%}%>
	   <%
	    ...
	    value=0;
	   	...
	   	<tr>
			...
			<%if(columnTotal1>0){%>
			<td class=rptValue><%=columnTotal1%></td><%}else{%><td class=rptValue>-</td><%}%> 
			<%if(columnTotal2>0){%>
			<td class=rptValue><%=columnTotal2%></td><%}else{%><td class=rptValue>-</td><%}%> 
		    <%if(columnTotal3>0.0){%>
			<td class=rptValue><%=ndf.format(Math.round(columnTotal3*100)/100f)%></td><%}else{%><td class=rptValue>-</td><%}%> 
			 <%if(columnTotal4>0.0){%>
			<td class=rptValue><%=ndf.format(Math.round(columnTotal4*100)/100f)%></td><%}else{%><td class=rptValue>-</td><%}%> 
			 <%if(columnTotal5>0.0){%>
			<td class=rptValue><%=ndf.format(Math.round(columnTotal5*100)/100f)%></td><%}else{%><td class=rptValue>-</td><%}%> 
			 <%if(columnTotal6>0.0){%>
			<td class=rptValue><%=ndf.format(Math.round(columnTotal6*100)/100f)  %></td><%}else{%><td class=rptValue>-</td><%}%> 
			 <%if(columnTotal3>0.0){%>
			<td class=rptValue><%=ndf.format(Math.round(columnTotal3*100)/100f)  %></td><%}else{%><td class=rptValue>-</td><%}%> 
	 ...
	 while(rs2.next()){
	  ...
	  ////System.out.println("count:"+count);
	  if(count!=0 && count>0){
	   %><td class=rptValue align="right"> <a href="./rws_works_name_notpaid_rpt.jsp?&district=<%=rs1.getString(1)%>&plancode=<%=planCode%>"><%=count%></td><%}
	   else{ %><td class=rptValue>-</td><%}
	    ...
	    if(count1>0){%>
	    <td class=rptValue align="right"><%=count1%></td><%}else {%> <td class=rptValue>-</td><%}
	    if(samt>0.0){%>
	    <td class=rptValue align="right"><%=samt%></td><%}else{%>
	    <td class=rptValue>-</td><%}%>
	    <%
	   ...
	   <%
	    ...
	    value=0;
	   	...
	   	<tr>
			...
			<%if(columnTotal1>0){%>
			<td class=rptValue align="right"><%=columnTotal1%></td><%}else{%><td class=rptValue>-</td><%}%> 
			<%if(columnTotal2>0){%>
			<td class=rptValue align="right"><%=columnTotal2%></td><%}else{%><td class=rptValue>-</td><%}%> 
		    <%if(columnTotal3>0.0){%>
			<td class=rptValue align="right"><%=ndf.format(Math.round(columnTotal3*100)/100f)%></td><%}else{%><td class=rptValue>-</td><%}%> 
			 <%if(columnTotal4>0.0){%>
			<td class=rptValue align="right"><%=ndf.format(Math.round(columnTotal4*100)/100f)%></td><%}else{%><td class=rptValue>-</td><%}%> 
			 <%if(columnTotal5>0.0){%>
			<td class=rptValue align="right"><%=ndf.format(Math.round(columnTotal5*100)/100f)%></td><%}else{%><td class=rptValue align="right">-</td><%}%> 
			 <%if(columnTotal6>0.0){%>
			<td class=rptValue align="right"><%=ndf.format(Math.round(columnTotal6*100)/100f)  %></td><%}else{%><td class=rptValue>-</td><%}%> 
			 <%if(columnTotal3>0.0){%>
			<td class=rptValue align="right"><%=ndf.format(Math.round(columnTotal3*100)/100f)  %></td><%}else{%><td class=rptValue align="right">-</td><%}%> 
