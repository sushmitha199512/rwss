...
*/
		...
		{
			// alert(" water quality");
		document.f1.action="./rws_premoonsoon_data_district_NEW_rpt.jsp";
		document.f1.submit(); 
		}else 
		{
			
			 
			 document.f1.action="./rws_postmoonsoon_data_district_NEW_rpt.jsp";
			 document.f1.submit(); 
		}
		...
		session.setAttribute("pCode","00");
           ...
           <%
				...
				session.setAttribute("pCode",null);
           		...
           		if(rDist.equals("40") || rMand.equals("00") || !rDist.equals("00") )
				{		
              %>
					<td class=btext colspan=3 align=center><font color=navy><b>Panchayat</b></font></td>
					<td class=btext colspan=3 align=center>
...
<%
               ...
               <%
				...
				session.setAttribute("vCode",null);
 					...
 					if(rDist.equals("40") || rMand.equals("00") || rPanch.equals("00"))
					{
				%>
