...
<table border = 1 cellspacing = 0 cellpadding = 0  width=70%   style="border-collapse:collapse">
	...
	while(dsrs.next())
	  {
	   ...
	   %>
		  ...
		  <td class=rptvalue align="left"><%=dsrs.getString(2)%></td>
		  <%
 ...
 while(drs.next())
	{
	 ...
	 %>
	  <tr>
		  ...
		  <td class=rptvalue align="right"><%=bamt%></td>
