	...
	function fnSubmit()
	{
		var loggedUser = '<%=loggedUser%>';
			...
			{ */
				...
				document.f1.action="./rws_drought_distinct_hab_rpt.jsp";
				document.f1.submit();
			}	
		/* } */
		</script>
...
<table border = 1 align = center cellspacing = 0 cellpadding = 0 rules = "rows" bordercolor = navy style = "border-collapse:collapse" bgcolor="#ffffff" width=350>		
	...
	<tr bgcolor="#8A9FCD" align="center">
		<td align="center" class="rptHeading" colspan=3>Drought Distinct Habitations Report </td>	
	</tr>
	<%
try
{
...
<%-- <tr><td class=rptLabel>Year&nbsp;&nbsp;<font color="red"></font></td>
		...
		//String query1="select  distinct year from RWS_DROUGHT_HABITATION_TBL    order by year";
		
		StringBuffer query1=new StringBuffer();
		query1.append("select  distinct year from RWS_DROUGHT_HABITATION_TBL    order by year");
		
		 ////System.out.println("year:"+query1.toString());
			ResultSet rs3 = stmt3.executeQuery(query1.toString());
			while(rs3.next())
			{%>
