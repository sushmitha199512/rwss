...
<table border = 1 cellspacing = 0 cellpadding = 0 height=5% width="100%" bordercolor=#000000 style="border-collapse:collapse" bgcolor="#ffffff" align = "center">
	...
	////System.out..println("First Drill");
	   ...
	   %>
		...
		String view1="Create or Replace view spillworks"+session.getId().substring(1,10)+" as SELECT work_id,office_code,no_of_habs,programme_code FROM RWS_WORK_ADMN_TBL W where w.category_code='"+catCode+"'  "+planQry+" and w.ADMIN_DATE < '"+fixYear+"'  and work_cancel_dt is null  and w.work_id not in (select work_id from rws_work_completion_tbl where (DATE_OF_COMPLETION < '"+fixYear+"'))";
		String view2="Create or Replace view newworks"+session.getId().substring(1,10)+" as SELECT work_id,office_code,no_of_habs,programme_code FROM RWS_WORK_ADMN_TBL W where w.category_code='"+catCode+"' "+planQry+" and w.ADMIN_DATE >= '"+fixYear+"'  and work_cancel_dt is null ";
...
<td class="btext" align="right"><%=ghabcovn1%></td>
	...
	////System.out..println("First Drill");
	   ...
	   %>
		...
		rs1=stmt1.executeQuery(qry1);
		//code modified by pranavi
		String view1="Create or Replace view spillworks"+session.getId().substring(1,10)+" as SELECT DISTINCT W.work_id,office_code,no_of_habs,A.HAB_CODE FROM RWS_WORK_ADMN_TBL W,RWS_ADMN_HAB_LNK_TBL A where W.WORK_ID=A.WORK_ID AND w.category_code='"+catCode+"' "+planQry+" and w.ADMIN_DATE < '"+fixYear+"' and SUBSTR (w.work_id,5,2)='"+rDistrict+"' and work_cancel_dt is null and w.work_id not in (select work_id from rws_work_completion_tbl where (DATE_OF_COMPLETION < '"+fixYear+"'))";
		String view2="Create or Replace view newworks"+session.getId().substring(1,10)+" as SELECT DISTINCT W.work_id,office_code,no_of_habs,A.HAB_CODE FROM RWS_WORK_ADMN_TBL W,RWS_ADMN_HAB_LNK_TBL A where W.WORK_ID=A.WORK_ID and work_cancel_dt is null AND w.category_code='"+catCode+"' "+planQry+" and w.ADMIN_DATE >= '"+fixYear+"' and SUBSTR (w.work_id,5,2)='"+rDistrict+"' ";
		//////System.out.println("View1:"+view1);
		//////System.out.println("View2:"+view2);
		Statement stmtv1= conn.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE,ResultSet.CONCUR_UPDATABLE);
	   	Statement stmtv2= conn.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE,ResultSet.CONCUR_UPDATABLE);
...
<tr>
	...
	////System.out..println("Second Drill");
	   ...
	   %>
		...
		stmt1 = conn.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE,ResultSet.CONCUR_UPDATABLE);
		rs1=stmt1.executeQuery(qry1);
		String view1="Create or Replace view spillworks"+session.getId().substring(1,10)+" as SELECT work_id,office_code,no_of_habs FROM RWS_WORK_ADMN_TBL W where w.category_code='"+catCode+"' "+planQry+" and w.ADMIN_DATE < '"+fixYear+"'  and SUBSTR (w.office_code,2,2)='"+rDistrict+"' and SUBSTR(w.office_code,4,1)='"+divisionCode+"' and work_cancel_dt is null and w.work_id not in (select work_id from rws_work_completion_tbl where (DATE_OF_COMPLETION < '"+fixYear+"'))";
		String view2="Create or Replace view newworks"+session.getId().substring(1,10)+" as SELECT work_id,office_code,no_of_habs FROM RWS_WORK_ADMN_TBL W where w.category_code='"+catCode+"' "+planQry+" and w.ADMIN_DATE >= '"+fixYear+"' and SUBSTR (w.office_code,2,2)='"+rDistrict+"' and SUBSTR(w.office_code,4,1)='"+divisionCode+"' and work_cancel_dt is null ";
		Statement stmtv1= conn.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE,ResultSet.CONCUR_UPDATABLE);
	   	Statement stmtv2= conn.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE,ResultSet.CONCUR_UPDATABLE);
