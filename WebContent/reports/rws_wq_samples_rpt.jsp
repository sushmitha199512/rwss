...
int slno=0;int totNotFoundContaminated=0;int totNotFoundContaminatedb=0;
	...
	Statement stmt1=null,stmt2=null,stmt3=null,stmt4=null,stmt5=null,stmt6=null,stmt7=null,stmt8=null,stmt9=null,stmt10=null,stmt11=null,stmt13=null,stmt20=null;
    ResultSet rs1=null, rs2=null, rs3=null, rs4=null, rs5=null, rs6=null,rs7=null,rs8=null,rs9=null,rs10=null,rs11=null,rs13=null,rs20=null;
...
<caption>
	       <table border=0 rules=none style="border-collapse:collapse" width=100% align="right" bgcolor="#edf2f8">		
				<tr align="right">
                    ...
                    <a href="rws_wq_samples_rpt_xls.jsp" target="_new">Excel</a>
                 </td>
			</tr>
		 </table>
</caption>
        <tr align=center  align=center>
		<td class=rptValue colspan="19"><b><font color="blue">WaterQuality Samples Report</font></b></td>
		</tr>
        <tr align=center  align=center>
...
<td class=btext colspan=6 align=center rowspan=2 style="background-color:green;color:white;"><b>Only Laboratories</b></td>
...
<tr>
		 ...
		 <td class=btext rowspan=1 style="background-color:orange;color:white;">Total No.of Tested Samples</td>
		<td class=btext rowspan=1 style="background-color:orange;color:white;">No.of Samples  Chemically Contaminated</td>
<td class=btext rowspan=1 style="background-color:orange;color:white;"> No.of Samples  Not Found Contaminated</td>
		 <td class=btext rowspan=1 style="background-color:orange;color:white;">Total No.of Tested Samples</td>

		<td class=btext rowspan=1 style="background-color:orange;color:white;" >No.of Samples   Contaminated</td>
<td class=btext rowspan=1 style="background-color:orange;color:white;">No.of Samples  Not Found Contaminated</td>

 <td class=btext rowspan=1 style="background-color:white;color:green;" >Total No.of Tested Samples</td>
		<td class=btext rowspan=1 style="background-color:white;color:green;">No.of Samples  Chemically Contaminated</td>
	 


		<td class=btext rowspan=1 style="background-color:white;color:green;">No.of Samples Found H2s Vial Contaminated</td>
...
<td class=btext rowspan=1 style="background-color:green;color:white;">No.of Samples  Found Physico-Chemical Contaminated</td>
...
<td class=btext  rowspan=1 style="background-color:green;color:white;">No. of Samples with(MPN(E-Coliform)/100ml)</td>
		...
		<!--<tr>
		<td class=btext colspan=2  style="background-color:green;color:white;">222</td>
		<td class=btext colspan=2  style="background-color:green;color:white;">222</td>
		</tr>
       --><tr align=center>
...
String q1="select count(c.source_code),substr(hd.panch_code,1,2),c.division_office_code  from rws_ftk_testing_tbl c,rws_complete_hab_view hd  where hd.panch_code=substr(c.source_code,1,16) and FIELD_TEST_CHEMICAL ='Y' ";
			if(month!=null && !month.equals("") && !month.equals("0") &&  !month.equals("51"))
			 {
...
String q2="select count(c.source_code),substr(hd.panch_code,1,2),c.division_office_code  from rws_ftk_testing_tbl c,rws_complete_hab_view hd  where hd.panch_code=substr(c.source_code,1,16) and FIELD_TEST_CHEMICAL ='Y' and CONTAMINATION_STATUS='Y'";
			if(month!=null && !month.equals("") && !month.equals("0") &&  !month.equals("51"))
			 {
...
String q3="select count( c.source_code),substr(hd.panch_code,1,2),c.division_office_code  from rws_ftk_testing_tbl c,rws_complete_hab_view hd  where hd.panch_code=substr(c.source_code,1,16) and H2S_VIAL ='Y' ";
			if(month!=null && !month.equals("") && !month.equals("0") &&  !month.equals("51"))
			 {
...
String q4="select count( c.source_code),substr(hd.panch_code,1,2),c.division_office_code  from rws_ftk_testing_tbl c,rws_complete_hab_view hd  where hd.panch_code=substr(c.source_code,1,16) and H2S_VIAL ='Y' and CONTAMINATION_STATUS='Y'";
			if(month!=null && !month.equals("") && !month.equals("0") &&  !month.equals("51"))
			 {
			...
			stmt6=conn.createStatement();
			//System.out.println("H2sContamination:"+q4);
            ...
            String q5="select count( d.source_code),substr(hd.panch_code,1,2),c.division_office_code  from rws_ftk_testing_tbl c,rws_complete_hab_view hd ,rws_water_sample_collect_tbl d where hd.panch_code=substr(c.source_code,1,16) and  d.ftk_test_id=c.ftk_test_id  ";
		    if(month!=null && !month.equals("") && !month.equals("0") &&  !month.equals("51"))
				{
 ...
 //String qry16="select count(distinct a.source_code),substr(c.panch_code,1,2),a.division_office_code from rws_water_sample_collect_tbl a,rws_wq_test_results_tbl b,rws_complete_hab_view c,RWS_WQ_TEST_RESULTS_LNK_TBL  d,rws_wq_para_test_tbl F where c.panch_code=a.hab_code and a.source_code=b.source_code and a.test_id=b.test_id AND d.TESTING_PARAMETER_code=F.TESTING_PARAMETER_code and  a.test_id=d.test_id and b.test_code=1 and ((d.TESTING_PARAMETER_code='04' and d.TESTING_PARAMETER_VALUE >8.5 and TESTING_PARAMETER_VALUE is not null) or  (d.TESTING_PARAMETER_code='05' and d.TESTING_PARAMETER_VALUE >2000 and  TESTING_PARAMETER_VALUE is not null) or  (d.TESTING_PARAMETER_code='07' and d.TESTING_PARAMETER_VALUE >600 and  TESTING_PARAMETER_VALUE is not null) or  (d.TESTING_PARAMETER_code='12' and d.TESTING_PARAMETER_VALUE >1000 and  TESTING_PARAMETER_VALUE is not null) or  (d.TESTING_PARAMETER_code='13' and d.TESTING_PARAMETER_VALUE >1.5 and  TESTING_PARAMETER_VALUE is not null) or  (d.TESTING_PARAMETER_code='15' and d.TESTING_PARAMETER_VALUE >45 and TESTING_PARAMETER_VALUE is not null) or  (d.TESTING_PARAMETER_code='14' and d.TESTING_PARAMETER_VALUE >400 and TESTING_PARAMETER_VALUE is not null) or  (d.TESTING_PARAMETER_code='16' and d.TESTING_PARAMETER_VALUE >'1' and TESTING_PARAMETER_VALUE is not null) or  (d.TESTING_PARAMETER_code='06' and d.TESTING_PARAMETER_VALUE >600 and TESTING_PARAMETER_VALUE is not null))  and TESTING_PARAMETER_VALUE is not null and  to_number(TESTING_PARAMETER_VALUE)>to_number(F.MAX_PERMISSIBLE_VALUE)  ";
 ...
 String qry15="select count(distinct a.source_code),substr(c.panch_code,1,2),a.division_office_code from rws_water_sample_collect_tbl a,rws_wq_test_results_tbl b,rws_complete_hab_view c,RWS_WQ_TEST_RESULTS_LNK_TBL  d where c.panch_code=a.hab_code and a.source_code=b.source_code and a.test_id=b.test_id and  a.test_id=d.test_id and b.test_code=2 and d.TESTING_PARAMETER_code='01'  and TESTING_PARAMETER_VALUE is not null  and TESTING_PARAMETER_VALUE >'0'  and  TESTING_PARAMETER_VALUE is not null  ";
			...
			stmt13=conn.createStatement();
			//System.out.println("samples msn coliform:"+qry15);
 ...
 if(rs13!=null){rs13.close();}
   ...
   //////for MPN(E-Coliform)/100ml added by anupama on 04072015/////////////          
            String qry20="select count(distinct a.source_code),substr(c.panch_code,1,2),a.division_office_code from rws_water_sample_collect_tbl a,rws_wq_test_results_tbl b,rws_complete_hab_view c,RWS_WQ_TEST_RESULTS_LNK_TBL  d where c.panch_code=a.hab_code and a.source_code=b.source_code and a.test_id=b.test_id and  a.test_id=d.test_id and b.test_code=2 and d.TESTING_PARAMETER_code='02'  and TESTING_PARAMETER_VALUE is not null and TESTING_PARAMETER_VALUE >0 and TESTING_PARAMETER_VALUE is not null ";
			if(month!=null && !month.equals("") && !month.equals("0") &&  !month.equals("51"))
			{
...
int totH2sTestedSources=0,gtotH2sTestedSources=0,totH2sConSources=0,gtotH2sConSources=0,totH2sNotConSources=0,gtotH2snotConSources=0,gtotbactecoli=0;
int totlabForSources=0,gtotlabForSources=0;
int totlabTestedSources=0,gtotlabTestedSources=0,totlabTestedSamples=0,gtotlabTestedSamples=0;
...
<%} //System.out.println("totdw"+totdw);%>
               ...
               <td class=rptValue align="right"><%=labForwardH2sSources %></td>
				...
				<td class=rptValue align="right"><%=totlabTestedSources %></td>
<td class=rptValue align="right"><%=totlabTestedSamples %></td>
<td class=rptValue align="right"><a href="#" onclick="viewWorks('rws_wq_samples_drill.jsp?mode=PCC&dcode=<%=rs.getString(1)%>&division=<%=rs.getString(3)%>&month=<%=month%>&startyear=<%=yearStart%>&endyear=<%=yearEnd%>&dname=<%=dname%>&divname=<%=rs.getString(4)%>')"><%=totphisicoChemical %></a></td>
<td class=rptValue align="right"><a href="#" onclick="viewWorks('rws_wq_samples_drill.jsp?mode=MPNC&dcode=<%=rs.getString(1)%>&division=<%=rs.getString(3)%>&month=<%=month%>&startyear=<%=yearStart%>&endyear=<%=yearEnd%>&dname=<%=dname%>&divname=<%=rs.getString(4)%>')"><%=totbactContaminated %></a></td>
<td class=rptValue align="right"><a href="#" onclick="viewWorks('rws_wq_samples_drill.jsp?mode=MPNE&dcode=<%=rs.getString(1)%>&division=<%=rs.getString(3)%>&month=<%=month%>&startyear=<%=yearStart%>&endyear=<%=yearEnd%>&dname=<%=dname%>&divname=<%=rs.getString(4)%>')"><%=totbactEcol%></a></td>
...
labForwardH2sSources=0;
 ...
 <td class=btext align="right"><%=gtotH2sTestedSources %></td>
  <td class=btext align="right"><%=gtotH2sConSources %></td>
			...
			<td class=btext align="right"><%=gtotbactecoli%></td>
