<%
if((rCircle != null) && (!rCircle.equals("0")) && (rAssetType != null) && (!rAssetType.equals("0")) && (rAssetType.equals("01")) && (rDivision.equals("0")) && (rMandal.equals("0")))
{
	//System.out.println("ASSET TYPE & CIRCLE SELECTED...");
...
%>
			<td class=rptValue><a href="./rws_asset_borewell_rpt.jsp?rAssetType=<%=rAssetType%>&rCircle=<%=rCircle%>" target=_new>BORE WELL</td>
<%			
		}
%>
...
<%		
		...
		{
%>
			<td class=rptValue><a href="./rws_asset_distric_rpt.jsp?rAssetType=<%=rAssetType%>&rCircle=<%=rCircle%>" target=_new>DISTRIBUTION</td>
<%
		}
%>
...
<%		}
		...
		{
%>
			<td class=rptValue><a href="./rws_asset_ohsr_rpt.jsp?rAssetType=<%=rAssetType%>&rCircle=<%=rCircle%>" target=_new>OHSR</td>
<%
		}
%>
...
<%
		...
		{
%>		
			<td class=rptValue><a href="./rws_asset_pumphouse_rpt.jsp?rAssetType=<%=rAssetType%>&rCircle=<%=rCircle%>" target=_new>PUMP HOUSE</td>
<%
		}
%>
...
<%		
		...
		{
%>
			<td class=rptValue><a href="./rws_asset_standposts_rpt.jsp?rAssetType=<%=rAssetType%>&rCircle=<%=rCircle%>" target=_new>STAND POSTS</td>
<%
		}
%>
...
<%		}
		...
		{
%>
			<td class=rptValue><a href="./rws_asset_cis_rpt.jsp?rAssetType=<%=rAssetType%>&rCircle=<%=rCircle%>" target=_new>CISTERNS
			</td>
<%
		}
%>
...
<%		
		...
		{
%>
			<td class=rptValue><a href="./rws_asset_capac_rpt.jsp?rAssetType=<%=rAssetType%>&rCircle=<%=rCircle%>" target=_new>CAPACITORS</td>
<%
		}
%>
...
<%		
		...
		{
%>
			<td class=rptValue><a href="./rws_asset_pumpingmain_rpt.jsp?rAssetType=<%=rAssetType%>&rCircle=<%=rCircle%>" target=_new>PUMPING MAIN</td>
<%
		}
%>
...
<%		
		...
		{
%>
			<td class=rptValue><a href="./rws_asset_glsr_rpt.jsp?rAssetType=<%=rAssetType%>&rCircle=<%=rCircle%>" target=_new>GLSR</td>
<%
		}
%>
...
{
	//System.out.println("The Error is in check list assetcir form= " +e);
}
}
%>