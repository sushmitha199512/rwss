...
nic.watersoft.works.WorksData1 w=new nic.watersoft.works.WorksData1();
	...
	<td ><a href="javascript:onclick=history.go(-1)">Back | &nbsp; </td>
	   <td><a href="./rws_bls_vwm_committe_excel.jsp">Excel</a></td>  
	</tr>  
	</table>
	</caption>
	<tr >
	<td align="center" class="rptHeading" > Base Line Survey VWS Committe - Report</td>
	</tr>
