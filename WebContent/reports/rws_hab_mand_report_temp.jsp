...
<table border = 1 cellspacing = 0 cellpadding = 0 width=70% height=20%  bordercolor=#000000 style="border-collapse:collapse" bgcolor="#ffffff">
<caption>
	<table  border=0 rules=none style="border-collapse:collapse" align = "right">
	 <tr align="right">
			...
			<a href="./rws_hab_rpt_excel_print.jsp?aType=<%=assetType%>" target="new">Excel</a> 
			</td> 
		</tr>
	</table>
</caption>
...
<table border =0 cellspacing = 0 cellpadding = 0  bordercolor=#000000 style="border-collapse:collapse" bgcolor="#edf2f8" align=center>	
	...
	<tr>
		...
		<font size=2>Status As On: </font><font color=#F2A80D> <%=FDATE %><td><%  if(assetType.equals("01")) %> 
	    <td class="textborder" align="center">
...
<% 			            
			...
			if(!assetType.equals("03"))
			{
					...
					{
					if(record1[k] !=null && record1[k].equals("null"))
					{
%>
