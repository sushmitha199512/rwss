...
<table border = 1 cellspacing = 0 cellpadding = 0 width=90% height=20%  bordercolor=#000000 style="border-collapse:collapse" bgcolor="#ffffff">
<caption>
...
<table border = 1 cellspacing = 0 cellpadding = 0 width=100%  bordercolor=#000000 style="border-collapse:collapse" bgcolor="#ffffff">	
	<tr >
		...
		<td align="center" class="btext" colspan=4> Habitation Status</td> 
<tr>
...
<%
	 int fcTotal=0,ncTotal=0,nssTotal=0,pcTotal=0,pc4Total=0,pchabs=0,nchabs=0,uiTotal=0;
			 int slno=0,total=0;
	 while(rs6.next())
		{
...
%>
		...
		<td class="mystyle1">
			<a href="rws_goi_panch_rpt.jsp?mcode=<%=rs6.getString(1)%>&mname=<%=rs6.getString(2)%>&FDate=<%=fdate%>&dcode=<%=dcode%>"><%=rs6.getString(2)%></a></td>
