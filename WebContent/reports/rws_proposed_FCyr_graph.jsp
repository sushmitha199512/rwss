...
//System.out.println("value of p is  "+p);
	...
	ch.addTitle("Proposed Year Status Graph Report", "times new roman Bold Italic",12);
...
String ss[]=new String[c];
  ...
  for(j=0;j<c;j++){
	...
	if(x.equals("b"))
   {
	...
	ch.addTitle("Proposed FC Year", "Arial Bold", 10);
	//ch.setPlotArea(40, 40, 200, 150);
	ch.yAxis().setTitle("No. of Habitations");
	ch.xAxis().setTitle("Proposed Year Status");
...
if(x.equals("p"))
 {
    ...
    ch.addTitle2(Chart.Top, "Proposed FC Year", "Times New Roman Bold Italic",13);
	ch.set3D();
...
%>
    ...
    if(x.equals("d"))
 {
	...
	ch.addTitle("Proposed FC Year", "times new roman Bold Italic",12);
	 ch.yAxis().setTitle("No. of Habitations");
	 ch.xAxis().setTitle("Proposed Year Status");
