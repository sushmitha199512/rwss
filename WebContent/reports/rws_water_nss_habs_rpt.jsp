...
//System.out.println("check:1213"+check);
...
if(loggedUser!=null && !loggedUser.equals(Constants.SEC_USER))
{ %>
			<tr><td align="right" class="bwborder"><a href="../home.jsp">Home&nbsp;|</a></td><td align="right" class="bwborder"><a href="javascript:onclick=history.go(-1)">Back</a></td></tr>
...
<%} %>
	...
	<td align="center" class="gridhdbg" colspan=11>Water Quality <%=cstatus %> Habitation Status &nbsp;&nbsp;&nbsp;&nbsp;Selected Parameter:<%=check%></td>	
	</tr>
<tr>
