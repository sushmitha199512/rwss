...
<%	
	...
	{		
		...
		<tr align=left >
			...
			<td  class="mystyle1"><a href= "rws_asset_subdiv_off_rpt.jsp?districtcode=<%=districtcode%>&mandalcode=<%=record1[0]%>&mandalname=<%=record1[1]%>"><%=record1[1]%></a></td>
