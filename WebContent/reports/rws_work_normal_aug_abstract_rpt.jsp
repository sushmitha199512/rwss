...
function unview()
{
	...
	function fnSubmit()
	{
		...
		if(logValue=="admin" || logValue=="100000")
		{
			...
			document.f1.action="./rws_work_normal_aug_abstract_rpt1.jsp";
			document.f1.submit();
		}
		else
		{
...
<table border = 1 align = center cellspacing = 0 cellpadding = 0 rules = "rows" bordercolor = navy style = "border-collapse:collapse" bgcolor="#ffffff" width=350>		
	...
	<tr bgcolor="#8A9FCD" align="center">
		<td align="center" class="rptHeading" colspan=3>DistrictWise Normal Augmentation Works Abstract Report</td>	
	</tr>
...
<%
	...
	<%
		...
		else
		{
			...
			{
	%>
				<input type="text" name="districts" value="<%=rs.getString(2)%>">
	...
	<%
		...
		%>
	   </SELECT></td></tr><tr><td class=rptLabel>Financial Year&nbsp;&nbsp;<font color="red">*</font></td>
		<td class=btext>
