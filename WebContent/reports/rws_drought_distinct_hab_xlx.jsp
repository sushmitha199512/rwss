...
StringBuffer dcode = null;
	...
	//System.out.println("data"+dname+"code"+dcode);
	...
	%>
	<table border = 1 cellspacing = 0 cellpadding = 0 width="55%"  bordercolor=#000000 style="border-collapse:collapse" bgcolor="#ffffff" ALIGN=CENTER>
	...
	<td align="center" class="rptHeading"  colspan=6>Drought Distinct Habitations Report  </td>
	</tr>
	</table>
   ...
   <table   bgcolor="#FFFFFF" bordercolor= "#8A9FCD"  width="50%" border=1 style="border-collapse:collapse"  ALIGN=CENTER >
   <tr align=center>
	<td class=btext colspan=5>District:<font color="red"><%=dname%></font> </td>
	</tr>
	<tr align=center>	
	<td class=btext rowspan = 1>Sl.No</td>
	<td class=btext  rowspan = 1 >Mandal</td>
