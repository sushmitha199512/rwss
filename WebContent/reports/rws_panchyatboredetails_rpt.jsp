...
<%
  ...
  try
 {
  ...
  pcode=request.getParameter("pcode");
   ...
   sqlquery ="select hp_code,location,drill_year,diameter,status,static_wl,summer_wl,depth,quality_affected,flouride,brakish,iron from rws_hp_subcomp_param_tbl where substr(hp_code,1,2)=? and substr(hp_code,6,2)=? and substr(hp_code,13,2)=? order by drill_year";
...
<table border = 1 align = center cellspacing = 0 cellpadding = 0  bordercolor = "#000000" style = "border-collapse:collapse" bgcolor="#edf2f8" width=350>		
		...
		<tr bgcolor="#efefef" align="center">
			<td align="center" class="rptHeading" colspan=13>Panchayat-Borewell-Details-Report</td>	
		</tr>
