...
<%	
	int start,end,limit =30,j,slno=0,pgcnt,pgno=0,habCnt=0;
	int line=0;	
	int r1=0, s1=1, GOPG;
...
<%	
	...
	{		
		...
		if(temp.equals(distcode))
			...
			{
				habCnt++;
				//System.out.println("hab cont  "+habCnt);
...
<%				}
		...
		<tr align=left >
			...
			<td  class="mystyle1"><%= record1[1]%>(<%=habCnt %>)
...
<%
	habCnt=0;
	//System.out.println("saduiq in esle const   "+habCnt);
