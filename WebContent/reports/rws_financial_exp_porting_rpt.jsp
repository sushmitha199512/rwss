       ...
       while(rs99.next())
        ...
        String m=rs99.getString(7); y=rs99.getString(8);
         ...
         {    
	       ...
	       insertquery="insert into Bank_Pao_exp_porting_tbl values ('"+wid+"',"+amt+",'"+nohabs+"','"+wname+"','"+dcode+"','"+m+"','"+catcode+"') ";
         ...
         {    
	       ...
	       insertquery="insert into Bank_Pao_exp_porting_tbl values ('"+wid+"',"+amt+",'0','"+wname+"','"+dcode+"','"+m+"','"+catcode+"') ";
	     // System.out.println("Insert Query:"+insertquery);
	      stmt99.executeUpdate(insertquery);
