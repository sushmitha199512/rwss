...
<%	
	...
	int start,end,limit =20,j,pgcnt,pgno=0,slno=0;
	int line=0;	
	...
	ArrayList myList1 = (ArrayList)session.getAttribute("workList");
...
<form name=f1 action="./rws_work_proposal_hab_rpt_temp.jsp?start=<%=start%>&slno=<%=slno%>&pgcnt=<%=GOPG%>">
...
<caption>
	<table  border=0 rules=none style="border-collapse:collapse" align = "right">
		...
		<tr align="right">
			<td class="bwborder">
				<a href="./rws_work_propo_det_frm.jsp">Back&nbsp;|&nbsp;</a>&nbsp;<a href="../home.jsp">Home&nbsp;|&nbsp;</a>
				<a href="rws_work_proposal_rpt_print.jsp"        target="_new">Print&nbsp;|&nbsp;</a>
				<a href="rws_work_proposal_rpt_excel_print.jsp"  target="_new">Excel</a>
			</td>
		</tr>
	</table>
</caption>
	<tr bgcolor="lavander">
		<td class="textborder" align="center" colspan="11"><font color="ffffff">Work Proposal Habitation  Report</font></td>
</tr>
<tr><td>
...
<%				}
		...
		else
		{
			...
			if(line>0){%>
				<tr>
				<td colspan=11 class="btext"><%= "   "%></td></tr>
				<%
					%></tr><% } line++;%>
		<tr align=left >
...
<% 
	...
	if((start+20)<=myList1.size())
		{
		%>
		<a href="rws_work_proposal_hab_rpt_temp.jsp?start=<%=r1%>&slno=<%=slno%>&pgcnt=<%=s1%>"><font   color=#FF00CC>Next </font></a>
		<%}
	%>
</td>
</table>
