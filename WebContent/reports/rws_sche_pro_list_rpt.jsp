...
try 
{
	...
	String rDistrict=null, rMandal=null, rPanchayat=null, rScheme=null, query=null, query1 = null,fdate=null,tdate=null;
	...
	//System.out.println("rPanchayat7777777777777777777777777777777777//7777 = " +rPanchayat);
...
if(rDistrict.equals("51"))
{
	...
	query1="SELECT P.PROPOSAL_ID, P.PROPOSAL_NAME, P.LEAD_HAB_CODE, PR.PANCH_NAME FROM RWS_REP_PROPOSAL_TBL P, RWS_PANCHAYAT_RAJ_TBL PR, RWS_ASSET_TYPE_TBL AT WHERE P.LEAD_HAB_CODE = PR.PANCH_CODE AND AT.TYPE_OF_ASSET_NAME = '"+rScheme+"' AND AT.TYPE_OF_ASSET_CODE = P.TYPE_OF_ASSET and P.rep_date is not null";
}
if(!rDistrict.equals("51") && !rDistrict.equals("0") && rMandal.equals("0"))
{
	//System.out.println("IN CIRCLE SELECTION...");
	query1="SELECT P.PROPOSAL_ID, P.PROPOSAL_NAME, P.LEAD_HAB_CODE, PR.PANCH_NAME FROM RWS_REP_PROPOSAL_TBL P, RWS_PANCHAYAT_RAJ_TBL PR, RWS_ASSET_TYPE_TBL AT WHERE P.LEAD_HAB_CODE = PR.PANCH_CODE AND SUBSTR(OFFICE_CODE,2,2)='"+rDistrict+"'  AND AT.TYPE_OF_ASSET_NAME = '"+rScheme+"' AND AT.TYPE_OF_ASSET_CODE = P.TYPE_OF_ASSET and P.rep_date is not null ";
}
...
if(!rDistrict.equals("51") && !rDistrict.equals("0") && !rMandal.equals("5200") && !rMandal.equals("0") && rPanchayat.equals("0"))
{
	...
	query1="SELECT P.PROPOSAL_ID, P.PROPOSAL_NAME, P.LEAD_HAB_CODE, PR.PANCH_NAME FROM RWS_REP_PROPOSAL_TBL P, RWS_PANCHAYAT_RAJ_TBL PR, RWS_ASSET_TYPE_TBL AT WHERE P.LEAD_HAB_CODE = PR.PANCH_CODE AND SUBSTR(OFFICE_CODE,2,2)='"+rDistrict+"' AND SUBSTR(OFFICE_CODE,4,1) = '"+rMandal+"'  AND AT.TYPE_OF_ASSET_NAME = '"+rScheme+"' AND AT.TYPE_OF_ASSET_CODE = P.TYPE_OF_ASSET and P.rep_date is not null  ";
}
