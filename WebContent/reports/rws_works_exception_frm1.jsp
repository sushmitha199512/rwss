...
if(document.f1.scheme.value=='')
             ...
             // alert(document.f1.finyear.value);
              ...
              document.f1.action="./rws_works_exception_all_rpt1.jsp";
			  document.f1.submit();
			}
           else
           {
			...
			if(document.f1.scheme.value=='')
				{
					...
					document.f1.prgname.value = document.f1.program.options[document.f1.program.selectedIndex].text;
                    //document.f1.finyear.value = document.f1.fyear.options[document.f1.fyear.selectedIndex].text;
					document.f1.action="./rws_works_exception_rpt1.jsp";
					document.f1.submit();
...
<%} %>
	...
	<tr bgcolor="#8A9FCD" align="center">
		<td align="center" class="rptHeading" colspan=5>Works Monitoring Exceptional  Works</td>	
	</tr>
...
try
{
	...
	<tr  ><td class=rptLabel>District&nbsp;&nbsp;<font color="red">*</font></td>
		<td class=btext>
		<%
		if(loggedUser!=null && (loggedUser.equals(Constants.ADMIN)||loggedUser.equals(Constants.LAKH_USER) ||loggedUser.equals(Constants.DROUGHT_USER)||loggedUser.equals(Constants.SEC_USER)||loggedUser.equals(Constants.GUEST)))
		{
