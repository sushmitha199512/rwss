...
function fnSubmit()
{
	  ...
	  //alert(d+d1);
	    ...
	    if(fDate<=tDate)
		{
	    document.f1.action="rws_voucher_audit_rpt.jsp";
		document.f1.submit();
		}
	    else
	    {
...
<tr bgcolor="#8A9FCD" align="center">
 ...
 <tr><td class=rptLabel>From Voucher Date &nbsp;<font color="red">*</font></td>
...
<tr>
<td class=rptLabel>To Voucher Date&nbsp;<font color="red">*</font></td>
...
Note********:Audit Report is generated based on To and From Voucher Dates </font></p>
<font face="verdana" size="2" color="red">
