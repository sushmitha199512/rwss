...
<body>
		...
		<caption>
			<table border=0 rules=none style="border-collapse: collapse"
				...
				<tr>
					...
					<td class="bwborder"><a href="./Rws_Contrator_Wise_Payment_Details_Frm.jsp">Back|</a><a
						href="./Rws_Contrator_Wise_Payment_Details_Excel.jsp" target=_new>Excel</a></td>
				</tr>
				<%
					} else {
				%>
	...
	<table border=1 cellspacing=0 cellpadding=0 width="76%"
						...
						<tr>
							<td align="center" class="gridhdbg" colspan=18>Contractor Wise Online Payments Details
							</td>
						</tr>
     ...
     <tr>   <td class="gridhdbg" style="text-align: left;" rowspan="2">Slno</td>
			...
			<td class="gridhdbg" style="text-align: left;" rowspan="2">Contractor ID</td>
		...
		<tr>
		     <td class="gridhdbg" style="text-align: left;" >Total Works</td>
		    <td class="gridhdbg" style="text-align: left;" >No.of Works<br>(on going)</td>
            <td class="gridhdbg" style="text-align: left;" >No.of Works<br>(Completed)</td>          
			<td class="gridhdbg" style="text-align: left;">2011</td>
			<td class="gridhdbg" style="text-align: left;">2012</td>
            <td class="gridhdbg" style="text-align: left;">2013</td>
            <td class="gridhdbg" style="text-align: left;">2014</td>
