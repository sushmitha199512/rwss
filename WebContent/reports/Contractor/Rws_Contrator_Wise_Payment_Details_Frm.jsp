...
%>
		...
		<SELECT name="program" id="combo2" style="width:140px" multiple size="10" class="hightlongcombo">
				...
				<option value="01,02,18,23,32,48,49,51,58">NRDWP Related</option>
<%
		stmt2 = conn.createStatement();
		String 	query2="select * from  rws_programme_tbl  where programme_code not in(01,02,18,23,32,48,49,51,58) order by 1";
