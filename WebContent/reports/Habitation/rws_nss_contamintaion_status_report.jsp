...
function fnView()
{
			...
			else
	{
		...
		document.forms[0].action= "rws_nss_contamintaion_status_rpt1.jsp";
...
<%} %>
		...
		<tr bgcolor="#8D9EAF" align="center">
			...
			<td align="center" class="rptHeading" colspan=2><font style="text-transform: uppercase;">NSS contamination report as per habitation status</font></td>		
		</tr>
...
<tr align="center">
			<td colspan=2 align=center>
				<input type=button value="View Report" class = btext onclick="fnView()"></td></tr>
		</table>
