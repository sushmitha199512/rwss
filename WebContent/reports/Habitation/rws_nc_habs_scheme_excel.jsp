...
nic.watersoft.works.WorksData1 w=new nic.watersoft.works.WorksData1();
   ...
   <table width="60%" border=1 style="border-collapse:collapse"  ALIGN=CENTER >
    <tr>
	<td align="center" class=gridhdbg colspan="7" >Habitations Which are not Covered under any Scheme								
  - Report</td>
	</tr>
	<tr>
...
try
{
   ...
   if(lpcd.equals("All")){
		qry+="(b.PWS_SUPPLY>0 or b.PWS_UNSAFE_SUPPLY>0 or b.MPWS_SUPPLY>0 or b.MPWS_UNSAFE_SUPPLY>0 or b.CPWS_SUPPLY>0 or b.DIRECT_PUMPING_SUPPLY>0)) ";
		
	}
	if(lpcd.equals("Safe")){
		qry+="(b.PWS_SUPPLY>0  or b.MPWS_SUPPLY>0  or b.CPWS_SUPPLY>0 or b.DIRECT_PUMPING_SUPPLY>0)) ";
