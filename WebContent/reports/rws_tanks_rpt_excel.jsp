...
response.setHeader("Content-Disposition", "inline; filename="
		+ "Drinking Water Facilities available through Schemes.xls");
...
%>
<table>
<tr><td class=gridhdbg colspan=8 align="center"><b>Drinking Water Facilities available through Schemes</b></td></tr></table>
<table border = 1 cellspacing = 0 cellpadding = 0  width=80%  bordercolor=#000000 style="border-collapse:collapse">
<tr >
   <td class=gridhdbg colspan=8 align="center"><b>District :<%=dname%></b> &nbsp;&nbsp;&nbsp; <b>Mandal:<%=mname%></b></td>
</tr>
<tr align=center>
		    ...
		    while(rs2.next())
			  {
				...
				styleCount++;
				  ...
				  // System.out.println("lcnt:::::::::::::::"+lcnt);
				   glsrloc=rs2.getString(2);
				   glsrcapacity=Integer.parseInt(rs2.getString(3));
...
%>
<tr>
<td  class=gridhdbg colspan=8 align="center" ><b>Total Capacity(in Ltrs.):</b> <%=tot_capacity%>&nbsp;&nbsp;&nbsp;&nbsp;<b>LPCD(Total Capacity/Population):</b> <%=ndf.format(lpcd) %> </td></td>
</tr>
<%
	  if(count==0)
	  {%>
