...
<body>
<%
session.setAttribute("fname","DistrictLevel_MprAndProjectShelf.mdb");
...
<tr align = center><td class=rptLabel>DISTRICT LEVEL MPR And Project Shelf PORTING FILE&nbsp;</td></tr>
<tr align = center><td class=rptValue>
<html:link action="/DownloadIt">Click here for the MDB</html:link> 
</td></tr>
</table>
</body>
</html>
