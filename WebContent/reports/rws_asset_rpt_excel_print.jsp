...
<p width="100%" align="center"><b><font face="Verdana" size="3">Asset Habitation  Status  Report</font>
	</p>
...
<P border =0 cellspacing = 0 cellpadding = 0  bordercolor=#000000 style="border-collapse:collapse"  align="center">	
	...
	<%if(!asseType.equals("null")){%>
<p align=center colspan=8 class="mystyle1"><font color="navy">Asset Type:&nbsp;&nbsp;<%=ATName %> </font></p>
<%}%>
