...
<form action="DistrictListAction.do" >
...
<caption>
		<table  border=0 rules=none style="border-collapse:collapse" align = "right">			
			...
			<tr align="right">
				...
				<td align="right"><a href="rws_habitation_list_excel.jsp" target="_new">Excel</a></td>
</tr>
		</table>
	</caption>
	</table>
...
<tr><td class=myfontclr><B><font color="#FFFFFF">HabitationLists</font></B></td></tr></table>
<table   bgcolor="#FFFFFF" bordercolor= "#8A9FCD"  width="100%" border=1 style="border-collapse:collapse" >
<tr bgcolor="#ffffff">
<td align="center" class=btext>District :<%=session.getAttribute("distname")%></td>
</tr>
