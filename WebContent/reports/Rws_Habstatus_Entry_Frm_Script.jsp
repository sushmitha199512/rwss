	...
	if(pop == "levelOfWater")	
	{
		...
		*/
		...
		var thisdate = new Date();
	 	...
	 	var levelOfWater=totalWaterSupplySafe/(netPop*Math.pow(1.01,presentYear-censusYear));		
		if(levelOfWater=='Infinity')levelOfWater=0.0;
		habStatusForm.levelOfWaterSupply.value = levelOfWater.toFixed(2);
	
		var calCoverageStatus = "";
		if(levelOfWater>0)
		{	
			if(levelOfWater>0 && levelOfWater<10)
			{
					calCoverageStatus = "PC1";
			}
			else if(levelOfWater>=10 && levelOfWater<20)
			{
					calCoverageStatus = "PC2";
			}
			else if(levelOfWater>=20 && levelOfWater<30)
			{
					calCoverageStatus = "PC3";
			}
			else if(levelOfWater>=30 && levelOfWater<40)
			{
					calCoverageStatus = "PC4";
			}
			else if(levelOfWater>=40)
			{
