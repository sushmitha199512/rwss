...
//System.out.println("value of p is  "+p);
	...
	ch.addTitle("Works in Progress Plan/Non Plan ", "times new roman Bold Italic",12);
...
String ss[]=new String[c];
  ...
  for(j=0;j<c;j++){
	...
	if(x.equals("b"))
   {
	...
	ch.xAxis().setTitle("Work Plan/Non Plan");
...
if(x.equals("p"))
 {
    ...
    ch.addTitle2(Chart.Top, "Works in Progress Plan/Non Plan", "Times New Roman Bold Italic",13);
	ch.set3D();
