	...
	<table  border=0 rules=none style="border-collapse:collapse" align = "right">
		...
		<tr align="right">
			<td class="bwborder">
				...
				<a href="./rws_proposal_pendency_consti_frm.jsp">Back&nbsp;|&nbsp;</a>&nbsp;
				<a href="../home.jsp">Home&nbsp;|&nbsp;</a>
		
			<a href="rws_proposal_pendency_consti_rpt_print.jsp"        target="_new">Print&nbsp;|&nbsp;</a>
			<a href="rws_proposal_pendency_consti_rpt_xsl.jsp"  target="_new">Excel</a>
...
//		int slno=0;
		...
		for(int z = start,sno=start+1; z<end; z++,sno++)
		{
			...
			//System.out.println("record  " +record1[0]);
			//System.out.println("record  " +record1[1]);
			//System.out.println("record  " +record1[11]);
			//System.out.println("record  " +record1[15]);
