...
String dcode="";
if(loggedUser.equals("admin") || loggedUser.equals("100000")){
...
{ %>
			<tr><td align="right" class="bwborder"><a href="/pred/home.jsp?loginMode=watersoft">Home|</a></td>
				<td class="bwborder"><a href="javascript:onclick=history.go(-1)">Back|</a><a href="./rws_fin_phy_prg_ach_rpt_excel.jsp" target=_new>Excel</a></td></tr>
<%  } else {%>
...
<tr bgcolor="white" ><td><font color="red"><b>Note:</b> Column 6:(Includes Current Fin. Year Expenditure + Last Fin. Year Physically Completed  Financially Not Completed Works Exp.)</font></td></tr>
	</table>
...
String query="";
if(!loggedUser.equals(Constants.SEC_USER) && !loggedUser.equals(Constants.GUEST)){

if(dcode!=null && divCode!=null && !dcode.equals("") && !dcode.equals("00") && !loggedUser.equals(Constants.GUEST)){
