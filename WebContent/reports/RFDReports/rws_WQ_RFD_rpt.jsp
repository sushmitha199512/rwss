...
<td class=btext align=center >During <br>(<%=cmonth %>-<%=yr1 %>)</td>
...
String q3="select substr(d.office_code,2,2),substr(d.office_code,4,1),d.lab_code,count(*) from rws_wq_test_results_tbl a,RWS_WATER_QUALITY_LAB_TBL d where  to_date(a.prepared_on)>='1-"+cmonth+"-"+yr1+"'  and a.test_id in(select test_id from rws_wq_test_results_lnk_tbl)  and a.lab_code=d.lab_code group by substr(d.office_code,2,2),substr(d.office_code,4,1),d.lab_code";
