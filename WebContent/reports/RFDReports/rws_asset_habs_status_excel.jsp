...
<%@ include file="conn.jsp" %>
	...
	response.setHeader("Content-Disposition", "inline; filename="
			+ "rws_asset_habs_status_excel.xls");
...
%>
<td  class=rptValue><%=mvsSchems %></td>
<td  class=rptValue><%=mvsSchemHabs %></td>
...
<td  class=rptValue><%=nmvsSchems %></td>
<td  class=rptValue><%=nmvsSchemHabs %></td>
