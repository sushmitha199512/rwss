...
try
{
  ...
  ///////////query for mvs///
  qry="select count(*),substr(asset_code,5,2) from rws_asset_mast_tbl  where type_of_asset_code='03' and  substr(asset_code,5,2) in('01','02','03','04','05','06','07','08','09','10','11','12','13')  group by substr(asset_code,5,2) order by substr(asset_code,5,2)";
   Statement	stmt80=conn.createStatement();
		...
		while(rs80.next())
	{
		...
		qry="select count(*),substr(asset_code,5,2) from rws_asset_mast_tbl  where type_of_asset_code='01' and substr(asset_code,5,2) in('01','02','03','04','05','06','07','08','09','10','11','12','13')  group by substr(asset_code,5,2) order by substr(asset_code,5,2)";
		...
		// qry="select sum(case when type_of_asset_code='01' or type_of_asset_code='02' then 1 else 0 end),substr(a.hab_code,1,2) from rws_asset_mast_tbl a,rws_asset_hab_tbl b where  a.asset_code=b.asset_code group by substr(a.hab_code,1,2) ";
		   Statement	stmt81=conn.createStatement();
				...
				while(rs81.next())
			{
				...
				qry="select count(*),substr(asset_code,5,2) from rws_asset_mast_tbl  where type_of_asset_code='02' and substr(asset_code,5,2) in('01','02','03','04','05','06','07','08','09','10','11','12','13')  group by substr(asset_code,5,2) order by substr(asset_code,5,2)";
		...
		// qry="select sum(case when type_of_asset_code='01' or type_of_asset_code='02' then 1 else 0 end),substr(a.hab_code,1,2) from rws_asset_mast_tbl a,rws_asset_hab_tbl b where  a.asset_code=b.asset_code group by substr(a.hab_code,1,2) ";
		   Statement	stmt90=conn.createStatement();
				...
				while(rs90.next())
			{
				...
				qry="select count(*),substr(asset_code,5,2) from rws_asset_mast_tbl  where type_of_asset_code='05' and substr(asset_code,5,2) in('01','02','03','04','05','06','07','08','09','10','11','12','13')  group by substr(asset_code,5,2) order by substr(asset_code,5,2)";
	...
	//////query for handpumps///					
		...
		qry="select count(*),substr(asset_code,5,2) from rws_asset_mast_tbl  where type_of_asset_code='04' and substr(asset_code,5,2) in('01','02','03','04','05','06','07','08','09','10','11','12','13')  group by substr(asset_code,5,2) order by substr(asset_code,5,2)";
				// qry="select sum(case when type_of_asset_code='04' or type_of_asset_code='05' or type_of_asset_code='09' then 1 else 0 end),substr(a.hab_code,1,2) from rws_asset_mast_tbl a,rws_asset_hab_tbl b where  a.asset_code=b.asset_code group by substr(a.hab_code,1,2)";
...
/////query for diret pumping ///////////
		...
		qry="select count(*),substr(asset_code,5,2) from rws_asset_mast_tbl  where type_of_asset_code='09' and substr(asset_code,5,2) in('01','02','03','04','05','06','07','08','09','10','11','12','13')  group by substr(asset_code,5,2) order by substr(asset_code,5,2)";
				// qry="select sum(case when type_of_asset_code='04' or type_of_asset_code='05' or type_of_asset_code='09' then 1 else 0 end),substr(a.hab_code,1,2) from rws_asset_mast_tbl a,rws_asset_hab_tbl b where  a.asset_code=b.asset_code group by substr(a.hab_code,1,2)";
				...
				//	System.out.println("schoolcount0:"+schoolcount0);
						...
						while(rs93.next())
					{
						 ...
						 qry="select count(*),substr(asset_code,5,2) from rws_asset_mast_tbl  where type_of_asset_code='08' and substr(asset_code,5,2) in('01','02','03','04','05','06','07','08','09','10','11','12','13')  group by substr(asset_code,5,2) order by substr(asset_code,5,2)";
	...
	qry="select distinct sum(case when a.type_of_asset_code='01' or a.type_of_asset_code='02' then 1 else 0 end),substr(a.hab_code,1,2) from rws_asset_mast_tbl a,rws_asset_hab_tbl b where a.asset_code=b.asset_code group by substr(a.hab_code,1,2)";
		...
		qry="select count(distinct a.hab_code),substr(a.hab_code,1,2) from rws_asset_mast_tbl a,rws_asset_hab_tbl b where a.asset_code=b.asset_code and  a.type_of_asset_code in ('09','04','05') group by substr(a.hab_code,1,2)";
		...
		qry="select distinct sum(case when a.type_of_asset_code='08' then 1 else 0 end),substr(a.hab_code,1,2) from rws_asset_mast_tbl a,rws_asset_hab_tbl b where a.asset_code=b.asset_code group by substr(a.hab_code,1,2)";
...
qry="select distinct dcode,dname,SUM(Case When b.coverage_status='FC' then 1 Else 0 End) as FC,SUM(Case When b.coverage_status='PC4' then 1 Else 0 End) AS PC4,SUM(Case When b.coverage_status='PC3' then 1 Else 0 End) AS PC3,SUM (Case When b.coverage_status='PC2' then 1 Else 0 End) as PC2,SUM(Case When b.coverage_status='PC1' then 1 Else 0 End) as PC1,sum(case when b.coverage_status='NSS' then 1 else 0 end) as QA from rws_complete_hab_view a,rws_habitation_directory_tbl b WHERE b.HAB_CODE=a.panch_code group by dcode,dname order by dcode";
...
%>
 <tr>
    ...
    <td class="<%=style%> "style="text-align: left;"><a href="#" onclick="viewWorks('rws_cm_habitation_assetstatus_drill.jsp?dcode=<%=rs8.getString(1)%>&dname=<%=rs8.getString(2)%>')"><%=rs8.getString(2)%></a></td>
