...
if(loggedUser!=null && loggedUser.equals(Constants.ADMIN) || loggedUser.equals(Constants.LAKH_USER) || loggedUser.equals(Constants.SEC_USER) || loggedUser.equals(Constants.GUEST)){
...
%>
<td class=rptValue align=center><a href="#" onclick="viewWorks('rws_rfd_schools_drill_rpt.jsp?type=4&dcode=<%=rs1.getString(3) %>&divCode=<%=rs1.getString(4) %>')"><%=ndf1.format(sCount) %></td>
<td class=rptValue align=center><a href="#" onclick="viewWorks('rws_rfd_schools_drill_providewithdr_rpt.jsp?type=5&dcode=<%=rs1.getString(3) %>&divCode=<%=rs1.getString(4) %>')"><%=ndf1.format(sCount1) %></td>
<td class=rptValue><%=ndf.format(per1) %></td>
<td class=rptValue align=center><a href="#" onclick="viewWorks('rws_rfd_schools_drill_Anganwadiesdr_rpt.jsp?type=5&dcode=<%=rs1.getString(3) %>&divCode=<%=rs1.getString(4) %>')"><%=ndf1.format(aCount) %></td>
<td class=rptValue align=center><a href="#" onclick="viewWorks('rws_rfd_schools_drill_providewithdrinkingwater_rpt.jsp?type=5&dcode=<%=rs1.getString(3) %>&divCode=<%=rs1.getString(4) %>')"><%=ndf1.format(aCount1) %></td>
<td class=rptValue><%=ndf.format(per2) %></td></tr>
...
%>
<tr><td class=rptlabel colspan=3>Total:</td><td class=rptlabel align=center><%=ndf1.format(gschoolCount) %></td><td class=rptLabel align=center><%=ndf1.format(gschoolCount1) %></td><td class=rptlabel align=center><%=ndf.format((gschoolCount1*100)/gschoolCount) %></td><td class=rptLabel align=center><%=ndf1.format(ganganiCount) %></td><td class=rptLabel align=center><%=ndf1.format(ganganiCount1) %></td><td class=rptLabel align=center><%=ndf.format((ganganiCount1*100)/ganganiCount) %></td></tr>
<% 
