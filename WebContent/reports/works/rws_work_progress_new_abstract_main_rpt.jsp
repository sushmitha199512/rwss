...
<%    DecimalFormat ndf = new DecimalFormat("####.00");
  ...
  // String programmeName= "JJM";
	...
	{ */
		String	programmeName= request.getParameter("programmeName").toString();
	/* } */
   ...
   System.out.println(request.getParameter("programme")+"!!!!!!!!!"+request.getParameter("schemes")+"!!!!*****!!!!!"+request.getParameter("programmeName"));
...
<script language="JavaScript" src="<rws:context page='/resources/javascript/wz_tooltip1.js'/>"></script>
    ...
    <center>
            ...
            <br/><br/><font color="#889900" face="Maiandra GD" size="3px"  >Programme: <%=request.getParameter("programmeName")%>
      ...
      System.out.println("groundWorks :"+groundWorks);
		...
		stmt2.close();
		  ...
		  bankCM = "select sum(nvl(BILL_AMOUNT_CENTRAL,0)) from RWS_BILL_BANK_BRIDGE_DET_TBL b,rws_work_admn_tbl a,RWS_SOURCE_IDEN_FIN_TBL i,RWS_WORK_COMMENCEMENT_TBL c ,rws_contractor_selection_tbl m "
                 ...
                 + "and to_date(BANK_SEND_DATE)<='31-MAR-" + yearEnd + "' and a.TYPE_OF_ASSET in (" + schemes + ")  and a.SANCTION_AMOUNT <=5 ";
		...
		if(programme.equals(scode) && schemeName.contains("laks")){
		 ...
		 paoCM = "select sum(nvl(BILL_AMOUT_STATE,0)) from RWS_BILL_PAO_BRIDGE_DET_TBL b,rws_work_admn_tbl a,RWS_SOURCE_IDEN_FIN_TBL i,RWS_WORK_COMMENCEMENT_TBL c ,rws_contractor_selection_tbl m "
                ...
                + "and to_date(STATE_SEND_DATE)<='31-MAR-" + yearEnd + "' and a.TYPE_OF_ASSET in (" + schemes + ")  and a.SANCTION_AMOUNT <=5 ";
