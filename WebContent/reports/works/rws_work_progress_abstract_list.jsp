			...
			<caption>
				<table border=0 rules=none style="border-collapse: collapse"
					...
					<tr align="right">
						...
						<!-- <td class="bwborder"><a
							href="./rws_work_progress_abstract_xls.jsp" target="_new">Excel</a></td>
 -->
					</tr>
			...
			<tr align=center align=center>
				...
				<td class=gridhdbg rowspan=1 colspan=2 style="width: 250px !important;">Physically Completed But<br/>Not Financially Completed</td>
			...
			<tr>
				...
				<%if(mode.equals("divisions")){ %>
				<td class="<%=style%>" style="text-align: left;" align="right"><a href="./rws_work_progress_abstract_list.jsp?mode=subdivisions&district=<%=rs.getString(4)%>&program=<%=programe%>&dname=<%=rs.getString(3)%>&finyear=<%=finyear%>&divCode=<%=rs.getString(5)%>&finyear=<%=finyear%>"><%=rs.getString(6)%></a></td>
				<td class="<%=style%>" style="text-align: right;" align="right"><a href="#" onclick="viewWorks('./rws_work_progress_abstract_drill.jsp?mode=tWorks&dcode=<%=rs.getString(4)%>&programmeCode=<%=programe%>&dname=<%=rs.getString(3)%>&divCode=<%=rs.getString(5)%>&finyear=<%=finyear%>')"><%=noOfWorks%></a></td>
				<%}else if(mode.equals("subdivisions")){ %>
				<td class="<%=style%>" style="text-align: left;" align="right"><%=rs.getString(8)%></td>
				<td class="<%=style%>" style="text-align: right;" align="right"><a href="#" onclick="viewWorks('./rws_work_progress_abstract_drill.jsp?mode=tWorks&dcode=<%=rs.getString(4)%>&programmeCode=<%=programe%>&dname=<%=rs.getString(3)%>&divCode=<%=rs.getString(5)%>&subdivCode=<%=rs.getString(7)%>&finyear=<%=finyear%>')"><%=noOfWorks%></a></td>
				<%} else{%>
				<td class="<%=style%>" style="text-align: left;" align="right"><a href="./rws_work_progress_abstract_list.jsp?mode=divisions&district=<%=rs.getString(4)%>&program=<%=programe%>&dname=<%=rs.getString(3)%>&finyear=<%=finyear%>"><%=rs.getString(3)%></a></td>
				<td class="<%=style%>" style="text-align: right;" align="right"><a href="#" onclick="viewWorks('./rws_work_progress_abstract_drill.jsp?mode=tWorks&dcode=<%=rs.getString(4)%>&programmeCode=<%=programe%>&dname=<%=rs.getString(3)%>&finyear=<%=finyear%>')"><%=noOfWorks%></a></td>
				<%}%>
				...
				%>
				<%if(mode.equals("divisions")){ %>
				<td class="<%=style%>" style="text-align: right;" align="right"><a href="#" onclick="viewWorks('./rws_work_progress_abstract_drill.jsp?mode=sHabs&mode1=normal&dcode=<%=rs.getString(4)%>&programmeCode=<%=programe%>&dname=<%=rs.getString(3)%>&divCode=<%=rs.getString(5)%>&finyear=<%=finyear%>')"><%=habsSanctioned%></a></td>
				<%}
				else if(mode.equals("subdivisions")){ %>
				<td class="<%=style%>" style="text-align: right;" align="right"><a href="#" onclick="viewWorks('./rws_work_progress_abstract_drill.jsp?mode=sHabs&mode1=normal&dcode=<%=rs.getString(4)%>&programmeCode=<%=programe%>&dname=<%=rs.getString(3)%>&divCode=<%=rs.getString(5)%>&subdivCode=<%=rs.getString(7)%>&finyear=<%=finyear%>')"><%=habsSanctioned%></a></td>
				<%}else{ %>
				<td class="<%=style%>" style="text-align: right;" align="right"><a href="#" onclick="viewWorks('./rws_work_progress_abstract_drill.jsp?mode=sHabs&mode1=normal&dcode=<%=rs.getString(4)%>&programmeCode=<%=programe%>&dname=<%=rs.getString(3)%>&finyear=<%=finyear%>')"><%=habsSanctioned%></a></td>
				<%}
					}
							stmt1.close();
							rs1.close();
...
<%
				...
				<td class="<%=style%>" style="text-align: right;" align="right"><a href="#" onclick="viewWorks('./rws_work_progress_abstract_drill.jsp?mode=cWorks&dcode=<%=rs.getString(4)%>&programmeCode=<%=programe%>&dname=<%=rs.getString(3)%>&divCode=<%=rs.getString(5)%>&finyear=<%=finyear%>')"><%=worksComp%></a></td>
				<%}
				else if(mode.equals("subdivisions")){ %>
				<td class="<%=style%>" style="text-align: right;" align="right"><a href="#" onclick="viewWorks('./rws_work_progress_abstract_drill.jsp?mode=cWorks&dcode=<%=rs.getString(4)%>&programmeCode=<%=programe%>&dname=<%=rs.getString(3)%>&divCode=<%=rs.getString(5)%>&subdivCode=<%=rs.getString(7)%>&finyear=<%=finyear%>')"><%=worksComp%></a></td>
				<%}else{ %>
				<td class="<%=style%>" style="text-align: right;" align="right"><a href="#" onclick="viewWorks('./rws_work_progress_abstract_drill.jsp?mode=cWorks&dcode=<%=rs.getString(4)%>&programmeCode=<%=programe%>&dname=<%=rs.getString(3)%>&finyear=<%=finyear%>')"><%=worksComp%></a></td>
				<%}
					}
							stmt1.close();
							rs1.close();
				...
				%>
				<%if(mode.equals("divisions")){ %>
				<td class="<%=style%>" style="text-align: right;" align="right"><a href="#" onclick="viewWorks('./rws_work_progress_abstract_drill.jsp?mode=cHabs&mode1=normal&dcode=<%=rs.getString(4)%>&programmeCode=<%=programe%>&dname=<%=rs.getString(3)%>&divCode=<%=rs.getString(5)%>&finyear=<%=finyear%>')"><%=habsCov%></a></td>
				<%}
				else if(mode.equals("subdivisions")){ %>
				<td class="<%=style%>" style="text-align: right;" align="right"><a href="#" onclick="viewWorks('./rws_work_progress_abstract_drill.jsp?mode=cHabs&mode1=normal&dcode=<%=rs.getString(4)%>&programmeCode=<%=programe%>&dname=<%=rs.getString(3)%>&divCode=<%=rs.getString(5)%>&subdivCode=<%=rs.getString(7)%>&finyear=<%=finyear%>')"><%=habsCov%></a></td>
				<%}else{ %>
				
				<td class="<%=style%>" style="text-align: right;" align="right"><a href="#" onclick="viewWorks('./rws_work_progress_abstract_drill.jsp?mode=cHabs&mode1=normal&dcode=<%=rs.getString(4)%>&programmeCode=<%=programe%>&dname=<%=rs.getString(3)%>&finyear=<%=finyear%>')"><%=habsCov%></a></td>
				<%}
					}
							stmt1.close();
							rs1.close();
				...
				<%
					String phyCompNotFinWorks = "select count(a.work_id) from rws_work_admn_tbl a,rws_work_completion_tbl b,RWS_SOURCE_IDEN_FIN_TBL i,RWS_WORK_COMMENCEMENT_TBL c ,rws_contractor_selection_tbl m,rws_programme_tbl p  where WORK_CANCEL_DT is null and substr(a.WORK_ID,5,2)='"
									...
									+ programe
									+ ") and b.DATE_OF_COMPLETION is not null and b.DATE_OF_COMPLETION between '01-APR-"+(yearStart)+"' and '31-MAR-"+(yearEnd)+"' and b.DT_FIN_COMPLETION is null";
							if(mode.equals("divisions")){
							...
							if (rs1.next()) {
								...
								%>
								<%if(mode.equals("divisions")){ %>
								<td class="<%=style%>" style="text-align: right;" align="right"><a href="#" onclick="viewWorks('./rws_work_progress_abstract_drill.jsp?mode=pnfWorks&dcode=<%=rs.getString(4)%>&programmeCode=<%=programe%>&dname=<%=rs.getString(3)%>&divCode=<%=rs.getString(5)%>&finyear=<%=finyear%>')"><%=worksPhyCompNotFin%></a></td>
								<%}
								else if(mode.equals("subdivisions")){ %>
								<td class="<%=style%>" style="text-align: right;" align="right"><a href="#" onclick="viewWorks('./rws_work_progress_abstract_drill.jsp?mode=pnfWorks&dcode=<%=rs.getString(4)%>&programmeCode=<%=programe%>&dname=<%=rs.getString(3)%>&divCode=<%=rs.getString(5)%>&subdivCode=<%=rs.getString(7)%>&finyear=<%=finyear%>')"><%=worksPhyCompNotFin%></a></td>
								<%}else{ %>
								<td class="<%=style%>" style="text-align: right;" align="right"><a href="#" onclick="viewWorks('./rws_work_progress_abstract_drill.jsp?mode=pnfWorks&dcode=<%=rs.getString(4)%>&programmeCode=<%=programe%>&dname=<%=rs.getString(3)%>&finyear=<%=finyear%>')"><%=worksPhyCompNotFin%></a></td>
								<%}
							}
							stmt1.close();
							rs1.close();
				...
				<%
					String phyCompNotFinExpBANK = "select sum(BILL_AMOUNT_CENTRAL) from RWS_BILL_BANK_BRIDGE_DET_TBL b,rws_work_admn_tbl a,RWS_SOURCE_IDEN_FIN_TBL i,RWS_WORK_COMMENCEMENT_TBL c ,rws_contractor_selection_tbl m, rws_work_completion_tbl wc where WORK_CANCEL_DT is null and substr(a.WORK_ID,5,2)='"
									...
									+ programe
									+ ") and a.work_id=wc.work_id and wc.DATE_OF_COMPLETION is not null and wc.DATE_OF_COMPLETION between '01-APR-"+(yearStart)+"' and '31-MAR-"+(yearEnd)+"' and wc.DT_FIN_COMPLETION is null and b.work_id=a.work_id and i.work_id(+)=a.work_id  and c.work_id(+)=a.work_id and m.work_id=a.work_id and m.work_id=i.work_id and BANK_SEND_DATE<='31-MAR-"
									+ (yearEnd-1) + "'";
								if(mode.equals("divisions")){
							...
							String phyCompNotFinExpPAO = "select sum(BILL_AMOUT_STATE) from RWS_BILL_PAO_BRIDGE_DET_TBL b,rws_work_admn_tbl a,RWS_SOURCE_IDEN_FIN_TBL i,RWS_WORK_COMMENCEMENT_TBL c ,rws_contractor_selection_tbl m, rws_work_completion_tbl wc where WORK_CANCEL_DT is null and substr(a.WORK_ID,5,2)='"
									...
									+ "' and a.ADMIN_DATE >to_date('01/04/2011','dd/mm/yyyy') and a.programme_code in ("
									+ programe
									+ ") and a.work_id=wc.work_id and wc.DATE_OF_COMPLETION is not null and wc.DATE_OF_COMPLETION between '01-APR-"+(yearStart)+"' and '31-MAR-"+(yearEnd)+"' and wc.DT_FIN_COMPLETION is null and b.work_id=a.work_id and i.work_id(+)=a.work_id  and c.work_id(+)=a.work_id and m.work_id=a.work_id and m.work_id=i.work_id and STATE_SEND_DATE<='31-MAR-"
									+ (yearEnd) + "'";
							if(mode.equals("divisions")){
			...
			<tr>
				...
				<td class="gridhdbg" style="text-align: right;"><%=totExpPhyCompNotFin%></td>
			</tr>
			<%
				} catch (Exception e) {
					e.printStackTrace();
