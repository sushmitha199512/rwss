...
<html:html>
    ...
    <table    width="70%" border=1 style="border-collapse:collapse"  ALIGN=CENTER >
        <%if (mode.equals("cWorks") || mode.equals("gWorks") || mode.equals("tWorks") || mode.equals("canWorks") || mode.equals("wcPrevYear") || mode.equals("worksYear") || mode.equals("ngWorks")) {%>
        <tr align=center>
            ...
            <%if(mode.equals("cWorks") || mode.equals("tWorks") || mode.equals("comWorks") || mode.equals("wcPrevYear")) {%>
        ...
        <%
            ...
            try {
              System.out.println("mode in new "+mode);
                if (mode.equals("tWorks")) {
                		...
                		query = "select a.SANCTION_AMOUNT,a.work_id,a.work_name,nvl(to_char(admin_date,'dd/mm/yyyy'),'--'),nvl(to_char(TARGET_DATE_COMP ,'dd/mm/yyyy'),'--'),ADMIN_NO,dis.dname,nvl(a.lead_habitation,'--') as lead_habitation,nvl(a.office_code,'--') as office_code from "
                            + "rws_work_admn_tbl a,rws_programme_tbl p,rws_district_tbl dis where dis.dcode=substr(a.work_id,5,2) and "
                            + " a.programme_code=p.PROGRAMME_CODE and a.programme_code in (" + pc + ") "
...
if(pc.equals(scode)&& schemeName.contains("laks")){
    					...
    					if(schemeName.contains("Below 5 laks")){
    						query = "select distinct a.SANCTION_AMOUNT, a.work_id,a.work_name,nvl(to_char(admin_date,'dd/mm/yyyy'),'--'),nvl(to_char(TARGET_DATE_COMP ,'dd/mm/yyyy'),'--'),to_char(b.DATE_OF_COMPLETION,'dd/mm/yyyy'),ADMIN_NO,dis.dname,nvl(a.lead_habitation,'--') as lead_habitation,nvl(a.office_code,'--') as office_code "
    						        ...
    						        + "  a.TYPE_OF_ASSET in (" + schemes + ") and   a.SANCTION_AMOUNT <=5";//TO_DATE(TARGET_DATE_COMP)>='01-APR-" + yearStart + "' and a.CORE_DASHBOARD_STATUS='Y' and
    					...
    					{query = "select distinct a.SANCTION_AMOUNT, a.work_id,a.work_name,nvl(to_char(admin_date,'dd/mm/yyyy'),'--'),nvl(to_char(TARGET_DATE_COMP ,'dd/mm/yyyy'),'--'),to_char(b.DATE_OF_COMPLETION,'dd/mm/yyyy'),ADMIN_NO,dis.dname,nvl(a.lead_habitation,'--') as lead_habitation,nvl(a.office_code,'--') as office_code "
    					        ...
    					        + "WORK_CANCEL_DT is null and b.work_id=a.work_id and i.work_id(+)=a.work_id  and c.work_id(+)=a.work_id and m.work_id(+)=a.work_id "
    					        + "and h.work_id=a.work_id and hd.hab_code=h.hab_code and a.programme_code in ("+pc+")  and TO_DATE(b.DATE_OF_COMPLETION) >= '01-APR-"+yearStart+"' and TO_DATE(b.DATE_OF_COMPLETION)<='31-MAR-" + yearEnd + "' and b.DATE_OF_COMPLETION is not null and "
    					        + "  a.TYPE_OF_ASSET in (" + schemes + ") and a.SANCTION_AMOUNT >5";
                    }
}else
{query = "select distinct a.SANCTION_AMOUNT, a.work_id,a.work_name,nvl(to_char(admin_date,'dd/mm/yyyy'),'--'),nvl(to_char(TARGET_DATE_COMP ,'dd/mm/yyyy'),'--'),to_char(b.DATE_OF_COMPLETION,'dd/mm/yyyy'),ADMIN_NO,dis.dname,nvl(a.lead_habitation,'--') as lead_habitation,nvl(a.office_code,'--') as office_code "
        + "from RWS_WORK_COMP_HAB_LNK_TBL h,rws_habitation_directory_tbl hd,rws_work_admn_tbl a,rws_work_completion_tbl b,RWS_SOURCE_IDEN_FIN_TBL i,RWS_WORK_COMMENCEMENT_TBL c ,rws_contractor_selection_tbl m,rws_district_tbl dis  where dis.dcode=substr(a.work_id,5,2) and "
        + "WORK_CANCEL_DT is null and b.work_id=a.work_id and i.work_id(+)=a.work_id  and c.work_id(+)=a.work_id and m.work_id(+)=a.work_id "
        + "and h.work_id=a.work_id and hd.hab_code=h.hab_code and a.programme_code in ("+pc+")  and TO_DATE(b.DATE_OF_COMPLETION) >= '01-APR-"+yearStart+"' and TO_DATE(b.DATE_OF_COMPLETION)<='31-MAR-" + yearEnd + "' and b.DATE_OF_COMPLETION is not null and "
        + "  a.TYPE_OF_ASSET in (" + schemes + ") ";//TO_DATE(TARGET_DATE_COMP)>='01-APR-" + yearStart + "' and and  a.CORE_DASHBOARD_STATUS='Y'
}
    						...
    						query = "select a.SANCTION_AMOUNT,a.work_id,a.work_name,nvl(to_char(admin_date,'dd/mm/yyyy'),'--'),nvl(to_char(TARGET_DATE_COMP ,'dd/mm/yyyy'),'--'),ADMIN_NO,dis.dname,nvl(a.lead_habitation,'--') as lead_habitation,nvl(a.office_code,'--') as office_code from "
	                                ...
	                                +"(select work_id from rws_work_completion_tbl where DATE_OF_COMPLETION is not null and TO_DATE(DATE_OF_COMPLETION) < '01-APR-"+yearStart+"')  " 
						...
						query = "select a.SANCTION_AMOUNT,a.work_id,a.work_name,nvl(to_char(admin_date,'dd/mm/yyyy'),'--'),nvl(to_char(TARGET_DATE_COMP ,'dd/mm/yyyy'),'--'),ADMIN_NO,dis.dname,nvl(a.lead_habitation,'--') as lead_habitation,nvl(a.office_code,'--') as office_code from "
                                + "rws_work_admn_tbl a,rws_programme_tbl p,RWS_SOURCE_IDEN_FIN_TBL i,RWS_WORK_COMMENCEMENT_TBL c, rws_contractor_selection_tbl m,rws_district_tbl dis where substr(a.work_id,5,2)=dis.dcode and "//,rws_new_est_tbl t
                                + "WORK_CANCEL_DT is null and  a.programme_code=p.PROGRAMME_CODE and a.programme_code in (" + pc + ") "
                                ...
                                + "and a.TYPE_OF_ASSET in (" + schemes + ")";//and TO_DATE(TARGET_DATE_COMP)>='01-APR-" + yearStart + "'
        					
                            
                }else if (mode.equals("canWorks")) { //cancel works  
                	System.out.println("inside canWorks ...");
if(pc.equals(scode)&& schemeName.contains("laks")){
    					
    					if(schemeName.contains("Below 5 laks")){
    						query = "select distinct a.SANCTION_AMOUNT, a.work_id,a.work_name,nvl(to_char(admin_date,'dd/mm/yyyy'),'--'),nvl(to_char(TARGET_DATE_COMP ,'dd/mm/yyyy'),'--'),to_char(b.DATE_OF_COMPLETION,'dd/mm/yyyy'),ADMIN_NO,dis.dname,nvl(a.lead_habitation,'--') as lead_habitation,nvl(a.office_code,'--') as office_code "
    						        + "from RWS_WORK_COMP_HAB_LNK_TBL h,rws_habitation_directory_tbl hd,rws_work_admn_tbl a,rws_work_completion_tbl b,RWS_SOURCE_IDEN_FIN_TBL i,RWS_WORK_COMMENCEMENT_TBL c ,rws_contractor_selection_tbl m,rws_district_tbl dis  where dis.dcode=substr(a.work_id,5,2) and "
    						        + "WORK_CANCEL_DT is not null and b.work_id=a.work_id and i.work_id(+)=a.work_id  and c.work_id(+)=a.work_id and m.work_id(+)=a.work_id "
    						        + "and h.work_id(+)=a.work_id and hd.hab_code(+)=h.hab_code and a.programme_code in ("+pc+") and b.DATE_OF_COMPLETION is not null and "
    						        + "  a.TYPE_OF_ASSET in (" + schemes + ")  and a.SANCTION_AMOUNT <=5";
	...
	System.out.println("inside else canWorks ...");		
	query = "select distinct a.SANCTION_AMOUNT, a.work_id,a.work_name,nvl(to_char(admin_date,'dd/mm/yyyy'),'--'),nvl(to_char(TARGET_DATE_COMP ,'dd/mm/yyyy'),'--'),to_char(b.DATE_OF_COMPLETION,'dd/mm/yyyy'),ADMIN_NO,dis.dname,nvl(a.lead_habitation,'--') as lead_habitation,nvl(a.office_code,'--') as office_code "
        + "from RWS_WORK_COMP_HAB_LNK_TBL h,rws_habitation_directory_tbl hd,rws_work_admn_tbl a,rws_work_completion_tbl b,RWS_SOURCE_IDEN_FIN_TBL i,RWS_WORK_COMMENCEMENT_TBL c ,rws_contractor_selection_tbl m,rws_district_tbl dis  where dis.dcode=substr(a.work_id,5,2) and "
        + "WORK_CANCEL_DT is not null and b.work_id=a.work_id and i.work_id(+)=a.work_id  and c.work_id(+)=a.work_id and m.work_id(+)=a.work_id "
        + "and h.work_id(+)=a.work_id and hd.hab_code(+)=h.hab_code and a.programme_code in ("+pc+") and b.DATE_OF_COMPLETION is not null and "
        + "  a.TYPE_OF_ASSET in (" + schemes + ") ";
    					...
    					}else if (mode.equals("wcPrevYear")) {  //
    						...
    						if(pc.equals(scode)&& schemeName.contains("laks")){
    						    					...
    						    					if(schemeName.contains("Below 5 laks")){
    						    						query = "select a.SANCTION_AMOUNT,a.work_id,a.work_name,nvl(to_char(admin_date,'dd/mm/yyyy'),'--'),nvl(to_char(TARGET_DATE_COMP ,'dd/mm/yyyy'),'--'),ADMIN_NO,dis.dname,nvl(a.lead_habitation,'--') as lead_habitation,nvl(a.office_code,'--') as office_code from "
        				    		                            ...
        				    		                            + "WORK_CANCEL_DT is null and  a.programme_code=p.PROGRAMME_CODE and a.programme_code in (" + pc + ") "
        				    		                            + "and a.work_id  in(select work_id from rws_work_completion_tbl where DATE_OF_COMPLETION is not null and TO_DATE(DATE_OF_COMPLETION)<'01-APR-" + yearStart + "') "
        				    		                            + "and i.work_id(+)=a.work_id  and c.work_id(+)=a.work_id and m.work_id(+)=a.work_id  "
    						...
    						{
    							query = "select a.SANCTION_AMOUNT,a.work_id,a.work_name,nvl(to_char(admin_date,'dd/mm/yyyy'),'--'),nvl(to_char(TARGET_DATE_COMP ,'dd/mm/yyyy'),'--'),ADMIN_NO,dis.dname,nvl(a.lead_habitation,'--') as lead_habitation,nvl(a.office_code,'--') as office_code from "
    		                            + "rws_work_admn_tbl a,rws_programme_tbl p,rws_district_tbl dis where dis.dcode=substr(a.work_id,5,2) and " //,RWS_SOURCE_IDEN_FIN_TBL i,RWS_WORK_COMMENCEMENT_TBL c, rws_contractor_selection_tbl m,
    		                            + "WORK_CANCEL_DT is null and  a.programme_code=p.PROGRAMME_CODE and a.programme_code in (" + pc + ") "
    		                            + "and a.work_id  in(select work_id from rws_work_completion_tbl where  TO_DATE(DATE_OF_COMPLETION)<'01-APR-" + yearStart + "') "
    		                           // + "and i.work_id(+)=a.work_id  and c.work_id(+)=a.work_id and m.work_id(+)=a.work_id  "
    		                            + "and a.TYPE_OF_ASSET in (" + schemes + ") ";
    						...
    						if(pc.equals(scode)&& schemeName.contains("laks")){
    						                    ...
    						                    query = "select a.SANCTION_AMOUNT,a.work_id,a.work_name,nvl(to_char(admin_date,'dd/mm/yyyy'),'--'),nvl(to_char(TARGET_DATE_COMP ,'dd/mm/yyyy'),'--'),ADMIN_NO,dis.dname,nvl(a.lead_habitation,'--') as lead_habitation,nvl(a.office_code,'--') as office_code from "
    											        + "rws_work_admn_tbl a,rws_programme_tbl p,RWS_SOURCE_IDEN_FIN_TBL i,RWS_WORK_COMMENCEMENT_TBL c, rws_contractor_selection_tbl m,rws_district_tbl dis where dis.dcode=substr(a.work_id,5,2) and "
    											        + " a.programme_code=p.PROGRAMME_CODE and a.programme_code in (" + pc + ") "
    											        +" and a.work_cancel_dt is null and a.work_id not in (select work_id from rws_work_completion_tbl where DATE_OF_COMPLETION is not null) "
    											        + "and  i.work_id(+)=a.work_id  and c.work_id(+)=a.work_id and m.work_id(+)=a.work_id  "
    											        + "and a.TYPE_OF_ASSET in (" + schemes + ") and a.CORE_DASHBOARD_STATUS='Y'  and ( TARGET_DATE_COMP is not null OR TARGET_DATE_COMP <> '') and a.SANCTION_AMOUNT <=5";
						...
						query = "select a.SANCTION_AMOUNT,a.work_id,a.work_name,nvl(to_char(admin_date,'dd/mm/yyyy'),'--'),nvl(to_char(TARGET_DATE_COMP ,'dd/mm/yyyy'),'--'),ADMIN_NO,dis.dname,nvl(a.lead_habitation,'--') as lead_habitation,nvl(a.office_code,'--') as office_code from "
						        + "rws_work_admn_tbl a,rws_programme_tbl p,RWS_SOURCE_IDEN_FIN_TBL i,RWS_WORK_COMMENCEMENT_TBL c, rws_contractor_selection_tbl m,rws_district_tbl dis where dis.dcode=substr(a.work_id,5,2) and "
						        + " a.programme_code=p.PROGRAMME_CODE and a.programme_code in (" + pc + ") "
						        +" and a.work_cancel_dt is null and a.work_id not in (select work_id from rws_work_completion_tbl) "
						        + "and  i.work_id(+)=a.work_id  and c.work_id(+)=a.work_id and m.work_id(+)=a.work_id  "
						        + "and a.TYPE_OF_ASSET in (" + schemes + ") and a.CORE_DASHBOARD_STATUS='Y'  and ( TARGET_DATE_COMP is not null OR TARGET_DATE_COMP <> '')";
               ...
               System.out.println("WOrk Related :- "+ query);
                ...
                while (rs.next()) {
                 ...
                 // MAX( nvl(to_char(EE_FWD_DATE,'dd/mm/yyyy'),'--'))
                    String billAmtQuery ="select SUM(BILL_AMT_ADMISSIBLE),MAX( to_char(EE_FWD_DATE,'dd-MON-yyyy')) from rws_work_bill_tbl a where not EXISTS  (select 1 from rws_bill_bank_bridge_tbl b where b.work_id=a.work_Id and b.bill_sl_no=a.bill_sl_no ) and a.work_id='" + rs.getString(2) + "'";
                   ...
                   // System.out.println("###############"+sachabs);
					...
					Double bankAmount=0.0,paoAmount=0.0,tot_amount=0.0;
					 ...
					 resultSet=statement.executeQuery(bank);
	                  if (resultSet.next()) {
	                      bankAmount = resultSet.getDouble(1)/100000;
	                 ...
	                 //System.out.println("****"+subdivNameQuery);
	                  if (resultSet.next()) {
