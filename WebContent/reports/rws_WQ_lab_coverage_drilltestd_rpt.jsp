...
System.out.println("yr**************8"+yr);

//String yr3=request.getParameter(yr3);
String yr3=(String)session.getAttribute("yr3");
System.out.println("yr3**************8"+yr3);
...
query="select distinct dname,mname,pname,vname,panch_name,panch_code from rws_water_sample_collect_tbl a,rws_wq_test_results_tbl b,rws_complete_hab_view c where  c.panch_code=a.hab_code and a.source_code=b.source_code and a.test_id=b.test_id and C.COVERAGE_STATUS<>'UI' and  to_date(SAMP_COLLECT_DATE)>='1-APR-"+yr+"' and  to_date(SAMP_COLLECT_DATE)<'31-MAR-"+yr3+"' and dcode='"+dcode+"'  order by dname";
