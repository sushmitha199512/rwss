...
<%
 ...
 try
 {
   ...
   sqlquery ="select hp_code,location,drill_year,diameter,status,static_wl,summer_wl,depth,quality_affected,flouride,brakish,iron from rws_hp_subcomp_param_tbl where substr(hp_code,1,2)=? and substr(hp_code,6,2)=? order by drill_year";
		...
		<caption>
			<table  border=0 rules=none style="border-collapse:collapse" width=100% align="right" bgcolor="#edf2f8">		
				<tr>
					...
					<a href="javascript:window.history.back()">Excel
					</td> 
				</tr>
			</table>
		</caption>
		<tr bgcolor="#efefef" align="center">
			<td align="center" class="rptHeading" colspan=13>Mandal-Borewell-Details-Report</font></td>	
		</tr>
		<tr align="center" class="rptLabel">
			<td rowspan=2>Sno</td>
			<td rowspan=2>Mandal Name</td>
			<td rowspan=2>No Of Borewells</td>
			<td colspan=5 align=center>Status</td>
			<td colspan=4 align=center>Quality</td>
		</tr>
		<tr align="center" class="rptLabel">
