	...
	function fnSubmit()
	{
		...
		if(user=="admin" || user=="100000")
		{
			...
			else
			{
				...
				document.f1.disname.value = document.f1.district.options[document.f1.district.selectedIndex].text;
				
				document.f1.action="./rws_work_district_division_rpt.jsp";
				document.f1.submit();
			}	
...
<table border = 1 align = center cellspacing = 0 cellpadding = 0 rules = "rows" bordercolor = navy style = "border-collapse:collapse" bgcolor="#ffffff" width=350>		
	...
	<tr bgcolor="#8A9FCD" align="center">
		<td align="center" class="rptHeading" colspan=3>Work Voucher Wise Report</td>	
	</tr>
	...
	<tr><td class=rptLabel>District&nbsp;&nbsp;<font color="red">*</font></td>
		...
		<%
		  ...
		  stmt = conn.createStatement();
			...
			System.out.println("dcodedname*******"+query);
