...
<caption>
 ...
 <tr bgcolor="#8A9FCD" align="center">
		 <td align="center" class="rptHeading" colspan=7><font color="white">Asset Check List Report - Open Well</font></td>	
   </tr>
    <tr bgcolor="#8A9FCD" align="center">
...
<%}%>
 ...
 <%
if(totCount!=0){
String firstpgurl = "WsPagerOw.jsp?pager.offset=0&district="+rDist+"&mandal="+rMandal+"&asset="+assetcode+"";
String prevpgurl = "WsPagerOw.jsp?pager.offset="+prevpgno+"&district="+rDist+"&mandal="+rMandal+"&asset="+assetcode;
String nextpgurl = "WsPagerOw.jsp?pager.offset="+nextpgno+"&district="+rDist+"&mandal="+rMandal+"&asset="+assetcode;
String lastpgurl = "WsPagerOw.jsp?pager.offset="+totalpgno+"&district="+rDist+"&mandal="+rMandal+"&asset="+assetcode;
...
if(i<=totalpgno)
	{
	String currenturl = "WsPagerOw.jsp?pager.offset="+i+"&district="+rDist+"&mandal="+rMandal+"&asset="+assetcode;
	if(currentpageno==i){%>
...
<%}
	...
	{
		%>
		<%String currenturl = "WsPagerOw.jsp?pager.offset="+j+"&district="+rDist+"&mandal="+rMandal+"&asset="+assetcode;
		if(currentpageno==j){%>
