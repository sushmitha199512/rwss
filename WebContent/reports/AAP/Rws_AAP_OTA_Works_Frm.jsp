...
String query = null;
   ...
   String ccode="";
   String divcode=""; 
   if(!loggedUser.equals(Constants.ADMIN) && !loggedUser.equals(Constants.LAKH_USER) && !loggedUser.equals(Constants.MINISTER)){
...
function unview()
{
  ...
  var year2=finyear.substring(5,9);
     var cyear=new Date().getFullYear() ;
		...
		if(logValue=="admin" || logValue=="100000" || logValue=="minrwss" )
		{
			if(document.f1.district.value=='00')
			{
			    document.f1.mode.value='districts';
			}
			...
			else
		{
			...
			document.f1.action="./Rws_AAP_OTA_Works_Rpt.jsp";
...
<%} %>
	...
	<tr bgcolor="#8A9FCD" align="center">
		<td align="center" class="rptHeading" colspan=4>AAP Report (All Schemes)</td>
	</tr>
...
<input type="hidden" name="district" value='<%=rs.getString(1) %>'  />
			...
			query="SELECT  d.dcode,d.dname from rws_district_tbl d ,rws_division_office_tbl a where a.circle_office_code=d.dcode and a.circle_office_code='"+ccode+"' and a.division_office_code='"+divcode+"'";
			rs = stmt.executeQuery(query);
			if(rs.next())
			{%>
...
<!-- <tr><td class=rptLabel>Sub Plan&nbsp;&nbsp;<font color="red">*</font></td>
		<td class=btext>
		<SELECT name="type" id="combo3" class="mycombo" style="width:150px">
