...
document.f1.distname.value = document.f1.combo.options[document.f1.combo.options.selectedIndex].text;
			...
			else
		{
			...
			document.f1.action="./rws_aap_lpcd_rpt1.jsp";
...
<%} %>
	...
	<tr bgcolor="#8A9FCD" align="center">
		<td align="center" class="rptHeading" colspan=4>AAP Habitations Coverage Abstract</td>
	</tr>
...
<td class=btext><%
	...
	if(loggedUser!=null && (loggedUser.equals(Constants.ADMIN)||loggedUser.equals(Constants.LAKH_USER) ||loggedUser.equals(Constants.GUEST) || loggedUser.equals(Constants.DROUGHT_USER) || loggedUser.equals(Constants.SEC_USER)))
	{
%>
...
</tr><tr><td class=rptLabel>Sub Plan Submitted:<font color="red">*</font></td>
<td class=btext>
		<SELECT name="category" id="combo4" style="width:140px"  >
		...
		</td><td class=rptLabel>LPCD Range:<font color="red">*</font></td><td><SELECT name="lpcdrange" id="combo4" style="width:140px"  >
