...
<%   
   ...
   /*rs.beforeFirst();
    ...
    /*
    dist[0]="     Projects  "; data[0]=rs.getInt(1);
	dist[1]="     Normal  ";
	dist[2]="     District Level  ";*/
...
//System.out.println("value of p is  "+p);
	...
	ch.addTitle("No Safe Habitations Graph   ", "times new roman Bold Italic",12);
...
String ss[]=new String[c];
  ...
  for(j=0;j<c;j++){
	...
	if(x.equals("b"))
   {
	...
	ch.addTitle("No Safe Source Habitations Graph", "times new roman Bold Italic",12);
	//ch.setPlotArea(40, 40, 200, 150);
	ch.yAxis().setTitle("Total ");
	ch.xAxis().setTitle("No Safe Source Habitations");
...
if(x.equals("p"))
 {
    ...
    ch.addTitle2(Chart.Top, "No Safe Source Habitations Graph", "Times New Roman Bold Italic",12);
	ch.set3D();
