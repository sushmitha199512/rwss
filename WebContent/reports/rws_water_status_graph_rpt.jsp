...
//System.out.println("value of p is  "+p);
	...
	ch.addTitle("Water Quality Samples Graph ", "times new roman Bold Italic",12);
...
String ss[]=new String[c];
  ...
  for(j=0;j<c;j++){
	...
	if(x.equals("b"))
   {
	...
	ch.yAxis().setTitle("No. of Samples");
	ch.xAxis().setTitle("Type of Tests");
...
if(x.equals("p"))
 {
    ...
    ch.addTitle2(Chart.Top, "Water Quality Samples Graph", "Times New Roman Bold Italic",12);
	ch.set3D();
