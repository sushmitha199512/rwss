...
{ %>
			<tr><td align="right" class="bwborder"><a href="/pred/home.jsp?loginMode=watersoft">Home|</a></td>
				<td class="bwborder"><a href="javascript:onclick=history.go(-1))">Back|</a><a href="./rws_works_program_details_excel.jsp" target=_new>Excel</a></td></tr>
<%  } else {%>
...
<td class=btext  align=center colspan=17 style="background-color:lightyellow">Spill Over Works</td>
<td class=btext colspan=15 align=center style="background-color:#d2b48c">New Works</td>
</tr>
<tr>
 ...
 <td  class=btext align="center"style="background-color:lightyellow"  colspan=2>Releases During <br><%=financialstartyr %></td>	
		<td  class=btext align="center"style="background-color:lightyellow"  colspan=2>Expenditure During <br><%=financialstartyr %></td>	
		<td  class=btext align="center" style="background-color:lightyellow" colspan=2>No.of.Works Completed<br><%=financialstartyr %></td>
...
<td  class=btext align="center" style="background-color:lightyellow" colspan=2>Habs Covered during <br><%=financialstartyr %></td>	
...
<td  class=btext align="center" style="background-color:#d2b48c" colspan=2>Releases During <br><%=financialstartyr %></td>
		<td  class=btext align="center" style="background-color:#d2b48c" colspan=2>Expenditure During <br><%=financialstartyr %></td>	
		<td class=btext align="center" style="background-color:#d2b48c" rowspan=2>Bal Est.Cost </td>

		<td  class=btext align="center" style="background-color:#d2b48c" colspan=2>No.of.Works Completed <br><%=financialstartyr %></td>
		<td  class=btext align="center" style="background-color:#d2b48c" rowspan=2>Habs Sanctioned</td>	
<td  class=btext align="center" style="background-color:#d2b48c" colspan=2>Habs Covered during <br><%=financialstartyr %></td>	
...
<tr><td align="center" class=btext>1</td><td align="center" class=btext>2</td><td align="center" class=btext>3</td><td align="center" class=btext colspan=3 >4</td><td align="center" class=btext >5</td><td align="center" class=btext>6</td><td align="center" class=btext>7</td><td align="center" colspan=2 class=btext>8</td><td align="center" class=btext colspan=2>9</td><td align="center" colspan=2 class=btext>10</td><td align="center" class=btext>11</td><td align="center" class=btext>12</td><td align="center" class=btext>13</td><td align="center" class=btext colspan=2>14</td><td align="center"  class=btext>15</td><td align="center" class=btext >16</td><td align="center"  class=btext>17</td><td align="center" class=btext >18</td><td align="center" class=btext colspan=2>19</td><td align="center" class=btext colspan=2>20</td><td align="center" class=btext>21</td><td align="center" class=btext>22</td><td align="center" class=btext>23</td><td align="center" class=btext>24</td><td align="center" class=btext>25</td><td align="center" class=btext>26</td></tr>
...
//System.out.println("newWorksCompQuery1"+newWorksCompQuery1);
	...
	String newWorksExpQuery="select b.circle_office_code,b.division_office_code,sum(case when to_date(voucher_dt)< '01-Apr-"+startyr+"' then voucher_amt else 0 end)||'@'||sum(case when (to_date(voucher_dt)>= '01-Apr-"+startyr+"' and to_date(voucher_dt)< '01-"+cmonth+"-"+endyr1+"') then voucher_Amt else 0 end) FROM RWS_WORK_ADMN_TBL W ,rws_division_office_tbl b,rws_work_exp_voucher_tbl a  where  (w.ADMIN_DATE >= '01-Apr-"+startyr+"' and w.ADMIN_DATE < '01-Apr-"+endyr+"') and work_cancel_dt is null ";
 if(scheme!=null && !scheme.equals("")){
...
newWorksCurExpQuery+=" and  substr(w.office_code,2,2)=b.circle_office_code and substr(w.office_code,4,1)=b.division_office_code and  w.programme_code in ("+programe+") and  a.work_id=w.work_id  group by  b.circle_office_code,b.division_office_code  order by 1";
		stmt3=conn.createStatement();
//System.out.println("newWorksCurExpQuy11"+newWorksCurExpQuery);
...
String newCurRelBankQuery="select b.circle_office_code,b.division_office_code,sum(case when (to_date(BANK_SEND_DATE)>= '01-APR-"+startyr+"' and to_date(BANK_SEND_DATE) < '01-"+cmonth+"-"+endyr1+"') then BILL_AMOUNT_CENTRAL else 0 end)||'@'||sum(case when (to_date(BANK_SEND_DATE)>='01-"+cmonth+"-"+endyr1+"' and to_date(BANK_SEND_DATE)< '01-"+nextmonth+"-"+endyr1+"') then BILL_AMOUNT_CENTRAL else 0 end) FROM RWS_WORK_ADMN_TBL W ,rws_division_office_tbl b,RWS_bill_bank_bridge_det_TBL a  where  (w.ADMIN_DATE >= '01-Apr-"+startyr+"' and w.ADMIN_DATE < '01-Apr-"+endyr+"') and work_cancel_dt is null ";
 if(scheme!=null && !scheme.equals("")){
...
String newCurRelpaoQuery="select b.circle_office_code,b.division_office_code,sum(case when (to_date(STATE_SEND_DATE)>= '01-APR-"+startyr+"' and to_date(STATE_SEND_DATE) < '01-"+cmonth+"-"+endyr1+"') then BILL_AMOUT_STATE else 0 end)||'@'||sum(case when (to_date(STATE_SEND_DATE)>='01-"+cmonth+"-"+endyr1+"' and to_date(STATE_SEND_DATE)< '01-"+nextmonth+"-"+endyr1+"') then BILL_AMOUT_STATE else 0 end) FROM RWS_WORK_ADMN_TBL W ,rws_division_office_tbl b,RWS_bill_pao_bridge_det_TBL a  where  (w.ADMIN_DATE >= '01-Apr-"+startyr+"' and w.ADMIN_DATE < '01-Apr-"+endyr+"') and work_cancel_dt is null ";
 if(scheme!=null && !scheme.equals("")){
...
String newWoksCoveredHabs="select b.circle_office_code,b.division_office_code,count(*) FROM RWS_WORK_ADMN_TBL W ,rws_division_office_tbl b,RWS_WORK_COMP_HAB_LNK_TBL c  where w.work_id=c.work_id and   work_cancel_dt is null and substr(w.office_code,2,2)=b.circle_office_code and substr(w.office_code,4,1)=b.division_office_code ";
if(scheme!=null && !scheme.equals("")){
          newWoksCoveredHabs+="and w.type_of_asset in("+scheme+")";
}
//newWoksCoveredHabs+=" and  w.programme_code in ("+programe+")  and w.work_id in(select work_id from rws_work_completion_tbl where (to_date(DATE_OF_COMPLETION) > '01-Apr-"+startyr+"') and (to_date(DATE_OF_COMPLETION) < '01-"+cmonth+"-"+endyr1+"')) group by  b.circle_office_code,b.division_office_code  order by 1";
newWoksCoveredHabs+=" and  w.programme_code in ("+programe+")  and w.work_id in(select work_id from rws_work_completion_tbl where (date_of_completion between to_date('01-Apr-"+startyr+"','dd-mon-yyyy') and to_date('01-"+cmonth+"-"+endyr1+"','dd-mon-yyyy')) or (PARTIAL_DATE_OF_COMPLETION  between to_date('01-Apr-"+startyr+"','dd-mon-yyyy') and to_date('01-"+cmonth+"-"+endyr1+"','dd-mon-yyyy')) ) group by  b.circle_office_code,b.division_office_code  order by 1";

		stmt3=conn.createStatement();
//System.out.println("november"+newWoksCoveredHabs);
...
newWoksCoveredHabs1+=" and  w.programme_code in ("+programe+")  and w.work_id in(select work_id from rws_work_completion_tbl where (date_of_completion>=to_date('01-"+cmonth+"-"+endyr1+"','dd-mon-yyyy')) or (PARTIAL_DATE_OF_COMPLETION>=to_date('01-"+cmonth+"-"+endyr1+"','dd-mon-yyyy')) ) group by  b.circle_office_code,b.division_office_code  order by 1";

		stmt3=conn.createStatement();
//System.out.println("december"+newWoksCoveredHabs1);
...
String spillExpQuery="SELECT b.circle_office_code,b.division_office_code,sum(case when to_date(voucher_dt)< '01-Apr-"+startyr+"' then voucher_amt else 0 end)||'@'||sum(case when (to_date(voucher_dt)>= '01-Apr-"+startyr+"' and to_date(voucher_dt)< '01-"+cmonth+"-"+endyr1+"') then voucher_Amt else 0 end)  FROM RWS_WORK_ADMN_TBL W ,rws_division_office_tbl b,rws_work_exp_voucher_tbl a where to_date(w.ADMIN_DATE) <'01-Apr-"+startyr+"'   and a.work_id=w.work_id  and substr(w.office_code,2,2)=b.circle_office_code and substr(w.office_code,4,1)=b.division_office_code  and w.programme_code in ("+programe+") ";
...
String spillRelBankQuery="SELECT b.circle_office_code,b.division_office_code,sum(case when (to_date(BANK_SEND_DATE)>= '01-APR-"+startyr+"' and to_date(BANK_SEND_DATE) < '01-"+cmonth+"-"+endyr1+"') then BILL_AMOUNT_CENTRAL else 0 end)||'@'||sum(case when (to_date(BANK_SEND_DATE)>='01-"+cmonth+"-"+endyr1+"' and to_date(BANK_SEND_DATE)< '01-"+nextmonth+"-"+endyr1+"') then BILL_AMOUNT_CENTRAL else 0 end)  FROM RWS_WORK_ADMN_TBL W ,rws_division_office_tbl b,RWS_bill_bank_bridge_det_TBL a where to_date(w.ADMIN_DATE) <'01-Apr-"+startyr+"'   and a.work_id=w.work_id  and substr(w.office_code,2,2)=b.circle_office_code and substr(w.office_code,4,1)=b.division_office_code  and w.programme_code in ("+programe+") ";
...
String spillRelPaoQuery="SELECT b.circle_office_code,b.division_office_code,sum(case when (to_date(STATE_SEND_DATE)>= '01-APR-"+startyr+"' and  to_date(STATE_SEND_DATE) < '01-"+cmonth+"-"+endyr1+"') then BILL_AMOUT_STATE else 0 end)||'@'||sum(case when (to_date(STATE_SEND_DATE)>='01-"+cmonth+"-"+endyr1+"' and to_date(STATE_SEND_DATE)< '01-"+nextmonth+"-"+endyr1+"') then BILL_AMOUT_STATE else 0 end)  FROM RWS_WORK_ADMN_TBL W ,rws_division_office_tbl b,RWS_bill_pao_bridge_det_TBL a where to_date(w.ADMIN_DATE) <'01-Apr-"+startyr+"'   and a.work_id=w.work_id  and substr(w.office_code,2,2)=b.circle_office_code and substr(w.office_code,4,1)=b.division_office_code  and w.programme_code in ("+programe+") ";
