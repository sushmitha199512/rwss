...
<BODY>
<table>
<tr><td class=btext align="center">Habitation Free Format Report</td></tr>
<tr>
<td align=right>
<A HREF="javascript:history.go(-1)">Back</A>&nbsp;|&nbsp;
<a href="<rws:context page='/home.jsp'/>">Home</a>&nbsp;|&nbsp;<a href="/pred/reports/excel_flexi_report.jsp" target="_new">Excel</a>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
</td>
</tr>
<tr><td>
...
<%}%>
<b><font color="indigo">Total No. Of Records:</font><%= count %><font size='02' color="red">&nbsp;(Only Habitations Mapped with Constituency are  Displayed in this Report)</font></b>
<%}%>
<!-- CONSOLIDATED REPORT -->
<%
