...
<form>
	...
	<td class="bwborder"><a href="/pred/home.jsp?loginMode=watersoft">Home | </a><a href="./rws_schoolgis_excel.jsp" target=_new>Excel</a></td>
	</tr>  
	</table>
	</caption>
	<tr bgcolor="#8A9FCD" align="center">
	<td align="center" class="rptHeading" > School  Information - Report &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;District:<%=dname%>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Mandal:<%=mname%>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	 </td>
	</tr>
	</table>
	...
	<td class=btext rowspan = 2>Habitation Code/<br>Name</td>
	<td class=btext rowspan=2>Schoolcode/<br>Name</td>
    	
	<td class=btext rowspan=2>SchoolLocation</td>
    <td class=btext  rowspan=2 >Category of School/<br>Classification</td>
	 
     <td class=btext  rowspan = 2>Facilities Available(Yes/No)<br>Drinking Water/Sanitation</td>
