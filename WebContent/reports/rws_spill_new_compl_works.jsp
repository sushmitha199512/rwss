...
<caption>
	<table  border=0 rules=none style="border-collapse:collapse" align = "right">
		<tr align="right">
				<td align="right" colspan="45"><a href="./rws_spill_new_frm.jsp">Back</a>|<a href="../home.jsp">Home|</a>|<a href="./rws_spill_new_compl_works_xls.jsp" target="_new">Excel</a></td>
		</tr>
	</table>
<caption>
<tr>
...
//System.out.println("distrct:"+district);
//System.out.println("Scheme:"+schemes);
session.setAttribute("district",district);
session.setAttribute("scheme",schemes);
try
{
int slno = 1;
  st2 = conn.createStatement();
  query1 = "select w.work_id,w.office_code,w.work_name,to_char(w.admin_date,'dd/MON/yyyy') as admin_date,to_char(w.admin_date,'dd/mm/yyyy') as admin_year,w.no_of_habs from rws_work_admn_tbl w where  category_code = '"+schemes+"' and length(office_code)>='4' and substr(work_id,5,2)='"+district+"' and w.admin_date is not null and substr(work_id,1,2) in (select programme_code from rws_programme_tbl)"; 
//System.out.println("query:"+query1);
  ...
  while(rs2.next())
  {
	...
	}catch(Exception e){}finally{if(rs3!=null)rs3.close();if(st3!=null)st3.close();}
%>
<tr bgcolor="#edf2f8">
...
<%
	...
	//System.out.println("q5 query:"+q5);
	try{
	...
	<%}
	}catch(Exception e){}finally{if(rs6!=null)rs6.close();if(st6!=null)st6.close();}
	try{
	...
	<td class="rptValue">0.0</td>
	<%}
	}catch(Exception e){}finally{if(rs10!=null)rs10.close();if(st10!=null)st10.close();}
%>	
	<td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td>
	...
	//System.out.println("q41 query:"+q41);
	try{
	...
	}catch(Exception e){}finally{if(rs41!=null)rs41.close();if(st41!=null)st41.close();}
	%>
	...
	<%}}catch(Exception e){}finally{if(rs7!=null)rs7.close();if(st7!=null)st7.close();}
	...
	//System.out.println("q6 query:"+q6);
	try{
	...
	}catch(Exception e){}finally{if(rs9!=null)rs9.close();if(st9!=null)st9.close();}
	%>
...
try{
 ...
 %>
	...
	}catch(Exception e){}finally{if(rs5!=null)rs5.close();if(st5!=null)st5.close();}
	}
	}catch(Exception e){}finally{if(rs4!=null)rs4.close();if(st4!=null)st4.close();}
	%>
	...
	//System.out.println("Record Printed with S NO:"+slno);
   	...
   	{
   		//System.out.println("Exceptionsssssssss: "+e);
   	}
