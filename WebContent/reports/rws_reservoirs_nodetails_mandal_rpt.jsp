s<%@ include file="/commons/rws_header1.jsp"%>
...
try
{
    	...
    	while(rs1.next())
			{    
	     	...
	     	%>
                ...
                <td class=rptValue><a href="rws_reservoirs_nodetails_mandal_detail_rpt.jsp?district=<%=district%>&assettype=<%=assettype%>&mandal=<%=rs1.getString(1)%>&mandalname=<%=rs1.getString(2)%>"><%=pwsreservoirs%></a></td>
                </tr>
                <%}
    ...
    <td class="btext"><%=gpwsreservoirs%></td>
