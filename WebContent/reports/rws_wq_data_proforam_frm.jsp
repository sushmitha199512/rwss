...
<!--
	...
	if(document.f1.mandal.selectedIndex == "00")
		...
		document.f1.action="./rws_wq_data_proforam_rpt.jsp";
		document.f1.submit();		
	}
//-->
</script>
...
<table border=1 align=center cellspacing=0 cellpadding=0 rules="rows" bordercolor=navy style="border-collapse:collapse" bgcolor="#ffffff">		
	...
	<tr bgcolor="#8A9FCD" align="center">
		<td align="center" class="mystyle" colspan="4"><font color="navy">Water Quality Proforma Report</font></td>	
	</tr>
<%	
	String rDist = null;
...
%>
	<tr>
		<td class=btext colspan=3 align=center><font color=navy><b>Mandal</b></font><font color="red"><b>*</b></font></td>
		<td class=btext colspan=3 align=center>
...
%>
	<tr>
		<td class=btext colspan=3 align=center><font color=navy><b>Habitations</b></font></font></td>
		<td class=btext colspan=3 align=center>
