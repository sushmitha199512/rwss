...
<td align=center colspan=8 class="mystyle1"><font color="navy">Asset Type:&nbsp;&nbsp;<%=assetName%> </font></td></tr>
<%}%>
</table>
...
<%	
	...
	{		
		...
		<tr align=left >
			...
			<td  class="mystyle1"><a href = "rws_asset_div_off_rpt.jsp?districtcode=<%=record1[0]%>&districtname=<%=record1[1]%>"><%= record1[1]%></a></td>
