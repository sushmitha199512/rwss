...
<tr bgcolor="#8A9FCD" align="center">
		<td align="center" class="rptHeading" colspan="14">RESERVOIRS-OHBR-REPORT </td>
</tr>
</table>
...
try
{
	    ...
	    if(typeassetcode.equals("03"))
	{
		...
		rs1=stmt1.executeQuery("select ohbr_code,ohbr_cap_lts,nvl(ohbr_loc,'-'),ohbr_satges,ohbr_lwl,ohbr_mwl,ohbr_fill_hr,ohbr_empty_hr,asset_code from RWS_CPWS_OHBR_SC_PARAM_TBL  where asset_code='"+assetcode+"'  ");
...
<%
			...
			
	{
		...
		stmt1=conn.createStatement();
		rs1=stmt1.executeQuery("select  ohbr_code,ohbr_cap_lts,nvl(ohbr_loc,'-'),ohbr_satges,ohbr_lwl,ohbr_mwl,ohbr_fill_hr,ohbr_empty_hr,asset_code from RWS_PWS_OHBR_SC_PARAM_TBL  where asset_code='"+assetcode+"'  ");
		while(rs1.next())
    	{
...
<%
			...
			
	{
		...
		stmt1=conn.createStatement();
		rs1=stmt1.executeQuery("select  ohbr_code,ohbr_cap_lts,nvl(ohbr_loc,'-'),ohbr_satges,ohbr_lwl,ohbr_mwl,ohbr_fill_hr,ohbr_empty_hr,asset_code from RWS_MPWS_OHBR_SC_PARAM_TBL  where asset_code='"+assetcode+"'  ");
		while(rs1.next())
    	{
