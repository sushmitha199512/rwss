...
<tr bgcolor="#8A9FCD" align="center">
		<td align="center" class="rptHeading" colspan=22>DistrictWise - ProgramWise Works Abstract Report for the Financial Year(<%=session.getAttribute("financialyr")%>)</td>	
	</tr>
...
%>	
	<tr  align="center">
		<td align="center" class="btext" colspan=22  >District: All &nbsp; &nbsp;PLAN WORKS&nbsp; &nbsp;</td>
	</tr>	
...
%>	
	<tr  align="center">
		<td align="center" class="btext" colspan=22>District: <%=session.getAttribute("districtName")%> &nbsp; &nbsp;PLAN WORKS</td>
	</tr>	
	<%}
...
%>	
	<tr  align="center">
		<td align="center" class="btext" colspan=22  >District: <%=session.getAttribute("districtName")%> &nbsp; &nbsp;Division: <%=session.getAttribute("divname")%>&nbsp;&nbsp;PLAN WORKS</td>
	</tr>	<%}%>
