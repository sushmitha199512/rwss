...
<caption>
		<table  border=0 rules=none style="border-collapse:collapse" align = "right">			
			<tr align="right">
				...
				<td class="bwborder"><a href="./rws_borewells_nodata_mandal_excel_rpt.jsp?district=<%=district%>&assettype=<%=assettype%>&mandal=<%=mandal%>&mandalname=<%=mandalname%> %>" target="_new">Excel</a></td>
