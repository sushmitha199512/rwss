...
<tr bgcolor="#8A9FCD" align="center">
		<td align="center" class="rptHeading" colspan="14"> Assets - GLBR  </td>
</tr>
</table>
<table border=1 cellpadding=1 cellspacing=1 width="100%">
<tr align=center>
               <td class=btext>Sl.No</td>
			   <td class=btext>Glbr Code</td>
			   <td class=btext>Glbr Capacity in Lts</td>
			   <td class=btext>Glbr Location</td>
			   <td class=btext>Glbr Lowest Water Level(LWL)</td>
			   <td class=btext>Glbr Maximum Water Level(MWL)</td>
			   <td class=btext>Glbr Fill in  Hrs.</td>
			   <td class=btext>Glbr Empty Hrs.</td>
...
try
{
//	String glbr="select glbr_code,glbr_cap_lts,nvl(glbr_loc,'-'),glbr_lwl,glbr_mwl,glbr_fill_hr,glbr_empty_hr,staging,asset_code from RWS_AST_GLBR_SC_PARAM_TBL  where asset_code='"+assetcode+"' and substr(glbr_code,1,2)='"+ districtcode+"' and substr(glbr_code,6,2)='"+mandalcode+"' and substr(glbr_code,13,2)='"+ panchayatcode+"' and substr(glbr_code,8,3)='"+villagecode+"' ";
	String glbr="select glbr_code,glbr_cap_lts,nvl(glbr_loc,'-'),nvl(glbr_lwl,0),nvl(glbr_mwl,0),nvl(glbr_fill_hr,0),nvl(glbr_empty_hr,0) from RWS_AST_GLBR_SC_PARAM_TBL  where asset_code='"+assetcode+"' ";
	 
	stmt1=conn.createStatement();
		rs1=stmt1.executeQuery(glbr);
