...
<tr bgcolor="#8A9FCD" align="center">
		<td align="center" class="rptHeading" colspan="14"> Assets - CISTERN  </td>
</tr>
</table>
...
<tr align=center>
			   ...
			   <td class=btext>Cistern Condition</td>
			   
			   
			   <td class=btext>Platform Existing</td>
			   <td class=btext>Platform Condition</td>
			   <td class=btext>Drain Provided</td>
...
//	String query="select  cis_no,cis_loc,cis_cap_lts,cis_cond,nvl(cis_fill,'-'),nvl(cis_mod_fill,'-'),nvl(cis_use,'-'),cis_pf,cis_pf_con,cis_drain,cis_tap,cis_tap_cond,cis_hr,cis_hr_one,cis_hr_all,cissc_code from rws_ast_cis_sc_param_tbl  where asset_code='" + assetcode + "' and substr(cissc_code,1,2)='" + districtcode + "' and substr(cissc_code,6,2)='" + mandalcode + "' and substr(cissc_code,13,2)='" + panchayatcode + "' and substr(cissc_code,8,3)='" + villagecode + "'  ";
	String query="select  CISSC_CODE,nvl(cis_loc,'-'),nvl(cis_cap_lts,0),CIS_HR,decode(CIS_PF,'Y','Yes','N','No')result1,decode(CIS_PF_CON,'G','Good','B','Bad')result2,decode(CIS_DRAIN,'Y','Yes','N','No')result3,decode(water_qty,'Y','SAFESOURCE','N','NSS')result from rws_ast_cis_sc_param_tbl  where asset_code='" + assetcode + "' ";
	//
