...
<%
//String id="24";
//String scode="svs_ohsr";
//String circle_code="11";
...
//session.setAttribute("dcode",dcode );
   ...
   <table  class=gridbg1 border="1" cellspacing="0" cellpadding="0" width="60%" height="60%"
	...
	%>
<tr><td class="btext" colspan="17"><b> <%=pre%>-RESERVOIRS- <%=post%> REPORT </b></td>	</tr>
				<tr><td class="btext" colspan="17"><b>District: <%=districtName%>   Mandal: <%=mandName%></b></td></tr>					
