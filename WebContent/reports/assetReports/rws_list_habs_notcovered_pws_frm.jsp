	...
	function fnSubmit()
	{
		var loggedUser = '<%=loggedUser%>';
			...
			else
			{
				...
				document.f1.action="./rws_list_habs_notcoverd_pwsschemes_rpt.jsp";
				document.f1.submit();
			}	
		}
		</script>
...
<table border = 1 align = center cellspacing = 0 cellpadding = 0 rules = "rows" bordercolor = navy style = "border-collapse:collapse" bgcolor="#ffffff" width=350>		
	...
	<tr bgcolor="#8A9FCD" align="center">
		<td align="center" class="rptHeading" colspan=3>Habs Not Covered Schemes Report</td>	
	</tr>
	<%
try
{
...
%>
	...
	<input type="submit" id="vbutton" onclick="fnSubmit()" class=btext value="View Report">
	</td>
	</tr>
</table>
