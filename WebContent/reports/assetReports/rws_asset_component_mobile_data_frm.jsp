...
<script language="JavaScript">
	function fnSubmit()
	{
		...
		var comp=document.f1.findimage.value;
			if(document.f1.district.value=='')
			{
				alert("Please Select District");
				return false;
			}
		 	if(comp!='' && (comp=='Assets With Images' || comp=='empty'))
			{
			...
			if(document.f1.type.value=='')
			{
				...
				if(loggedUser=="admin"||loggedUser=="100000" ||loggedUser=="guest"||loggedUser=="pdswsm"||loggedUser=="cerwss" ||loggedUser=="secrwss")
				{
				...
				document.f1.action="./rws_asset_component_mobile_data_rpt.jsp";
				document.f1.submit();
...
<table border = 1 align = center cellspacing = 0 cellpadding = 0 rules = "rows" bordercolor = navy style = "border-collapse:collapse" bgcolor="#ffffff" width=350>		
	...
	<tr bgcolor="#8A9FCD" align="center">
		<td align="center" class="rptHeading" colspan=3>Assets and Components - Image Status</td>	
	</tr>
	<%
try
{
...
%>
	...
	<tr>
		...
		<td class=btext>
			<SELECT name="type" id="combo" class="mycombo" style="width:150px">
				 <option value="">-Select-</option>
	...
	<tr>
		<td class=rptLabel>Components &nbsp;&nbsp;</td>
		<td class=btext>
			<SELECT name="findimage" id="combo" class="mycombo" style="width:150px">
				<option value="empty">-Select-</option>
				<option value="Assets With Images">With Images</option> 
				<option value="Assets Without Images">Without Images</option>
			</SELECT>
		</td>
	</tr>
...
<p style="text-align:center;">NOTE :-<font color="red" size="1"> HANDPUMPS, SHALLOW-HANDPUMP, OPEN-WELL, POND are contained in <b>COMPONENTS</b> Type.</font></p>
