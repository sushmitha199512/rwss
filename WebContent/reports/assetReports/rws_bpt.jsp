...
<tr bgcolor="#8A9FCD" align="center">
		<td align="center" class="rptHeading" colspan="14"> Assets - BPT </td>
</tr>
</table>
...
<tr align=center>
			   ...
			   <td class=btext>Bpt Capacity in Lts</td>
			   <td class=btext>Bpt Staging(mts)</td>
			   </tr>
...
try
{
		...
		//String bptq="select  bpt_code,nvl(location,'-'),capacity,staging from rws_ast_bpt_param_tbl where asset_code='" + assetcode + "' and substr(bpt_code,1,2)='" + districtcode + "' and substr(bpt_code,6,2)='" + mandalcode + "' and substr(bpt_code,13,2)='" + panchayatcode + "' and substr(bpt_code,8,3)='" + villagecode + "'";
		
		//String bptq="select  bpt_code,nvl(location,'-'),capacity,staging from rws_ast_bpt_param_tbl where  hab_code='"+habcode+"'" ;
		String bptq="select  bpt_code,nvl(location,'-'),nvl(capacity,0),nvl(staging,0) from rws_ast_bpt_param_tbl where  asset_code='"+assetcode+"'" ;
		rs1=stmt1.executeQuery(bptq);
