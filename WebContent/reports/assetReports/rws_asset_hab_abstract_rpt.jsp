...
int cyear = Calendar.getInstance().get(Calendar.YEAR);
	...
	<td><a href="./rws_asset_hab_abstract_rpt_excel.jsp?dcode=<%=dcode%>">Excel</a></td> 
 ...
 -->	</tr>  
  ...
  - Report</td>
   ...
   <table width="70%" border=0 style="border-collapse:collapse"  ALIGN=CENTER >
	...
	<td class=gridhdbg rowspan="1" colspan="7">Current Year Status(as per 2011 Census Data)</td>
	<td class=gridhdbg rowspan="1" colspan="14">Population as on 01-04-<%= cyear %> </td>
	...
	<td class=gridhdbg rowspan="1" colspan="4">Population</td>
	 <td class=gridhdbg rowspan="2">House Holds</td>
    <td class=gridhdbg rowspan="2">House Connections</td>
	<td class=gridhdbg rowspan="2">Safe Lpcd</td>
	<td class=gridhdbg rowspan="1" colspan="7">Coverage Status</td>
	</tr>
	<tr>
...
try
{
	...
	int totActPlainPop=0,totActSCPop=0,totActSTPop=0,totActTotPop=0,totActHouseHolds=0,totActHouseConn=0,totActFc=0,totActPc1=0,totActPc2=0,totActPc3=0,totActPc4=0,totActNss=0,totActNc=0;
	double totsafe=0.0,totunsafe=0.0,totActSafeLpcd=0.0;
	
	st1=conn.createStatement();
	String assetqry="select substr(hab_code,1,2),TYPE_OF_ASSET_NAME,count(1) from RWS_ASSET_MAST_TBL a,RWS_ASSET_TYPE_TBL b,rws_complete_hab_dyna_view c where a.hab_code=c.panch_code and a.TYPE_OF_ASSET_code=b.TYPE_OF_ASSET_code ";
	if(dcode !=null && !dcode.equals("00")){
...
while(rset.next()){
	...
	//System.out.println("pws----"+pws);
	 ...
	 String house="select sum(HOUSEHOLD_NO),sum(NO_OF_HOUSECONN_GIVEN) from rws_habitation_dir_dyna_tbl a,rws_complete_hab_dyna_view c where a.hab_code=c.panch_code and substr(hab_code,1,2)='"+rset.getString(23)+"'";
	 statement=conn.createStatement();
	 ...
	 int platforms=0;
	 String hpplatform="select count(PLATFORM_EXISTING) from RWS_HP_SUBCOMP_PARAM_TBL a,rws_complete_hab_dyna_view c where substr(hp_code,1,16)=c.panch_code and substr(hp_code,1,2)='"+rset.getString(23)+"' and PLATFORM_EXISTING='N'";
	 statement=conn.createStatement();
	 ...
	 statement.close();
	 resultSet.close();
	 String shpplatform="select count(PLATFORM_EXISTING) from RWS_SHALLOWHANDPUMPS_TBL a,rws_complete_hab_dyna_view c where a.hab_code=c.panch_code and substr(hab_code,1,2)='"+rset.getString(23)+"' and PLATFORM_EXISTING='N'";
	 statement=conn.createStatement();
	 ...
	 int soakpit=0;
	 String hpsoakpits="select count(SOAK_PIT) from RWS_HP_SUBCOMP_PARAM_TBL a,rws_complete_hab_dyna_view c where substr(hp_code,1,16)=c.panch_code and substr(hp_code,1,2)='"+rset.getString(23)+"' and SOAK_PIT='N'";
	 statement=conn.createStatement();
	 ...
	 statement.close();
	 resultSet.close();
	 String shpsoakpits="select count(SOAK_PIT) from RWS_SHALLOWHANDPUMPS_TBL a,rws_complete_hab_dyna_view c where a.hab_code=c.panch_code and substr(hab_code,1,2)='"+rset.getString(23)+"' and SOAK_PIT='N'";
	 statement=conn.createStatement();
	...
	<tr>
	 ...
	 <td class="<%=style%>"style="text-align: left;"> <a href="rws_asset_hab_abstract_rpt.jsp?drill=m&district=<%=rset.getString(23)%>&dname=<%= rset.getString(1)%>"><%=rset.getString(1)%></a></td>
			...
			<td class="<%=style%>"style="text-align: right;"> <%=rset.getInt(9)%></td>
			 ...
			 <td class="<%=style%>"style="text-align: right;"> <%=rset.getInt(13)%></td>
			  <td class="<%=style%>"style="text-align: right;"><a href="#" onclick="viewWorks('./rws_asset_hab_rpt.jsp?district=<%=rset.getString(23)%>&dname=<%= rset.getString(1)%>&mode=NSS')"> <%=rset.getInt(14)%></a></td>
			   ...
			   <td class="<%=style%>"style="text-align: right;"> <%=rset.getInt("LPCD_ACT_POPU")%></td>
			   <td class="<%=style%>"style="text-align: right;"> <%=rset.getInt("fcactcount")%></td>
			   <td class="<%=style%>"style="text-align: right;"> <%=rset.getInt("pc1actcount")%></td>
			   <td class="<%=style%>"style="text-align: right;"> <%=rset.getInt("pc2actcount")%></td>
			   <td class="<%=style%>"style="text-align: right;"> <%=rset.getInt("pc3actcount")%></td>
			   <td class="<%=style%>"style="text-align: right;"> <%=rset.getInt("pc4actcount")%></td>
			   <td class="<%=style%>"style="text-align: right;"> <%=rset.getInt("nssactcount")%></td>
			   <td class="<%=style%>"style="text-align: right;"> <%=rset.getInt("ncactcount")%></td>
	...
	totActPlainPop+=rset.getInt("ACT_PLAIN_POPU");
	totActSCPop+=rset.getInt("ACT_SC_POPU");
	totActSTPop+=rset.getInt("ACT_ST_POPU");
	totActTotPop+=rset.getInt("ACT_TOT_POPU");
	totActHouseHolds+=rset.getInt("ACT_HOUSE_HOLD");
	totActHouseConn+=rset.getInt("ACT_HOUSE_CONN");
	totActSafeLpcd+=rset.getInt("LPCD_ACT_POPU");
	totActFc+=rset.getInt("fcactcount");
	totActPc1+=rset.getInt("pc1actcount");
	totActPc2+=rset.getInt("pc2actcount");
	totActPc3+=rset.getInt("pc3actcount");
	totActPc4+=rset.getInt("pc4actcount");
	totActNss+=rset.getInt("nssactcount");
	totActNc+=rset.getInt("ncactcount");
...
<td class=gridhdbg style="text-align: right;" ><%=totActPlainPop %></td>
<td class=gridhdbg style="text-align: right;" ><%=totActSCPop %></td>
<td class=gridhdbg style="text-align: right;" ><%=totActSTPop %></td>
<td class=gridhdbg style="text-align: right;" ><%=totActTotPop %></td>
<td class=gridhdbg style="text-align: right;" ><%=totActHouseHolds %></td>
<td class=gridhdbg style="text-align: right;" ><%=totActHouseConn %></td>
<td class=gridhdbg style="text-align: right;" ><%=totActSafeLpcd %></td>
<td class=gridhdbg style="text-align: right;" ><%=totActFc %></td>
<td class=gridhdbg style="text-align: right;" ><%=totActPc1 %></td>
<td class=gridhdbg style="text-align: right;" ><%=totActPc2 %></td>
<td class=gridhdbg style="text-align: right;" ><%=totActPc3 %></td>
<td class=gridhdbg style="text-align: right;" ><%=totActPc4 %></td>
<td class=gridhdbg style="text-align: right;" ><%=totActNss %></td>
<td class=gridhdbg style="text-align: right;" ><%=totActNc %></td>
</tr>
...
try
{
	...
	st1=conn.createStatement();
	String assetqry="select substr(hab_code,1,2),substr(hab_code,6,2),TYPE_OF_ASSET_NAME,count(1) from RWS_ASSET_MAST_TBL a,RWS_ASSET_TYPE_TBL b ,rws_complete_hab_dyna_view c where a.hab_code=c.panch_code and a.TYPE_OF_ASSET_code=b.TYPE_OF_ASSET_code ";
	if(dcode !=null && !dcode.equals("00")){
		assetqry+=" and substr(hab_code,1,2)='"+dcode+"'";
	}
	...
	String mainqry="select dname,count(panch_code),sum(nvl(b.CENSUS_PLAIN_POPU,0)),sum(nvl(b.CENSUS_SC_POPU,0)),sum(nvl(b.CENSUS_ST_POPU,0)),sum(nvl(b.CENSUS_PLAIN_POPU,0)+nvl(b.CENSUS_SC_POPU,0)+nvl(b.CENSUS_ST_POPU,0)+nvl(a.CENSUS_MINORITY_POPU,0)),sum(nvl(b.SAFE_LPCD,0)),sum(nvl(b.UNSAFE_LPCD,0)),sum(case when b.coverage_status='FC' then 1 else 0 end) as fccount,sum(case when b.coverage_status='PC1' then 1 else 0 end) as pc1count,sum(case when b.coverage_status='PC2' then 1 else 0 end) as pc2count,sum(case when b.coverage_status='PC3' then 1 else 0 end) as pc3count,sum(case when b.coverage_status='PC4' then 1 else 0 end) as pc4count,sum(case when b.coverage_status='NSS' then 1 else 0 end) as nsscount,sum(case when b.coverage_status='NC' then 1 else 0 end) as nccount,sum(case when b.PREVIOUS_YR_STATUS='FC' then 1 else 0 end) as fcprevcount,sum(case when b.PREVIOUS_YR_STATUS='PC1' then 1 else 0 end) as pc1prevcount,sum(case when b.PREVIOUS_YR_STATUS='PC2' then 1 else 0 end) as pc2prevcount,sum(case when b.PREVIOUS_YR_STATUS='PC3' then 1 else 0 end) as pc3prevcount,sum(case when b.PREVIOUS_YR_STATUS='PC4' then 1 else 0 end) as pc4prevcount,sum(case when b.PREVIOUS_YR_STATUS='NSS' then 1 else 0 end) as nssprevcount,sum(case when b.PREVIOUS_YR_STATUS='NC' then 1 else 0 end) as ncprevcount,dcode,mname,mcode,sum(nvl(a.CENSUS_MINORITY_POPU,0)) as minority,sum(nvl(a.ACT_PLAIN_POPU,0)) as ACT_PLAIN_POPU,sum(nvl(a.ACT_SC_POPU,0)) as ACT_SC_POPU,sum(nvl(a.ACT_ST_POPU,0)) as ACT_ST_POPU,sum(nvl(a.ACT_TOT_POPU,0)) as ACT_TOT_POPU,sum(nvl(a.ACT_HOUSE_HOLD,0)) as ACT_HOUSE_HOLD,sum(nvl(a.ACT_HOUSE_CONN,0)) as ACT_HOUSE_CONN,sum(nvl(a.LPCD_ACT_POPU,0)) as LPCD_ACT_POPU,sum(case when a.ACT_COVERAGE_STATUS='FC' then 1 else 0 end) as fcactcount,sum(case when a.ACT_COVERAGE_STATUS='PC1' then 1 else 0 end) as pc1actcount,sum(case when a.ACT_COVERAGE_STATUS='PC2' then 1 else 0 end) as pc2actcount,sum(case when a.ACT_COVERAGE_STATUS='PC3' then 1 else 0 end) as pc3actcount,sum(case when a.ACT_COVERAGE_STATUS='PC4' then 1 else 0 end) as pc4actcount,sum(case when a.ACT_COVERAGE_STATUS='NSS' then 1 else 0 end) as nssactcount,sum(case when a.ACT_COVERAGE_STATUS='NC' then 1 else 0 end) as ncactcount from rws_habitation_dir_dyna_tbl a,rws_complete_hab_dyna_view b ";
	if(dcode !=null && !dcode.equals("00")){
...
while(rset.next()){
	if(styleCount%2==0){
	 ...
	 int pwssafe=0,pwsunsafe=0,mpwssafe=0,mpwsunsafe=0,cpwssafe=0,cpwsunsafe=0,hpsafe=0,hpunsafe=0,shpsafe=0,shpunsafe=0,othsafe=0,othunsafe=0;
	 String pws="select sum(PWS_SUPPLY),sum(PWS_HAB_SUPPLY),sum(PWS_UNSAFE_SUPPLY),sum(MPWS_SUPPLY),sum(MPWS_HAB_SUPPLY),sum(MPWS_UNSAFE_SUPPLY),sum(CPWS_SUPPLY),sum(CPWS_HAB_SUPPLY),sum(HPS_OTH_SUPPLY),sum(HPS_OTH_SUPPLY_UNSAFE),sum(SHP_DK_SUPPLY_SAFE),sum(SHP_DK_SUPPLY),sum(OTHERS_SUPPLY_SAFE),sum(DP_HAB_SUPPLY),sum(OTHERS_SUPPLY) from rws_hab_supply_status_tbl a,rws_complete_hab_dyna_view c where a.hab_code=c.panch_code and substr(hab_code,1,2)='"+rset.getString(23)+"' and substr(hab_code,6,2)='"+rset.getString(25)+"'";
	 ...
	 int households=0,houseconn=0;
	 String house="select sum(HOUSEHOLD_NO),sum(NO_OF_HOUSECONN_GIVEN) from rws_habitation_dir_dyna_tbl a,rws_complete_hab_dyna_view c where a.hab_code=c.panch_code and substr(hab_code,1,2)='"+rset.getString(23)+"' and substr(hab_code,6,2)='"+rset.getString(25)+"'";
	 statement=conn.createStatement();
	 resultSet=statement.executeQuery(house);
	 if(resultSet.next()){
		 households=resultSet.getInt(1);
	 ...
	 int platforms=0;
	 String hpplatform="select count(PLATFORM_EXISTING) from RWS_HP_SUBCOMP_PARAM_TBL a,rws_complete_hab_dyna_view c where substr(hp_code,1,16)=c.panch_code and substr(hp_code,1,2)='"+rset.getString(23)+"' and substr(hp_code,6,2)='"+rset.getString(25)+"' and PLATFORM_EXISTING='N'";
	 statement=conn.createStatement();
	 resultSet=statement.executeQuery(hpplatform);
	 if(resultSet.next()){
		 platforms+=resultSet.getInt(1);
	 ...
	 statement.close();
	 resultSet.close();
	 String shpplatform="select count(PLATFORM_EXISTING) from RWS_SHALLOWHANDPUMPS_TBL a,rws_complete_hab_dyna_view c where a.hab_code=c.panch_code and substr(hab_code,1,2)='"+rset.getString(23)+"' and substr(hab_code,6,2)='"+rset.getString(25)+"' and PLATFORM_EXISTING='N'";
	 statement=conn.createStatement();
	 resultSet=statement.executeQuery(shpplatform);
	 if(resultSet.next()){
		 platforms+=resultSet.getInt(1);
	 ...
	 int soakpit=0;
	 String hpsoakpits="select count(SOAK_PIT) from RWS_HP_SUBCOMP_PARAM_TBL a,rws_complete_hab_dyna_view c where substr(hp_code,1,16)=c.panch_code and substr(hp_code,1,2)='"+rset.getString(23)+"' and substr(hp_code,6,2)='"+rset.getString(25)+"' and SOAK_PIT='N'";
	 statement=conn.createStatement();
	 resultSet=statement.executeQuery(hpsoakpits);
	 if(resultSet.next()){
		 soakpit+=resultSet.getInt(1);
	 ...
	 statement.close();
	 resultSet.close();
	 String shpsoakpits="select count(SOAK_PIT) from RWS_SHALLOWHANDPUMPS_TBL a,rws_complete_hab_dyna_view c where a.hab_code=c.panch_code and substr(hab_code,1,2)='"+rset.getString(23)+"' and substr(hab_code,6,2)='"+rset.getString(25)+"' and SOAK_PIT='N'";
	 statement=conn.createStatement();
	 resultSet=statement.executeQuery(shpsoakpits);
	 if(resultSet.next()){
		 soakpit+=resultSet.getInt(1);
	...
	<tr>
	 ...
	 <td class="<%=style%>"style="text-align: left;"><a href="rws_asset_hab_abstract_rpt.jsp?drill=p&district=<%=rset.getString(23)%>&mandal=<%=rset.getString(25)%>&mname=<%=rset.getString(24)%>&dname=<%=rset.getString(1)%>">  <%=rset.getString(24)%></a></td>
...
try
{
	...
	st1=conn.createStatement();
	String assetqry="select substr(hab_code,1,2),substr(hab_code,6,2),substr(hab_code,13,2),TYPE_OF_ASSET_NAME,count(1) from RWS_ASSET_MAST_TBL a,RWS_ASSET_TYPE_TBL b,rws_complete_hab_dyna_view c where a.hab_code=c.panch_code and a.TYPE_OF_ASSET_code=b.TYPE_OF_ASSET_code ";
	if(dcode !=null && !dcode.equals("00")){
		assetqry+=" and substr(hab_code,1,2)='"+dcode+"'";
	}
...
while(rset.next()){
	if(styleCount%2==0){
	 ...
	 int pwssafe=0,pwsunsafe=0,mpwssafe=0,mpwsunsafe=0,cpwssafe=0,cpwsunsafe=0,hpsafe=0,hpunsafe=0,shpsafe=0,shpunsafe=0,othsafe=0,othunsafe=0;
	 String pws="select sum(PWS_SUPPLY),sum(PWS_HAB_SUPPLY),sum(PWS_UNSAFE_SUPPLY),sum(MPWS_SUPPLY),sum(MPWS_HAB_SUPPLY),sum(MPWS_UNSAFE_SUPPLY),sum(CPWS_SUPPLY),sum(CPWS_HAB_SUPPLY),sum(HPS_OTH_SUPPLY),sum(HPS_OTH_SUPPLY_UNSAFE),sum(SHP_DK_SUPPLY_SAFE),sum(SHP_DK_SUPPLY),sum(OTHERS_SUPPLY_SAFE),sum(DP_HAB_SUPPLY),sum(OTHERS_SUPPLY) from rws_hab_supply_status_tbl a,rws_complete_hab_dyna_view c where a.hab_code=c.panch_code and substr(hab_code,1,2)='"+rset.getString(23)+"' and substr(hab_code,6,2)='"+rset.getString(25)+"' and substr(hab_code,13,2)='"+rset.getString(27)+"'";
	 ...
	 int households=0,houseconn=0;
	 String house="select sum(HOUSEHOLD_NO),sum(NO_OF_HOUSECONN_GIVEN) from rws_habitation_dir_dyna_tbl a,rws_complete_hab_dyna_view c where a.hab_code=c.panch_code and substr(hab_code,1,2)='"+rset.getString(23)+"' and substr(hab_code,6,2)='"+rset.getString(25)+"' and substr(hab_code,13,2)='"+rset.getString(27)+"'";
	 statement=conn.createStatement();
	 resultSet=statement.executeQuery(house);
	 if(resultSet.next()){
		 households=resultSet.getInt(1);
	 ...
	 int platforms=0;
	 String hpplatform="select count(PLATFORM_EXISTING) from RWS_HP_SUBCOMP_PARAM_TBL a,rws_complete_hab_dyna_view c where substr(hp_code,1,16)=c.panch_code and substr(hp_code,1,2)='"+rset.getString(23)+"' and substr(hp_code,6,2)='"+rset.getString(25)+"' and substr(hp_code,13,2)='"+rset.getString(27)+"' and PLATFORM_EXISTING='N'";
	 statement=conn.createStatement();
	 resultSet=statement.executeQuery(hpplatform);
	 if(resultSet.next()){
		 platforms+=resultSet.getInt(1);
	 ...
	 statement.close();
	 resultSet.close();
	 String shpplatform="select count(PLATFORM_EXISTING) from RWS_SHALLOWHANDPUMPS_TBL a,rws_complete_hab_dyna_view c where a.hab_code=c.panch_code and substr(hab_code,1,2)='"+rset.getString(23)+"' and substr(hab_code,6,2)='"+rset.getString(25)+"' and substr(hab_code,13,2)='"+rset.getString(27)+"' and PLATFORM_EXISTING='N'";
	 statement=conn.createStatement();
	 resultSet=statement.executeQuery(shpplatform);
	 if(resultSet.next()){
		 platforms+=resultSet.getInt(1);
	 ...
	 int soakpit=0;
	 String hpsoakpits="select count(SOAK_PIT) from RWS_HP_SUBCOMP_PARAM_TBL a,rws_complete_hab_dyna_view c where substr(hp_code,1,16)=c.panch_code and substr(hp_code,1,2)='"+rset.getString(23)+"' and substr(hp_code,6,2)='"+rset.getString(25)+"' and substr(hp_code,13,2)='"+rset.getString(27)+"' and SOAK_PIT='N'";
	 statement=conn.createStatement();
	 resultSet=statement.executeQuery(hpsoakpits);
	 if(resultSet.next()){
		 soakpit+=resultSet.getInt(1);
	 ...
	 statement.close();
	 resultSet.close();
	 String shpsoakpits="select count(SOAK_PIT) from RWS_SHALLOWHANDPUMPS_TBL a,rws_complete_hab_dyna_view c where a.hab_code=c.panch_code and substr(hab_code,1,2)='"+rset.getString(23)+"' and substr(hab_code,6,2)='"+rset.getString(25)+"' and substr(hab_code,13,2)='"+rset.getString(27)+"' and SOAK_PIT='N'";
	 statement=conn.createStatement();
	 resultSet=statement.executeQuery(shpsoakpits);
	 if(resultSet.next()){
		 soakpit+=resultSet.getInt(1);
