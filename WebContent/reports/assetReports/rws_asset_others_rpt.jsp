...
<tr bgcolor="#8A9FCD" align="center">
		<td align="center" class="rptHeading" colspan="14"> Assets - Others </td>
</tr>
</table>
<table border=1 cellpadding=1 cellspacing=1 width="100%">
<tr align=center>
               <td class=btext>Sl.No</td>
			   <td class=btext>General Component Code</td>
...
try
{
   ...
   String query=null;
//   query="select  other_comp_code,nvl(comp_name,'-'),nvl(comp_location,'-'),nvl(remarks,'-') from rws_ast_others_param_tbl  where asset_code='" + assetcode + "' and substr(hab_code,1,2)='" + districtcode + "' and substr(hab_code,6,2)='" + mandalcode + "' and substr(hab_code,13,2)='" + panchayatcode + "' and substr(hab_code,8,3)='" + villagecode + "'  ";
   query="select  other_comp_code,nvl(comp_name,'-'),nvl(comp_location,'-'),nvl(remarks,'-') from rws_ast_others_param_tbl  where asset_code='" + assetcode + "' and substr(hab_code,1,2)='" + districtcode + "' and substr(hab_code,6,2)='" + mandalcode + "' and substr(hab_code,13,2)='" + panchayatcode + "' and substr(hab_code,8,3)='" + villagecode + "'  ";
