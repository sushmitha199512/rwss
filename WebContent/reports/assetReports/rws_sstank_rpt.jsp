...
<tr bgcolor="#8A9FCD" align="center">
		<td align="center" class="rptHeading" colspan="14"> Assets - SS TANK  </td>
</tr>
</table>
...
<tr align=center>
			   ...
			   <td class=btext>SS Tank Area(Sq.Mts)</td>
			   <td class=btext>No of days Storage</td>
			   <td class=btext>Capacity (in Mcum)</td>
...
try
{
//	 String query="select  sssc_code,ss_size,capacity_days,capacity_mcum,nvl(tank_adeqacy,'-'),nvl(location,'-'),nvl(power_con,'-'),power_hrs,depth,nvl(others,'-') from rws_ast_ss_sc_param_tbl  where asset_code='" + assetcode + "' and substr(sssc_code,1,2)='" + districtcode + "' and substr(sssc_code,6,2)='" + mandalcode + "' and substr(sssc_code,13,2)='" + panchayatcode + "' and substr(sssc_code,8,3)='" + villagecode + "'  "
	 String query="select  sssc_code,ss_size,capacity_days,capacity_mcum,nvl(tank_adeqacy,'-'),nvl(location,'-'),depth,nvl(others,'-') from rws_ast_ss_sc_param_tbl  where asset_code='" + assetcode + "' ";
