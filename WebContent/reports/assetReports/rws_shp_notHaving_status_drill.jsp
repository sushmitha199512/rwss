...
nic.watersoft.works.WorksData1 w=new nic.watersoft.works.WorksData1();
	...
	<tr >
	<td align="center" class="rptHeading" >Shallow HandPumps Not Having Status							
  - Report</td>
	</tr>
   ...
   <table width="60%" border=1 style="border-collapse:collapse"  ALIGN=CENTER >
	...
	<td class=gridhdbg >Sl.No</td>
       ...
       <td class=gridhdbg >Village</td>
        ...
        <td class=gridhdbg >Shallow HandPump Code</td>
...
try
{
   ...
   qry="select dcode,dname,mname,pname,vname,panch_code,panch_name,SHALLOWHP_CODE,a.Location,a.ASSET_CODE from  RWS_SHALLOWHANDPUMPS_TBL a,rws_complete_hab_view b where substr(SHALLOWHP_CODE,1,16)=b.panch_code  and substr(SHALLOWHP_CODE,1,2)='"+dcode+"' and  status is null";
