...
function unview()
{
	...
	function fnSubmit()
	{
		...
		if(logValue=="admin" || logValue=="100000"|| logValue=="guest" || logValue=="1000DR")
		{
			...
			document.f1.action="./rws_district_wise_shpstatus_report.jsp";
			document.getElementById('vbutton').disabled=true;
			document.f1.submit();
		}
		else
...
<%} %>
	...
	<tr bgcolor="#8A9FCD" align="center">
		<td align="center" class="rptHeading" colspan=3>District Wise Shallow HandPumps Status Report</td>	
	</tr>
