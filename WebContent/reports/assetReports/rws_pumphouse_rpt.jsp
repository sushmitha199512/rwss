...
<tr align=center>
			   ...
			   <td class=btext>Pump House Area (Sq. Mts)</td>
...
//String pumphouse="select  type,area,height,pumphouse_code,location from rws_ast_pumphouse_param_tbl  where asset_code='" + assetcode + "' and substr(pumphouse_code,1,2)='" + districtcode + "' and substr(pumphouse_code,6,2)='" + mandalcode + "' and substr(pumphouse_code,13,2)='" + panchayatcode + "' and substr(pumphouse_code,8,3)='" + villagecode + "'  ";
String pumphouse="select  pumphouse_code,nvl(location,'-'),nvl(area,0) from rws_ast_pumphouse_param_tbl  where asset_code='" + assetcode + "'  ";
	
		stmt1=conn.createStatement();
		rs1=stmt1.executeQuery(pumphouse);
		while(rs1.next())
    	{
	     				%>
