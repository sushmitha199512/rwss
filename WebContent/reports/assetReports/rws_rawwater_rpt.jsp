...
<tr bgcolor="#8A9FCD" align="center">
		<td align="center" class="rptHeading" colspan="14"> Assets - RAW WATER COLLECTION WELL </td>
</tr>
</table>
...
//	String query="select  rw_collwell_code,diameter,depth,nvl(type_of_flooring,'-'),nvl(location,'-'),capacity,asset_code from rws_ast_rw_collwell_param_tbl  where asset_code='"+assetcode+"' and substr(rw_collwell_code,1,2)='"+districtcode+"' and substr(rw_collwell_code,6,2)='"+mandalcode+"' and substr(rw_collwell_code,13,2)='"+panchayatcode+"' and substr(rw_collwell_code,8,3)='"+ villagecode+"'  ";
	String query="select  rw_collwell_code,nvl(location,'-'),nvl(capacity,0) from rws_ast_rw_collwell_param_tbl  where asset_code='"+assetcode+"' ";
