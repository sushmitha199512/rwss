...
<tr bgcolor="#8A9FCD" align="center">
		<td align="center" class="rptHeading" colspan="14"> Assets - FOOT PATH BRIRDGE </td>
</tr>
</table>
...
// 	String query="select  bridge_code,nvl(bridge_type,'-'),Bridge_length,bridge_width,bridge_walk_way_width,length_of_the_bridge,bridge_span_length,asset_code,nvl(hab_code,'-') from RWS_AST_FP_BRIDGE_PARAM_TBL   where asset_code='" + assetcode + "' and substr(bridge_code,1,2)='" + districtcode + "' and substr(bridge_code,6,2)='" + mandalcode + "' and substr(bridge_code,13,2)='" + panchayatcode + "' and substr(bridge_code,8,3)='" + villagecode + "'  ";
 	String query="select  bridge_code,nvl(location,'-') from RWS_AST_FP_BRIDGE_PARAM_TBL   where asset_code='" + assetcode + "' "; 	
