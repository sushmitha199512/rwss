...
<tr bgcolor="#8A9FCD" align="center">
		<td align="center" class="rptHeading" colspan="14"> Assets - OANDM </td>
</tr>
</table>
...
<tr align=center>
			   ...
			   <td class=btext rowspan=2>Agency </td>
               <td class=btext colspan=3>(Annual Cost (Rs. In Lakhs)</td>
               <td class=btext rowspan=2>Source of Funding</td>
               <td class=btext rowspan=2>No. of Public Stand Posts</td>
                <td class=btext rowspan=2>No. Of House Connections</td>
               <td class=btext colspan=1>(Amount In Rupees)</td>
               </tr>
               <tr>
               <td>Power Cost  </td>
			   <td class=btext>Consumables</td>
			   <td class=btext>Wages & Others</td>
			  
			   
			  
			   <td class=btext>Tariff/Month</td>
			   </tr>
...
try
{
	...
	String query=null;
 //  query="select  oandmcode,nvl(agency_code,'-'),nvl(power_cost,'0.0'),nvl(consum_annum,'0.0'),nvl(wages_annum,'0.0'),nvl(sources_fund,'0.0'),nvl(tariff_month,'0.0'),nvl(house_conn,'0') from rws_ast_oandm_param_tbl where asset_code='" + assetcode + "' and substr(oandmcode,1,2)='" + districtcode + "' and substr(oandmcode,6,2)='" + mandalcode + "' and substr(oandmcode,13,2)='" + panchayatcode + "' and substr(oandmcode,8,3)='"+villagecode+"'  ";
    query="select  nvl(agency_code,'-'),nvl(sources_fund,'0.0'),nvl(PUBLIC_STAND_POSTS,0),nvl(house_conn,'0'),nvl(power_cost,'0.0'),nvl(consum_annum,'0.0'),nvl(wages_annum,'0.0'),nvl(tariff_month,'0.0') from rws_ast_oandm_param_tbl where asset_code='" + assetcode + "' ";
