...
<tr bgcolor="#8A9FCD" align="center">
		<td align="center" class="rptHeading" colspan="14"> Assets - CLEAR WATER COLLECTION WELL </td>
</tr>
</table>
...
try
{
//	 String query="select  cw_collwell_code,diameter,depth,nvl(type_of_flooring,'-'),nvl(location,'-'),capacity,asset_code from rws_ast_cw_collwell_param_tbl  where asset_code='" + assetcode + "' and substr(cw_collwell_code,1,2)='" + districtcode + "' and substr(cw_collwell_code,6,2)='" + mandalcode + "' and substr(cw_collwell_code,13,2)='" + panchayatcode + "' and substr(cw_collwell_code,8,3)='" + villagecode + "'  ";
	 String query="select  cw_collwell_code,nvl(location,'-'),nvl(capacity,0) from rws_ast_cw_collwell_param_tbl  where asset_code='" + assetcode + "' ";
