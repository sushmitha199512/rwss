...
<tr bgcolor="#8A9FCD" align="center">
		<td align="center" class="rptHeading" colspan="14"> Assets - GRAVITYMAIN </td>
</tr>
</table>
<table border=1 cellpadding=1 cellspacing=1 width="100%">
<tr align=center>
               <td class=btext>Sl.No</td>
			   <td class=btext>Gravity Main Code</td>
...
try
{
	// String gravity="select gravitymain_code,length,airvalve_no,scourevalve,reflexvalve,sluicevalve,nvl(met_type,'-'),no_of_pipes,nvl(location,'-'),asset_code from RWS_AST_GRAVITYMAIN_TBL   where asset_code='"+assetcode+"' and substr(gravitymain_code,1,2)='"+districtcode+"' and substr(gravitymain_code,6,2)='"+mandalcode+"' and substr(gravitymain_code,13,2)='"+panchayatcode+"' and substr(gravitymain_code,8,3)='"+villagecode+"' ";
	 String query="select GRAVITYMAIN_CODE,LENGTH,AIRVALVE_NO,SCOUREVALVE,REFLEXVALVE,SLUICEVALVE,NO_OF_PIPES,ZERO_VELOCITY_VALVE,NON_RETURN_VALVE,AIR_CUSHION_VALVE from rws_ast_gravitymain_tbl where asset_code='"+assetcode+"'";
	 //String gravity="select gravitymain_code,length,airvalve_no,scourevalve,reflexvalve,sluicevalve,nvl(met_type,'-'),no_of_pipes,nvl(location,'-'),asset_code from RWS_AST_GRAVITYMAIN_TBL   where asset_code='"+assetcode+"' ";
