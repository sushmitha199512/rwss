...
<tr bgcolor="#8A9FCD" align="center">
		<td align="center" class="rptHeading" colspan="14"> Assets - GLSR </td>
</tr>
</table>
...
<tr align=center>
			   ...
			   <td class=btext>Glsr Capacity in Lts</td>
			   <td class=btext>Glsr Location</td>
			  <td class=btext>No. of Fillings per Day</td>
...
//	String glsrquery="select glsr_code,glsr_cap_lts,nvl(glsr_loc,'-'),glsr_satges,glsr_lwl,glsr_mwl,GLSR_FILL_HR,GLSR_EMPTY_HR,GLSR_NO_OF_FILLING,asset_code from RWS_AST_GLSR_SC_PARAM_TBL  where asset_code='"+assetcode+"' and substr(glsr_code,1,2)='"+ districtcode+"' and substr(glsr_code,6,2)='"+mandalcode+"' and substr(glsr_code,13,2)='"+ panchayatcode+"' and substr(glsr_code,8,3)='"+villagecode+"' ";
String glsrquery="select glsr_code,nvl(glsr_cap_lts,0),nvl(glsr_loc,'-'),nvl(GLSR_NO_OF_FILLING,0),decode(water_qty,'N','NSS','Y','SAFE SOURCE')water from RWS_AST_GLSR_SC_PARAM_TBL  where asset_code='"+assetcode+"'";
	rs1=stmt1.executeQuery(glsrquery);
	//System.out.println("GLSR Query "+glsrquery);
