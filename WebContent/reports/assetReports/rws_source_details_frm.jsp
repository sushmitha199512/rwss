...
<script language="JavaScript">
	function fnSubmit()
	{
		var loggedUser = '<%=loggedUser%>';
			...
			else if(document.f1.sourcetype.value==''){
			...
			else
			{
				...
				document.f1.action="./rws_source_details_rpt.jsp";
				document.f1.submit();
			}	
		}
		</script>
...
<table border = 1 align = center cellspacing = 0 cellpadding = 0 rules = "rows" bordercolor = navy style = "border-collapse:collapse" bgcolor="#ffffff" width=350>		
	...
	<tr bgcolor="#8A9FCD" align="center">
		<td align="center" class="rptHeading" colspan=3>Source Details - Report</td>	
	</tr>
	<%
try
{
...
%>
	...
	<tr><td class=rptLabel>Panchayath&nbsp;&nbsp;</td>
		<td class=btext>
...
<%}
		...
		<option value="">--Select--</option>
		<option value="source">Source(CPWS/PWS/MPWS)</option>
