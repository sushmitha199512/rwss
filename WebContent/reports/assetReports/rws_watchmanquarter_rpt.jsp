...
<tr bgcolor="#8A9FCD" align="center">
		<td align="center" class="rptHeading" colspan="14"> Assets - WATCHMAN QUARTER  </td>
</tr>
</table>
<table border=1 cellpadding=1 cellspacing=1 width="100%">
<tr align=center>
               <td class=btext>Sl.No</td>
			   <td class=btext>WatchMan Quarter Code</td>
...
try
{
//String query="select  nvl(type,'-'),area,no_of_qtrs,asset_code,watchman_code,nvl(hab_code,'-'),nvl(location,'-') from RWS_AST_WATCHMAN_PARAM_TBL  where asset_code='" + assetcode + "' and substr(watchman_code,1,2)='" + districtcode + "' and substr(watchman_code,6,2)='" + mandalcode + "' and substr(watchman_code,13,2)='" + panchayatcode + "' and substr(watchman_code,8,3)='" + villagecode + "'  ";
String query="select  watchman_code,nvl(location,'-') from RWS_AST_WATCHMAN_PARAM_TBL  where asset_code='" + assetcode + "'  ";
