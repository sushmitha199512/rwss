...
<tr bgcolor="#8A9FCD" align="center">
		<td align="center" class="rptHeading" colspan="14"> Assets - OHSR </td>
</tr>
</table>
...
<tr align=center>
			   ...
			   <td class=btext>Ohsr Capacity in Lts</td>
			   <td class=btext>Ohsr Location</td>
			    <td class=btext> Ohsr Staging</td>
...
try
{
//	 String ohsr="select ohsr_code,ohsr_cap_lts,nvl(ohsr_loc,'-'),ohsr_satges,ohsr_lwl,ohsr_mwl,ohsr_fill_hr,ohsr_empty_hr,ohsr_no_of_filling,asset_code from RWS_AST_OHSR_SC_PARAM_TBL   where asset_code='"+assetcode+"' and substr(ohsr_code,1,2)='"+districtcode+"' and substr(ohsr_code,6,2)='"+mandalcode+"' and substr(ohsr_code,13,2)='"+panchayatcode+"' and substr(ohsr_code,8,3)='"+villagecode+"' ";
	 String ohsr="select ohsr_code,nvl(ohsr_cap_lts,0),nvl(ohsr_loc,'-'),nvl(ohsr_satges,0),nvl(ohsr_no_of_filling,0) from RWS_AST_OHSR_SC_PARAM_TBL   where asset_code='"+assetcode+"' ";
		stmt1=conn.createStatement();
		rs1=stmt1.executeQuery(ohsr);
