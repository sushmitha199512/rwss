...
<tr align=center>
			   ...
			   <td class=btext>Other Component Code</td>
...
//String other="select  other_comp_code,comp_name,comp_location,remarks from rws_ast_others_param_tbl  where asset_code='" + assetcode + "' and substr(hab_code,1,2)='" + districtcode + "' and substr(hab_code,6,2)='" + mandalcode + "' and substr(hab_code,13,2)='" + panchayatcode + "' and substr(hab_code,8,3)='" + villagecode + "'  ";
String other="select  other_comp_code,comp_name,comp_location,remarks from rws_ast_others_param_tbl  where asset_code='" + assetcode + "' ";
		stmt1=conn.createStatement();
		rs1=stmt1.executeQuery(other);
		while(rs1.next())
    	{
	     				%>
