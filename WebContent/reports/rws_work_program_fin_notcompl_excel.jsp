...
String relTable=(String)session.getAttribute("relTable");
String relColumn=(String)session.getAttribute("relColumn");
...
<table border = 0 cellspacing = 0 cellpadding = 0 width="100%" bordercolor=#000000 style="border-collapse:collapse" bgcolor="#ffffff" align = "center">
   ...
   <tr><td class="bwborder" align="center" colspan=8><font  color="red" ><b>Note:<%=message %></b></font></td></tr>
	</table>
