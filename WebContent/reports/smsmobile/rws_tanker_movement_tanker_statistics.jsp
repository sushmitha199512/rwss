...
function fnSubmitDetails()
{
	...
	return false;
		...
		document.f1.action="./rws_tanker_movement_drill_statitics_rpt.jsp?mode1=mandal&type=1&dcode="+distCode+"&dname="+dname+"&fromdate="+frmdate+"&todate="+todate+"";
...
<table border = 1 align = center cellspacing = 0 cellpadding = 0 rules = "rows" bordercolor = navy style = "border-collapse:collapse" bgcolor="#ffffff" width=350>		
	...
	<tr bgcolor="#8A9FCD" align="center">
		<td align="center" class="rptHeading" colspan=3> Tanker Statistics -  Report</td>	
	</tr>
	<%
try
{ 
