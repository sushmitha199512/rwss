...
function fnSubmitDetailsTnk()
{
 ...
 var Difference_In_Daysf2 = Difference_In_Timec / (1000 * 3600 * 24);    
    ...
    { */
    	document.f1.action="./tanker_movement_serverless_trip_details_image_rpt.jsp";
        document.f1.submit();
    	//document.f1.action="./reports/smsmobile/tanker_movement_serverless_trip_details_image_rpt.jsp";
