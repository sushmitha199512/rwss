...
<table>
	<tr>
		...
		<a href="<rws:context page='/home.jsp'/>">Home</a>&nbsp;|&nbsp;<a
			href="./reports/out_flexi_report1_excel.jsp" target="_new">Excel</a>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		</td>
	</tr>
	<tr>
		<td>
		<table width="100%">
			<caption align="right" class="staticLabel"><b>(Amount in Rs. lakhs But Expenditure in Rupees)</b></caption>
		</table>
		<table>
