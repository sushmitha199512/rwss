...
function unview()
{
	...
	function fnSubmit()
	{
		...
		if (logValue == "admin" || logValue == "100000"
			...
			document.f1.action = "./rws_cpws_pws_cov_ass_rptfy.jsp"
			document.f1.submit();
		} else {
			document.f1.drill.value = 'next';
	...
	<form name=f1 action="<%= request.getRequestURI()%>">
		<table border=1 align=center cellspacing=0 cellpadding=0 rules="rows" bordercolor=navy style="border-collapse: collapse" bgcolor="#ffffff"	width=350>
			...
			<tr bgcolor="#8A9FCD" align="center">
				<td align="center" class="rptHeading" colspan=3>Coverage Of Habitations(Surface Water & Ground Water)-Report</td>
			</tr>
		<%
