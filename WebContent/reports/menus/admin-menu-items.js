...
function init()
{
    ...
    menus[2].addItem("#", "", 22, "left", "Water Quality", 11);
			...
			//  "Employee Details":
				...
				menus[9].addItem("switch.do?prefix=/masters&page=/Employee.do&mode=DeptOptForms", "",22, "left","Department Opted ", 0);
				menus[9].addItem("switch.do?prefix=/masters&page=/EmpSearch.do&mode=EmployeeList", "",22, "left","Employee Search ", 0);				 
			//////////////////
			//  "Head Of Accounts":
...
//Sub Menus for 4rd Main Menu Item ("graphs"):
	...
	menus[19].addItem("#", "", 22, "left", "Fund Accounting", 41);
				...
				menus[20].addItem("switch.do?prefix=/masters&page=/Employee.do&mode=checklist", "", 32, "left", "Employee CheckList", 0);
				menus[20].addItem("#", "", 22, "left", "Asset", 27);
				menus[20].addItem("./reports/rws_hab_asset_status_no_frm.jsp", "", 22, "left", "Sources", 0);
				menus[20].addItem("switch.do?prefix=/reports&page=/reportsDisplay.do&mode=data", "", 22, "left", "Habitation Status" , 0);
			    //////////////////

			                 // "Habitation":
							
			                 // "Habitation":
							menus[26] = new menu(160, "vertical", 0, 0, 0, 0, "#cccccc", "#8A9FCD", "Verdana,Helvetica", 9, "bold", "bold", "black", "white",15, "#E1E1E1", 2, "rollover:images/tri-right1.gif:images/tri-right2.gif", false, true, false, false, 0, true, 0, 0, "#cccccc");
							//menus[26].addItem("./reports/rws_hab_update_frm.jsp", "", 10, "left", "Habs Updated", 0);
							//menus[26].addItem("./reports/rws_hab_dist_combo.jsp", "", 18, "left", "Habs Not Updated", 0);
							menus[26].addItem("switch.do?prefix=/reports&page=/flexReport.do?mode=inFlexi", "", 22, "left", "Free Format Reports", 0);
							menus[26].addItem("./reports/rws_hab_updates_frm.jsp", "", 32, "left", "Habitations Last Updated Month Wise", 0);
							menus[26].addItem("./reports/rws_hab_status_form.jsp", "", 18, "left", "Location Status", 0);
							menus[26].addItem("./reports/rws_const_coverage_status_frm.jsp", "", 18, "left", "Constituency Status", 0);
							//menus[26].addItem("./reports/rws_office_coverage_frm.jsp", "", 18, "left", "Office Wise Status", 0);
                            //menus[26].addItem("./reports/rws_office_coverage_frm.jsp", "", 18, "left", "Dist", 0);
                            menus[26].addItem("#", "", 18, "left", "Hab Vs Population",43);
							menus[26].addItem("./reports/rws_coverage_status_frm1.jsp", "", 5, "left", "District Wise", 0);
							menus[26].addItem("./reports/rws_goi_coverage_frm.jsp", "", 15, "left", "District Wise - GOI", 0);
							menus[26].addItem("./reports/rws_planning_format1_frm.jsp", "", 18, "left", "RWS Planing-Format-I", 0);
							menus[26].addItem("./reports/rws_planning_format2_frm.jsp", "", 18, "left", "RWS Planing-Format-II", 0);
							menus[26].addItem("./reports/rws_planning_format_frm.jsp", "", 18, "left", "Habitations List", 0);
                            menus[26].addItem("switch.do?prefix=/reports&page=/PublicInst.do?mode=data", "", 32, "left", "Habitation -Public Institutes", 0);
...
////Sub menu items of work flow proposals-new work flow
	...
	////su menu items of WORKFLOW-PROPOSAL
			   ...
			   // menus[36].addItem("switch.do?prefix=/worksMonitoring&page=/workStatus.do", "", 22, "left", "Work Status", 0);
				...
				menus[37] = new menu(150, "vertical", 0, 0, 0, 0, "#E1E1E1", "#8A9FCD", "Verdana,Helvetica", 9, "bold", "bold", "black", "white", 1, "gray", 2, "rollover:images/tri-right1.gif:images/tri-right2.gif", false, true, false, false, 0, true, 4, 4, "#cccccc");
				...
				//menus[37].addItem("./reports/rws_admn_status_form.jsp", "", 22, "left", "Checklist", 0);      
				...
				menus[37].addItem("switch.do?prefix=/proposals&page=/Workwise.do?mode=circles", "", 30, "left", "WorkWise Report", 0);      
				menus[37].addItem("./reports/rws_prajapatham_workstatus_select.jsp", "", 22, "left", "Work Status", 0);      
				menus[37].addItem("./reports/rws_worksmonitoring_workstatus_select.jsp", "", 22, "left", "District Wise", 0);      
				menus[37].addItem("./reports/rws_worksmonitoring_progstatus_select.jsp", "", 30, "left", "Programme Wise", 0);  
				menus[37].addItem("./reports/rws_works_frm.jsp", "", 30, "left", "Total Works/Habs ", 0);  
				//menus[37].addItem("./reports/rws_workwise_monthly_rpt.jsp", "", 30, "left", "Monthly Progress Report", 0);      
				menus[37].addItem("./reports/rws_mnth_frm.jsp", "", 30, "left", "Monthly Progress Report", 0);      
				
				
				
				 // "HELP DOCUMENTS"
				menus[38] = new menu(160, "vertical", 0, 0, 0, 0, "#E1E1E1", "#8A9FCD", "Verdana,Helvetica", 9, "bold", "bold", "black", "white", 1, "gray", 2, 62, false, true, false, false, 0, true, 4, 4, "#cccccc");
				...
				menus[39] = new menu(150, "vertical", 0, 0, 0, 0, "#E1E1E1", "#8A9FCD", "Verdana,Helvetica", 9, "bold", "bold", "black", "white", 1, "gray", 2, "rollover:images/tri-right1.gif:images/tri-right2.gif", false, true, false, false, 0, true, 4, 4, "#cccccc");
				menus[39].addItem("./reports/rws_admn_status_form.jsp", "", 22, "left", "Admin Sanction", 0);      
				menus[39].addItem("./reports/rws_tech_status_form.jsp", "", 30, "left", "Technical Sanction", 0);   
				menus[39].addItem("./reports/rws_contractor_frm.jsp", "", 30, "left", "Contractor Management", 0);         
				menus[39].addItem("./reports/rws_program_sched_frm.jsp", "", 30, "left", "Program Schedule", 0);         
				menus[39].addItem("./reports/rws_work_expenditure_frm.jsp", "", 30, "left", "Work Expenditure", 0);     
				menus[39].addItem("./reports/rws_work_completion_frm.jsp", "", 30, "left", "Work Completion", 0); 
				menus[39].addItem("./reports/rws_integrated_rpt.jsp", "", 30, "left", "Integrated Work Checklist ", 0);                         
				
				
				//Fund Accounting  Menu
				menus[40] = new menu(150, "vertical", 0, 0, 0, 0, "#E1E1E1", "#8A9FCD", "Verdana,Helvetica", 9, "bold", "bold", "black", "white", 1, "gray", 2, "rollover:images/tri-right1.gif:images/tri-right2.gif", false, true, false, false, 0, true, 4, 4, "#cccccc");
				...
				menus[41] = new menu(200, "vertical", 0, 0, 0, 0, "#E1E1E1", "#8A9FCD", "Verdana,Helvetica", 9, "bold", "bold", "black", "white", 1, "gray", 2, "rollover:images/tri-right1.gif:images/tri-right2.gif", false, true, false, false, 0, true, 4, 4, "#cccccc");
				menus[41].addItem("switch.do?prefix=/fundAccounting&page=/releasesVsExpenditureWorkWise.do&mode=init", "", 32, "left", "Releases Vs Expenditure", 0);      
				...
				menus[41].addItem("switch.do?prefix=/fundAccounting&page=/releasesVsExpenditureSchemeWiseBetweenDates.do&mode=betweenDates", "", 32, "left", "Scheme Wise Releases Vs Expenditure", 0);      
				menus[41].addItem("switch.do?prefix=/fundAccounting&page=/releasesVsExpenditureProgrammeWise.do&mode=init", "", 32, "left", "Programme Wise Releases Vs Expenditure", 0);      
				menus[41].addItem("switch.do?prefix=/fundAccounting&page=/releasesVsExpenditureProgrammeWise.do&mode=ProgWiseDrillFrm", "", 32, "left", "Programme Wise Rpt2 Releases Vs Expenditure", 0);      
