...
<td align=center colspan=8 class="mystyle1"><font color="navy">AssetType:&nbsp;&nbsp;<%=assetName%> </font></td></tr>
<%}%>
</table>
...
<%	
	...
	{		
		...
		<tr align=left >
		    ...
		    <td  class="mystyle1"><a href = "rws_asset_hab_off_rpt1.jsp?panchayatcode=<%=record1[0]%>&panchyatname=<%=record1[1]%>&mandalcode=<%=mandalcode%>&districtcode=<%=districtcode%>"><%= record1[1]%></a></td>
<%		
