...
{ %>
			<tr><td align="right" class="bwborder"><a href="/pred/home.jsp?loginMode=watersoft">Home|</a></td>
				<td class="bwborder"><a href="javascript:onclick=history.go(-1)">Back|</a></td><td class="bwborder"><a href="./rws_no_household_habs_excel.jsp">Excel</a></td></tr>
<%  } else {%>
...
<tr bgcolor="#8A9FCD" ">
		<td align="center" class=gridhdbg colspan=9>Habitations without Household Connections</font></td>	
	</tr>
		<tr >
...
String householdzeroqry="select dname,mname,pname,vname,panch_code,panch_name from   RWS_HABITATION_DIRECTORY_TBL a,RWS_COMPLETE_HAB_VIEW b where a.hab_code=b.panch_code and (nvl(HOUSEHOLDS_SC,0)+nvl(HOUSEHOLDS_ST,0)+nvl(HOUSEHOLDS_PLAIN,0))=0 order by dcode,mcode,pcode,vcode,panch_code";
