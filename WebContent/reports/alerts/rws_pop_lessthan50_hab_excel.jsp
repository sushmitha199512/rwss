...
String householdzeroqry="select dname,mname,pname,vname,panch_code,panch_name,nvl(a.CENSUS_PLAIN_POPU,0),nvl(a.CENSUS_ST_POPU,0),nvl(a.CENSUS_SC_POPU,0) from   RWS_HABITATION_DIRECTORY_TBL a,RWS_COMPLETE_HAB_VIEW b where a.hab_code=b.panch_code and (nvl(a.CENSUS_PLAIN_POPU,0)+nvl(a.CENSUS_ST_POPU,0)+nvl(a.CENSUS_SC_POPU,0))<50 order by dcode,mcode,pcode,vcode,panch_code";
