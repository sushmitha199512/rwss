...
//System.out.println("value of p is  "+p);
	...
	ch.addTitle("Habitations Coverage Status  ", "times new roman Bold Italic",12);
...
String ss[]=new String[c];
  ...
  for(j=0;j<c;j++){
	...
	if(x.equals("b"))
   {
	...
	ch.addTitle("Habitations Coverage Status ", "Arial Bold", 10);
	//ch.setPlotArea(40, 40, 200, 150);
	ch.yAxis().setTitle("Coverage Status");
	ch.xAxis().setTitle("Total Habitations");
...
if(x.equals("p"))
 {
    ...
    ch.addTitle2(Chart.Top, "Habitations Coverage Status ", "Times New Roman Bold Italic",13);
	ch.set3D();
...
%>
    ...
    if(x.equals("d"))
 {
	...
	ch.addTitle("Habitations Coverage Status ", "times new roman Bold Italic",12);
	 ch.yAxis().setTitle("Coverage Status");
	 ch.xAxis().setTitle("Habitation Status");
