...
<script language="JavaScript">
	...
	/*  else  if(division=="-1")
	  ...
	  {
		  document.forms[0].action="./rws_Pushkar_Ghatwise_report2_rpt.jsp";
...
<table border = 1 align = center cellspacing = 0 cellpadding = 0 rules = "rows" bordercolor = navy style = "border-collapse:collapse" bgcolor="#ffffff" width=350>		
	...
	<tr bgcolor="#8A9FCD" align="center">
		<td align="center" class="rptHeading" colspan=3>Pushkar Ghat Wise Report 2</td>	
	</tr>
...
<input type="radio" value="2" name="habtype" onclick="show1()">Work Id&nbsp;&nbsp;
	...
	<table border = 1 align = center cellspacing = 0 cellpadding = 0 rules = "rows" bordercolor = navy style = "border-collapse:collapse" bgcolor="#ffffff" width=350>	
		...
		<%
				...
				query = "select  distinct * from RWS_CIRCLE_OFFICE_TBL where CIRCLE_OFFICE_CODE in('04','05')";
...
%>
		...
		else
		{
							...
							query = "select  distinct * from RWS_CIRCLE_OFFICE_TBL where circle_office_code='"+loggedUser.substring(1,3)+"' and CIRCLE_OFFICE_CODE in('04','05')";
