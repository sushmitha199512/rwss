...
<script language="JavaScript">
	...
	function fnSubmit()
	{
	  ...
	  {
		  document.forms[0].action="./rws_pushkar_work_wise_progress_rpt.jsp";
...
<table border = 1 align = center cellspacing = 0 cellpadding = 0 rules = "rows" bordercolor = navy style = "border-collapse:collapse" bgcolor="#ffffff" width=350>		
	...
	<tr bgcolor="#8A9FCD" align="center">
		<td align="center" class="rptHeading" colspan=3>Pushkar Work Wise Progress Report</td>	
	</tr>
	...
	<tr>
		...
		<td class=btext>
			...
			<%     		
				...
				query = "select  distinct * from RWS_DIVISION_OFFICE_TBL where circle_office_code='"+rCircle+"' and CIRCLE_OFFICE_CODE in('04','05','06','07','13')";
	...
	<tr>
		...
		<td class=btext>
			...
			<%     		
				...
				query = "select  distinct * from RWS_DIVISION_OFFICE_TBL where circle_office_code='"+loggedUser.substring(1,3)+"' and CIRCLE_OFFICE_CODE in('04','05','06','07','13')";
