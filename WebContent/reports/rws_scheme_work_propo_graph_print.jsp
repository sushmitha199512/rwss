<%@ page import="java.text.DecimalFormat,ChartDirector.*,java.sql.*,java.util.*" %>
...
<%  
	...
	String x=String.valueOf(session.getAttribute("x"));
	//System.out.println("TYPE OF CHART IS        "+x);	
	...
	dist=new String[mylists1];
    count=0;c=0; 
    int [] data=new int[mylists1];

	for(int y=1;y<=mylists1; y++)
	{
	String[] record1 =(String[])myList1.get(y);	
   ...
   if(count!=0){
	 ...
	 if(x.equals("l"))
    {
     XYChart ch = new XYChart(570, 200);
    
	ch.addTitle("Scheme Wise Work Proposal", "times new roman Bold Italic",12);
...
if(x.equals("p"))
 {
    ...
    ch.addTitle2(Chart.Top, "Scheme Wise  Work Proposal Graph Report", "Times New Roman Bold Italic",13);
	ch.set3D();
