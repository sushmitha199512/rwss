...
while(rs1.next())
    ...
    if(astcount>0)
	{%>
	<td class="rptValue" align="right"><a href="./rws_assets_resource_home_rpt.jsp?dcode=<%=rsss.getString(9)%>&mcode=<%=rsss.getString(3)%>&pcode=<%=rsss.getString(5)%>&hcode=<%=rsss.getString(1)%>&hname=<%=rsss.getString(2)%>&code=<%="Assets"%>">
	<%=astcount%></a></td>
	<%}else{%>
...
%>
<td class="rptValue" align="right"><a href="./rws_assets_resource_home_rpt.jsp?dcode=<%=rsss.getString(9)%>&mcode=<%=rsss.getString(3)%>&pcode=<%=rsss.getString(5)%>&hcode=<%=rsss.getString(1)%>&hname=<%=rsss.getString(2)%>&code=<%="Works"%>">
	<%=workid%></a></td>
<td class="rptValue" align="right">
	<%=workcount%></td><%
...
while(rs.next()){
 if(rs.getString(1)!=null && !rs.getString(1).equals("0")){
	 %><td class="rptValue" align="right"><a href="./rws_assets_resource_home_rpt.jsp?dcode=<%=rsss.getString(9)%>&mcode=<%=rsss.getString(3)%>&pcode=<%=rsss.getString(5)%>&hcode=<%=rsss.getString(1)%>&hname=<%=rsss.getString(2)%>&code=<%="Assets"%>"><%=rs.getString(1)%></td><%}else {%>
	<td class="rptValue" align="right">-</td>
	<%}if(rs.getString(2)!=null && !rs.getString(2).equals("0")){%>
	 <td class="rptValue" align="right"><a href="./rws_assets_resource_home_rpt.jsp?code=<%="Works"%>&dcode=<%=rsss.getString(9)%>&mcode=<%=rsss.getString(3)%>&pcode=<%=rsss.getString(5)%>&hcode=<%=rsss.getString(1)%>&hname=<%=rsss.getString(2)%>"><%=rs.getString(2)%></a></td>
		<%}else {%>
	<td class="rptValue" align="right">-</td>
		<%}
}
...
while(rs4.next()) 
{
	...
	%>
	<td class="rptValue" align="right"><a href="./rws_assets_resource_home_rpt.jsp?&dcode=<%=rsss.getString(9)%>&mcode=<%=rsss.getString(3)%>&pcode=<%=rsss.getString(5)%>&hcode=<%=rsss.getString(1)%>&hname=<%=rsss.getString(2)%>&code=<%="school"%>"><%=rs4.getString(1)%></a></td>
...
while(rs3.next()) 
{
	...
	%>
	<td class="rptValue" align="right"><a href="./rws_assets_resource_home_rpt.jsp?&dcode=<%=rsss.getString(9)%>&mcode=<%=rsss.getString(3)%>&pcode=<%=rsss.getString(5)%>&hcode=<%=rsss.getString(1)%>&hname=<%=rsss.getString(2)%>&code=<%="source"%>"><%=rs3.getString(1)%></a></td>
