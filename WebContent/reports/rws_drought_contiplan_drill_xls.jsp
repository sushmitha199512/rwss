...
try	
  {
    ...
    String trasqry="select substr(habcode,1,2),substr(habcode,6,2),count(*),sum(nvl(TRANSPORT_EST,'0')) from rws_drought_habitation_tbl where TRANSPORTATION ='Y' and year='"+y1+"' group by substr(habcode,1,2),substr(habcode,6,2)";
	Statement stmt2=conn.createStatement();
	System.out.println("trasqry**********"+trasqry);
    ...
    String hireqry="select substr(habcode,1,2),substr(habcode,6,2),count(*),sum(nvl(HIRING_OF_SOURCES,'0')),sum(nvl(HIRING_EST,'0')) from rws_drought_habitation_tbl where HIRING_OF_SOURCES>0 and year='"+y1+"' group by substr(habcode,1,2),substr(habcode,6,2)";
    ...
    String flushqry="select substr(habcode,1,2),substr(habcode,6,2),sum(nvl(FLUSHING,0)),sum(nvl(FLUSHING_EST,'0')) from rws_drought_habitation_tbl where FLUSHING>0 and year='"+y1+"' group by substr(habcode,1,2),substr(habcode,6,2)";
    ...
    String deepqry="select substr(habcode,1,2),substr(habcode,6,2),sum(nvl(DEEPENING,0)) ,sum(nvl(DEEPENING_EST,'0')) from rws_drought_habitation_tbl where DEEPENING>0 and year='"+y1+"' group by substr(habcode,1,2),substr(habcode,6,2)";
    ...
    String owdeepqry="select substr(habcode,1,2),substr(habcode,6,2),sum(nvl(DEEP_OW_NUM,0)),sum(nvl(DEEP_OW_EST,'0')) from rws_drought_habitation_tbl where DEEP_OW_NUM>0 and year='"+y1+"' group by substr(habcode,1,2),substr(habcode,6,2)";
    ...
    String sstqry="select substr(habcode,1,2),substr(habcode,6,2),sum(nvl(SST_NUM,0)),sum(nvl(SST_EST,'0')) from rws_drought_habitation_tbl where SST_NUM>0 and year='"+y1+"' group by substr(habcode,1,2),substr(habcode,6,2)";
...
///////////////////////////////////////////////////////////////////
	if(dcode.equals("00"))
  {
		//gqry="select   substr(habcode,1,2),d.dname,count(*) from rws_district_tbl d,rws_drought_habitation_tbl h where substr(h.habcode,1,2)=d.dcode and year='"+y1+"' and substr(h.habcode,1,2)='"+dcode+"' group by substr(habcode,1,2),d.dname order by 2";
	//gqry="select   substr(habcode,1,2),m.mcode,d.dname,count(*) from rws_district_tbl d,rws_drought_habitation_tbl h,rws_mandal_tbl m where substr(h.habcode,1,2)=d.dcode and m.dcode=d.dcode and year='"+y1+"' group by substr(habcode,1,2),d.dname order by 2";
  	//gqry="select substr(habcode,1,2),substr(habcode,6,2),d.dname,count(*) from rws_district_tbl d,rws_drought_habitation_tbl h,rws_mandal_tbl a where substr(h.habcode,1,2)=d.dcode and d.dcode=a.DCODE  and year='"+y1+"' and substr(h.habcode,1,2)='"+dcode+"' group by substr(habcode,1,2),d.dname,substr(habcode,6,2) order by 2";

	gqry="select substr(habcode,1,2),substr(habcode,6,2),d.dname,count(*),mname from rws_district_tbl d,rws_drought_habitation_tbl h,rws_mandal_tbl a where substr(h.habcode,1,2)=d.dcode and d.dcode=a.DCODE  and year='"+y1+"'  group by substr(habcode,1,2),d.dname,substr(habcode,6,2),mname  order by 2";
  }
  else
	{
	...
	//  gqry="select   substr(habcode,1,2),d.dname ,count(*) from rws_district_tbl d,rws_drought_habitation_tbl h where substr(h.habcode,1,2)=d.dcode and substr(h.habcode,1,2)='"+dcode+"' and year='"+y1+"' group by substr(habcode,1,2),d.dname order by 2";
      //gqry="select   substr(habcode,1,2),d.dname ,count(*) from rws_district_tbl d,rws_drought_habitation_tbl h,rws_mandal_tbl m where substr(h.habcode,1,2)=d.dcode and m.dcode=d.dcode and substr(h.habcode,1,2)='"+dcode+"' and year='"+y1+"' group by substr(habcode,1,2),d.dname order by 2";
	
	//  gqry="select substr(habcode,1,2),substr(habcode,6,2),d.dname,count(*) from rws_district_tbl d,rws_drought_habitation_tbl h,rws_mandal_tbl a where substr(h.habcode,1,2)=d.dcode and d.dcode=a.DCODE and substr(h.habcode,1,2)='"+dcode+"' and year='"+y1+"' group by substr(habcode,1,2),d.dname,substr(habcode,6,2) order by 2";
	  gqry="select substr(habcode,1,2),substr(habcode,6,2),d.dname,count(*),mname from rws_district_tbl d,rws_drought_habitation_tbl h,rws_mandal_tbl a where substr(h.habcode,1,2)=d.dcode and d.dcode=a.DCODE  and year='"+y1+"' and substr(h.habcode,1,2)='"+dcode+"' group by substr(habcode,1,2),d.dname,substr(habcode,6,2),mname  order by 2";
	}
		

gqry="select substr(habcode,1,2),substr(habcode,6,2),d.dname,m.mname,count(*)  from rws_district_tbl d,rws_drought_habitation_tbl h,rws_mandal_tbl m  where substr(h.habcode,1,2)=d.dcode  and year='"+y1+"' and substr(h.habcode,1,2)='"+dcode+"'  and m.dcode=d.dcode and m.mcode=substr(habcode,6,2) group by substr(habcode,1,2),substr(habcode,6,2),d.dname,m.mname order by 2";
     System.out.println("queryttttt**********"+gqry);
