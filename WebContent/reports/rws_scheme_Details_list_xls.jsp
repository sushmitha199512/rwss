...
DecimalFormat ndf = new DecimalFormat("####.00");
	...
	//System.out.println("programe"+programe);
		String pnames=(String)session.getAttribute("pname");
%>
<body>
...
<tr>
<td colspan="19"><B><font class="btext" >Progress Report of<font color="rptValue"> <%=sname%></font> Schemes  </B></td></tr>
<tr><td class="btext" align="left" colspan="19">District: <font color="rptValue"><%=dname%></font></td></tr>
<tr><td style="width:960px"colspan="19" ><B><font class="btext">Programmes:<font color="rptValue"><%=pnames%></font>  </B></td></tr>
</table>
<table border = 1 cellspacing = 0 cellpadding = 0 height="5%" width="70%" bordercolor=#000000 style="border-collapse:collapse" bgcolor="#ffffff" align = "center">	
	...
	<td class=btext >Admn. <br>San. No.</td>
	<td class=btext  >Admn. <br>San. Date</td>
	<td class=btext  >Tech.<br> San. No.</td>
	<td class=btext  >Tech. <br>San. Date</td>
	<td class=btext >Est.Cost/<br> Rev. Cost</td>
<td class=btext  >Exp. upto<br> previous year</td>
<td class=btext >Bal Est.Cost <br>as on 1.4.11</td>
<td class=btext >Exp. during<br> the month</td>
<td class=btext  >Exp. during <br>the year</td>
<td class=btext  >% of Exp. <br>against Bal<br> Est.Cost(14/12)</td>
<td class=btext  >Date of <br>Grounding</td>
<!-- <td class=btext  >Physical Stage
(Major Component wise % of Achmt.)</td> -->
<td class=btext  >Date of <br>Completion</td>
<td class=btext  >No. of Habs <br>Sanctioned</td>
<td class=btext  >No. of Habs <br>covered</td>
