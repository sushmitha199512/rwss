...
<tr align=center>
			...
			<td class="btext" nowrap>Bill Amount (In Rupees)</td>
			<td class="btext">Bill Amount Admissable(In Rupees)</td>
			<td class="btext">Voucher Amount(In Rupees)</td>
	</tr>
...
//System.out.println("qry3aaaaaaa:"+qry);
