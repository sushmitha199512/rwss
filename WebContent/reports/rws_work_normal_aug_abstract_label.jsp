...
<tr bgcolor="#8A9FCD" align="center">
		<td align="center" class="rptHeading" colspan=20>District Wise Normal - Augmentation Works Abstract Report for the Financial Year(<%=session.getAttribute("financialyr")%>)</td>	
	</tr>
...
%>	
	<tr  align="center">
		<td align="center" class="btext" colspan=20  >District: All &nbsp; &nbsp;PLAN WORKS&nbsp; &nbsp;</td>
	</tr>	
