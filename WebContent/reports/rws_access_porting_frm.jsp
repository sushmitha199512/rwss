...
<head>
	...
	<script language="JavaScript">
		function fnSubmit(){    
			...
			document.forms[0].action="switch.do?prefix=/reports&page=/accessPorting.do?mode=get";
...
<body bgcolor="#edf2f8">
	<html:form action="accessPorting.do">
		<table border = 1 align=center cellspacing = 0 cellpadding = 0 rules="rows" width="32%"  bordercolor=navy style="border-collapse:collapse" bgcolor="#ffffff">
			...
			<tr bgcolor="#8A9FCD" align="center">
				<td align="center" class="textborder" colspan="2">
					<font color="#FFFFFF">MPR Porting</font>
				</td>	
			</tr>
			<tr> 
				<td valign="top" align="center" height="25%" width="30%">
					<table  bordercolor= navy width="100%" height="100%" border=1 rules="rows" style="border-collapse:collapse" align = center>
						<tr>
							...
							<td class=btext><input id="demo1" type="text" size="10" ><a href="javascript:NewCal('demo1','ddmmmyyyy')"><img src="./images/cal.gif" width="16" height="16" border="0" alt="Pick a date"></a></td>
						</tr>
						<tr>
							<td class=rptLabel>To Date&nbsp;<font color="red">*</font></td>
							<td class=btext><input id="demo2" type="text" size="10"><a href="javascript:NewCal('demo2','ddmmmyyyy')">
					...
					<table bordercolor="navy" width="40%" border="0" rules="none" style="border-collapse:collapse" align="center">
						<tr>
							<td colspan="2" align="center">
								<input type=button onclick="fnSubmit()" value="Start" class="btext">
							</td>
						</tr>
					</table>	
				</td>
		...
		<table width="30%" align=center>
			<tr>
				...
				<td class=rptValue nowrap>1. For Financial MPR , Bank & State Fund Release Dates are considered.</td>
			</tr>
			<tr>
				<td bordercolor="black"></td>
				<td class=rptValue nowrap>2. For Physical and School MPR , Update Date is Considered. </td>
			</tr>
			<tr>
				<td bordercolor="black"></td>
				<td class=rptValue nowrap>3. Only One Month Data can be Ported at a time. </td>
			</tr>
		</table>
