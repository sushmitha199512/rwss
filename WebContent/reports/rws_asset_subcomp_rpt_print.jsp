...
<%	
	...
	ArrayList myList1 = (ArrayList)session.getAttribute("arrList");
...
<table align="center" width="100%">
	<tr>
	<td align="center" class="mystyle1"><font color="navy"><h5>Asset Sub Component Status  Report</h3></font></td>
