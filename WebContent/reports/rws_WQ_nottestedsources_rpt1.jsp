...
<table border = 0 cellspacing = 0 cellpadding = 0 width=50%   style="border-collapse:collapse" >
		<caption>
	       <table border=0 rules=none style="border-collapse:collapse" width=50% align="right" >		
				<tr align="right">
					<td  ><a href="javascript:history.go(-1)">Back| <!--   <a href="rws_WQ_RFD_excel.jsp" target="_new">Excel</a>--></td>
				</tr>
		 </table>
		</caption>
...
<td class="gridhdbg" align=center >Total Not Tested Sources<br></td>
	...
	//
		...
		qry13.delete(0,qry13.length()); 
		 qry13.append("SELECT COUNT(DISTINCT A.SOURCE_CODE),SUBSTR(A.SOURCE_CODE,1,2) FROM RWS_WQ_TEST_RESULTS_TBL B, RWS_ASSET_MAST_TBL M, RWS_ASSET_SCHEME_TBL S,RWS_SOURCE_TBL A,RWS_COMPLETE_HAB_VIEW V WHERE M.HAB_CODE=V.PANCH_CODE AND M.ASSET_CODE=A.ASSET_CODE AND M.ASSET_CODE=S.ASSET_CODE AND (M.TYPE_OF_ASSET_CODE='01' OR M.TYPE_OF_ASSET_CODE='02' OR M.TYPE_OF_ASSET_CODE='03' OR  M.TYPE_OF_ASSET_CODE='09') AND A.ASSET_CODE=S.ASSET_CODE AND B.SOURCE_CODE=A.SOURCE_CODE AND TO_DATE(B.PREPARED_ON)>='1-APR-"+yearStart+"' AND  TO_DATE(B.PREPARED_ON)<='31-MAR-"+yearEnd+"'");
		if(dcode.toString()!=null && !dcode.toString().equals("00"))
		{
		...
		//System.out.println("tested sources1:"+qry13);
		...
		qry13.delete(0,qry13.length()); 
		qry13.append(" SELECT COUNT(DISTINCT A.HP_CODE),SUBSTR(A.HP_CODE,1,2) FROM RWS_WQ_TEST_RESULTS_TBL B, RWS_ASSET_MAST_TBL M, RWS_ASSET_SCHEME_TBL S, RWS_HP_SUBCOMP_PARAM_TBL A, RWS_COMPLETE_HAB_VIEW V WHERE M.ASSET_CODE=A.ASSET_CODE AND M.ASSET_CODE=S.ASSET_CODE AND M.TYPE_OF_ASSET_CODE='04' AND A.ASSET_CODE=S.ASSET_CODE AND M.HAB_CODE=V.PANCH_CODE AND (SUBSTR(S.SCHEME_CODE,17,3) LIKE '0%' OR SUBSTR(S.SCHEME_CODE,17,3) LIKE '1%' OR SUBSTR(S.SCHEME_CODE,17,3) LIKE '2%') AND B.SOURCE_CODE=A.HP_CODE AND TO_DATE(B.PREPARED_ON)>='1-APR-"+yearStart+"' AND  TO_DATE(B.PREPARED_ON)<='31-MAR-"+yearEnd+"'");
		if(dcode.toString()!=null && !dcode.toString().equals("00"))
		{
			qry13.append(" AND  SUBSTR(A.HP_CODE,1,2) = '"+dcode.toString()+"' ");
		}
		qry13.append(" GROUP BY  SUBSTR(A.HP_CODE,1,2) ORDER BY 2");
		//System.out.println("tested sources2:"+qry13);
		rs13=stmt13.executeQuery(qry13.toString());
		...
		qry13.delete(0,qry13.length()); 
		qry13.append("SELECT COUNT(DISTINCT A.SHALLOWHP_CODE),SUBSTR(A.SHALLOWHP_CODE,1,2) FROM RWS_WQ_TEST_RESULTS_TBL B , RWS_ASSET_MAST_TBL M, RWS_ASSET_SCHEME_TBL S, RWS_SHALLOWHANDPUMPS_TBL A, RWS_COMPLETE_HAB_VIEW V WHERE M.ASSET_CODE=A.ASSET_CODE AND M.ASSET_CODE=S.ASSET_CODE AND M.TYPE_OF_ASSET_CODE='05' AND A.ASSET_CODE=S.ASSET_CODE AND V.PANCH_CODE=M.HAB_CODE AND B.SOURCE_CODE=A.SHALLOWHP_CODE AND TO_DATE(B.PREPARED_ON)>='1-APR-"+yearStart+"' AND  TO_DATE(B.PREPARED_ON)<='31-MAR-"+yearEnd+"'");
		if(dcode.toString()!=null && !dcode.toString().equals("00"))
		{
			qry13.append(" AND  SUBSTR(A.SHALLOWHP_CODE,1,2) = '"+dcode.toString()+"' ");
		}
		qry13.append(" GROUP BY  SUBSTR(A.SHALLOWHP_CODE,1,2) ORDER BY 2");
		//System.out.println("tested sources3:"+qry13);
		rs13=stmt13.executeQuery(qry13.toString());
		...
		qry13.delete(0,qry13.length()); 
		qry13.append(" SELECT COUNT(DISTINCT A.POND_CODE),SUBSTR(A.POND_CODE,1,2) FROM RWS_WQ_TEST_RESULTS_TBL B, RWS_ASSET_MAST_TBL M, RWS_ASSET_SCHEME_TBL S, RWS_OPENWELL_POND_TBL A, RWS_COMPLETE_HAB_VIEW V WHERE M.ASSET_CODE=A.ASSET_CODE AND M.ASSET_CODE=S.ASSET_CODE AND M.TYPE_OF_ASSET_CODE='07' AND A.ASSET_CODE=S.ASSET_CODE AND V.PANCH_CODE=M.HAB_CODE AND B.SOURCE_CODE=A.POND_CODE AND TO_DATE(B.PREPARED_ON)>='1-APR-"+yearStart+"' AND  TO_DATE(B.PREPARED_ON)<='31-MAR-"+yearEnd+"'");
		if(dcode.toString()!=null && !dcode.toString().equals("00"))
		{
			qry13.append(" AND  SUBSTR(A.POND_CODE,1,2) = '"+dcode.toString()+"' ");
		}
		qry13.append(" GROUP BY  SUBSTR(A.POND_CODE,1,2) ORDER BY 2");
		//System.out.println("tested sources5:"+qry13);
		rs13=stmt13.executeQuery(qry13.toString());
	...
	String query="SELECT COUNT(DISTINCT A.SOURCE_CODE),SUBSTR(A.SOURCE_CODE,1,2) FROM RWS_ASSET_MAST_TBL M, RWS_ASSET_SCHEME_TBL S,RWS_SOURCE_TBL A,RWS_COMPLETE_HAB_VIEW V WHERE M.HAB_CODE=V.PANCH_CODE AND M.ASSET_CODE=A.ASSET_CODE AND M.ASSET_CODE=S.ASSET_CODE AND (M.TYPE_OF_ASSET_CODE='01' OR M.TYPE_OF_ASSET_CODE='02' OR M.TYPE_OF_ASSET_CODE='03' OR  M.TYPE_OF_ASSET_CODE='09') AND A.ASSET_CODE=S.ASSET_CODE ";
			if (dcode.toString() != null && !dcode.toString().equals("00")) {
				query += " AND SUBSTR(A.SOURCE_CODE,1,2) = '"
						+ dcode.toString() + "' ";
			}
			query += " GROUP BY  SUBSTR(A.SOURCE_CODE,1,2) ORDER BY 2";
			...
			query = "SELECT COUNT(DISTINCT A.HP_CODE),SUBSTR(A.HP_CODE,1,2) FROM RWS_ASSET_MAST_TBL M, RWS_ASSET_SCHEME_TBL S, RWS_HP_SUBCOMP_PARAM_TBL A, RWS_COMPLETE_HAB_VIEW V WHERE M.ASSET_CODE=A.ASSET_CODE AND M.ASSET_CODE=S.ASSET_CODE AND M.TYPE_OF_ASSET_CODE='04' AND A.ASSET_CODE=S.ASSET_CODE AND M.HAB_CODE=V.PANCH_CODE AND (SUBSTR(S.SCHEME_CODE,17,3) LIKE '0%' OR SUBSTR(S.SCHEME_CODE,17,3) LIKE '1%' OR SUBSTR(S.SCHEME_CODE,17,3) LIKE '2%') ";
			if (dcode.toString() != null && !dcode.toString().equals("00")) {
				query += " AND SUBSTR(A.HP_CODE,1,2) = '"
						+ dcode.toString() + "' ";
			}

			query += " GROUP BY  SUBSTR(A.HP_CODE,1,2) ORDER BY 2";

			stmt15 = conn.createStatement();
			//System.out.println("Hp sources having lab results qry15:"	+ query);
			...
			//ShallowHand Pump
			query = "SELECT COUNT(DISTINCT A.SHALLOWHP_CODE ),SUBSTR(A.SHALLOWHP_CODE,1,2) FROM RWS_ASSET_MAST_TBL M, RWS_ASSET_SCHEME_TBL S, RWS_SHALLOWHANDPUMPS_TBL A, RWS_COMPLETE_HAB_VIEW V WHERE M.ASSET_CODE=A.ASSET_CODE AND M.ASSET_CODE=S.ASSET_CODE AND M.TYPE_OF_ASSET_CODE='05' AND A.ASSET_CODE=S.ASSET_CODE AND V.PANCH_CODE=M.HAB_CODE ";

			if (dcode.toString() != null && !dcode.toString().equals("00")) {
				query += " AND SUBSTR(A.SHALLOWHP_CODE,1,2) = '"
						+ dcode.toString() + "' ";
			}

			query += " GROUP BY  SUBSTR(A.SHALLOWHP_CODE,1,2) ORDER BY 2";

			stmt16 = conn.createStatement();
			//System.out.println("SHP sources having lab results qry16:"+ query);
			...
			//OPen Pump
			query = "SELECT COUNT(DISTINCT A.OPENWELL_CODE),SUBSTR(A.OPENWELL_CODE,1,2) FROM RWS_ASSET_MAST_TBL M, RWS_ASSET_SCHEME_TBL S, RWS_OPEN_WELL_MAST_TBL A, RWS_COMPLETE_HAB_VIEW V WHERE M.ASSET_CODE=A.ASSET_CODE AND M.ASSET_CODE=S.ASSET_CODE AND M.TYPE_OF_ASSET_CODE='06' AND A.ASSET_CODE=S.ASSET_CODE AND V.PANCH_CODE=M.HAB_CODE ";
			if (dcode.toString() != null && !dcode.toString().equals("00")) {
				query += " AND SUBSTR(A.OPENWELL_CODE,1,2) = '"
						+ dcode.toString() + "' ";
			}
			query += " GROUP BY  SUBSTR(A.OPENWELL_CODE,1,2) ORDER BY 2";

			stmt17 = conn.createStatement();
			//System.out.println("Open Well sources having lab results qry17:"+ query);
			...
			//ponds Pump
			query = "SELECT COUNT(DISTINCT A.POND_CODE),SUBSTR(A.POND_CODE,1,2) FROM RWS_ASSET_MAST_TBL M, RWS_ASSET_SCHEME_TBL S, RWS_OPENWELL_POND_TBL A, RWS_COMPLETE_HAB_VIEW V WHERE M.ASSET_CODE=A.ASSET_CODE AND M.ASSET_CODE=S.ASSET_CODE AND M.TYPE_OF_ASSET_CODE='07' AND A.ASSET_CODE=S.ASSET_CODE AND V.PANCH_CODE=M.HAB_CODE ";
			if (dcode.toString() != null && !dcode.toString().equals("00")) {
				query += " AND SUBSTR(A.POND_CODE,1,2) = '"
						+ dcode.toString() + "' ";
			}

			query += " GROUP BY  SUBSTR(A.POND_CODE,1,2) ORDER BY 2";

			stmt18 = conn.createStatement();
			//System.out.println("Pond sources having lab results qry18:"	+ query);
			...
			if (dcode.toString() != null && !dcode.toString().equals("00")) {
				...
				qry13.append("SELECT A.DCODE, A.DNAME  FROM RWS_DISTRICT_TBL A WHERE A.DCODE='"
						+ dcode.toString()
						+ "' AND A.DCODE<>'16' ORDER BY A.DCODE ");
			...
			while (rs.next()) {
				...
				source1.append((String.valueOf(sources11.get(rs
						.getString(1)))));

				if (source1.toString() != null
						&& !source1.toString().equals(" ")
						&& !source1.toString().equals("null")) {
				...
				if (hp1.toString() != null && !hp1.toString().equals("")
						&& !hp1.toString().equals("null")) {
				...
				if (shp1.toString() != null && !shp1.toString().equals("")
						&& !shp1.toString().equals("null")) {
				...
				if (op1.toString() != null && !op1.toString().equals("")
						&& !op1.toString().equals("null")) {
				...
				if (pon1.toString() != null && !pon1.toString().equals("")
						&& !pon1.toString().equals("null")) {
				...
				if (cur1.toString() != null && !cur1.toString().equals("")
						&& !cur1.toString().equals("null")) {
				...
				if (cur2.toString() != null && !cur2.toString().equals("")
						&& !cur2.toString().equals("null")) {
				...
				if (cur3.toString() != null && !cur3.toString().equals("")
						&& !cur3.toString().equals("null")) {
				...
				if (cur4.toString() != null && !cur4.toString().equals("")
						&& !cur4.toString().equals("null")) {
				...
				if (cur5.toString() != null && !cur5.toString().equals("")
						&& !cur5.toString().equals("null")) {
				...
				if (hp.toString() != null && !hp.toString().equals("")
						&& !hp.toString().equals("null")) {
				...
				if (shp.toString() != null && !shp.toString().equals("")
						&& !shp.toString().equals("null")) {
				...
				if (op.toString() != null && !op.toString().equals("")
						&& !op.toString().equals("null")) {
				...
				if (pon.toString() != null && !pon.toString().equals("")
						&& !pon.toString().equals("null")) {
...
<td class="<%=style.toString() %>" style="text-align:right;"><a href="#" onclick="viewWorks('rws_WQ_nottestedsources_drill_count_rpt1.jsp?dcode=<%=rs.getString(1)%>&dname=<%=rs.getString(2)%>&year=<%=yearStart.toString()%>&year1=<%=yearEnd.toString()%>')"><%=totalsources%></td>
