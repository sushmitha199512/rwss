...
qry="select dname,mname,pname,vname,panch_name,panch_code,TOTAL_STANDPOSTS,TOTAL_HOUSEHOLDS,TOTAL_MULTI_STANDPOST,TOTAL_MULTI_HOUSEHOLDS,TOTAL_PUMPS,TOTAL_OPENWELL,nvl(SEASONAL,0),THROUGH_OUT_YEAR,to_char(SURVEY_DATE,'dd/mm/yyyy') from rws_complete_hab_view a,rws_bls_water_fac_Inhab_tbl b where a.panch_code=b.habitation_code and dcode='"+dcode+"'";
