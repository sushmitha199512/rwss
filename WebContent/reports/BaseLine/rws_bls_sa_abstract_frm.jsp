	...
	function fnSubmit()
	{
		var loggedUser = '<%=loggedUser%>';
			...
			else
			{
				...
				document.f1.action="./rws_bls_sa_abstract_rpt.jsp";
				document.f1.submit();
			}	
		}
		</script>
...
<body bgcolor="#edf2f8">
<form name=f1  action="./rws_bls_sa_abstract_rpt.jsp" method="post">
<table border = 1 align = center cellspacing = 0 cellpadding = 0 rules = "rows" bordercolor = navy style = "border-collapse:collapse" bgcolor="#ffffff" width=350>		
	...
	<tr bgcolor="#8A9FCD" align="center">
		<td align="center" class="rptHeading" colspan=3>Base Line Survey - Abstract Report</td>	
	</tr>
	<%
try
{
