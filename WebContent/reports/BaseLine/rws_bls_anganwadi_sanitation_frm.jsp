	...
	function fnSubmit()
	{
		var loggedUser = '<%=loggedUser%>';
			...
			else
			{
				...
				document.f1.action="./rws_bls_anganwadi_sanitation_rpt.jsp";
				document.f1.submit();
			}	
		}
		</script>
...
<table border = 1 align = center cellspacing = 0 cellpadding = 0 rules = "rows" bordercolor = navy style = "border-collapse:collapse" bgcolor="#ffffff" width=350>		
	...
	<tr bgcolor="#8A9FCD" align="center">
		<td align="center" class="rptHeading" colspan=3>BaseLine Survey- Anganvadi Sanitation Survey - Report</td>	
	</tr>
	<%
try
{
