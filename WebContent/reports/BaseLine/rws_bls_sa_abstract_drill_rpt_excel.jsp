...
response.setHeader("Content-Disposition", "inline; filename="
		+ "base line survey school&anganwadi drill.xls");
...
nic.watersoft.works.WorksData1 w=new nic.watersoft.works.WorksData1();
 ...
 String qry="";
	...
	<tr >
	<td align="center" class="rptHeading" > Base Line Survey  School and Anganwadi - Detailed Report</td>
	</tr>
...
try
{
 ...
 //school queries
   ...
   if(type.equals("1")){
	   ...
	   rs3=stmt3.executeQuery(schoolqry);
...
// anganwadi query
   ...
   if(type.equals("4")){
	   ...
	   rs3=stmt3.executeQuery(anganqry);
	   }
...
<td  class="<%=style%> "style="text-align: left;"> <%=rs3.getString(11)%></td> 
<td  class="<%=style%> "style="text-align: left;"> <%=rs3.getString(12)%></td> 
<td  class="<%=style%> "style="text-align: left;"> <%=rs3.getString(13)%></td> 
<td  class="<%=style%> "style="text-align: left;"> <%=rs3.getString(14)%></td> 
<td  class="<%=style%> "style="text-align: left;"> <%=rs3.getString(15)%></td>
<td  class="<%=style%> "style="text-align: left;"> <%=rs3.getString(16)%></td> 
<td  class="<%=style%> "style="text-align: left;"> <%=rs3.getString(17)%></td> 
<td  class="<%=style%> "style="text-align: left;"> <%=rs3.getString(18)%></td> 
<td  class="<%=style%> "style="text-align: left;"> <%=rs3.getString(19)%></td> 
<td  class="<%=style%> "style="text-align: left;"> <%=rs3.getString(20)%></td> 
<td  class="<%=style%> "style="text-align: left;"> <%=rs3.getString(21)%></td> 
<td  class="<%=style%> "style="text-align: left;"> <%=rs3.getString(22)%></td> 
<td  class="<%=style%> "style="text-align: left;"> <%=rs3.getString(23)%></td> 
<td  class="<%=style%> "style="text-align: left;"> <%=rs3.getString(24)%></td> 
<td  class="<%=style%> "style="text-align: left;"> <%=rs3.getString(25)%></td> 
<td  class="<%=style%> "style="text-align: left;"> <%=rs3.getString(26)%></td> 
