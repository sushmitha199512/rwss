...
System.out.println("hab qry :"+qry);
...
%>
	...
	<% String qry1="SELECT nvl(testing_parameter_value,'-')  from RWS_WQ_TEST_RESULTS_LNK_TBL wr,RWS_WATER_SAMPLE_COLLECT_TBL ws WHERE ws.TEST_ID = '"+testId+"' and wr.test_id=ws.test_id and testing_parameter_code='"+rs.getString(6)+"' and ws.assigned_on BETWEEN '"+yearStart+"' AND '"+yearEnd+"'";
	 System.out.println("query3 : "+qry1);
