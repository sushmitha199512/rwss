...
<td class=btext ><b>Milestone SlNo </b></td>
<td class=btext ><b>Major Milestone Code</b></td>
...
<td class=btext ><b>Type Of Contractor</b></td>
<td class=btext ><b>Component No Ach</b></td>
...
query="select w.office_code,substr(w.office_code,2,2),substr(w.office_code,4,1),substr(w.office_code,5,2),m.work_id,MILESTONE_SLNO,MAJOR_MILESTONE_CODE,nvl(COMPONENT_NO,0),to_char(TARGET_DATE),nvl(PERCENT_COMPLETED_WORK,0),nvl(PERCENT_COMPLETED,0),TYPE_OF_CONTRACTOR,nvl(COMPONENT_NO_ACH,0),nvl(PERCENT_COMPLETED_WORK_VAL,0),nvl(PERCENT_COMPLETED_VAL,0)  from rws_work_admn_tbl w,rws_milestone_target_ach_tbl m where w.work_id=m.work_id and w.work_id='"+workid+"'";
