...
<%		
	...
	String query = null,qu=null, a1="",codename=null,mcode=null,mname=null,dcode=null,dname=null,panch=null,pname=null,vill=null,vname=null,hcode=null,hname=null,code=null,sourcecode=null,yrcreation="",astCode="";
...
<body bgcolor="#edf2f8">        
        ...
        <br/><br/>
            <center>
                ...
                <br/><br/><font color="#889900" face="Maiandra GD" size="3px">District: <%=dname%></font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <font color="#889900" face="Maiandra GD" size="3px">Mandal: <%=mname%></font><br/><br/>
                <font color="#889900" face="Maiandra GD" size="3px">Habitation: <%=hname%></font>
            </center>
            ...
            <table align="center" style="margin-top: -15px !important; width: 700px !important;  text-align: center !important;">
                ...
                <tr id="exportList" style="display: none; ">
                    ...
                    <a href="" title="PDF" onClick="$('#tableID').tableExport({type:'pdf',pdfFontSize:'8', pdfColWidth: '30', ignoreColumn: [0],escape:'false',htmlContent:'false',colSpace: [10,33,20,30,36,36,36]}); return false;">
...
st1=conn.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE,ResultSet.CONCUR_UPDATABLE);
                    ...
                    qu = "select distinct b.asset_name,b.location,b.asset_status,to_char(b.date_creation,'DD-MON-YYYY'),b.asset_cost,b.type_of_asset_code,b.asset_code from rws_complete_asset_view b,rws_hab_directory_view h where b.HAB_CODE='"+hcode+"' and h.hab_code=b.HAB_CODE and b.type_of_asset_code='"+astCode+"'";
