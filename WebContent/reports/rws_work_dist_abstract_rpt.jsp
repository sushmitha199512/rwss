...
function unview()
{
	...
	function fnSubmit()    
	{
		if(document.f1.district.value=='00')
			...
			document.f1.action="./rws_work_gen_rpt.jsp";
			document.f1.submit();
	}
...
<table border = 1 align = center cellspacing = 0 cellpadding = 0 rules = "rows" bordercolor = navy style = "border-collapse:collapse" bgcolor="#ffffff" width=350>		
	...
	<tr bgcolor="#8A9FCD" align="center">
		<td align="center" class="rptHeading" colspan=3>DistrictWise District Level Works Abstract Report</td>	
	</tr>
...
<input type="hidden" name="catCode" value="3">
</form>
</body>
</html>
