...
if(loggedUser!=null && loggedUser.equals(Constants.ADMIN) || loggedUser.equals(Constants.LAKH_USER))
{
...
<td class=rptValue align="right" style="background-color:lightyellow"><a href="#" onclick="viewWorks('rws_svs_mvs_prevcomp_curr_update_drill_rpt.jsp?type=2&ccode=<%=rs1.getString(3) %>&divCode=<%=rs1.getString(4) %>')"><%=SVSList.get(rs1.getString(3)+rs1.getString(4))==null?"0":(svscnt=(Integer.parseInt((String)SVSList.get(rs1.getString(3)+rs1.getString(4)))))%></td>
...
<td class=rptValue align="right"  style="background-color:#F9F2FA"><a href="#" onclick="viewWorks('rws_svs_mvs_prevcomp_curr_update_drill_rpt.jsp?type=1&ccode=<%=rs1.getString(3) %>&divCode=<%=rs1.getString(4) %>')"><%=MVSList.get(rs1.getString(3)+rs1.getString(4))==null?"0":(mvscnt=(Integer.parseInt((String)MVSList.get(rs1.getString(3)+rs1.getString(4)))))%></td>
