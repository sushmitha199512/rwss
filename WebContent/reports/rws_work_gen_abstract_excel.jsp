...
<table border = 1 cellspacing = 0 cellpadding = 0 height=5% width="100%" bordercolor=#000000 style="border-collapse:collapse" bgcolor="#ffffff" align = "center">
	...
	////System.out.println("First Drill");
	   ...
	   %>
		...
		String view1="Create or Replace view spillworks"+session.getId().substring(1,10)+" as SELECT work_id,office_code,no_of_habs,category_code,plan_code FROM RWS_WORK_ADMN_TBL W where w.ADMIN_DATE < '"+fixYear+"' and w.work_id not in (select work_id from rws_work_completion_tbl where (DATE_OF_COMPLETION < '"+fixYear+"'))";
		String view2="Create or Replace view newworks"+session.getId().substring(1,10)+" as SELECT work_id,office_code,no_of_habs,category_code,plan_code FROM RWS_WORK_ADMN_TBL W where w.ADMIN_DATE >= '"+fixYear+"' ";
