...
<%   
	...
	dist[0]="PWS";	data[0]=totfc;
	dist[1]="MPWS";	data[1]=totpc1;
	dist[2]="CPWS";data[2]=totpc2;
	dist[3]="HPS";	data[3]=totpc3;
	dist[4]=" SHPS";data[4]=totpc4;
	dist[5]=" OWS";data[5]=totpc5;
	dist[6]=" PONDS";data[6]=totpc6;
	dist[7]=" OTHERS";data[7]=totpc7;
	dist[8]=" DP";data[8]=totpc8;
	dist[9]=" SCHOOLS";data[9]=totpc9;
    dist[10]=" LABS";data[10]=totpc10;
...
//		   //System.out.println("value of c is  "+c);
	...
	ch.addTitle("Assets Graph", "times new roman Bold Italic",12);
...
String ss[]=new String[c];
  ...
  for(j=0;j<c;j++){
	...
	if(x.equals("b"))
   {
	...
	ch.addTitle("Assets Graph", "Arial Bold", 10);
	//ch.setPlotArea(40, 40, 200, 150);
	ch.yAxis().setTitle("No. of Habitations");
	ch.xAxis().setTitle("Asset Name");
...
if(x.equals("p"))
 {
    ...
    ch.addTitle2(Chart.Top, "Assets Graph", "Times New Roman Bold Italic",13);
	ch.set3D();
