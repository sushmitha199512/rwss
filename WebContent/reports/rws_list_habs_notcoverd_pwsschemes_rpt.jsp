...
<td class="bwborder"><a href="javascript:onclick=history.go(-1)">Back&nbsp;|</a></td>
			...
			<td class="bwborder"><a href="/pred/home.jsp?loginMode=watersoft">Home | </a></td>
				...
				<td class="bwborder"><a href="./rws_list_habs_notcoverd_pwsschemes_xls.jsp" target=_new>Excel | </a></td>
			</tr>  
		</table>
	</caption>
...
%>
<tr><td colspan=7 class=btext align="center">Total:</td><td class=btext><%=gtotpop %></td></tr>
<% 
 }
catch(Exception e)
{
