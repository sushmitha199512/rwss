...
if(scPer==0 && stPer==0)
{
	...
	String insertQuery1="insert into  rws_sc_st_performance_temp_tbl values (?,'P')";
	stmt3=conn.createStatement();
	PreparedStatement ps3=conn.prepareStatement(insertQuery1);
    ps3.setString(1, rs2.getString(3));
	ps3.executeUpdate();
	if(stmt3!=null)
	{
		stmt3.close();
...
if(scPer!=0.0 || stPer!=0.0)
{
	...
	myWorkList1=myWorkList1.replace("]", ")" );
	String insertQuery1="insert into  rws_sc_st_performance_temp_tbl values (?,'S')";
	stmt3=conn.createStatement();
	 PreparedStatement ps1=conn.prepareStatement(insertQuery1);
     ps1.setString(1, rs2.getString(3));
	ps1.executeUpdate();
	if(stmt3!=null)
	{
		stmt3.close();
