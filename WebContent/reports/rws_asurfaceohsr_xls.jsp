...
<%
		...
		String aname=(String)session.getAttribute("assetname");
		String dcode=(String)session.getAttribute("dcode");
		String mcode=(String)session.getAttribute("mcode");
		String asset=(String)session.getAttribute("asset");System.out.println("aaa:"+asset);
...
<table   bgcolor="#FFFFFF" bordercolor= "#8A9FCD"  width="80%" border=1 style="border-collapse:collapse"  ALIGN=CENTER ><tr align=center>
	...
	<!-- <td class=btext nowrap>GPS Code(Way Point)/GLSR/GLBR<br>/OHSR/OHBR</td>
	<td class=btext nowrap>Latitude/GLSR/GLBR<br>/OHSR/OHBR</td>
	<td class=btext nowrap>Longitude/GLSR/GLBR<br>/OHSR/OHBR</td>
	<td class=btext nowrap>Elevation/GLSR/GLBR<br>/OHSR/OHBR</td> -->
...
try
{
  ...
  //System.out.println("gqryssssssssssss:"+gqry);
	...
	if(rs8.isBeforeFirst())
   {
	...
	%>
	<%if(!asset.equals("09")){%>
<tr><td  colspan="14"  class=btext>Panchayat Name:<%=rs8.getString(3)%></td></tr>
<%}else{%>
<tr><td  colspan="14"  class=btext>Panchayat Name:<%=rs8.getString(3)%></td></tr>
<%}%>
<%}else{}%>
