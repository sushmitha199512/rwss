...
{ %>
			<tr><td align="right" class="bwborder"><a href="/pred/home.jsp?loginMode=watersoft">Home|</a></td>
				...
				<td class="bwborder"><a href="./rws_pop_greaterthan3000_hab_excel.jsp">Excel</a></td></tr>
<%  } else {%>
...
<tr bgcolor="#8A9FCD" ">
		<td align="center" class=gridhdbg colspan=10>Habitations having population greater than 3000</font></td>	
	</tr>
		<tr >
...
String householdzeroqry="select dname,mname,pname,vname,panch_code,panch_name,nvl(a.CENSUS_PLAIN_POPU,0),nvl(a.CENSUS_ST_POPU,0),nvl(a.CENSUS_SC_POPU,0) from   RWS_HABITATION_DIRECTORY_TBL a,RWS_COMPLETE_HAB_VIEW b where a.hab_code=b.panch_code and (nvl(a.CENSUS_PLAIN_POPU,0)+nvl(a.CENSUS_ST_POPU,0)+nvl(a.CENSUS_SC_POPU,0))>3000 order by dcode,mcode,pcode,vcode,panch_code";
