...
{ %>
			<tr><td align="right" class="bwborder"><a href="/pred/home.jsp?loginMode=watersoft">Home|</a></td>
				...
				<td class="bwborder"><a href="./rws_lpcd_lessthan10_hab_excel.jsp">Excel</a></td></tr>
<%  } else {%>
...
<tr bgcolor="#8A9FCD" ">
		<td align="center" class=gridhdbg colspan=8>Habitations having Lpcd less than 10</font></td>	
	</tr>
		<tr >
...
String householdzeroqry="select dname,mname,pname,vname,panch_code,panch_name,nvl(a.EXIST_WATER_LEVEL,0) from   RWS_HABITATION_DIRECTORY_TBL a,RWS_COMPLETE_HAB_VIEW b where a.hab_code=b.panch_code and nvl(a.EXIST_WATER_LEVEL,0)<10 order by dcode,mcode,pcode,vcode,panch_code";
