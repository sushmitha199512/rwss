...
String query = null;
   ...
   String ccode="";
   String divcode=""; 
   if(!loggedUser.equals(Constants.ADMIN) && !loggedUser.equals(Constants.LAKH_USER) && !loggedUser.equals("cerwss")){
...
document.f1.distname.value = document.f1.combo.options[document.f1.combo.options.selectedIndex].text;
			...
			else
		{
			...
			document.f1.action="./rws_sc_st_subplan_abstract_rpt.jsp";
...
<%} %>
	...
	<tr bgcolor="#8A9FCD" align="center">
		<td align="center" class="rptHeading" colspan=4>RWS&S Ongoing Works of different programmes and Budget Provision under  Sub Plan/SC Sub Plan</td>
	</tr>
...
if(ccode!=null && !ccode.equals("")&& !loggedUser.equals("guest") && !loggedUser.equals("secrwss") && !loggedUser.substring(0,3).equals("col")) {
