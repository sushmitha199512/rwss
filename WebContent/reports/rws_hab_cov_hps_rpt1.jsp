		...
		<caption>
			<table  border=0 rules=none style="border-collapse:collapse" align = "right">		
				<tr>
					...
					<a href="./rws_hab_cov_hps_rpt1_excel.jsp" target=_new>Excel</a>
					</td>
				</tr>
			</table>
		</caption>
...
try
{
	...
	%>
		...
		<tr align="center">
			...
			<td class=btext>No of HP(Safe+Un Safe)</td>
...
//System.out.println("Query:"+cpQuery);
			...
			<tr>
				...
				%>
				<td class=rptValue align="right"><%=cpcount1%></td>
				<td class=rptValue align="right"><%=cpcount%></td>
		...
		%>
		<tr>
				<td class=btext align="right" colspan="2">Totalsss</td>
				<td class=btext align="right"><%=columnTotal3%></td>
				<td class=btext align="right"><%=Gtotalpop%></td>
				<td class=btext align="right"><a href="./rws_hab_details_hp_xls.jsp" target="_new"><%=columnTotal4%></a></td>
...
try
{
	...
	%>
		<tr align="center" bgcolor="#ffffff">
			<td class=btext rowspan=2>Snodd</td>
			<td class=btext rowspan=2>District</td>
			<td class=btext rowspan=2>No. of Habs</td>	
			<td class=btext rowspan=2>Pop</td>	
			 <td class=btext colspan="3" >Habs covered by HPs only</td>
	...
	<%
		...
		%>
		<tr>
				<td class=btext align=right colspan="2">Totaldfd</td>
				<td class=btext align="right"><%=columnTotal3%></td>
				<td class=btext align="right"><%=Gtotalpop%></td>
				<td class=btext align="right"><a href="./rws_hab_details_hp_xls.jsp" target="_new"><%=columnTotal4%></a></td>
				<td class=btext align="right"><%=columnTotal5%></td>
