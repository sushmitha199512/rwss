...
function fnSubmit()
{
	...
	if(document.f1.FDate.selectedIndex!="")
	{
		...
		{
		document.f1.action="./rws_circle_work_proposal_graph_rpt.jsp";
	document.f1.submit();
	}
	}
	else
	...
	<table  border=0 rules=none style="border-collapse:collapse" width=100% align = "right" bgcolor="#edf2f8">
		...
		<tr bgcolor="#8A9FCD" align="center">
			<td align="center" class="textborder" colspan="2">
				<font color="#FFFFFF">Office Wise Work Proposals</font>
			</td>	
		</tr>
...
<%		session.setAttribute("dName",null);
	...
	stmt = conn.createStatement();
		rs =stmt.executeQuery("SELECT distinct c.CIRCLE_OFFICE_CODE , c.circle_office_name from rws_circle_office_tbl c, rws_panchayat_raj_tbl pr,rws_work_proposal_tbl a, RWS_PROPOSAL_HAB_LNK_TBL ah where  c.circle_office_code=substr(a.office_code,2,2) and  a.proposal_id=ah.proposal_id and pr.panch_code=ah.hab_code");
