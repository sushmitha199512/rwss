...
function unview()    
{
	...
	function fnSubmit()
	{
		...
		if(logValue=="admin" || logValue=="100000")
		{
			...
			document.f1.action="./rws_work_prog_abstract_rpt.jsp";
			document.f1.submit();
		}
		else
		{
...
<table border = 1 align = center cellspacing = 0 cellpadding = 0 rules = "rows" bordercolor = navy style = "border-collapse:collapse" bgcolor="#ffffff" width=350>		
	...
	<tr bgcolor="#8A9FCD" align="center">
		<td align="center" class="rptHeading" colspan=3>Program wise Works Abstract Report</td>	
	</tr>
...
<td class=rptLabel>Work Cateogry&nbsp;&nbsp;<font color="red">*</font></td>
		<td class=btext>
