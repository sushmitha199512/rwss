...
<!--
		...
		if(document.f1.FDate.selectedIndex!="")
	{
		...
		{
		document.f1.action="./rws_work_status_different_stages_graph_rpt.jsp";
	document.f1.submit();
	}
	}
	else
...
<form name=f1 >
	...
	<table  border=0 rules=none style="border-collapse:collapse" align = "right">
		...
		<tr bgcolor="#8A9FCD" align="center">
			<td algin="center" class="textborder" colspan="5"><font color="#FFFFFF">Work Status At Different Stages Report
			</font></td>	
		</tr>
		<tr>
