...
response.setHeader("Content-Disposition", "inline; filename="
		+ "drought daily detailed report.xls");
...
<table border = 1 cellspacing = 0 cellpadding = 0 height=5% width="80%" bordercolor=#000000 style="border-collapse:collapse" bgcolor="#ffffff" align = "center">	
		...
		<tr bgcolor="#8A9FCD" align="center">
			<td align="center" class="rptHeading" colspan=24>DETAILED DAILY REPORT ON DRINKING WATER SITUATION&nbsp;&nbsp;&nbsp;&nbsp;OF <%=dcode.toString()%>&nbsp;&nbsp;:&nbsp;&nbsp;<%=rvalue.toString()%> &nbsp;&nbsp;<font color="blue"></font></td>	
		</tr>
		<% }else{ %>
		<tr bgcolor="#8A9FCD" align="center">
