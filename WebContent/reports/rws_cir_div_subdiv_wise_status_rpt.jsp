...
<table border = 1 cellspacing = 0 cellpadding = 0 width=100%  bordercolor=#000000 style="border-collapse:collapse" bgcolor="#ffffff">	
	<tr>
		...
		<td class="btext">SubDivision<br>Name</td>
...
<%
	...
	if(Count!=0){
			...
			<td class="rptValue">
			<a href="rws_subdiv_mandal_wise_rpt.jsp?dcode=<%=dCode%>&mcode=<%=mCode%>&pcode=<%=rs6.getString(1)%>&pname= <%=rs6.getString(2)%>"><%=rs6.getString(2)%></a></td>
