...
<%		int totfc=0,totpc1=0,totpc2=0,totpc3=0,totpc4=0,totpc5=0,totpc6=0,totpc7=0,totpc8=0,totpc9=0,totpc10=0,totnc=0,totnss=0,tot=0;
	...
	ResultSet r1 = null,r2 = null,r3 = null,r4 = null,r5 = null,r6=null,r7=null,r8=null,r9=null,r10=null;
...
<caption>
	<table  border=0 rules=none style="border-collapse:collapse" align = "right">
		<tr align="right">
			<td class="bwborder">
				<a href="./rws_distwise_assets_graph_frm.jsp">Back |</a>
	...
	<tr bgcolor="lavander">
		<td class="textborder" align="center" colspan="7">
			<font color="ffffff">Assets Graph</font></td>
	</tr>
...
try
	...
	if(district.equals("51")){
		...
		%>	<%@ include file="./rws_distwise_assets_graph_tot.jsp" %>
	 ...
	 <%@ include file = "./rws_distwise_assets_graph.jsp"%>	
	<%
	}
	catch(Exception ee)
	{
