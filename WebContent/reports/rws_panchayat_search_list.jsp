...
<tr><td class=myfontclr><B><font color="#FFFFFF">Panchayat Search List</font></B></td></tr></table>
...
<tr bgcolor="#ffffff">
	...
	<% int count=0;
	java.util.Collection a = (java.util.ArrayList)session.getAttribute("panchayatdisplay"); 
...
<td  class="bwborder" ><%=count %></td>
				...
				<td align="left" class=bwborder><bean:write name="employee" property="panchayatCode" /></td>
