...
<caption>
	<table  border=0 rules=none style="border-collapse:collapse" align = "right">
		...
		<tr align="right">
			<td class="bwborder">
				<a href="./rws_om_proposal_det_frm.jsp">Back&nbsp;|&nbsp;</a>&nbsp;<a href="../home.jsp">Home&nbsp;|&nbsp;</a>
				<a href="rws_om_proposal_rpt_print.jsp"        target="_new">Print&nbsp;|&nbsp;</a>
				<a href="rws_om_proposal_rpt_excel_print.jsp"  target="_new">Excel</a>
			</td>
		</tr>
	</table>
</caption>
	<tr bgcolor="lavander">
		<td class="textborder" align="center" colspan="11"><font color="ffffff">O & M Proposal  Report</font></td>
</tr>
<tr><td>
...
<% 
	...
	if((start+20)<=myList1.size())
		{
		%>
		<a href="rws_om_proposal_hab_rpt_temp.jsp?start=<%=r1%>&slno=<%=slno%>&pgcnt=<%=s1%>"><font   color=#FF00CC>Next </font></a>
		<%}
	%>
</td>
</table>
