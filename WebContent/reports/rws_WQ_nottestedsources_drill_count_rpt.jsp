...
%>
<tr>
<td class="<%=style.toString() %>" style="text-align: left;" align="right">Scheme Sources</td><td class="<%=style %>" style="text-align: right;" align="right"><a href="#" onclick="viewWorks('rws_WQ_nottestedsources_drill_rpt.jsp?stype=SO&dcode=<%=dcode.toString()%>')"><%=sourcecnt.toString() %></td>
</tr>
<tr>
<td class="<%=style %>" style="text-align: left;" align="right">Hand Pumps</td><td class="<%=style %>" style="text-align: right;" align="right" ><a href="#" onclick="viewWorks('rws_WQ_nottestedsources_drill_rpt.jsp?stype=HP&dcode=<%=dcode%>')"><%=hpcnt %></td>
</tr>
<tr>
<td class="<%=style %>" style="text-align: left;" align="right">OpenWells</td><td class="<%=style %>" style="text-align: right;" align="right"><a href="#" onclick="viewWorks('rws_WQ_nottestedsources_drill_rpt.jsp?stype=OP&dcode=<%=dcode%>')"><%=opcnt %></td>
</tr>
<tr>
<td class="<%=style %>" style="text-align: left;" align="right">Shallow HandPumps</td><td class="<%=style %>" style="text-align: right;" align="right"><a href="#" onclick="viewWorks('rws_WQ_nottestedsources_drill_rpt.jsp?stype=SHP&dcode=<%=dcode%>')"><%=shpcnt %></td>
</tr>
<tr>
<td class="<%=style %>" style="text-align: left;" align="right">Ponds </td><td class="<%=style %>" style="text-align: right;" align="right"><a href="#" onclick="viewWorks('rws_WQ_nottestedsources_drill_rpt.jsp?stype=PS&dcode=<%=dcode%>')"><%=pscnt %></td>
</tr>
<% 
      }
