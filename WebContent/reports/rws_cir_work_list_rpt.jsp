...
try 
{
	...
	String rDistrict, rMandal, rPanchayat, query, query1 = null;
	...
	// //System.out.println("FFFFFFFFFFFFFFFFFFFF    "+fdate);
	// //System.out.println("TTTTTTTTTTTTTTTTTTTTTt    "+tdate);
...
if(rDistrict.equals("51"))
{
	...
	query1="SELECT P.PROPOSAL_ID, P.PROPOSAL_NAME, P.LEAD_HAB_CODE, PR.PANCH_NAME FROM RWS_REP_PROPOSAL_TBL P, RWS_PANCHAYAT_RAJ_TBL PR, RWS_work_PROPOSAL_TBL W WHERE P.LEAD_HAB_CODE = PR.PANCH_CODE and W.PROPOSAL_ID = P.PROPOSAL_ID  ";
}
if(!rDistrict.equals("51") && !rDistrict.equals("0") && rMandal.equals("0"))
{
	// //System.out.println("IN CIRCLE SELECTION...");
	query1="SELECT P.PROPOSAL_ID, P.PROPOSAL_NAME, P.LEAD_HAB_CODE, PR.PANCH_NAME FROM RWS_REP_PROPOSAL_TBL P, RWS_PANCHAYAT_RAJ_TBL PR, RWS_work_PROPOSAL_TBL W WHERE P.LEAD_HAB_CODE = PR.PANCH_CODE AND SUBSTR(W.OFFICE_CODE,2,2)='"+rDistrict+"' and W.PROPOSAL_ID = P.PROPOSAL_ID  ";
}
...
if(!rDistrict.equals("51") && !rDistrict.equals("0") && !rMandal.equals("5200") && !rMandal.equals("0") && rPanchayat.equals("0"))
{
	...
	query1="SELECT P.PROPOSAL_ID, P.PROPOSAL_NAME, P.LEAD_HAB_CODE, PR.PANCH_NAME FROM RWS_REP_PROPOSAL_TBL P, RWS_PANCHAYAT_RAJ_TBL PR, RWS_work_PROPOSAL_TBL W WHERE P.LEAD_HAB_CODE = PR.PANCH_CODE AND SUBSTR(W.OFFICE_CODE,2,2)='"+rDistrict+"' AND SUBSTR(W.OFFICE_CODE,4,1) = '"+rMandal+"'  and W.PROPOSAL_ID = P.PROPOSAL_ID  ";
}
