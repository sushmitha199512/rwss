...
<tr><td class=myfontclr><B><font color="#FFFFFF">Village Search List</font></B></td></tr></table>
...
<tr bgcolor="#ffffff">
	...
	<% int count=0;
	java.util.Collection a = (java.util.ArrayList)session.getAttribute("villagedisplay"); 
