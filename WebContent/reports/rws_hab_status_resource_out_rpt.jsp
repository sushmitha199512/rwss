	 ...
	 if(document.forms[0].habtype[0].checked)
	 {
	  ...
	  /* if(dist=="00")
	   ...
	   if(dist!="00" && mand!="-1" && panch!="-1" && vill!="-1" && hab=="-1")
	    ...
	    {
	     //alert("in Hab select ");*/
	    document.forms[0].action="./rws_hab_only_status_resource_out_rpt.jsp";
		document.forms[0].submit();
	    }
	 }
	  ...
	  function fnSubmit1()
	  {
	   ...
	   }else if(val.length<3)
	   {
        ...
        var url="./rws_hab_status_resource_out_rpt1.jsp";
        // alert(url);
...
<%} %>
 --%>
	...
	<tr bgcolor="#8A9FCD" align="center">
		<td align="center" class="rptHeading" colspan=3>Know your Habitation</td>	
	</tr>
