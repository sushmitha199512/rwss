	...
	function fnSubmit()
	{
		...
		var loggedUser = '<%=loggedUser%>';
			 ...
			 else
			{
				...
				document.f1.action="./rws_news_paper_clippings_rpt.jsp";
				document.f1.submit();
			}	
		}
</script>
...
<table border = 1 align = center cellspacing = 0 cellpadding = 0 rules = "rows" bordercolor = navy style = "border-collapse:collapse" bgcolor="#ffffff" width=350>		
	...
	<tr>
	<td class=rptLabel>Level&nbsp;&nbsp;<font color="red">*</font></td>
	
		<td class=btext>
		<select name="level" id="combo" class="mycombo" style="width:150px">
