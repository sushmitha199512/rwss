	...
	function fnSubmit()
	{
		...
		if(user=="admin" || user=="100000" || user=="guest")
		{
			...
			else
			{
				...
				//document.f1.divpname.value = document.f1.division.options[document.f1.division.selectedIndex].text;
				
                
				
				document.f1.action="./rws_blockedworks_rpt.jsp";
				document.f1.submit();
			}	
		}
		else
...
<table border = 1 align = center cellspacing = 0 cellpadding = 0 rules = "rows" bordercolor = navy style = "border-collapse:collapse" bgcolor="#ffffff" width=350>		
	...
	<tr bgcolor="#8A9FCD" align="center">
		<td align="center" class="rptHeading" colspan=3>Payment Blocked Works Report</td>	
	</tr>
...
<%  
		...
		<%}else{%>
			...
			query="SELECT distinct d.dcode,d.dname  from rws_district_tbl d ,rws_work_admn_tbl w  where d.dcode<>16  and substr(w.work_id,5,2)=d.dcode and block_payment='Y' order by d.dname";
...
<%
			...
			query="select  distinct a.division_office_code,a.division_office_name from rws_division_office_tbl a,rws_work_admn_tbl w where substr(w.office_code,2,2)=a.circle_office_code and substr(w.office_code,4,1)=a.division_office_code and w.block_payment='Y' ";
			if(dcode!=null && !dcode.equals("all"))
			{
