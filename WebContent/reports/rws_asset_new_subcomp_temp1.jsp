...
<caption>
	<table  border=0 rules=none style="border-collapse:collapse" align = "right">
		...
		<tr align="right">
			...
			<a href="rws_asset_new_subcomp_rpt_print.jsp" target="_new">Print&nbsp;|&nbsp;</a>
			<a href="rws_asset_new_subcomp_rpt_excel_print.jsp"target="_new">Excel</a>
				<%			
		}
		}
...
<td align="left" class=mystyle1><%for(int r=0,s=1;r<myList1.size(); r+=30,s++) { 
		// //System.out.println("panchayat  name is ");		
		if(pgcnt==s)
		{ 
		...
		<a href="rws_asset_new_subcomp_temp1.jsp?start=<%=r%>&slno=<%=slno%>&pgcnt=<%=s%>"><%=s%></a>
<% 			}%>
