...
{       
    ...
    if(document.f1.FDate.selectedIndex=="")
	{
        ...
        document.f1.action="./rws_coveragefc_status_graph_rpt.jsp";
		document.f1.submit();
}
	...
	<table  border=0 rules=none style="border-collapse:collapse" width=100% align = "right" bgcolor="#edf2f8">
		...
		<tr bgcolor="#8A9FCD" align="center">
			<td align="center" class="textborder" colspan="2">
                ...
                <font color="#FFFFFF">Habitations Coverage Status Graph</font>
			</td>	
		</tr>
...
<%			
	...
	rs5=st5.executeQuery("select DISTINCT to_char(status_date,'dd-MON-yyyy') from rws_habitation_directory_tbl  where status_date is not null order by to_char(status_date,'dd-MON-yyyy')"); 
