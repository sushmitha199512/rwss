...
<script language="JavaScript">
	...
	document.f1.mname.value = document.f1.mandal.options[document.f1.mandal.selectedIndex].text;
				...
				document.f1.action="./rws_district_wise_con_gps_rpt.jsp";
				document.f1.submit();
			}	
		}
         ...
         
      {
			...
			else
			{
                ...
                //alert("....hai....."+document.f1.dname1.value);
				document.f1.action="./rws_district_wise_gps_rpt.jsp";
				document.f1.submit();
			}	
...
<table border = 1 align = center cellspacing = 0 cellpadding = 0 rules = "rows" bordercolor = navy style = "border-collapse:collapse" bgcolor="#ffffff" width=350>		
	...
	<tr bgcolor="#8A9FCD" align="center">
		<td align="center" class="rptHeading" colspan=3>District Wise 100% GP's  </td>	
	</tr>
...
%>
	<tr bgcolor="#8A9FCD" align="center">
		<td align="center" colspan=3 class=btext>
			<input type="radio" name="reptype" id="con" value="con" onclick="fnSubmit1();"/>Consolidated
            <input type="radio" name="reptype" id="det" value="det" onclick="fnSubmit1();"/>Detailed
		</td>
	</tr>
...
<br><br><br>
Note:&nbsp;&nbsp;1.Cosolidated report-District wise<br>
     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2. Detailed report   -Mandal wise  
