<%
if((rSubDivision != null) && (!rSubDivision.equals("0")) && (rDivision != null) && (!rDivision.equals("0")) && (rCircle != null) && (!rCircle.equals("0")) && (rAssetType != null) && (!rAssetType.equals("0")) && (rAssetType.equals("01")) && (rMandal != null) && (!rMandal.equals("0")) && (rPanchayat.equals("0")))
{
	//System.out.println("ASSET TYPE & CIRCLE & DIVISION & SUB DIVISION & MANDAL SELECTED...");
...
try
{	
	query = " SELECT COUNT(*) FROM RWS_ASSET_MAST_TBL A, RWS_ASSET_SCHEME_TBL S, RWS_PWS_SUBCOMP_PARAM_TBL H, RWS_ASSET_TYPE_TBL T WHERE A.ASSET_CODE = S.ASSET_CODE AND A.ASSET_CODE = H.ASSET_CODE AND  SUBSTR(S.SCHEME_CODE,17,3) LIKE '%6%' AND SUBSTR(A.HAB_CODE,1,2) = '" +rCircle+ "' AND SUBSTR(A.HAB_CODE,6,2) = '" +rMandal+ "' AND A.TYPE_OF_ASSET_CODE = T.TYPE_OF_ASSET_CODE AND T.TYPE_OF_ASSET_NAME='PWS' AND A.TYPE_OF_ASSET_CODE='" +rAssetType+ "' AND SUBSTR(H.PUMP_CODE,1,2) = '" +rCircle+ "' AND SUBSTR(H.PUMP_CODE,6,2) = '" +rMandal+ "' AND A.CIRCLE_OFFICE_CODE = '" +rCircle+ "' AND A.DIVISION_OFFICE_CODE = '" +rDivision+ "' AND A.SUBDIVISION_OFFICE_CODE = '" +rSubDivision+ "' ";
	rs = stmt.executeQuery(query);
	rs.next();

	query1 = " SELECT COUNT(*) FROM RWS_ASSET_MAST_TBL A, RWS_ASSET_SCHEME_TBL S, RWS_PWS_DISTRI_SC_PARAM_TBL H, RWS_ASSET_TYPE_TBL T WHERE A.ASSET_CODE = S.ASSET_CODE AND A.ASSET_CODE = H.ASSET_CODE AND  SUBSTR(S.SCHEME_CODE,17,3) LIKE '%6%' AND SUBSTR(A.HAB_CODE,1,2) = '" +rCircle+ "' AND SUBSTR(A.HAB_CODE,6,2) = '" +rMandal+ "' AND A.TYPE_OF_ASSET_CODE = T.TYPE_OF_ASSET_CODE AND T.TYPE_OF_ASSET_NAME='PWS' AND A.TYPE_OF_ASSET_CODE='" +rAssetType+ "' AND SUBSTR(H.DISTRISC_CODE,1,2) = '" +rCircle+ "' AND SUBSTR(H.DISTRISC_CODE,6,2) = '" +rMandal+ "' AND A.CIRCLE_OFFICE_CODE = '" +rCircle+ "' AND A.DIVISION_OFFICE_CODE = '" +rDivision+ "' AND A.SUBDIVISION_OFFICE_CODE = '" +rSubDivision+ "' ";
	rs1 = stmt1.executeQuery(query1);
	rs1.next();

	query2 = " SELECT COUNT(*) FROM RWS_ASSET_MAST_TBL A, RWS_ASSET_SCHEME_TBL S, RWS_PWS_OHSR_SC_PARAM_TBL H, RWS_ASSET_TYPE_TBL T WHERE A.ASSET_CODE = S.ASSET_CODE AND A.ASSET_CODE = H.ASSET_CODE AND  SUBSTR(S.SCHEME_CODE,17,3) LIKE '%6%' AND SUBSTR(A.HAB_CODE,1,2) = '" +rCircle+ "' AND SUBSTR(A.HAB_CODE,6,2) = '" +rMandal+ "' AND A.TYPE_OF_ASSET_CODE = T.TYPE_OF_ASSET_CODE AND T.TYPE_OF_ASSET_NAME='PWS' AND A.TYPE_OF_ASSET_CODE='" +rAssetType+ "' AND SUBSTR(H.OHSR_CODE,1,2) = '" +rCircle+ "' AND SUBSTR(H.OHSR_CODE,6,2) = '" +rMandal+ "' AND A.CIRCLE_OFFICE_CODE = '" +rCircle+ "' AND A.DIVISION_OFFICE_CODE = '" +rDivision+ "' AND A.SUBDIVISION_OFFICE_CODE = '" +rSubDivision+ "' ";
	rs2 = stmt2.executeQuery(query2);
	rs2.next();

	query3 = " SELECT COUNT(*) FROM RWS_ASSET_MAST_TBL A, RWS_ASSET_SCHEME_TBL S, RWS_PWS_SP_HC_PC_SC_PARAM_TBL H, RWS_ASSET_TYPE_TBL T WHERE A.ASSET_CODE = S.ASSET_CODE AND A.ASSET_CODE = H.ASSET_CODE AND  SUBSTR(S.SCHEME_CODE,17,3) LIKE '%6%' AND SUBSTR(A.HAB_CODE,1,2) = '" +rCircle+ "' AND SUBSTR(A.HAB_CODE,6,2) = '" +rMandal+ "' AND A.TYPE_OF_ASSET_CODE = T.TYPE_OF_ASSET_CODE AND T.TYPE_OF_ASSET_NAME='PWS' AND A.TYPE_OF_ASSET_CODE='" +rAssetType+ "' AND SUBSTR(H.SPHCPCSC_CODE,1,2) = '" +rCircle+ "' AND SUBSTR(H.SPHCPCSC_CODE,6,2) = '" +rMandal+ "' AND A.CIRCLE_OFFICE_CODE = '" +rCircle+ "' AND A.DIVISION_OFFICE_CODE = '" +rDivision+ "' AND A.SUBDIVISION_OFFICE_CODE = '" +rSubDivision+ "' ";
	rs3 = stmt3.executeQuery(query3);
	rs3.next();

	query4 = " SELECT COUNT(*) FROM RWS_ASSET_MAST_TBL A, RWS_ASSET_SCHEME_TBL S, RWS_PWS_CIS_SC_PARAM_TBL H, RWS_ASSET_TYPE_TBL T WHERE A.ASSET_CODE = S.ASSET_CODE AND A.ASSET_CODE = H.ASSET_CODE AND  SUBSTR(S.SCHEME_CODE,17,3) LIKE '%6%' AND SUBSTR(A.HAB_CODE,1,2) = '" +rCircle+ "' AND SUBSTR(A.HAB_CODE,6,2) = '" +rMandal+ "' AND A.TYPE_OF_ASSET_CODE = T.TYPE_OF_ASSET_CODE AND T.TYPE_OF_ASSET_NAME='PWS' AND A.TYPE_OF_ASSET_CODE='" +rAssetType+ "' AND SUBSTR(H.CISSC_CODE,1,2) = '" +rCircle+ "' AND SUBSTR(H.CISSC_CODE,6,2) = '" +rMandal+ "' AND A.CIRCLE_OFFICE_CODE = '" +rCircle+ "' AND A.DIVISION_OFFICE_CODE = '" +rDivision+ "' AND A.SUBDIVISION_OFFICE_CODE = '" +rSubDivision+ "' ";
	rs4 = stmt4.executeQuery(query4);
	rs4.next();

	query5 = " SELECT COUNT(*) FROM RWS_ASSET_MAST_TBL A, RWS_ASSET_SCHEME_TBL S, RWS_PWS_CP_SC_PARAM_TBL H, RWS_ASSET_TYPE_TBL T WHERE A.ASSET_CODE = S.ASSET_CODE AND A.ASSET_CODE = H.ASSET_CODE AND  SUBSTR(S.SCHEME_CODE,17,3) LIKE '%6%' AND SUBSTR(A.HAB_CODE,1,2) = '" +rCircle+ "' AND SUBSTR(A.HAB_CODE,6,2) = '" +rMandal+ "' AND A.TYPE_OF_ASSET_CODE = T.TYPE_OF_ASSET_CODE AND T.TYPE_OF_ASSET_NAME='PWS' AND A.TYPE_OF_ASSET_CODE='" +rAssetType+ "' AND SUBSTR(H.CPSC_CODE,1,2) = '" +rCircle+ "' AND SUBSTR(H.CPSC_CODE,6,2) = '" +rMandal+ "' AND A.CIRCLE_OFFICE_CODE = '" +rCircle+ "' AND A.DIVISION_OFFICE_CODE = '" +rDivision+ "' AND A.SUBDIVISION_OFFICE_CODE = '" +rSubDivision+ "' ";
	rs5 = stmt5.executeQuery(query5);
	rs5.next();

	query6 = " SELECT COUNT(*) FROM RWS_ASSET_MAST_TBL A, RWS_ASSET_SCHEME_TBL S, RWS_PWS_GLSR_SC_PARAM_TBL H, RWS_ASSET_TYPE_TBL T WHERE A.ASSET_CODE = S.ASSET_CODE AND A.ASSET_CODE = H.ASSET_CODE AND  SUBSTR(S.SCHEME_CODE,17,3) LIKE '%6%' AND SUBSTR(A.HAB_CODE,1,2) = '" +rCircle+ "' AND SUBSTR(A.HAB_CODE,6,2) = '" +rMandal+ "' AND A.TYPE_OF_ASSET_CODE = T.TYPE_OF_ASSET_CODE AND T.TYPE_OF_ASSET_NAME='PWS' AND A.TYPE_OF_ASSET_CODE='" +rAssetType+ "' AND SUBSTR(H.GLSR_CODE,1,2) = '" +rCircle+ "' AND SUBSTR(H.GLSR_CODE,6,2) = '" +rMandal+ "' AND A.CIRCLE_OFFICE_CODE = '" +rCircle+ "' AND A.DIVISION_OFFICE_CODE = '" +rDivision+ "' AND A.SUBDIVISION_OFFICE_CODE = '" +rSubDivision+ "' ";
	rs6 = stmt6.executeQuery(query6);
	rs6.next();

	query7 = " SELECT COUNT(*) FROM RWS_ASSET_MAST_TBL A, RWS_ASSET_SCHEME_TBL S, RWS_PWS_PM_SC_PARAM_TBL H, RWS_ASSET_TYPE_TBL T WHERE A.ASSET_CODE = S.ASSET_CODE AND A.ASSET_CODE = H.ASSET_CODE AND  SUBSTR(S.SCHEME_CODE,17,3) LIKE '%6%' AND SUBSTR(A.HAB_CODE,1,2) = '" +rCircle+ "' AND SUBSTR(A.HAB_CODE,6,2) = '" +rMandal+ "' AND A.TYPE_OF_ASSET_CODE = T.TYPE_OF_ASSET_CODE AND T.TYPE_OF_ASSET_NAME='PWS' AND A.TYPE_OF_ASSET_CODE='" +rAssetType+ "' AND SUBSTR(H.PM_CODE,1,2) = '" +rCircle+ "' AND SUBSTR(H.PM_CODE,6,2) = '" +rMandal+ "' AND A.CIRCLE_OFFICE_CODE = '" +rCircle+ "' AND A.DIVISION_OFFICE_CODE = '" +rDivision+ "' AND A.SUBDIVISION_OFFICE_CODE = '" +rSubDivision+ "' ";
	rs7 = stmt7.executeQuery(query7);
	rs7.next();

	query8 = " SELECT COUNT(*) COUNT FROM RWS_ASSET_MAST_TBL A, RWS_ASSET_SCHEME_TBL S, RWS_PWS_PUMPHOUSE_PARAM_TBL H, RWS_ASSET_TYPE_TBL T WHERE A.ASSET_CODE = S.ASSET_CODE AND A.ASSET_CODE = H.ASSET_CODE AND  SUBSTR(S.SCHEME_CODE,17,3) LIKE '%6%' AND SUBSTR(A.HAB_CODE,1,2) = '" +rCircle+ "' AND SUBSTR(A.HAB_CODE,6,2) = '" +rMandal+ "' AND A.TYPE_OF_ASSET_CODE = T.TYPE_OF_ASSET_CODE AND T.TYPE_OF_ASSET_NAME='PWS' AND A.TYPE_OF_ASSET_CODE='" +rAssetType+ "' AND SUBSTR(H.PUMPHOUSE_CODE,1,2) = '" +rCircle+ "' AND SUBSTR(H.PUMPHOUSE_CODE,6,2) = '" +rMandal+ "' AND A.CIRCLE_OFFICE_CODE = '" +rCircle+ "' AND A.DIVISION_OFFICE_CODE = '" +rDivision+ "' AND A.SUBDIVISION_OFFICE_CODE = '" +rSubDivision+ "' ";	
...
<%
		...
		{
		//System.out.println("HERE BORE WELL CIRDIVSDIVMAND");
%>
...
%>
		<td class=rptValue><a href="./rws_asset_cirdivsdivmand_borewell_rpt.jsp">BORE WELL</td>
<%
		}
%>
...
<%		
		...
		{
%>
		<td class=rptValue><a href="./rws_asset_cirdivsdivmand_distri_rpt.jsp">DISTRIBUTION</td>
<%
		}
%>
		<td class=rptValue><%=rs1.getString(1)%></td>
...
<%		
		...
		{
%>
		<td class=rptValue><a href="./rws_asset_cirdivsdivmand_ohsr_rpt.jsp">OHSR</td>
<%
		}
%>
...
<%
		...
		{
%>		
			<td class=rptValue><a href="./rws_asset_cirdivsdivmand_pumphouse_rpt.jsp">PUMP HOUSE</td>
<%
		}
%>
...
<%		
		...
		{
%>
		<td class=rptValue><a href="./rws_asset_cirdivsdivmand_standposts_rpt.jsp">STAND POSTS</td>
<%
		}
%>
...
<%		
		...
		{
%>
		<td class=rptValue><a href="./rws_asset_cirdivsdivmand_cis_rpt.jsp">CISTERNS</td>
<%
		}
%>
...
<%		
		...
		{
%>
		<td class=rptValue><a href="./rws_asset_cirdivsdivmand_capac_rpt.jsp">CAPACITORS</td>
<%
		}
%>
...
<%		
		...
		{
%>
		<td class=rptValue><a href="./rws_asset_cirdivsdivmand_pumpingmain_rpt.jsp">PUMPING MAIN</td>
<%
		}
%>
...
<%		
		...
		{
%>
		<td class=rptValue><a href="./rws_asset_cirdivsdivmand_glsr_rpt.jsp">GLSR</td>
<%
		}
%>
