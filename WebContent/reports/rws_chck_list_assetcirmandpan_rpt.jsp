...
{
	//System.out.println("ASSET TYPE & CIRCLE & MANDAL & PANCHAYAT SELECTED...");
...
try
{
	...
	query2 = " SELECT COUNT(*) FROM RWS_ASSET_MAST_TBL A, RWS_ASSET_SCHEME_TBL S, RWS_PWS_OHSR_SC_PARAM_TBL H, RWS_ASSET_TYPE_TBL T WHERE A.ASSET_CODE = S.ASSET_CODE AND A.ASSET_CODE = H.ASSET_CODE AND  SUBSTR(S.SCHEME_CODE,17,3) LIKE '%6%' AND SUBSTR(A.HAB_CODE,1,2) = '" +rCircle+ "' AND SUBSTR(A.HAB_CODE,6,2) = '" +rMandal+ "' AND SUBSTR(A.HAB_CODE,13,2) = '" +rPanchayat+ "' AND A.TYPE_OF_ASSET_CODE=T.TYPE_OF_ASSET_CODE AND T.TYPE_OF_ASSET_NAME='PWS' AND A.TYPE_OF_ASSET_CODE='" +rAssetType+ "' AND SUBSTR(H.OHSR_CODE,1,2) = '" +rCircle+ "' AND SUBSTR(H.OHSR_CODE,6,2) = '" +rMandal+ "' AND SUBSTR(H.OHSR_CODE,13,2) = '" +rPanchayat+ "' ";	
	rs2 = stmt2.executeQuery(query2);
	rs2.next();

	query3 = " SELECT COUNT(*) FROM RWS_ASSET_MAST_TBL A, RWS_ASSET_SCHEME_TBL S, RWS_PWS_SP_HC_PC_SC_PARAM_TBL H, RWS_ASSET_TYPE_TBL T WHERE A.ASSET_CODE = S.ASSET_CODE AND A.ASSET_CODE = H.ASSET_CODE AND  SUBSTR(S.SCHEME_CODE,17,3) LIKE '%6%' AND SUBSTR(A.HAB_CODE,1,2) = '" +rCircle+ "' AND SUBSTR(A.HAB_CODE,6,2) = '" +rMandal+ "' AND SUBSTR(A.HAB_CODE,13,2) = '" +rPanchayat+ "' AND A.TYPE_OF_ASSET_CODE=T.TYPE_OF_ASSET_CODE AND T.TYPE_OF_ASSET_NAME='PWS' AND A.TYPE_OF_ASSET_CODE='" +rAssetType+ "' AND SUBSTR(H.SPHCPCSC_CODE,1,2) = '" +rCircle+ "' AND SUBSTR(H.SPHCPCSC_CODE,6,2) = '" +rMandal+ "'  AND SUBSTR(H.SPHCPCSC_CODE,13,2) = '" +rPanchayat+ "' ";
	rs3 = stmt3.executeQuery(query3);
	rs3.next();

	query4 = " SELECT COUNT(*) FROM RWS_ASSET_MAST_TBL A, RWS_ASSET_SCHEME_TBL S, RWS_PWS_CIS_SC_PARAM_TBL H, RWS_ASSET_TYPE_TBL T WHERE A.ASSET_CODE = S.ASSET_CODE AND A.ASSET_CODE = H.ASSET_CODE AND  SUBSTR(S.SCHEME_CODE,17,3) LIKE '%6%' AND SUBSTR(A.HAB_CODE,1,2) = '" +rCircle+ "' AND SUBSTR(A.HAB_CODE,6,2) = '" +rMandal+ "' AND SUBSTR(A.HAB_CODE,13,2) = '" +rPanchayat+ "' AND A.TYPE_OF_ASSET_CODE=T.TYPE_OF_ASSET_CODE AND T.TYPE_OF_ASSET_NAME='PWS' AND A.TYPE_OF_ASSET_CODE='" +rAssetType+ "' AND SUBSTR(H.CISSC_CODE,1,2) = '" +rCircle+ "' AND SUBSTR(H.CISSC_CODE,6,2) = '" +rMandal+ "' AND SUBSTR(H.CISSC_CODE,13,2) = '" +rPanchayat+ "' ";	
	rs4 = stmt4.executeQuery(query4);
	rs4.next();

	query5 = " SELECT COUNT(*) FROM RWS_ASSET_MAST_TBL A, RWS_ASSET_SCHEME_TBL S, RWS_PWS_CP_SC_PARAM_TBL H, RWS_ASSET_TYPE_TBL T WHERE A.ASSET_CODE = S.ASSET_CODE AND A.ASSET_CODE = H.ASSET_CODE AND  SUBSTR(S.SCHEME_CODE,17,3) LIKE '%6%' AND SUBSTR(A.HAB_CODE,1,2) = '" +rCircle+ "' AND SUBSTR(A.HAB_CODE,6,2) = '" +rMandal+ "' AND SUBSTR(A.HAB_CODE,13,2) = '" +rPanchayat+ "' AND A.TYPE_OF_ASSET_CODE=T.TYPE_OF_ASSET_CODE AND T.TYPE_OF_ASSET_NAME='PWS' AND A.TYPE_OF_ASSET_CODE='" +rAssetType+ "' AND SUBSTR(H.CPSC_CODE,1,2) = '" +rCircle+ "' AND SUBSTR(H.CPSC_CODE,6,2) = '" +rMandal+ "'  AND SUBSTR(H.CPSC_CODE,13,2) = '" +rPanchayat+ "' ";	
	rs5 = stmt5.executeQuery(query5);
	rs5.next();

	query6 = " SELECT COUNT(*) FROM RWS_ASSET_MAST_TBL A, RWS_ASSET_SCHEME_TBL S, RWS_PWS_GLSR_SC_PARAM_TBL H, RWS_ASSET_TYPE_TBL T WHERE A.ASSET_CODE = S.ASSET_CODE AND A.ASSET_CODE = H.ASSET_CODE AND  SUBSTR(S.SCHEME_CODE,17,3) LIKE '%6%' AND SUBSTR(A.HAB_CODE,1,2) = '" +rCircle+ "' AND SUBSTR(A.HAB_CODE,6,2) = '" +rMandal+ "' AND SUBSTR(A.HAB_CODE,13,2) = '" +rPanchayat+ "' AND A.TYPE_OF_ASSET_CODE=T.TYPE_OF_ASSET_CODE AND T.TYPE_OF_ASSET_NAME='PWS' AND A.TYPE_OF_ASSET_CODE='" +rAssetType+ "' AND SUBSTR(H.GLSR_CODE,1,2) = '" +rCircle+ "' AND SUBSTR(H.GLSR_CODE,6,2) = '" +rMandal+ "' AND SUBSTR(H.GLSR_CODE,13,2) = '" +rPanchayat+ "' ";	
	rs6 = stmt6.executeQuery(query6);
	rs6.next();

	query7 = " SELECT COUNT(*) FROM RWS_ASSET_MAST_TBL A, RWS_ASSET_SCHEME_TBL S, RWS_PWS_PM_SC_PARAM_TBL H, RWS_ASSET_TYPE_TBL T WHERE A.ASSET_CODE = S.ASSET_CODE AND A.ASSET_CODE = H.ASSET_CODE AND  SUBSTR(S.SCHEME_CODE,17,3) LIKE '%6%' AND SUBSTR(A.HAB_CODE,1,2) = '" +rCircle+ "' AND SUBSTR(A.HAB_CODE,6,2) = '" +rMandal+ "' AND SUBSTR(A.HAB_CODE,13,2) = '" +rPanchayat+ "' AND A.TYPE_OF_ASSET_CODE=T.TYPE_OF_ASSET_CODE AND T.TYPE_OF_ASSET_NAME='PWS' AND A.TYPE_OF_ASSET_CODE='" +rAssetType+ "' AND SUBSTR(H.PM_CODE,1,2) = '" +rCircle+ "' AND SUBSTR(H.PM_CODE,6,2) = '" +rMandal+ "'  AND SUBSTR(H.PM_CODE,13,2) = '" +rPanchayat+ "' ";
	rs7 = stmt7.executeQuery(query7);
	rs7.next();

	query8 = " SELECT COUNT(*) COUNT FROM RWS_ASSET_MAST_TBL A,RWS_ASSET_SCHEME_TBL S, RWS_PWS_PUMPHOUSE_PARAM_TBL H, RWS_ASSET_TYPE_TBL T WHERE A.ASSET_CODE = S.ASSET_CODE AND A.ASSET_CODE = H.ASSET_CODE AND A.TYPE_OF_ASSET_CODE = T.TYPE_OF_ASSET_CODE AND T.TYPE_OF_ASSET_NAME = 'PWS' AND A.TYPE_OF_ASSET_CODE='" +rAssetType+ "' AND SUBSTR(H.PUMPHOUSE_CODE,17,3) LIKE '%6%' AND SUBSTR(A.HAB_CODE,1,2) = '" +rCircle+ "' AND SUBSTR(A.HAB_CODE,6,2) = '" +rMandal+ "' AND SUBSTR(A.HAB_CODE,13,2) = '" +rPanchayat+ "' AND SUBSTR(H.PUMPHOUSE_CODE,1,2) = '" +rCircle+ "' AND SUBSTR(H.PUMPHOUSE_CODE,6,2) = '" +rMandal+ "' AND SUBSTR(H.PUMPHOUSE_CODE,13,2) = '" +rPanchayat+ "' " ;
...
%>
			<td class=rptValue><a href="./rws_asset_borewell_rpt.jsp?rAssetType=<%=rAssetType%>&rCircle=<%=rCircle%>&rMandal=<%=rMandal%>&rPanchayat=<%=rPanchayat%>" target=_new>BORE WELL</td>
<%			
		}
%>
...
<%		
		...
		{
%>
			<td class=rptValue><a href="./rws_asset_distric_rpt.jsp?rAssetType=<%=rAssetType%>&rCircle=<%=rCircle%>&rMandal=<%=rMandal%>&rPanchayat=<%=rPanchayat%>" target=_new>DISTRIBUTION</td>
<%
		}
%>
...
<%		}
		...
		{
%>
			<td class=rptValue><a href="./rws_asset_ohsr_rpt.jsp?rAssetType=<%=rAssetType%>&rCircle=<%=rCircle%>&rMandal=<%=rMandal%>&rPanchayat=<%=rPanchayat%>" target=_new>OHSR</td>
<%
		}
%>
...
%>		
			<td class=rptValue>
<a href="./rws_asset_pumphouse_rpt.jsp?rAssetType=<%=rAssetType%>&rCircle=<%=rCircle%>&rMandal=<%=rMandal%>&rPanchayat=<%=rPanchayat%>" target=_new>PUMP HOUSE</td>
<%
		}
%>
...
<%		
		...
		{
%>
			<td class=rptValue><a href="./rws_asset_standposts_rpt.jsp?rAssetType=<%=rAssetType%>&rCircle=<%=rCircle%>&rMandal=<%=rMandal%>&rPanchayat=<%=rPanchayat%>" target=_new>STAND POSTS</td>
<%
		}
%>
...
<%		}
		...
		{
%>
			<td class=rptValue><a href="./rws_asset_cis_rpt.jsp?rAssetType=<%=rAssetType%>&rCircle=<%=rCircle%>&rMandal=<%=rMandal%>&rPanchayat=<%=rPanchayat%>" target=_new>CISTERNS
			</td>
<%
		}
%>
...
<%		
		...
		{
%>
			<td class=rptValue><a href="./rws_asset_capac_rpt.jsp?rAssetType=<%=rAssetType%>&rCircle=<%=rCircle%>&rMandal=<%=rMandal%>&rPanchayat=<%=rPanchayat%>" target=_new>CAPACITORS</td>
<%
		}
%>
...
<%		
		...
		{
%>
			<td class=rptValue><a href="./rws_asset_pumpingmain_rpt.jsp?rAssetType=<%=rAssetType%>&rCircle=<%=rCircle%>&rMandal=<%=rMandal%>&rPanchayat=<%=rPanchayat%>" target=_new>PUMPING MAIN</td>
<%
		}
%>
...
<%		
		...
		{
%>
			<td class=rptValue><a href="./rws_asset_glsr_rpt.jsp?rAssetType=<%=rAssetType%>&rCircle=<%=rCircle%>&rMandal=<%=rMandal%>&rPanchayat=<%=rPanchayat%>" target=_new>GLSR</td>
<%
		}
%>
...
{
	//System.out.println("The Error is in check list assetcirmandpan form= " +e);
}
}
%>
