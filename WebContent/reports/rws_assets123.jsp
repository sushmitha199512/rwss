...
//out.println(qu);
	...
	%>      <TR>
        ...
        <td class=rptValue align=center><!-- <a href="./rws_comp_rpt.jsp?type=<%=rs1.getString(6)%>
...
<%
	...
	%>      <TR>
		<td class=rptValue align=center><%=++slno%></td>
        <td class=rptValue align=center><a href="./rws_wrk_progress1.jsp?work_id=<%=rs1.getString(1)%>&dcode=<%=dist%>&scheme=<%=rs1.getString(7)%>"><%=rs1.getString(2)%><%="-"+rs1.getString(1)%></a>
		</td>
		<td class=rptValue align=center><%=rs1.getString(3)%></td>
		<td class=rptValue align=center><%=rs1.getString(4)%></TD>
		<td class=rptValue align=center><%=rs1.getString(5)%></TD>
