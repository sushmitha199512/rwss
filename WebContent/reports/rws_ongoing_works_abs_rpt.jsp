...
int wrk_cnt=0;
 ...
 session.setAttribute("comp_Habs", comp_Habs);  	
		...
		<td class=<%=style %> style="text-align: left;"><a href="rws_ongoing_works_abs_drill_abs.jsp?drill=next&mode=divisions&district=<%=rs2.getString(5)%>&DistrictName=<%=dname%>&scheme=<%=scheme%>&program=<%=programe%>&startyr=<%=startyr%>&nextFinYear=<%=nextFinYear%>&endyr=<%=endyr%>"><%=dname %></a></td>
		<td class=<%=style %> style="text-align: right;"><a href="rws_ongoing_works_abs_drill4.jsp?&rDistrict=<%=rs2.getString(5)%>&rDistrictName=<%=dname%>&scheme=<%=scheme%>&programe=<%=programe%>&startyr=<%=startyr%>&nextFinYear=<%=nextFinYear%>&endyr=<%=endyr%>&prevyear=<%=prevyear%>"><%=wrk_cnt %></a></td>
		...
		<td class=<%=style %> style="text-align: right;"><a href="rws_ongoing_works_abs_drill6.jsp?&rDistrict=<%=rs2.getString(5)%>&rDistrictName=<%=dname%>&scheme=<%=scheme%>&programe=<%=programe%>&startyr=<%=startyr%>&nextFinYear=<%=nextFinYear%>&endyr=<%=endyr%>&prevyear=<%=prevyear%>"><%=phyfinWorks %></a></td>
