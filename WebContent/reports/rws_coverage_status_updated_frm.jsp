...
function fnDistSubmit()
	{ 
		document.f1.action="./rws_coverage_status_updated_dist_rpt.jsp";
		document.f1.submit();
...
<tr> 
	...
	/*
	select distinct  to_char(status_date,'dd-MON-yyyy') from rws_habitation_dir_his_tbl where to_char(status_date,'yyyy')< to_char(sysDate,'YYYY') and status_date is not null Union select distinct to_char(status_date,'dd-MON-yyyy') from rws_habitation_directory_tbl where status_date is not null*/
...
<tr>
	<td class = btext ><font color=navy><b>PC1</b> </font>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font color=navy><b>Min</b> </font>
				<SELECT name="pc1Min" id="combo" style="width:45px" class="mycombo" >
<%  for(int k=0;k<100;k++) {  %>
...
%>
	...
	<td class = btext ><font color=navy><b>Max</b> </font>
				<SELECT name="pc1Max" id="combo" style="width:45px" class="mycombo" >
<%  for(int k=0;k<100;k++) {  %>
...
<%
      int pc1Max=Integer.parseInt(request.getParameter("pc1Max")!=null?request.getParameter("pc1Max"):"0");

 %>
<tr>
	<td class = btext ><font color=navy><b>PC2</b> </font>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font color=navy><b>Min</b> </font>
				<SELECT name="pc2Min" id="combo" style="width:45px" class="mycombo" >
<%  for(int k=0;k<100;k++) {  
...
%>
	...
	<td class = btext ><font color=navy><b>Max</b> </font>
				<SELECT name="pc2Max" id="combo" style="width:45px" class="mycombo" >
<%  for(int k=0;k<100;k++) {  %>
...
<tr>
	<td class = btext ><font color=navy><b>PC3</b> </font>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font color=navy><b>Min</b> </font>
				<SELECT name="pc3Min" id="combo" style="width:45px" class="mycombo" >
<%  for(int k=0;k<100;k++) {  %>
...
%>
	...
	<td class = btext ><font color=navy><b>Max</b> </font>
				<SELECT name="pc3Max" id="combo" style="width:45px" class="mycombo" >
<%  for(int k=0;k<100;k++) {  %>
...
<tr>
	<td class = btext ><font color=navy><b>PC4</b> </font>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font color=navy><b>Min</b> </font>
				<SELECT name="pc4Min" id="combo" style="width:45px" class="mycombo" >
<%  for(int k=0;k<100;k++) {  %>
...
%>
	...
	<td class = btext ><font color=navy><b>Max</b> </font>
				<SELECT name="pc4Max" id="combo" style="width:45px" class="mycombo" >
<%  for(int k=0;k<100;k++) {  %>
...
<tr>
	<td class = btext ><font color=navy>FC </font>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font color=navy><b>Min</b> </font>
				<SELECT name="fcMin" id="combo" style="width:45px" class="mycombo" >
<%  for(int k=0;k<100;k++) {  %>
...
%>
	...
	<td class = btext ><font color=navy><b>Max</b> </font>
				<SELECT name="fcMax" id="combo" style="width:45px" class="mycombo" >
<%  for(int k=0;k<100;k++) {  %>
