...
<table width="100%" border=0 cellpadding=0 cellspacing=0 rules="none" align=center style="border-collapse:collapse" border color ="#000000">
	<tr>
		<% if(headname != null && !headname.equals("")) { %>
			<td	class=printFontHeading align=center>Head Office : <%= headname%></td>
		<% } %>
		<% if(circlename != null && !circlename.equals("")) {	%>
			<td	class=printFontHeading align=center>Circle Office : <%= circlename%></td>
		<% } %>
		<% if(divisionname != null && !divisionname.equals("")) {	%>
			<td	class=printFontHeading align=center>Division Office : <%= divisionname%></td>
		<% } %>
		<% if(subdivisionname != null && !subdivisionname.equals("")) { %>
			<td	class=printFontHeading align=center>Sub Division Office : <%= subdivisionname%></td>
		<%	} %>				
	</tr>
</table>
<%
...
<table bgcolor="#ffffff" bordercolor= "#000000" width="100%" border=1 style="border-collapse:collapse" align = center>
	<tr>
		<td align = center class = printFontHeading>Sl.No</font></td>
		<td align = center class = printFontHeading>Office</font></td>
		<td align = center class = printFontHeading colspan=5>Address</font></td>		
		<td align = center class = printFontHeading>Phone<br>Fax</td>
		<!-- <td align = center class = printFontHeading>Fax</td> -->
		<td align = center class = printFontHeading>E-Mail</td>
		<td align = center class = printFontHeading>Building</td>
		<td align = center class = printFontHeading>Office Head</td>
		<td align = center class = printFontHeading>Project</td>
	</tr>
<%
		try
		{
...
%>
	<tr>		
		<td align = center class = printFont><%=slno%></td>
<%		if(headcode!=null && circlecode.equals("00")){%>
		<td align = center class = printFont><%=headname%></td>
		<%}else if(circlecode!=null && divisioncode.equals("0")){%>
		<td align = center class = printFont><%=circlename%></td>
		<%}else if(divisioncode!=null && subdivisioncode.equals("0")){%>
		<td align = center class = printFont><%=divisionname%></td>
		<%}else{%>
		<td align = center class = printFont><%=subdivisionname%></td>
		<%}%>
		<td align = left class = printFont colspan=5><%=rs.getString(2)%><br><%=rs.getString(3)%><br><%=rs.getString(4)%><br><%=rs.getString(5)%><br><%=rs.getString(6)%></td>		
		<td align = center class = printFont><%=rs.getString(7)%><br><%=rs.getString(8)%></td>		
		<td align = center class = printFont><%=rs.getString(9)%></td>
		<td align = center class = printFont><%=rs.getString(10)%></td>
		<td align = center class = printFont><%=rs.getString(13)%></td>
		<td align = center class = printFont><%=rs.getString(12)%></td>		
	</tr>
...
<%
		...
		if(!subdivisioncode.equals("0")) 
		{
			//System.out.println("Fiveoooooooooooooooooooooooooooo");
%>
<table bgcolor="#ffffff" bordercolor= "#000000" width="100%" border=1 style="border-collapse:collapse" align = center>
	<tr>
		<td align = center class = printFontHeading>Sl.No</font></td>
...
<%
		try
		{
			...
			+ " substr(OFFICE_CODE,2,2)='" +circlecode + "' and "
			+ " substr(office_code,4,1)='" +divisioncode+ "' and "
			+ " substr(office_code,5,1)='" +subdivisioncode+ "' and " 
			+ " RWS_OFFICE_TBL.HEAD_OF_OFFICE=RWS_DESIGNATION_TBL.DESIGNATION_CODE");
			
		while(rs.next())
			{
			slno++;	
			//System.out.println("Coming Fourth00000000000000000000");
%>
	<tr>		
		<td align = center class = printFont><%=slno%></td>
<%		if(headcode!=null && circlecode.equals("00")){%>
