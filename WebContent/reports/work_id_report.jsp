...
//	String qry8 = "select hl.hab_code from rws_new_est_tbl est,rws_est_new_hab_lnk_tbl hl where est.work_id=hl.work_id and hl.work_id="+rs1.getString(1)+"";
	...
	%>
	  		<td class=rptValue colspan=1 align="center" title="Click to Get Habitation Details"><b><a href="work_id_report.jsp?hab=1&work_id=<%=rs1.getString(1)%>"><%=rs7.getString(1)%></a></b></td>	
	<%
	}
	else
	{
