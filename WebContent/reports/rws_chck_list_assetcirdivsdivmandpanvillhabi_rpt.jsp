...
{
	//System.out.println("ASSET TYPE & CIRCLE & DIVISION & SUB DIVISION & MANDAL & PANCHAYAT & VILLAGE & HABITATION SELECTED...");
...
<%
		...
		{
		//System.out.println("HERE BORE WELL CIRDIVSDIVMANDPANVILLAGEHABITATION");
%>
...
%>
		<td class=rptValue><a href="./rws_asset_cirdivsdivmandpanvillhab_borewell_rpt.jsp">BORE WELL</td>
<%
		}
%>
...
<%		
		...
		{
%>
		<td class=rptValue><a href="./rws_asset_cirdivsdivmandpanvillhab_distri_rpt.jsp">DISTRIBUTION</td>
<%
		}
%>
		<td class=rptValue><%=rs1.getString(1)%></td>
...
<%		
		...
		{
%>
		<td class=rptValue><a href="./rws_asset_cirdivsdivmandpanvillhab_ohsr_rpt.jsp">OHSR</td>
<%
		}
%>
...
<%
		...
		{
%>		
			<td class=rptValue><a href="./rws_asset_cirdivsdivmandpanvillhab_pumphouse_rpt.jsp">PUMP HOUSE</td>
<%
		}
%>
...
<%		
		...
		{
%>
		<td class=rptValue><a href="./rws_asset_cirdivsdivmandpanvillhab_standposts_rpt.jsp">STAND POSTS</td>
<%
		}
%>
...
<%		
		...
		{
%>
		<td class=rptValue><a href="./rws_asset_cirdivsdivmandpanvillhab_cis_rpt.jsp">CISTERNS</td>
<%
		}
%>
...
<%		
		...
		{
%>
		<td class=rptValue><a href="./rws_asset_cirdivsdivmandpanvillhab_capac_rpt.jsp">CAPACITORS</td>
<%
		}
%>
...
<%		
		...
		{
%>
		<td class=rptValue><a href="./rws_asset_cirdivsdivmandpanvillhab_pumpingmain_rpt.jsp">PUMPING MAIN</td>
<%
		}
%>
...
<%		
		...
		{
%>
		<td class=rptValue><a href="./rws_asset_cirdivsdivmandpanvillhab_glsr_rpt.jsp">GLSR</td>
<%
		}
%>
