...
//out.println("currentYear"+currentYear);
 ...
 //if(fdate.substring(7,11).equals(currentYear))
	//{
      ...
      if(!dCode.equals("00"))
 {
	  query = "SELECT distinct t1.plan_nonplan,normal_others,pr.programme_name "+q1+" from rws_district_tbl d,rws_programme_tbl pr,rws_mon_fin_phy_progress_tbl t1,rws_mon_progrees_ob_bal t3 where d.dcode=t1.dcode and pr.programme_code=t1.programme_code and t1.dcode=t3.dcode and t1.programme_code=t3.programme_code and t1.dcode='"+dCode+"' and t1.fin_year='"+fdate+"' and t1.month='"+month+"'";


 }
  else if(dCode.equals("00"))
 {
	  query = "SELECT distinct t1.plan_nonplan,normal_others, pr.programme_name "+q1+" from rws_district_tbl d,rws_programme_tbl pr,rws_mon_fin_phy_progress_tbl t1,rws_mon_progrees_ob_bal t3 where d.dcode=t1.dcode and pr.programme_code=t1.programme_code and t1.dcode=t3.dcode and t1.programme_code=t3.programme_code and t1.fin_year='"+fdate+"' and t1.month='"+month+"'";
   ...
   String a1=" order by t1.PLAN_NONPLAN DESC,t1.NORMAL_OTHERS ASC";
   //group by pr.programme_name
  query=query+a1;
...
//out.println("count isssssssssssssss"+Cnt);
	...
	<%@ include file="./rws_wrkmonth1.jsp"%>
<%}
catch(Exception e)
{
	e.printStackTrace();
