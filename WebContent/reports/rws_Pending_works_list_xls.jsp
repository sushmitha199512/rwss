...
response.setHeader("Content-Disposition", "inline; filename="
		+ "rws_Pending_works_list_xls.xls");
java.text.DateFormat dateFormat = new java.text.SimpleDateFormat("yyyy-MM-dd");
	...
	String wtype=(String)session.getAttribute("wtype");
    String work_name="";
...
<form name=f1 method="post">
	<p align="center">
	<font face=verdana size=2><b>Pending Works Monitoring Report </b></font><BR>
...
<table border = 1 cellspacing = 0 cellpadding = 0 height=5% width="100%" bordercolor=#000000 style="border-collapse:collapse" bgcolor="#ffffff" align = "center">
	<tr align=center  align=center>
		...
		<td colspan=1 class=btext align="center">Technical Sancation</td>
		...
		<td colspan=1 class=btext align="center">Programme Schedule</td>
		<td colspan=1 class=btext align="center">Work Expenditure</td>				
		<td colspan=6 class=btext align="center">Work Completion</td>		
	</tr>
	<tr>
			...
			<td colspan=1 class=btext align="center">Grounding Date</td>
