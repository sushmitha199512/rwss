	        ...
	        if(d==''){
		        ...
		        if(diffDays>31) {
            		alert("Only Porting  for One Month is Allowed");
				     ...
				     document.forms[0].action="switch.do?prefix=/reports&page=/draccessPorting.do?mode=get";
...
<body bgcolor="#edf2f8">
<html:form action="draccessPorting.do">
	<table border = 1 align=center cellspacing = 0 cellpadding = 0 rules="rows" width="32%"  bordercolor=navy style="border-collapse:collapse" bgcolor="#ffffff">
		...
		<tr bgcolor="#8A9FCD" align="center">
			<td align="center" class="textborder" colspan="2">
				<font color="#FFFFFF">Drouhgt ProjectShelf Porting</font>
			</td>	
		</tr>
		<tr> 
			<td valign="top"  align="center" height="25%" width="30%">
				<table  bordercolor="navy" width="100%" height="100%" border="1" rules="rows" style="border-collapse:collapse" align="center">
					<tr>
						...
						<td class=btext><input id="demo1" type="text" size="10" ><a href="javascript:NewCal('demo1','ddmmmyyyy')"><img src="./images/cal.gif" width="16" height="16" border="0" alt="Pick a date"></a></td></tr>
					<tr>
						<td class=rptLabel>To Date&nbsp;<font color="red">*</font></td>
						<td class=btext><input id="demo2" type="text" size="10"><a href="javascript:NewCal('demo2','ddmmmyyyy')"><img src="./images/cal.gif" width="16" height="16" border="0" alt="Pick a date"></a></td>
					</tr>
				</table>
			</td>
	 	</tr>
	...
	<table width="30%" align="center">
		<tr>
			...
			<td class=rptValue nowrap>1. Genrating PorjectShelf between dates - Update Date is considered.</td>
		</tr>
		<br>
		<tr>
