...
<%
	...
	if (type != null && type.equals("1")) {
		...
		chargeField = "DPRSTATUS='Completed/Approved'  and  DPRCOMPDATE  is not null and ";
		if (subType != null && subType.equals("1")) {
			field = "CATEGORY_CODE='2' ";
		}
		//  System.out.println("*****"+field);
...
<table border=1 cellspacing=0 cellpadding=0 width="100%"
	...
	<table border=0 rules=none style="border-collapse: collapse"
		align="right">
		<tr align="right">
			<td class="bwborder"><a href="javascript:onclick=history.go(-1)">Back</a>|<a
	...
	<tr bgcolor="#8A9FCD" align="center">
		<td align="center" class="rptHeading"></td>
		<td align="right" class="rptHeading" colspan=8>*** Rupees in
		Lakhs</td>
	</tr>
</table>
<table bgcolor="#FFFFFF" bordercolor="#8A9FCD" width="70%" border=1
	...
	<tr>
		<td align="center" class=btext>1</td>
		<td align="center" class=btext>2</td>
		<td align="center" class=btext>3</td>
		<td align="center" class=btext>4</td>
		<td align="center" class=btext>5</td>
		<td align="center" class=btext>6</td>
		<td align="center" class=btext>7</td>
		<td align="center" class=btext>8</td>
	</tr>
	<%
		try {
			int count = 1;
			...
			query = "select dname,division_office_name,a.WORK_ID,b.WORK_NAME ,b.SANCTION_AMOUNT,DPRSTATUS ,nvl(to_char(DPRCOMPDATE),'-')"
					+ partADate
					+ " from RWS_NOTGROUNDWORKS_STATUS_TBL a,rws_work_admn_tbl b,rws_district_tbl c,rws_division_office_tbl d,rws_programme_tbl p where "
					+ parta
					+ " "
					+ partcle
					+ " a.work_id=b.work_id and d.CIRCLE_OFFICE_CODE =c.DCODE  and substr(b.office_code,4,1)=d.DIVISION_OFFICE_CODE and "
					+ field
					+ " and "
					+ chargeField
					+ "  c.dcode=substr(b.office_code,2,2)  ";

			   if(scheme!=null && !scheme.equals("")){
				   query+=" and b.type_of_asset in("+scheme+")";
			}

			
			   query+= " and b.PROGRAMME_CODE =p.PROGRAMME_CODE and p.programme_code in ("+pname+") ";
			...
			query += "and substr(b.office_code,2,2)='" + dcode
					+ "' and  substr(b.office_code,4,1)='" + divcode + "' ";
