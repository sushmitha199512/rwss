...
int pc1Min=Integer.parseInt(request.getParameter("pc1Min"));
int pc1Max=Integer.parseInt(request.getParameter("pc1Max"));
int pc2Min=Integer.parseInt(request.getParameter("pc2Min"));
int pc2Max=Integer.parseInt(request.getParameter("pc2Max"));
int pc3Min=Integer.parseInt(request.getParameter("pc3Min"));
int pc3Max=Integer.parseInt(request.getParameter("pc3Max"));
int pc4Min=Integer.parseInt(request.getParameter("pc4Min"));
int pc4Max=Integer.parseInt(request.getParameter("pc4Max"));
int fcMin=Integer.parseInt(request.getParameter("fcMin"));
int fcMax=Integer.parseInt(request.getParameter("fcMax"));
