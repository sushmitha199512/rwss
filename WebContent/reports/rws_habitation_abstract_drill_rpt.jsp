...
try{
	if(coverageStatus.equals("FC") || coverageStatus.equals("PC4") || coverageStatus.equals("PC3") || coverageStatus.equals("PC2") || coverageStatus.equals("PC1")){
		...
		if(lpcdrange1.equals("55")){
			...
			query1="select distinct m.mname,p.pname,v.vname,h.panch_name,h.panch_code,hd.exist_water_level,hd.coverage_status,nvl(hd.CENSUS_PLAIN_POPU,'0'),nvl(hd.CENSUS_SC_POPU,'0'),nvl(hd.CENSUS_ST_POPU,'0'),nvl(safe_lpcd,0),nvl(unsafe_lpcd,0) from rws_district_tbl d,rws_mandal_tbl m,rws_panchayat_tbl p,rws_village_tbl v,rws_panchayat_raj_tbl h,"+habTableName+" hd where d.dcode=m.dcode and m.dcode=p.dcode and m.mcode =p.mcode and p.dcode=v.dcode and p.mcode=v.mcode and p.pcode=v.pcode and substr (h.panch_code,1,2) = v.dcode and substr(h.panch_code,6,2) = v.mcode and substr(h.panch_code,13,2) = v.pcode and substr (h.panch_code,8,3) = v.vcode and h.panch_code=hd.hab_code and hd.coverage_status is not null and hd.coverage_status not in('UI','NW')  and d.dcode='"+rDistrict+"' and hd.safe_lpcd>=55  ";
			if(poptype.equals("SC"))	
			{
				System.out.println("SC");
			query1+="  and (0.4)*(nvl(hd.CENSUS_PLAIN_POPU,'0')+nvl(hd.CENSUS_SC_POPU,'0')+nvl(hd.CENSUS_ST_POPU,'0')+nvl(hd.CENSUS_MINORITY_POPU,'0'))<= hd.CENSUS_SC_POPU and (0.4)*(nvl(hd.CENSUS_PLAIN_POPU,'0')+nvl(hd.CENSUS_SC_POPU,'0')+nvl(hd.CENSUS_ST_POPU,'0')+nvl(hd.CENSUS_MINORITY_POPU,'0'))> hd.CENSUS_ST_POPU ";
			}
			else if(poptype.equals("ST"))
			{
				query1+="  and (0.4)*(nvl(hd.CENSUS_PLAIN_POPU,'0')+nvl(hd.CENSUS_SC_POPU,'0')+nvl(hd.CENSUS_ST_POPU,'0')+nvl(hd.CENSUS_MINORITY_POPU,'0'))<= hd.CENSUS_ST_POPU ";
			}
			else if(poptype.equals("PLAIN"))
			{
				query1+="  AND (0.4)*(nvl(hd.CENSUS_PLAIN_POPU,'0')+nvl(hd.CENSUS_SC_POPU,'0')+nvl(hd.CENSUS_ST_POPU,'0')+nvl(hd.CENSUS_MINORITY_POPU,'0'))> hd.CENSUS_SC_POPU AND  (40/100)*(nvl(hd.CENSUS_PLAIN_POPU,'0')+nvl(hd.CENSUS_SC_POPU,'0')+nvl(hd.CENSUS_ST_POPU,'0')+nvl(hd.CENSUS_MINORITY_POPU,'0'))> hd.CENSUS_ST_POPU  ";
			}
			
	 System.out.println("55FC-anupama---------"+query1);
		}
		else{
			query1="select distinct m.mname,p.pname,v.vname,h.panch_name,h.panch_code,nvl(safe_lpcd,0),nvl(unsafe_lpcd,0),nvl(CENSUS_PLAIN_POPU,0),nvl(CENSUS_SC_POPU,0),nvl(CENSUS_ST_POPU,0),nvl(total_water_supply,0) from rws_district_tbl d,rws_mandal_tbl m,rws_panchayat_tbl p,rws_village_tbl v,rws_panchayat_raj_tbl h,"+habTableName+" hd where d.dcode=m.dcode and m.dcode=p.dcode and m.mcode =p.mcode and p.dcode=v.dcode and p.mcode=v.mcode and p.pcode=v.pcode and substr (h.panch_code,1,2) = v.dcode and substr(h.panch_code,6,2) = v.mcode and substr(h.panch_code,13,2) = v.pcode and substr (h.panch_code,8,3) = v.vcode and h.panch_code=hd.hab_code and hd.coverage_status is not null and hd.coverage_status not in('UI','NW')  and d.dcode='"+rDistrict+"' and hd.safe_lpcd>40  ";
			if(poptype.equals("SC"))
			{
				query1+=" and (0.4)*(nvl(hd.CENSUS_PLAIN_POPU,'0')+nvl(hd.CENSUS_SC_POPU,'0')+nvl(hd.CENSUS_ST_POPU,'0')+nvl(hd.CENSUS_MINORITY_POPU,'0'))<= hd.CENSUS_SC_POPU and (0.4)*(nvl(hd.CENSUS_PLAIN_POPU,'0')+nvl(hd.CENSUS_SC_POPU,'0')+nvl(hd.CENSUS_ST_POPU,'0')+nvl(hd.CENSUS_MINORITY_POPU,'0'))> hd.CENSUS_ST_POPU  ";
			}
		...
		if(lpcdrange1.equals("55")){
			query1="select distinct m.mname,p.pname,v.vname,h.panch_name,h.panch_code,hd.exist_water_level,hd.coverage_status,nvl(hd.CENSUS_PLAIN_POPU,'0'),nvl(hd.CENSUS_SC_POPU,'0'),nvl(hd.CENSUS_ST_POPU,'0'),nvl(safe_lpcd,0),nvl(unsafe_lpcd,0) from rws_district_tbl d,rws_mandal_tbl m,rws_panchayat_tbl p,rws_village_tbl v,rws_panchayat_raj_tbl h,"+habTableName+" hd where d.dcode=m.dcode and m.dcode=p.dcode and m.mcode =p.mcode and p.dcode=v.dcode and p.mcode=v.mcode and p.pcode=v.pcode and substr (h.panch_code,1,2) = v.dcode and substr(h.panch_code,6,2) = v.mcode and substr(h.panch_code,13,2) = v.pcode and substr (h.panch_code,8,3) = v.vcode and h.panch_code=hd.hab_code and hd.coverage_status is not null and hd.coverage_status not in('UI','NW')  and d.dcode='"+rDistrict+"' and hd.safe_lpcd>=41.25 and hd.safe_lpcd<55";
			...
			else if(poptype.equals("PLAIN"))
			{
			 ...
			 System.out.println("55PC4----------"+query1);
					...
					query1="select distinct m.mname,p.pname,v.vname,h.panch_name,h.panch_code,nvl(safe_lpcd,0),nvl(unsafe_lpcd,0),nvl(CENSUS_PLAIN_POPU,0),nvl(CENSUS_SC_POPU,0),nvl(CENSUS_ST_POPU,0),nvl(total_water_supply,0) from rws_district_tbl d,rws_mandal_tbl m,rws_panchayat_tbl p,rws_village_tbl v,rws_panchayat_raj_tbl h,"+habTableName+" hd where d.dcode=m.dcode and m.dcode=p.dcode and m.mcode =p.mcode and p.dcode=v.dcode and p.mcode=v.mcode and p.pcode=v.pcode and substr (h.panch_code,1,2) = v.dcode and substr(h.panch_code,6,2) = v.mcode and substr(h.panch_code,13,2) = v.pcode and substr (h.panch_code,8,3) = v.vcode and h.panch_code=hd.hab_code and hd.coverage_status is not null and hd.coverage_status not in('UI','NW')  and d.dcode='"+rDistrict+"' and hd.safe_lpcd>30 and hd.safe_lpcd<=40";
					if(poptype.toString().equals("SC"))
					{
						query1+=" and (0.4)*(nvl(hd.CENSUS_PLAIN_POPU,'0')+nvl(hd.CENSUS_SC_POPU,'0')+nvl(hd.CENSUS_ST_POPU,'0')+nvl(hd.CENSUS_MINORITY_POPU,'0'))<= hd.CENSUS_SC_POPU and (0.4)*(nvl(hd.CENSUS_PLAIN_POPU,'0')+nvl(hd.CENSUS_SC_POPU,'0')+nvl(hd.CENSUS_ST_POPU,'0')+nvl(hd.CENSUS_MINORITY_POPU,'0'))> hd.CENSUS_ST_POPU  ";
					}
		...
		if(lpcdrange1.equals("55")){
			query1="select distinct m.mname,p.pname,v.vname,h.panch_name,h.panch_code,hd.exist_water_level,hd.coverage_status,nvl(hd.CENSUS_PLAIN_POPU,'0'),nvl(hd.CENSUS_SC_POPU,'0'),nvl(hd.CENSUS_ST_POPU,'0'),nvl(safe_lpcd,0),nvl(unsafe_lpcd,0) from rws_district_tbl d,rws_mandal_tbl m,rws_panchayat_tbl p,rws_village_tbl v,rws_panchayat_raj_tbl h,"+habTableName+" hd where d.dcode=m.dcode and m.dcode=p.dcode and m.mcode =p.mcode and p.dcode=v.dcode and p.mcode=v.mcode and p.pcode=v.pcode and substr (h.panch_code,1,2) = v.dcode and substr(h.panch_code,6,2) = v.mcode and substr(h.panch_code,13,2) = v.pcode and substr (h.panch_code,8,3) = v.vcode and h.panch_code=hd.hab_code and hd.coverage_status is not null and hd.coverage_status not in('UI','NW')  and d.dcode='"+rDistrict+"' and hd.safe_lpcd>=27.5 and hd.safe_lpcd<41.25";
			if(poptype.toString().equals("SC"))
			{
				query1+=" and (0.4)*(nvl(hd.CENSUS_PLAIN_POPU,'0')+nvl(hd.CENSUS_SC_POPU,'0')+nvl(hd.CENSUS_ST_POPU,'0')+nvl(hd.CENSUS_MINORITY_POPU,'0'))<= hd.CENSUS_SC_POPU and (0.4)*(nvl(hd.CENSUS_PLAIN_POPU,'0')+nvl(hd.CENSUS_SC_POPU,'0')+nvl(hd.CENSUS_ST_POPU,'0')+nvl(hd.CENSUS_MINORITY_POPU,'0'))> hd.CENSUS_ST_POPU  ";
			}
			...
			else if(poptype.equals("PLAIN"))
			{
			 ...
			 System.out.println("55PC3----------"+query1);
					...
					query1="select distinct m.mname,p.pname,v.vname,h.panch_name,h.panch_code,nvl(safe_lpcd,0),nvl(unsafe_lpcd,0),nvl(CENSUS_PLAIN_POPU,0),nvl(CENSUS_SC_POPU,0),nvl(CENSUS_ST_POPU,0),nvl(total_water_supply,0) from rws_district_tbl d,rws_mandal_tbl m,rws_panchayat_tbl p,rws_village_tbl v,rws_panchayat_raj_tbl h,"+habTableName+" hd where d.dcode=m.dcode and m.dcode=p.dcode and m.mcode =p.mcode and p.dcode=v.dcode and p.mcode=v.mcode and p.pcode=v.pcode and substr (h.panch_code,1,2) = v.dcode and substr(h.panch_code,6,2) = v.mcode and substr(h.panch_code,13,2) = v.pcode and substr (h.panch_code,8,3) = v.vcode and h.panch_code=hd.hab_code and hd.coverage_status is not null and hd.coverage_status not in('UI','NW')  and d.dcode='"+rDistrict+"' and hd.safe_lpcd>20 and hd.safe_lpcd<=30";
					if(poptype.toString().equals("SC"))
					{
						query1+=" and (0.4)*(nvl(hd.CENSUS_PLAIN_POPU,'0')+nvl(hd.CENSUS_SC_POPU,'0')+nvl(hd.CENSUS_ST_POPU,'0')+nvl(hd.CENSUS_MINORITY_POPU,'0'))<= hd.CENSUS_SC_POPU and (0.4)*(nvl(hd.CENSUS_PLAIN_POPU,'0')+nvl(hd.CENSUS_SC_POPU,'0')+nvl(hd.CENSUS_ST_POPU,'0')+nvl(hd.CENSUS_MINORITY_POPU,'0'))> hd.CENSUS_ST_POPU  ";
					}
		...
		if(lpcdrange1.equals("55")){
			query1="select distinct m.mname,p.pname,v.vname,h.panch_name,h.panch_code,hd.exist_water_level,hd.coverage_status,nvl(hd.CENSUS_PLAIN_POPU,'0'),nvl(hd.CENSUS_SC_POPU,'0'),nvl(hd.CENSUS_ST_POPU,'0'),nvl(safe_lpcd,0),nvl(unsafe_lpcd,0) from rws_district_tbl d,rws_mandal_tbl m,rws_panchayat_tbl p,rws_village_tbl v,rws_panchayat_raj_tbl h,"+habTableName+" hd where d.dcode=m.dcode and m.dcode=p.dcode and m.mcode =p.mcode and p.dcode=v.dcode and p.mcode=v.mcode and p.pcode=v.pcode and substr (h.panch_code,1,2) = v.dcode and substr(h.panch_code,6,2) = v.mcode and substr(h.panch_code,13,2) = v.pcode and substr (h.panch_code,8,3) = v.vcode and h.panch_code=hd.hab_code and hd.coverage_status is not null and hd.coverage_status not in('UI','NW')  and d.dcode='"+rDistrict+"' and hd.safe_lpcd>=13.75 and hd.safe_lpcd<27.5";
			if(poptype.toString().equals("SC"))
			{
				query1+=" and (0.4)*(nvl(hd.CENSUS_PLAIN_POPU,'0')+nvl(hd.CENSUS_SC_POPU,'0')+nvl(hd.CENSUS_ST_POPU,'0')+nvl(hd.CENSUS_MINORITY_POPU,'0'))<= hd.CENSUS_SC_POPU and (0.4)*(nvl(hd.CENSUS_PLAIN_POPU,'0')+nvl(hd.CENSUS_SC_POPU,'0')+nvl(hd.CENSUS_ST_POPU,'0')+nvl(hd.CENSUS_MINORITY_POPU,'0'))> hd.CENSUS_ST_POPU  ";
			}
			...
			System.out.println("55PC3----------"+query1);
					...
					query1="select distinct m.mname,p.pname,v.vname,h.panch_name,h.panch_code,nvl(safe_lpcd,0),nvl(unsafe_lpcd,0),nvl(CENSUS_PLAIN_POPU,0),nvl(CENSUS_SC_POPU,0),nvl(CENSUS_ST_POPU,0),nvl(total_water_supply,0) from rws_district_tbl d,rws_mandal_tbl m,rws_panchayat_tbl p,rws_village_tbl v,rws_panchayat_raj_tbl h,"+habTableName+" hd where d.dcode=m.dcode and m.dcode=p.dcode and m.mcode =p.mcode and p.dcode=v.dcode and p.mcode=v.mcode and p.pcode=v.pcode and substr (h.panch_code,1,2) = v.dcode and substr(h.panch_code,6,2) = v.mcode and substr(h.panch_code,13,2) = v.pcode and substr (h.panch_code,8,3) = v.vcode and h.panch_code=hd.hab_code and hd.coverage_status is not null and hd.coverage_status not in('UI','NW')  and d.dcode='"+rDistrict+"' and hd.safe_lpcd>10 and hd.safe_lpcd<=20 ";
		...
		if(lpcdrange1.equals("55")){
			query1="select distinct m.mname,p.pname,v.vname,h.panch_name,h.panch_code,hd.exist_water_level,hd.coverage_status,nvl(hd.CENSUS_PLAIN_POPU,'0'),nvl(hd.CENSUS_SC_POPU,'0'),nvl(hd.CENSUS_ST_POPU,'0'),nvl(safe_lpcd,0),nvl(unsafe_lpcd,0) from rws_district_tbl d,rws_mandal_tbl m,rws_panchayat_tbl p,rws_village_tbl v,rws_panchayat_raj_tbl h,"+habTableName+" hd where d.dcode=m.dcode and m.dcode=p.dcode and m.mcode =p.mcode and p.dcode=v.dcode and p.mcode=v.mcode and p.pcode=v.pcode and substr (h.panch_code,1,2) = v.dcode and substr(h.panch_code,6,2) = v.mcode and substr(h.panch_code,13,2) = v.pcode and substr (h.panch_code,8,3) = v.vcode and h.panch_code=hd.hab_code and hd.coverage_status is not null and hd.coverage_status not in('UI','NW')  and d.dcode='"+rDistrict+"' and hd.safe_lpcd>0 and hd.safe_lpcd<13.75";
			if(poptype.toString().equals("SC"))
			{
				query1+=" and (0.4)*(nvl(hd.CENSUS_PLAIN_POPU,'0')+nvl(hd.CENSUS_SC_POPU,'0')+nvl(hd.CENSUS_ST_POPU,'0')+nvl(hd.CENSUS_MINORITY_POPU,'0'))<= hd.CENSUS_SC_POPU and (0.4)*(nvl(hd.CENSUS_PLAIN_POPU,'0')+nvl(hd.CENSUS_SC_POPU,'0')+nvl(hd.CENSUS_ST_POPU,'0')+nvl(hd.CENSUS_MINORITY_POPU,'0'))> hd.CENSUS_ST_POPU  ";
			}
			...
			else if(poptype.equals("PLAIN"))
			{
			 ...
			 System.out.println("55PC3----------"+query1);
					...
					query1="select distinct m.mname,p.pname,v.vname,h.panch_name,h.panch_code,nvl(safe_lpcd,0),nvl(unsafe_lpcd,0),nvl(CENSUS_PLAIN_POPU,0),nvl(CENSUS_SC_POPU,0),nvl(CENSUS_ST_POPU,0),nvl(total_water_supply,0) from rws_district_tbl d,rws_mandal_tbl m,rws_panchayat_tbl p,rws_village_tbl v,rws_panchayat_raj_tbl h,"+habTableName+" hd where d.dcode=m.dcode and m.dcode=p.dcode and m.mcode =p.mcode and p.dcode=v.dcode and p.mcode=v.mcode and p.pcode=v.pcode and substr (h.panch_code,1,2) = v.dcode and substr(h.panch_code,6,2) = v.mcode and substr(h.panch_code,13,2) = v.pcode and substr (h.panch_code,8,3) = v.vcode and h.panch_code=hd.hab_code and hd.coverage_status is not null and hd.coverage_status not in('UI','NW')  and d.dcode='"+rDistrict+"' and hd.safe_lpcd>0 and hd.safe_lpcd<=10";
					if(poptype.toString().equals("SC"))
					{
						query1+=" and (0.4)*(nvl(hd.CENSUS_PLAIN_POPU,'0')+nvl(hd.CENSUS_SC_POPU,'0')+nvl(hd.CENSUS_ST_POPU,'0')+nvl(hd.CENSUS_MINORITY_POPU,'0'))<= hd.CENSUS_SC_POPU and (0.4)*(nvl(hd.CENSUS_PLAIN_POPU,'0')+nvl(hd.CENSUS_SC_POPU,'0')+nvl(hd.CENSUS_ST_POPU,'0')+nvl(hd.CENSUS_MINORITY_POPU,'0'))> hd.CENSUS_ST_POPU  ";
					}
