  ...
  <tr>
   <td  bgcolor="#8A9FCD">
	...
	<tr>
		...
		<td  class="textborder">
		<bean:message key="app.zone" /><font color="#FF6666">*</font>
		</td>
		<td  class="textborder">
...
<fieldset>
	...
	<html:submit property="mode" title="Update the Fields" styleClass="btext" value="Update" onclick="showAge();verifyDoA();verifyDoj();return validateEmpForm(empForm);"/>
	<html:reset title="Clear all the Fields" styleClass="btext" value="Reset" />
	<html:button property="View" title="View the Fields"  styleClass="btext" value="View" onclick="getViewDetails()" />
	</td>
	</tr>
