...
<td>
	...
	<tr>
		<td  class=mycborder >
		<FONT class=myfontclr><bean:message key="app.qualCode" /><font color="#FF6666">*</font></FONT>
		</td>
		<td  class=mycborder >
		<html:text property="qualCode" value="<%=(String)request.getAttribute(\"qcode\")%>" styleClass="mytext" maxlength="2" readonly="true" />
		</td>
		</tr>
		<tr>
		<td  class=mycborder >
		<FONT class=myfontclr><bean:message key="app.qualName" /><font color="#FF6666">*</font></FONT>
		</td>
		<td  class=mycborder >
		<html:text property="qualName" value="" styleClass="mytext" maxlength="10" onkeypress="return textOnly(evt);"/>
		</td>
		</tr>
		</table>
...
<tr>
	...
	<html:submit property="mode" title="Save the Fields" styleClass="btext" value="Save" onclick="return validateQualForm(qualForm)" /> 
