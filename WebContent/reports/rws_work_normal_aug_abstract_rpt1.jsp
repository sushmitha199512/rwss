...
<table border = 1 cellspacing = 0 cellpadding = 0 height=5% width="100%" bordercolor=#000000 style="border-collapse:collapse" bgcolor="#ffffff" align = "center">
	<caption>
		<table  border=0 rules=none style="border-collapse:collapse" align = "right">			
			<tr align="right">
				...
				<td class="bwborder"><a href="./rws_work_normal_aug_abstract_excel.jsp" target=_new">Excel|</a></td>
	...
	//System.out.println("First Drill");
	   ...
	   %>
	   	...
	   	<%@ include file="./rws_work_normal_aug_abstract_label.jsp"%>
	   	<%String qry1=null;
		...
		String view1="Create or Replace view spillworks?  as SELECT work_id,office_code,no_of_habs FROM RWS_WORK_ADMN_TBL W where w.plan_code ='1' and w.category_code='2' and w.aug_new_code='2'  and w.ADMIN_DATE < ? and w.work_id not in (select work_id from rws_work_completion_tbl where (DATE_OF_COMPLETION >= ? or DATE_OF_COMPLETION is null))";
		String view2="Create or Replace view newworks?   as SELECT work_id,office_code,no_of_habs FROM RWS_WORK_ADMN_TBL W where w.plan_code ='1' and w.category_code='2' and w.aug_new_code='2'  and w.ADMIN_DATE >= ?";
...
PreparedStatement ps2=conn.prepareStatement(view2);
		...
		<td class=rptValue title=Click><b><a href="rws_work_normal_aug_abstract_rpt1.jsp?district=<%=rs1.getString(1)%>&drill=1&distname=<%=rs1.getString(2)%>"><%=rs1.getString(2)%></a></td>
      ...
      if(rs44!=null){rs44.close();}
       if(stmt44!=null){stmt44.close();}
         ...
         // ArrayList progs=worksData.getAdminPrograms(reque,fb.getWorkId());
          ...
          String work="";
            ...
            //qry52="SELECT work_id,office_code FROM RWS_WORK_ADMN_TBL W where w.plan_code ='1' and w.category_code='2' and w.aug_new_code='2'  and w.ADMIN_DATE < '"+fixYear+"' and SUBSTR (w.work_id,5,2)='"+rDistrict+"' and w.work_id not in (select work_id from rws_work_completion_tbl where (DATE_OF_COMPLETION >= '"+fixYear+"' or DATE_OF_COMPLETION is null)) union SELECT work_id,office_code FROM RWS_WORK_ADMN_TBL W where w.plan_code ='1' and w.category_code='2' and w.aug_new_code='2'  and w.ADMIN_DATE >= '"+fixYear+"' and SUBSTR (w.work_id,5,2)='"+rDistrict+"' ";
       ...
       if(stmt8!=null){stmt8.close();}
         ...
         String qry9=null;Statement stmt9=null;
			...
			qry9 = "select sum(case when date_of_completion<'"+fixYear+"' then 1 else 0 end),sum(case when date_of_completion>='"+fixYear+"' then 1 else 0 end) from rws_work_completion_tbl wc, rws_work_admn_tbl w where w.work_id=wc.work_id and SUBSTR (w.work_id,5,2)='"+rs1.getString(1)+"' and w.plan_code ='1' and w.category_code='2' and w.aug_new_code='2'  ";
       ...
       String qry4=null;
			...
			qry4 = "select (select sum(w.no_of_habs) from rws_work_completion_tbl wc, rws_work_admn_tbl w where w.work_id=wc.work_id and SUBSTR (w.work_id,5,2)='"+rs1.getString(1)+"' and date_of_completion<'"+fixYear+"' and w.plan_code ='1' and w.category_code='2' and w.aug_new_code='2'  )as a, (select sum(w.no_of_habs) from rws_work_completion_tbl wc, rws_work_admn_tbl w where w.work_id=wc.work_id and SUBSTR (w.work_id,5,2)='"+rs1.getString(1)+"'  and date_of_completion>='"+fixYear+"' and w.plan_code ='1' and w.category_code='2' and w.aug_new_code='2'  )as b from dual";
       ...
       if(stmt4!=null){stmt4.close();}
        ...
        String qry10=null; Statement stmt10=null;
           ...
           // qry10="Select count(e.hab_code) from RWS_WORK_COMP_HAB_LNK_TBL e where e.work_id in (select work_id from spillworks"+session.getId().substring(1,10)+" where substr(work_id,5,2)='"+rs1.getString(1)+"' union select work_id from newworks"+session.getId().substring(1,10)+" where substr(work_id,5,2)='"+rs1.getString(1)+"')";
            ...
            qry10="select (Select count(e.hab_code) from RWS_WORK_COMP_HAB_LNK_TBL e where e.work_id in (select w.work_id from rws_work_completion_tbl wc, rws_work_admn_tbl w where w.work_id=wc.work_id and SUBSTR (w.work_id,5,2)='"+rs1.getString(1)+"' and date_of_completion<'"+fixYear+"' and w.plan_code ='1' and w.category_code='2' and w.aug_new_code='2'  ))a, (Select count (e.hab_code) from RWS_ADMN_HAB_LNK_TBL e where e.work_id in (select w.work_id from rws_work_completion_tbl wc, rws_work_admn_tbl w where w.work_id=wc.work_id and SUBSTR (w.work_id,5,2)='"+rs1.getString(1)+"' and date_of_completion>='"+fixYear+"' and w.plan_code ='1' and w.category_code='2' and w.aug_new_code='2'  ))b from dual";
...
<td class="btext" align="right"><%=ghabcovn1%></td>
	...
	//System.out.println("First Drill");
	   ...
	   %>
		...
		String view1="Create or Replace view spillworks?  as SELECT work_id,office_code,no_of_habs FROM RWS_WORK_ADMN_TBL W where w.plan_code ='1' and w.category_code='2' and w.aug_new_code='2'  and w.ADMIN_DATE < ? and SUBSTR (w.work_id,5,2)=? and w.work_id not in (select work_id from rws_work_completion_tbl where (DATE_OF_COMPLETION >= ? or DATE_OF_COMPLETION is null))";
		String view2="Create or Replace view newworks ? as SELECT work_id,office_code,no_of_habs FROM RWS_WORK_ADMN_TBL W where w.plan_code ='1' and w.category_code='2' and w.aug_new_code='2'  and w.ADMIN_DATE >= ? and SUBSTR (w.work_id,5,2)=? ";
		...
		<tr onmouseover="this.style.background='#E3E4FA'" onmouseout="this.style.background='WHITE'">
        <td class=rptValue><%=++slno%></td>
		<td class=rptValue title=Click><b><a href="rws_work_normal_aug_abstract_rpt1.jsp?district=<%=rDistrict%>&drill=2&distname=<%=districtName%>&division=<%=rs1.getString(1)%>&divname=<%=rs1.getString(2)%>"><%=rs1.getString(2)%></a></td>
...
<%
       ...
       if(stmt8!=null){stmt8.close();}
         ...
         String qry9=null;Statement stmt9=null;
            try
            {
				qry9 = "select sum(case when date_of_completion<'"+fixYear+"' then 1 else 0 end),sum(case when date_of_completion>='"+fixYear+"' then 1 else 0 end) from rws_work_completion_tbl wc, rws_work_admn_tbl w where w.work_id=wc.work_id and SUBSTR (w.work_id,5,2)='"+rDistrict+"' and SUBSTR(office_code,4,1)='"+rs1.getString(1)+"' and w.plan_code ='1' and w.category_code='2' and w.aug_new_code='2'  ";
       ...
       String qry4=null;
			...
			qry4 = "select (select sum(w.no_of_habs) from rws_work_completion_tbl wc, rws_work_admn_tbl w where w.work_id=wc.work_id and SUBSTR (w.work_id,5,2)='"+rDistrict+"' and SUBSTR (office_code,4,1) ='"+rs1.getString(1)+"' and date_of_completion<'"+fixYear+"' and w.plan_code ='1' and w.category_code='2' and w.aug_new_code='2'  )as a, (select sum(w.no_of_habs) from rws_work_completion_tbl wc, rws_work_admn_tbl w where w.work_id=wc.work_id and SUBSTR (w.work_id,5,2)='"+rDistrict+"' and SUBSTR (office_code,4,1) ='"+rs1.getString(1)+"' and date_of_completion>='"+fixYear+"' and w.plan_code ='1' and w.category_code='2' and w.aug_new_code='2'  )as b from dual";
       ...
       if(stmt4!=null){stmt4.close();}
        ...
        String qry10=null; Statement stmt10=null;
          ...
          //  qry10="Select count(e.hab_code) from RWS_WORK_COMP_HAB_LNK_TBL e where e.work_id in (select work_id from spillworks"+session.getId().substring(1,10)+" where SUBSTR(office_code,4,1)='"+rs1.getString(1)+"' union select work_id from newworks"+session.getId().substring(1,10)+" where SUBSTR(office_code,4,1)='"+rs1.getString(1)+"')";
            //System.out.println("qry10:"+qry10);
			qry10="select (Select count(e.hab_code) from RWS_WORK_COMP_HAB_LNK_TBL e where e.work_id in (select w.work_id from rws_work_completion_tbl wc, rws_work_admn_tbl w where w.work_id=wc.work_id and SUBSTR (w.work_id,5,2)='"+rDistrict+"' and SUBSTR (office_code,4,1) ='"+rs1.getString(1)+"' and date_of_completion<'"+fixYear+"' and w.plan_code ='1' and w.category_code='2' and w.aug_new_code='2'  ))a, (Select count (e.hab_code) from RWS_ADMN_HAB_LNK_TBL e where e.work_id in (select w.work_id from rws_work_completion_tbl wc, rws_work_admn_tbl w where w.work_id=wc.work_id and SUBSTR (w.work_id,5,2)='"+rDistrict+"' and SUBSTR (office_code,4,1) ='"+rs1.getString(1)+"' and date_of_completion>='"+fixYear+"' and w.plan_code ='1' and w.category_code='2' and w.aug_new_code='2'  ))b from dual";
			//System.out.println("qry10"+qry10);
            stmt10= conn.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE,ResultSet.CONCUR_UPDATABLE);
             rs10=stmt10.executeQuery(qry10);
            while(rs10.next())
...
<td class="btext" align="right"><%=ghabcovn1%></td>
       ...
       Statement stmtdv1=null,stmtdv2=null;
		...
		String dropqry1="drop VIEW spillworks?";
		String dropqry2="drop VIEW newworks?";
		PreparedStatement ps3=conn.prepareStatement(dropqry1);
		PreparedStatement ps4=conn.prepareStatement(dropqry2);
		        ps1.setString(1,session.getId().substring(1,10));
				ps2.setString(2,session.getId().substring(1,10));
		ps1.executeUpdate();
		ps2.executeUpdate();
		}
		catch(SQLException se)
	...
	//System.out.println("Second Drill");
	   ...
	   %>
		...
		stmt1 = conn.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE,ResultSet.CONCUR_UPDATABLE);
		rs1=stmt1.executeQuery(qry1);
		String view1="Create or Replace view spillworks? as SELECT work_id,office_code,no_of_habs FROM RWS_WORK_ADMN_TBL W where w.plan_code ='1' and w.category_code='2' and w.aug_new_code='2'  and w.ADMIN_DATE < ?  and SUBSTR (w.office_code,2,2)=? and SUBSTR(w.office_code,4,1)=? and w.work_id not in (select work_id from rws_work_completion_tbl where (DATE_OF_COMPLETION >= ? or DATE_OF_COMPLETION is null))";
		String view2="Create or Replace view newworks?  as SELECT work_id,office_code,no_of_habs FROM RWS_WORK_ADMN_TBL W where w.plan_code ='1' and w.category_code='2' and w.aug_new_code='2'  and w.ADMIN_DATE >= ? and SUBSTR (w.office_code,2,2)=? and SUBSTR(w.office_code,4,1)=?";
		Statement stmtv1= conn.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE,ResultSet.CONCUR_UPDATABLE);
	   	Statement stmtv2= conn.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE,ResultSet.CONCUR_UPDATABLE);
...
<%	
       ...
       if(stmt8!=null){stmt8.close();}
         ...
         String qry9=null;Statement stmt9=null;
            ...
            {
            //qry9="SELECT distinct SUM(CASE WHEN WC.work_id IS NOT NULL THEN 1 ELSE 0 END) FROM RWS_WORK_COMPLETION_TBL WC,RWS_WORK_ADMN_TBL W WHERE W.WORK_ID=WC.WORK_ID and wc.work_id in (select work_id from spillworks"+session.getId().substring(1,10)+" where SUBSTR(office_code,4,1)='"+divisionCode+"' and SUBSTR(office_code,5,2)='"+rs1.getString(1)+"' union select work_id from newworks"+session.getId().substring(1,10)+" where SUBSTR(office_code,4,1)='"+divisionCode+"' and SUBSTR(office_code,5,2)='"+rs1.getString(1)+"')";
          qry9 = "select sum(case when date_of_completion<'"+fixYear+"' then 1 else 0 end),sum(case when date_of_completion>='"+fixYear+"' then 1 else 0 end) from rws_work_completion_tbl wc, rws_work_admn_tbl w where w.work_id=wc.work_id and SUBSTR (w.work_id,5,2)='"+rDistrict+"' and SUBSTR(office_code,4,1)='"+divisionCode+"' and SUBSTR(office_code,5,2)='"+rs1.getString(1)+"' and w.plan_code ='1' and w.category_code='2' and w.aug_new_code='2'  ";
			 stmt9= conn.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE,ResultSet.CONCUR_UPDATABLE);
          // System.out.println("qry9"+qry9);   
             rs9=stmt9.executeQuery(qry9);
            while(rs9.next())
       ...
       String qry4=null;
			...
			//System.out.println("qry4"+qry4);
			qry4 = "select (select sum(w.no_of_habs) from rws_work_completion_tbl wc, rws_work_admn_tbl w where w.work_id=wc.work_id and SUBSTR (w.work_id,5,2)='"+rDistrict+"' and SUBSTR(office_code,4,1)='"+divisionCode+"' and SUBSTR(office_code,5,2)='"+rs1.getString(1)+"' and date_of_completion<'"+fixYear+"' and w.plan_code ='1' and w.category_code='2' and w.aug_new_code='2'  )as a, (select sum(w.no_of_habs) from rws_work_completion_tbl wc, rws_work_admn_tbl w where w.work_id=wc.work_id and SUBSTR (w.work_id,5,2)='"+rDistrict+"' and SUBSTR(office_code,4,1)='"+divisionCode+"' and SUBSTR(office_code,5,2)='"+rs1.getString(1)+"' and date_of_completion>='"+fixYear+"' and w.plan_code ='1' and w.category_code='2' and w.aug_new_code='2'  )as b from dual";
       ...
       if(stmt4!=null){stmt4.close();}
        ...
        String qry10=null; Statement stmt10=null;
           ...
           // System.out.println("qry10:"+qry10);
		   qry10="select (Select count(e.hab_code) from RWS_WORK_COMP_HAB_LNK_TBL e where e.work_id in (select w.work_id from rws_work_completion_tbl wc, rws_work_admn_tbl w where w.work_id=wc.work_id and SUBSTR (w.work_id,5,2)='"+rDistrict+"' and SUBSTR(office_code,4,1)='"+divisionCode+"' and SUBSTR(office_code,5,2)='"+rs1.getString(1)+"' and date_of_completion<'"+fixYear+"' and w.plan_code ='1' and w.category_code='2' and w.aug_new_code='2'  ))a, (Select count (e.hab_code) from RWS_ADMN_HAB_LNK_TBL e where e.work_id in (select w.work_id from rws_work_completion_tbl wc, rws_work_admn_tbl w where w.work_id=wc.work_id and SUBSTR (w.work_id,5,2)='"+rDistrict+"' and SUBSTR(office_code,4,1)='"+divisionCode+"' and SUBSTR(office_code,5,2)='"+rs1.getString(1)+"' and date_of_completion>='"+fixYear+"' and w.plan_code ='1' and w.category_code='2' and w.aug_new_code='2'  ))b from dual";
