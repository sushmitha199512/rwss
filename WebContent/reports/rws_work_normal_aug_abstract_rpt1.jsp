...
<table border = 1 cellspacing = 0 cellpadding = 0 height=5% width="100%" bordercolor=#000000 style="border-collapse:collapse" bgcolor="#ffffff" align = "center">
	...
	//System.out.println("First Drill");
	   ...
	   %>
		...
		String view1="Create or Replace view spillworks"+session.getId().substring(1,10)+" as SELECT work_id,office_code,no_of_habs FROM RWS_WORK_ADMN_TBL W where w.plan_code ='1' and w.category_code='2' and w.aug_new_code='2'  and w.ADMIN_DATE < '"+fixYear+"' and w.work_id not in (select work_id from rws_work_completion_tbl where (DATE_OF_COMPLETION >= '"+fixYear+"' or DATE_OF_COMPLETION is null))";
		String view2="Create or Replace view newworks"+session.getId().substring(1,10)+" as SELECT work_id,office_code,no_of_habs FROM RWS_WORK_ADMN_TBL W where w.plan_code ='1' and w.category_code='2' and w.aug_new_code='2'  and w.ADMIN_DATE >= '"+fixYear+"' ";
...
<td class="btext" align="right"><%=ghabcovn1%></td>
	...
	//System.out.println("First Drill");
	   ...
	   %>
		...
		String view1="Create or Replace view spillworks"+session.getId().substring(1,10)+" as SELECT work_id,office_code,no_of_habs FROM RWS_WORK_ADMN_TBL W where w.plan_code ='1' and w.category_code='2' and w.aug_new_code='2'  and w.ADMIN_DATE < '"+fixYear+"' and SUBSTR (w.work_id,5,2)='"+rDistrict+"' and w.work_id not in (select work_id from rws_work_completion_tbl where (DATE_OF_COMPLETION >= '"+fixYear+"' or DATE_OF_COMPLETION is null))";
		String view2="Create or Replace view newworks"+session.getId().substring(1,10)+" as SELECT work_id,office_code,no_of_habs FROM RWS_WORK_ADMN_TBL W where w.plan_code ='1' and w.category_code='2' and w.aug_new_code='2'  and w.ADMIN_DATE >= '"+fixYear+"' and SUBSTR (w.work_id,5,2)='"+rDistrict+"' ";
...
<td class="btext" align="right"><%=ghabcovn1%></td>
	...
	//System.out.println("Second Drill");
	   ...
	   %>
		...
		stmt1 = conn.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE,ResultSet.CONCUR_UPDATABLE);
		rs1=stmt1.executeQuery(qry1);
		String view1="Create or Replace view spillworks"+session.getId().substring(1,10)+" as SELECT work_id,office_code,no_of_habs FROM RWS_WORK_ADMN_TBL W where w.plan_code ='1' and w.category_code='2' and w.aug_new_code='2'  and w.ADMIN_DATE < '"+fixYear+"'  and SUBSTR (w.office_code,2,2)='"+rDistrict+"' and SUBSTR(w.office_code,4,1)='"+divisionCode+"' and w.work_id not in (select work_id from rws_work_completion_tbl where (DATE_OF_COMPLETION >= '"+fixYear+"' or DATE_OF_COMPLETION is null))";
		String view2="Create or Replace view newworks"+session.getId().substring(1,10)+" as SELECT work_id,office_code,no_of_habs FROM RWS_WORK_ADMN_TBL W where w.plan_code ='1' and w.category_code='2' and w.aug_new_code='2'  and w.ADMIN_DATE >= '"+fixYear+"' and SUBSTR (w.office_code,2,2)='"+rDistrict+"' and SUBSTR(w.office_code,4,1)='"+divisionCode+"'";
		Statement stmtv1= conn.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE,ResultSet.CONCUR_UPDATABLE);
	   	Statement stmtv2= conn.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE,ResultSet.CONCUR_UPDATABLE);
