...
{ %>
			<tr><td align="right" class="bwborder"><a href="/pred/home.jsp?loginMode=watersoft">Home</a>&nbsp;|&nbsp;</td>
				...
				<td class="bwborder"><a href="rws_works_exception_rpt_xls1.jsp" target="_new">Excel</a></td></tr>
<%  } else {%>
...
try
	{
        ...
        String mycolor="";
            ...
            qry15="    SELECT distinct substr(a.work_id,1,2),count(a. work_id) FROM RWS_WORK_ADMN_TBL a,rws_work_commencement_tbl c where a.work_id=c.work_id and work_cancel_dt is null   and sysdate - grounding_date>5*365 and substr(a.work_id,1,2) in ("+programe+") and substr(a.work_id,5,2)='"+rDistrict+"'  group by substr(a.work_id,1,2)";
           ...
           qry14="   SELECT distinct substr(a.work_id,1,2),count(a. work_id) FROM RWS_WORK_ADMN_TBL a,rws_work_commencement_tbl c where a.work_id=c.work_id and work_cancel_dt is null  and sysdate - grounding_date<5*365 and sysdate - grounding_date>4*365 and substr(a.work_id,1,2) in ("+programe+") and substr(a.work_id,5,2)='"+rDistrict+"'  group by substr(a.work_id,1,2)";
	        ...
	        qry13="  SELECT distinct substr(a.work_id,1,2),count(a. work_id) FROM RWS_WORK_ADMN_TBL a,rws_work_commencement_tbl c where a.work_id=c.work_id and work_cancel_dt is null   and sysdate - grounding_date<4*365 and sysdate - grounding_date>3*365 and substr(a.work_id,1,2) in ("+programe+") and substr(a.work_id,5,2)='"+rDistrict+"'  group by substr(a.work_id,1,2)";
	       ...
	       qry12="  SELECT distinct substr(a.work_id,1,2),count(a. work_id) FROM RWS_WORK_ADMN_TBL a,rws_work_commencement_tbl c where a.work_id=c.work_id and work_cancel_dt is null and sysdate - grounding_date<3*365 and sysdate - grounding_date>2*365 and substr(a.work_id,1,2) in ("+programe+") and substr(a.work_id,5,2)='"+rDistrict+"' group by substr(a.work_id,1,2)";
	       ...
	       qry11="  SELECT distinct substr(a.work_id,1,2),count(a. work_id) FROM RWS_WORK_ADMN_TBL a,rws_work_commencement_tbl c where a.work_id=c.work_id and work_cancel_dt is null  and sysdate - grounding_date<2*365 and sysdate - grounding_date>365 and substr(a.work_id,1,2) in ("+programe+") and substr(a.work_id,5,2)='"+rDistrict+"'  group by substr(a.work_id,1,2)";
	      ...
	      // System.out.println("qry11 "+qry11);
	       ...
	       qry10=" SELECT distinct substr(a.work_id,1,2),count(a. work_id) FROM RWS_WORK_ADMN_TBL a,rws_work_commencement_tbl c where a.work_id=c.work_id and work_cancel_dt is null  and sysdate - grounding_date>365 and substr(a.work_id,1,2) in ("+programe+") and substr(a.work_id,5,2)='"+rDistrict+"'  group by substr(a.work_id,1,2)";
	     ...
	     //  System.out.println("qry10 "+qry10);
	        ...
	        qry9=" SELECT distinct substr(a.work_id,1,2),count(a. work_id) FROM RWS_WORK_ADMN_TBL a,rws_work_commencement_tbl c where a.work_id=c.work_id and work_cancel_dt is null and sysdate - grounding_date<365 and sysdate - grounding_date>180 and substr(a.work_id,1,2) in ("+programe+") and substr(a.work_id,5,2)='"+rDistrict+"' group by substr(a.work_id,1,2)";
	     ...
	     //  System.out.println("qry9 "+qry9);
	        ...
	        qry8=" SELECT distinct substr(a.work_id,1,2),count(a. work_id) FROM RWS_WORK_ADMN_TBL a,rws_work_commencement_tbl c where a.work_id=c.work_id  and work_cancel_dt is null and sysdate - grounding_date<180 and sysdate - grounding_date>90 and substr(a.work_id,1,2) in ("+programe+") and substr(a.work_id,5,2)='"+rDistrict+"'  group by substr(a.work_id,1,2)";
        ...
        System.out.println("5.qry5 "+qry5);
	       while(rs5.next())
	       {
        ...
        qry4=" SELECT distinct substr(a.work_id,1,2),count(a.work_id) FROM RWS_WORK_ADMN_TBL a  where work_cancel_dt is null  and  a.work_id not in(select work_id from rws_new_est_tbl) and sysdate - admin_date>365 and  substr(a.work_id,1,2) in ("+programe+") and substr(a.work_id,5,2)='"+rDistrict+"' group by substr(a.work_id,1,2)";

		Hashtable h4=new Hashtable();
	    pst4=conn.createStatement();
	    rs4=pst4.executeQuery(qry4);
       System.out.println("4.qry4 "+qry4);
	       while(rs4.next())
	       {
      ...
      System.out.println("3.qry3 "+qry3);
        ...
        qry2=" SELECT substr(a.work_id,1,2),count(distinct a.work_id) FROM RWS_WORK_ADMN_TBL a where work_cancel_dt is null  and substr(a.work_id,1,2) in ("+programe+") and substr(a.work_id,5,2)='"+rDistrict+"' group by substr(a.work_id,1,2)";
    	Hashtable h2=new Hashtable();
	    pst2=conn.createStatement();
	    rs2=pst2.executeQuery(qry2);
       System.out.println("1.qry2 "+qry2);
	       while(rs2.next())
	       { 
	   ...
	   qry1=" SELECT distinct substr(a.work_id,1,2),count(a.work_id) FROM RWS_WORK_ADMN_TBL a  where work_cancel_dt is null  and  a.work_id not in(select work_id from rws_new_est_tbl) and sysdate - admin_date<180 and sysdate - admin_date>90  and  substr(a.work_id,1,2) in ("+programe+") and substr(a.work_id,5,2)='"+rDistrict+"' group by substr(a.work_id,1,2)";
        ...
        System.out.println("2.qry1 "+qry1);
	       while(rs1.next())
	       {
