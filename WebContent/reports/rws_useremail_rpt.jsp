...
<form>
   ...
   %>
<input type="hidden" property="token" styleClass="mytext" value="${sessionScope.csrfToken}" />
...
<tr bgcolor="#8A9FCD" align="center">
	<td align="center" class="gridhdbg " > <b>Offices Having Email Id / Not Having Email Id Report</b> </td>
</tr>
</table>
...
<%
String a1="";
a1=request.getParameter("abc");System.out.println("a1******"+a1);
//System.out.println("a1******"+a1);
if(a1.equals("7") || a1.equals("8")){ %>
<td class=gridhdbg   > <b> Special Priveleged Users   </b> </td>
...
<td class=<%=style %> style="text-align: left;"><%=nic.watersoft.commons.Mask_Userid.UserIdmaskString(rs3.getString(1)) %></td>


<%-- <td class=<%=style %> style="text-align: left"><%=rs3.getString(4) %></td> --%>
<td class=<%=style %> style="text-align: left"><%=nic.watersoft.commons.Mask_Userid.EmailmaskString(rs3.getString(4)) %></td>
