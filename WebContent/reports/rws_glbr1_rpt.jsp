...
<tr bgcolor="#8A9FCD" align="center">
		<td align="center" class="rptHeading" colspan="14"> RESERVOIRS-GLBR-REPORT</td>
</tr>
</table>
...
try
{
	    ...
	    if(typeassetcode.equals("03"))
	{
		...
		rs1=stmt1.executeQuery("select glbr_code,glbr_cap_lts,nvl(glbr_loc,'-'),glbr_lwl,glbr_mwl,glbr_fill_hr,glbr_empty_hr,staging,asset_code from RWS_CPWS_GLBR_SC_PARAM_TBL  where asset_code='"+assetcode+"'  ");
...
<%
			...
			
	{
		...
		stmt1=conn.createStatement();
		rs1=stmt1.executeQuery("select  glbr_code,glbr_cap_lts,nvl(glbr_loc,'-'),glbr_lwl,glbr_mwl,glbr_fill_hr,glbr_empty_hr,staging,asset_code  from RWS_PWS_GLBR_SC_PARAM_TBL  where asset_code='"+assetcode+"' ");
		while(rs1.next())
    	{
...
<%
			...
			
	{
		...
		stmt1=conn.createStatement();
		rs1=stmt1.executeQuery("select  glbr_code,glbr_cap_lts,nvl(glbr_loc,'-'),glbr_lwl,glbr_mwl,glbr_fill_hr,glbr_empty_hr,staging,asset_code  from RWS_MPWS_GLBR_SC_PARAM_TBL  where asset_code='"+assetcode+"'");
		while(rs1.next())
    	{
