...
if(district.equals("00")  && (mandal.equals("00") || mandal.equals("-1")))
 ...
 {
	query1 = "CREATE TABLE TEMP_ASSET_HAB_TBL AS select am.asset_code,am.hab_code from asset_mast1 am, asset_hab1 ah where substr(am.hab_code,1,2)='"+district +"' and am.division_office_code='"+ mandal +"' and am.subdivision_office_code = '" + panchayat + "' AND (am.hab_code = ah.hab_code (+) and am.asset_code  =  ah.asset_code (+)) ";
 }
