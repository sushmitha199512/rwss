...
%>
	...
	<td class="bwborder"><a href="/pred/home.jsp?loginMode=watersoft">Home | </a><a href="./rws_hpgis_xls_rpt.jsp" target=_new>Excel</a></td>
	</tr>  
	</table>
	</caption>
