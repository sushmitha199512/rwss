...
{       
	...
	if(document.f1.FDate.selectedIndex=="")
	{
        ...
        document.f1.action="./rws_work_plan_graph.jsp";
		document.f1.submit();
}
	...
	<table  border=0 rules=none style="border-collapse:collapse" width=100% align = "right" bgcolor="#edf2f8">
		...
		<tr bgcolor="#8A9FCD" align="center">
			<td align="center" class="textborder" colspan="2">
                ...
                <font color="#FFFFFF">Works in Progress Plan/Non Plan Graph</font>
			</td>	
		</tr>
...
<%			
	...
	<tr>
			<td class = btext nowrap >
				<font color=navy><b>Admin Sanction Year</b> </font>
				<font color=red><b>*</b> </font>
			</td>
			<td class = btext >
	...
	rs5=st5.executeQuery("select distinct to_char(admin_date,'yyyy') from rws_work_admn_tbl where to_char(admin_date,'yyyy')>='2007' and admin_date is not null and to_char(admin_date,'yyyy')<=to_char(sysdate,'yyyy') order by to_char(admin_date,'yyyy') desc"); 
