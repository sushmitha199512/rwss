...
<!-- end of ajax code -->
	...
	function getParameters(that)
	{
		...
		if(that.checked)
		{
			url = "switch.do?prefix=/wquality&page=/WaterSampleRes.do&mode=test&testCode="+testval+"&testId="+testId+"&sourceCode="+sourceCode;
...
<tr>
	...
	<table   bgcolor="#FFFFFF" bordercolor= "#8A9FCD"  width="100%" border=1 style="border-collapse:collapse" >
		<tr >
			...
			<td class="clrborder" align=center>Sample Collected Date</td>
			<td class="clrborder" align=center>Forwarded On</td>
		...
		<tr align="left" >
			...
			<td  class="bwborder" >
				...
				<nested:text name="LABTEST_LIST" property="testName" 
							styleClass="mytbltext" indexed="true" readonly="true" />
			</td>
			<td  class="bwborder" >
				<nested:text name="LABTEST_LIST" property="habName"  
				             styleClass="mytbltext" indexed="true" readonly="true" />
			</td>
			<td  class="bwborder" >
			...
			<td  class="bwborder" >
				<nested:text name="LABTEST_LIST" property="sampCollectDate" 
							styleClass="mytbltext" indexed="true" readonly="true" />
			</td>
			<td  class="bwborder" >
				<nested:text name="LABTEST_LIST" property="assignedOn" 
							styleClass="mytbltext" indexed="true" readonly="true" 
							style="width:80px" />
			</td>
			<td  class="bwborder" nowrap>
				<nested:hidden name="LABTEST_LIST" property="sourceCode" indexed="true" />
				<nested:text name="LABTEST_LIST" property="sourceName" 
							styleClass="mytbltext" indexed="true" readonly="true" 
							style="width:200px" />
			</td>
			<td  class="bwborder" align=center>
				<nested:hidden name="LABTEST_LIST" property="labCode" indexed="true" />
				<nested:text name="LABTEST_LIST" property="labName" 
							styleClass="mytbltext" indexed="true" readonly="true" 
							style="width:140px" />
			</td>
		</tr>
	...
	<tr>
		<td align=center>
		<html:submit property="mode" title="Save the Fields"  styleClass="btext" value="Submit" onclick="return fnSave()"/>
	    <html:reset title="Clear all the Fields" styleClass="btext" value="Reset" />
		<html:submit property="mode" title="View the Results" styleClass="btext" value="View"   />
