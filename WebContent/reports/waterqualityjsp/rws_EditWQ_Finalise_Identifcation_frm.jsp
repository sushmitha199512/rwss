...
<!--
	...
	{
		if(document.forms[0].sourceType.value!="" && document.forms[0].habCode.value!="")
		{
		document.forms[0].action="switch.do?prefix=/wquality&page=/WaterFinalIden.do&mode=newSource&opType=edit";
	...
	{
		workCode=document.forms[0].workCode.value;
		workCode=workCode.substring(0,14);
		
		document.forms[0].action="switch.do?prefix=/wquality&page=/WaterFinalIden.do&mode=data&opType=edit&workCode="+workCode;
		document.forms[0].submit();
	}
	function getData()
	{
		document.forms[0].action="switch.do?prefix=/wquality&page=/WaterFinalIden.do&mode=data&opType=edit";
		document.forms[0].submit();
	}
	function showWork()
	{
...
<html:form action="/WaterFinalIden.do?mode=edit" enctype="multipart/form-data">
...
<tr>
	...
	<html:hidden property="subdivisionOfficeCode" name="RWS_USER" />
		...
		<html:text property="workCode" style="width:573px" readonly="true" />
		...
		<td class="textborder">
		<html:select property="sourceType" styleClass="mycombo" style="width:123px" onchange="sourceTypeChanged()">
		<html:option value="">SELECT...</html:option>
