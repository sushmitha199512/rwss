...
<td class=btext>SUBPROGERMME_NAME.</td>
			...
			<td class=btext>BANK_SEND_DATE	</td>
			<td class=btext> BILL_AMOUNT_CENTRAL </td>
<td class=btext>%</td>
...
qry="select  distinct  a.work_id,b.work_name,p.programme_name,sp.subprogramme_name,bill_sl_no,to_char(bank_send_date,'dd-mm-yyyy'), nvl(BILL_AMOUNT_CENTRAL,0) from rws_bill_bank_bridge_det_tbl a,rws_work_admn_tbl b ,rws_programme_tbl p, rws_subprogramme_tbl sp  where  b.programme_code=p.programme_code and (b.programme_code=sp.programme_code and b.subprogramme_code=sp.subprogramme_code) and a.work_id=b.work_id and a.office_code is not null and substr(a.office_code,2,3)='"+dcode+""+divcode+"' ";
