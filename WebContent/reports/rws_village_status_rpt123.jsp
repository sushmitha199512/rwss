...
<td align="center" class="btext"><font color="navy">Mandal: <%=rs6.getString(4) %>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</font></td>
<td align="center" class="btext"><font color="navy">Panchayat: <%=rs6.getString(6) %></font></td>
...
%>
		...
		<td class="mystyle1">
			<a href="rws_panch_only_status_rpt123.jsp?vcode=<%=rs6.getString(7)%>&vname=<%=rs6.getString(8)%>&FDate=<%=fdate%>&dcode=<%=dCode%>&mcode=<%=mCode%>&pcode=<%=rs6.getString(5)%>"><%=rs6.getString(8)%></a></td>
