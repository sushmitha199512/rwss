...
function isSaveAttended()
{
		...
		else
		{
			...
			//alert(h);
			document.f1.action="./rws_exp_voucher_prg_rpt.jsp?fyear="+h;
			document.f1.submit();
			init();
		}
}
...
function isSaveAttended1()
{
		...
		else
		{
			var h=document.f1.fyear.value;
			//alert(h);
			document.f1.action="./rws_exp_voucher_nrdwpprg_rpt.jsp?fyear="+h;
			document.f1.submit();
			init();
		}
}
	...
	<caption>
		...
		<tr bgcolor="#8A9FCD" align="center">
			<td align="center" class="textborder" colspan="2">
                ...
                <font color="#FFFFFF">NRDWP Programmes - Select Financial Year</font>
			</td>	
		</tr>
		...
		<option value="09"><font class="myfontclr1">2009-2010</option>
		<option value="10"><font class="myfontclr1">2010-2011</option>
        <option value="11"><font class="myfontclr1">2011-2012</option>
