...
function unview()
{
	...
	function fnSubmit()
	{
		...
		document.f1.action="./rws_prajapatham_workstatus_drill.jsp";
		document.f1.submit();
	...
	function MandSubmit()
	{
		...
		document.f1.action="./rws_prajapatham_workstatus_rpt.jsp";
		document.f1.submit();
...
<table border = 1 align = center cellspacing = 0 cellpadding = 0 rules = "rows" bordercolor = navy style = "border-collapse:collapse" bgcolor="#ffffff" width=350>		
	...
	<tr bgcolor="#8A9FCD" align="center">
		<td align="center" class="rptHeading" colspan=3>Work Status Report</font></td>	
	</tr>
<%
...
<tr bgcolor="#8A9FCD" align="center">
		<td colspan=3 align=center>
			<input type=button id="vbutton" onclick="MandSubmit()" class=btext value="View Report">
		</td>
	</tr>
	<% } 
	else
