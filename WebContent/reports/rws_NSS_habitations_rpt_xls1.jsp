...
<%--@ include file="./rws_NSS_habitations_label.jsp"--%>
	<tr bgcolor="#8A9FCD" align="center">
		<td align="center" class="rptHeading" colspan=3>Quality Affected Coverage Status Excel Report</font></td>	
	</tr>
	<tr  align="center">
		<td  class="rptValue" colspan=3><b>District:</b> All</td>		
	</tr>	
	<tr align=center>
...
%>	
	<tr>
		...
		<td class=rptValue><%=rs2.getInt(3)%></a></td>
...
%>
	<tr>
		...
		<td class=btext><b><%=nssTotal%></b></td>
	</tr>
</table>
<%
}
