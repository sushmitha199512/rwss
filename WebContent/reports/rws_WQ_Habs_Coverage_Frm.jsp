...
function unview()
{
	...
	function fnSubmit()
	{
		...
		if(logValue=="admin" || logValue=="100000"|| logValue=="guest")
		{
			...
			document.f1.action="./rws_WQ_Habs_Coverage_rpt.jsp";
			document.getElementById('vbutton').disabled=true;
			document.f1.submit();
		}
		else
...
<%} %>
	...
	<tr bgcolor="#8A9FCD" align="center">
		<td align="center" class="rptHeading" colspan=3>Water Quality-Habitaion Covearage Status</td>	
	</tr>
...
<table><tr><td class=rptvalue>
<b><font color="red">Note:</font></b>&nbsp;&nbsp;All Sources- (Bore well (Hand pump, Shallow Hand pump,Tube well), open well,River, Canal, Ponds) </td></tr>
<tr><td class=rptvalue>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Surface Sources - (River, Canal, Ponds)  </td></tr>

<tr><td class=rptvalue>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Subsurface Sources- (Bore well (Hand pump, Shallow Hand pump,Tube well), open well)</td></tr>
</table>
