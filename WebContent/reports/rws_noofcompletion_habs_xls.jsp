...
response.setHeader("Content-Disposition", "inline; filename="
		+ "rws_noofcompletion_habs_xls.xls");
...
StringBuffer sname=new StringBuffer();
	 ...
	 yr.append((StringBuffer)session.getAttribute("yr"));
  ...
  sname.append((StringBuffer)session.getAttribute("scheme"));
    ...
    */
	...
	<tr >
	<td align="center" class="rptHeading" colspan="10" > STATUS WISE COVERAGE OF HABITATIONS DURING THE CURRENT FINANCIAL YEAR -(2013-14)-(as per works monitoring)									
  - Report</td>
	</tr>
