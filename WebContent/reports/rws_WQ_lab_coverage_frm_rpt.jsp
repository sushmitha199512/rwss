...
document.f1.distname.value = document.f1.combo.options[document.f1.combo.options.selectedIndex].text;
			 ...
			 if(document.getElementById('finyear').value=='0')
			{
		...
		{
			document.f1.action="./rws_WQ_lab_coverage_rpt.jsp";
			document.f1.submit();
		}
		//}
		//else
...
<%} %>
	...
	<tr bgcolor="#8A9FCD" align="center">
		<td align="center" class="rptHeading" colspan=4>WQ Lab Testing Coverage Abstract </td>
	</tr>
