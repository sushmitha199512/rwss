...
<%
					...
					stmt = conn.createStatement();
					query = "SELECT DISTINCT M.MCODE, M.MNAME FROM RWS_MANDAL_TBL M, RWS_HABITATION_DIRECTORY_TBL H,RWS_PRAJAPADAM_TBL PRAJA WHERE SUBSTR(PRAJA.HAB_CODE,1,2)=M.DCODE AND SUBSTR(PRAJA.HAB_CODE,6,2)=M.MCODE AND SUBSTR(H.HAB_CODE,1,2) = M.DCODE AND M.DCODE = '" +rDistrict+ "' AND SUBSTR(H.HAB_CODE,6,2) = M.MCODE ";
...
<%
					...
					stmt = conn.createStatement();
					query = "SELECT DISTINCT P.PANCH_CODE, P.PANCH_NAME FROM RWS_PANCHAYAT_RAJ_TBL P,RWS_PRAJAPADAM_TBL PRAJA WHERE SUBSTR(P.PANCH_CODE,1,2)  = '"+rDistrict+"'  AND SUBSTR(P.PANCH_CODE,6,2)  ='"+rMandal+"' AND PRAJA.HAB_CODE=P.PANCH_CODE";
