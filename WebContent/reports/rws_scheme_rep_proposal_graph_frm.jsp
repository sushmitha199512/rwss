...
function fnSubmit()
{
	...
	document.f1.action="./rws_scheme_rep_proposal_graph_rpt.jsp";
	document.f1.submit();
	...
	<table  border=0 rules=none style="border-collapse:collapse" width=100% align = "right" bgcolor="#edf2f8">
		...
		<tr bgcolor="#8A9FCD" align="center">
			<td align="center" class="textborder" colspan="2">
				<font color="#FFFFFF">Scheme Wise Representative Proposal</font>
			</td>	
		</tr>
...
<%		session.setAttribute("dName",null);
	...
	rs =stmt.executeQuery("SELECT distinct c.CIRCLE_OFFICE_CODE , c.circle_office_name from rws_circle_office_tbl c, rws_panchayat_raj_tbl pr,rws_Rep_proposal_tbl a, RWS_PROPOSAL_HAB_LNK_TBL ah where  c.circle_office_code=substr(a.office_code,2,2) and  a.proposal_id=ah.proposal_id and pr.panch_code=ah.hab_code and a.rep_date is not null");
	while(rs.next())
	{
...
<%			session.setAttribute("pName",null);
		...
		//System.out.println("THe error in subdivsion " +e);
		}
...
<tr>
			<td class = btext nowrap >
				<font color=navy><b>Year</b></font><font color=red>*</font>
			</td>
			<td class = btext >
