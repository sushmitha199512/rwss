...
{ %>
			...
			<td ><a href="./Rws_Ntr_Hab_Plant_Details_Excel_Rpt.jsp">Excel</a></td>
				</tr>
<%  } else {%>
...
<tr>
			<td align="center" class="gridhdbg" colspan=20>Sujala Patakam - Plant Installation Details of <%=dname%>&nbsp;&nbsp;District &nbsp; </td>
	</tr>
	 <tr align="center" >
...
String style="";
  try{
	  ...
	  String qry1 = "select distinct habitation_code,CONT_TYPE ,nvl(CONT_PERC,'0')   from rws_hab_contamination_tbl a ,RWS_NTR_SUJALA_HAB_IMPL_TBL c  where c.habitation_code=a.hab_code and substr(hab_code,1,2)='"+dcode+"'";
