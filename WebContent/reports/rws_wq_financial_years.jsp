        ...
        <SELECT name="finyear" id="combo1" class="mycombo" style="width:150px">
            ...
            <%
                ...
                try {
                    ...
                    int fy = 0;
                    int fy1 = 0;
                    String finquery = "select distinct substr(to_char(prepared_on,'dd/mm/yyyy'),7,4)  from rws_wq_test_results_tbl where substr(to_char(prepared_on,'dd/mm/yyyy'),4,2)>=4 and prepared_on is not null order by substr(to_char(prepared_on,'dd/mm/yyyy'),7,4) desc";
