...
document.f1.distname.value = document.f1.combo.options[document.f1.combo.options.selectedIndex].text;
			...
			else
		{
			...
			document.f1.action="./rws_coverage_habs_exp_rpt.jsp";
...
<%} %>
	...
	<tr bgcolor="#8A9FCD" align="center">
		<td align="center" class="rptHeading" colspan=4>PROGRAMME WISE EXPENDITURE DURING THE CURRENT FINANCIAL YEAR </td>
	</tr>
