...
function unview()
{
	...
	{
	//alert("in fun");	
	//document.forms[0].elements["workIdList"].value
...
document.f1.distname.value = document.f1.combo.options[document.f1.combo.options.selectedIndex].text;
			...
			else
		{
            ...
            if(cyear!=year1){
			document.f1.action="./rws_programme_milestone_district_rpt.jsp";
            }else {
            document.f1.action="./rws_programme_milestone_district_rpt.jsp";
			}
			document.f1.submit();
...
<%} %>
	...
	<tr bgcolor="#8A9FCD" align="center">
		<td align="center" class="rptHeading" colspan=4>Works Milestone Wise Abstract Report</td>
	</tr>
