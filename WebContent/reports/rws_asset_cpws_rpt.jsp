...
function fnSubmit()
	...
	//10/8/2009alert(document.f1.asset.value);
		...
		{
			//alert(document.f1.asset.selectedIndex.text);
			//alert(document.f1.asset.options[document.f1.asset.options.selectedIndex].text);
			if(document.f1.district.selectedIndex!="-1")
			{
				document.forms[0].districtName.value = document.f1.district.options[document.f1.district.options.selectedIndex].text;
			}
			else
			{
				document.forms[0].districtName.value='';
			}

			if(document.f1.mandal.selectedIndex!="-1")
			{
				document.forms[0].mandalName.value = document.f1.mandal.options[document.f1.mandal.options.selectedIndex].text;
			}
			else
			{
			...
			if(document.f1.panchayat.selectedIndex!="-1")
			{
				document.forms[0].panchayatName.value = document.f1.panchayat.options[document.f1.panchayat.options.selectedIndex].text;
			}
			else
			{
				document.forms[0].panchayatName.value='';
			}

			if(document.f1.village.selectedIndex!="-1")
			{
				document.forms[0].villageName.value = document.f1.village.options[document.f1.village.options.selectedIndex].text;
			}
			else
			{
				document.forms[0].villageName.value='';
			}

			if(document.f1.hab.selectedIndex!="-1")
			{
				document.forms[0].habName.value = document.f1.hab.options[document.f1.hab.options.selectedIndex].text;
			}
			else
			{
				document.forms[0].habName.value='';
			}
			...
			document.forms[0].typeOfAssetName.value = document.f1.asset.options[document.f1.asset.options.selectedIndex].text;
		...
		{
			document.f1.action="./WsPager.jsp";
			document.f1.submit();
		}
		else if(document.forms[0].printType[1].checked)
		{
			if(document.forms[0].asset.value=="04")// || document.forms[0].asset.value=="01"
			{
				if(document.forms[0].mandal.value=="-1")
				{
				...
				{
					document.f1.action="./WsPagerExcel.jsp";
					document.f1.submit();
				}
			}
			else
	...
	<table  border=0 rules=none style="border-collapse:collapse" align = "right" bgcolor="#edf2f8">
		...
		<tr bgcolor="#8A9FCD" align="center">
			<td align="center" class="textborder" colspan="2">
				<font color="#FFFFFF">Assets - Details Report</font>
			</td>	
		</tr>
...
<%
 ...
 %></select></td></tr>
 <tr><td class = btext nowrap colspan="2" align="center"><input type="radio" name="printType" checked>Normal Report&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="printType">Excel Report</tr>
<TR>
...
<%}catch(Exception e)
{
 ...
 %>	  
	...
	<input type="hidden" name="typeOfAssetName">
	</form>
	</body>
	</html>
