...
<tr bgcolor="#8A9FCD" align="center">
		<td align="center" class="rptHeading" colspan="14"> Assets - Others(Miscellaneous) </td>
</tr>
</table>
<table border=1 cellpadding=1 cellspacing=1 width="100%">
<tr align=center>
               <td class=btext>Sl.No</td>
			   <td class=btext>Component Code</td>
			   <td class=btext>Component Name</td>
			   <td class=btext>Component Location</td>
...
try
{
	    ...
	    else if(typeassetcode.equals("03"))
	{
   
		stmt1=conn.createStatement();
		rs1=stmt1.executeQuery("select  other_comp_code,comp_name,comp_location,remarks from rws_cpws_others_param_tbl  where asset_code='" + assetcode + "'  ");
		while(rs1.next())
    	{
	     				%>
...
<%
			...
			
	{
		...
		stmt1=conn.createStatement();
		rs1=stmt1.executeQuery("select  other_comp_code,comp_name,comp_location,remarks from rws_pws_others_param_tbl    where asset_code='"+assetcode+"' ");
		while(rs1.next())
    	{
...
<%
			...
			
	{
		...
		stmt1=conn.createStatement();
		rs1=stmt1.executeQuery("select  other_comp_code,comp_name,comp_location,remarks from rws_mpws_others_param_tbl    where asset_code='"+assetcode+"'  ");
		while(rs1.next())
    	{
