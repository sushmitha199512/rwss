...
<td>
	...
	<td>
		...
		<tr>
			...
			<%
			if(users.getUserId().equals("100000") || users.getUserId().equals("admin")){
				%>
			<html:button property="addNew" title="Add New Pushkar" styleClass="btext" value="Add New"  onclick="fnAddNew();" disabled="false"/>
			<%}else
			{
