                        ...
                        if(Result.equals("Deliverd"))
   		                  {
   	                       ...
   	                       String inoutqry="insert into RWS_SMS_IN_OUT_STATUS_TBL (MOBILE,SMS_DATE,SMS_TYPE,SMS_MODULE_AREA,SMS_DESC,HABITATION_CODE ) values('"+mobileNumbers+"',SYSDATE,'PUSH','DR','"+resultAlert+"','"+rs1.getString(5)+"')";
