                ...
                out.println("**TESTING***"+ps);
                    ...
                    for (String mobileNumbers : alertNumbers) {
                        ...
                        if(Result.equals("Deliverd"))
 		               {
 	                       ...
 	                       String inoutqry="insert into RWS_SMS_IN_OUT_STATUS_TBL (MOBILE,SMS_DATE,SMS_TYPE,SMS_MODULE_AREA,SMS_DESC,habitation_code) values('"+mobileNumbers+"',SYSDATE,'PUSH','GL','"+resultAlert+"','"+rs1.getString(5)+"')";
