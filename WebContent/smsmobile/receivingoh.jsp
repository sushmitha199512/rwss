                ...
                out.println("**TESTING***"+ps);
                    ...
                    for (String mobileNumbers : alertNumbers) {
                        ...
                        if(Result.equals("Deliverd"))
 		               {
 	                       ...
 	                       String inoutqry="insert into RWS_SMS_IN_OUT_STATUS_TBL (MOBILE,SMS_DATE,SMS_TYPE,SMS_MODULE_AREA,SMS_DESC,habitation_code) values(?,SYSDATE,'PUSH','OH',?,?)";
 	                       System.out.println("inoutqry"+inoutqry);
 	                      PreparedStatement psv=con.prepareStatement(inoutqry);
                          psv.setString(1,mobileNumbers);
							psv.setString(2,resultAlert);
							psv.setString(3,rs1.getString(5));
 	                       psv.executeUpdate();
