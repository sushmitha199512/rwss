...
<html:form action="SourceDestination.do">
<table width="100%">
<tr>
...
<tr><td class=myfontclr><B><font color="#FFFFFF">Source and Destination Distance Details</font></B></td>
</tr>
</table>
<table   bgcolor="#FFFFFF" bordercolor= "#8A9FCD"  width="100%" border=1 style="border-collapse:collapse" >
	...
	<td  class=mycborder align=center>
	<FONT class=myfontclr><font color="#993366">Source&nbsp;Code</FONT></FONT></td>
	
	 <td  class=mycborder align=center>
	<FONT class=myfontclr><font color="#993366">Source&nbsp;Location</FONT></FONT></td>
	
	 <td  class=mycborder align=center>
	<FONT class=myfontclr><font color="#993366">Destination</FONT></FONT></td>
	
	 <td  class=mycborder align=center>
	<FONT class=myfontclr><font color="#993366">Distance (in Kms)</FONT></FONT></td>
	<!--<td  class=mycborder align=center>
...
<td  class=mycborder1 align=left>
<FONT class=myfontclr1><bean:write name="SourceDetails" property="destination" /></FONT>
</td>
<td  class=mycborder1 align=left>
<FONT class=myfontclr1><bean:write name="SourceDetails" property="distance" /></FONT>
</td>
<%-- <td  class=mycborder1 align=left>
