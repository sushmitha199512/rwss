...
function funcDistrictChanged()
{
	...
	document.forms[0].action="/pred/smsmobile/divisionMandal.do?mode=mandals";
...
function fnSaveNew()
{
	...
	else if(document.forms[0].divisionName.value=="")
	{
		alert("Please Enter Division Name");
		return;
	}
	else if(document.forms[0].divmandals1.value=="")
	{
		alert("Please Select Mandals");
		return;
	}	
	else{
		document.forms[0].action="/pred/smsmobile/divisionMandal.do?mode=save";
...
<td>
		...
		<td>
				<html:text property="divisionName"  style="width:140px" onkeypress="return textOnly()"/>
				
		</td>
		</tr>
		<tr>
		<td class="textborder">Mandals	
			<span class="mandatory">*</span>
		</td>
		<td>
		<html:select property="divmandals1" style="width:200px" multiple="true" >
