...
<body  style="background-image:url('images/back3.jpg');" onload="init();" >
      ...
      <TABLE border=0 cellSpacing=0 cellPadding=0 width=1100 align=center>
        ...
        <TR>
          <TD vAlign=top align=middle>
           ...
           <td><img src="images/Vikas Raj.jpg" width="140" height="140">	
				<font face="verdana" size="3" color=blue><br>Welcome to<br>
				</font><font color="#9400d3" size="2" face="verdana">&nbsp; Shri. Vikas Raj,IAS <br> Secretary, RWSS </font></td>
...
<div  id="messaging1">
<table bgcolor="" cellpadding="5" border="0" bordercolor="#8A9FCD" rules="none" style="border-collapse:collapse" align="center" >
	<tbody class="formTBody" >
	<tr>
		<td><font face=Verdana  color="#F58F00" size="2"><b>From:</b><font color="red">*</font></td>
		<td><font face=Verdana  size="3"><input class="modeltextbox" type="text"  name="userId"  value=<%=userid %>   readonly="true"/></font></td>
	</tr>
	<tr>
...
<TR>
      <TD class=grey10pixel vAlign=top  align=middle><div align="center" class="style1">
                                    <p>&nbsp;</p>
                                    <p><b>Designed &amp; Developed by National Informatics Centre, AP State Centre</b></p>
                                  </div></TD>
                                </TR>
</table>
