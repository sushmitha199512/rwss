...
try
{
	...
	if(st3.executeUpdate(q3)>=0)
	{
		String q4 = "insert into rws_secretary_details_tbl values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
		  PreparedStatement pst=conn.prepareStatement(q4);
          pst.setString(1, rs1.getString(1));
			...
			pst.setString(7,rs1.getString(7));
			pst.setString(8,rs1.getString(8));
			pst.setString(9,rs1.getString(9));
			pst.setString(10,rs1.getString(10));
			pst.setString(11,rs1.getString(11));
			pst.setString(12,rs1.getString(12));
			pst.setString(13,rs1.getString(13));
			pst.setString(14,rs1.getString(14));
			pst.setString(15,rs1.getString(15));
			pst.setString(16,rs1.getString(1));
			pst.setString(17,rs1.getString(2));
			pst.setString(18,rs1.getString(3));
			pst.setString(19,rs1.getString(4));
			pst.setString(20,rs1.getString(5));
			pst.setString(21,rs1.getString(6));
			pst.setString(22,rs1.getString(7));
			pst.setString(23,rs1.getString(16));
			pst.setString(24,rs1.getString(17));
